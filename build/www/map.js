...
let scaleFactor = null; // Perfect like this (null so we know it hasn't been loaded yet)
...
window.onload = async () => {
    ...
    connection = new conn_js_1.Connection();
    ...
    svgContainer.on("click.coordtest", (event) => {
        ...
        try {
            ...
            const robotPoint_OUT = (0, coords_js_1.localCoordsToRobotCoords)(worldPoint_IN, params);
