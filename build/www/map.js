...
class MapApplication {
    ...
    resetZoomButton;
    constructor() {
        this.connection = new conn_js_1.Connection();
    ...
    setupD3() {
        ...
        this.pinGroup
            .append("image")
            .attr("class", "goto-pin")
            .attr("href", images_js_1.IMG_GO_TO_PIN)
            .attr("width", 29)
            .attr("height", 24)
            .style("opacity", 0)
            .style("display", "none")
    ...
    drawRobotAndCharger(robotPos, chargerPos) {
        ...
        charger
            ...
            .append("image")
            .attr("class", "charger")
            .attr("href", images_js_1.IMG_CHARGER)
            .merge(charger)
        ...
        robot
            ...
            .append("image")
            .attr("class", "robot")
            .attr("href", images_js_1.IMG_ROBOT_ORIGINAL)
            .merge(robot)
    ...
    drawPaths(pathData, mopData) {
        ...
        const paths = (0, pathProcessor_js_1.processPaths)(pathData.points, mopData, (robotPoint, p) => this.robotToSvg({ x: robotPoint[0], y: robotPoint[1] }, p), scale, params);
    ...
    drawObstacles(obstaclesData) {
        ...
        const enterGroups = groups
            ...
            const worldPoint = (0, coords_js_1.robotCoordsToLocalCoords)(robotPoint, params);
    ...
    updateRobotZones() {
        ...
        for (const rect of this.rects) {
            ...
            const coords1 = (0, coords_js_1.localCoordsToRobotCoords)(p1, params);
            const coords2 = (0, coords_js_1.localCoordsToRobotCoords)(p2, params);
            this.zones.push([
    ...
    bindUiEvents() {
        ...
        this.goToButton.addEventListener("click", () => {
            ...
            this.svgContainer.on("click.gototarget", (event) => {
                ...
                const point = (0, coords_js_1.localCoordsToRobotCoords)({ x: worldX, y: worldY }, params);
