...
describe("V1VacuumFeatures", () => {
    ...
    it("should correctly breakdown dss bits into status codes", async () => {
        ...
        (0, chai_1.expect)(adapterMock.setStateChanged.calledWith("Devices.duid1.dockingStationStatus.cleanFluidStatus", { val: 1, ack: true })).to.be.true; // 1 = ERROR
        (0, chai_1.expect)(adapterMock.setStateChanged.calledWith("Devices.duid1.dockingStationStatus.waterBoxFilterStatus", { val: 2, ack: true })).to.be.true; // 2 = OK
        (0, chai_1.expect)(adapterMock.setStateChanged.calledWith("Devices.duid1.dockingStationStatus.dustBagStatus", { val: 0, ack: true })).to.be.true; // 0 = UNKNOWN
    });
