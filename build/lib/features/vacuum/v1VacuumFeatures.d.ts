...
export declare abstract class V1VacuumFeatures extends BaseDeviceFeatures {
    ...
    protected processConsumables(resultObj: Record<string, any>): Promise<void>;
    ...
    protected getCleaningRecordMap(startTime: number, _recordDetails?: any): Promise<{
