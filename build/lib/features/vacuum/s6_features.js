...
let S6Features = class S6Features extends baseVacuumFeatures_1.BaseVacuumFeatures {
    constructor(dependencies, duid) {
        super(dependencies, duid, "roborock.vacuum.s6", s6Config, PROFILE_S6);
    }
};
exports.S6Features = S6Features;
exports.S6Features = S6Features = __decorate([
    (0, baseDeviceFeatures_1.RegisterModel)("roborock.vacuum.s6"),
