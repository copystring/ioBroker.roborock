...
const a51Config = {
    staticFeatures: [
        ...
        features_enum_1.Feature.ShakeMopStrength, // Alias for WaterBox logic
        features_enum_1.Feature.WaterBox,
        features_enum_1.Feature.AvoidCarpet
    ]
};
let A51Features = (() => {
    let _classDecorators = [(0, baseDeviceFeatures_1.RegisterModel)('roborock.vacuum.a51')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = baseVacuumFeatures_1.BaseVacuumFeatures;
    var A51Features = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            A51Features = _classThis = _classDescriptor.value;
    ...
    return A51Features = _classThis;
})();
exports.A51Features = A51Features;
//# sourceMappingURL=a51_features.js.map