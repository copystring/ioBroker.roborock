...
let A62Features = (() => {
    let _classDecorators = [(0, baseDeviceFeatures_1.RegisterModel)('roborock.vacuum.a62')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = baseVacuumFeatures_1.BaseVacuumFeatures;
    var A62Features = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            A62Features = _classThis = _classDescriptor.value;
    ...
    return A62Features = _classThis;
})();
exports.A62Features = A62Features;
//# sourceMappingURL=a62_features.js.map