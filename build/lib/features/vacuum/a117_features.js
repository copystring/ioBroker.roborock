...
const a117Config = {
    staticFeatures: [
        ...
        features_enum_1.Feature.LiveVideo // Action feature triggered by isVideoLiveCallSupported
        // Add Feature.Camera if applicable
    ]
};
let A117Features = (() => {
    let _classDecorators = [(0, baseDeviceFeatures_1.RegisterModel)('roborock.vacuum.a117')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = baseVacuumFeatures_1.BaseVacuumFeatures;
    var A117Features = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            A117Features = _classThis = _classDescriptor.value;
    ...
    return A117Features = _classThis;
})();
exports.A117Features = A117Features;
//# sourceMappingURL=a117_features.js.map