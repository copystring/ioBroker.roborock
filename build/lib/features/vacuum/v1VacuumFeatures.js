...
class V1VacuumFeatures extends baseDeviceFeatures_1.BaseDeviceFeatures {
    ...
    async detectAndApplyRuntimeFeatures(statusData) {
        ...
        // WaterBox
        if (version !== "B01" && (validStatus.water_box_mode !== undefined || validStatus.mop_mode !== undefined) && !this.appliedFeatures.has(features_enum_1.Feature.WaterBox)) {
        ...
        // MopDry
        if (version !== "B01" && validStatus.dry_status !== undefined && !this.appliedFeatures.has(features_enum_1.Feature.MopDry)) {
        ...
        // AutoEmptyDock
        if (version !== "B01" && validStatus.dust_collection_status !== undefined && !this.appliedFeatures.has(features_enum_1.Feature.AutoEmptyDock)) {
        ...
        // MopWash
        if (version !== "B01" && validStatus.wash_status !== undefined && !this.appliedFeatures.has(features_enum_1.Feature.MopWash)) {
        ...
        if (version !== "B01" && (hasDssInStatus || hasSupportedDock) && !this.appliedFeatures.has(features_enum_1.Feature.DockingStationStatus)) {
