...
class message_parser {
    ...
    _decodeMsg(message, duid) {
        ...
        while (offset + 3 <= message.length) {
            ...
            const crc32 = crc_32_1.default.buf(msgBuffer.subarray(0, msgBuffer.length - 4)) >>> 0;
            ...
            try {
                switch (version) {
                    case "1.0": {
                        ...
                        const decipher = crypto_1.default.createDecipheriv("aes-128-ecb", aesKey, null);
                    ...
                    case "A01": {
                        ...
                        const decipher = crypto_1.default.createDecipheriv("aes-128-cbc", localKey, iv);
                        dataCopy.payload = Buffer.concat([decipher.update(dataCopy.payload), decipher.final()]);
                        break;
                    }
                }
    ...
    async buildRoborockMessage(duid, protocol, timestamp, payload) {
        ...
        if (version == "1.0") {
            ...
            const cipher = crypto_1.default.createCipheriv("aes-128-ecb", aesKey, null);
            ...
            const cipher = crypto_1.default.createCipheriv("aes-128-cbc", keyBuffer, ivBuffer);
