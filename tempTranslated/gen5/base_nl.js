 ...
 * @property {number} dss - Ik weet niet
 * @property {number} rss - Signaalkwaliteit
 * @property {number} clean_percent - Reinigingspercentage voltooid
 * @property {number} charge_status - Oplaadstatus
 * @property {number} switch_map_mode - Wissel van kaartmodus
 * @property {number} collision_avoid_status - Status botsing vermijden
 * @property {number} avoid_count - Vermijd tellen
 * @property {number} camera_status - Camera
 * @property {number} last_clean_t - Laatste schoonmaaktijd
 * @property {number} rdt - ???
 * @property {number} dry_status - Droogstatus
 * @property {number} wash_status - Wasstatus
 */
const deviceStatus = {
	unsave_map_flag: {
 ...
 * @property {Object} avoid_count - Vermijd tellen
 */
