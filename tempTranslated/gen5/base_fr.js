 ...
 * @property {number} dss - Je ne sais pas
 * @property {number} rss - Qualité du signal
 * @property {number} clean_percent - Pourcentage de nettoyage terminé
 * @property {number} charge_status - État de charge
 * @property {number} switch_map_mode - Changer de mode carte
 * @property {number} collision_avoid_status - Statut d'évitement de collision
 * @property {number} avoid_count - Évitez de compter
 * @property {number} camera_status - Caméra
 * @property {number} last_clean_t - Dernière heure de nettoyage
 * @property {number} rdt - ???
 * @property {number} dry_status - État de séchage
 * @property {number} wash_status - Statut de lavage
 */
const deviceStatus = {
	unsave_map_flag: {
 ...
 * @property {Object} dust_collection_status - Statut de dépoussiérage
 * @property {Object} map_flag - @map_flag@
 * @property {Object} avoid_count - Évitez de compter
 */
