 ...
 * @property {number} rss - Качество сигнала
 * @property {number} clean_percent - Процент завершения очистки
 * @property {number} charge_status - Статус зарядки
 * @property {number} switch_map_mode - Переключить режим карты
 * @property {number} collision_avoid_status - Статус предотвращения столкновений
 * @property {number} avoid_count - Избегайте подсчета
 * @property {number} camera_status - Камера
 * @property {number} last_clean_t - Последний раз чистоты
 * @property {number} rdt - ???
 * @property {number} dry_status - Статус сушки
 * @property {number} wash_status - Статус стирки
 */
const deviceStatus = {
	unsave_map_flag: {
 ...
 * @property {Object} avoid_count - Избегайте подсчета
 */
