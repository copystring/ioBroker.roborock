 ...
 * @property {number} dss - Не знаю
 * @property {number} rss - Якість сигналу
 * @property {number} clean_percent - Відсоток очищення виконано
 * @property {number} charge_status - Стан зарядки
 * @property {number} switch_map_mode - Переключити режим карти
 * @property {number} collision_avoid_status - Статус уникнення зіткнення
 * @property {number} avoid_count - Уникайте підрахунку
 * @property {number} camera_status - Камера
 * @property {number} last_clean_t - Останній чистий час
 * @property {number} rdt - ???
 * @property {number} dry_status - Статус сушіння
 * @property {number} wash_status - Стан прання
 */
const deviceStatus = {
	unsave_map_flag: {
 ...
 * @property {Object} dust_collection_status - Стан збору пилу
 * @property {Object} map_flag - @map_flag@
 * @property {Object} avoid_count - Уникайте підрахунку
 */
