 ...
 * @property {number} dss - 不知道
 * @property {number} rss - 信号质量
 * @property {number} clean_percent - 清洁完成百分比
 * @property {number} charge_status - 充电状态
 * @property {number} switch_map_mode - 切换地图模式
 * @property {number} collision_avoid_status - 避免碰撞状态
 * @property {number} avoid_count - 避免计数
 * @property {number} camera_status - 相机
 * @property {number} last_clean_t - 最后清洁时间
 * @property {number} rdt - ???
 * @property {number} dry_status - 干燥状态
 * @property {number} wash_status - 洗涤状态
 */
const deviceStatus = {
	unsave_map_flag: {
 ...
 * @property {Object} avoid_count - 避免计数
 */
