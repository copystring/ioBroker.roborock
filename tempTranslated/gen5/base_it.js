 ...
 * @property {number} dss - Non lo so
 * @property {number} rss - Qualità del segnale
 * @property {number} clean_percent - Percentuale di pulizia completata
 * @property {number} charge_status - Stato di carica
 * @property {number} switch_map_mode - Cambia modalità mappa
 * @property {number} collision_avoid_status - Stato di evitare collisioni
 * @property {number} avoid_count - Evitare il conteggio
 * @property {number} camera_status - Telecamera
 * @property {number} last_clean_t - L'ultima volta pulita
 * @property {number} rdt - ???
 * @property {number} dry_status - Stato di asciugatura
 * @property {number} wash_status - Stato del lavaggio
 */
const deviceStatus = {
	unsave_map_flag: {
 ...
 * @property {Object} dust_collection_status - Stato della raccolta della polvere
 * @property {Object} map_flag - @map_flag@
 * @property {Object} avoid_count - Evitare il conteggio
 */
