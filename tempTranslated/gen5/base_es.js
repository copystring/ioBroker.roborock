 ...
 * @property {number} dss - No sé
 * @property {number} rss - Calidad de la señal
 * @property {number} clean_percent - Porcentaje de limpieza completado
 * @property {number} charge_status - Estado de carga
 * @property {number} switch_map_mode - Cambiar modo de mapa
 * @property {number} collision_avoid_status - Estado de evitar colisión
 * @property {number} avoid_count - evitar contar
 * @property {number} camera_status - Cámara
 * @property {number} last_clean_t - última vez limpia
 * @property {number} rdt - ???
 * @property {number} dry_status - Estado de secado
 * @property {number} wash_status - Estado de lavado
 */
const deviceStatus = {
	unsave_map_flag: {
 ...
 * @property {Object} avoid_count - evitar contar
 */
