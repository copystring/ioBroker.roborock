 ...
 * @description 清洁记录的描述。
 * @property {Object} begin - 开始清洁时间
 * @property {Object} end - 结束清洁时间
 * @property {Object} duration - 持续时间 清洁时间
 * @property {Object} area - 清洁区
 * @property {Object} error - 错误类型
 * @property {Object} complete - 完成类型
 * @property {Object} start_type - 启动类型
 * @property {Object} clean_type - 清洁型
 * @property {Object} finish_reason - 清洁完成原因
