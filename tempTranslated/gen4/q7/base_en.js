...
const states = {
	...
	/**
	 * @namespace mop_mode
	 * @description Description of mop modes.
	 ...
	 * @property {string} '[{"enable":0,"stall_time":10,"current_low":400,"current_high":500,"current_integral":450}]' - off
	 * @property {string} '[{"enable":1,"stall_time":10,"current_low":400,"current_high":500,"current_integral":450}]' - on
	 */
	carpet_mode: {
	 ...
	 * @description Carpet avoidance mode
	 * @property {string} '{"carpet_clean_mode":0}' - Avoid
	 * @property {string} '{"carpet_clean_mode":1}' - Rise
	 * @property {string} '{"carpet_clean_mode":2}' - Ignore
	 */
	carpet_clean_mode: {
	 ...
	 * @description Custom water usage mode
	 * @property {string} 200 - Off
	 * @property {string} 201 - Mild
	 * @property {string} 202 - Moderate
	 * @property {string} 203 - Intense
	 */
 ...
 * @property {Object} clean_time - Cleaning Time
 * @property {Object} clean_area - Cleaned Area
