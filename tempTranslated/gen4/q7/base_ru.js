...
const states = {
	 ...
	 * @description Режим предотвращения ковров
	 ...
	 * @description Пользовательский режим использования воды
 ...
 * @property {Object} begin - Начать уборку
 * @property {Object} end - Окончание уборки
 * @property {Object} duration - Продолжительность уборки
 * @property {Object} area - Зона уборки
 * @property {Object} error - Тип ошибки
 * @property {Object} complete - Тип завершения
 * @property {Object} start_type - Тип старта
 * @property {Object} clean_type - Чистый тип
 * @property {Object} finish_reason - Причина чистой отделки
