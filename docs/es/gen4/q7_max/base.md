...
| Name | Type | Description |
| --- | --- | --- |
| '[{"enable":0, | <code>string</code> | "stall_time": 10, "current_low": 400, "current_high": 500, "current_integral": 450}]' - apagado |
| '[{"enable":1, | <code>string</code> | "stall_time": 10, "current_low": 400, "current_high": 500, "current_integral": 450}]' - en |
...
| '{"carpet_clean_mode": | <code>string</code> | 1}' - Elevar |
...
| distance_off | <code>number</code> | Distancia desactivada |
