...
| `common_battery_percentage` | Відсоток батареї |
...
| `fault_summery_503` | Установіть пилозбірник і фільтр на місце.<br>Якщо проблема залишиться, замініть фільтр. |
...
| `guide_map_save_tip3` | Якщо вимкнути збереження карти, редагування карти й такі інтелектуальні функції прибирання, як «Вибіркове прибирання кімнат» і «Заборонена зона», стануть недоступними.<br> |
...
| `mapEdit_recommend_cill_subtitle` | <br>Тут виявлено поріг. Задайте зону порога. |
...
| `map_save_close_content` | Якщо вимкнути збереження карти, редагування карти й такі інтелектуальні функції прибирання, як «Прибирання кімнат» і «Заборонена зона», стануть недоступними.<br> |
...
| `setting_carpet_avoid_tip` | Після встановлення кріплення ганчірки для вологого прибирання робот уникає килимів і переміщається по них, лише щоб не пропустити ділянку.<br>* Застосовуйте після додавання килима в редагуванні карти |
...
| `setting_charging_note` | *Заряджання акумулятора може відбуватися в пікові години за таких умов:<br>1. У разі наявності незавершених завдань.<br>2. Якщо завдань немає, робот також заряджатиметься для підтримання мінімального заряду. |
| `setting_check_text` | Переглянути |
| `setting_consumable_change_tips1` | <br>Строк експлуатації основної щітки скінчився. Невідкладно замініть її. |
| `setting_consumable_change_tips2` | <br>Строк експлуатації бічної щітки скінчився. Невідкладно замініть її. |
| `setting_consumable_change_tips3` | <br>Строк експлуатації фільтра скінчився. Невідкладно замініть його. |
| `setting_consumable_change_tips4` | <br>Строк ганчірки для миття підлоги скінчився. Невідкладно замініть її. |
