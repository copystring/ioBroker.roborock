...
| `fault_summery_503` | התקינו מחדש את פח האשפה והפילטר במקום.<br>אם הבעיה נמשכת, החליפו את המסנן. |
...
| `guide_map_save_tip3` | ברגע ששמירת מפה מושבתת, עריכת מפה ותכונות ניקוי מותאמות אישית כגון ניקוי חדרים סלקטיבי ואזורי No-Go (אין מעבר) לא יהיו זמינים.<br> |
...
| `mapEdit_recommend_cill_subtitle` | <br>זוהה כאן סף. קבע אזור סף. |
...
| `setting_carpet_avoid_tip` | לאחר התקנת תושבת הבד למגב, הרובוט נמנע משטיחים וחוצה אותם רק כשצריך כדי למנוע החמצת נקודות.<br>* אנא השתמש בו לאחר הוספת שטיח בעריכת מפה |
...
| `setting_charging_note` | *טעינת הסוללה עשויה להתרחש במהלך שעות השיא בתנאים הבאים:<br>1. יש משימות לא גמורות.<br>2. אם אין משימות, רובוט יטעין גם כדי לשמור על מינימום הספק. |
| `setting_check_text` | צפה |
| `setting_consumable_change_tips1` | <br>המברשת הראשית הגיעה לחיי השירות. אנא החליפו אותו מיד |
| `setting_consumable_change_tips2` | <br>מברשת הצד הגיעה לחיי השירות. אנא החלפו אותו מיד |
| `setting_consumable_change_tips3` | <br>הפילטר הגיע לחיי השירות שלו. אנא החליפו אותו מיד |
| `setting_consumable_change_tips4` | <br>בד המגב הגיעה לחיי השירות. אנא החליפו אותו מיד |
