...
| `guide_map_save_tip3` | เมื่อปิดการใช้งานการบันทึกแผนที่แล้ว ฟีเจอร์การแก้ไขแผนที่และการทำความสะอาดแบบกำหนดเอง เช่น การทำความสะอาดห้องแบบเจาะจงและพื้นที่ห้ามเข้าจะไม่สามารถใช้งานได้<br> |
...
| `mapEdit_recommend_cill_subtitle` | <br>ตรวจพบธรณีประตูที่นี่ กำหนดโซนธรณีประตู |
...
| `setting_carpet_avoid_tip` | หลังติดตั้งตัวยึดผ้าถูพื้น หุ่นยนต์จะหลีกเลี่ยงพรมและข้ามพรมไปเมื่อจำเป็นเท่านั้น เพื่อไม่ให้พลาดการทำความสะอาดจุดใดไป<br>* โปรดใช้หลังจากเพิ่มพรมในการแก้ไขแผนที่ |
...
| `setting_charging_note` | *อาจมีการชาร์จแบตเตอรี่ในช่วงเวลาความต้องการสูงในสถานการณ์ต่อไปนี้<br>1. ยังมีงานที่ไม่เสร็จ<br>2. หากไม่มีงาน หุ่นยนต์จะยังคงชาร์จเพื่อรักษาระดับพลังงานต่ำสุด |
| `setting_check_text` | ดู |
| `setting_consumable_change_tips1` | <br>แปรงหลักหมดอายุการใช้งานแล้ว โปรดเปลี่ยนทันที |
| `setting_consumable_change_tips2` | <br>แปรงด้านข้างหมดอายุการใช้งานแล้ว โปรดเปลี่ยนทันที |
| `setting_consumable_change_tips3` | <br>ไส้กรองหมดอายุการใช้งานแล้ว โปรดเปลี่ยนทันที |
| `setting_consumable_change_tips4` | <br>ผ้าถูพื้นหมดอายุการใช้งานแล้ว โปรดเปลี่ยนทันที |
