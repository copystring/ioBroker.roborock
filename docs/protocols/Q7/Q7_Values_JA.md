# 🤖 Roborock Q7 Protocol Values (JA)
...
| `fault_summery_503` | ダストボックスとフィルターを所定の位置に再度取り付けてください。<br>問題が解決しない場合は、フィルターを交換してください。 |
...
| `map_save_close_content` | マップの保存を無効にすると、マップ編集や、エリア掃除、進入禁止エリアなどのカスタマイズされた掃除機能が利用できなくなります。<br> |
...
| `setting_carpet_avoid_tip` | モップクロスマウントが取り付けられた後は、本体はカーペットを避け、必要な場合のみ通過して掃除漏れを防ぎます。<br>※この機能を使用するには、マップ編集でカーペットを追加してください。 |
...
| `setting_charging_note` | *次の場合には、バッテリーの充電がピーク時に行われる可能性があります。<br>1.未完了のタスクがある場合。<br>2.タスクがない場合でも、本体が最低限の電力を維持するために充電を行う場合。 |
| `setting_check_text` | ご参照ください |
| `setting_consumable_change_tips1` | <br>メインブラシが耐用年数に達しています。すぐに交換してください。 |
| `setting_consumable_change_tips2` | サイドブラシが耐用年数に達しました。直ちに交換してください |
| `setting_consumable_change_tips3` | フィルターを交換してください。 |
| `setting_consumable_change_tips4` | <br>モップクロスが耐用年数に達しています。すぐに交換してください。 |
