...
- Die APK-Reihenfolge roher Geräte- und zugehöriger V5-Produkt-JSONs wird
  ...
  ein Persistenzfehler rollt auch das bereits umbenannte Paket zurück. Noch
  offen sind die echte Cloud-/Adapter-Anbindung dieses Pfads und das Starten
  sowie Stoppen des Supervisors durch den Adapter-Lebenszyklus.
