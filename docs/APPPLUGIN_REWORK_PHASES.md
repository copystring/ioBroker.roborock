...
- Die APK-Reihenfolge roher Geräte- und zugehöriger V5-Produkt-JSONs wird
  ...
  unveränderten Q7-, Q10-, RockMow- und Saros-Artefakten bestätigt. Noch offen
  sind die Anbindung an Versionsabfrage, authentifizierten Download,
  persistierten Speicher und Adapter-Lebenszyklus.
