...
- Die APK-Reihenfolge roher Geräte- und zugehöriger V5-Produkt-JSONs wird
  ...
  Repository-Artefakten. Die direkte Anbindung dieses Speicherpfads an den
  ...
  Speicher bildet Staging, Commit und Abbruch bereits atomar ab; seine
  produktive Befüllung nach Paketprüfung ist noch offen.
