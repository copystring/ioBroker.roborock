...
| Name | Type | Description |
| --- | --- | --- |
| '[{"enable":0, | <code>string</code> | "stall_time": 10, "current_low": 400, "current_high": 500, "current_integral": 450}]' - uit |
| '[{"enable":1, | <code>string</code> | "stall_time": 10, "current_low": 400, "current_high": 500, "current_integral": 450}]' - op |
...
| Name | Type | Description |
| --- | --- | --- |
| '{"carpet_clean_mode": | <code>string</code> | 0}' - Voorkomen |
| '{"carpet_clean_mode": | <code>string</code> | 1}' - Opstaan |
| '{"carpet_clean_mode": | <code>string</code> | 2}' - Negeren |
...
| dss | <code>number</code> | Ik weet niet |
| rss | <code>number</code> | Signaalkwaliteit |
| clean_percent | <code>number</code> | Reinigingspercentage voltooid |
| charge_status | <code>number</code> | Oplaadstatus |
| switch_map_mode | <code>number</code> | Wissel van kaartmodus |
| collision_avoid_status | <code>number</code> | Status botsing vermijden |
...
| avoid_count | <code>Object</code> | Vermijd tellen |
