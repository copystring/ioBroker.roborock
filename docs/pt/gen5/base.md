...
| dss | <code>number</code> | Não sei |
| rss | <code>number</code> | Qualidade do sinal |
| clean_percent | <code>number</code> | Porcentagem de limpeza concluída |
| charge_status | <code>number</code> | Status de carregamento |
| switch_map_mode | <code>number</code> | Alternar modo de mapa |
| collision_avoid_status | <code>number</code> | Status de evitar colisão |
| avoid_count | <code>number</code> | Evite contar |
| camera_status | <code>number</code> | Câmera |
