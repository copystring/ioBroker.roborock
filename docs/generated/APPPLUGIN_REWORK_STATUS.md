...
- **P0C-Q7-RENAME-VALIDATION** – Vordefinierte und doppelte Raumnamen prüfen: Je Fall eine frische Sitzung und Assertions für lokalisierte Auswahl sowie erzeugte beziehungsweise unterdrückte Absicht ergänzen.
...
| `P0C-Q7-RENAME-VALIDATION` | P0 | ⏳ offen | Vordefinierte und doppelte Raumnamen prüfen | `P0C-Q7-RENAME-HAPPY`, `P0C-Q7-RENAME-EMPTY`, `P0C-Q7-RENAME-MAX-LENGTH` | — | Je Fall eine frische Sitzung und Assertions für lokalisierte Auswahl sowie erzeugte beziehungsweise unterdrückte Absicht ergänzen. |
