...
- **P0B-DEVICE-BOOTSTRAP** – AppPlugin-Sitzung aus Modell, Bundlemetadaten und vollständigem Gerätekontext statt Roboter-Testprofilen starten: Der angemeldete Cloud-Datenfluss erzeugt Geräte- und zugehörige V5-Produkt-JSONs in APK-Reihenfolge und stellt rruid, Land sowie Region gemeinsam im Speicher bereit. Ein geräteklassenneutraler Rriot-Builder leitet daraus die statischen RRPluginSDK-Werte für die Ziel-DUID ab; der Supervisor übergibt den validierten Deskriptor begrenzt per Standardeingabe statt über Kindprozessargumente, Umgebung oder eine selbst erzeugte Datei. Die APK-lokale Haupt-Plugin-Version besitzt einen atomaren Staging-/Commit-/Abbruchspeicher. Als Nächstes Builder und Pipe im Adapter-Lebenszyklus verbinden, echte Mehrgeräte-HomeData in derselben isolierten Sitzung prüfen und den Installations-Commit an die Integritätsprüfung des realen Pluginpakets binden. RockMow bleibt bis zu echter Mäher-HomeData und vollständiger Bedarfsdeckung eine Bootstrap-Gegenprobe.
