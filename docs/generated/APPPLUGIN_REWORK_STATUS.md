...
- **P0B-DEVICE-BOOTSTRAP** – AppPlugin-Sitzung aus Modell, Bundlemetadaten und vollständigem Gerätekontext statt Roboter-Testprofilen starten: Der angemeldete Cloud-Datenfluss erzeugt Geräte- und zugehörige V5-Produkt-JSONs in APK-Reihenfolge im Speicher; der Supervisor übergibt den validierten Deskriptor begrenzt per Standardeingabe statt über Kindprozessargumente, Umgebung oder eine selbst erzeugte Datei. Die APK-lokale Haupt-Plugin-Version ist aus HomeData entfernt und besitzt einen atomaren Staging-/Commit-/Abbruchspeicher; ohne bestätigten Eintrag liefert RRDevicesModule 0. Als Nächstes diesen Speicherpfad an den Adapter-Lebenszyklus anschließen, echte Mehrgeräte-HomeData in der isolierten Sitzung prüfen und den Commit an die Integritätsprüfung des realen Pluginpakets binden. RockMow bleibt bis zu echter Mäher-HomeData und vollständiger Bedarfsdeckung eine Bootstrap-Gegenprobe.
...
| `P0B-DEVICE-BOOTSTRAP` | P0 | 🔄 in Arbeit | AppPlugin-Sitzung aus Modell, Bundlemetadaten und vollständigem Gerätekontext statt Roboter-Testprofilen starten | `P0A-SOURCE-PROVENANCE`, `P0A-APK-CONTRACT-INVENTORY`, `P0B-REACT-NATIVE-BRIDGE` | [`scripts/start_appplugin_desktop_runtime.ts`](../../scripts/start_appplugin_desktop_runtime.ts)<br>[`scripts/lib/appPluginDesktopLauncher.ts`](../../scripts/lib/appPluginDesktopLauncher.ts)<br>[`scripts/lib/appPluginDesktopFixtureSessions.ts`](../../scripts/lib/appPluginDesktopFixtureSessions.ts)<br>[`scripts/lib/appPluginSessionDescriptorTransport.ts`](../../scripts/lib/appPluginSessionDescriptorTransport.ts)<br>[`scripts/appplugin_hermes_runtime_probe.ts`](../../scripts/appplugin_hermes_runtime_probe.ts)<br>[`src/apppluginHost/apkAppPluginSessionDescriptor.ts`](../../src/apppluginHost/apkAppPluginSessionDescriptor.ts)<br>[`src/apppluginHost/apkHomeDataContext.ts`](../../src/apppluginHost/apkHomeDataContext.ts)<br>[`src/apppluginHost/apkPluginInstallationStore.ts`](../../src/apppluginHost/apkPluginInstallationStore.ts)<br>[`src/apppluginHost/apkDevicesRuntime.ts`](../../src/apppluginHost/apkDevicesRuntime.ts)<br>[`src/apppluginHost/apkCoreRuntimeConstants.ts`](../../src/apppluginHost/apkCoreRuntimeConstants.ts)<br>[`src/apppluginHost/apkDeviceIngress.ts`](../../src/apppluginHost/apkDeviceIngress.ts)<br>[`src/apppluginHost/apkNativeInvocationDiagnostics.ts`](../../src/apppluginHost/apkNativeInvocationDiagnostics.ts)<br>[`src/apppluginHost/apkPluginSdkRpcModule.ts`](../../src/apppluginHost/apkPluginSdkRpcModule.ts)<br>[`src/lib/httpApi.ts`](../../src/lib/httpApi.ts)<br>[`test/unit/appplugin_apk_home_data_context.test.ts`](../../test/unit/appplugin_apk_home_data_context.test.ts)<br>[`test/unit/appplugin_apk_native_invocation_diagnostics.test.ts`](../../test/unit/appplugin_apk_native_invocation_diagnostics.test.ts)<br>[`test/unit/appplugin_apk_devices_runtime.test.ts`](../../test/unit/appplugin_apk_devices_runtime.test.ts)<br>[`test/unit/appplugin_apk_plugin_installation_store.test.ts`](../../test/unit/appplugin_apk_plugin_installation_store.test.ts)<br>[`test/unit/appplugin_apk_session_descriptor.test.ts`](../../test/unit/appplugin_apk_session_descriptor.test.ts)<br>[`test/unit/appplugin_desktop_launcher.test.ts`](../../test/unit/appplugin_desktop_launcher.test.ts)<br>[`test/unit/appplugin_desktop_fixture_sessions.test.ts`](../../test/unit/appplugin_desktop_fixture_sessions.test.ts)<br>[`test/unit/appplugin_session_descriptor_transport.test.ts`](../../test/unit/appplugin_session_descriptor_transport.test.ts) | Der angemeldete Cloud-Datenfluss erzeugt Geräte- und zugehörige V5-Produkt-JSONs in APK-Reihenfolge im Speicher; der Supervisor übergibt den validierten Deskriptor begrenzt per Standardeingabe statt über Kindprozessargumente, Umgebung oder eine selbst erzeugte Datei. Die APK-lokale Haupt-Plugin-Version ist aus HomeData entfernt und besitzt einen atomaren Staging-/Commit-/Abbruchspeicher; ohne bestätigten Eintrag liefert RRDevicesModule 0. Als Nächstes diesen Speicherpfad an den Adapter-Lebenszyklus anschließen, echte Mehrgeräte-HomeData in der isolierten Sitzung prüfen und den Commit an die Integritätsprüfung des realen Pluginpakets binden. RockMow bleibt bis zu echter Mäher-HomeData und vollständiger Bedarfsdeckung eine Bootstrap-Gegenprobe. |
