...
- **P0C-Q7-RENAME-VALIDATION** – Vordefinierte, zu lange und doppelte Raumnamen prüfen: Je Fall eine frische Sitzung und Assertions für Dialogzustand, lokalisierte Auswahl und erzeugte beziehungsweise unterdrückte Absicht ergänzen.
- **P0C-Q7-RENAME-FAILURE** – Gerätefehler, Timeout, Rollback und erneuten Kartenabruf beim Umbenennen prüfen: APK-konforme Antwort- und Timeoutereignisse einspielen und AppPlugin-Zustand sowie Wiederherstellung belegen.
...
| `P0C-Q7-RENAME-VALIDATION` | P0 | ⏳ offen | Vordefinierte, zu lange und doppelte Raumnamen prüfen | `P0C-Q7-RENAME-HAPPY`, `P0C-Q7-RENAME-EMPTY` | — | Je Fall eine frische Sitzung und Assertions für Dialogzustand, lokalisierte Auswahl und erzeugte beziehungsweise unterdrückte Absicht ergänzen. |
| `P0C-Q7-RENAME-FAILURE` | P0 | ⏳ offen | Gerätefehler, Timeout, Rollback und erneuten Kartenabruf beim Umbenennen prüfen | `P0C-Q7-RENAME-HAPPY`, `P0B-ERROR-CLASSIFICATION` | — | APK-konforme Antwort- und Timeoutereignisse einspielen und AppPlugin-Zustand sowie Wiederherstellung belegen. |
