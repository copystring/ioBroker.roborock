...
- **P0B-REACT-NATIVE-BRIDGE** – React-Native-Modul-, UIManager- und Ereignisverträge APK-konform bereitstellen: Die aus APK 4.54.02 inventarisierten 70 effektiven Native-Module bleiben die aktuelle Obermenge. Davon sind 31 vollständig, drei teilweise und 36 nicht implementiert. Der endliche Audit über 14 unterschiedliche lokale Bundles meldet 14 vollständige Berichte, zehn erzeugte React-Roots und keine Zeitüberschreitung. Vier ältere JavaScript-Bundles verlangen beim Bootstrap einen anderen AsyncStorage-Namen als APK 4.54.02 bereitstellt; dafür ein durch eine passende ältere APK belegtes Hostprofil ergänzen, statt einen stillen Kompatibilitätsalias in das aktuelle Profil einzubauen.
- **P0B-APK-HOST-SERVICES** – APK-Konto-, IoT-HTTP-, Rollen- und Verbindungsdienste als generische Hostgrenze bereitstellen: Die getrennten und APK-belegten Hostgrenzen iotGet und userGet sowie die Produktrollen-Abfrage an den vorhandenen authentifizierten ioBroker-Roborock-Transport hängen; Offline-Proben dürfen fehlende Antworten weiterhin nicht erfinden.
