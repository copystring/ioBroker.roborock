...
- **P0C-Q7-M5-GATES** – Q7-M5-Familienabweichungen durch vollständige Verhaltens-Gates absichern: Die gemeinsamen Rename- und verbleibenden Gesten-Gates gegen M5 ausführen; nur belegte Bundleabweichungen separat festhalten.
...
| --- | --- | --- | --- |
| SCMap/Skia – Q7 L5, Q7 M5 und B01 | Hermes HBC, SCMap.RobotMap, React Native und Skia | 🔄 in Arbeit | Den für Q7 L5 und M5 gemeinsamen Host-, Vollszenen-, Theme-, Akteur-, Split- und Merge-Vertrag um die noch offenen M5-Rename- und Gesten-Gates erweitern. |
