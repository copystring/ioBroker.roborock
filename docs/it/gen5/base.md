...
| dss | <code>number</code> | Non lo so |
| rss | <code>number</code> | Qualità del segnale |
| clean_percent | <code>number</code> | Percentuale di pulizia completata |
| charge_status | <code>number</code> | Stato di carica |
| switch_map_mode | <code>number</code> | Cambia modalità mappa |
| collision_avoid_status | <code>number</code> | Stato di evitare collisioni |
| avoid_count | <code>number</code> | Evitare il conteggio |
| camera_status | <code>number</code> | Telecamera |
| last_clean_t | <code>number</code> | L'ultima volta pulita |
