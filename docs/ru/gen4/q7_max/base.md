...
| Name | Type | Description |
| --- | --- | --- |
| '[{"enable":0, | <code>string</code> | "stall_time": 10, "current_low": 400, "current_high": 500, "current_integral": 450}]' - выключенный |
| '[{"enable":1, | <code>string</code> | "stall_time": 10, "current_low": 400, "current_high": 500, "current_integral": 450}]' - на |
...
| Name | Type | Description |
| --- | --- | --- |
| '{"carpet_clean_mode": | <code>string</code> | 0}' - Избегать |
| '{"carpet_clean_mode": | <code>string</code> | 1}' - Рост |
| '{"carpet_clean_mode": | <code>string</code> | 2}' - игнорировать |
...
| distance_off | <code>number</code> | Расстояние выкл. |
