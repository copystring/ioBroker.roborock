# Roborock S8 <br> Roborock S8 Pro Ultra
...
<dd><p>Mapping of water box custom modes.</p>
</dd>
<dt><a href="#carpet_mode">carpet_mode</a> : <code>object</code></dt>
<dd><p>Represents the carpet mode settings for the vacuum.
Each key is a JSON string that encodes the settings, and each value
indicates whether the mode is &quot;on&quot; or &quot;off&quot;.</p>
</dd>
<dt><a href="#carpet_clean_mode">carpet_clean_mode</a> : <code>object</code></dt>
<dd><p>Represents the different cleaning modes for carpets.
Each key is a JSON string that encodes the mode setting, and each value
indicates the behavior of the vacuum on carpets.</p>
</dd>
<dt><a href="#water_box_mode">water_box_mode</a> : <code>object</code></dt>
<dd><p>Represents the different modes for water box usage.
Each key is a string representing a mode ID, and each value
describes the water output level for the mopping function.</p>
</dd>
...
Mapping of water box custom modes.
...
| Name | Type | Description |
| --- | --- | --- |
| 200 | <code>string</code> | Off mode |
| 201 | <code>string</code> | Mild mode |
| 202 | <code>string</code> | Moderate mode |
| 203 | <code>string</code> | Intense mode |

<a name="carpet_mode"></a>

## carpet\_mode : <code>object</code>
Represents the carpet mode settings for the vacuum.
Each key is a JSON string that encodes the settings, and each value
...
| Name | Type | Description |
| --- | --- | --- |
| '[{"enable":0, | <code>string</code> | "stall_time": 10, "current_low": 400, "current_high": 500, "current_integral": 450}]' - Carpet mode is off |
| '[{"enable":1, | <code>string</code> | "stall_time": 10, "current_low": 400, "current_high": 500, "current_integral": 450}]' - Carpet mode is on |

<a name="carpet_clean_mode"></a>

## carpet\_clean\_mode : <code>object</code>
Represents the different cleaning modes for carpets.
Each key is a JSON string that encodes the mode setting, and each value
...
| Name | Type | Description |
| --- | --- | --- |
| '{"carpet_clean_mode": | <code>string</code> | 0}' - The vacuum avoids carpets. |
| '{"carpet_clean_mode": | <code>string</code> | 1}' - The vacuum rises the mop on carpets. |
| '{"carpet_clean_mode": | <code>string</code> | 2}' - The vacuum ignores the presence of carpets and cleans normally. |

<a name="water_box_mode"></a>

## water\_box\_mode : <code>object</code>
Represents the different modes for water box usage.
Each key is a string representing a mode ID, and each value
...
| Name | Type | Description |
| --- | --- | --- |
| "200" | <code>string</code> | The water box is turned off. |
| "201" | <code>string</code> | Low level of water output. |
| "202" | <code>string</code> | Medium level of water output. |
| "203" | <code>string</code> | High level of water output. |
| "204" | <code>string</code> | Customize automatically based on the surface. |
| "207" | <code>string</code> | User customized water output levels. |
...
| distance_off | <code>number</code> | Distance Off |
...
| dss | <code>number</code> | Collision Avoid Status |
...
| Name | Type | Description |
| --- | --- | --- |
| clean_time | <code>Object</code> | Total cleaning time |
| clean_area | <code>Object</code> | Total cleaning area |
...
| avoid_count | <code>Object</code> | How many obstacles have been avoided |
