...
| Name | Type | Description |
| --- | --- | --- |
| '[{"enable":0, | <code>string</code> | "stall_time": 10, "current_low": 400, "current_high": 500, "current_integral": 450}]' - вимкнено |
...
| Name | Type | Description |
| --- | --- | --- |
| '{"carpet_clean_mode": | <code>string</code> | 0}' - Уникайте |
| '{"carpet_clean_mode": | <code>string</code> | 1}' - Підйом |
| '{"carpet_clean_mode": | <code>string</code> | 2}' - Ігнорувати |
...
| distance_off | <code>number</code> | Відстань |
