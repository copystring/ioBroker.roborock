...
const actions = {
	...
	set_CleaningRecordsS6: async (context) => { // this is a special case for the S6 MaxV only as far as I know
		context.cleaningRecords = cleaningRecordsString;
		context.cleaningInfo = cleaningInfoInt;
	},
...
class deviceFeatures {
	...
	async processSupportedFeatures() {
		if (this.productCategory == "robot.vacuum.cleaner") {
			...
			const modelConfig = {
				// S6 Pure
				"roborock.vacuum.a08": ["set_CleaningRecordsS6", "setConsumablesInt"],
				// S6 MaxV
				"roborock.vacuum.a10": ["set_CleaningRecordsS6", "setConsumablesInt"],
				// S7
