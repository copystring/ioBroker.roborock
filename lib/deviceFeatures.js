...
class deviceFeatures {
	...
	async processSupportedFeatures() {
		if (this.productCategory == "robot.vacuum.cleaner") {
			...
			const modelConfig = {
				"roborock.vacuum.a08": ["setCleaningRecordsInt"], // S6 Pure
				"roborock.vacuum.a10": ["setCleaningRecordsInt"], // S6 MaxV
				"roborock.vacuum.a15": ["setCleaningRecordsString"], // S7
				"roborock.vacuum.a19": ["setCleaningRecordsInt"], // S4 Max
				"roborock.vacuum.a27": [
					// S7 MaxV (Ultra)
				...
				"roborock.vacuum.s5e": ["setCleaningRecordsInt"], // S5 Max
				"roborock.vacuum_s6": ["setCleaningRecordsInt"], // S6
				default: ["setDefault"],
			};
