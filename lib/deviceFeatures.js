...
const actions = {
	...
	setDefault: async (context) => {
		context.cleaningRecords = cleaningRecordsString;
		await context.processCleaningInfo(cleaningInfoString);
		deviceStates.map_flag = "number";
		cleaningRecordsString.map_flag = { type: "number", name: "cleaningRecord_map_flag" };
...
class deviceFeatures {
	...
	getFeatureList() {
		this.adapter.log.debug(`FEATURE TEST ${this.featuresStr}`);
		...
		return {
			...
			isMopForbiddenSupported: ["roborock.vacuum.a51"],
	...
	async processSupportedFeatures() {
		if (this.productCategory == "robot.vacuum.cleaner") {
			...
			const modelConfig = {
				// S6 Pure
				"roborock.vacuum.a08": ["setCleaningRecordsInt"],
				// S6 MaxV
				"roborock.vacuum.a10": ["setCleaningRecordsInt"],
				// S7
				"roborock.vacuum.a15": ["setCleaningRecordsString"],
				// S4 Max
				"roborock.vacuum.a19": ["setCleaningRecordsInt"],
				// S7 MaxV (Ultra)
				"roborock.vacuum.a27": ["setCleaningRecordsString", "set_map_flag", "set_back_type"],
				// Q7 Max
				"roborock.vacuum.a38": ["setCleaningRecordsString", "set_map_flag"],
				// Q7
				"roborock.vacuum.a40": ["setCleaningRecordsString", "set_map_flag"],
				// S8
				"roborock.vacuum.a51": ["setCleaningRecordsString", "set_dss", "set_rss", "set_last_clean_t", "set_map_flag"],
				// S7 Pro Ultra
				"roborock.vacuum.a62": ["setCleaningRecordsString", "set_dss", "set_rss", "set_map_flag"],
				// S7 Max Ultra
				"roborock.vacuum.a65": ["setCleaningRecordsString", "set_dss", "set_rss", "set_map_flag", "set_back_type"],
				// S8 Pro Ultra
				"roborock.vacuum.a70": ["setCleaningRecordsString", "set_common_status", "set_dss", "set_rss", "set_last_clean_t", "set_map_flag", "set_back_type"],
				// Q5 Pro
				"roborock.vacuum.a72": ["setCleaningRecordsString", "set_dss", "set_rss", "set_last_clean_t", "set_map_flag", "set_back_type"],
				// Q8 Max
				"roborock.vacuum.a73": ["setCleaningRecordsString", "set_common_status", "set_dss", "set_rss", "set_in_warmup", "set_last_clean_t", "set_map_flag"],
				// Q Revo
				"roborock.vacuum.a75": [
				...
				// S4
				"roborock.vacuum.s4": ["setCleaningRecordsInt", "setConsumablesInt"],
				// S5 Max
				"roborock.vacuum.s5e": ["setCleaningRecordsInt"],
				// S6
				"roborock.vacuum_s6": ["setCleaningRecordsInt"],
				default: ["setDefault"],
			};

			// process modelConfig
			const configActions = modelConfig[this.model] || modelConfig["default"];
			...
			await this.adapter.createCameraStreams(this.duid);
	...
	processDockType(dockType) {
		// for now this is needed for S7 (MaxV) only
		if (this.model == "roborock.vacuum.a15" || this.model == "roborock.vacuum.a27") {
			switch (dockType) {
