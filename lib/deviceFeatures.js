...
class deviceFeatures {
	...
	isSupportedDrying() {
		this.adapter.createCommand(this.duid, "app_set_dryer_status", "string", '{"status": 0}', { '{"status": 1}': "On", '{"status": 0}': "Off" });
		this.adapter.createCommand(this.duid, "app_set_dryer_setting", "json", '{"on":{"dry_time":10800},"status":0}', {
