    ...
    },
    {
      ...
      value: function () {
        var t,
          ...
          L = React.default.createElement(module1846.default, {
            ref: function (t) {
        ...
        var G = React.default.createElement(module1055.MultiMapSelectView, {
          ...
          F = React.default.createElement(module1427.default, {
            ref: function (t) {
    ...
    },
    {
      ...
      value: function () {
        ...
        if (!(null == (n = this.sidebarMenu)))
          n.setState({
            tab: this.state.mode == j.Segment ? module1544.TabSegment : module1544.TabZone,
            mapEditButtonEnabled: module390.default.isSupportSmartScene(),
            modeSetButtonEnabled: module390.default.isSupportSmartScene(),
          });
    ...
    },
    {
      ...
      value: function () {
        ...
        var o = module382.getCleanModeTitle(this.state.cleanMode),
          ...
          s = o + (l ? ' | ' + l : '');
        if (module390.default.isPureCleanMopSupported() && this.state.cleanMode == module1541.CleanModeZero) return l + ' | ' + module382.getMopMethodTitle(this.state.mopMode);

        if (module390.default.isShakeMopSetSupported() && 200 != this.state.waterMode) {
          var u,
            c = t ? (null == (u = module1543.ModeDataInstance.modePannelCustomMops[0]) ? undefined : u.name) : module382.getMopMethodTitle(this.state.mopMode);
          if (301 == this.state.mopMode) return l + ' | ' + c;

          if (t) {
            if (n == module1542.CleanMethodClean) return s;
            if (n == module1542.CleanMethodMop) return c;
            if (n == module1542.CleanMethodCleanAndMop) return s + ' | ' + c;
          }
        }
