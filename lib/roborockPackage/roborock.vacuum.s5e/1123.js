...
module1399.propTypes = {
  onLongPress: PropTypes.default.func,
};
module1399.defaultProps = {
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return 1 != this.props.parent.state.inBlockMode && this.props.mapMode != module1265.MAP_MODE_CARPET_EDIT
          ? React.default.createElement(module1389.ForbiddenView, {
              ref: function (t) {
    ...
    },
    {
      ...
      value: function () {
        ...
        return React.default.createElement(module1132.ObjectNameBubble, {
          ...
          objectName: u,
          objectImage: p ? module1397 : module1396,
          objectLottie: p ? module1398 : null,
          center: h,
          transform: this.state.transform,
          textWidth: 70,
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return module390.default.isCarpetSupported() && this.props.mapElementShowFlag & module1057.MapElementShow.FLOOR_CARPET
          ? React.default.createElement(module1389.CarpetsView, {
              ref: function (t) {
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return this.props.mapElementShowFlag & module1057.MapElementShow.FURNITURE &&
          ...
          ? React.default.createElement(module1389.FurnitureView, {
              ref: function (t) {
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return this.props.parent.props.shouldShowRobotMovingAnimation
          ? React.default.createElement(module1389.HistoryMarkView, {
              ref: function (t) {
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return this.props.mapElementShowFlag & module1057.MapElementShow.FLOOR_CARPET &&
          ...
          ? React.default.createElement(module1389.DoorSillView, {
              ref: function (t) {
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return module390.default.isSupportStuckZone() && 1 != this.props.parent.state.inBlockMode && this.props.mapMode == module1265.MAP_MODE_REGULAR
          ? React.default.createElement(module1389.AIObjectView, {
              ref: function (t) {
      ...
      value: function () {
        ...
        return React.default.createElement(
          ...
          React.default.createElement(
            ...
            Z && F,
            this.getCleanRect(s),
            React.default.createElement(module1399, {
              ref: function (s) {
                return (t.target = s);
              },
              transform: s,
...
module1400.contextType = module1121.AppConfigContext;
module1400.propTypes = {
