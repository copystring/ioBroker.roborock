...
exports.default = function (u, l) {
  var h,
    v,
    y = '__create-react-context-' + (0, module1163.default)() + '__',
    b = (function (t) {
      function n() {
        var module1163, u, p, f;
        s(this, n);

        for (var l = arguments.length, h = Array(l), v = 0; v < l; v++) h[v] = arguments[v];

        module1163 = u = c(this, t.call.apply(t, [this].concat(h)));
        u.emitter =
          ((p = u.props.value),
          (f = []),
          {
  ...
  var _ = (function (t) {
    function n() {
      ...
      module1163 = u = c(this, t.call.apply(t, [this].concat(f)));
      u.state = {
        value: u.getValue(),
      };
