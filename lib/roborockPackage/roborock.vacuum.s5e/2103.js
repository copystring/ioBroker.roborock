...
var module505 = require('./505').strings,
  ...
  module2108 = (function (t) {
    module7.default(module2104, t);

    var module50 = module2104,
      module1121 = T(),
      O = function () {
        var t,
    ...
    function module2104(t) {
      var o;
      module4.default(this, module2104);
    ...
    module5.default(module2104, [
      ...
      },
      {
        key: 'darkImgs',
        value: function () {
          return [require('./2104'), require('./2105'), require('./2106'), require('./2107'), require('./2108')];
        },
      },
      {
        key: '_getActiveImage',
...
exports.default = module2108;
module2108.contextType = module1121.AppConfigContext;
