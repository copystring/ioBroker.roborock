    ...
    module5.default(O, [
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module393.isLogFunctionSupported()) !module423.DMM.isV1 || module390.default.isDebuggableV1User();
      ...
      },
      {
        ...
        value: function () {
          this.props.navigation.navigate('WebViewPage', {
            title: V.localization_strings_Main_Views_ImprovementPage_0,
            refrence: module1573.default.UserPrivacyProtocol(),
            isNotMarginBottom: true,
          });
        },
      },
            ...
            function (l) {
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    l.next = 2;
                    return regeneratorRuntime.default.awrap(module419.GetStorageKey(module419.StorageKeys.RobotSerialNumber));
                  ...
                  case 6:
                    ...
                    l.next = 14;
                    return regeneratorRuntime.default.awrap(module419.SetStorageKey(module419.StorageKeys.RobotSerialNumber, module5));
