...
var Ee = (function (t) {
  ...
  function j(t, n) {
    ...
    (o = K.call(this, t, n)).checkOnlyShowGeneralObstacle = function () {
      var t, n;
          ...
          for (;;)
            switch ((s.prev = s.next)) {
              ...
              case 2:
                t = s.sent;
                n = null;
                n = !!B.default.isShowGeneralObstacle() && (!!z.DMM.isV1 || !('on' == t));
                o.setState({
                  onlyShowGeneralObstacle: n,
                });
                I.MC.onlyShowGeneralObstacle = n;
          ...
          for (;;)
            switch ((n.prev = n.next)) {
              ...
              case 2:
                ...
                I.MC.showAllFurnitureModel = !('on' != t);
        ...
        function (t) {
          for (;;)
            switch ((t.prev = t.next)) {
              case 0:
                o.setState({
                  showBrushCarpet: I.MC.isShowCarpet,
                });
    ...
    o.shouldSelectType = function (t) {
      return -1 != P.RSM.currentMapId || t != Be.AR || (globals.showToast(de.switch_ar_map_when_map_unsaved_tip), !1);
    };
        ...
        function (u) {
          for (;;)
            switch ((u.prev = u.next)) {
              case 0:
                if (((0, V.LogEventCommon)('tap_map_switcher_' + t), t != Be.AR)) {
                  u.next = 14;
                  break;
                }
              ...
              case 10:
                if (o.lastMapType != Be.AR) {
                  u.next = 14;
                  break;
                }

                o.props.navigation.navigate('MapARScanResultPage', {
                  title: ' ',
                ...
                null == (s = o.mapTypeSwitcher) || s.hide();
                return u.abrupt('return');
    ...
    o._onPressMapTypeButton = function () {
      var t;
      null == (t = o.mapTypeSwitcher) || t.show();
    };
    ...
    o._onPressSmartZoneBubble = function (t, n) {
      var s = E.SmartBubbleConfig[n].pageType,
        u = E.SmartBubbleConfig[n].pageTitle,
        l = !t || !t.custom;
      t &&
        s &&
        o.navigateTo('MapAICheckPage', {
          title: u,
          pageType: s,
          initParams: {
            zoneData: t,
    ...
    o.aiReminderOpacity = new Se.Value(1);
    o.state = {
      error: 0,
      currentReminder: '',
      topTip: '',
      ...
      cleanArea: b.default.getAreaUnitValue(P.RSM.cleanArea),
  ...
  (0, p.default)(j, [
        ...
        return v.default.createElement(q.default, {
          ...
          onPress: function () {
            t.privacyDialogVisible ||
              ...
              (0, V.LogEventStat)(V.LogEventMap.TapSettingButton),
    ...
    },
    {
      ...
      value: function () {
        ...
        return v.default.createElement(G.PureImageButton, {
          onPress: function () {
      ...
      value: function () {
        ...
        this.robotStatusListener = me.addListener(R.NotificationKeys.RobotStatusDidUpdate, function (o) {
          ...
          t.checkShouldShowProhibitedBehaviorsGuide(function () {
            ...
            t.checkShouldShowOfflineMapGuide();
        ...
        _e.isMiApp
          ? ((this.deviceNameChangedListener = _e.DeviceEvent.deviceNameChanged.addListener(function (n) {
              t.props.navigation.setParams({
                title: _e.Device.name,
              });
              _e.deviceName = _e.Device.name;
            })),
            (this.mapDiffListener = me.addListener(R.NotificationKeys.MapDynamicDiffInfoChange, function (n) {
              t.setState({
                mapDiffInfo: k.MM.diffInfo,
              });
            })))
          : (this.deviceNameChangedListener = me.addListener(_e.deviceNameChangedEvent, function (n) {
              _e.deviceName = n.newName;
              t.props.navigation.setParams({
                title: n.newName,
              });
      ...
      value: function () {
        ...
        if (!b.default.isShareUser()) {
          ...
          var s = setInterval(function () {
            ...
            _e.isMiApp
              ? _e
                  .getFirmwareUpgradingInfo(_e.deviceId, _e.isMiApp ? _e.Device.type : '')
                  .then(function (n) {
        ...
        return l.default.async(
          function (u) {
            for (;;)
              switch ((u.prev = u.next)) {
                case 0:
                  if (!(!_e.isMiApp && P.RSM.isChargingOnDock() && P.RSM.battery >= 20) || b.default.isShareUser()) {
                    u.next = 15;
                    break;
                  }

                  u.next = 3;
                  return l.default.awrap(_e.getFirmwareVersion());

                case 3:
                  t = u.sent;
                  u.next = 6;
                  return l.default.awrap(_e.getValue('firmwareLastVersion1'));

                case 6:
                  if (((n = u.sent), (o = t.lastVersion), !((1 == _e.iotType || o != n) && De))) {
                    u.next = 15;
                    break;
                  }
                  ...
                  De = !1;
                  u.next = 13;
                  return l.default.awrap(_e.setValue('firmwareLastVersion1', o));
    ...
    },
    {
      ...
      value: function () {
        ...
        B.default.isFwFilterObstacleSupported() && C.default.mapObjectPhotoEnabled
          ? this.setState({
            ...
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  ...
                  n.next = 7;
                  return l.default.awrap(this.checkAIReminderStatus());
    ...
    },
    {
      ...
      value: function () {
        ...
        (0, V.LogEventStat)(V.LogEventMap.MapOnReady);
        B.default.isAnalysisSupported() && (0, V.PluginDidReadyForStatisticsTask)();
      },
    },
    {
      ...
      value: function (t) {
        ...
        t && this.changeMapType(Be.NORMAL);
      },
    },
    {
      key: 'changeMapType',
    ...
    },
    {
      ...
      value: function (t) {
        var n = t.data;
        (ke()[n] || !1) && this.eventToast && this.eventToast.show(n);
      },
    },
    {
      key: 'getErrorView',
      ...
      value: function () {
        ...
        return this.state.hasGotMap
          ? v.default.createElement(D.default, {
              ...
              showCount: 2,
              isModalAllowed: B.default.isActivityCN0919Supported(),
    ...
    },
    {
      ...
      value: function () {
        var t = this,
          n = be.SuppliesUpgradeTip()[this.state.suppliesUpgradeTipKey];
        return void 0 != n
          ? v.default.createElement(D.default, {
              content: n,
              isArrowStyle: !0,
    ...
    },
    {
      ...
      value: function () {
                  ...
                  for (;;)
                    switch ((c.prev = c.next)) {
                      ...
                      case 3:
                        if (
                          ((s = !!c.sent),
                          (u = parseInt(I.MC.photoPrivacyVersionAgreedOnServer) == xe.RRPhotoPrivacyVersion),
                          !n || 0 != s || -1 != I.MC.photoPrivacyVersionAgreedOnServer)
                        ) {
                          c.next = 12;
                          break;
                        }
                      ...
                      case 8:
                        (u = parseInt(I.MC.photoPrivacyVersionAgreedOnServer) == xe.RRPhotoPrivacyVersion)
                          ? ((0, V.LogEventCommon)('tap_map_object'), t && t())
                          : o.photoPrivacyDialog && o.photoPrivacyDialog.show();
                        c.next = 13;
                        break;

                      case 12:
                        n && 0 == s && !u ? o.photoPrivacyDialog && o.photoPrivacyDialog.show() : ((0, V.LogEventCommon)('tap_map_object'), t && t());
        ...
        if (P.RSM.isOnDock() && k.MM.parsedMapData && k.MM.parsedMapData.robot && k.MM.parsedMapData.charger) {
          ...
          var w = M + z.DMM.robotInMap.chargerAngle + _,
            b = {
        ...
        var y = k.MM.mapRotateAngle[P.RSM.currentMapId] || 0,
          x = v.default.createElement(ae.default, {
            style: {
              flex: 1,
              justifyContent: 'center',
              alignSelf: 'stretch',
        ...
        if (this.state.inQuickBuildMap && P.RSM.mapStatus == P.MapStatus.None) return D;

        if (this.state.hasGotMap && !this.state.isLocating) {
          if (this.state.shouldShowNoMapTipView) return N;
          var L = c;
          this.state.mapType == Be.AR && this.state.arMapMatchParam ? (L = h) : this.state.mapType == Be.THREE && (L = x);
          return L;
        }
    ...
    },
    {
      ...
      value: function () {
        ...
        return v.default.createElement(N.default, {
          ...
          mode: N.ModalMapEditMenuMode.Home,
    ...
    },
    {
      ...
      value: function () {
        ...
        return n
          ? v.default.createElement(G.PureImageButton, {
              image: t.videoIcon,
              imageWidth: 60,
              imageHeight: 60,
              enabled: o,
              style: Ae.videoButton,
        ...
        return v.default.createElement(
            ...
            v.default.createElement(
              ...
              v.default.createElement(
                ...
                (0, s.default)(
                  ...
                  b.default.getAccessibilityLabel('home_map_type', de.map_element_switcher_title),
                  {
          ...
          v.default.createElement(
            ...
            (0, s.default)(
              ...
              b.default.getAccessibilityLabel('home_more', de.smart_scene_more),
              {
    ...
    },
    {
      ...
      value: function () {
        ...
        var t = this.context.theme.homeSidebar,
          n = v.default.createElement(G.PureImageButton, {
            ...
            style: Ae.debugButton,
            onPress: this.onPressDebugButton.bind(this),
          });
        return z.DMM.isV2 || z.DMM.isV4 || z.DMM.isV5 || B.default.isDebuggableV1User() ? n : null;
      },
    },
    {
    ...
    },
    {
      ...
      value: function () {
        ...
        return v.default.createElement(L.MonitorPrivacyDialogWithNavbar, {
          ...
          onConfirm: function () {
            (0, V.LogEventCommon)('monitor_privacy_dialog_confirm');
          ...
          onCancel: function () {
            (0, V.LogEventCommon)('monitor_privacy_dialog_cancel');
          },
        ...
        return v.default.createElement(W.PhotoFeaturePrivacyDialog, {
          ...
          onConfirm: function () {
            return C.default.updatePhotoPrivacy(!0, function (n) {
              ...
              _e.postPrivacyAgreementStatusWithVersion(P.RSM.serverCode, 4, xe.RRPhotoPrivacyVersion || 1)
                .then(function (t) {})
                .catch(function (t) {});
            });
          },
          onCancel: function () {
            ...
            _e.postPrivacyAgreementStatusWithVersion(P.RSM.serverCode, 5, xe.RRPhotoPrivacyVersion || 1)
              .then(function (t) {})
              .catch(function (t) {});
    ...
    },
    {
      ...
      value: function () {
        ...
        return v.default.createElement(G.ActionSheetView, {
          ref: function (n) {
    ...
    {
      key: 'getAIZonesGuideView',
      value: function () {
        return this.state.showAIReminder
          ? v.default.createElement(
              Se.View,
              {
                style: [
                  Ae.AIZoneGuide,
                  {
                    opacity: this.aiReminderOpacity,
                  },
                ],
              },
              v.default.createElement(ve, {
                style: Ae.AIZoneGuideImg,
                source: require(d[66]),
              }),
              v.default.createElement(
                fe,
                {
                  style: Ae.AIZoneGuideRight,
                },
                v.default.createElement(
                  ge,
                  {
                    style: Ae.AIZoneGuideTxt,
                    numberOfLines: 2,
                  },
                  this.state.AIReminderText
                )
              )
            )
          : null;
    ...
    },
    {
      ...
      value: function () {
        ...
        var n = this.context.theme,
          ...
          s = o.width,
          u = o.height,
          l = _e.isWindowDisplay ? re.titleBarContentHeight + 14 : re.titleBarContentHeight + we.StatusBarHeight + we.AppBarMarginTop,
          c = b.default.iOSAndroidReturn(l, re.titleBarHeight);
        return v.default.createElement(
          v.default.Fragment,
          null,
          v.default.createElement(fe, {
          ...
          v.default.createElement(
            fe,
            {
              style: [
                {
                  backgroundColor: n.pageBackgroundColor,
                  height: I.default.sharedCache().ScreenHeight,
                  top: -c,
                },
              ],
            },
            v.default.createElement(
              ...
              v.default.createElement(G.AlertView, {
                ref: function (n) {
                  return (t.alert = n);
                },
                isModal: !0,
              ...
              v.default.createElement(G.CancelableLoadingView, {
          ...
          function (c) {
            for (;;)
              switch ((c.prev = c.next)) {
                ...
                case 2:
                  if (((this.tabIndex = t), (n = t == H.TabGlobal), (o = t == H.TabNeutral), n || o || this.state.mapType == Be.NORMAL)) {
                    c.next = 8;
                    break;
                  }

                  c.next = 8;
                  return l.default.awrap(this.changeMapType(Be.NORMAL));
                ...
                case 11:
                  ...
                  c.next = 15;
                  return l.default.awrap(y.default.setCustomMopById(null == (s = Q.ModeDataInstance.modePannelCustomMops[0]) ? void 0 : s.id));
            ...
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  n.prev = 0;
                  n.next = 3;
                  return l.default.awrap(_e.postPrivacyAgreementStatus(P.RSM.serverCode, 2));
          ...
          function (p) {
            for (;;)
              switch ((p.prev = p.next)) {
                case 0:
                  if (!((z.DMM.isTanosV && _e.apiLevel < 10005) || ((z.DMM.isTopazSV || z.DMM.isTanosSV) && _e.apiLevel < 10010))) {
                    p.next = 3;
                    break;
                  }
                ...
                case 3:
                  ...
                  this.alert &&
                    this.alert.customAlert(
                      ...
                      function () {
                        (0, V.LogEventCommon)('open_real_time_video_alert_confirm');
                        c.navigateTo('CameraSettingDetail');
                      },
                      function () {
                        (0, V.LogEventCommon)('open_real_time_video_alert_cancel');
                      },
                      {
                ...
                case 6:
                  -1 == parseInt(I.MC.MonitorPrivacyVersionAgreedOnServer) && this.getMonitorPrivacyVersionAgreedVersionOnServer();
                  t = parseInt(I.MC.MonitorPrivacyVersionAgreedOnServer) == xe.RRMonitorPrivacyVersion;
                  p.next = 10;
    ...
    },
    {
      ...
      value: function () {
        ...
        if (P.RSM.state != P.RobotState.UPDATING && !C.default.hasShownPetModeAlert && B.default.isPetModeSettingSupported() && !this.hasCheckedPetAlert && !P.RSM.isRunning) {
    ...
    },
    {
      ...
      value: function (t, n) {
        ...
        (0, V.LogEventCommon)('tap_map_object_bubble', {
          photoEnabled: s,
        });
      ...
      value: function () {
        B.default.groundOnlySupportFloor()
          ...
          ? this.navigateTo('MapEditCarpetPage', {
              action: B.default.isMapCarpetAddSupport() ? P.CarpetEditMode.CarpetIgnore | P.CarpetEditMode.CarpetAdd : P.CarpetEditMode.CarpetIgnore,
    ...
    },
    {
      ...
      value: function (t) {
        ...
        B.default.isCarpetSupported() && !z.DMM.isGarnet
          ? (null == (o = this.quickCreateMapGuide) || o.startLoading(),
            y.default
              .getCarpetCleanMode()
              .then(function (t) {
                if (t.result[0].carpet_clean_mode == be.CarPetCleanModeSettingMap.CarPetCleanModeAllForbidden) {
                  var o = {
                      text: de.localization_strings_Main_MainPage_11,
                    },
                    u = {
          ...
          function (n) {
            for (;;)
              switch ((n.prev = n.next)) {
                ...
                case 2:
                  n.next = 4;
                  return l.default.awrap((0, R.GetStorageKey)(R.StorageKeys.BuildMapFinishGuide));
                ...
                case 4:
                  ...
                  n.next = 10;
                  return l.default.awrap((0, R.SetStorageKey)(R.StorageKeys.BuildMapFinishGuide, 'true'));
          ...
          function (s) {
            for (;;)
              switch ((s.prev = s.next)) {
                ...
                case 13:
                  n = J.default.sharedManager().dockSetSNPrefixes;
            ...
            for (;;)
              switch ((n.prev = n.next)) {
                ...
                case 2:
                  ...
                  n.next = 5;
                  return l.default.awrap((0, R.GetStorageKey)(R.StorageKeys.OfflineMapGuide));
                ...
                case 5:
                  ...
                  n.next = 10;
                  return l.default.awrap((0, R.SetStorageKey)(R.StorageKeys.OfflineMapGuide, 'true'));
          ...
          function (n) {
            for (;;)
              switch ((n.prev = n.next)) {
                ...
                case 2:
                  t = n.sent;
                  I.default.sharedCache().areaUnitIndex = t || 0;
                  this.setState({
                    areaUnit: b.default.getAreaUnit(),
                  });
            ...
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  n.prev = 0;
                  n.next = 3;
                  return l.default.awrap(_e.saveDeviceExtraValue('RRMonitorPrivacyVersion', xe.RRMonitorPrivacyVersion.toString()));
            ...
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  n.prev = 0;
                  n.next = 3;
                  return l.default.awrap(_e.getDeviceExtraInfoForKey('RRMonitorPrivacyVersion'));

                case 3:
                  t = n.sent;
                  console.log('getMonitorPrivacyVersionAgreedVersionOnServer - ' + t);
                  I.MC.MonitorPrivacyVersionAgreedOnServer = t.RRMonitorPrivacyVersion;
                  n.next = 10;
                  break;
            ...
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  n.prev = 0;
                  n.next = 3;
                  return l.default.awrap(_e.saveDeviceExtraValue('RRPhotoPrivacyVersion', xe.RRPhotoPrivacyVersion.toString()));
            ...
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  n.prev = 0;
                  n.next = 3;
                  return l.default.awrap(_e.getDeviceExtraInfoForKey('RRPhotoPrivacyVersion'));

                case 3:
                  t = n.sent;
                  console.log('getPhotoPrivacyVersionAgreedVersionOnServer - ' + t);
                  I.MC.photoPrivacyVersionAgreedOnServer = t.RRPhotoPrivacyVersion;
                  n.next = 10;
                  break;
              ...
              switch ((n.prev = n.next)) {
                ...
                case 2:
                  (t = n.sent)
                    ...
                    : this.lastMapType == Be.AR && this.changeMapType(Be.NORMAL);
              ...
              switch ((M.prev = M.next)) {
                ...
                case 17:
                  ...
                  (null == (n = c.hide) ? void 0 : n.length) > 0 &&
                    (((null == (f = c.hide) ? void 0 : f.length) == c.num && 0 == h.length) || I.MC.showAllFurnitureModel) &&
            ...
            for (;;)
              switch ((M.prev = M.next)) {
                ...
                case 5:
                  ...
                  M.next = 8;
                  return l.default.awrap(this.dealShowAIGuide(E.SmartBubbleType.BT_CLIFF));
                ...
                case 10:
                  if (
                    !(B.default.isSupportSmartDoorSill() && (null == (s = k.MM.mapData) ? void 0 : null == (u = s.smartds) ? void 0 : null == (c = u.fbzs) ? void 0 : c.length) > 0)
                  ) {
                    M.next = 15;
                    break;
                  }
                  ...
                  M.next = 13;
                  return l.default.awrap(this.dealShowAIGuide(E.SmartBubbleType.BT_DOORSILL));
                ...
                case 15:
                  if (
                    !(B.default.isSupportStuckZone() && (null == (p = k.MM.mapData) ? void 0 : null == (h = p.stuckpts) ? void 0 : null == (f = h.data) ? void 0 : f.length) > 0)
                  ) {
                    M.next = 20;
                    break;
                  }
                  ...
                  M.next = 18;
                  return l.default.awrap(this.dealShowAIGuide(E.SmartBubbleType.BT_STUCK));
          ...
          function (u) {
            for (;;)
              switch ((u.prev = u.next)) {
                case 0:
                  u.next = 2;
                  return l.default.awrap((0, R.GetStorageKey)(R.StorageKeys.AIZonesGuideMain));

                case 2:
                  if ((n = u.sent) && 0 != (parseInt(n) & t)) {
                    u.next = 10;
                    break;
                  }

                  (s = E.SmartBubbleConfig[t].guideTxt) && this.showAIReminderView(s);
                  null == (o = this.mapView) || o.findSmartBubbleShowGuide(t);
                  u.next = 9;
                  return l.default.awrap((0, R.SetStorageKey)(R.StorageKeys.AIZonesGuideMain, n ? (parseInt(n) | t).toString() : t.toString()));
    ...
    },
    {
      ...
      value: function (t) {
        ...
        this.AIReminderTimer && Re.clearTimeout(this.AIReminderTimer);
        this.AIReminderTimer = Re.setTimeout(this.hideAIReminderView.bind(this), 5e3);
      },
    },
    {
      key: 'hideAIReminderView',
      value: function () {
        var t = this;
        this.AIReminderTimer && Re.clearTimeout(this.AIReminderTimer);
        this.state.showAIReminder &&
          Se.timing(this.aiReminderOpacity, {
            toValue: 0,
            duration: 200,
          }).start(function () {
            t.setState({
    ...
    },
    {
      ...
      value: function () {
        Ie = B.default.isSharedAllowed() && 'cn' == P.RSM.serverCode;
        Ve = Ie ? 1 : 0;
      },
    },
    {
...
exports.default = Ee;
Ee.contextType = j.AppConfigContext;
var Ae = he.create({
  container: {
    flex: 1,
  ...
  topTipView: {
    alignSelf: 'center',
    marginTop: we.NavigationBarHeight,
    alignItems: 'center',
    justifyContent: 'center',
    height: 40,
  ...
  debugButton: {
    position: 'absolute',
    top: 216 + (K.StatusBar.currentHeight || 0) + we.AppBarMarginTop,
    left: 15,
  },
  videoButton: {
    position: 'absolute',
    top: 245 + (K.StatusBar.currentHeight || 0) + we.AppBarMarginTop,
    right: 10,
    width: 60,
    height: 60,
  },
  ...
  mapEditMenu: {
    position: 'absolute',
    top: 150 + (K.StatusBar.currentHeight || 0) + we.AppBarMarginTop,
    right: 20,
    width: 40,
    height: 92,
  },
  ...
  AIZoneGuideImg: {
    height: 33,
    width: 36,
    marginRight: globals.isRTL ? 0 : 6,
    marginLeft: globals.isRTL ? 6 : 0,
  },
  AIZoneGuideRight: {
    backgroundColor: 'white',
  ...
  mapDiffText: {
    position: 'absolute',
    top: 160 + (K.StatusBar.currentHeight || 0) + we.AppBarMarginTop,
    left: 30,
    height: 30,
    width: 300,
    fontSize: 15,
