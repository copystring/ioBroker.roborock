    ...
    module5.default(E, [
      {
        ...
        value: function () {
          ...
          if (!(null == this || null == (t = this.props) || null == (o = t.navigation) || null == (n = o.state) || null == (s = n.params) || null == (c = s.settingPanel)))
            c.addBackListener();
          module1543.ModeDataInstance.getCustomMopList();
        },
      },
      {
              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  ...
                  case 4:
                    o = [];
                    s = [];
                    c = module1541.getSystemCustomMopModes();
                    module1543.ModeDataInstance.customMopModeListData.forEach(function (n, l) {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (
            !t &&
            module1543.ModeDataInstance.customMopModeListData.filter(function (t) {
              return !t.sys_type;
            }).length >= 5
          )
