          ...
          return [
            {
              ...
              bottomDetail: module505.robot_setting_air_dry_desc,
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    n.prev = 0;
                    n.next = 3;
                    return regeneratorRuntime.default.awrap(module415.default.getFanMotorWorkTimeout());
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    c.next = 5;
                    return regeneratorRuntime.default.awrap(module415.default.setFanMotorWorkTimeout(t ? n : 0));

                  case 5:
                    s = c.sent;
                    if (module381.RSM.isAirDrying && !t) globals.showToast(module505.setting_air_dry_close_prompt);
                ...
                switch ((o.prev = o.next)) {
                  case 0:
                    if (!(null == (t = globals.Alert)))
                      t.alert(module505.setting_stop_air_dry_desc, '', [
                        {
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    n.prev = 0;
                    n.next = 3;
                    return regeneratorRuntime.default.awrap(module415.default.stopAirdryMop());
...
exports.default = module2040;
module2040.contextType = module1121.AppConfigContext;
