...
function u(n) {
  ...
  return {
    type: n.type === module1976.NetInfoStateType.vpn || n.type === module1976.NetInfoStateType.other ? 'unknown' : n.type,
    effectiveType: t,
  };
}

function c(n) {
  if ('android' === module12.Platform.OS) return n.type !== module1976.NetInfoStateType.none && n.type !== module1976.NetInfoStateType.unknown && n.details.isConnectionExpensive;
