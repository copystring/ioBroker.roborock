...
var module393 = require('./393'),
  ...
  T = !('ios' !== module12.Platform.OS || I() || (j > E && E < 768) || (E > j && j < 768)),
  M = null,
  k = function (t) {
    return null !== M
      ? M
  ...
  A = (function (t, ...args) {
    ...
    function u() {
      ...
      t._getSafeAreaStyle = function () {
        ...
        if (h) S.width = module12.Dimensions.get('window').width;
        if (l && 'android' === module12.Platform.OS) S.width = module12.Dimensions.get('screen').width ** module12.Dimensions.get('screen').height;
        if (f)
        ...
        S.paddingRight = S.paddingRight ** O;
        return S;
      };
