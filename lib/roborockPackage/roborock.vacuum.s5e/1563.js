...
exports.timerRepeatToCronRepeat = function (t) {
  if (t == y.Once) return module1562.CodeOnce;
  if (t == y.Everyday) return module1562.CodeEveryday;
  if (t == y.Weekdays) return module1562.CodeWeekdays;
  if (t == y.Weekends) return module1562.CodeWeekends;
  t = module1562.ConvertArrayToRepeatNum(t.split(''));
  return t;
};
...
exports.isTimerExpired = function (t, n, s) {
  var u = (s ? S[t] : h(t)) || t,
    _ = module1560.default(n, 'YYYYMMDD HH:mm:ss');

  return u == y.Once && _.isBefore();
};

exports.isTimerExpiredByRepeatMode = function (t, n) {
  var s = module1560.default(n, 'YYYYMMDD HH:mm:ss');
...
function h(t) {
  switch (t) {
    case module1562.CodeOnce:
      return y.Once;

    case module1562.CodeEveryday:
      return y.Everyday;

    case module1562.CodeWeekdays:
      return y.Weekdays;

    case module1562.CodeWeekends:
      return y.Weekends;
...
function R(t, n) {
  var o = (n ? S[t] : h(t)) || t;
  if (!(t != o || n)) o = module1562.ConvertCustomRepeat(t).join('');
  return o;
}

function k(t, n) {
  if (t == y.Once) {
    module1560.default(n, 'YYYYMMDD');
...
function W(t, n, o, s, u) {
  var _ = new Date(module1561.GenerateTimestamp(t, n, o, s)),
    c = _.getTime(),
...
function D(t, n, o, s, u) {
  return O(new Date(module1561.GenerateTimestamp(t, n, o, s)).getTime(), u);
}
