    ...
    module5.default(N, [
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    c.prev = 2;
                    if (!(module1559.TLM.resultTimerList && 0 != module1559.TLM.resultTimerList.length)) t = true;
                    c.next = 6;
                    return regeneratorRuntime.default.awrap(module1559.TLM.fetchTimerList(t));

                  case 6:
                    if (module1559.TLM.resultTimerList || !(this.retryTime < 7)) {
                      c.next = 9;
                      break;
                    }
                  ...
                  case 9:
                    l = null != (n = module1559.TLM.resultTimerList) ? n : [];
                    console.log('fetchTimerList ' + module1559.TLM.resultTimerList);
                    this.finishLoading();
                    this.retryTime = 0;
                    this.setState({
                      loading: false,
                  ...
                  for (;;)
                    switch ((l.prev = l.next)) {
                      case 0:
                        l.prev = 0;
                        l.next = 3;
                        return regeneratorRuntime.default.awrap(module1559.TLM.fetchTimerList(true));

                      case 3:
                        s = null != (n = module1559.TLM.resultTimerList) ? n : [];
                        t.finishLoading();
                        t.setState({
                          loading: false,
                          refreshing: false,
            ...
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    s.next = 2;
                    return regeneratorRuntime.default.awrap(module1559.TLM.deleteServerTimer(t));
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    c.prev = 0;
                    c.next = 3;
                    return regeneratorRuntime.default.awrap(module1559.TLM.deleteRobotTimer(t));
                  ...
                  case 3:
                    ...
                    c.next = 9;
                    return regeneratorRuntime.default.awrap(module1559.TLM.fetchTimerList(false));

                  case 9:
                    u = null != (s = module1559.TLM.resultTimerList) ? s : [];
      ...
      },
      {
        ...
        value: function (t, n, o) {
          var s = this;
          if (0 == Object.keys(n).length && (module1559.TLM.totalTimerCount >= 10 || this.state.timerlist.length >= 10))
      ...
      },
      {
        ...
        value: function (t, n) {
          ...
          if (1 == n)
            ...
            this.openSettingPage(true, s, module393.isMiApp && 1 == this.FCCState ? module1559.TLM.miTimerScenes[t] : 0);
          }
        },
      },
      {
          ...
          this.alert.alert(module505.localization_strings_Setting_Timer_index_13, '', [
            ...
            },
            {
              ...
              onPress: function () {
                var s;
                if (1 == n)
                  module1884.SmartSceneAPI.editTriggers(null == (s = o.state.smartSceneTimerlist[t]) ? undefined : s.id, [])
                    .then(function (t) {
                      var n, s;
                      o.fetchSmartSceneTimers();
              ...
              for (;;)
                switch ((h.prev = h.next)) {
                  case 0:
                    ...
                    h.next = 9;
                    return regeneratorRuntime.default.awrap(module1884.SmartSceneAPI.editTriggers(null == (u = this.state.smartSceneTimerlist[t]) ? undefined : u.id, [module9]));
                  ...
                  case 11:
                    h.next = 13;
                    return regeneratorRuntime.default.awrap(module1559.TLM.updateTimerOnStatus(t, l, s));
        ...
        value: function (t, o, s) {
          if (1 == o) {
            var l = this.state.smartSceneTimerlist.map(function (t) {
              return module22.default(new module1885.CommandCardData(), t);
            });
        ...
        value: function (t, n) {
          ...
          if (
            (o = s
              ...
              ? t.waterMode == module1541.WaterModeZero
                ? module505.robot_clean_status_only_clean
                : t.mode == module1541.CleanModeZero
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (
            ...
            if (((o = module1542.getCleanMethods()[t.cleanMethod]), (l = t.mopModeName), t.cleanMethod == module1542.CleanMethodClean)) return o + ' | ' + n;
            if (t.cleanMethod == module1542.CleanMethodMop) return o + ' | ' + l;
            if (t.cleanMethod == module1542.CleanMethodCleanAndMop) return o + ' | ' + n + ' | ' + l;
          }
...
exports.default = module1893;
module1893.contextType = module1121.AppConfigContext;
