  ...
  N = (function (t) {
    ...
    function F(t) {
      ...
      n.mapCarpetFocus = function (t, o) {
        n.editAction = o ? module1120.EditAction.Ignore : module1120.EditAction.AddCarpet;
        n.setState(
          o
            ? {
        ...
        n.setState(
          ...
          function () {
            ...
            if (!(null == (u = n.editMenu)))
              u.setState({
                tip: module505.map_edit_carpet_init_tip,
              });
            if (!t) n.endLoading();
            if (t) t();
          }
          ...
          function (o) {
            for (;;)
              switch ((o.prev = o.next)) {
                case 0:
                  if (null == (t = n.mapView) ? undefined : t.isCarpetReachMaxNum(true)) globals.showToast(module505.map_edit_carpet_zone_exceed_limit);
    ...
    module5.default(F, [
      ...
      },
      {
        key: 'configNavibar',
        value: function () {
          module1271.default.setNavigation(this, null, this.onNavigationBackPress.bind(this));
        },
      },
      {
        key: 'initMapView',
      ...
      },
      {
        ...
        value: function () {
          ...
          this.mapEditDidChange = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.MapEditDidChange, function (n) {
            if (!(n.data != module1057.FbzType.FBZ_TYPE_CARPET && n.data != module1057.FbzType.RECT_TYPE_CARPET))
              t.setState({
                ignoreCarpetEdited: n.data == module1057.FbzType.FBZ_TYPE_CARPET,
                cusCarpetEdited: n.data == module1057.FbzType.RECT_TYPE_CARPET,
              });
          });
        },
      },
      ...
      },
      {
        ...
        value: function (t) {
          var n, o, s;
          if (t && (null == (n = this.mapView) ? undefined : n.isCustomCarpetOverlap())) globals.showToast(module505.map_edit_carpet_overlap_tip);
          else if (t && (null == (o = this.mapView) ? undefined : o.isCustomCarpetRectUnknown())) globals.showToast(module505.map_edit_carpet_unknown_tip);
          else {
      ...
      },
      {
        ...
        value: function (t, n) {
          var o,
            s,
            u = this;
          if (t && (null == (o = this.mapView) ? undefined : o.isIgnoreCarpetOverlap())) globals.showToast(module505.map_edit_carpet_overlap_tip);
          else {
            ...
            if ((null == p && (p = []), t && !n)) this.saveChangedParams(p);
              ...
              var c,
                l = t ? module505.map_edit_carpet_ignore_confirm_ignore : module505.map_edit_carpet_ignore_confirm_cancel,
                f = {
              ...
              if (!(null == (c = globals.Alert))) c.alert(l, '', [f, h]);
            }
          }
        },
      },
      {
        ...
        value: function (t) {
          ...
          if (module390.default.isMultiFloorSupported())
            this.state.mapStatus != module381.MapStatus.None && module414.MM.maps.length >= 1 && -1 == n
              ? globals.showToast(module505.no_map_status_description)
              : 1 == module414.MM.maps.length && 1 == module414.MM.mapCountMax
              ? ((n = module414.MM.maps[0].id), this.startMapSave(n, t))
      ...
      },
      {
        ...
        value: function (t, n) {
          ...
          if (this.editAction == module1120.EditAction.Ignore)
            module1340.setTimeout(function () {
              return module414.MM.saveCarpetIgnoreZone(t, n, o.onMapSaveCompleted.bind(o));
            }, 500);
          else if (this.editAction == module1120.EditAction.AddCarpet)
            module1340.setTimeout(function () {
              return module414.MM.saveCarpetAddedZone(t, 1, n, o.onMapSaveCompleted.bind(o));
            }, 500);
        },
      },
      {
          ...
          return regeneratorRuntime.default.async(
            function (o) {
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    this.editAction = module1120.EditAction.AddCarpet;
      ...
      },
      {
        ...
        value: function (t, n) {
          ...
          s = t
            ? n
              ? module505.map_edit_carpet_ignore_tip
              : module505.map_edit_carpet_ignore_edit_tip
            : n
            ? module505.map_edit_carpet_add_tip
            : module505.map_edit_carpet_add_edit_tip;
        ...
        value: function () {
          var t = this,
            n = React.default.createElement(module1056.MapView, {
              ...
              mapMode: module1265.MAP_MODE_CARPET_EDIT,
            ...
            o = React.default.createElement(module1315.default, {
              tip: module505.no_map_tip,
            });
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module1120.default, {
            type: module1120.MenuType.Menu_Carpet,
...
exports.default = N;
N.contextType = module1121.AppConfigContext;
