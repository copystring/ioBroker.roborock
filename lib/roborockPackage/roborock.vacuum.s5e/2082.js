...
var module505 = require('./505').strings,
  module2083 = (function (t) {
    ...
    function T(t) {
      ...
      (n = module2085.call(this, t)).state = {};
      return n;
    }
    ...
    module5.default(T, [
      ...
      },
      {
        ...
        value: function () {
          return module381.RSM.isCleaning() ? require('./2083') : require('./2084');
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          return module381.RSM.state == module381.RobotState.BACK_TO_DOCK ? require('./2083') : require('./2085');
        },
      },
      {
        key: 'render',
