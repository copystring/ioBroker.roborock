...
var module505 = require('./505').strings,
  ...
  K = (function (t) {
    ...
    function K(t) {
      ...
      s.originalRepeatMode = u.repeatMode || module1563.RepeatMode.Once;
      ...
      s.state = {
        ...
        repeatMode: u.repeatMode || module1563.RepeatMode.Once,
        ...
        mopModeName: s.editMode ? u.mopModeName : null == (n = module1543.ModeDataInstance.modePannelCustomMops[0]) ? undefined : n.name,
        mopModeId: s.editMode ? u.mopModeId : null == (o = module1543.ModeDataInstance.modePannelCustomMops[0]) ? undefined : o.id,
        currentCleanMethod: undefined == u.cleanMethod ? module1542.CleanMethodMop : u.cleanMethod,
    ...
    module5.default(K, [
        ...
        value: function () {
          ...
          this.modeChangeHandler = function () {
            ...
            if (
              !(
                -1 !=
                module1543.ModeDataInstance.modePannelCustomMops.findIndex(function (n) {
                  return n.id == t.setState.mopModeId;
                })
              )
            )
              t.setState({
                mopModeId: null == (n = module1543.ModeDataInstance.modePannelCustomMops[0]) ? undefined : n.id,
                mopModeName: null == (o = module1543.ModeDataInstance.modePannelCustomMops[0]) ? undefined : o.name,
              });
          };

          module1543.ModeDataInstance.addChangeListener(this.modeChangeHandler);
        },
      },
      {
        ...
        value: function () {
          ...
          module414.MM.stop();
          module1543.ModeDataInstance.removeChangeListener(this.modeChangeHandler);
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          if (this.state.currentCleanMethod == module1542.CleanMethodClean && 301 == o) o = 300;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (4 == t) {
            ...
            this.hideModalView(function () {
              n.setState({
                repeatMode: module1563.IndexRepeatMap[t],
                shouldShowFrequenceView: false,
              });
            });
        },
      ...
      },
      {
        ...
        value: function () {
          ...
          if (this.state.hasSetTime) {
            var n = module1563.timerRepeatToCronRepeat(this.state.repeatMode),
              s = -1,
              l = -1;

            if (this.state.repeatMode == module1563.RepeatMode.Once) {
              var u = new Date(),
                h = u.getHours() == this.state.hour && u.getMinutes() == this.state.minute,
                c = module1560.default();
            ...
            if (this.isRepeatTimer(l, s)) globals.showToast(module505.set_timer_dup);
              ...
              var M = module1562.ConvertToCronStr(this.state.hour, this.state.minute, n, l, s);

              if (module393.isMiApp && 1 == this.FCCState) {
                var S = module1563.convertToBeijingTime(this.state.minute, this.state.hour, l, s),
                  w = this.state.repeatMode;

                if (this.state.repeatMode != module1563.RepeatMode.Once && this.state.repeatMode != module1563.RepeatMode.Everyday) {
                  var _ = new Date();

                  if (S.month == _.getMonth() + 1)
                    S.day == _.getDate() + 1
                      ? (w = module1563.getDaysArrByOffset(this.state.repeatMode, 1))
                      : S.day == _.getDate() - 1 && (w = module1563.getDaysArrByOffset(this.state.repeatMode, -1));
                  else w = 1 == S.day ? module1563.getDaysArrByOffset(this.state.repeatMode, 1) : module1563.getDaysArrByOffset(this.state.repeatMode, -1);
                }

                n = module1563.timerRepeatToCronRepeat(w);
                M = module1562.ConvertToCronStr(S.hour, S.minute, n, S.day, S.month);
              }
      ...
      },
      {
        ...
        value: function (t, n, s, l) {
          var u, h, c, p, f, M, S, w, _, y, module1560, module394, module382, module414, module1889, module1055;
              ...
              for (;;)
                switch ((D.prev = D.next)) {
                  ...
                  case 31:
                    ...
                    module394 = module1563.convertToTargetTime(this.state.minute, this.state.hour, s, l, module393.robotTimeZone);
                    module382 = module394.hour + ':' + module1563.addZeroPrefix(module394.minute);
                    module414 = module1563.getLoopStringOfRepeatMode(this.state.repeatMode);
                    module1889 = new Date();
                    module1055 = module1563.resolveRepeatModeByTargetTime(module414, module1889.getMonth() + 1, module1889.getDate(), module394.month, module394.day);
                    console.log('loops -- time - ' + module382 + ' - loop -' + module1055 + ' -repeat-' + this.state.repeatMode + ' - timerId- ' + this.timerId);
                    D.next = 40;
                    return regeneratorRuntime.default.awrap(module393.rrAddOrEditTimer(module382, module1055, module1560, this.timerId));
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(module385.SettingListItemView, {
                  ...
                  bottomDetail: module1563.getTextOfRepeatMode(this.state.repeatMode, this.date),
              ...
              u &&
                React.default.createElement(module1889.default, {
                  style: Q.mapSegmentSettingView,
                  ref: function (n) {
                    t.mapSegmentSettingView = n;
                  },
      ...
      },
      {
        ...
        value: function () {
          return this.state.currentCleanMethod == module1542.CleanMethodNoSet ? module505.timer_setting_no_setting : module1542.getCleanMethods()[this.state.currentCleanMethod];
        },
      },
      {
        ...
        value: function () {
          ...
          var o = module382.getCleanModeTitle(this.state.mode),
            ...
            l = o + (s ? ' | ' + s : '');
          if (module390.default.isPureCleanMopSupported() && this.state.mode == module1541.CleanModeZero) return s + ' | ' + module382.getMopMethodTitle(this.state.mopMode);
          ...
          if (module390.default.isShakeMopSetSupported() && 200 != this.state.waterMode) {
            ...
            if (t) {
              if (n == module1542.CleanMethodClean) return l;
              if (n == module1542.CleanMethodMop) return u;
              if (n == module1542.CleanMethodCleanAndMop) return l + ' | ' + u;
            }
          }
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = module1563.RepeatIndexMap[this.state.repeatMode];
          if (undefined == n) n = 4;
          return React.default.createElement(
            module12.View,
            {
            ...
            React.default.createElement(module1427.ActionSheetView, {
              title: module505.localization_strings_Setting_Timer_SettingPage_1,
              actions: module1563.RepeatMenuItems(),
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = module1563.isCustomMode(this.state.repeatMode) ? [0, 0, 0, 0, 0, 0, 0] : this.state.repeatMode.split('');
          return React.default.createElement(module1891, {
            selectedItems: n,
            cancel: function (n) {
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module1427.ActionSheetView, {
            title: module505.timer_setting_clean_method,
            actions: module1542.getCleanMethods(),
            didSelectRow: function (n) {
      ...
      },
      {
        ...
        value: function () {
          return this.state.hasSetTime || this.editMode
            ? module1563.addZeroPrefix(this.state.hour) + ' : ' + module1563.addZeroPrefix(this.state.minute)
      ...
      },
      {
        key: 'isRepeatTimer',
        value: function (t, n) {
          for (var o = module1563.convetToWeekendsByStartTime(this.state.repeatMode, t, n), s = 0; s < this.timerList.length; s++) {
            ...
            if (!this.editMode || l.hour != this.originalHour || l.minute != this.originalMinute || JSON.stringify(u) !== JSON.stringify(this.originStartWeekdays)) {
              ...
              if (l.repeatMode == module1563.RepeatMode.Once && l.hour == this.state.hour && l.minute == this.state.minute) return true;
            }
          }
      ...
      },
      {
        ...
        value: function () {
          if (module423.DMM.isGarnet)
            this.state.currentCleanMethod != module1542.CleanMethodNoSet || this.editMode ? this.confirmButton.setEnabled(true) : this.confirmButton.setEnabled(false);
