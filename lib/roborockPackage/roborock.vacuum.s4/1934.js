var module21 = require('./21'),
  ...
  module1937 = x(require('./1937')),
  module1245 = require('./1245'),
  module1801 = require('./1801'),
  module1800 = x(require('./1800')),
...
var module491 = require('./491').strings,
  ...
  module1341 = require('./1341').parseSync,
  ...
  J = (function (t) {
    ...
    function q(t) {
      ...
      (n = x.call(this, t)).dataProvider = module386.default.isMultiFloorSupported() ? new module1801.MultiMapDataProvider() : new module1801.SingleMapDataProvider();
    ...
    module5.default(q, [
        ...
        value: function () {
          ...
          this.multiMapsListener = module12.DeviceEventEmitter.addListener(module411.NotificationKeys.DidReceiveSpecialEvent, function (n) {
            if (n.sender != t) {
              ...
              if (n.data == module411.EventKeys.CurrentMapDidChange) module1231.MM.getMultiMaps();
            }
          });
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this.dataProvider
            ...
            .then(function () {
              return n.dataProvider.manualSegmentMap(module1231.CurrentMapId);
            })
            .then(function () {
              n.setState({
                multiFloorEnabled: t,
                ...
                .then(function (o) {
                  var l =
                    ...
                    p.state.items.map(function (o) {
                      if (o.id == t) o.name = module1245.FloorMapPageUtils.getRealName(n);
                      return o;
                    });
                  p.setState({
                    items: l,
        ...
        value: function (t) {
          ...
          this.dataProvider
            ...
            .then(function (o) {
              ...
              if (n.state.multiFloorFeatureEnabled) module1231.MM.getMultiMaps();
              else {
                module12.DeviceEventEmitter.emit(module411.NotificationKeys.DidReceiveSpecialEvent, {
                  data: module411.EventKeys.MapSegmentsDidChange,
                  sender: n,
        ...
        value: function (t) {
          ...
          o.then(function (o) {
            var l = base64js.toByteArray(o),
              s = module1341(l, globals.app.state.theme != module507.Themes.light);
      ...
      },
      {
        ...
        value: function () {
          if (((module377.RSM.mapSaveEnabled && !module377.RSM.multiFloorEnabled) || module377.RSM.multiFloorEnabled) && 0 == module1231.MM.maps.length)
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this.singleFloorSaveNewMapActionSheet.hide(function () {
            if (t == module1231.CurrentMapId) n.singleFloorSaveNewMapAlert.show();
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (
            ...
            if ('' != o) {
              var l = module1245.FloorMapPageUtils.getRealLength(o);
              if (module1245.FloorMapPageUtils.getRealLength(o) >= 30) globals.showToast(module491.floor_map_name_too_long);
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            l = React.default.createElement(module1800.default, {
              ...
              mode: module1800.ModalMapEditMenuMode.MapManagement,
              ...
              onEditingMapNameSuccess: function (n, o) {
                var l =
                  ...
                  t.state.items.map(function (t) {
                    if (t.id == n) t.name = module1245.FloorMapPageUtils.getRealName(o);
                    return t;
                  });
                t.setState({
                  items: l,
            ...
            N = React.default.createElement(module1937.default, {
              ref: function (n) {
            ...
            B = React.default.createElement(module1937.SingleMapEmptyMapItem, {
            ...
            U = React.default.createElement(module381.InputDialog, {
              ...
              warningVisibilityAdapter: function (t) {
                return !module1245.FloorMapPageUtils.isLengthValid(t);
              },
            }),
            G = React.default.createElement(module1808.default, {
              ref: function (n) {
            ...
            Q = React.default.createElement(module1233.MultiFloorEnableTipsView, {
              ref: function (n) {
                t.qaContentView = n;
              },
            }),
            ...
            $ = React.default.createElement(module1243.MapSaveActionSheetView, {
              ...
              mode: module1243.MapSaveActionSheetMode.SaveNewMapInSingleFloor,
              handleSaveMap: function (n) {
                return t.onTapSingleFloorSaveActionSheet.apply(t, [n]);
              },
            }),
            ee = React.default.createElement(module1243.MapSaveActionSheetView, {
              ref: function (n) {
            ...
            te = React.default.createElement(module1935.SingleFloorSaveNewMapAlert, {
              ref: function (n) {
