...
var module491 = require('./491'),
  ...
  module2024 = (function (t) {
    ...
    function B(t) {
      ...
      (o = k.call(this, t)).defaultBackground = require('./2021');
      o.activeBackground = require('./2022');
      o.activeControlBall = require('./2023');
      o.activeOutterBorder = require('./2024');
      o.isRemoting = false;
