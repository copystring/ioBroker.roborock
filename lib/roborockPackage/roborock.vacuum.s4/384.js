...
function D(t, n) {
  var s = ('undefined' != typeof Symbol && t['function' == typeof Symbol ? Symbol.iterator : '@@iterator']) || t['@@iterator'];
      ...
      [
              ...
              function (L) {
                for (;;)
                  switch ((L.prev = L.next)) {
                    case 0:
                      if (((o = 768), 'AppStat' in module385.Methods != false)) {
                        L.next = 5;
                        break;
                      }
                    ...
                    case 17:
                      ...
                      if (((f = O.value), (A = module22.default(f, 2)), (N = A[0]), (h = A[1]), !this._allPendingItems.has(N))) {
                        L.next = 25;
                        break;
                      }
                    ...
                    case 54:
                      ...
                      L.prev = 59;
                      L.next = 62;
                      return regeneratorRuntime.default.awrap(module407.default.appStat(b));
        ...
        },
        {
          ...
          value: function (n) {
            var s = {
                mobileBrand: '*',
                mobileModel: module389.systemInfo.mobileModel,
                os: module12.Platform.OS,
                osVersion: module12.Platform.Version.toString(),
                pluginVersion: module389.pluginVersion.toString(),
                ...
                region: module377.RobotStatusManager.sharedManager().timeZone || '*',
                mcc: module389.MCC || '*',
                mnc: '*',
                appType: module389.isMiApp ? 'mi' : 'roborock',
              },
