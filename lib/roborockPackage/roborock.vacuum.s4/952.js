...
function h(t, n) {
  return n.encode ? (n.strict ? module953(t) : encodeURIComponent(t)) : t;
}

function k(t, n) {
  return n.decode ? module954(t) : t;
}
...
function x(o, c) {
  ...
  for (var f, y = u(o.split('&')); !(f = y()).done; ) {
    ...
    if ('' !== v) {
      var h = module955(c.decode ? v.replace(/\+/g, ' ') : v, '='),
        F = module22(h, 2),
        A = F[0],
        O = F[1];
