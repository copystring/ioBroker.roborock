...
var module389 = require('./389'),
  module2067 = module389.monitorAllowed() ? require('./2067').default : module12.View,
    ...
    module5.default(Q, [
      {
        ...
        value: function () {
          ...
          module1063.default.shared().popGestureEnabled = false;
          ...
          module2058.default.isConnected.removeEventListener('connectionChange', this.onNetWorkChange.bind(this));
        },
      },
      {
                ...
                switch ((u.prev = u.next)) {
                  ...
                  case 17:
                    if (module377.RSM.isHomeSecDisconnected()) {
                      ...
                      l = {
                        quality: module936.VideoQuality.SD,
                      ...
                      module377.RSM.isHomeSecControlledByCurrentClient()
                        ...
                        : (module409.Log.log(
                          ...
                          this.setState({
                            isLoading: false,
                            isLoadFailed: true,
                            error: module936.VideoError.Video_StartPreviewFailed_alreadyInPreview,
                          }));
      ...
      },
      {
        ...
        value: function () {
          ...
          this.statusListener = module12.DeviceEventEmitter.addListener(module411.NotificationKeys.RobotStatusDidUpdate, function (n) {
            ...
            if (module377.RSM.bumperLeft) t.showTip(se[module2045.DirectionLeft]);
            if (module377.RSM.bumperRight) t.showTip(se[module2045.DirectionRight]);
            if (module377.RSM.bumperMiddle) t.showTip(se[module2045.DirectionMiddle]);
            if (module377.RSM.obstacleLeft) t.showTip(le[module2045.DirectionLeft]);
            if (module377.RSM.obstacleRight) t.showTip(le[module2045.DirectionRight]);
            if (module377.RSM.obstacleMiddle) t.showTip(le[module2045.DirectionMiddle]);
          ...
          module2058.default.isConnected.addEventListener('connectionChange', this.onNetWorkChange.bind(this));
          this.gotoFailListener = module12.DeviceEventEmitter.addListener(module411.NotificationKeys.EventToastChange, function (o) {
            if ('target_not_reachable' == o.data) t.showTip(module1362.getToast()[o.data][0]);
          });
        },
      },
      {
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    n.prev = 0;
                    n.next = 3;
                    return regeneratorRuntime.default.awrap(module2058.default.getConnectionInfo());
      ...
      },
      {
        ...
        value: function (t) {
          var o = this,
            ...
            u = React.default.createElement(module2067, {
              ref: function (t) {
          ...
          return module389.monitorAllowed() ? module387.default.iOSAndroidReturn(h, u) : module2071;
        },
      },
      {
        key: 'didRecieveMsg',
      ...
      },
      {
        ...
        value: function (t, o) {
          if (
            t.code == module936.VideoError.Video_StartPreviewFailed_alreadyInPreview.code &&
            (module409.Log.log(
              module409.LogTypes.Monitor,
            ...
            if (
              t.code == module936.VideoError.Video_StartPreviewFailed_unKnownReason.code ||
              t.code == module936.VideoError.Video_StartPreviewFailed_innerUnknowReason.code ||
              t.code == module936.VideoError.Video_PreviewTimeout
            ) {
      ...
      },
      {
        ...
        value: function (t) {
          var o = this;
          return React.default.createElement(module2025.default, {
      ...
      },
      {
        ...
        value: function (t) {
          var o = this;
          return React.default.createElement(module2039.default, {
            ref: function (t) {
            ...
            style: [
              ...
              t
                ? {}
                : {
                    left: module936.AppBarMarginTop + 24,
                  },
            ],
      ...
      },
      {
        key: 'getCallView',
        value: function (t) {
          return React.default.createElement(module2054.default, {
            style: ge.callView,
            isLandscape: t,
            ...
            React.default.createElement(
              ...
              module415.DMM.isTopazSV || module415.DMM.isTanosSV
                ? React.default.createElement(module381.PureImageButton, {
                    ...
                    image: this.state.robotMic ? require('./2032') : require('./2033'),
                    imageWidth: 30,
                    imageHeight: 30,
                    onPress: function () {
                      return t.soundOff();
        ...
        value: function () {
          ...
          if (this.videoView)
            this.videoView.startRecordVideo(function (o) {
              if (o) {
                module2028.timeTool.startRecordTime();
                t.setState({
      ...
      },
      {
        ...
        value: function () {
          if (this.state.screenRecording) {
            module2028.timeTool.cancleRecord();
            this.setState({
              screenRecording: !this.state.screenRecording,
            });
            if (this.videoView)
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module2037.FuncTabMenu, {
              style: {
                position: 'absolute',
                top: he() + de,
                zIndex: 2,
            ...
            React.default.createElement(
              module12.View,
              {
                style: [
                  ...
                  {
                    width: oe(),
                    height: ne() - he() - ae - de - module2037.FuncTabBackgroundHeight + 15,
                  },
                ],
              },
            ...
            React.default.createElement(module2019.default, {
              ref: function (o) {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            n && (module377.RSM.bumperMiddle || module377.RSM.obstacleMiddle)
              ? React.default.createElement(module2045.BumperView, {
                  direction: module2045.DirectionMiddle,
                })
              : null,
            n && (module377.RSM.bumperLeft || module377.RSM.obstacleLeft)
              ? React.default.createElement(module2045.BumperView, {
                  direction: module2045.DirectionLeft,
                })
              : null,
            n && (module377.RSM.bumperRight || module377.RSM.obstacleRight)
              ? React.default.createElement(module2045.BumperView, {
                  direction: module2045.DirectionRight,
                })
              : null,
            React.default.createElement(module381.AlertView, {
              ref: function (o) {
            ...
            module386.default.isRecordAllowed() && module389.isRecordSupported() && 2 == module389.iotType
              ? React.default.createElement(module2046.default, {
                  ref: function (o) {
...
exports.default = module2033;
module2033.contextType = module506.AppConfigContext;
module2033.navigationOptions = {
  header: null,
};
