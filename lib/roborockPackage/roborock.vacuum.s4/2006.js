    ...
    module5.default(L, [
        ...
        value: function () {
          ...
          return [
            ...
            },
            {
              ...
              detail: module2007.DustCollectionModes[this.state.dustCollectionMode]
                ? module2007.DustCollectionModes[this.state.dustCollectionMode].title
                : module491.dust_collection_title_1,
              onPress: function () {
                t.props.navigation.navigate('DustCollectionSettingPageNew', {
                  title: module491.dust_collection_desc_title,
                  dustCollectionMode: module2007.DustCollectionModes[t.state.dustCollectionMode] ? t.state.dustCollectionMode : 0,
      ...
      },
      {
        ...
        value: function () {
          ...
          var module1967 = this.getMenus().map(function (t, o) {
              return t.visible
                ? t.title
