var module340 = require('./340'),
  f = [];

require('./39').default.addListener('hardwareBackPress', function () {
...
var u = {
  exitApp: function () {
    if (module340.default) module340.default.invokeDefaultBackPressHandler();
  },
