...
module1231.MM.createJsExecutor();
...
module12.AppState.addEventListener('change', function (t) {
  ...
  if (module377.RSM.hasAgreedPrivacyPolicy) {
    ...
    if (o) {
      ...
      module1231.MM.lastMapRequestHasHandled = true;
      module1231.MM.start();
    }
  }
});
module404
  .createJsExecutor(require('./2078'))
  .then(function (t) {
  ...
  te = (function (t) {
    ...
    module5.default(re, [
      ...
      },
      {
        ...
        value: function () {
          ...
          this.robotStatusListener = module12.DeviceEventEmitter.addListener(module411.NotificationKeys.RobotStatusDidUpdate, function (n) {
            if (module377.RSM.shouldStopFetchMap()) module1231.MM.stop();
            else module1231.MM.start();
      ...
      },
      {
        key: 'getRootStack',
        value: function (t) {
          return module938.createStackNavigator(module1369.routes, {
              ...
              return {
                header:
                  o.state.params && o.state.params.header
                    ...
                    : React.default.createElement(module2073.default, {
                        ...
                        onPressLeft: function () {
                          if (o.state.routeName == (t || 'MainPage')) {
                            if (module1063.default.shared().isDisableBackAndMore) return;
                            Q();
            ...
            transitionConfig: function () {
              return {
                screenInterpolator: module1369.interpolator,
              };
            },
          });
        },
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  ...
                  case 3:
                    ...
                    s = (s = t.serverCode || module936.areaServerMap[o].code).replace('eu', 'de');
                ...
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    setTimeout(function () {
                      ...
                      module1857.default.checkTimeZoneRedPoint();
                        ...
                        function (s) {
                          for (;;)
                            switch ((s.prev = s.next)) {
                              case 0:
                                s.next = 2;
                                return regeneratorRuntime.default.awrap(module1911.default.getInUseSoundPackage());
                              ...
                              case 4:
                                t = module1911.default.checkSoundPackageNeedUpgrade();
                                o = t > 0;
                  ...
                  case 0:
                    ...
                    if (module389.isMiApp && module415.DMM.isTopazS) {
                      ...
                      module389.openPrivacyLicense(
                        ...
                        module1378.default.UserAgreement(),
                        Z.rubys_main_alert_title_privacy,
                        module1378.default.UserPrivacyProtocol(),
                        function (o) {
                          var s, l;
                          return regeneratorRuntime.default.async(
                            function (u) {
              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  ...
                  case 6:
                    ...
                    l.next = 24;
                    return regeneratorRuntime.default.awrap(module1354.ModeDataInstance.getCustomMopList());
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    module4 = (module4 = (module4 = module936.areaServerMap[t || module377.RSM.serverCode].host).replace('cdn.', '')).replace('mi-img', 'xiaomi');
                    c.next = 7;
      ...
      },
      {
        ...
        value: function (t) {
          return 'cn' == t ? module936.privacyName.PN_CN : 'de' == t ? module936.privacyName.PN_EU : module936.privacyName.PN_GENERAL;
        },
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(module1924.default, {
                ref: function (n) {
              ...
              module389.isTestModeSupport() &&
                React.default.createElement(module2077.default, {
                  ref: function (t) {
