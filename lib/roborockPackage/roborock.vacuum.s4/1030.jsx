exports.default = function (t) {
    ...
    function P() {
      ...
      (t = O.call(this, ...args))._renderScene = function (n) {
        var o = n.route,
          ...
          p = u[o.key],
          f = p.getComponent();
        return <module938.SceneView screenProps={c} navigation={p.navigation} component={f} />;
      };
          ...
          f = function () {
            if (u.isFocused()) {
              if (o.hasOwnProperty('index') && o.index > 0)
                u.dispatch(
                  module938.StackActions.popToTop({
                    key: o.key,
                  })
                );
      ...
      t._jumpTo = function (n) {
        return t.props.navigation.dispatch(
          module938.NavigationActions.navigate({
            routeName: n,
          })
        );
      };
  ...
  return function (t) {
    var n = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : {},
      s = module938.TabRouter(t, n),
      c = module938.createNavigator(o, s, n);
    return module938.createNavigationContainer(c);
  };
};
