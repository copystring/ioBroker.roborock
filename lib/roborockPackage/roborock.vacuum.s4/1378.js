...
var module377 = require('./377'),
  ...
  module1379 = require('./1379').HtmlMap,
  module1609 = require('./1609').HtmlMap;
...
function S() {
  return module936.areaServerMap[T()].host;
}
...
M = module389.isMiApp
  ...
  ? module1609.TanosS
  : module415.DMM.isTanosSPlus
  ? module1609.TanosSPlus
  : module415.DMM.isTanosV
  ? module1609.TanosV
  : module415.DMM.isRubysLite
  ? module1609.RubysLite
  : module415.DMM.isTopazS
  ? module1609.TopazS
  : module415.DMM.isTanos || module415.DMM.isRubyPlus || module415.DMM.isRubySC || module415.DMM.isRubysE
  ? module1609.Tanos
...
var U = (HtmlResManager = {
  ...
  WiFiPrivacy: function () {
    var t = module1609.Tanos;
    if (module389.isMiApp) t = module1379.Tanos;
    var n = b(),
      o = 'en' == c && 'en' == _() ? _() : n,
      u = t.wifi_privacy_en;
