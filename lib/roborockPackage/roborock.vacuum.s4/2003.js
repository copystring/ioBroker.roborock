        ...
        value: function () {
          ...
          if (module377.RSM.isO1Dock()) {
            ...
            if (o) {
              var n,
                l,
                s = module1810.default.sharedManager().dockSetSNPrefixes;
              if (
                ((l = false),
      ...
      },
      {
        ...
        value: function () {
          ...
          var c = this.getTopMenus().map(function (t, o) {
            ...
            module1967 = this.getMenus().map(function (t, o) {
              return t.visible
                ? t.title
                  ? React.default.createElement(
                      module381.SettingListItemView,
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              this.state.dustCollectionSwitch && module386.default.isDustCollectionSettingSupported() && module1967
            ),
