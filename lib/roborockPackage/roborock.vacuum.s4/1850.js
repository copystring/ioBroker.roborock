  ...
  _ = (function (t, ...args) {
    ...
    function _() {
      ...
      t.onGLCaptureFrame = function (n) {
        var o = n.nativeEvent,
          ...
          l = o.config,
          p = w(l);
        module1847.default(p in t._pendingCaptureFrame, "capture '%s' is not scheduled in this._pendingCaptureFrame", p);
    ...
    module5.default(_, [
      ...
      },
      {
        ...
        value: function (t) {
          var n = w(t);
          return this._pendingCaptureFrame[n] || (module1851.default(module12.findNodeHandle(this.refs.native), t), (this._pendingCaptureFrame[n] = this._makeDeferred()));
        },
      },
      {
        key: '_makeDeferred',
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (t) {
            module1847.default('object' == typeof t, 'captureFrame takes an object option in parameter');
            var o = 0;

            if ('format' in t) {
              module1847.default('string' == typeof t.format, "captureFrame({format}): format must be a string (e.g: 'base64'), Got: '%s'", t.format);
              if ('file' === t.format)
                module1847.default(
            ...
            if ('type' in t) {
              module1847.default('string' == typeof t.type, "captureFrame({type}): type must be a string (e.g: 'png', 'jpg'), Got: '%s'", t.type);
              o++;
            }
            ...
            if ('filePath' in t) o++;
            var u = Object.keys(t);
            module1847.default(u.length === o, "captureFrame(config): config must be an object with {format, type, quality, filePath}, found some invalid keys in '%s'", u);
            n = t;
          }
