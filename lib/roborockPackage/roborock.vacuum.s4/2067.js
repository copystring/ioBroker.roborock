    ...
    module5.default(I, [
      {
        ...
        value: function () {
          ...
          module2069.VideoManager.cancelRequest = false;
      ...
      },
      {
        ...
        value: function () {
          ...
          module2069.VideoManager.cancelRequest = false;
          module2069.VideoManager.addIceListener(function (o) {
            if (t.videoView)
              t.videoView.sendIceInfoToSDK(o, function (t) {
                console.log('\u53d1\u9001 ICE \u4fe1\u606f \u5230SDK \u6210\u529f');
              });
          });
          module2069.VideoManager.addTurnServerCallback(function (o) {
            t.sendTurnserviceInfoToSdk(o);
          });
          module2069.VideoManager.addSdpListener(function (o) {
            if (t.videoView)
              t.videoView.sendSdpInfoToSDK(o, function (t) {
                console.log('\u53d1\u9001 sdp \u4fe1\u606f \u5230SDK \u6210\u529f');
              });
          });
          module2069.VideoManager.addErrorCodeListener(function (o, n) {
      ...
      },
      {
        ...
        value: function () {
          ...
          module2069.VideoManager.cancelRequest = true;
      ...
      },
      {
        key: 'renderStateView',
        value: function (t) {
          if (!module415.DMM.isV1 && !module415.DMM.isV3) {
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module2068.default, {
              width: n || p,
              height: s || w,
              ...
              onCallingError: function (o) {
                ...
                module383.LogEventStat(module383.LogEventMap.RealTimeCallingError);
              },
              onCallingTimeout: function () {
                ...
                console.log('\u89c6\u9891\u8d85\u65f6 \u9519\u8bef');
                module383.LogEventStat(module383.LogEventMap.RealTimeCallTimeout);
              },
              onFrameStuck: function () {
                ...
                console.log('\u89c6\u9891 \u5361\u987f');
                module383.LogEventStat(module383.LogEventMap.RealTimeFrameStuck);
              },
              onFirstFrameRendered: function () {
                t.setState({
                  isFirstVideoFrameRender: true,
                });
                module2069.VideoManager.notifyFirstVideoFrameRendered();
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    s.next = 5;
                    return regeneratorRuntime.default.awrap(module407.default.sendSdpInfo(t));
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    s.next = 4;
                    return regeneratorRuntime.default.awrap(module407.default.sendIceInfo(t));
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    module2069.VideoManager.stopCameraPreview(t, n);
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    module2069.VideoManager.startVideoPreview(t, n);
