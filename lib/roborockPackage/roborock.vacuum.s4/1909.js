      ...
      },
      {
        ...
        value: function () {
          var t = this.context.theme.soundPackage,
            ...
            c = React.default.createElement(module1910.default, {
              progress: this.state.progress,
              style: E.progressView,
            }),
            v = this.state.progress >= 0 && this.state.progress < 1 ? c : p,
            P = 'https://' + module936.areaServerMap[module377.RSM.serverCode].host + this.props.data.bg_pic.split('.com')[1],
            w = '';

          if (this.props.data.validEndTime) {
            var b = module1368.convertTimeFromSourceZoneToPhoneZoneByTimestamp(this.props.data.validEndTime, 0);
            ...
            function (l) {
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    if (((t = module1911.default.wavFileName(this.props.data.voice_id, this.props.data.version)), !this.state.playing)) {
                      l.next = 16;
                      break;
                    }
                  ...
                  case 25:
                    ...
                    l.t1 = l.catch(16);
                    l.prev = 27;
                    module4 = module936.areaServerMap[module377.RSM.serverCode].cdnHost;
