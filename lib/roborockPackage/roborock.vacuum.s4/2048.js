...
var k,
  ...
  module2049 = module389.isRecordSupported() ? require('./2049') : module12.View,
  M = module12.NativeModules.RRRecorder,
  D = 0,
  module2050 = (function (t) {
    module7.default(module2051, t);

    var module506 = module2051,
      b = P(),
      w = function () {
        var t,
    ...
    function module2051(t, n) {
      var o;
      module4.default(this, module2051);
          ...
          this.Gesture = {
            ...
            onResponderRelease: function (n) {
              ...
              if (
                ...
                t.setState({
                  text: module491.long_press_to_send_voice,
                  icon: t.props.isLandscape ? require('./2050') : t.context.theme.monitor.recordImg,
                }),
                clearTimeout(k),
                t.state.recording)
              ) {
      ...
      },
      {
        ...
        value: function () {
          ...
          this.setState({
            ...
            icon: this.props.isLandscape ? require('./2051') : this.context.theme.monitor.recordSelImg,
          });
                ...
                switch ((t.prev = t.next)) {
                  ...
                  case 9:
                    ...
                    this.setState({
                      recording: false,
                      text: module491.long_press_to_send_voice,
                      icon: this.props.isLandscape ? require('./2050') : this.context.theme.monitor.recordImg,
                    });
...
exports.default = module2050;
module2050.contextType = module506.AppConfigContext;
