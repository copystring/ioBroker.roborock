...
var module491 = require('./491').strings,
  ...
  H = module938.createSwitchNavigator(
    {
      KeyView: J ? module1948.default : module1946.default,
      JoyStickView: J ? module1949.default : module1947.default,
    },
    {
          ...
          return this.state.loading
            ...
            : React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(module1945.default, {
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  ...
                  case 2:
                    ...
                    s = module938.NavigationActions.navigate({
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (this.noteTimerID > 0) {
            module1249.clearTimeout(this.noteTimerID);
            this.noteTimerID = 0;
          }

          this._setNoteVisible(true);

          this.noteTimerID = module1249.setTimeout(function () {
                ...
                switch ((s.prev = s.next)) {
                  case 0:
                    if (
                      ...
                      (t = function () {
                        if (n.startTimerID <= 0)
                          n.startTimerID = module1249.setInterval(function () {
      ...
      },
      {
        ...
        value: function () {
          if (this.startTimerID > 0) {
            module1249.clearInterval(this.startTimerID);
            this.startTimerID = 0;
