  ...
  B = (function (t) {
    ...
    function _(t) {
      ...
      (o = E.call(this, t))._handleStartShouldSetPanResponder = function () {
        return (
          o.props.mapMode == module936.MAP_MODE_MAP_EDIT ||
      ...
      o._handlePanResponderStart = function (t, n) {
        o.touch.move = module1247._parseEvent2(t.nativeEvent, n) || {};
        o.setState({
          leftSplitPoint: null,
    ...
    module5.default(_, [
      ...
      },
      {
        key: '_getMoveXY',
        value: function (t, o) {
          var s = [module1247._parseEvent2(t.nativeEvent, o), this.touch.move],
            l = s[0],
            h = s[1];
          if (((this.touch.move = l || {}), !(l && l.x && l.y && h.x))) return null;
          if (l.hasOwnProperty('distance')) return null;

          var f = module1247._parseDegPointWithTrans(l, h, this.props.transform, this.props.mapDeg),
      ...
      },
      {
        ...
        value: function () {
          if ('undefined' != this.props.parent) {
            ...
            if ((o = module1247._isVerticalRotate(this.props.mapDeg) ? this.getRotateEdge() : this.getNormalEdge()) && o.res) {
              ...
              isNaN(w) || isNaN(k)
                ...
                : React.default.createElement(
                    ...
                    React.default.createElement(
                      ...
                      React.default.createElement(module1069.Circle, {
                        cx: '20',
                        cy: '20',
                        r: '8',
                        stroke: 'white',
