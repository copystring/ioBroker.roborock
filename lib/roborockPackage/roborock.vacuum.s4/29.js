      ...
      [
        ...
        },
        {
          ...
          value: function (t, l, u, s, h) {
            ...
            module35.counterEvent('pending_js_to_native_queue', this._queue[0].length);
            if (this.__spy)
              this.__spy({
                type: 1,
                module: t + '',
        ...
        },
        {
          ...
          value: function () {
            module35.beginEvent('JSTimers.callImmediates()');
        ...
        },
        {
          ...
          value: function (t, l, u) {
            ...
            if (this.__spy) module35.beginEvent(t + '.' + l + '(' + module37(u) + ')');
            else module35.beginEvent(t + '.' + l + '(...)');
            if (this.__spy)
              this.__spy({
                type: 0,
                module: t,
            ...
            module13(!!s, 'Module %s is not a registered callable module (calling %s)', t, l);
            module13(!!s[l], 'Method %s does not exist on module %s', l, t);
            var c = s[l].apply(s, u);
            module35.endEvent();
            return c;
          },
