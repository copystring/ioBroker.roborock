                                ...
                                switch ((b.prev = b.next)) {
                                  case 0:
                                    if (
                                      ...
                                      (n = module1343.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].host),
                                  ...
                                  case 7:
                                    module1937 = 'https://' + n + o;
                                    x = '/config.json';
                                    console.log('' + module1937 + x + '?time=' + new Date().getTime());
                                    b.next = 12;
                                    return regeneratorRuntime.default.awrap(module391.default.asyncDownloadFile('' + module1937 + x + '?time=' + new Date().getTime(), 'infoTemp'));
