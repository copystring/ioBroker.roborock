  ...
  S = (function (t) {
    ...
    function k(t) {
      ...
      (s = P.call(this, t)).handleFBZPanOnShouldStart = function (t) {
        ...
        if (module393.isMiApp && -1 == n && s.editItems.length >= module1126.MAX_FURNITURE_EDIT_MIAPP) {
          var u = {
        ...
        module1124.MapEditCommonService.enableEditMap();
        return true;
      };
    ...
    module7.default(k, [
      ...
      },
      {
        ...
        value: function () {
          var t = [];
          this.state.data.forEach(function (n) {
            if (n.type != module1126.FurnitureType.FT_TOILET) n.changed ? t.push(n) : n.edited || t.push(n);
          });
          return t;
        },
      },
      ...
      },
      {
        ...
        value: function (t, n) {
          if (t == module1126.FurnitureType.FT_TOILET) return true;
          return !(
            !this.props.showFurnitureIcon ||
            !((t >= module1126.FurnitureType.FT_TVCABINET && t <= module1126.FurnitureType.FT_DINNERTABLE) || t == module1126.FurnitureType.FT_TEATABLE) ||
            n
          );
        },
      },
      ...
      },
      {
        ...
        value: function (t) {
          ...
          var s = this.props.mapMode == module1343.MAP_MODE_FURNITURE_EDIT;
          return this.state.data.map(function (u, o) {
            if (u.type == module1126.FurnitureType.FT_NONE || (u.type == module1126.FurnitureType.FT_TOILET && (n.props.showFurnitureIcon || !module394.MC.showAllFurnitureModel)))
