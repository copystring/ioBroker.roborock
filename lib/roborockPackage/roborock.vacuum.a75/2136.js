...
var x = module13.Dimensions.get('window').width,
  G = (function (t) {
    ...
    function module2139(t) {
      var n;
      module6.default(this, module2139);
    ...
    module7.default(module2139, [
      {
        key: 'componentDidMount',
        value: function () {
          this.props.navigation.setParams({
            navBarBackgroundColor: 'transparent',
            naviBackImage: require('./2139'),
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module2137.MapARPrivacyDialogWithNavbar, {
            ref: function (n) {
            ...
            onPressLink: function () {
              return t.props.navigation.navigate('WebViewPage', {
                ...
                refrence: module1654.default.ARMapPrivacy(),
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            module2141 = React.default.createElement(module385.PureImageButton, {
              funcId: 'map_edit_menu_close',
              style: E.bigButton,
              image: this.state.status == k.INIT ? require('./2140') : require('./2141'),
              imageWidth: 70,
              imageHeight: 70,
              onPress: function () {
            ...
            module2143 = React.default.createElement(module385.PureImageButton, {
              funcId: 'map_edit_menu_close',
              style: E.smallButton,
              image: this.state.status == k.SCANNING ? require('./2142') : require('./2143'),
              imageWidth: 46,
              imageHeight: 46,
              onPress: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module2138.default, {
              ref: function (n) {
                return (t.arView = n);
              },
              style: E.arMapView,
            ...
            module2141,
            this.state.status != k.INIT && module2143,
