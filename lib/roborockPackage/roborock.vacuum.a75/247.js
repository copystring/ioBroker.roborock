...
class p {
  constructor(s) {
    ...
    module14(V._stiffness > 0, 'Stiffness value must be greater than 0');
    module14(V._damping > 0, 'Damping value must be greater than 0');
    module14(V._mass > 0, 'Mass value must be greater than 0');
    return V;
  }
  ...
  stop() {
    module41(module12(b.prototype), 'stop', this).call(this);
    this.__active = false;
