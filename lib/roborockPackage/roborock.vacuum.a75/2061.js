    ...
    o._onPressBottomBtn = function () {
      ...
      if (module381.RSM.mapSaveEnabled)
        module381.RSM.isRunning
          ...
          ? module1639.default.mapObjectPhotoEnabled &&
    ...
    },
    {
      ...
      value: function () {
        ...
        var t = this,
          ...
          n = module13.Dimensions.get('window').height - module1343.StatusBarHeight - 44 - 150,
        ...
        if (this.state.photoSize && this.state.rectInfo) {
          var V = s / this.state.photoSize.width,
            ...
            module2074 = T + B + 10 > s ? s - T - B - 2 : 10;
          T -= A;
          x -= F;
          B = B + A + module2074;
          L = L + F + H;
        ...
        var module2072 = this.getInnerFailedView(require('./2072'), module510.button_title_retry),
          module1421 = React.default.createElement(module1203.default, {
            ref: function (o) {
          ...
          ee = React.default.createElement(
            ...
            React.default.createElement(
              ...
              v,
              this.state.readPhotoLoadingStatus == K.LOADING && module1421,
              this.state.readPhotoLoadingStatus == K.FAILED && module2072
            )
          ),
          te = module424.DMM.obstacleImagesMap.topBigImage[f],
          module2073 = React.default.createElement(
            module13.ImageBackground,
            {
              resizeMode: 'cover',
              style: {
        ...
        var ae =
            ...
            !module391.default.isShareUser() &&
            (module424.DMM.isTanosV_CN || module424.DMM.isTopazSV_CN),
          ie = module1343.obstacleRemoveTips,
          re = this.state.selfHeight ** n,
          se = R(
            R({}, module1434.BaseShadow),
            {},
            {
              width: s,
              height: re,
        ...
        return React.default.createElement(
          ...
          React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                module390.default.isFwFilterObstacleSupported() && module1639.default.mapObjectPhotoEnabled && y && y.length >= 1 ? ee : module2073,
                React.default.createElement(
                  module13.View,
                  {
                    style: J.line,
          ...
          React.default.createElement(module2062.MapObjectIgnoreDescDialog, {
            ref: function (o) {
