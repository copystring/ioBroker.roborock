...
var module1339 = require('./1339'),
  E = 2 * module1126.buttonConfig.rectBtn.size.width,
  O = (function (t) {
    module9.default(O, t);
    ...
    function O(t) {
      ...
      o.edgeSize = module1126.getFurnitureEdge(t.type, t.subType);
      return o;
    }
    ...
    module7.default(O, [
      ...
      },
      {
        ...
        value: function (t) {
          if (t.type != this.props.type) this.edgeSize = module1126.getFurnitureEdge(t.type, t.subType);
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = module1126.FurnitureResource[this.props.type];
          return t
      ...
      },
      {
        ...
        value: function (t) {
          var o = module1126.Config.size.objectsRadius,
            n = module1126.Config.size.objectsRadius;
          return {
            x: t.x + t.width / 2 - o / 2,
      ...
      },
      {
        ...
        value: function (t) {
          var o = t.x + t.width / 2,
            ...
            u = p[1];
          if (
            this.props.type != module1126.FurnitureType.FT_SOFA ||
            (this.props.subType != module1126.SofaSubType.SST_SECTIONAL && this.props.subType != module1126.SofaSubType.SST_SECTIONAL_LEFT)
          )
            this.props.type == module1126.FurnitureType.FT_DINNERTABLE
              ? ((s = (255 * t.width) / 195), (u = (192 * t.height) / 132))
              : this.props.type == module1126.FurnitureType.FT_TEATABLE
              ? this.props.subType == module1126.TableSubType.TST_CIRCLE && ((s = (240 * t.width) / 180), (u = (240 * t.height) / 180))
              : this.props.type == module1126.FurnitureType.FT_SHOECABINET && ((s = (246 * t.width) / 186), (u = (141 * t.height) / 81));
          else {
            s = (264 * t.width) / 210;
            u = (171 * t.height) / 117;
          }
      ...
      },
      {
        ...
        value: function () {
          ...
          if (t == module1126.FurnitureType.FT_NONE) return React.default.createElement(module13.View, null);
          ...
          var u = module1339._convertToPixelRect(n, this.props.transform);

          if (!u || isNaN(u.x) || isNaN(u.y) || isNaN(u.width) || isNaN(u.height)) return null;
          var h = u.width + 2 * E,
            l = u.height + 2 * E,
            y = t == module1126.FurnitureType.FT_TEATABLE && this.props.subType == module1126.TableSubType.TST_CIRCLE,
            b =
              t == module1126.FurnitureType.FT_SOFA &&
              (this.props.subType == module1126.SofaSubType.SST_SECTIONAL || this.props.subType == module1126.SofaSubType.SST_SECTIONAL_LEFT),
            w =
              t == module1126.FurnitureType.FT_BED ||
              t == module1126.FurnitureType.FT_DINNERTABLE ||
              t == module1126.FurnitureType.FT_TOILET ||
              t == module1126.FurnitureType.FT_SHOECABINET,
            ...
            x = y || b || w || P ? z : N,
            C = module1349.default.zoneDeleteButton('furniture_rect_edit_delete', this.panProxy.panResponderDelete, E),
            M = module1349.default.zoneScaleButton(u, 'furniture_rect_edit_scale', this.panProxy.panResponderScale, E),
            D = module1349.default.zoneRotateButton(u.width, 'furniture_rect_edit_rotate', this.panProxy.panResponderRotate, E),
            j = {
              transform: [
                {
            ...
            B = module1349.default.zoneAreaView(u.width, this.props.rectSize, false, '', j),
          ...
          return React.default.createElement(
            ...
            this.props.isFocus && module1349.default.zoneFocusBorderView(u.width, u.height, E),
            this.props.isFocus && C,
            this.props.isFocus && M,
            this.props.isFocus && D,
            this.props.isFocus && module1349.default.zoneDragButtonView(u.height, this.panProxy.panResponder)
          );
        },
      },
    ]);
...
O.defaultProps = {
  ...
  percent: 0,
  direction: 0,
  type: module1126.FurnitureType.FT_UNKNOWN,
  subType: module1126.FurnitureType.FT_UNKNOWN,
