...
var module1343 = require('./1343').Definitions,
  x = function (t) {
            ...
            function (u) {
              for (;;)
                switch ((u.prev = u.next)) {
                  case 0:
                    u.next = 2;
                    return regeneratorRuntime.default.awrap(module420.GetStorageKey(module420.StorageKeys.MonitorVideoDefinition));

                  case 2:
                    t = u.sent;
                    n = module1343.findIndex(function (n) {
                      return n.command == t;
                    });
                  ...
                  module13.Animated.View,
                  {
                    style: [
                      k.container,
                      {
                        ...
                        width: ((t = true), t ? module13.Dimensions.get('screen').width : module13.Dimensions.get('window').width),
                        height: o || x(true),
                      },
                    ],
                  },
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    this.hide();
                    s.prev = 1;
                    n = module1343[t].command;
                    module387.LogEventCommon('tap_video_quality_' + n);
                    s.next = 6;
                    return regeneratorRuntime.default.awrap(module416.default.setVideoQuality(n));
                  ...
                  case 6:
                    ...
                    s.next = 10;
                    return regeneratorRuntime.default.awrap(module420.SetStorageKey(module420.StorageKeys.MonitorVideoDefinition, n));

                  case 10:
                    if (this.props.definitionDidChange) this.props.definitionDidChange(true, module1343[t]);
