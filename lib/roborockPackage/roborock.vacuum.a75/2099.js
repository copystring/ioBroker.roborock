    ...
    module7.default(Z, [
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            o = module1349.default.confirmButton(this.onNavigationSavePress.bind(this), n, function (n) {
              t.mapSaveButton = n;
            }),
            s = module1349.default.guideButton(
          ...
          module1349.default.setNavigation(this, globals.isRTL ? [o, s] : [s, o], this.onNavigationBackPress.bind(this));
        },
      },
      {
        key: 'registListeners',
      ...
      },
      {
        ...
        value: function (t) {
          ...
          return t
            ? new module1348.default(function (t, n) {
                module416.default
                  .setLabStatus({
                    lab_status: 3,
                  })
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            s = this.state.mapStatus == module381.MapStatus.None ? module1349.default.getNoMapTipView(this.state.mapStatus) : o,
            u = React.default.createElement(module1212.MapSaveActionSheetView, {
              ref: function (n) {
                return (t.singleFloorSaveNewMapActionSheet = n);
              },
              mode: module1212.MapSaveActionSheetMode.SingleFloorWithoutSave,
              handleSaveMap: function (n) {
                return t.onTapSingleFloorSaveActionSheet.apply(t, [n]);
              },
            }),
            l = React.default.createElement(module1212.SingleFloorSaveNewMapAlert, {
              ref: function (n) {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module1198.default, {
              type: module1198.MenuType.Menu_Fbz,
              ref: function (n) {
                return (t.editMenu = n);
              },
