    ...
    (o = h.call(this, t))._panResponder = module13.PanResponder.create({
      ...
      onPanResponderTerminate: function (t, n) {
        ...
        if (o._active) {
          ...
          if (module2161.shallowEqual(o.props.location, o._location)) o._relocate(o.props.location);
        }
      },
    });
  ...
  module7.default(b, [
    {
      ...
      value: function () {
        if (!this._active && !module2161.shallowEqual(this._location, this.props.location)) {
    ...
    },
    {
      ...
      value: function (t, o) {
        return this.props.disabled !== t.disabled || this.props.children !== t.children || !module2161.shallowEqual(this.props.style, t.style);
      },
    },
    {
      key: 'moveBy',
