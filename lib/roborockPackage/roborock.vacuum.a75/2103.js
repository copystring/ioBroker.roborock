  ...
  I = (function (t) {
    ...
    module7.default(I, [
      ...
      },
      {
        key: 'isValidTag',
        value: function (t) {
          return !this.props.supportTag || (!(!t || t <= 0) && 'object' == typeof module1126.RoomTagInfo[t]);
        },
      },
      {
        key: 'isAutoCreateTagName',
        value: function (t, o) {
          if (!module1126.RoomTagInfo[o] && t.length > 0) return false;
          var n = module1126.RoomTagInfo[o].name;
          if (t == n) return true;
          var s = n.length;

          if (t.length > s) {
            var l = t.substring(0, s);
            if (l == module1126.RoomTagInfo[o].name && (l = t.substring(s)).match(/^\d+$/)) return true;
          }
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if ('' == o) o = module1126.RoomTagInfo[t].name;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (t.length >= 2 && this.props.supportTag)
            for (var n = 0; n < module1126.DisplayRoomTag.length; n++)
              if (this.isAutoCreateTagName(t, module1126.DisplayRoomTag[n])) {
                o = module1126.DisplayRoomTag[n];
                break;
              }
          return o;
        },
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            module2104 = module1126.RoomTagInfo[this.state.selectTagKey] ? module1126.RoomTagInfo[this.state.selectTagKey].image : require('./2104'),
            u = {
            ...
            module2105 = module1126.DisplayRoomTag.map(function (o, s) {
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    React.default.createElement(
                      ...
                      React.default.createElement(module13.Image, {
                        style: R.tagImg,
                        source: module1126.RoomTagInfo[o].image,
                      }),
                      React.default.createElement(
                        module13.Text,
            ...
            module2107 = this.state.showAllName ? require('./2106') : require('./2107'),
