...
var module510 = require('./510').strings,
  k = (function (t) {
    ...
    function w(t) {
      ...
      n.state = {
        selectedIndex: undefined == module394.MC.tabIndex ? module1626.TabNeutral : module394.MC.tabIndex,
      };
      return n;
    }
      ...
      },
      {
        ...
        value: function () {
          ...
          var n = this.props,
            o = n.enabled,
            u = n.onLayout,
            l = [module510.home_bottom_menu_global, module510.home_bottom_menu_select_zone, module510.home_bottom_menu_draw_zone],
...
var j = module13.StyleSheet.create({
    tabWrap: {
      maxWidth: 300,
      height: module1434.TabWrapHeight,
      marginBottom: 12,
    ...
    tabButton: {
      height: module1434.TabWrapHeight - 8,
      borderRadius: (module1434.TabWrapHeight - 4) / 2,
