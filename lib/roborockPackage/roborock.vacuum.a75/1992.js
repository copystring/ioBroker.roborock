  ...
  module1987 = (function (t) {
    ...
    module7.default(z, [
          ...
          if (this.feedbackCallback)
            this.mapLoadEmitter = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.MapImageLoaded, function (n) {
              if (n.types && 0 != n.types.length) {
                ...
                var o = Object.values(module1124.shareViewLoadType),
                  l = 0;
      ...
      },
      {
        ...
        value: function () {
          this.context.theme;
          var module1949 = React.default.createElement(module385.PureImageButton, {
            image: require('./1949'),
          ...
          this.props.navigation.setParams({
            ...
            rightItems: this.shouldShowShareButton ? [module1949] : [],
          });
        },
      },
      {
      ...
      },
      {
        ...
        value: function (t) {
          var n,
            ...
            s,
            c,
            u = module1993.parse(t, globals.app.state.theme != module520.Themes.light, module424.DMM.isSapphirePlus, module394.MC.sapMapBeautify),
            h = {
      ...
      },
      {
        key: 'render',
        value: function () {
          if (1 == this.props.navigation.state.params.status) require('./1986');
          else require('./1987');
          ...
          var t = this,
            ...
            c = module1644.utcTimeConvertToPhoneTimeZoneTime(1e3 * this.state.start),
            u = module1644.addZeroPrefix(c.month) + '/' + module1644.addZeroPrefix(c.day) + ' ' + module1644.addZeroPrefix(c.hour) + ':' + module1644.addZeroPrefix(c.minute),
            h = {
              marginHorizontal: 2,
              fontSize: 20,
            ...
            K = W + ' | ' + (module1343.CleanStartType()[this.state.startType] || module510.localization_strings_Setting_General_index_0) + ' | ' + u + ' ';
          ...
          var q = [n.cleanHistory.gradSuccessLeft, n.cleanHistory.gradSuccessRight],
            module1986 = [n.cleanHistory.gradFailLeft, n.cleanHistory.gradFailRight],
            ...
            ie = React.default.createElement(
              ...
              globals.isRTL ? module1994 : te,
              globals.isRTL ? te : module1994
            ),
            ...
            module1994 = React.default.createElement(
              module13.TouchableWithoutFeedback,
              module22.default(
                {
                  onPress: this.onPressPlay.bind(this),
          ...
          if (this.state.uiStatus != J) {
            ...
            ie = React.default.createElement(
              ...
              globals.isRTL ? module1997 : module1995,
              se ? module1994 : module1996,
              globals.isRTL ? module1995 : module1997
            );
          }
            ...
            React.default.createElement(
              ...
              this.state.hasGotMap
                ? React.default.createElement(module1124.MapView, {
                    ...
                    syncMapDeg: false,
                    left: module1124.MapEditCommonStyles.mapLeft,
                    right: module1124.MapEditCommonStyles.mapRight,
                    top: module1124.MapEditCommonStyles.mapTop,
                    bottom: Y + 40,
                    alwaysShowFBZ: true,
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  {
                    colors: 1 == this.props.navigation.state.params.status ? q : module1986,
                    start: {
                      x: 0,
                      y: 0,
                    },
              ...
              React.default.createElement(module1926.default, {
                style: {
                  position: 'absolute',
                  bottom: 0,
                  height: Q,
      ...
      },
      {
        key: 'getDescText',
        value: function () {
          var t = module1343.CleanFinishCleanReasons()[this.state.finishReasonCode];
...
exports.default = module1987;
module1987.contextType = module1199.AppConfigContext;
var ee = module13.StyleSheet.create({
  container: {
    ...
    marginTop: -module391.default.iOSAndroidReturn(
      module1395.titleBarContentHeight + module1343.StatusBarHeight + module1343.AppBarMarginTop,
      (module13.StatusBar.currentHeight || 0) + module1395.titleBarContentHeight
    ),
  },
  contentView: {
    flex: 1,
