  ...
  E = (function (t, ...args) {
    ...
    function E() {
      ...
      (t = b.call(this, ...args))._configureTransition = function (n, o) {
        return T(
          T({}, module1262.default.getTransitionConfig(t.props.navigationConfig.transitionConfig, n, o, 'modal' === t.props.navigationConfig.mode).transitionSpec),
          {},
          {
            useNativeDriver: !!C,
          }
    ...
    module7.default(E, [
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module1265.default, {
            render: this._render,
            ...
            onTransitionEnd: function (n, o) {
              ...
              if (n.navigation.state.isTransitioning)
                u.dispatch(
                  module1217.StackActions.completeTransition({
                    key: u.state.key,
                  })
                );
              if (p) p(n, o);
