...
function l(t, n, _) {
  var l = [];
  module14(_[0] && _[0].nativeEvent, 'Native driven events only support animated values contained inside `nativeEvent`.');
...
class h {
  ...
  __attach(t, n) {
    module14(this.__isNative, 'Only native driven events need to be attached.');
    this._attachedEvent = l(t, n, this._argMapping);
  }

  __detach(t, n) {
    module14(this.__isNative, 'Only native driven events need to be detached.');
