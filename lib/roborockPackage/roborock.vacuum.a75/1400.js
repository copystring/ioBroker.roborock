...
var module1339 = require('./1339'),
  T = 2 * module1126.buttonConfig.rectBtn.size.width,
  F = (function (t) {
    module9.default(F, t);
    ...
    function F(t) {
      ...
      n.onTouchStart = function (t) {
        if (t == module1212.RectPanType.PanTypeMove) null == n.props.handlePanStart || n.props.handlePanStart(n.state.type, n.state.id);
      };
      ...
      n.state = {
        type: t.type || module1126.FbzType.FBZ_TYPE_REGULAR,
        id: t.id,
        serial: t.id || 1,
        ...
        newAdded: module1126.RectConfig.newAdded,
    ...
    module7.default(F, [
      ...
      },
      {
        ...
        value: function () {
          ...
          var o = t.width + 2 * T,
            ...
            c = module1349.default.zoneDeleteButton('forbidden_rect_edit_delete', this.panProxy.panResponderDelete, T),
            u = module1349.default.zoneScaleButton(t, 'forbidden_rect_edit_scale', this.panProxy.panResponderScale, T),
            p = this.state.isFocus && h && !this.feedbackMark,
            v = module1349.default.zoneRotateButton(t.width, 'forbidden_rect_edit_rotate', this.panProxy.panResponderRotate, T),
            C = module1349.default.zoneDragButtonView(t.height, this.panProxy.panResponder),
            ...
            R = module1349.default.carpetZoneSaveButton(t.width, 'forbidden_carpet_edit_save', this.panResponderSave, T, S),
            F = this.state.isFocus && (this.ignoreCarpet || (this.customCarpet && !this.state.newAdded)),
            z = module1349.default.carpetZoneDelButton('forbidden_carpet_edit_delete', this.panProxy.panResponderDelete, T, S),
            B = module1349.default.zoneFocusBorderView(t.width, t.height, T),
            Z = this.props.showArea && this.state.isFocus,
            x = module1349.default.zoneAreaView(t.width, this.state.rectSize),
      ...
      },
      {
        ...
        get: function () {
          return this.state.type == module1126.FbzType.FBZ_TYPE_REGULAR;
        },
      },
      {
        key: 'moppingForbidden',
        get: function () {
          return this.state.type == module1126.FbzType.FBZ_TYPE_MOPPING;
        },
      },
      {
        key: 'cleanForbidden',
        get: function () {
          return this.state.type == module1126.FbzType.FBZ_TYPE_CLEANING;
        },
      },
      {
        key: 'feedbackMark',
        get: function () {
          return this.state.type == module1126.FbzType.RECT_TYPE_FBMARK;
        },
      },
      {
        key: 'customCarpet',
        get: function () {
          return this.state.type == module1126.FbzType.RECT_TYPE_CARPET;
        },
      },
      {
        key: 'ignoreCarpet',
        get: function () {
          return this.state.type == module1126.FbzType.FBZ_TYPE_CARPET;
        },
      },
      {
        key: 'carpetCanSave',
