              ...
              for (;;)
                switch ((K.prev = K.next)) {
                  case 0:
                    ...
                    if (module6 - this.lastCameraStatusLockTime >= 2e3 && !this.cameraStatusLocked) module1639.default.parseCameraStatus(t.camera_status);
                    else {
            ...
            function (E) {
              for (;;)
                switch ((E.prev = E.next)) {
                  case 0:
                    E.next = 2;
                    return regeneratorRuntime.default.awrap(module1640.TLM.GetListByHours(6));
                  ...
                  case 2:
                    ...
                    if (module390.default.isUnsaveMapReasonSupported() && this.unsaveMapReason == H.ChargerOffset && -1 != this.unsaveMapFlag)
                      ...
                      this.fanPower != module1624.CleanModeZero &&
                      this.waterBoxMode != module1624.WaterModeZero &&
                      this.mopMode == module1624.CleanRouteFastMode &&
                      this.isCleaning()
                    )
                      this.specialInfo = {
                    ...
                    else if (module390.default.isPureCleanMopSupported() && this.fanPower == module1624.CleanModeZero && this.isCleaning()) {
                      C = this.isCollectDustDock ? module510.home_sepecial_tip_for_only_mop_collectdusk : module510.home_sepecial_tip_for_only_mop;
                      if (this.mopMode == module1624.CleanRouteFastMode) C = o + ', ' + C;
                      this.specialInfo = {
                        text: C,
                        actionStyle: F.PureMop,
                      };
                    } else if (module390.default.isPureCleanMopSupported() && this.waterBoxMode == module1624.WaterModeZero && this.isCleaning()) {
                      p = module510.home_sepecial_tip_for_only_clean;
                      if (this.mopMode == module1624.CleanRouteFastMode) p = o + ', ' + p;
                      this.specialInfo = {
                        text: p,
                  ...
                  case 0:
                    ...
                    if (
                      (o = module23.filter(function (t) {
                        return module23 && module1638.Toast[t];
                      }))[0]
                    )
                    ...
                    u = module23.filter(function (t) {
                      return module23 && module1638.Reminder()[t];
                    });
                    S.next = 8;
