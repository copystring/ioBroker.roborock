  ...
  V = (function (t) {
    function n() {
      ...
      n.getWebViewHandle = function () {
        ...
        module2005.default(null != t, 'nodeHandle expected to be non-null');
        return t;
      };
    ...
    n.prototype.render = function () {
      var t = this.props,
        ...
        O = null;
      if ('LOADING' === this.state.viewState) O = (w || module2006.defaultRenderLoading)();
      else if ('ERROR' === this.state.viewState) {
        var H = this.state.lastErrorEvent;
        module2005.default(null != H, 'lastErrorEvent expected to be non-null');
        O = (v || module2006.defaultRenderError)(H.domain, H.code, H.description);
      } else 'IDLE' !== this.state.viewState && console.error('RNCWebView invalid state encountered: ' + this.state.viewState);
      var R = [module2008.default.container, module2008.default.webView, C],
        N = [module2008.default.container, V];
      ...
      var _ = M.component || y,
        P = module2006.createOnShouldStartLoadWithRequest(this.onShouldStartLoadWithRequestCallback, h, u),
    ...
    n.defaultProps = {
      ...
      originWhitelist: module2006.defaultOriginWhitelist,
    };
