var regeneratorRuntime = require('regenerator-runtime'),
  ...
  React = require('react'),
  module13 = require('./13'),
  module2233 = require('./2233'),
  module416 = require('./416'),
  module2234 = require('./2234'),
  ...
  T = (function (t) {
    ...
    function I(t, o) {
      ...
      (s = T.call(this, t, o)).state = {
        ...
        transformAnimation: new module13.Animated.Value(0),
        videoStateString: '',
        videoFrameRate: '',
    ...
    module7.default(I, [
      {
        ...
        value: function () {
          ...
          module2234.VideoManager.cancelRequest = false;
      ...
      },
      {
        ...
        value: function () {
          ...
          module2234.VideoManager.cancelRequest = false;
          module2234.VideoManager.addIceListener(function (o) {
            if (t.videoView)
              t.videoView.sendIceInfoToSDK(o, function (t) {
                console.log('\u53d1\u9001 ICE \u4fe1\u606f \u5230SDK \u6210\u529f');
              });
          });
          module2234.VideoManager.addTurnServerCallback(function (o) {
            t.sendTurnserviceInfoToSdk(o);
          });
          module2234.VideoManager.addSdpListener(function (o) {
            if (t.videoView)
              t.videoView.sendSdpInfoToSDK(o, function (t) {
                console.log('\u53d1\u9001 sdp \u4fe1\u606f \u5230SDK \u6210\u529f');
              });
          });
          module2234.VideoManager.addErrorCodeListener(function (o, n) {
      ...
      },
      {
        ...
        value: function () {
          ...
          module2234.VideoManager.cancelRequest = true;
      ...
      },
      {
        key: 'renderStateView',
        value: function (t) {
          if (!module424.DMM.isV1 && !module424.DMM.isV3) {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            p = n || module13.Dimensions.get('screen').width,
            w = s || 280;

          if (this.state.isFullScreen) {
            u = b.videoView_land;
            c = b.landscapeStyle_show;
            w = module13.Dimensions.get('screen').height;
            p = module13.Dimensions.get('screen').width;
          }
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module2233.default, {
              width: n || p,
              height: s || w,
              ...
              onFirstFrameRendered: function () {
                ...
                module2234.VideoManager.notifyFirstVideoFrameRendered();
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    s.next = 5;
                    return regeneratorRuntime.default.awrap(module416.default.sendSdpInfo(t));
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    s.next = 4;
                    return regeneratorRuntime.default.awrap(module416.default.sendIceInfo(t));
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    module2234.VideoManager.stopCameraPreview(t, n);
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    module2234.VideoManager.startVideoPreview(t, n);
