...
function ue(t) {
  for (var n = 1; n < arguments.length; n++) {
    ...
    n % 2
      ? se(Object(o), !0).forEach(function (n) {
          (0, s.default)(t, n, o[n]);
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(o))
      : se(Object(o)).forEach(function (n) {
...
var De = (function (t) {
  ...
  var n = W,
    ...
    L = function () {
      ...
      if (s) {
        var u = (0, f.default)(this).constructor;
  ...
  function W(t, n) {
    ...
    (o = L.call(this, t, n)).checkOnlyShowGeneralObstacle = function () {
      var t, n;
          ...
          for (;;)
            switch ((s.prev = s.next)) {
              ...
              case 2:
                t = s.sent;
                n = null;
                n = !!D.default.isShowGeneralObstacle() && (!!H.DMM.isV1 || !('on' == t));
                o.setState({
    ...
    o.shouldSelectType = function (t) {
      return -1 != y.RSM.currentMapId || t != Ie.AR || (globals.showToast(ce.switch_ar_map_when_map_unsaved_tip), !1);
    };
                      ...
                      function (n) {
                        for (;;)
                          switch ((n.prev = n.next)) {
                            case 0:
                              n.next = 2;
                              return u.default.awrap(o.changeMapType(t));
    ...
    o.onRotateMap = function (t) {
      var n;
      y.RSM.isRunning
        ? (0, q.showFinishCurrentTastAlertIfNeeded)(o.props.alertHandler).catch(function (t) {
            null == o.props.toastHandler || o.props.toastHandler(ce.robot_communication_exception);
          })
        : null == (n = o.mapView) ||
          n.rotateMap(t, function (t) {
            var n;
            null == (n = o.loadingView) || n.showWithText(ce.rubys_main_diag_update_map);
    ...
    o._handleZoneAddButton = function () {
      ...
      y.RSM.mapStatus != y.MapStatus.None
        ? (o.mapView && o.mapView.enterZoneEditMode(),
          o.mapView && !o.mapView.addRectangle() && globals.showToast(ce.rubys_main_zone_max_tips),
          o.mapView3D && o.mapView3D.enterZoneEditMode(),
          o.mapView3D && o.mapView3D.addRectangle())
    ...
    o.onPressSuppliesUpgradeTip = function () {
      var t = o.suppliesParams.suppliesItem,
        n = o.suppliesParams.suppliesValue,
        s = b.default.percentCalculate(n, t.total);
      t.isUnitsTime || (s = Math.ceil(100 * (1 - n / t.total)));
      var u = s <= 20 && s > 5,
        l = s > 20 ? ce.dust_collection_life10 : u ? ce.dust_collection_life11 : ce.dust_collection_life12,
        c = {
      ...
      o.props.navigation.navigate('SupplyDetailPage', c);
    };

    o.onPressSoundPkgGuide = function () {
      o.navigateTo('SoundPackagePage', {
        title: ce.soundpackage_volume_adjust_title,
      });
      o.onCloseSoundPkgGuide();
    };

    o.onCloseSoundPkgGuide = function () {
      var t;
      return u.default.async(
        function (n) {
          for (;;)
    ...
    o.onOpenErrorDetailPage = function (t) {
      o.navigateTo('ErrorDetailPageNew', {
        title: ce.localization_strings_Main_Error_ErrorDetailPage_0,
        code: t,
      });
    };

    o.closeReminder = function () {
      y.RSM.closeReminder();
      o.updateRobotStatusGuide();
      o.forceUpdate();
    };

    o.closeError = function () {
      return u.default.async(
        function (t) {
          for (;;)
            switch ((t.prev = t.next)) {
              case 0:
                if ((y.RSM.closeError(), o.updateRobotStatusGuide(), o.forceUpdate(), !(y.RSM.dockErrorStatus > 0))) {
                  t.next = 6;
                  break;
                }
    ...
    o._onPressSmartZoneBubble = function (t, n) {
      var s = V.SmartBubbleConfig[n].pageType,
        u = V.SmartBubbleConfig[n].pageTitle,
        l = !t || !t.custom;
      t &&
        s &&
  ...
  (0, c.default)(W, [
    ...
    },
    {
      ...
      value: function () {
        ...
        D.default.isFwFilterObstacleSupported() && k.default.mapObjectPhotoEnabled
          ? this.setState({
    ...
    },
    {
      ...
      value: function () {
        ...
        D.default.isAnalysisSupported() && (0, I.PluginDidReadyForStatisticsTask)();
      },
    },
    {
          ...
          function (l) {
            for (;;)
              switch ((l.prev = l.next)) {
                ...
                case 3:
                  n = l.sent;
                  (s = n ? JSON.parse(n) : (0, o.default)({}))[y.RSM.currentMapId] = t;
                  n = JSON.stringify(s);
                  P.MM.mapRotateAngle = s;
                  l.next = 10;
    ...
    },
    {
      ...
      value: function () {
        return D.default.isMapBeautifyDebugUser() && D.default.isSupportIncrementalMap()
    ...
    },
    {
      ...
      value: function () {
        ...
        var l = {
          ...
          c = M.default.createElement(V.MapView, {
            style: {
              flex: 1,
              ...
              return u.default.async(
                function (c) {
                  for (;;)
                    switch ((c.prev = c.next)) {
                      case 0:
                        n = 'photo' == s.state.mapObstaclesPopBoxType && k.default.mapObjectPhotoPrivacyPolicyAgreed && k.default.mapObjectPhotoEnabled;
                        c.next = 3;
                      ...
                      case 3:
                        if (
                          ...
                          !n || 0 != o || -1 != T.MC.photoPrivacyVersionAgreedOnServer)
                        ) {
                          c.next = 12;
                          break;
                        }
                        ...
                        c.next = 8;
                        return u.default.awrap(s.getPhotoPrivacyVersionAgreedVersionOnServer());

                      case 8:
                        (l = parseInt(T.MC.photoPrivacyVersionAgreedOnServer) == ke.RRPhotoPrivacyVersion)
                          ? ((0, I.LogEventCommon)('tap_map_object'), t && t())
                          : s.photoPrivacyDialog && s.photoPrivacyDialog.show();
                        c.next = 13;
                        break;

                      case 12:
                        n && 0 == o && !l ? s.photoPrivacyDialog && s.photoPrivacyDialog.show() : ((0, I.LogEventCommon)('tap_map_object'), t && t());
            ...
            onSupplementZonesChanged: this.handleSupplementZonesChanged.bind(this),
        ...
        var h = M.default.createElement(
          ...
          f = {},
          S = V.MapUtilManager.adjustChargerAngle(null == P.MM ? void 0 : null == (t = P.MM.parsedMapData) ? void 0 : null == (n = t.charger) ? void 0 : n.angle);
        P.MM.parsedMapData &&
        ...
        if (y.RSM.isOnDock() && P.MM.parsedMapData && P.MM.parsedMapData.robot && P.MM.parsedMapData.charger) {
          ...
          var b = S + H.DMM.robotInMap.chargerAngle + _,
            w = {
              x: 2 * Math.cos(V.MapUtilManager.degreeToRad(S)),
              y: 2 * Math.sin(V.MapUtilManager.degreeToRad(S)),
            };
          v.adjustRobot = {
        ...
        var C = P.MM.mapRotateAngle[y.RSM.currentMapId] || 0,
          E = M.default.createElement(Y.default, {
            style: {
              flex: 1,
              justifyContent: 'center',
              alignSelf: 'stretch',
          ...
          F = D.default.isSupportQuickMapBuilder() && y.RSM.mapSaveEnabled && !G && this.state.noMapTip,
          N = M.default.createElement(B.default, {
            ...
            onPressQuickCreateMap: function () {
              var t;
              return null == (t = s.quickCreateMapGuide) ? void 0 : t.show();
            },
        ...
        if (this.state.hasGotMap && !this.state.isLocating) {
          ...
          var L = c;
          this.state.mapType == Ie.AR && this.state.arMapMatchParam ? (L = h) : this.state.mapType == Ie.THREE && (L = E);
          return L;
        }
      ...
      value: function () {
        var t = this.context.theme.homeSidebar,
          n =
            ...
            D.default.isVideoMonitorSupported() &&
            !b.default.isShareUser() &&
            !Me.isMiApp &&
            D.default.isVideoMonitorModelSupported(),
          o =
    ...
    },
    {
      ...
      value: function () {
        ...
        return M.default.createElement(
          ...
          D.default.isSupportMainSlideForMapShow() &&
            M.default.createElement(
              ge,
              {
                style: {},
    ...
    },
    {
      ...
      value: function () {
        ...
        return (H.DMM.isV2 || H.DMM.isV4 || H.DMM.isV5 || D.default.isDebuggableV1User()) && !D.default.is2022CESIpad() ? n : null;
      },
    },
    {
    ...
    },
    {
      ...
      value: function () {
        var t = this,
          n = H.DMM.isTopazSV || H.DMM.isPearlPlus ? ce.camera_monitor_voice_privacy_title : ce.camera_monitor_privacy_title;
        return M.default.createElement(F.MonitorPrivacyDialogWithNavbar, {
          ...
          title: n,
          privacyTitle: H.DMM.isTopazSV || H.DMM.isPearlPlus ? ce.monitor_voice_privacy_dialog_title : ce.monitor_privacy_dialog_title,
          onConfirm: function () {
    ...
    },
    {
      ...
      value: function () {
        var t = this,
          ...
          o = n && D.default.isWashThenChargeCmdSupported(),
        ...
        !D.default.isBackChargeAutoWashSupported() &&
          o &&
          !l &&
          c.push({
    ...
    },
    {
      ...
      value: function () {
        ...
        var n = this.context.theme,
          ...
          p = D.default.isFirmwareProgressSupported() && y.RSM.state == y.RobotState.UPDATING;
        return M.default.createElement(
          M.default.Fragment,
          null,
          M.default.createElement(ge, {
          ...
          function (l) {
            for (;;)
              switch ((l.prev = l.next)) {
                ...
                case 2:
                  if (((this.tabIndex = t), (n = t == U.TabGlobal), (o = t == U.TabZone), (s = t == U.TabSegment), t == U.TabNeutral, !o || this.state.mapType == Ie.NORMAL)) {
                    l.next = 12;
                    break;
                  }
          ...
          function (f) {
            for (;;)
              switch ((f.prev = f.next)) {
                case 0:
                  if (!((H.DMM.isTanosV && Me.apiLevel < 10005) || ((H.DMM.isTopazSV || H.DMM.isPearlPlus || H.DMM.isTanosSV) && Me.apiLevel < 10010))) {
                    f.next = 3;
                    break;
                  }
        ...
        setTimeout(function () {
          t.alert &&
            t.alert.customAlert(
              ...
              '',
              function () {
                D.default.isMultiFloorSupported();
        ...
        return u.default.async(
          function (o) {
            for (;;)
              switch ((o.prev = o.next)) {
                case 0:
                  if (y.RSM.state != y.RobotState.UPDATING && D.default.isAvoidCollisionSupported() && !this.hasCheckedCollisionAlert) {
                    o.next = 2;
                    break;
                  }
    ...
    },
    {
      ...
      value: function () {
        ...
        if (y.RSM.state != y.RobotState.UPDATING && !k.default.hasShownPetModeAlert && D.default.isPetModeSettingSupported() && !this.hasCheckedPetAlert && !y.RSM.isRunning) {
          this.hasCheckedPetAlert = !0;
          if (k.default.cameraEnabled)
            setTimeout(function () {
              O.Log.log(O.LogTypes.Home, 'begin update pet status,' + JSON.stringify(k.default), O.InfoColors.Normal, !0);
              t.addGuide([
                {
          ...
          function (t) {
            for (;;)
              switch ((t.prev = t.next)) {
                ...
                case 2:
                  if ((this.mapView && this.mapView.setAllCleanMopMode(P.MM.customCleanModes), this.handleCleanWaterModeDidChange(), !D.default.isMultiFloorSupported())) {
                    t.next = 7;
                    break;
                  }
    ...
    },
    {
      ...
      value: function () {
        ...
        if (D.default.isMultiFloorSupported() || y.RSM.mapSaveEnabled) {
          D.default.isMultiFloorSupported();
          var n = 'MultiFloorPage';
          this.navigateTo(n, {
    ...
    {
      key: 'handleSupplementZonesChanged',
      value: function (t) {
        globals.dlog('dymamic zones', 'handleSupplementZonesChanged num: ' + t);
        var n =
          t > 0
            ? '' +
              '\u5df2\u8865\u589e${num}\u4e2a\u533a\u57df'.templateStringWithParams({
                zones: t,
              })
            : '';
        this.setState({
    ...
    },
    {
      ...
      value: function (t) {
        ...
        D.default.isCarpetSupported() && !H.DMM.isGarnet
        ...
        return u.default.async(
          function (n) {
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  if (!this.hasCheckedOfflineMapGuide && D.default.isOfflineMapSupported()) {
                    n.next = 2;
                    break;
                  }
                ...
                case 2:
                  if (
                    ...
                    !(
                      ...
                      D.default.isFwFilterObstacleSupported() &&
    ...
    },
    {
      ...
      value: function () {
        var t;
        y.RSM.unsaveMapReason == y.UnsaveMapReason.MapMess &&
          -1 != y.RSM.currentMapId &&
          y.RSM.hasGotMapFirstTime &&
          ...
          function (M) {
            for (;;)
              switch ((M.prev = M.next)) {
                ...
                case 5:
                  if (!(D.default.isSupportCliffZone() && (null == (t = P.MM.mapData) ? void 0 : null == (n = t.clffbz) ? void 0 : null == (o = n.fbzs) ? void 0 : o.length) > 0)) {
                    M.next = 10;
                    break;
                  }

                  M.next = 8;
                  return u.default.awrap(this.dealShowAIGuide(V.SmartBubbleType.BT_CLIFF));
                ...
                case 10:
                  if (
                    !(D.default.isSupportStuckZone() && (null == (s = P.MM.mapData) ? void 0 : null == (l = s.stuckpts) ? void 0 : null == (c = l.data) ? void 0 : c.length) > 0)
                  ) {
                    M.next = 15;
                    break;
                  }
                  ...
                  M.next = 13;
                  return u.default.awrap(this.dealShowAIGuide(V.SmartBubbleType.BT_STUCK));
                ...
                case 15:
                  if (
                    !(
                      D.default.isSupportSmartDoorSill() &&
                      (0, V.canEditDoorSill)() &&
                  ...
                  M.next = 18;
                  return u.default.awrap(this.dealShowAIGuide(V.SmartBubbleType.BT_DOORSILL));
          ...
          function (c) {
            for (;;)
              switch ((c.prev = c.next)) {
                case 0:
                  c.next = 2;
                  return u.default.awrap((0, R.GetStorageKey)(R.StorageKeys.AIZonesGuideMain));

                case 2:
                  if (
                    ((n = c.sent),
                    (o = !n || 0 == (parseInt(n) & t)),
                    !((t == V.SmartBubbleType.BT_CLIFF && o) || t == V.SmartBubbleType.BT_DOORSILL || t == V.SmartBubbleType.BT_STUCK))
                  ) {
                    c.next = 13;
                    break;
                  }

                  l = V.SmartBubbleConfig[t].guideTxt;
                  o && l && this.showAIReminderView(l);
                  null == (s = this.mapView) || s.findSmartBubbleShowGuide(t);
                  c.next = 12;
                  return u.default.awrap((0, R.SetStorageKey)(R.StorageKeys.AIZonesGuideMain, n ? (parseInt(n) | t).toString() : t.toString()));
    ...
    },
    {
      ...
      value: function (t) {
        ...
        this.AIReminderTimer && Pe.clearTimeout(this.AIReminderTimer);
        this.AIReminderTimer = Pe.setTimeout(this.hideAIReminderView.bind(this), 5e3);
      },
    },
    {
    ...
    },
    {
      ...
      value: function () {
        Ce = D.default.isSharedAllowed() && 'cn' == y.RSM.serverCode;
        xe = Ce ? 1 : 0;
      },
    },
    {
    ...
    },
    {
      ...
      get: function () {
        ...
        !D.default.is2022CESIpad() && o.push(t);
        return o;
      },
    },
    {
...
exports.default = De;
De.contextType = W.AppConfigContext;
var Ve = pe.create({
  container: {
    flex: 1,
  ...
  debugButton: {
    position: 'absolute',
    top: 216 + (L.StatusBar.currentHeight || 0) + Se.AppBarMarginTop,
    left: 10,
  },
  videoButton: {
    position: 'absolute',
    top: 245 + (L.StatusBar.currentHeight || 0) + Se.AppBarMarginTop,
    right: 10,
    width: 60,
    height: 60,
  },
  ...
  mapEditMenu: {
    position: 'absolute',
    top: 150 + (L.StatusBar.currentHeight || 0) + Se.AppBarMarginTop,
    right: 20,
    width: 40,
    height: 92,
  },
  mapDiffText: {
    position: 'absolute',
    top: 160 + (L.StatusBar.currentHeight || 0) + Se.AppBarMarginTop,
    left: 30,
    height: 30,
    width: 300,
    fontSize: 15,
