        ...
        value: function (t, l, n) {
          var o,
            ...
            h = {
              ...
              slopeAngle: l,
              id: s,
              type: module1126.DoorSillType.RealSill,
              newAdded: true,
              heightLock: n,
            };
        ...
        value: function () {
          ...
          if (
            this.state.data.filter(function (t) {
              return !t.type || t.type != module1126.DoorSillType.SmartSill;
            }).length >= module1126.DoorConfig.max_count
          ) {
      ...
      },
      {
        ...
        value: function (t, l, n) {
          if (this.state.data && !(this.state.data.length <= 0)) {
            ...
            if (o) {
              if (o.type == module1126.DoorSillType.SmartSill && this.checkMaxCount()) return;
              if (l) o.rectSize = l;
              if (null != n && undefined !== n) o.slopeAngle = n;
              if (o.type == module1126.DoorSillType.SmartSill) o.aiToReal = true;
              o.type = module1126.DoorSillType.RealSill;
              this.setState({
                data: this.state.data,
              });
      ...
      },
      {
        ...
        value: function (t) {
          ...
          var n = {
            ...
            o = this.props.mapMode == module1343.MAP_MODE_DOORSILL_EDIT;
          return this.state.data.map(function (s, h) {
            if (s.type && s.type === module1126.DoorSillType.SmartSill && (!o || !module1197.canEditDoorSill())) return null;
            var c = s.rectSize.width >= s.rectSize.height,
              y = s.type != module1126.DoorSillType.SmartSill ? 'rect_zone_doorsill' : 'map_smart_doorsill',
              v = s.type != module1126.DoorSillType.SmartSill ? null : module1126.MapAITag;
