          ...
          return [
            {
              ...
              bottomDetail: module510.robot_setting_air_dry_desc,
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    n.prev = 0;
                    n.next = 3;
                    return regeneratorRuntime.default.awrap(module416.default.getFanMotorWorkTimeout());
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    c.next = 5;
                    return regeneratorRuntime.default.awrap(module416.default.setFanMotorWorkTimeout(t ? n : 0));

                  case 5:
                    s = c.sent;
                    if (module381.RSM.isAirDrying && !t) globals.showToast(module510.setting_air_dry_close_prompt);
                ...
                switch ((o.prev = o.next)) {
                  case 0:
                    if (!(null == (t = globals.Alert)))
                      t.alert(module510.setting_stop_air_dry_desc, '', [
                        {
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    n.prev = 0;
                    n.next = 3;
                    return regeneratorRuntime.default.awrap(module416.default.stopAirdryMop());
...
exports.default = module2134;
module2134.contextType = module1199.AppConfigContext;
