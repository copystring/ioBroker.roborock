  ...
  function k() {
    ...
    t._handleDrawerOpen = function () {
      t.props.navigation.dispatch({
        type: module1281.default.DRAWER_OPENED,
    ...
    t._handleDrawerClose = function () {
      t.props.navigation.dispatch({
        type: module1281.default.DRAWER_CLOSED,
        key: t.props.navigation.state.key,
      });
    };
      ...
      value: function () {
        ...
        return React.default.createElement(
          module1283.default,
          {
            ...
            drawerPosition: 'right' === this.props.navigationConfig.drawerPosition ? module1283.default.positions.Right : module1283.default.positions.Left,
          },
