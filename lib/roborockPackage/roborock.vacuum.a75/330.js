...
var module14 = require('./14'),
  ...
  p = {
    showActionSheetWithOptions: function (t, o) {
      module14('object' == typeof t && null !== t, 'Options must be a valid object');
      module14('function' == typeof o, 'Must provide a valid callback');
      module14(module331.default, "ActionSheetManager does't exist");
      var s = t.tintColor,
    ...
    showShareActionSheetWithOptions: function (t, o, n) {
      module14('object' == typeof t && null !== t, 'Options must be a valid object');
      module14('function' == typeof o, 'Must provide a valid failureCallback');
      module14('function' == typeof n, 'Must provide a valid successCallback');
      module14(module331.default, "ActionSheetManager does't exist");
