...
var module1928 = (function (t) {
  ...
  function A(t) {
    ...
    if (
      ...
      ((n = module1928.call(this, t)).onPressAddMap = function () {
      ...
      (n.dataProvider = module390.default.isMultiFloorSupported() ? new module1347.MultiMapDataProvider() : new module1347.SingleMapDataProvider()),
      (n.mapUpdated = true),
      (n.lastMap = null),
  ...
  module7.default(A, [
            ...
            n.loadEditingMap(t)
              ...
              .catch(function (t) {
                ...
                if (t != B) {
                  ...
                  module1200.showFinishCurrentTastAlertIfNeeded(n.props.alertHandler).catch(function (t) {
      ...
      value: function (t) {
        ...
        if (
          ...
          if ('' != o) {
            var l,
              s,
              p = module1214.FloorMapPageUtils.getRealLength(o);
            if (module1214.FloorMapPageUtils.getRealLength(o) >= 30) null == (l = (s = this.props).toastHandler) || l.call(s, module510.floor_map_name_too_long);
    ...
    },
    {
      ...
      value: function () {
        ...
        var o = {
            ...
            onPress: function () {
              if (module381.RSM.isRunning)
                module1200.showFinishCurrentTastAlertIfNeeded(t.props.alertHandler).catch(function (n) {
    ...
    },
    {
      ...
      value: function () {
        var t = this;
        return React.default.createElement(module1124.MultiMapSelectView, {
    ...
    },
    {
      ...
      value: function () {
        ...
        var T,
          ...
          module1928 = this.getTopButtons(),
          A = (null == module1928 ? undefined : module1928.length) ? p / module1928.length : 0,
          F = {
          ...
          W = (!this.props.isTitleViewHidden && !y) || (null == module1928 ? undefined : module1928.length) > 0,
          ...
          Z = React.default.createElement(module1124.MultiMapHintModal, {
            ref: function (t) {
        ...
        return React.default.createElement(
          ...
          !this.props.isTitleViewHidden &&
            (module381.RSM.mapSaveEnabled
              ? ((T = {
                ...
                (E = P ? l.currentMapSource : require('./1928')),
          ...
          !this.props.isTitleViewHidden && H && module1929,
    ...
    },
    {
      ...
      get: function () {
        var t,
          n,
          o = this;
        return module1214.FloorMapPageUtils.getRealName(
          null !=
            (t =
              null ==
...
module1928.contextType = module1199.AppConfigContext;
module1928.defaultProps = {
...
var N = module13.StyleSheet.create({
    mainView: {
      ...
      borderBottomLeftRadius: module1343.AppBorderRadius,
      borderBottomRightRadius: module1343.AppBorderRadius,
      borderWidth: 1,
      borderColor: 'white',
    },
    bottomButtonView: {
  ...
  A = module385.HocBottomModal(module385.WithSwipeToClose(module1928), !module393.isMiApp || 'android' != module13.Platform.OS);
exports.default = A;
