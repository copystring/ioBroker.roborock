  ...
  R = (function (t) {
    ...
    function _(t) {
      ...
      n.state = {
        ...
        angle: new module13.Animated.Value(0),
        offset: new module13.Animated.Value(0),
        isControlling: false,
        isAnimating: false,
    ...
    module7.default(_, [
      ...
      },
      {
        ...
        value: function (t) {
          if (module381.RSM.state == module381.RobotState.BACK_TO_DOCK || module381.RSM.isCleanTaskShouldResume() || module381.RSM.isCleaning()) {
            ...
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 8:
                    n = s.sent;
                    console.log('callMethod remote - ' + JSON.stringify(n));
      ...
      },
      {
        ...
        value: function (t) {
          var n = this;
          module1420.setTimeout(function t() {
            return (
              n._panView &&
              n._panView.measure(function (o, s, l, u, c, h) {
                if ((console.log('RemoteControlJoyStickView::measure:', o, s, l, u, c, h), n._panViewLayout && n._panViewLayout.pageX === c && n._panViewLayout.pageY === h))
      ...
      },
      {
        ...
        value: function (t, n) {
          ...
          if (u > this.state.radiusLimit) {
            h = (u = this.state.radiusLimit) * Math.sin(f);
            p = u * Math.cos(f);
          }
          ...
          if (c <= (39 * -Math.PI) / 40) {
            ...
            h = 0;
            p = 0;
          } else if (c < this.state.angleLimitLower) {
            f = this.state.angleLimitLower;
            p = h / Math.tan(f);
            u = Math.sqrt(h * h + p * p);
          } else if (c >= (39 * Math.PI) / 40) {
            f = 0;
            u = 0;
            h = 0;
            p = 0;
          ...
          var v = Math.PI / 3,
            M = p <= 0 ? 0 : (p / this.state.radiusLimit) * 0.29,
            S = (-h / this.state.radiusLimit) * v,
            y = {
              angle: f,
              dL: u,
      ...
      },
      {
        ...
        value: function (t, n) {
          ...
          var s = [],
            l = module13.Animated.timing(this.state.angle, {
              toValue: t,
              duration: 100,
            });

          if ((s.push(l), 'number' == typeof n)) {
            var u = module13.Animated.timing(this.state.offset, {
              toValue: n,
              duration: 100,
            });
            s.push(u);
          ...
          module13.Animated.parallel(s).start(
            function () {
              if (0 === t || 0 === n) module13.Animated.delay(50).start(c);
              else c();
            },
            {
              stopTogether: false,
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            o = this.context.theme.remoteControl.imageDefaultJoy,
