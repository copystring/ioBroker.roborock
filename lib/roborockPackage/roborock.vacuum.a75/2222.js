...
var P,
  ...
  module2223 = module393.isRecordSupported() ? require('./2223') : module13.View,
  M = module13.NativeModules.RRRecorder,
  O = 0,
  module2224 = (function (t) {
    module9.default(C, t);
    ...
    function C(t, n) {
      ...
      (o = module2225.call(this, t))._onVolumeChanged = function (t) {
        var n = t.nativeEvent;
    ...
    module7.default(C, [
          ...
          this.Gesture = {
            ...
            onResponderRelease: function (n) {
              ...
              if (
                ...
                t.setState({
                  text: module510.long_press_to_send_voice,
                  icon: t.props.isLandscape ? require('./2224') : t.context.theme.monitor.recordImg,
                }),
                clearTimeout(P),
                t.state.recording)
              ) {
      ...
      },
      {
        ...
        value: function () {
          ...
          this.setState({
            ...
            icon: this.props.isLandscape ? require('./2225') : this.context.theme.monitor.recordSelImg,
          });
                ...
                switch ((t.prev = t.next)) {
                  ...
                  case 9:
                    ...
                    this.setState({
                      recording: false,
                      text: module510.long_press_to_send_voice,
                      icon: this.props.isLandscape ? require('./2224') : this.context.theme.monitor.recordImg,
                    });
      ...
      },
      {
        key: 'robotPlayAudio',
        value: function (t) {
          var n, module22, module6, module7, module9, module11, module12, React, module13, module1199;
          return regeneratorRuntime.default.async(
            function (b) {
              for (;;)
                switch ((b.prev = b.next)) {
                  ...
                  case 7:
                    ...
                    module1199 = JSON.parse(JSON.stringify(module13));
                    b.next = 19;
                    return regeneratorRuntime.default.awrap(module416.default.playAudio(module1199));
...
exports.default = module2224;
module2224.contextType = module1199.AppConfigContext;
