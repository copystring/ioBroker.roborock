        ...
        var module2072 = this.getInnerFailedView(require('./2072'), module510.button_title_retry),
          ...
          F = React.default.createElement(
            ...
            React.default.createElement(
              ...
              f,
              this.state.readPhotoLoadingStatus == R.LOADING && module1421,
              this.state.readPhotoLoadingStatus == R.FAILED && module2072
            )
          ),
          ...
          module2097 = this.state.isSure ? require('./2097') : o.monitor.confirmPhoto;
        return React.default.createElement(
          module13.View,
          {
            style: [
          ...
          React.default.createElement(
            ...
            React.default.createElement(
              ...
              module390.default.isFwFilterObstacleSupported() && module1639.default.mapObjectPhotoEnabled && u && u.length >= 1 ? F : module2073,
              React.default.createElement(
                module13.Text,
