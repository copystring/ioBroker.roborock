...
var P = Boolean(module13.NativeModules.NativeAnimatedModule),
  x = (function (t) {
    module9.default(_, t);
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            S = module13.Animated.multiply(this.state.scrollAmount, -1);
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                p.map(function (n, l) {
                  ...
                  var P = module13.StyleSheet.flatten(t.props.tabStyle),
...
exports.default = x;
x.propTypes = w(
  w({}, module1317.SceneRendererPropType),
  {},
  {
    scrollEnabled: PropTypes.default.bool,
    bounces: PropTypes.default.bool,
    pressColor: module1316.default.propTypes.pressColor,
    pressOpacity: module1316.default.propTypes.pressOpacity,
