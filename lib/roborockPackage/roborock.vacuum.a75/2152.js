...
var module393 = require('./393'),
  b = (function (t, ...args) {
    ...
    function k() {
      ...
      t.contentOffsetY = 0;
      t.state = {
        customCommands: new module1968.CommandListSectionData(module1968.LocalizationStrings.smart_scene_custom_commands, []),
        recommendCommands: new module1968.CommandListSectionData(module1968.LocalizationStrings.smart_scene_recommend_commands, []),
        renaming: false,
        isLoading: false,
        isSorting: false,
      };
    ...
    module7.default(k, [
      ...
      },
      {
        ...
        value: function () {
          ...
          var c = this.commandsCount >= module1968.MaxCommandCount ? [] : [new module1968.CommandCardData(null, module1968.CommandCardType.Add, null)];
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(module2153.default, {
                data: new module1968.CommandListSectionData(module1968.LocalizationStrings.smart_scene_custom_commands, [].concat(module31.default(this.commandsData), c)),
                titleStyle: {
                  fontSize: 32,
                  fontWeight: 'bold',
                },
              ...
              React.default.createElement(module1508.default, {
                ref: function (t) {
                  return (s.actionSheet = t);
                },
                title: module1968.LocalizationStrings.smart_scene_more,
            ...
            React.default.createElement(module2165.default, {
              ref: function (t) {
      ...
      },
      {
        ...
        value: function () {
          if (module381.RSM.isRunning) globals.showToast(module1968.LocalizationStrings.auto_split_will_trigger_after_cleaning_and_charing);
          else {
            module1968.SmartSceneLog('\u8df3\u8f6c -- \u6dfb\u52a0\u6307\u4ee4');
            this.props.navigation.navigate('SmartCommandEditView', {
              title: module1968.LocalizationStrings.smart_scene_edit_title,
      ...
      },
      {
        ...
        value: function (t) {
          if (this.commandsCount >= module1968.MaxCommandCount) globals.showToast(module1968.LocalizationStrings.smart_scene_reached_max_command_count_toast_hint);
          else if (module381.RSM.isRunning) globals.showToast(module1968.LocalizationStrings.auto_split_will_trigger_after_cleaning_and_charing);
      ...
      },
      {
        ...
        value: function (t) {
          switch ((this.settingModal.hide(), this.actions[t])) {
            case module1968.SmartCommandAction.Edit:
              if (module381.RSM.isRunning) return void globals.showToast(module1968.LocalizationStrings.auto_split_will_trigger_after_cleaning_and_charing);
              else {
                module1968.SmartSceneLog('\u8df3\u8f6c\u7f16\u8f91\u6307\u4ee4, \u4f20\u5165\u6307\u4ee4\u6570\u636e: ' + JSON.stringify(this.commandsData[this.editingIndex]));
            ...
            case module1968.SmartCommandAction.EditTimer:
              return void this.props.navigation.navigate('SmartCommandTimer', {
                title: module1968.LocalizationStrings.localization_strings_Setting_Timer_SettingPage_16,
                data: this.commandsData[this.editingIndex],
                onEditTimer: this.onEditTimer.bind(this),
                autoActivateTrigger: true,
              });

            case module1968.SmartCommandAction.Rename:
              return void this.setState({
                renaming: true,
              });

            case module1968.SmartCommandAction.Sort:
              return void this.setState({
                isSorting: true,
              });

            case module1968.SmartCommandAction.Delete:
        ...
        value: function () {
          var t = this,
            n = function () {
              ...
              module1968.SmartSceneLog('\u5373\u5c06\u83b7\u53d6\u670d\u52a1\u7aef\u547d\u4ee4\u5217\u8868.');
              module1967.SmartSceneAPI.getCommandList()
                .then(function (n) {
                  ...
                  t.setState({
                    customCommands: new module1968.CommandListSectionData(module1968.LocalizationStrings.smart_scene_custom_commands, o),
                  });
                  t.setState({
                    isLoading: false,
                  });
                  t.doOperationsFromAppIfNeeded(function () {
                    var n, o, s;
                    console.log('TIDList: ' + (null == (n = module1967.SmartSceneAPI.commandListCache) ? undefined : n.tidList));
                    t.sync(null != (o = null == (s = module1967.SmartSceneAPI.commandListCache) ? undefined : s.tidList) ? o : []);
                  });
                })
                .catch(function (t) {
                  module1968.SmartSceneLog('\u83b7\u53d6\u670d\u52a1\u7aef\u547d\u4ee4\u5217\u8868\u5931\u8d25. ' + JSON.stringify(t));
                })
                .finally(function () {
                  t.setState({
                    isLoading: false,
      ...
      },
      {
        ...
        value: function () {
          var t =
            module390.default.isShakeMopSetSupported() && !(module424.DMM.isUltronE || module424.DMM.isUltronLite)
              ? [module1968.RecommendGlobal, module1968.RecommendDiningArea, module1968.RecommendCleanThenMop]
              : [module1968.RecommendGlobal, module1968.RecommendDiningArea];
          this.setState({
            recommendCommands: new module1968.CommandListSectionData(module1968.LocalizationStrings.smart_scene_recommend_commands, t),
          });
        },
      },
      {
        ...
        value: function (t) {
          ...
          if (null != c && undefined != c) {
            if (this.commandsCount >= module1968.MaxCommandCount) {
              globals.showToast(module1968.LocalizationStrings.smart_scene_reached_max_command_count_toast_hint);
              return void (null == t || t());
            }

            if (module381.RSM.isRunning) {
              globals.showToast(module1968.LocalizationStrings.auto_split_will_trigger_after_cleaning_and_charing);
              return void (null == t || t());
            }
      ...
      },
      {
        key: 'sync',
        value: function (t) {
          module1968.SmartSceneLog('\u5373\u5c06\u540c\u6b65TID, \u5f53\u524d\u6709\u6548\u4e91\u7aefTID: ' + t);
          var module22 = [];
          module1968.SmartSceneLog('\u5373\u5c06\u83b7\u53d6\u8bbe\u5907TID.');
          module416.default
            .getScenes()
            .then(function (o) {
              var s;
              ...
              module1968.SmartSceneLog('\u83b7\u53d6\u8bbe\u5907TID\u6210\u529f, \u6709\u6548\u7684\u8bbe\u5907TID: ' + module22);
              return module1967.SmartSceneAPI.sync(module22, t);
            })
            .then(function (t) {
              module1968.SmartSceneLog('\u540c\u6b65TID\u6210\u529f, \u6709\u6548\u7684\u8bbe\u5907TID: ' + t);
            })
            .catch(function (t) {
              module1968.SmartSceneLog('\u540c\u6b65TID\u5931\u8d25, ' + JSON.stringify(t));
            });
        },
      },
      {
        ...
        value: function (t) {
          var n,
            o = this;
          module1967.SmartSceneAPI.renameCommand(null == (n = this.commandsData[this.editingIndex]) ? undefined : n.id, t)
            .then(function () {
      ...
      },
      {
        ...
        value: function () {
          var t,
            n = this;
          module1967.SmartSceneAPI.deleteCommand(null == (t = this.commandsData[this.editingIndex]) ? undefined : t.id)
            .then(function () {
      ...
      },
      {
        ...
        value: function (t, n) {
          switch (t) {
            case module1968.SmartSceneTemplateID.GlobalClean:
              this.addRecommendCommand(module1968.RecommendGlobal, n);
              break;

            case module1968.SmartSceneTemplateID.DiningAreaClean:
              return void this.addRecommendDiningAndClean(n);

            case module1968.SmartSceneTemplateID.NewCommand:
              return void (null == n || n());

            case module1968.SmartSceneTemplateID.CleanAndMop:
              this.addRecommendCommand(module1968.RecommendCleanThenMop, n);
              break;
      ...
      },
      {
        ...
        value: function (t, o) {
          var s,
            c = this,
            l = module22.default(new module1968.CommandCardData(), t),
            u = null != (s = null == l ? undefined : l.tasks) ? s : [];
          this.startLoading();
          Promise.all(
            u.map(function (t) {
              return module1967.SmartSceneAPI.syncTaskToRobot(t);
            })
          )
            .then(function () {
              return module1967.SmartSceneAPI.addCommand(l.name, l.actionModel);
            })
            .then(function (t) {
              l.type = module1968.CommandCardType.Custom;
              l.id = t;
              c.commandsData.splice(0, 0, l);
              c.setState({
                customCommands: c.state.customCommands,
              });
              globals.showToast(module1968.LocalizationStrings.smart_scene_add_command_success);
            })
            .catch(function (t) {
              globals.showToast(module1968.LocalizationStrings.map_object_ignore_failed);
            })
        ...
        value: function (t) {
          var o,
            ...
            u = function () {
              ...
              var c = {
                  name: module1968.RecommendDiningArea.name,
                  data: [
                    {
                      id: 0,
                      name: module1968.LocalizationStrings.smart_scene_add_dining_room_and_kitchen_hint,
                      mode: module1969.SmartSceneMode.Segment,
                      customMode: module1968.RecommendDiningArea.tasks[0].customMode,
                      data: {
                        segs: [].concat(o, s),
                      },
                      isModeFixed: true,
              ...
              if (o.length > 0 && s.length > 0 && u) {
                var h,
                  f = module22.default(new module1968.CommandCardData(), module1968.RecommendDiningArea);
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (-1 == n) {
            module1968.SmartSceneLog('\u63a5\u6536\u5230\u6dfb\u52a0\u6307\u4ee4\u6210\u529f\u56de\u8c03 - ' + JSON.stringify(t));
      ...
      },
      {
        ...
        get: function () {
          ...
          return o
            ? [module1968.SmartCommandAction.Edit, module1968.SmartCommandAction.Rename, module1968.SmartCommandAction.Delete]
            : s
            ? [
                module1968.SmartCommandAction.Edit,
                module1968.SmartCommandAction.EditTimer,
                module1968.SmartCommandAction.Rename,
                module1968.SmartCommandAction.Sort,
                module1968.SmartCommandAction.Delete,
              ]
            : [module1968.SmartCommandAction.Edit, module1968.SmartCommandAction.EditTimer, module1968.SmartCommandAction.Rename, module1968.SmartCommandAction.Delete];
        },
      },
      {
        key: 'commandsData',
