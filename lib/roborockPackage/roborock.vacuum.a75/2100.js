  ...
  q = (function (t) {
    ...
    function V(t) {
      ...
      (n = L.call(this, t)).gotoZoneInfoPage = function () {
        n.props.navigation.navigate('MapEditZoneInfoPage', {
          ...
          initAction: module1198.EditAction.Name,
        });
      };
    ...
    module7.default(V, [
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = module1349.default.guideButton(this.onNavigationGuidePress, function (n) {
              t.guideButton = n;
            }),
            s = module1349.default.confirmButton(this.onNavigationSavePress, false, function (n) {
              t.mapSaveButton = n;
            }),
            o = this.showSmartMenu ? [n] : [s];
          module1349.default.setNavigation(this, globals.isRTL ? o.reverse() : o, this.onNavigationBackPress.bind(this));
        },
      },
      {
        key: 'initMapView',
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module1349.default.isEditedByArrays(this.originalSelectedSegements, this.selectedSegements)) {
            var n,
              s = {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            s = React.default.createElement(module1124.MapView, {
              ref: function (n) {
                t.mapView = n;
              },
              ...
              inBlockMode: true,
              hideAccessory: true,
              blockBubbleShowInfo: module1124.BlockBubbleShowInfo.CLEANSEQUENCE | module1124.BlockBubbleShowInfo.DISPLAYNAME,
            ...
            o = React.default.createElement(module1198.default, {
              type: module1198.MenuType.Menu_Order,
              ref: function (n) {
                return (t.editMenu = n);
              },
              onPressGuideButton: this.onNavigationGuidePress,
            }),
            u = React.default.createElement(module1198.default, {
              type: module1198.MenuType.Menu_Order_Smart,
              ref: function (n) {
                return (t.editMenu = n);
              },
              hasConfirmMenu: true,
          ...
          var h = module1349.default.resetButton(module510.reset_order_button_title, this.state.isResetOrderEnable, this.onResetButtonPressed);
...
exports.default = q;
q.contextType = module1199.AppConfigContext;
