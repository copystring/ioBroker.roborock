...
switch (module13.Platform.OS) {
  case 'android':
    o = require('./1294').default;
    break;

  case 'ios':
    o = require('./1295').default;
    break;

  default:
    o = require('./1296').default;
}
...
var P = (function (t) {
  ...
  function v(t) {
    ...
    var o = n.props.navigationState,
      ...
      f = new module13.Animated.Value(0),
      l = new module13.Animated.Value(-o.index * u.width),
      p = new module13.Animated.ValueXY({
        x: u.width || 0.001,
        y: u.height || 0.001,
      }),
      y = module13.Animated.multiply(module13.Animated.divide(module13.Animated.add(f, l), p.x), -1);
    n.state = {
      layout: u,
      layoutXY: p,
      panX: f,
  ...
  module7.default(v, [
    ...
    },
    {
      ...
      value: function () {
        ...
        return (
          <module13.View collapsable={false} style={[O.container, this.props.style]}>
            {c && c(p)}
            <module13.View onLayout={this._handleLayout} style={O.pager}>
              {s(
                w(
                  w(w({}, p), l),
                  {},
...
exports.default = P;
P.propTypes = {
  navigationState: module1293.NavigationStatePropType.isRequired,
