      ...
      },
      {
        ...
        value: function () {
          ...
          var c = this.getTopMenus().map(function (t, n) {
            ...
            module2076 = this.getMenus().map(function (t, n) {
              return t.visible
                ? t.title
                  ? React.default.createElement(
                      module385.SettingListItemView,
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                module390.default.shouldShowCarpetSettingView() && module2076
              ),
                ...
                switch ((l.prev = l.next)) {
                  ...
                  case 4:
                    if (
                      ...
                      (l.t0 = !this.isCarpetSwitchEnabled(t)),
                      !l.t0)
                    ) {
                      l.next = 12;
                      break;
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    o.next = 4;
                    return regeneratorRuntime.default.awrap(module1200.showFinishCurrentTastAlertIfNeeded());
