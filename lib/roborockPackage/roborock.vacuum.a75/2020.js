...
var module1420 = require('./1420'),
  ...
  C = (function (t) {
    ...
    function E(t) {
      ...
      s.host = module1343.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].host;
      s.state = {
        progress: -1,
            ...
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 8:
                    this.timer = module1420.setInterval(this.getProgess.bind(this), 1e3);
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    c.next = 4;
                    return regeneratorRuntime.default.awrap(module2023.default.getListDataFromLocal());
      ...
      },
      {
        ...
        value: function (t, s, n) {
          return 'normal' == s
            ...
            : 'special' == s
            ? React.default.createElement(module2021.default, {
                progress: t.voice_id == this.state.currentDownloadVoiceId ? this.state.progress : -1,
                data: t,
                rowId: n,
                showTopLine: false,
              ...
              for (;;)
                switch ((v.prev = v.next)) {
                  ...
                  case 3:
                    ...
                    module1420.clearInterval(this.timer);
                    this.downloading = false;
                    this.setState({
                      progress: -1,
