      ...
      },
      {
        ...
        value: function () {
          var t = this.context.theme.soundPackage,
            ...
            u = React.default.createElement(module2022.default, {
              progress: this.state.progress,
              style: E.progressView,
            }),
            _ = this.state.progress >= 0 && this.state.progress < 1 ? u : c,
            P = 'https://' + module1343.areaServerMap[module381.RSM.serverCode].host + this.props.data.bg_pic.split('.com')[1],
            S = '';

          if (this.props.data.validEndTime) {
            var b = module1644.convertTimeFromSourceZoneToPhoneZoneByTimestamp(this.props.data.validEndTime, 0);
            ...
            function (l) {
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    if (((t = module2023.default.wavFileName(this.props.data.voice_id, this.props.data.version)), !this.state.playing)) {
                      l.next = 16;
                      break;
                    }
                    ...
                    l.prev = 2;
                    l.next = 5;
                    return regeneratorRuntime.default.awrap(module2023.default.stopPlay());
                  ...
                  case 16:
                    ...
                    return regeneratorRuntime.default.awrap(
                      module2023.default.startPlay(t, {
                  ...
                  case 25:
                    ...
                    l.t1 = l.catch(16);
                    l.prev = 27;
                    s = module1343.areaServerMap[module381.RSM.serverCode].cdnHost;
