...
var j = function (t, n) {
  ...
  Object.keys(t).forEach(function (t) {
    ...
    module1223.default(null === o || 'string' == typeof o, 'Route path for ' + t + ' must be specified as a string, or null.');
    var u = null !== o,
      l = [],
      s = u ? module1229.default(o, l) : null,
      v = [],
      y = '' === o || !u,
      P = module1229.default(y ? '*' : o + '/*', v);
    h[t] = {
      exactRe: s,
      exactReKeys: l,
      extendedPathRe: P,
