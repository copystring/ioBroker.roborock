  ...
  module7.default(b, [
    ...
    },
    {
      ...
      value: function () {
        var t = this,
          ...
          l = module13.Dimensions.get('window').height,
    ...
    },
    {
      ...
      value: function () {
        ...
        this.state.circles.forEach(function (u, S) {
          ...
          o = u.isActive;
          l.push(
            React.default.createElement(module2060.default, {
              funcId: 'circle' + S,
              key: 'c_' + S,
              fill: t,
              normalColor: h,
    ...
    },
    {
      ...
      value: function (t) {
        ...
        for (var n = module2058.getMiddlePoint(this.state.circles[s], this.state.circles[t]), o = 0; o < '13457'.length; o++) {
          var l = '13457'[o];
          if (module2058.isEquals(n, this.state.circles[l])) return String(l);
        }
    ...
    },
    {
      ...
      value: function (t, s) {
        ...
        if (this.isMoving) {
          var o = module2058.getRealPassword(this.sequence);
          this.sequence = '';
          this.lastIndex = -1;
          this.isMoving = false;
          var l = {
    ...
    },
    {
      key: 'radius',
      get: function () {
        return module13.Dimensions.get('window').width / 10;
      },
    },
    {
      key: 'width',
