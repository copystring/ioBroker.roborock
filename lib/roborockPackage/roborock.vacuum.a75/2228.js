      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            c = s.style,
            l = s.calling,
            module2225 = this.props.isLandscape ? require('./2225') : this.context.theme.monitor.call,
            module2229 = this.props.isLandscape ? require('./2229') : this.context.theme.monitor.hung,
            p = l ? module2229 : module2225,
