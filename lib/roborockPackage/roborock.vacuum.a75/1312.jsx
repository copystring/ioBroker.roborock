  ...
  function P() {
    ...
    n._renderTabBar = function (t) {
      var o = n.props.navigation.state,
        ...
        p = n.props,
        f = p.tabBarComponent,
        b = undefined === f ? module1324.default : f,
        h = p.tabBarPosition,
        x = p.tabBarOptions;
    ...
    n._renderScene = function (t) {
      ...
      if (c) {
        ...
        if (p)
          return (
            <module1311.default isVisible={y}>
              {l({
                route: o,
              })}
            </module1311.default>
...
module1219.polyfill(P);
var w = module1306.default(P);
exports.default = w;
