    ...
    },
    {
      ...
      value: function () {
        ...
        if (this.rectPanType & T.PanTypeMove || this.rectPanType & T.PanTypeMoveWall) {
          ...
          this.panResponder = module13.PanResponder.create({
            ...
            onPanResponderStart: function (n, o) {
              t.touch.move = module1339._parseEvent2(n.nativeEvent, o) || {};
            ...
            onPanResponderMove: function (n, o) {
              if (!t.callBack.onShouldMove || t.callBack.onShouldMove()) {
                var l = [module1339._parseEvent2(n.nativeEvent, o), t.touch.move],
                  s = l[0],
                  c = l[1];
                t.touch.move = s || {};
        ...
        if (this.rectPanType & T.PanTypeScale)
          this.panResponderScale = module13.PanResponder.create({
            onStartShouldSetPanResponder: function () {
              return true;
            },
            onMoveShouldSetPanResponder: function () {
            ...
            onPanResponderStart: function (n, o) {
              if (!(n.nativeEvent.touches.length > 1)) {
                var l = module1339._parseMove(n.nativeEvent, o) || {};
                t.scale.dx = l.x;
                t.scale.dy = l.y;
                ...
                if (s) {
                  ...
                  if (c) {
                    ...
                    t.rotateTrans.widthVsign = module1339._pointVectorToLine(
                      t.rotateTrans.realLTX,
                      t.rotateTrans.realLTY,
                      t.rotateTrans.targetVectorX,
                      t.rotateTrans.targetVectorY
                    );
                    t.rotateTrans.heightVsign = module1339._pointVectorToLine(
                      t.rotateTrans.realLTX,
                      t.rotateTrans.realLTY,
            ...
            onPanResponderMove: function (o, l) {
              if (!(o.nativeEvent.touches.length > 1)) {
                o = module1339._parseMove(o.nativeEvent, l) || {};
                var s = null == t.callBack.getInfo ? undefined : t.callBack.getInfo();
                ...
                if (s) {
                  ...
                  if (c) {
                    var h = {
                      ...
                      T = module1339._parseDegPointWithTrans(o, h, s.trans, s.mapDeg),
                    ...
                    if (s.mapDeg % 360 == 0 && 0 === s.slopeAngle) {
                      ...
                      if (((w = X[0]), (E = X[1]), X[2])) {
                        var Y = E ** w,
                          L = module1339._regularAngle(s.slopeAngle + Y);
        ...
        if (this.rectPanType & T.PanTypeRotate)
          this.panResponderRotate = module13.PanResponder.create({
            onStartShouldSetPanResponder: function () {
              return true;
            },
            onMoveShouldSetPanResponder: function () {
            ...
            onPanResponderMove: function (o, l) {
              if (!(o.nativeEvent.touches.length > 1)) {
                var s = module1339._parseMove2(o.nativeEvent, l) || {},
                  c = null == t.callBack.getInfo ? undefined : t.callBack.getInfo();

                if (c) {
                  var h = module1339._parseDegPointWithTrans(
                      s,
                      {
                        x: 0,
                        y: 0,
        ...
        if (this.rectPanType & T.PanTypeDragEnd)
          this.panResponderDragEnd = module13.PanResponder.create({
            onStartShouldSetPanResponder: function () {
              return true;
            },
            onMoveShouldSetPanResponder: function () {
              ...
              if (!(o.nativeEvent.touches.length > 1)) {
                ...
                if (s) {
                  var c = {
                    ...
                    T = module1339._parseDegPointWithTrans(o, c, s.trans, s.mapDeg),
                    p = module23.default(T, 2),
                    v = p[0],
                    f = p[1],
                    R = t.wallEnd.x + v,
                  ...
                  if (B > module1126.RectConfig.maxLength) {
                    var w = module1126.RectConfig.maxLength - B;
                    P += Math.sin(D) * w;
                    R += Math.cos(D) * w;
                  }

                  if (!(B < module1126.RectConfig.minLength)) {
                    var E = {
    ...
    },
    {
      ...
      value: function (t, n) {
        var o,
          l,
          s = false,
          c = module1126.RectConfig.maxLength,
          u = module1126.RectConfig.maxLength,
          T = module1126.RectConfig.minLength,
          p = module1126.RectConfig.minLength,
        ...
        if (v) {
          ...
          if (f) {
            ...
            if ((null == (c = (h = this.callBack).onShouldTwoFinger) ? undefined : c.call(h)) && t.hasOwnProperty('distance') && o.hasOwnProperty('distance')) {
              ...
              var B = module1339._parseDegPointWithTrans(t, o, v.trans, v.mapDeg),
    ...
    },
    {
      ...
      value: function (t, o) {
        ...
        if (!t.hasOwnProperty('distance')) {
          ...
          if (T) {
            var p = module1339._parseDegPointWithTrans(t, o, T.trans, T.mapDeg),
