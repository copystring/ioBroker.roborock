  ...
  module7.default(j, [
    ...
    },
    {
      ...
      value: function () {
        var t,
          ...
          D = React.default.createElement(
            ...
            React.default.createElement(module385.SettingListItemView, {
              ...
              detail:
                module1214.FloorMapPageUtils.getRealName(
                  null !=
                    (u =
                      null ==
          ...
          L = React.default.createElement(module1927.default, {
            ref: function (t) {
          ...
          O = React.default.createElement(module1346.default, {
            ref: function (t) {
        ...
        var G = React.default.createElement(module1124.MultiMapSelectView, {
          ...
          F = React.default.createElement(module1508.default, {
            ref: function (t) {
    ...
    },
    {
      ...
      value: function () {
        ...
        this.props.navigation.setParams({
          ...
          rightItems: [
            module1349.default.confirmButton(
              function () {
    ...
    },
    {
      ...
      value: function () {
        ...
        if (!(null == (n = this.sidebarMenu)))
          n.setState({
            tab: this.state.mode == U.Segment ? module1626.TabSegment : module1626.TabZone,
            mapEditButtonEnabled: module390.default.isSupportSmartScene(),
            modeSetButtonEnabled: module390.default.isSupportSmartScene(),
          });
          ...
          if (t != module381.RSM.currentMapId)
            module381.RSM.isRunning
              ...
              : ((n.isLoadingMap = true),
                ...
                new module1347.MultiMapDataProvider()
                  .loadMap(t)
                  .then(function (o) {
                    n.mapUpdated = false;
    ...
    },
    {
      ...
      value: function () {
        ...
        var o = module382.getCleanModeTitle(this.state.cleanMode),
          ...
          s = o + (l ? ' | ' + l : '');
        if (module390.default.isPureCleanMopSupported() && this.state.cleanMode == module1624.CleanModeZero) return l + ' | ' + module382.getMopMethodTitle(this.state.mopMode);
        ...
        if (module390.default.isShakeMopSetSupported() && 200 != this.state.waterMode) {
          ...
          if (t) {
            if (n == module1625.CleanMethodClean) return s;
            if (n == module1625.CleanMethodMop) return u;
            if (n == module1625.CleanMethodCleanAndMop) return s + ' | ' + u;
          }
        }
    ...
    },
    {
      key: 'mapMode',
      get: function () {
        if (!module390.default.isSupportSmartScene()) return module1124.MapModelInCleanMode.Segment_Clean_Read_Only;

        switch (this.state.mode) {
          case U.GlobalClean:
            return module1124.MapModelInCleanMode.Global_Clean_With_Clean_Type;
          ...
          case U.Segment:
            ...
            else return n ? module1124.MapModelInCleanMode.Segment_Clean_Read_Only : module1124.MapModelInCleanMode.Segment_Clean_Edit;

          case U.Zone:
            return module1124.MapModelInCleanMode.Zone_Clean_Edit;
