...
function V(t) {
  var o = React.useContext(module1199.AppConfigContext).theme,
    n = t.title,
    s = t.options,
    l = t.selectedIndex,
    u = t.enabled,
...
function k(t) {
  ...
  return React.default.createElement(
    ...
    React.default.createElement(module385.FatSlider, {
      ...
      enabled: M,
      sliderWidth: b || module13.Dimensions.get('window').width - 40,
      value: p,
      circleValue: h,
...
var I = (function (t) {
  ...
  function T(t) {
    ...
    (h = S.call(this, t)).state = {
      ...
      washCount: 1,
      moveSpeed: 30,
      modeName: module510.localization_strings_Setting_General_index_0,
      hasFetchedData: false,
    };
    var p =
        (null == (o = module8.default(h))
          ? undefined
          : null == (n = o.props)
          ? undefined
          : null == (s = n.navigation)
  ...
  module7.default(T, [
              ...
              for (;;)
                switch ((y.prev = y.next)) {
                  case 0:
                    y.prev = 0;
                    y.next = 3;
                    return regeneratorRuntime.default.awrap(module416.default.getCustomMopModeDetail(o));
    ...
    },
    {
      ...
      value: function () {
        var t = this,
          module1637 = React.default.createElement(module385.PureImageButton, {
            ...
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  ...
                  globals.showToast(module510.save_mop_mode_now_used_tip);
                ...
                case 3:
                  ...
                  n.next = 7;
                  return regeneratorRuntime.default.awrap(module416.default.delCustomMopMode(this.id));
            ...
            for (;;)
              switch ((M.prev = M.next)) {
                ...
                case 3:
                  ...
                  M.next = 11;
                  return regeneratorRuntime.default.awrap(module416.default.addCustomMopMode(y));
                ...
                case 14:
                  M.next = 16;
                  return regeneratorRuntime.default.awrap(module416.default.updateCustomMopMode(y));
    ...
    },
    {
      ...
      value: function () {
        var t = [
            {
              name: module510.mop_mode_custom_wet_mode_wetest_name,
              desc: module510.mop_mode_custom_wet_mode_wetest_desc,
            },
            {
              name: module510.mop_mode_custom_wet_mode_wet_name,
              desc: module510.mop_mode_custom_wet_mode_wet_desc,
            },
            {
              name: module510.dust_collection_title_3,
              desc: module510.mop_mode_custom_wet_mode_normal_desc,
            },
            {
              name: module510.mop_mode_custom_wet_mode_dry_name,
              desc: module510.mop_mode_custom_wet_mode_dry_desc,
            },
            {
              name: module510.mop_mode_custom_wet_mode_dryest_name,
              desc: module510.mop_mode_custom_wet_mode_dryest_desc,
            },
          ],
      ...
      value: function () {
        ...
        return React.default.createElement(
          ...
          React.default.createElement(
            ...
            !this.sys_type &&
              React.default.createElement(module385.SettingListItemView, {
                title: module510.mop_mode_setting_page_mode_name,
          ...
          React.default.createElement(module385.InputDialog, {
            ...
            maxLength: 10,
            title: module510.mop_mode_setting_page_mode_name,
            inputPlaceholder: module510.mop_mode_setting_page_input_mode_name,
    ...
    },
    {
      ...
      get: function () {
        ...
        return [
          {
            title: module510.mop_mode_custom_page_mop_setting_title,
            section: true,
          },
          {
            title: module510.mop_mode_custom_page_wet_title,
            minValue: 15,
            maxValue: 150,
            step: 5,
          ...
          {
            title: module510.mop_mode_setting_page_roller_clean,
            section: true,
          },
          {
            ...
            desc: module510.mop_mode_setting_wash_interval_desc,
            onSlidingComplete: function (t) {},
            onSlidingMove: function (o) {
              t.setState({
                washInterval: 60 * o,
          ...
          {
            title: module510.mop_cleaning_time,
            minValue: 30,
            maxValue: 60,
            step: 10,
            value: this.state.washTime,
            showValue: this.state.washTime + 's',
            desc: module510.mop_mode_setting_page_wash_time_desc,
            onSlidingMove: function (o) {
              t.setState({
                washTime: o,
              });
...
exports.default = I;
I.contextType = module1199.AppConfigContext;
