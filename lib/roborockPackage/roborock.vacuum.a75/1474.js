...
var _ = module13.ART.Transform,
  ...
  x = module1126.Config.size.objectsRadius,
  z = (function (t) {
    module9.default(R, t);
    ...
    module7.default(R, [
            ...
            return null == (u = this.props.stuckPoints)
              ...
              : u.map(function (o, u) {
                  if (o.nearby) {
                    ...
                    return React.default.createElement(
                      ...
                      module22.default(
                        {
                          key: u,
                          onPress: l.onPressSmartZone.bind(l, module1126.SmartBubbleType.BT_STUCK, o, c),
                        },
                        module391.default.getAccessibilityLabel('map_nearby_stuck')
                      ),
                      React.default.createElement(module13.Image, {
                        resizeMode: 'contain',
                        style: [I.stuckImage, y],
                        source: l.zoneTheme.stuckPtImg,
                      })
                    );
                  }

                  var v = module1339._pointToStuckRect(o),
                    k = {
                      rectSize: v,
                      slopeAngle: 0,
                    };
                  ...
                  return React.default.createElement(module1210.RectZone, {
                    ...
                    innerImage: module1126.MapAITag,
                    handlePanShouldStart: l.onPanShouldStart,
                    handlePanOnStart: l.onPressSmartZone.bind(l, module1126.SmartBubbleType.BT_STUCK, o, k),
                  });
                });
          }
      ...
      },
      {
        ...
        value: function (t) {
          var o,
            l = this;
          if (!module1197.canEditDoorSill()) return null;
          var u =
            ...
            : u.map(function (o, u) {
                ...
                return React.default.createElement(
                  ...
                  module22.default(
                    {
                      key: u,
                      onPress: l.onPressSmartZone.bind(l, module1126.SmartBubbleType.BT_DOORSILL, o, c),
                    },
