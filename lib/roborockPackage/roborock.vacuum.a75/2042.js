...
var module510 = require('./510').strings,
  ...
  G = (function (t) {
    ...
    function G(t) {
      ...
      (n = q.call(this, t)).dataProvider = module390.default.isMultiFloorSupported() ? new module1347.MultiMapDataProvider() : new module1347.SingleMapDataProvider();
                ...
                .then(function (o) {
                  var l =
                    ...
                    p.state.items.map(function (o) {
                      if (o.id == t) o.name = module1214.FloorMapPageUtils.getRealName(n);
                      return o;
                    });
                  p.setState({
                    items: l,
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  ...
                  case 3:
                    ...
                    n.then(function (n) {
                      var l = module1993(n, globals.app.state.theme != module520.Themes.light, false, false);
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (
            ...
            if ('' != o) {
              var l = module1214.FloorMapPageUtils.getRealLength(o);
              if (module1214.FloorMapPageUtils.getRealLength(o) >= 30) globals.showToast(module510.floor_map_name_too_long);
        ...
        value: function () {
          if (module390.default.groundOnlySupportFloor())
            ...
            this.props.navigation.navigate('MapEditCarpetPage', {
              action: module1197.getCarpetPageAction(),
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            c = React.default.createElement(module1927.default, {
              ...
              mode: module1927.ModalMapEditMenuMode.MapManagement,
              ...
              onEditingMapNameSuccess: function (n, o) {
                var l =
                  ...
                  t.state.items.map(function (t) {
                    if (t.id == n) t.name = module1214.FloorMapPageUtils.getRealName(o);
                    return t;
                  });
                t.setState({
                  items: l,
            ...
            V =
              ...
              this.state.items.map(function (n, o) {
                return React.default.createElement(module2043.default, {
                  key: o,
                  mapID: n.id,
                  name: n.name,
                  mapTime: n.time,
            ...
            q = React.default.createElement(module2044.default, {
              ref: function (n) {
            ...
            U = React.default.createElement(module2044.SingleMapEmptyMapItem, {
            ...
            j = React.default.createElement(module385.InputDialog, {
              ...
              warningVisibilityAdapter: function (t) {
                return !module1214.FloorMapPageUtils.isLengthValid(t);
              },
            }),
            J = React.default.createElement(module1212.MultiMapHintModal, {
              ref: function (n) {
            ...
            Q = React.default.createElement(module1124.MultiFloorEnableTipsView, {
              ref: function (n) {
                t.qaContentView = n;
              },
            }),
            ...
            $ = React.default.createElement(module1212.MapSaveActionSheetView, {
              ref: function (n) {
                return (t.singleFloorSaveNewMapActionSheet = n);
              },
              mode: module1212.MapSaveActionSheetMode.SaveNewMapInSingleFloor,
              handleSaveMap: function (n) {
                return t.onTapSingleFloorSaveActionSheet.apply(t, [n]);
              },
            }),
            ee = React.default.createElement(module1212.MapSaveActionSheetView, {
              ref: function (n) {
            ...
            te = React.default.createElement(module1212.SingleFloorSaveNewMapAlert, {
              ref: function (n) {
            ...
            ie =
              ...
              React.default.createElement(module1944.LoadBackupMapView, {
                ref: function (n) {
...
exports.default = G;
G.defaultProps = {};
G.contextType = module1199.AppConfigContext;
