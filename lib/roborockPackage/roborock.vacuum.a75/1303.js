...
var T = parseInt(module13.Platform.Version, 10),
  x = 'ios' === module13.Platform.OS,
  C = T >= 11 && x,
  I = (function (t, ...args) {
    module9.default(x, t);
    ...
    function x() {
          ...
          ? React.default.createElement(
              module13.Animated.Text,
              {
                ...
                style: [
                  ...
                  v && t._shouldUseHorizontalTabs() ? O.labelBeside : O.labelBeneath,
                  b,
                ],
                allowFontScaling: P,
              },
      ...
      t._renderIcon = function (n) {
        ...
        return React.default.createElement(module1302.default, {
          position: l,
          navigation: s,
          activeTintColor: c,
          inactiveTintColor: u,
          renderIcon: f,
          scene: n,
          style: [O.iconWithExplicitHeight, false === b && !v && O.iconWithoutLabel, false !== b && !v && O.iconWithLabel],
        });
      };
      ...
      t._handleTabPress = function (n) {
        ...
        if (s.state.index === n) {
          ...
          if (c.hasOwnProperty('index') && c.index > 0)
            s.dispatch(
              module1217.StackActions.popToTop({
                key: c.key,
              })
            );
        } else l(n);
    ...
    module7.default(x, [
      {
        ...
        value: function () {
          var t,
            ...
            o = n.tabStyle,
            l = n.layout,
            s = module13.StyleSheet.flatten(o);
          if (s)
      ...
      },
      {
        ...
        value: function () {
          ...
          if (!s) return false;
          var c = l.width;
          if (0 === c) return module13.Platform.isPad;
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            I = [O.tabBar, this._shouldUseHorizontalTabs() && !module13.Platform.isPad ? O.tabBarCompact : O.tabBarRegular, v];
                ...
                return React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    React.default.createElement(
                      module13.View,
                      {
                        style: [O.tab, t._shouldUseHorizontalTabs() ? O.tabLandscape : O.tabPortrait, P],
                      },
                      t._renderIcon(v),
                      t._renderLabel(v)
                    )
...
var O = module13.StyleSheet.create({
  ...
  S = module1217.withOrientation(I);
exports.default = S;
