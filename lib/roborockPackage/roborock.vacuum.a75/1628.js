...
var y = React.forwardRef(function (t, o) {
    var l = React.useContext(module1199.AppConfigContext).theme,
      C = t.cleanIconMode,
      module1630 = undefined === C ? 'start' : C,
      p = t.dockIconMode,
    ...
    var G = [
        S(
          S({}, module1629.getNewCollectButtonConfig(x, l)),
          {},
          {
        ...
        S(
          S({}, module1629.getNewWashButtonConfig('start', l)),
          {},
          {
      ...
      K = S(
        S({}, module1629.getNewDryButtonConfig(D, l)),
        {},
        {
    ...
    var V = module13.Dimensions.get('window').width,
      U = 0.6 * (V - 3 * module1434.HorizontalMargin),
      F = 0.4 * (V - 3 * module1434.HorizontalMargin),
      q = (V - module1434.HorizontalMargin * (G.length + 2) - 43) / G.length,
      J = function () {
        v.current.scrollTo({
          x: 0,
          y: 0,
      ...
      Q = S(
        S({}, module1629.getDockButtonConfig(R, l)),
        {},
        {
      ...
      Y = S(
        S({}, module1629.getCleanButtonConfig(module1630, l)),
        {},
        {
        ...
        module1408.BoxShadow,
        {
          setting: S(
            ...
            {},
            {
              width: 43,
              style: {
                marginLeft: 2 * module1434.HorizontalMargin,
                bottom: 20,
              },
            }
          ),
