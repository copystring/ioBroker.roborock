      ...
      },
      {
        ...
        value: function () {
          ...
          var u = 'reminder' == this.props.type || this.props.closeable ? t.popMsgBox.close : t.popMsgBox.rightArrow,
            ...
            module1650 = this.props.leftIcon || ('error' == this.props.type ? require('./1649') : require('./1650')),
            P =
              l.length > 0 &&
              ...
              module13.View,
              {
                style: [
                  j.containter,
                  {
                    ...
                    width: module13.Dimensions.get('window').width - 2 * module1434.HorizontalMargin,
                  },
                ],
                onLayout: function (t) {
