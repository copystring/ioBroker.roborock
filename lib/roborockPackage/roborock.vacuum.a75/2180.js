...
var module1343 = require('./1343'),
  E = (function (t) {
    ...
    function S(t) {
      ...
      (n = y.call(this, t)).host = module1343.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].host;
      n.state = {
        imageHeight: 500,
      };
      return n;
    ...
    module7.default(S, [
      {
        ...
        value: function () {
          var t = this;
          module13.Image.getSize(this.imgUrl, function (n, o) {
            t.setState({
              imageHeight: (o / n) * module13.Dimensions.get('window').width,
            });
          });
        },
      },
...
var k = module13.StyleSheet.create({
  ...
  wrap: {
    ...
    height: module13.Dimensions.get('window').height - 180,
  },
  detailImage: {
    width: module13.Dimensions.get('window').width,
  },
