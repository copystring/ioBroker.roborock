exports.default = function (t) {
    ...
    function O() {
      ...
      (t = P.call(this, ...args))._renderScene = function (n) {
        var o = n.route,
          ...
          p = u[o.key],
          l = p.getComponent();
        return <module1217.SceneView screenProps={c} navigation={p.navigation} component={l} />;
      };
  ...
  return function (t) {
    var o = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : {},
      s = module1217.TabRouter(t, o),
      c = module1217.createNavigator(n, s, o);
    return module1217.createNavigationContainer(c);
  };
};
