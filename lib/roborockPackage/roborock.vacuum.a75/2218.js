...
var module1343 = require('./1343'),
  ...
  j = (function (t) {
    ...
    function C(t) {
      ...
      o.animatedWidth = new module13.Animated.Value(L);
      return o;
    }
    ...
    module7.default(C, [
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    o.t0 = JSON;
                    o.next = 3;
                    return regeneratorRuntime.default.awrap(module420.GetStorageKey('tttt_map_data'));
      ...
      },
      {
        ...
        value: function () {
          ...
          this.statusListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.RobotStatusDidUpdate, function (o) {
            t.forceUpdate();
          });
        },
      },
      {
        ...
        value: function () {
          ...
          if (!module381.RSM.voiceChat || module390.default.isSupportRemoteControlInCall()) {
            ...
            this.setState(
              ...
              function () {
                ...
                module13.Animated.timing(t.animatedWidth, {
                  toValue: B(),
                  duration: 150,
                  bounciness: 0,
                }).start();
          ...
          } else this.showMsg(module510.voice_chat_title2);
        },
      },
      {
        key: 'minsize',
      ...
      },
      {
        ...
        value: function () {
          ...
          var t = this,
            ...
            f = n ? module13.View : module13.Animated.View,
            ...
            w = React.default.createElement(
              ...
              M &&
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    module381.RSM.state == module381.RobotState.GOTO_TARGET ? module510.rubys_main_subtitle_goto_target : module510.rubys_main_goto_click_text
                  ),
                  !n &&
              ...
              (function () {
                var n = React.default.createElement(module1124.MapView, {
                    style: {
                      flex: 1,
                    ...
                    left: M ? 20 : 5,
                    right: M ? 20 : 5,
                    bottom: M ? module1343.AppBarMarginBottom + 16 : 5,
              ...
              M &&
                React.default.createElement(module385.TopImageButton, {
                  ...
                  fontSize: 12,
                  textTop: 7,
                  title: module381.RSM.state == module381.RobotState.GOTO_TARGET ? module510.localization_strings_Common_Constants_11 : module510.rubys_main_button_text_goto_cmd,
            ...
            O = s ? 0 : module1343.AppBarMarginTop + 24,
            R = {
              width: s ? I(true) : L,
              height: s ? A(true) : L,
              opacity: s ? c : 1,
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    this.showMsg(module510.voice_chat_title2);
                  ...
                  case 3:
                            ...
                            for (;;)
                              switch ((u.prev = u.next)) {
                                ...
                                case 3:
                                  ...
                                  l.forceUpdate();
                                  module418.Log.log(module418.LogTypes.Monitor, 'gotoTarget - ' + JSON.stringify(s) + ' - fromOtherStatus:' + o, module418.InfoColors.Success);
                                  l.minsize();
                                  u.next = 13;
                                  break;
                            ...
                            for (;;)
                              switch ((t.prev = t.next)) {
                                ...
                                case 3:
                                  ...
                                  l.forceUpdate();
                                  module418.Log.log(module418.LogTypes.Monitor, 'gotoTarget stop - ' + JSON.stringify(o), module418.InfoColors.Success);
                    ...
                    this.showMsg(module510.rubys_main_goto_click_text);
                    return c.abrupt('return');

                  case 10:
                    u = {
                      BACK_TO_DOCK: module510.localization_strings_abort_current_task_and_start_goto,
                      ZONED_CLEAN: module510.localization_strings_abort_current_task_and_start_goto,
                      SPOT_CLEAN: module510.localization_strings_abort_current_task_and_start_goto,
                      REMOTE: module510.localization_strings_abort_current_task_and_start_goto,
                    };
                    if (!u[module381.RSM.state]) module510.localization_strings_abort_current_task_and_start_goto;
                    if (
...
var z = module13.StyleSheet.create({
  ...
  gotoButton: {
    ...
    height: 90,
    position: 'absolute',
    bottom: 16 + module1343.AppBarMarginBottom,
    right: 20,
  },
});
