    ...
    module7.default(T, [
          ...
          var l = this,
            ...
            E = React.default.createElement(
              ...
              React.default.createElement(module385.PureButton, {
                ...
                enabled: !s,
                title: (j || module510.localization_strings_Main_Error_ErrorDetailPage_3) + (s ? u : ''),
                textColor: s
      ...
      },
      {
        ...
        value: function () {
          ...
          this.timer = module1420.setTimeout(this._fire.bind(this), 1e3);
      ...
      },
      {
        key: '_stopSecond',
        value: function () {
          if (this.timer) module1420.clearTimeout(this.timer);
        },
      },
      {
        key: 'show',
...
var j = O(function (t) {
  var o = module13.StyleSheet.create({
    ...
    n = module510.obstacle_photo_page_ignore_desc;
  return React.default.createElement(
    ...
    React.default.createElement(
      ...
      React.default.createElement(
        ...
        n + ' ' + ('android' === module13.Platform.OS ? '\n\n' : ' ')
      )
    )
  );
}, true);
