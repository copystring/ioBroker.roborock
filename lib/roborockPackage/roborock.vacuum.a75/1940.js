      ...
      },
      {
        ...
        value: function (t) {
          if (!(module393.apiLevel < 10015)) {
            var n = 'main';
            if (
              t == module1124.MapModelInCleanMode.Segment_Clean_Read_Only ||
              t == module1124.MapModelInCleanMode.Segment_Clean_Read_Only_With_Clean_Type ||
              t == module1124.MapModelInCleanMode.Segment_Clean_Sequential_Read_Only_With_Clean_Type
            )
              n = 'blockCleanRO';
            else if (t == module1124.MapModelInCleanMode.Segment_Clean_Edit) n = 'blockCleanEdit';
            else if (t == module1124.MapModelInCleanMode.Zone_Clean_Read_Only) n = 'zoneCleanRO';
            else if (t == module1124.MapModelInCleanMode.Zone_Clean_Edit) n = 'zoneCleanEdit';
            this.setState({
              mode: n,
            });
            b.setMapViewMode(n);
