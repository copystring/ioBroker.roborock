...
var module510 = require('./510').strings,
  ...
  U = module1217.createSwitchNavigator(
    {
      KeyView: W ? module2054.default : module2052.default,
    },
    {
    ...
    module7.default(x, [
      {
        ...
        value: function () {
          ...
          var s = React.default.createElement(
            ...
            c = module393.isWindowDisplay ? module1395.titleBarContentHeight + 14 : module1395.titleBarContentHeight + module1343.StatusBarHeight + module1343.AppBarMarginTop,
            l = module391.default.iOSAndroidReturn(c, module1395.titleBarHeight);
      ...
      },
      {
        ...
        value: function () {
          ...
          module1491.readRemoteControlModeFlag(function (o) {
            if (o) {
              var n = parseInt(o);
      ...
      },
      {
        ...
        value: function () {
          ...
          module1491.saveRemoteControlModeFlag(this.state.activeControlViewIndex);
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  ...
                  case 2:
                    ...
                    s = module1217.NavigationActions.navigate({
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (this.noteTimerID > 0) {
            module1420.clearTimeout(this.noteTimerID);
            this.noteTimerID = 0;
          }

          this._setNoteVisible(true);

          this.noteTimerID = module1420.setTimeout(function () {
                ...
                switch ((s.prev = s.next)) {
                  case 0:
                    if (
                      ...
                      (t = function () {
                        if (o.startTimerID <= 0)
                          o.startTimerID = module1420.setInterval(function () {
      ...
      },
      {
        ...
        value: function () {
          if (this.startTimerID > 0) {
            module1420.clearInterval(this.startTimerID);
            this.startTimerID = 0;
