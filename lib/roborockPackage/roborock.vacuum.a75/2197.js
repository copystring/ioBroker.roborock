...
var module50 = require('./50'),
  ...
  module2226 = require('./2226'),
  module2228 = require('./2228'),
  module2230 = require('./2230'),
...
var module393 = require('./393'),
  module2232 = module393.monitorAllowed() ? require('./2232').default : module13.View,
    ...
    module7.default(X, [
      {
        ...
        value: function () {
          ...
          module1500.default.shared().popGestureEnabled = false;
                ...
                switch ((u.prev = u.next)) {
                  ...
                  case 16:
                    if (module381.RSM.isHomeSecDisconnected()) {
                      ...
                      s = {
                        quality: module1343.VideoQuality.SD,
                      ...
                      module381.RSM.isHomeSecControlledByCurrentClient()
                        ...
                        : (module418.Log.log(
                          ...
                          this.setState({
                            isLoading: false,
                            isLoadFailed: true,
                            error: module1343.VideoError.Video_StartPreviewFailed_alreadyInPreview,
                          }));
      ...
      },
      {
        ...
        value: function () {
          ...
          this.statusListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.RobotStatusDidUpdate, function (n) {
            ...
            if (module381.RSM.bumperLeft) t.showTip(le[module2219.DirectionLeft]);
            if (module381.RSM.bumperRight) t.showTip(le[module2219.DirectionRight]);
            if (module381.RSM.bumperMiddle) t.showTip(le[module2219.DirectionMiddle]);
            if (module381.RSM.obstacleLeft) t.showTip(ue[module2219.DirectionLeft]);
            if (module381.RSM.obstacleRight) t.showTip(ue[module2219.DirectionRight]);
            if (module381.RSM.obstacleMiddle) t.showTip(ue[module2219.DirectionMiddle]);
          ...
          this.gotoFailListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.EventToastChange, function (o) {
            if ('target_not_reachable' == o.data) t.showTip(module1638.getToast()[o.data][0]);
          });
      ...
      },
      {
        ...
        value: function (t) {
          var o = this,
            ...
            u = React.default.createElement(module2232, {
              ref: function (t) {
            ...
            module1928 = React.default.createElement(
              module13.View,
              {
                style: [
                  pe.video,
          ...
          return module393.monitorAllowed() ? module391.default.iOSAndroidReturn(h, u) : module1928;
        },
      },
      {
        key: 'didRecieveMsg',
      ...
      },
      {
        key: 'didRecieveError',
        value: function (t, o) {
          if (!(t.code == module1343.VideoError.Video_SendSDKSdpToDeviceFailed_responseTimeout.code && this.isMonitoring))
            t.code == module1343.VideoError.Video_StartPreviewFailed_alreadyInPreview.code &&
            (module418.Log.log(
              module418.LogTypes.Monitor,
            ...
            o && ((module381.RSM.homeSecClientID = o), o == module393.appClientID))
              ...
              : (module418.Log.log(module418.LogTypes.Monitor, '\u6536\u5230\u89c6\u9891\u62a5\u9519 \u9519\u8bef\u7801 code=' + t.code),
                ...
                t.code == module1343.VideoError.Video_StartPreviewFailed_unKnownReason.code ||
                t.code == module1343.VideoError.Video_StartPreviewFailed_innerUnknowReason.code ||
                t.code == module1343.VideoError.Video_PreviewTimeout
            ...
            function (h) {
              for (;;)
                switch ((h.prev = h.next)) {
                  case 0:
                    h.prev = 0;
                    module50 = module1343.Definitions[t];
      ...
      },
      {
        ...
        value: function (t) {
          var o = this;
          return React.default.createElement(module2203.default, {
      ...
      },
      {
        ...
        value: function (t) {
          var o = this,
            n = {
              left: module1343.AppBarMarginTop + 24,
            },
            l = ae;
          ...
          return React.default.createElement(module2186.default, {
            ref: function (t) {
      ...
      },
      {
        ...
        value: function (t) {
          var o = this;
          return React.default.createElement(module2218.default, {
            isPortrait: t,
            ref: function (t) {
              return (o.gotoView = t);
            },
      ...
      },
      {
        ...
        value: function () {
          return React.default.createElement(module2221.default, {
            isLandscape: false,
            alertOwner: this,
          });
        },
      },
      {
        key: 'getCallView',
        value: function (t) {
          return React.default.createElement(module2228.default, {
            style: pe.callView,
            isLandscape: t,
            calling: this.state.calling,
          ...
          return React.default.createElement(
            ...
            module390.default.isVideoLiveCallSupported() &&
              ...
              React.default.createElement(module385.PureImageButton, {
                ...
                image: this.state.robotMic ? require('./2212') : require('./2213'),
                imageWidth: 30,
                imageHeight: 30,
                onPress: function () {
                  return t.soundOff();
        ...
        value: function () {
          ...
          if (this.isMonitoring && this.videoView)
            this.videoView.startRecordVideo(function (o) {
              if (o) {
                module2206.timeTool.startRecordTime();
                t.setState({
            ...
            n = function () {
              ...
              if (o.state.screenRecording) {
                module387.LogEventStatus('screen_recording_duration', {
                  duration: module2206.timeTool.getRecordSpan(),
                });
                module2206.timeTool.cancleRecord();
                o.setState({
      ...
      },
      {
        ...
        value: function (t) {
          var o = t == module2217.PortraitActionCall;

          if (t == module2217.PortraitActionRemote || o) {
            module387.LogEventCommon(t == module2217.PortraitActionRemote ? 'tap_remote_control_tab' : 'tap_voice_tab');
            if (o && module390.default.isVideoLiveCallSupported()) this.handleLiveCall();
            else this.togglePortaitPopup(t);
          } else if (t == module2217.PortraitActionRecord) this.handleScreenCast();
          else if (t == module2217.PortraitActionShortcut) this.screenShot();
        },
      },
      {
        key: 'showNotReadyTip',
                ...
                switch ((t.prev = t.next)) {
                  case 0:
                    ...
                    module387.LogEventStatus('call_duration', {
                      duration: module2206.timeTool.getSpan(),
                    });
                    this.cancleLiveCall();
      ...
      },
      {
        ...
        value: function (t) {
          var o = this,
            n = t == module2217.PortraitActionRemote;
          this.setState(
            {
            ...
            function () {
              module13.Animated.spring(o.animatedPortraitPopupViewHeight, {
                toValue: re() - (ge() + se + he + module2217.FuncTabBackgroundHeight - 15),
                duration: 800,
              }).start();
            }
          );
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module2217.PortraitActionMenu, {
              isRemoteActive: c,
              isScreenCasting: l,
              isLiveCall: u,
            ...
            React.default.createElement(
              module13.View,
              {
                style: [
                  ...
                  {
                    width: ne(),
                    height: re() - ge() - se - he - module2217.FuncTabBackgroundHeight + 15,
                  },
                ],
              },
              ...
              this.state.calling &&
                React.default.createElement(module2230.default, {
                  ref: function (o) {
            ...
            React.default.createElement(module385.ActionSheetView, {
              ...
              actions: module1343.Definitions.map(function (t) {
                return t.title;
              }),
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            o &&
              React.default.createElement(module2202.default, {
                ref: function (o) {
                  return (t.definitionView = o);
                },
            ...
            o &&
              React.default.createElement(module2198.default, {
                style: [pe.actionMenu],
                ref: function (o) {
            ...
            n && (module381.RSM.bumperMiddle || module381.RSM.obstacleMiddle)
              ? React.default.createElement(module2219.BumperView, {
                  direction: module2219.DirectionMiddle,
                })
              : null,
            n && (module381.RSM.bumperLeft || module381.RSM.obstacleLeft)
              ? React.default.createElement(module2219.BumperView, {
                  direction: module2219.DirectionLeft,
                })
              : null,
            n && (module381.RSM.bumperRight || module381.RSM.obstacleRight)
              ? React.default.createElement(module2219.BumperView, {
                  direction: module2219.DirectionRight,
                })
              : null,
            React.default.createElement(module385.AlertView, {
              ref: function (o) {
            ...
            module390.default.isRecordAllowed() && module393.isRecordSupported() && 2 == module393.iotType
              ? React.default.createElement(module2220.default, {
                  ref: function (o) {
            ...
            this.state.shouldShowRecordToast && !module390.default.isVideoLiveCallSupported()
              ? React.default.createElement(module2226.default, {
                  ref: function (o) {
...
exports.default = module2236;
module2236.contextType = module1199.AppConfigContext;
module2236.navigationOptions = {
  header: null,
};
