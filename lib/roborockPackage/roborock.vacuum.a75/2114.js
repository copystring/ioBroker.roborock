  ...
  b = (function (t) {
    ...
    function b(t) {
      ...
      (o = _.call(this, t)).onPressAddSlideSillButton = function () {
        var t;
        if (!(null == (t = o.mapView))) t.addDoorSill(module1126.DoorConfig.silde_df_height);
      };

      o.onPressAddStoneSillButton = function () {
        var t;
        if (!(null == (t = o.mapView))) t.addDoorSill(module1126.DoorConfig.stone_df_height);
      };

      o.onPressAddOtherSillButton = function () {
        var t;
        if (!(null == (t = o.mapView))) t.addDoorSill(module1126.DoorConfig.other_df_height);
      };
    ...
    module7.default(b, [
      {
        ...
        value: function () {
          return {
            ...
            mapProps: {
              hideAccessory: true,
              mapMode: module1343.MAP_MODE_DOORSILL_EDIT,
              initDoorSill: this.initParams,
            },
            menuProps: {
              type: module1198.MenuType.Menu_DoorSill,
