    ...
    module7.default(L, [
      ...
      },
      {
        ...
        value: function (t, o) {
          ...
          if (s && h && !module2161.shallowEqual(s, h)) {
            y = y || Object.keys(h);
            I.id++;
            this._rowsLayouts = {};
          ...
          } else if (c && y && !module2161.shallowEqual(c, y))
            this.setState({
              order: y,
            });

          if (s && u && !module2161.shallowEqual(s, u)) this._onUpdateLayouts();
        },
      },
      {
        key: 'scrollBy',
          ...
          if (null !== n && !this._autoScrollInterval) {
            ...
            if ((this._movingDirectionChanged && (this._prevSwapedRowKey = null), f !== n && f !== this._prevSwapedRowKey)) {
              if (1 === Math.abs(h - l)) {
                ...
                c = module2161.swapArrayElements(s, l, h);
              } else {
