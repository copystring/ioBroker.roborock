...
var module510 = require('./510').strings,
  ...
  module2076 = (function (t) {
    ...
    function R(t) {
      ...
      (o = module2076.call(this, t)).state = {
        titleSelected: module1639.default.realVideoSetting,
      };
      o.isChanging = false;
      return o;
    }
      ...
      },
      {
        ...
        value: function () {
          var t = this.context.theme,
            o = this.getMenus().map(function (t, module2076) {
              return t.visible
                ? t.title
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (!this.isChanging) {
            ...
            module1639.default.updateRealTimeVideoSetting(t, function (l) {
              o.isChanging = false;
