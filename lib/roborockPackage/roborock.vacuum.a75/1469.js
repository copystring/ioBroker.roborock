  ...
  A = (function (t) {
    ...
    function O(t) {
      ...
      (s = k.call(this, t)).handleFBZPanOnShouldStart = function () {
        return module1124.MapEditCommonService.enableEditMap();
      };

      s.handleFBZPanStart = function (t, n) {
        var o = null;

        if (t == module1126.FbzType.FBZ_TYPE_CARPET) {
          s._setCarpetZonesFocus(s.fbzReferences, n);

          s._clearCarpetZonesFocus(s.customReferences);

          o = s.fbzReferences[n];
        } else if (t == module1126.FbzType.RECT_TYPE_CARPET) {
        ...
        if (o) null == s.props.mapCarpetFocusCallback || s.props.mapCarpetFocusCallback(o.state.newAdded, t == module1126.FbzType.FBZ_TYPE_CARPET);
      };
    ...
    module7.default(O, [
      ...
      },
      {
        ...
        value: function (t, n) {
          ...
          if (s)
            if (t && 0 != t.length) {
              for (c = 1; c <= module1126.MAX_COUNT_WALL_OR_FBZ; c++)
                if (c <= t.length) {
                  var o,
                    l = t[c - 1];
              ...
              for (var c = 1; c <= module1126.MAX_COUNT_WALL_OR_FBZ; c++) {
                var f;
        ...
        value: function (t, n, s) {
          for (
            var o = this,
              ...
              c = function (c) {
                if (l[c] && 0 == l[c].state.visible && l[c].state.serial == u + 1) {
                  l[c].addNew(t, n, function () {
                    o.handleFBZPanStart(s ? module1126.FbzType.RECT_TYPE_CARPET : module1126.FbzType.FBZ_TYPE_CARPET, c);
                  });
                  return {
                    v: c,
                  };
              ...
              f = 1;
            f <= module1126.MAX_COUNT_WALL_OR_FBZ;
            f++
          ) {
            var p = c(f);
      ...
      },
      {
        ...
        value: function (t) {
          var n = t ? this.customReferences : this.fbzReferences;
          return this._getVisibleZonesCount(n) >= module1126.MAX_COUNT_WALL_OR_FBZ;
        },
      },
      {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          for (var o = module1339._getRotateMaxRectSize(s[0]), l = 1; l <= module1126.MAX_COUNT_WALL_OR_FBZ; l++)
            if (n[l] && n[l].state.visible) {
              var u = {
                  rectSize: n[l].state.rectSize,
                  slopeAngle: n[l].state.slopeAngle,
                },
                c = module1339._getRotateMaxRectSize(u);
      ...
      },
      {
        ...
        value: function () {
          ...
          for (var o = 0; o < s.length; o++) {
            ...
            if (module1339._isVerticalRotate((180 * u) / Math.PI)) {
      ...
      },
      {
        ...
        value: function () {
          var t = new E({
            ...
            n = this.props.mapMode == module1343.MAP_MODE_CARPET_EDIT && !module381.RSM.isRunning,
            s = !!(this.props.subCarpetMode & module1197.CarpetEditMode.CarpetIgnore),
            o = !!(this.props.subCarpetMode & module1197.CarpetEditMode.CarpetAdd);
          return React.default.createElement(
            module13.View,
            {
              style: T.container,
            },
            this.getCarpetZoneView(module1126.FbzType.RECT_TYPE_CARPET, this.customReferences, t, o && n),
            n && s && this.getCarpetZoneView(module1126.FbzType.FBZ_TYPE_CARPET, this.fbzReferences, t, true)
          );
        },
      },
    ]);
