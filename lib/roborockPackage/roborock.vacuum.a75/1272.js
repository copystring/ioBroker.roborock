...
exports.default = function (t, n) {
  return function (f, p) {
    var O = f.state,
      l = O;
    module1223.default(l.routeName && 'string' == typeof l.routeName, 'Cannot get config because the route does not have a routeName.');
    var b = module1271.default(t, l.routeName),
      v = t[l.routeName],
