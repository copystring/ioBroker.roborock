...
var f = {
    ...
    push: function (t, n) {
      module1223.default(-1 === f.indexOf(t, n.key), 'should not push route with duplicated key %s', n.key);
    ...
    jumpToIndex: function (t, n) {
      if (n === t.index) return t;
        ...
        module1223.default(!!t.routes[n], 'invalid index %s to jump to', n);
        return c(
          c({}, t),
          {},
          {
    ...
    replaceAtIndex: function (t, n, o) {
      if ((module1223.default(!!t.routes[n], 'invalid index %s for replacing route %s', n, o.key), t.routes[n] === o && n === t.index)) return t;
    ...
    reset: function (t, n, o) {
      module1223.default(n.length && Array.isArray(n), 'invalid routes to replace');
      ...
      module1223.default(!!n[f], 'invalid index %s to reset', f);
      return c(
        c({}, t),
        {},
        {
