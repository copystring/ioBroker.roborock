...
var module1264 = {
    transitionSpec: (n = require('./1264').supportsImprovedSpringAnimation()
      ? {
    ...
    screenInterpolator: module1263.default.forHorizontal,
    containerStyle: {
      backgroundColor: '#000',
    },
  },
  p = {
    transitionSpec: n,
    screenInterpolator: module1263.default.forVertical,
    containerStyle: {
      backgroundColor: '#000',
    },
  },
  O = {
    ...
    screenInterpolator: module1263.default.forFadeFromBottomAndroid,
  },
  b = {
    transitionSpec: {
      duration: 230,
