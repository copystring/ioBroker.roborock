var regeneratorRuntime = require('regenerator-runtime'),
  ...
  k = module1126.buttonConfig.rectBtn.size.width,
  z = module1126.buttonConfig.rectBtn.size.width,
  I = k + z,
  D = {
    SwitchOff: 0,
    NoMap: 1,
...
var M = function () {
  var t = module393.isWindowDisplay ? module1395.titleBarContentHeight + 14 : module1395.titleBarContentHeight + module1343.StatusBarHeight + module1343.AppBarMarginTop;
  return -module391.default.iOSAndroidReturn(t, module1395.titleBarHeight);
};

exports.mapOffset = M;

var module1399 = (function () {
  function t() {
  ...
  module7.default(t, null, [
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return React.default.createElement(module1393.default, {
          tip: n,
    ...
    },
    {
      ...
      value: function (t) {
        var n = '';
        n =
          t == module1343.mapOpErrorCode.VENDOR_ERROR_CODE
            ? module510.robot_communication_exception
            : t == module1343.mapOpErrorCode.PROCESS_BUSY_ERROR_CODE
            ? module510.toast_frequently_operate
            : t == module1343.mapOpErrorCode.ERROR_ACCESS_DENIED || t == module1343.mapOpErrorCode.BAD_REQUEST
            ? module510.map_edit_unauthorized_op
            : t == module1343.mapOpErrorCode.ERROR_ACTION_LOCKED
            ? module510.rubys_main_diag_update_map
            : (t == module1343.mapOpErrorCode.ERROR_ACTION_TIMEOUT || module1343.mapOpErrorCode.PARAM_ERROR || module1343.mapOpErrorCode.OPERATION_FAILED,
    ...
    },
    {
      ...
      value: function (t, n, o) {
        ...
        return React.default.createElement(module13.View, {
          ...
          style: {
            position: 'absolute',
            left: o - module1126.buttonConfig.rectOperateBoarderDis - 1,
            top: o - module1126.buttonConfig.rectOperateBoarderDis - 1,
            width: t + 2 * module1126.buttonConfig.rectOperateBoarderDis + 1,
            height: n + 2 * module1126.buttonConfig.rectOperateBoarderDis + 1,
            overflow: 'visible',
      ...
      value: function (t, n, o, s) {
        ...
        return React.default.createElement(
          ...
          module22.default({}, o.panHandlers, {
            ...
            style: {
              position: 'absolute',
              left: n - module1126.buttonConfig.rectOperateBoarderDis - 1,
              top: n - module1126.buttonConfig.rectOperateBoarderDis - 1,
              width: t.width + 2 * module1126.buttonConfig.rectOperateBoarderDis + 1,
              height: t.height + 2 * module1126.buttonConfig.rectOperateBoarderDis + 1,
    ...
    },
    {
      ...
      value: function (t, n) {
        var o = arguments.length > 2 && undefined !== arguments[2] ? arguments[2] : {},
          s = I - module1126.buttonConfig.rectOperateBoarderDis + 1,
          l = I + t + module1126.buttonConfig.rectOperateBoarderDis - 1,
          f = z / 2 + k - module1126.buttonConfig.rectOperateBoarderDis + 1;
        return React.default.createElement(
          module13.View,
          module22.default(
            {
          ...
          React.default.createElement(module1212.RectButton, {
            funcId: 'furniture_rect_edit_drag',
            left: 0,
            top: s - 1.5 * z,
            width: module1126.buttonConfig.rectBtn.size.width,
            height: module1126.buttonConfig.rectBtn.size.height,
    ...
    },
    {
      ...
      value: function (t, n, o, u) {
        return React.default.createElement(module1212.RectButton, {
          funcId: n,
          panResponder: o,
          left: t + u - (1.5 * module1126.buttonConfig.rectBtn.size.width) / 2 - 1 + module1126.buttonConfig.rectOperateBoarderDis,
          top: u - (1.5 * module1126.buttonConfig.rectBtn.size.height) / 2 + 1 - module1126.buttonConfig.rectOperateBoarderDis,
          width: module1126.buttonConfig.rectBtn.size.width,
          height: module1126.buttonConfig.rectBtn.size.height,
    ...
    },
    {
      ...
      value: function (t, n, o, u) {
        return React.default.createElement(module1212.RectButton, {
          funcId: n,
          panResponder: o,
          left: t.width + u - (1.5 * module1126.buttonConfig.rectBtn.size.width) / 2 - 1 + module1126.buttonConfig.rectOperateBoarderDis,
          top: t.height + u - (1.5 * module1126.buttonConfig.rectBtn.size.height) / 2 - 2 + module1126.buttonConfig.rectOperateBoarderDis,
          width: module1126.buttonConfig.rectBtn.size.width,
          height: module1126.buttonConfig.rectBtn.size.height,
    ...
    },
    {
      ...
      value: function (t, n, o) {
        ...
        return React.default.createElement(module1212.RectButton, {
          funcId: t,
          panResponder: n,
          left: o - (1.5 * module1126.buttonConfig.rectBtn.size.width) / 2 - module1126.buttonConfig.rectOperateBoarderDis,
          top: module22 - (1.5 * module1126.buttonConfig.rectBtn.size.height) / 2 + 1 - module1126.buttonConfig.rectOperateBoarderDis,
          width: module1126.buttonConfig.rectBtn.size.width,
          height: module1126.buttonConfig.rectBtn.size.height,
    ...
    },
    {
      ...
      value: function (t, n, o) {
        ...
        return React.default.createElement(module1212.RectButton, {
          ...
          panResponder: n,
          left: o - (1.5 * module1126.buttonConfig.rectBtn.size.width) / 2 - module1126.buttonConfig.rectOperateBoarderDis,
          top: o - (1.5 * module1126.buttonConfig.rectBtn.size.height) / 2 + 1 - module1126.buttonConfig.rectOperateBoarderDis,
          width: module1126.buttonConfig.rectBtn.size.width,
          height: module1126.buttonConfig.rectBtn.size.height,
...
var x = module13.StyleSheet.create({
  ...
  mapTop: module391.default.iOSAndroidReturn(module1343.StatusBarHeight + module1343.AppBarMarginTop, module13.StatusBar.currentHeight || 0) + 44 + 60,
  mapBottom: 60,
  mapLeft: 10,
  mapRight: 10,
  confirmButton: {
  ...
  resetButton: {
    ...
    justifyContent: 'center',
    right: 22,
    top: module391.default.isIphoneX() ? module1343.StatusBarHeight + module1343.AppBarHeight + 36 : module1343.StatusBarHeight + module1343.AppBarHeight + 12,
  ...
  areaView: {
    position: 'absolute',
    alignSelf: 'center',
    bottom: module1126.buttonConfig.rectSerial.size.height / 2,
    width: 100,
    height: module1126.buttonConfig.rectSerial.size.height,
    overflow: 'visible',
    alignItems: 'center',
    justifyContent: 'center',
  },
  areaText: {
    color: module1126.buttonConfig.areaTextColor,
    fontSize: 10,
  },
  dragView: {
    position: 'absolute',
