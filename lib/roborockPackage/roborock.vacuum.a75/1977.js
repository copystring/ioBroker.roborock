      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (!(null == (n = this.mapView)))
            n.changeMapViewMode(t ? module1124.MapModelInCleanMode.Segment_Clean_Edit_With_Clean_Type : module1124.MapModelInCleanMode.Segment_Clean_Edit);
        },
      },
      {
        key: 'setMapData',
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            C = React.default.createElement(module1393.default, {
