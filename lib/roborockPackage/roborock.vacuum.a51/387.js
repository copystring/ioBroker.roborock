...
exports.LogEventCommon = function (t) {
  var n,
    l = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : {},
    u = arguments.length > 2 && undefined !== arguments[2] ? arguments[2] : null != (n = globals.currentPageName) ? n : '';
  ...
  module419.Log.log(module418.LogTypes.UserAction, '@' + u + ' -- event: ' + t + ' -- params: ' + JSON.stringify(l), module418.InfoColors.Normal);
};

exports.LogEventRecordView = function (t, n, l) {
  var u = arguments.length > 3 && undefined !== arguments[3] ? arguments[3] : {};
  module393.logEventRecordView(t, n, l, u);
  module419.Log.log(module418.LogTypes.UserAction, t + ' ==> ' + n + ', stay ' + l + 'ms, paras: ' + JSON.stringify(u), module418.InfoColors.Normal);
};
...
function E(t) {
  for (var l = 1; l < arguments.length; l++) {
    var I = null != arguments[l] ? arguments[l] : {};
    if (l % 2)
      u(Object(I), true).forEach(function (l) {
        module50.default(t, l, I[l]);
      });
    else if (Object.getOwnPropertyDescriptors) Object.defineProperties(t, Object.getOwnPropertyDescriptors(I));
    else
      u(Object(I)).forEach(function (n) {
