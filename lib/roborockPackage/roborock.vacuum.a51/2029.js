  ...
  B = (function (t) {
    ...
    function O(t) {
      ...
      (o = B.call(this, t)).state = {
        monitorEnabled: module1633.default.realTimeMonitorEnabled,
        videoSetting: module1633.default.realVideoSetting,
      ...
      },
      {
        ...
        value: function () {
          ...
          this.props.navigation.navigate('WebViewPage', {
            ...
            refrence: module1648.default.MonitorPrivacy(),
            buttonTitle: module1633.default.monitorPrivacyPolicyAgreed ? module510.reset_authoration : module510.button_title_agree,
            buttonColor: module1633.default.monitorPrivacyPolicyAgreed ? 'red' : '#007aff',
            buttonAction: function (o) {
              if (module381.RSM.isRunning && module1633.default.monitorPrivacyPolicyAgreed)
                o.alertView &&
                ...
                var n = function () {
                  ...
                  if (t.timerForUnlock) module1414.clearTimeout(t.timerForUnlock);
                  module381.RSM.hardLockCameraStatus();
                  module1633.default.updateMonitorPrivacy(!module1633.default.monitorPrivacyPolicyAgreed, function (n) {
                    if (
                      ((t.timerForUnlock = module1414.setTimeout(function () {
                      ...
                      if ('' != (l = module1633.default.monitorPrivacyPolicyAgreed ? '' : module510.map_object_cancel_privacy_success)) globals.showToast(l);
                      o.props.navigation.setParams({
                        buttonTitle: module1633.default.monitorPrivacyPolicyAgreed ? module510.reset_authoration : module510.button_title_agree,
                        buttonColor: module1633.default.monitorPrivacyPolicyAgreed ? 'red' : '#007AFF',
                      });
                      module387.LogEventCommon(module1633.default.monitorPrivacyPolicyAgreed ? 'accept_monitor_privacy' : 'reset_monitor_privacy_confirm');
                    } else {
                      var l = module1633.default.monitorPrivacyPolicyAgreed ? module510.map_object_cancel_privacy_timeout : module510.map_object_ignore_failed;
                      globals.showToast(l);
                    }
                  });
                };

                if (module1633.default.monitorPrivacyPolicyAgreed) {
                  if (o.alertView)
                    o.alertView.customAlert(
                ...
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    return regeneratorRuntime.default.awrap(
                      module393.postPrivacyAgreementStatus(module381.RobotStatusManager.sharedManager().serverCode, module1633.default.monitorPrivacyPolicyAgreed ? 2 : 3)
                    );
                              ...
                              for (;;)
                                switch ((n.prev = n.next)) {
                                  case 0:
                                    ...
                                    module1633.default.realTimeMonitorEnabled = t;
                                    n.next = 4;
                                    return regeneratorRuntime.default.awrap(module1633.default.updateCameraStatus());
      ...
      },
      {
        ...
        value: function () {
          ...
          var l = this.getMenus().map(function (t, o) {
            ...
            s = {
              title: module510.setting_realtime_monitor_switch_title,
              detail: module1633.default.realTimeMonitorEnabled ? module510.setting_camera_on : module510.setting_camera_off,
              detailColor: module1633.default.realTimeMonitorEnabled ? '#007AFF' : this.context.theme.settingListItem.disableColor,
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module1924.MonitorPrivacyDialogWithNavbar, {
              ref: function (o) {
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    o = 0 == t;
                    n.next = 3;
                    return regeneratorRuntime.default.awrap(module1633.default.updatePetModeEnabled(o));

                  case 3:
                    this.setState({
                      petModeEnabled: module1633.default.petModeEnabled,
                    });
