  ...
  F = (function (t) {
    ...
    module7.default(j, [
      ...
      },
      {
        ...
        value: function () {
          module1494.default.shared().enableBackAndMore();
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            p = l.parent,
            c = l.isSmartScene,
            M = (u && (null == p ? undefined : p.tabIndex) == module1620.TabZone) || this.props.isTabZone,
            f = null;
          if (h || (c && !M)) f = module510.custom_mode_panel_has_custom_data_tip;
          ...
          var b = React.default.createElement(module13.ImageBackground, {
            ...
            y = React.default.createElement(module1118.MapView, {
              top: 30,
              right: 0,
              left: 0,
              bottom: 80,
              ...
              pointerEvents: 'none',
              hideAccessory: true,
              blockBubbleShowInfo: module1118.BlockBubbleShowInfo.CLEANMODE,
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module390.default.isPureCleanMopSupported())
            this.waterMode == module1618.WaterModeZero ? (t = 2) : this.cleanMode == module1618.CleanModeZero ? (t = 1) : this.state.isCustomMode && (t = 3);
          return t;
        },
      },
      {
        ...
        value: function () {
          ...
          var p = n && module390.default.isSoftCleanModeSupportedInMain() ? 0 : 1,
            c = module1618.CleanModes().slice(p, module1618.CleanModes().length);
          if (module390.default.isMaxPlusModeSupported() || module390.default.isNonePureCleanMopWithMaxPlus()) c.pop();

          var M = !u && h,
            _ = M && n && module390.default.isSoftCleanModeSupportedInMain() && this.cleanMode == module1618.CleanModeZero,
      ...
      },
      {
        ...
        value: function () {
          ...
          return module390.default.isCustomWaterBoxDistanceSupported() && 207 == module381.RSM.waterBoxMode && o
            ? React.default.createElement(module1630.SliderAdjuster, {
                title: null,
                style: {
                  backgroundColor: 'transparent',
                },
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            h = this.getCurrentTab(),
            p = module390.default.isPureCleanMopSupported() && 0 == h,
            c = module390.default.isPureCleanMopSupported() && 1 == h,
            M = module390.default.isPureCleanMopSupported() && 2 == h,
            C = module1618.MopMethods();

          if (
            (p
              ? (C = [module1618.CleanRouteFast(), module1618.CleanRouteDaily()])
              : c
              ? (C = module1618.MopMethods())
              : M && (C = [module1618.CleanRouteFast(), module1618.CleanRouteDaily()]),
            !s)
          ) {
            var x = C.findIndex(function (t) {
              return t.strength == module1618.CleanRouteFastMode;
            });
            if (-1 != x) C.splice(x, 1);
            console.log('cleanRouteItems', x, C);
          }
          ...
          return module390.default.isShakeMopSetSupported() && u
            ? React.default.createElement(
                ...
                React.default.createElement(module384.default, {
                  ...
                  isRedAddonTip: true,
                  isInHomePage: s,
                  shouldShowQuestionIcon: s && (301 == this.mopMode || 303 == this.mopMode || this.mopMode == module1618.CleanRouteDeepSlowPearlMode || 304 == this.mopMode),
                  willOnPressButton: function (o) {
                    console.log('willOnPressButton', o, module381.RSM.mapSaveEnabled, module381.RSM.currentMapId);
                    return (
                      !s ||
                      !!(o != module1618.CleanRouteFastMode || (module381.RSM.mapSaveEnabled && -1 != module381.RSM.currentMapId)) ||
                      (null == t || null == (n = t.props) || n.showCleanRouteGuideByMode(module1618.CleanRouteFastMode + 1e4), false)
                    );
                    var n;
                  },
      ...
      },
      {
        ...
        value: function () {
          ...
          var x = module1618.MopWaterOrStrengths();
          ...
          return React.default.createElement(
            ...
            c &&
              React.default.createElement(module384.default, {
                ...
                submode: v,
                title: module390.default.isCleanRouteSettingSupported() && !module424.DMM.isPearl ? module510.custom_water_tanos_mode_title : module510.custom_water_mode_title,
                items: x,
                enabled: y,
                isInHomePage: l,
                addonTip: module390.default.isPureCleanMopSupported()
                  ? null
                  : C && module381.RSM.isWaterBoxIn && l && module381.RSM.waterBoxMode == module1618.WaterModeZero
                  ? module510.effect_only_once_tip
                  : u && !module390.default.isShakeMopSetSupported() && module381.RSM.waterBoxMode == module1618.WaterModeZero
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(module1610.SwipeDownIndicator, {
                  style: {
                    marginBottom: 10,
                  },
                }),
                (!s || module390.default.isPureCleanMopSupported()) &&
                  React.default.createElement(module1629.default, {
                    tabs: this.tabs,
            ...
            function (E) {
              for (;;)
                switch ((E.prev = E.next)) {
                  case 0:
                    if (
                      (module1494.default.shared().disableBackAndMore(),
                  ...
                  case 10:
                    if (
                      ...
                      (this.waterMode = S),
                      (this.mopMode = f),
                      (C = module1618.isModeCustomized(M, S, f) && !h),
                      (x = module390.default.isPureCleanMopSupported() && M == module1618.CleanModeZero),
                      (v = module390.default.isPureCleanMopSupported() && S == module1618.WaterModeZero),
                      module390.default.isPureCleanMopSupported()
                        ? ((P = S != module1618.WaterModeZero && M != module1618.CleanModeZero),
                          (W = 0),
                          x ? (W = 1) : v ? (W = 2) : C && (W = 3),
                          (this.state.shouldShowCleanModeView = P || v),
                          (this.state.shouldShowWaterModeView = P || x),
                          (this.state.shouldShowMopMethodView = x || (module390.default.isCleanRouteFastModeSupported() && p)),
                          (module394.MC.customTabIndex = W))
                        : ((this.state.shouldShowWaterModeView = module390.default.isElectronicWaterBoxSupported()),
                          (this.state.shouldShowMopMethodView = module390.default.isCleanRouteSettingSupported() && p),
                    ...
                    if (M == module1618.CustomCleanMode) M = module1618.CleanModes()[2].strength;
                    if (S == module1618.CustomWaterMode) S = module1618.MopWaterOrStrengths()[2].strength;
                    if (f == module1618.CustomMopMode) f = module1618.MopMethods()[0].strength;
                  ...
                  case 30:
                    this.setState(
                      ...
                      function () {
                        if (k.cleanModeSetView) k.cleanModeSetView.setMode(M, module1618.CustomCleanMode);
                        if (k.waterModeSetView) k.waterModeSetView.setMode(S, module1618.CustomWaterMode);
                        if (k.mopModeSetView) k.mopModeSetView.setMode(f, u || h || c ? 0 : 301);
                        k.updateMapWithCustomMode();
                        module13.Animated.timing(k.animatedMarginBottom, {
                          toValue: 0,
                          duration: 250,
                        }).start();
                        k.forceUpdate();
      ...
      },
      {
        ...
        value: function () {
          if (this.mapView) this.mapView.setState(L({}, module415.MM.mapData));
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    ...
                    if (
                      !(
                        h != module1618.WaterModeZero ||
                        (p != module1618.CleanRouteSubtlyMode && p != module1618.CleanRouteDeepSlowMode && p != module1618.CleanRouteDeepSlowPearlMode)
                      )
                    )
                      p = module1618.CleanRouteDailyMode;
      ...
      },
      {
        ...
        value: function () {
          if (module390.default.isCleanRouteSettingSupported())
            return !module381.RSM.isWaterBoxIn && this.props.isInHomePage
              ? module510.water_box_not_installed_tip_tanos
              : !module381.RSM.isWaterBoxCarriageIn && this.props.isInHomePage
              ? module510.water_box_not_installed_tip
              : module381.RSM.waterShortageStatus && this.props.isInHomePage
              ? module510.tanos_s_water_shortage
              : null;
          else return module390.default.isElectronicWaterBoxSupported() && !module381.RSM.isWaterBoxIn && this.props.isInHomePage ? module510.water_box_not_installed_tip : null;
        },
      },
      {
              ...
              for (;;)
                switch ((M.prev = M.next)) {
                  ...
                  case 21:
                    ...
                    this.cleanMode = t;
                    if (this.cleanModeSetView) this.cleanModeSetView.setMode(t, module1618.CustomCleanMode);
              ...
              for (;;)
                switch ((M.prev = M.next)) {
                  ...
                  case 38:
                    ...
                    this.showToast(module510.robot_communication_exception);
                    if (this.waterModeSetView) this.waterModeSetView.setMode(t, module1618.CustomWaterMode);
              ...
              for (;;)
                switch ((p.prev = p.next)) {
                  ...
                  case 11:
                    ...
                    if (((u = module420.StorageKeys.ExquisiteCleanbyGuide + '_' + o), (p.t0 = o == module1618.CleanRouteFastMode), p.t0)) {
                      p.next = 21;
                      break;
                    }
                  ...
                  case 31:
                    ...
                    p.t1 = p.catch(7);
                    this.isRequesting = false;
                    console.log('setMopMode  error: ' + ('object' == typeof p.t1 ? JSON.stringify(p.t1) : p.t1));
                    this.showToast(module510.robot_communication_exception);
              ...
              for (;;)
                switch ((K.prev = K.next)) {
                  case 0:
                    ...
                    K.t0 = module1618.CustomCleanMode;
                    K.next = 17;
                    break;
                  ...
                  case 17:
                    ...
                    K.t4 = module1618.CustomWaterMode;
                    K.next = 30;
                    break;
                  ...
                  case 43:
                    if (
                      ((C = K.t8),
                      s && !p && (C = module381.RSM.mopMode),
                      !p &&
                        (function () {
                          if (module390.default.isCleanRouteFastModeSupported()) {
                            if (!(c || (C != module1618.CleanRouteSubtlyMode && C != module1618.CleanRouteDeepSlowMode && C != module1618.CleanRouteDeepSlowPearlMode))) C = 300;
                            if (!(s || C != module1618.CleanRouteFastMode)) C = module1618.CleanRouteDailyMode;
                          } else if (!c) C = 300;

                          if (C == module1618.CustomMopMode) C = 300;
                        })(),
                      module390.default.isPureCleanMopSupported()
                        ? (M
                            ? ((f = module1618.WaterModeZero),
                              (this.state.shouldShowCleanModeView = true),
                              (this.state.shouldShowWaterModeView = false),
                              (this.state.shouldShowMopMethodView = false))
                            : c
                            ? ((S = module1618.CleanModeZero),
                      ...
                      this.setState(
                        ...
                        function () {
                          if (p) H.updateMapWithCustomMode();
                          if (h && module390.default.isPureCleanMopSupported() && 104 == S)
                            null == H ||
                              H.cleanModeSetView.setState({
                                current: 3,
                              });
                        }
                      ),
                  ...
                  case 73:
                    ...
                    if (s) null == l || null == (W = l.sidebarMenu) || W.updateModeIcon(S, f, C);
                    if (u) u(S, f, C);
                    module13.DeviceEventEmitter.emit(module420.NotificationKeys.DidReceiveSpecialEvent, {
                      data: module420.EventKeys.CleanWaterModeDidChange,
                    });
      ...
      },
      {
        ...
        value: function (t, o, n) {
          return !(module1618.isModeCustomized(t, o, n) && !this.props.isSmartScene);
        },
      },
      {
