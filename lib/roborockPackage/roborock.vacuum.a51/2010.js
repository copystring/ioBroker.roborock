      ...
      },
      {
        ...
        value: function () {
          ...
          if (module393.isMiApp)
            ...
            this.audioPlayerDidFinishPlayingListener = module13.DeviceEventEmitter.addListener(module393.audioPlayerDidFinishPlayingEvent, function (s) {
          ...
          module13.AppState.addEventListener('change', this._handleAppStateChange.bind(this));
        },
      },
      {
        ...
        value: function () {
          ...
          module13.AppState.removeEventListener('change', this._handleAppStateChange.bind(this));
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = this.context.theme.soundPackage,
            s = module13.Dimensions.get('window').width - 220,
            ...
            u = React.default.createElement(module2011.default, {
              progress: this.state.progress,
              style: E.progressView,
            }),
            _ = this.state.progress >= 0 && this.state.progress < 1 ? u : c,
            P = 'https://' + module1337.areaServerMap[module381.RSM.serverCode].host + this.props.data.bg_pic.split('.com')[1],
            S = '';

          if (this.props.data.validEndTime) {
            var b = module1638.convertTimeFromSourceZoneToPhoneZoneByTimestamp(this.props.data.validEndTime, 0);
            S = module510.soundpackage_valid_end_time_title + ' ' + b.year + '.' + b.month + '.' + b.day;
            if (b.year >= 2099) S = module510.soundpackage_valid_end_time_title + ' ' + module510.voice_package_end_validtime_forever;
          }
            ...
            function (l) {
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    if (((t = module2012.default.wavFileName(this.props.data.voice_id, this.props.data.version)), !this.state.playing)) {
                      l.next = 16;
                      break;
                    }
                    ...
                    l.prev = 2;
                    l.next = 5;
                    return regeneratorRuntime.default.awrap(module2012.default.stopPlay());
                  ...
                  case 16:
                    ...
                    return regeneratorRuntime.default.awrap(
                      module2012.default.startPlay(t, {
                  ...
                  case 25:
                    ...
                    l.t1 = l.catch(16);
                    l.prev = 27;
                    s = module1337.areaServerMap[module381.RSM.serverCode].cdnHost;
                    module6 = 'https://' + s + this.props.data.voice_pre_listen.split('.com')[1];
                    l.next = 32;
                    return regeneratorRuntime.default.awrap(module391.default.asyncDownloadFile(module6, t));
...
exports.default = D;
D.contextType = module1193.AppConfigContext;
