  ...
  E = (function (n) {
    ...
    function E(n) {
      ...
      (t = R.call(this, n)).handleFBZPanOnShouldStart = function () {
        return module1343.default.enableEditMap();
      };

      t.handleFBZPanStart = function (n, l) {
        if (n == module1120.FbzType.FBZ_TYPE_REGULAR) {
        ...
        } else if (n == module1120.FbzType.FBZ_TYPE_MOPPING) {
          ...
          t._clearMapZonesFocus(t.cleanFbzReferences);
        } else if (n == module1120.FbzType.FBZ_TYPE_CLEANING) {
    ...
    module7.default(E, [
      {
        ...
        value: function (n, t) {
          if (!n.zonesHasEdited) {
            ...
            this._initFBZones(n.fbzZones, module1120.FbzType.FBZ_TYPE_REGULAR);

            this._initFBZones(n.mopZones, module1120.FbzType.FBZ_TYPE_MOPPING);

            this._initFBZones(n.cleanZones, module1120.FbzType.FBZ_TYPE_CLEANING);
          }
      ...
      },
      {
        key: 'getNewWallIndex',
        value: function () {
          for (var n = this._getVisibleZonesCount(this.wallReferences), t = 1; t <= module1120.MAX_COUNT_WALL_OR_FBZ; t++)
      ...
      },
      {
        ...
        value: function () {
          return this._getVisibleZonesCount(this.wallReferences) >= module1120.MAX_COUNT_WALL_OR_FBZ;
        },
      },
      {
        key: 'getVisibleWalls',
      ...
      },
      {
        key: 'getNewRectIndex',
        value: function (n) {
          for (var t = this._getFbzRefsByType(n), l = this._getVisibleZonesCount(t), s = 1; s <= module1120.MAX_COUNT_WALL_OR_FBZ; s++)
      ...
      },
      {
        ...
        value: function (n) {
          ...
          return !!t && this._getVisibleZonesCount(t) >= module1120.MAX_COUNT_WALL_OR_FBZ;
        },
      },
      {
        key: 'getVisibleFBZZones',
        value: function () {
          for (var n = [], t = 1; t <= module1120.MAX_COUNT_WALL_OR_FBZ; t++) {
            var l, s, o;
      ...
      },
      {
        ...
        value: function () {
          return (
            ...
            3 * module1120.MAX_COUNT_WALL_OR_FBZ
          );
        },
      },
      {
        ...
        value: function () {
          for (var n = 0, t = 1; t <= module1120.MAX_COUNT_WALL_OR_FBZ; t++)
          ...
          for (t = 1; t <= module1120.MAX_COUNT_WALL_OR_FBZ; t++)
      ...
      },
      {
        ...
        value: function (n, t, l) {
          ...
          if (s && !(s.length <= 0))
            if (this.isFBZsReachMaxNum(module1120.FbzType.FBZ_TYPE_REGULAR) || this.isAllZonesReachMaxNum()) globals.showToast(module510.map_edit_forbidden_zone_exceed_limit);
            else {
        ...
        value: function () {
          ...
          if ((!this.FBZZoneInit && this.props.initFBZone && ((t = true), (l = this.props.initFBZone), (this.FBZZoneInit = true)), !this.stuckPtInit && this.props.initStuckPt)) {
            ...
            if ((null == u ? undefined : null == (c = u.nearby) ? undefined : c.length) > 1) {
              ...
              l = module1333._pointToStuckRect(u);
              s = true;
            }
          }
          ...
          if (t && l)
            module1414.setTimeout(function () {
              var t = n.getNewRectIndex(module1120.FbzType.FBZ_TYPE_REGULAR);

              if (t > 0) {
                n.addFBZZones(t, l, o, module1120.FbzType.FBZ_TYPE_REGULAR, s);
                module1414.setTimeout(function () {
      ...
      },
      {
        ...
        value: function (n) {
          if (n && 0 != n.length) {
            for (o = 1; o <= module1120.MAX_COUNT_WALL_OR_FBZ; o++)
              if (o <= n.length) {
                var t,
                  l = n[o - 1];
            ...
            for (var o = 1; o <= module1120.MAX_COUNT_WALL_OR_FBZ; o++) {
              var c;
      ...
      },
      {
        ...
        value: function (n, t) {
          ...
          if (l)
            if (n && 0 != n.length) {
              for (u = 1; u <= module1120.MAX_COUNT_WALL_OR_FBZ; u++)
                if (u <= n.length) {
                  var s,
                    o = n[u - 1];
              ...
              for (var u = 1; u <= module1120.MAX_COUNT_WALL_OR_FBZ; u++) {
                var f;
      ...
      },
      {
        ...
        value: function (n) {
          return n == module1120.FbzType.FBZ_TYPE_REGULAR
            ? this.forbidReferences
            : n == module1120.FbzType.FBZ_TYPE_MOPPING
            ? this.moppingFbzReferences
            : n == module1120.FbzType.FBZ_TYPE_CLEANING
      ...
      },
      {
        ...
        value: function (n, t) {
          ...
          if (n[t].state.visible) {
            for (var s = this._getVisibleZonesCount(n), o = 1; o <= module1120.MAX_COUNT_WALL_OR_FBZ; o++)
              n[o] &&
                n[o].state.visible &&
      ...
      },
      {
        ...
        value: function (n, t) {
          var l,
            ...
            c = t ? module1120.ROBOT_FORBIDDEN_R : module1120.DOCK_FORBIDDEN_R;
          return !(!o || (0 == o.x && 0 == o.y)) && module1333._judgeInlegalFBZ(o.x, o.y, n, c * this.props.transform.xx);
        },
      },
      {
      ...
      },
      {
        ...
        value: function (n, t) {
          ...
          var u = module1333._convertToPixelEndpoint(n.state.position, this.props.transform);

          return module1333._disBtwPointSegement(o.x, o.y, u.start.x, u.start.y, u.end.x, u.end.y).distance / this.props.transform.xx < c;
        },
      },
      {
        ...
        value: function (n, t, l) {
          var s = this,
            o = this.props.mapMode == module1337.MAP_MODE_MAP_EDIT;
          return Object.keys(t).map(function (c, u) {
            return React.default.createElement(module1204.ForbiddenZone, {
              ...
              transform: l,
              editable: o,
              showArea: s.props.mapMode == module1337.MAP_MODE_MAP_EDIT,
      ...
      },
      {
        ...
        value: function (n) {
          var t = this,
            l = this.props.mapMode == module1337.MAP_MODE_MAP_EDIT;
          return Object.keys(this.wallReferences).map(function (s, o) {
            return React.default.createElement(module1204.InvisibleWall, {
              key: o,
              id: s,
      ...
      },
      {
        ...
        value: function (n) {
          if (this.props.initStuckPt && this.props.initStuckPt.nearby) {
            ...
            var l = module1120.Config.size.objectsRadius * (n.xx || 1);
      ...
      },
      {
        ...
        value: function (n) {
          ...
          var l = {
            ...
            s = this.props.mapMode == module1337.MAP_MODE_MAP_EDIT;
          return this.state.cliffData.map(function (o, c) {
            var u = o.rectSize || module1333._pointToStuckRect(o),
              h = o.slopeAngle || 0;
            ...
            return React.default.createElement(module1204.RectZone, {
              ...
              innerImage: o.changed ? null : module1120.MapAITag,
        ...
        value: function () {
          var n = new M({
            ...
            l =
              ...
              (this.props.mapMode == module1337.MAP_MODE_MAP_EDIT || !module381.RSM.isRunning || (module381.RSM.isRunning && module381.RSM.isCleanFBZEnabled)),
            s = module1343.default.mapEditStep >= module1343.MapEditSteps.Saved || this.props.mapMode != module1337.MAP_MODE_MAP_EDIT;
          return React.default.createElement(
            ...
            this.getForbiddenZone(module1120.FbzType.FBZ_TYPE_REGULAR, this.forbidReferences, n),
            l && this.getForbiddenZone(module1120.FbzType.FBZ_TYPE_CLEANING, this.cleanFbzReferences, n),
            t && this.getForbiddenZone(module1120.FbzType.FBZ_TYPE_MOPPING, this.moppingFbzReferences, n),
