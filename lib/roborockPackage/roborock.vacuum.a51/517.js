...
var module512 = require('./512'),
  x = [module421.Types.Home, module421.Types.KeyEvent, module421.Types.LoopStatus, module421.Types.LoopMap],
  C = (function (t) {
    module9.default(R, t);
    ...
    function R(t) {
      ...
      n.state = {
        ...
        showDelete: true,
        isNoData: false,
        selectedTypes: module421.Category.map(function (t, n) {
          return -1 !=
    ...
    module7.default(R, [
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    c.t0 = JSON.parse(JSON.stringify(module419.Log.logs));
                    c.next = 8;
                    break;

                  case 5:
                    c.next = 7;
                    return regeneratorRuntime.default.awrap(module419.Log.getLog(this.logId));
                    ...
                    l = (t ? n : n.logs).filter(function (t) {
                      return (
                        ...
                        s.state.selectedTypes.findIndex(function (n) {
                          return module421.Category[n].type == t.type;
                        })
                      );
                    });
                    this.logs = l;
      ...
      },
      {
        ...
        value: function () {
          ...
          this.logs.forEach(function (n) {
            t += n.type + '  ' + module422.default.getTime(n.time) + ' \n ' + n.content + ' \n\n';
          });
          this.copy(t);
        },
      },
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    ...
                    n.next = 4;
                    return regeneratorRuntime.default.awrap(module419.Log.upload(this.logId, t));
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module385.OptionSheetView, {
              title: '\u8bf7\u9009\u62e9\u8981\u67e5\u770b\u7684log\u7c7b\u578b',
              options: module421.Category.map(function (t) {
                return t.name;
              }),
      ...
      },
      {
        key: 'renderRow',
        value: function (t) {
          var n = module421.GetCateroy(t.type) || {};
          return React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    module422.default.getTime(t.time),
                    ' '
                  )
                )
              ),
      ...
      },
      {
        key: 'onPressRow',
        value: function (t) {
          this.copy(t.type + '  ' + module422.default.getTime(t.time) + ' \n' + t.content);
        },
      },
    ]);
    return R;
