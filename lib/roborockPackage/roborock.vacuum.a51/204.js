...
var module205 = require('./205'),
  ...
  p = {
    componentDidMount: function () {
      if (module52.isTV) {
        this._tvEventHandler = new module208();

        this._tvEventHandler.enable(this, function (t, E) {
          var R = module86.findNodeHandle(t);
          E.dispatchConfig = {};
          if (R === E.tag)
            'focus' === E.eventType
    ...
    _remeasureMetricsOnActivation: function () {
      ...
      if (null != t) module47.measure(t, this._handleQueryLayout);
    },
    _handleQueryLayout: function (t, E, R, o, _, S) {
      if (t || E || R || o || _ || S) {
        if (this.state.touchable.positionOnActivate) module207.release(this.state.touchable.positionOnActivate);
        if (this.state.touchable.dimensionsOnActivate) module205.release(this.state.touchable.dimensionsOnActivate);
        this.state.touchable.positionOnActivate = module207.getPooled(_, S);
        this.state.touchable.dimensionsOnActivate = module205.getPooled(R, o);
      }
    },
  ...
  C = module56(p, ['touchableHandleFocus', 'touchableHandleBlur']);
