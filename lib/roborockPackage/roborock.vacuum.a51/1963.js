  ...
  module7.default(j, [
    ...
    },
    {
      ...
      value: function () {
        var t,
          ...
          R = React.default.createElement(
            ...
            React.default.createElement(module385.SettingListItemView, {
              ...
              detail:
                module1208.FloorMapPageUtils.getRealName(
                  null !=
                    (u =
                      null ==
          ...
          L = React.default.createElement(module1921.default, {
            ref: function (t) {
        ...
        var G = React.default.createElement(module1118.MultiMapSelectView, {
          ...
          F = React.default.createElement(module1502.default, {
            ref: function (t) {
    ...
    },
    {
      ...
      value: function () {
        ...
        this.props.navigation.setParams({
          ...
          rightItems: [
            module1343.default.confirmButton(
              function () {
      ...
      value: function () {
        ...
        this.mapListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.MapDidUpdate, function () {
          ...
          if ((t.updateMap(), (null != (n = null == (o = t.initialZonesList) ? undefined : o.length) ? n : 0) > 0)) {
            ...
            var S = null != (u = null == (c = module415.MM.mapData) ? undefined : null == (h = c.smartZones) ? undefined : h.smartZones) ? u : [];
            ...
            S.filter(function (n) {
              ...
              .forEach(function (n) {
                ...
                if (!(null == (o = t.mapView)))
                  o.setState(F({}, module415.MM.mapData), function () {
    ...
    },
    {
      ...
      value: function () {
        ...
        if (!(null == (n = this.sidebarMenu)))
          n.setState({
            tab: this.state.mode == U.Segment ? module1620.TabSegment : module1620.TabZone,
            mapEditButtonEnabled: module390.default.isSupportSmartScene(),
            modeSetButtonEnabled: module390.default.isSupportSmartScene(),
          });
          ...
          if (t != module381.RSM.currentMapId)
            module381.RSM.isRunning
              ...
              : ((n.isLoadingMap = true),
                ...
                new module1341.MultiMapDataProvider()
                  .loadMap(t)
                  .then(function (o) {
                    n.mapUpdated = false;
    ...
    },
    {
      ...
      value: function () {
        ...
        var o = module382.getCleanModeTitle(this.state.cleanMode),
          ...
          s = o + (l ? ' | ' + l : '');
        if (module390.default.isPureCleanMopSupported() && this.state.cleanMode == module1618.CleanModeZero) return l + ' | ' + module382.getMopMethodTitle(this.state.mopMode);
        ...
        if (module390.default.isShakeMopSetSupported() && 200 != this.state.waterMode) {
          ...
          if (t) {
            if (n == module1619.CleanMethodClean) return s;
            if (n == module1619.CleanMethodMop) return u;
            if (n == module1619.CleanMethodCleanAndMop) return s + ' | ' + u;
          }
        }
    ...
    },
    {
      key: 'mapMode',
      get: function () {
        if (!module390.default.isSupportSmartScene()) return module1118.MapModelInCleanMode.Segment_Clean_Read_Only;
