...
var module510 = require('./510').strings,
  ...
  N = ['DEV_TEST', 'INTERNAL_TEST', 'EXTERNAL_TEST'],
  K = (function (t) {
    module9.default(K, t);
    ...
    function K(t) {
      ...
      (o = _.call(this, t)).onPressIncrementalMapDebug = function () {
            ...
            for (;;)
              switch ((w.prev = w.next)) {
                ...
                case 4:
                  ...
                  if (c.logId) {
                    module13.Clipboard.setString(c.logId);
                    if (!(null == (S = globals))) S.showToast('\u4e0a\u4f20\u6210\u529f\uff0c logId\u5df2\u590d\u5236');
                  } else if (!(null == (p = globals))) p.showToast('\u4e0a\u4f20\u5931\u8d25\uff0c\u8bf7\u4e00\u5206\u949f\u540e\u91cd\u8bd5\uff0cerror:' + c.error);
      ...
      },
      {
        ...
        value: function () {
          this.setState({
            ...
            photoSwitch: module1633.default.mapObjectPhotoEnabled,
          });
        },
      },
      {
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 3:
                    ...
                    module1633.default.updatePhotoPrivacy(true, function (s) {
                      if (s)
                        module420
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            this.state.showVoiceTest &&
              React.default.createElement(module2108.default, {
                parent: this,
              }),
            this.state.shouldShowAnonymousIDView &&
              React.default.createElement(module2109.default, {
                ref: function (o) {
