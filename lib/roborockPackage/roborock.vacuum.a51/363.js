    ...
    module7.default(n, [
      {
        ...
        value: function (n) {
          ...
          module14.default(module364.default, 'PermissionsAndroid is not installed correctly.');
            ...
            function (E) {
              for (;;)
                switch ((E.prev = E.next)) {
                  ...
                  case 6:
                    module6 = E.sent;
                    return E.abrupt('return', module6 === this.RESULTS.GRANTED);
            ...
            function (o) {
              for (;;)
                switch ((o.prev = o.next)) {
                  ...
                  case 3:
                    if ((module14.default(module364.default, 'PermissionsAndroid is not installed correctly.'), !s)) {
                      o.next = 10;
                      break;
                    }
