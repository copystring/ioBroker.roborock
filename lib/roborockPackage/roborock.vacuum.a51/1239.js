  ...
  E = (function (t, ...args) {
    ...
    function E() {
      ...
      (t = b.call(this, ...args))._configureTransition = function (n, o) {
        return T(
          T({}, module1256.default.getTransitionConfig(t.props.navigationConfig.transitionConfig, n, o, 'modal' === t.props.navigationConfig.mode).transitionSpec),
          {},
          {
            useNativeDriver: !!C,
          }
          ...
          return React.default.createElement(module1259.default, {
            ...
            onTransitionEnd: function (n, o) {
              ...
              if (n.navigation.state.isTransitioning)
                u.dispatch(
                  module1211.StackActions.completeTransition({
                    key: u.state.key,
                  })
                );
              if (p) p(n, o);
