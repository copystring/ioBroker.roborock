...
var F = function () {
  ...
  N = module215({
    ...
    render: function () {
      var module6;
      module6 = this._renderAndroid();
      return <module203.Provider value>{module6}</module203.Provider>;
    },
    _getText: function () {
    ...
    _renderIOSLegacy: function () {
      ...
      if (
        ...
        module14(!(n.value && o), 'Cannot specify both value and children.');
        if (o >= 1)
          s = (
    ...
    _renderAndroid: function () {
      ...
      module14(!(this.props.value && s), 'Cannot specify both value and children.');
