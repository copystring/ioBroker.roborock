        ...
        var module2061 = this.getInnerFailedView(require('./2061'), module510.button_title_retry),
          ...
          F = React.default.createElement(
            ...
            React.default.createElement(
              ...
              f,
              this.state.readPhotoLoadingStatus == R.LOADING && module1415,
              this.state.readPhotoLoadingStatus == R.FAILED && module2061
            )
          ),
          ...
          module2086 = this.state.isSure ? require('./2086') : o.monitor.confirmPhoto;
        return React.default.createElement(
          module13.View,
          {
            style: [
          ...
          React.default.createElement(
            ...
            React.default.createElement(
              ...
              module390.default.isFwFilterObstacleSupported() && module1633.default.mapObjectPhotoEnabled && u && u.length >= 1 ? F : module2062,
              React.default.createElement(
                module13.Text,
