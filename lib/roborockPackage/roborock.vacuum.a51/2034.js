  ...
  h = (function (t) {
    ...
    module7.default(E, [
      ...
      },
      {
        key: 'render',
        value: function () {
          var t = Object.keys(module1337.VideoError).map(function (t) {
            return module1337.VideoError[t];
          });
          return React.default.createElement(module13.FlatList, {
            style: [
              w.wrap,
              {
                paddingLeft: this.isPortrait ? 0 : module1337.AppBarMarginTop + 20,
              },
            ],
            data: t,
...
var w = module13.StyleSheet.create({
  wrap: {
    ...
    paddingLeft: module1337.AppBarMarginTop > 0 ? module1337.AppBarMarginTop + 20 : 0,
  },
  row: {
