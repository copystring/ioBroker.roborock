    ...
    module7.default(_, [
      {
        ...
        value: function () {
          var t = this,
            ...
            n = [
              {
                title: module510.map_type_2d,
                type: '2d',
                img: o.type2d,
              },
            ],
            p = {
              title: module510.map_type_3d,
              type: '3d',
              img: o.type3d,
            },
            u = {
              title: module510.map_type_ar,
              type: 'ar',
              img: o.typear,
            };
          ...
          var s = this.props.currentType,
            f = undefined === s ? '2d' : s,
            y = ((module13.Dimensions.get('window').width - 16 * (n.length + 1)) / n.length) ** 250,
            S = (y / 504) * 306;
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              module510.map_type_switcher_title
            ),
            React.default.createElement(
              module13.View,
              {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              module510.map_edit_rotate_map_title
            ),
            React.default.createElement(
              module13.View,
              {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          var o = (module13.Dimensions.get('window').width - 32) / t.length - 6,
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              module510.map_element_switcher_title
            ),
            React.default.createElement(
              module13.View,
              {
      ...
      },
      {
        ...
        value: function () {
          var t = this.theme.mapTypeSwitcher,
            l = [],
            o = {
              title: module510.map_element_room_props,
              type: module1118.MapElementShow.NAME_TAG,
              image: t.eleName,
              selImg: t.eleNameSel,
              pvEvent: 'mapdetails_roomname_switch',
            },
            n = {
              title: module510.map_element_custom_props,
              type: module1118.MapElementShow.CUSTOM_ORDER,
              image: t.eleCustom,
              selImg: t.eleCustomSel,
              pvEvent: 'mapdetails_customize_switch',
            },
            p = {
              title: module510.map_edit_floor,
              type: module1118.MapElementShow.FLOOR_CARPET,
              image: t.eleFloor,
              selImg: t.eleFloorSel,
              pvEvent: 'mapdetails_floor_switch',
            },
            u = {
              title: module510.map_element_furnitures,
              type: module1118.MapElementShow.FURNITURE,
              image: t.eleFurniture,
              selImg: t.eleFurnitureSel,
              pvEvent: 'mapdetails_furniture_switch',
            },
            s = {
              title: module510.map_obstacles_title18,
              type: module1118.MapElementShow.OBSTACLE,
              image: t.eleObstacle,
...
module1936.contextType = module1193.AppConfigContext;
module1936.defaultProps = {
...
var O = module13.StyleSheet.create({
  ...
  k = module385.HocBottomModal(module385.WithSwipeToClose(module1936), false);
exports.default = k;
