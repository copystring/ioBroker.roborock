                ...
                switch ((J.prev = J.next)) {
                  case 0:
                    if (
                      ...
                      (J.prev = 1),
                      (o = module1337.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].host),
                      (s = module1337.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].cdnHost),
            ...
            function (y) {
              for (;;)
                switch ((y.prev = y.next)) {
                  case 0:
                    y.prev = 0;
                    t = module1337.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].cdnHost;
                    y.next = 4;
