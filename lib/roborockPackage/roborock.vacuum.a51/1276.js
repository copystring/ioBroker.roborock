  ...
  function k() {
    ...
    t._handleDrawerOpen = function () {
      t.props.navigation.dispatch({
        type: module1275.default.DRAWER_OPENED,
    ...
    t._handleDrawerClose = function () {
      t.props.navigation.dispatch({
        type: module1275.default.DRAWER_CLOSED,
        key: t.props.navigation.state.key,
      });
    };
  ...
  module7.default(k, [
    {
      ...
      value: function () {
        module13.Dimensions.addEventListener('change', this._updateWidth);
      },
    },
    {
    ...
    },
    {
      ...
      value: function () {
        module13.Dimensions.removeEventListener('change', this._updateWidth);
      },
    },
    {
      key: 'render',
      value: function () {
        ...
        return React.default.createElement(
          module1277.default,
          {
            ...
            drawerPosition: 'right' === this.props.navigationConfig.drawerPosition ? module1277.default.positions.Right : module1277.default.positions.Left,
          },
