...
var module510 = require('./510').strings,
  ...
  module1970 = (function (t) {
    ...
    function z(t) {
      ...
      (o = module1977.call(this, t)).hasFetchedRecordCount = 0;
    ...
    module7.default(z, [
      ...
      },
      {
        key: 'testUI',
        value: function () {
          this.cleanRecords = require('./1977');
      ...
      },
      {
        ...
        value: function (t, o, n, s) {
          var l = this,
            u = module1638.utcTimeConvertToPhoneTimeZoneTime(1e3 * t.start);
          console.log('rowData = ' + t);
          if (!module1337.CleanStartType()[t.startType]) module510.localization_strings_Setting_General_index_0;
          var c = module1638.addZeroPrefix(u.month) + '/' + module1638.addZeroPrefix(u.day) + ' ' + module1638.addZeroPrefix(u.hour) + ':' + module1638.addZeroPrefix(u.minute),
          ...
          return React.default.createElement(module1974.default, {
...
module1970.contextType = module1193.AppConfigContext;
