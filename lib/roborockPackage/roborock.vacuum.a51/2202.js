...
var P,
  ...
  module2203 = module393.isRecordSupported() ? require('./2203') : module13.View,
  M = module13.NativeModules.RRRecorder,
  O = 0,
  module2204 = (function (t) {
    module9.default(C, t);
    ...
    function C(t, n) {
      ...
      (o = module2205.call(this, t))._onVolumeChanged = function (t) {
        var n = t.nativeEvent;
    ...
    module7.default(C, [
          ...
          this.Gesture = {
            ...
            onResponderRelease: function (n) {
              ...
              if (
                ...
                t.setState({
                  text: module510.long_press_to_send_voice,
                  icon: t.props.isLandscape ? require('./2204') : t.context.theme.monitor.recordImg,
                }),
                clearTimeout(P),
                t.state.recording)
              ) {
      ...
      },
      {
        ...
        value: function () {
          ...
          this.setState({
            ...
            icon: this.props.isLandscape ? require('./2205') : this.context.theme.monitor.recordSelImg,
          });
                ...
                switch ((t.prev = t.next)) {
                  ...
                  case 9:
                    ...
                    this.setState({
                      recording: false,
                      text: module510.long_press_to_send_voice,
                      icon: this.props.isLandscape ? require('./2204') : this.context.theme.monitor.recordImg,
                    });
      ...
      },
      {
        key: 'robotPlayAudio',
        value: function (t) {
          var n, module22, module6, module7, module9, module11, module12, React, module13, module1193;
          return regeneratorRuntime.default.async(
            function (b) {
              for (;;)
                switch ((b.prev = b.next)) {
                  ...
                  case 7:
                    ...
                    module1193 = JSON.parse(JSON.stringify(module13));
                    b.next = 19;
                    return regeneratorRuntime.default.awrap(module416.default.playAudio(module1193));
...
exports.default = module2204;
module2204.contextType = module1193.AppConfigContext;
