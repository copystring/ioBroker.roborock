  ...
  p = (function (t) {
    ...
    function b(t) {
      ...
      s.handleRemoveFBZ = function (t, n) {
        for (var l, u = s._getVisibleZonesCount(), o = 1; o <= module1120.MAX_COUNT_WALL_OR_FBZ; o++) {
          var c, f;
    ...
    module7.default(b, [
      {
        ...
        value: function () {
          ...
          if (t >= module1120.MAX_COUNT_WALL_OR_FBZ) return -1;
          ...
          var t = this,
            ...
            s = Object.keys(this.markRes).map(function (s, l) {
              return React.default.createElement(module1204.ForbiddenZone, {
                key: l,
                id: s,
                type: module1120.FbzType.RECT_TYPE_FBMARK,
