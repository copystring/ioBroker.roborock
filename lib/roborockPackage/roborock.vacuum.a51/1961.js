            ...
            return new Promise(function (o, u) {
              ...
              n.items.forEach(function (t) {
                if (null == t.id || undefined == t.id) {
                  module1962.SmartSceneLog('\u65e0\u6548\u4efb\u52a1! -- ' + JSON.stringify(t));
                  return void u();
                }
              });
              module393
        ...
        },
        {
          ...
          value: function (t, n) {
            return new Promise(function (o, u) {
              ...
              module1962.SmartSceneLog('\u5373\u5c06\u5411\u8bbe\u5907\u7aef\u540c\u6b65TID, ' + p);
              module416.default
                .reunionScenes(
                  p.map(function (t) {
                    return {
                ...
                .then(function () {
                  module1962.SmartSceneLog('\u6210\u529f\u5411\u8bbe\u5907\u7aef\u540c\u6b65TID, ' + p);
                  module1962.SmartSceneLog('\u5373\u5c06\u5411\u4e91\u7aef\u540c\u6b65TID, ' + p);
                  module1962.SmartSceneLog('TODO: \u539f\u751f\u6ca1\u7ed9\u540c\u6b65\u63a5\u53e3\u7684\u56de\u8c03');
    ...
    module7.default(t, [
      ...
      },
      {
        ...
        get: function () {
          ...
          var l = new module1962.CommandCardData(this.name, module1962.CommandCardType.Custom, s, o, this.timers, this.id);
          l.isInvalid = u;
          return l;
        },
      },
  ...
  T = (function () {
    ...
    module7.default(t, [
      ...
      },
      {
        key: 'timeObj',
        get: function () {
          return this.cron ? module1637.ConvertToReadableFormat(this.cron) : {};
        },
      },
      {
        key: 'repeatMode',
        get: function () {
          return module1638.getRepeatMode(this.timeObj.repeat, false);
        },
      },
      {
        key: 'timeDescription',
        get: function () {
          return null != this.timeObj.minute && null != this.timeObj.hour
            ? module1638.addZeroPrefix(this.timeObj.hour) + ' : ' + module1638.addZeroPrefix(this.timeObj.minute)
      ...
      },
      {
        ...
        get: function () {
          return module1638.getTextOfRepeatMode(this.repeatMode, new Date());
        },
      },
    ]);
    return t;
    ...
    module7.default(t, [
      {
        ...
        get: function () {
          ...
          return new module1962.TaskDescriptorData(
            ...
            this.param.mopMode,
            module1962.taskMethodToMode(this.param.method),
            this.param.repeat,
