    ...
    module7.default(E, [
      {
        ...
        value: function () {
          ...
          if (!(null == this || null == (t = this.props) || null == (o = t.navigation) || null == (n = o.state) || null == (s = n.params) || null == (c = s.settingPanel)))
            c.addBackListener();
          module2028.ModeDataInstance.getCustomMopList();
        },
      },
      {
              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    ...
                    l.prev = 1;
                    l.next = 4;
                    return regeneratorRuntime.default.awrap(module2028.ModeDataInstance.getCustomMopList());

                  case 4:
                    o = [];
                    s = [];
                    c = module1618.getSystemCustomMopModes();
                    module2028.ModeDataInstance.customMopModeListData.forEach(function (n, l) {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (
            !t &&
            module2028.ModeDataInstance.customMopModeListData.filter(function (t) {
              return !t.sys_type;
            }).length >= 5
          )
