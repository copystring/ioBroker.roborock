...
var module510 = require('./510').strings,
  ...
  module2065 = (function (t) {
    ...
    function R(t) {
      ...
      (o = module2065.call(this, t)).state = {
        titleSelected: module1633.default.realVideoSetting,
      };
      o.isChanging = false;
      return o;
    }
      ...
      },
      {
        ...
        value: function () {
          var t = this.context.theme,
            o = this.getMenus().map(function (t, module2065) {
              return t.visible
                ? t.title
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (!this.isChanging) {
            ...
            module1633.default.updateRealTimeVideoSetting(t, function (l) {
              o.isChanging = false;
...
exports.default = module2065;
module2065.contextType = module1193.AppConfigContext;
