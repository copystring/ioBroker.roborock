    ...
    o._onPressBottomBtn = function () {
      ...
      if (module381.RSM.mapSaveEnabled)
        module381.RSM.isRunning
          ...
          ? module1633.default.mapObjectPhotoEnabled &&
    ...
    },
    {
      ...
      value: function () {
        ...
        var t = this,
          ...
          n = module13.Dimensions.get('window').height - module1337.StatusBarHeight - 44 - 150,
        ...
        if (this.state.photoSize && this.state.rectInfo) {
          var V = s / this.state.photoSize.width,
            ...
            module2063 = T + B + 10 > s ? s - T - B - 2 : 10;
          T -= A;
          x -= F;
          B = B + A + module2063;
          L = L + F + H;
        ...
        var module2061 = this.getInnerFailedView(require('./2061'), module510.button_title_retry),
          module1415 = React.default.createElement(module1197.default, {
            ref: function (o) {
          ...
          ee = React.default.createElement(
            ...
            React.default.createElement(
              ...
              v,
              this.state.readPhotoLoadingStatus == K.LOADING && module1415,
              this.state.readPhotoLoadingStatus == K.FAILED && module2061
            )
          ),
          te = module424.DMM.obstacleImagesMap.topBigImage[f],
          module2062 = React.default.createElement(
            module13.ImageBackground,
            {
              resizeMode: 'cover',
              style: {
        ...
        var ae =
            ...
            !module391.default.isShareUser() &&
            (module424.DMM.isTanosV_CN || module424.DMM.isTopazSV_CN),
          ie = module1337.obstacleRemoveTips,
          re = this.state.selfHeight ** n,
          se = R(
            R({}, module1428.BaseShadow),
            {},
            {
              width: s,
              height: re,
        ...
        return React.default.createElement(
          ...
          React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                module390.default.isFwFilterObstacleSupported() && module1633.default.mapObjectPhotoEnabled && y && y.length >= 1 ? ee : module2062,
                React.default.createElement(
                  module13.View,
                  {
                    style: J.line,
          ...
          React.default.createElement(module2051.MapObjectIgnoreDescDialog, {
            ref: function (o) {
