...
var te = 0,
  ...
  se = (function (t) {
    ...
    function ie(t) {
      var n;
      module6.default(this, ie);
      (n = se.call(this, t)).state = {
    ...
    module7.default(ie, [
      ...
      },
      {
        key: 'getRootStack',
        value: function (t) {
          return module1211.createStackNavigator(module1639.routes, {
              ...
              return {
                header:
                  f.state.params && f.state.params.header
                    ...
                    : React.default.createElement(module1389.default, {
            ...
            transitionConfig: function () {
              return {
                screenInterpolator: module1639.interpolator,
              };
            },
          });
        },
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  ...
                  case 3:
                    ...
                    s = (s = t.serverCode || module1337.areaServerMap[n].code).replace('eu', 'de');
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    t = this;
                    setTimeout(function () {
                      module1957.default.checkSuppliesRedPoint();
                      module1957.default.checkFirmwareRedPoint();
                      module1957.default.checkTimeZoneRedPoint();
                        ...
                        function (c) {
                          for (;;)
                            switch ((c.prev = c.next)) {
                              case 0:
                                c.next = 2;
                                return regeneratorRuntime.default.awrap(module2012.default.getInUseSoundPackage());

                              case 2:
                                c.next = 4;
                                return regeneratorRuntime.default.awrap(module2012.default.getListDataFromServer());

                              case 4:
                                t = module2012.default.checkSoundPackageNeedUpgrade();
                                s = t > 0;
                  ...
                  case 0:
                    ...
                    c = function () {
                      module393.openPrivacyLicense(
                        ...
                        module1648.default.UserAgreement(),
                        Z.rubys_main_alert_title_privacy,
                        module1648.default.UserPrivacyProtocol(),
                        s
                      );
                    };
            ...
            function (l) {
              for (;;)
                switch ((l.prev = l.next)) {
                  ...
                  case 6:
                    n = l.sent;
                    s = module411.deviceLocation || n.result[0].local_info.location.replace('prc', 'cn');
                    module381.RSM.deviceLocation = s;
                    module390.default.deviceLocation = s;
                    module381.RSM.robotFeatures = n.result[0].feature_info;
                    module390.default.robotFeatures = n.result[0].feature_info;
                    module381.RSM.FCCState = 1 & n.result[0].local_info.featureset;
                    module381.RSM.robotNewFeatures = n.result[0].new_feature_info;
                    module390.default.robotNewFeatures = n.result[0].new_feature_info;
                    module390.default.newFeatureInfoStr = n.result[0].new_feature_info_str;
                    module418.Log.log(module418.LogTypes.Home, 'fetchDeviceLocation - ' + JSON.stringify(n) + ' -location - ' + s, module418.InfoColors.Success);
                    ...
                    module1341.MapListDataProvider.syncSmartSceneIfNeeded();
                    l.next = 29;
                    break;
                  ...
                  case 25:
                    l.prev = 25;
                    l.t0 = l.catch(2);
                    module418.Log.log(module418.LogTypes.Home, 'fetchDeviceLocation  error: ' + ('object' == typeof l.t0 ? JSON.stringify(l.t0) : l.t0), module418.InfoColors.Fail);
                    if (!this.destroyed)
                      setTimeout(function () {
                        return regeneratorRuntime.default.async(
                          function (n) {
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    n = (n = (n = module1337.areaServerMap[t || module381.RSM.serverCode].host).replace('cdn.', '')).replace('mi-img', 'xiaomi');
                    c.next = 7;
      ...
      },
      {
        ...
        value: function (t) {
          return 'cn' == t ? module1337.privacyName.PN_CN : 'de' == t ? module1337.privacyName.PN_EU : module1337.privacyName.PN_GENERAL;
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            module1193.AppConfigContext.Provider,
            {
              value: {
            ...
            React.default.createElement(
              ...
              React.default.createElement(module2217.default, {
                ref: function (n) {
              ...
              module393.isTestModeSupport() &&
                React.default.createElement(module2218.default, {
                  ref: function (t) {
