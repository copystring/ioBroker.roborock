...
var h = function (o) {
  if (o == c) return module510.localization_strings_Setting_Timer_Common_4;
...
exports.getCleanModeDetailText = function (o) {
  ...
  if (module390.default.isShakeMopSetSupported() && 200 != o.waterMode) {
    ...
    if (c) {
      if (t == module1619.CleanMethodClean) return p;
      if (t == module1619.CleanMethodMop) return S;
      if (t == module1619.CleanMethodCleanAndMop) return p + ' | ' + S;
    }
  }
...
var C = function (o) {
  ...
  if (o == u) return module510.localization_strings_Common_custom_mode;
...
var W = function () {
  ...
  return {
    ...
    strength: module390.default.isCleanRouteDeepSlowPlusSupported() && 'cn' == module390.default.deviceLocation ? 305 : 303,
  };
};
...
function D(o, t, s) {
  return module424.DMM.isGarnet ? o == c || 0 == s : module390.default.isShakeMopStrengthSupported() ? o == c || t == u || s == _ : o == c || t == u;
}
