...
class k {
  ...
  __detach() {
    ...
    module41(module12(O.prototype), '__detach', this).call(this);
  }
  ...
  __connectAnimatedView() {
    module14(this.__isNative, 'Expected node to be marked as "native"');
    var t = module86.findNodeHandle(this._animatedView);
    module14(null != t, 'Unable to locate attached view in the native tree');
