var module381 = require('./381'),
  ...
  module1649 = require('./1649').HtmlMap;

function M() {
  return module1337.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].host;
}
