    ...
    module7.default(O, [
        ...
        value: function () {
          ...
          if (this.state.fbName.length <= 0) globals.showToast('\u8bf7\u586b\u5199\u5185\u6d4b\u7528\u6237\u540d');
            ...
            this.state.fbType == R.keyHard && this.state.imageArray.length <= 0
              ...
              : this.state.fbType != R.keySoft || this.state.historyImage
      ...
      },
      {
        ...
        value: function (t) {
          ...
          var n = module1638.utcTimeConvertToPhoneTimeZoneTime(1e3 * t);
          return [module1638.addZeroPrefix(n.month), module1638.addZeroPrefix(n.day), module1638.addZeroPrefix(n.hour), module1638.addZeroPrefix(n.minute)];
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module2080.default, {
              types: A,
            ...
            React.default.createElement(module2079.default, {
              style: {
                marginHorizontal: 20,
                marginTop: 40,
              },
