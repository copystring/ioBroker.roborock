...
class w {
  constructor(t) {
    module6(this, h);
    module504(t && 'function' == typeof t.rowHasChanged, 'Must provide a rowHasChanged function.');
  ...
  cloneWithRowsAndSections(t, n, s) {
    module504('function' == typeof this._sectionHeaderHasChanged, 'Must provide a sectionHeaderHasChanged function with section data.');
    module504(!n || !s || n.length === s.length, 'row and section ids lengths must be the same');
    var c = new h({
  ...
  rowShouldUpdate(t, n) {
    ...
    module506(undefined !== s, 'missing dirtyBit for section, row: ' + t + ', ' + n);
    return s;
  }
  ...
  getRowData(t, n) {
    ...
    module506(undefined !== s && undefined !== o, 'rendering invalid section, row: ' + t + ', ' + n);
  ...
  sectionHeaderShouldUpdate(t) {
    ...
    module506(undefined !== n, 'missing dirtyBit for section: ' + t);
    return n;
  }
  ...
  getSectionHeaderData(t) {
    ...
    module506(undefined !== n, 'renderSection called on invalid section: ' + t);
  ...
  _calculateDirtyArrays(t, n, s) {
    for (var o, h = f(n), u = {}, l = 0; l < s.length; l++) {
      var w = n[l];
      module506(!u[w], 'SectionID appears more than once: ' + w);
      u[w] = f(s[l]);
    }
...
function f(t) {
  if (module505(t)) return {};

  for (var n = {}, s = 0; s < t.length; s++) {
    var o = t[s];
    module506(!n[o], 'Value appears more than once in array: ' + o);
    n[o] = true;
  }
