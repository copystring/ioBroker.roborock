      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            c = s.style,
            l = s.calling,
            module2205 = this.props.isLandscape ? require('./2205') : this.context.theme.monitor.call,
            module2209 = this.props.isLandscape ? require('./2209') : this.context.theme.monitor.hung,
            p = l ? module2209 : module2205,
