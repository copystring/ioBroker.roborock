    ...
    function I(t) {
      ...
      o._onKeyboardDidShow = function (t) {
        if (o.state.shouldShow && !o.props.supportTag) {
          ...
          module13.Animated.spring(o.animatedMarginBottom, {
            toValue: n,
            duration: 100,
          }).start();
        }
    ...
    module7.default(I, [
      {
        ...
        value: function () {
          this.keyboardShowListener = this.props.supportTag ? null : module13.Keyboard.addListener('keyboardDidShow', this._onKeyboardDidShow);
          this.keyboardHideListener = this.props.supportTag ? null : module13.Keyboard.addListener('keyboardDidHide', this._onKeyboardDidHide);
        },
      },
      {
      ...
      },
      {
        key: 'isValidTag',
        value: function (t) {
          return !this.props.supportTag || (!(!t || t <= 0) && 'object' == typeof module1120.RoomTagInfo[t]);
        },
      },
      {
        key: 'isAutoCreateTagName',
        value: function (t, o) {
          if (!module1120.RoomTagInfo[o] && t.length > 0) return false;
          var n = module1120.RoomTagInfo[o].name;
          if (t == n) return true;
          var s = n.length;

          if (t.length > s) {
            var l = t.substring(0, s);
            if (l == module1120.RoomTagInfo[o].name && (l = t.substring(s)).match(/^\d+$/)) return true;
          }
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if ('' == o) o = module1120.RoomTagInfo[t].name;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (t.length >= 2 && this.props.supportTag)
            for (var n = 0; n < module1120.DisplayRoomTag.length; n++)
              if (this.isAutoCreateTagName(t, module1120.DisplayRoomTag[n])) {
                o = module1120.DisplayRoomTag[n];
                break;
              }
          return o;
        },
      ...
      },
      {
        ...
        value: function () {
          ...
          this.setState(
            ...
            function () {
              module13.Animated.spring(t.animatedMarginBottom, {
                toValue: module391.default.isIphoneX() ? 34 : 20,
                duration: 100,
              }).start();
            }
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            module2093 = module1120.RoomTagInfo[this.state.selectTagKey] ? module1120.RoomTagInfo[this.state.selectTagKey].image : require('./2093'),
            u = {
            ...
            module2094 = module1120.DisplayRoomTag.map(function (o, s) {
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    React.default.createElement(
                      ...
                      React.default.createElement(module13.Image, {
                        style: R.tagImg,
                        source: module1120.RoomTagInfo[o].image,
                      }),
                      React.default.createElement(
                        module13.Text,
            ...
            module2096 = this.state.showAllName ? require('./2095') : require('./2096'),
            ...
            B = React.default.createElement(
              ...
              React.default.createElement(
                ...
                module510.map_edit_zone_select_tag
              ),
              module2094
            ),
