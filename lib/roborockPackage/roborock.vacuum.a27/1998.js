...
var module505 = require('./505').strings,
  ...
  M = (function (t) {
    ...
    function module2000(t) {
      var n;
      module4.default(this, module2000);

      (n = _.call(this, t)).onPressSubmit = function () {
        var t, o, c, u, h, f, p, y, w, S, module1121, module391, module415, x;
            ...
            for (;;)
              switch ((I.prev = I.next)) {
                ...
                case 24:
                  n.startLoading();
                  I.next = 27;
                  return regeneratorRuntime.default.awrap(module419.SetStorageKey(module419.StorageKeys.InnerTestUsersName, n.state.fbName));

                case 27:
                  I.next = 29;
                  return regeneratorRuntime.default.awrap(module419.SetStorageKey(module419.StorageKeys.InnerTestHDVersion, n.state.fbHDVersion));
                ...
                case 51:
                  ...
                  module1121 = n.state.radioSelect ? D.keySoft : D.keyHard;
                  module391 = n.getOccurTime();
                  module415 = n.getDeviceInfo();
                  I.next = 57;
                  return regeneratorRuntime.default.awrap(
                    module393.fileInternalBug(n.state.fbName, module1121, module393.deviceModel, n.state.fbSummary, n.state.fbDetail, module391, module415, S, y)
                  );
      ...
      n.onPressDeleteImage = function (t) {
        var o,
          ...
          l = {
            text: module505.rubys_history_del_button,
            onPress: function () {
      ...
      n.onUploadLog = function () {
        var t,
          o = module390.default.isShowPicUpload() ? module505.log_for_v4_dialog_title : module505.upload_log_legal_statement,
          s = {
            text: module505.localization_strings_Main_MainPage_11,
          },
          l = {
      ...
      n.getShowOccurTime = function () {
        return null == n.state.occurHour || null == n.state.occurMinute
          ? '\u672a\u8bbe\u7f6e'
          : module1565.addZeroPrefix(n.state.occurHour) + ':' + module1565.addZeroPrefix(n.state.occurMinute);
      };
    ...
    module5.default(module2000, [
            ...
            function (n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    n.next = 2;
                    return regeneratorRuntime.default.awrap(module419.GetStorageKey(module419.StorageKeys.InnerTestUsersName));
            ...
            function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    t.next = 2;
                    return regeneratorRuntime.default.awrap(module419.GetStorageKey(module419.StorageKeys.InnerTestHDVersion));
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    ...
                    this.firmwareVersion = module505.share_device;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          var n = module1565.utcTimeConvertToPhoneTimeZoneTime(1e3 * t);
          return [module1565.addZeroPrefix(n.month), module1565.addZeroPrefix(n.day), module1565.addZeroPrefix(n.hour), module1565.addZeroPrefix(n.minute)];
        },
      },
      {
      ...
      },
      {
        key: 'getDeviceInfo',
        value: function () {
          var t = module393.isMiApp ? module505.debug_info_xiaomi_id : 'UID',
        ...
        value: function () {
          return React.default.createElement(
            ...
            React.default.createElement(module385.PureButton, {
              ...
              title: module505.rubys_setting_guide_contact_report_log,
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            module1999 = React.default.createElement(
              module12.TouchableOpacity,
              {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module12.FlatList, {
              ...
              horizontal: true,
              ListFooterComponent: module1999,
            })
          );
        },
      },
...
var H = module12.StyleSheet.create({
  ...
  containter: {
    flex: 1,
    backgroundColor: '#f5f5f5',
    marginTop: module1265.NavigationBarHeight + 2,
    marginHorizontal: 15,
    marginBottom: 20,
  },
  categoryView: {
