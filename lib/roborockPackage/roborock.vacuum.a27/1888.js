...
function W(t) {
  for (var o = 1; o < arguments.length; o++) {
    ...
    if (o % 2)
      F(Object(l), true).forEach(function (o) {
...
var H = (function (t) {
  ...
  function H(t) {
    ...
    (o = F.call(this, t)).checkShowFurnitureModel = function () {
      var t;
    ...
    o.state = {
      ...
      cleanMode: 102,
      waterMode: 202,
      mopMode: module423.DMM.isGarnet ? 1 : 300,
      initializedInfo: false,
      hasMapList: (null != (n = module414.MM.maps) ? n : []).length > 0,
    };
    return o;
  }
  ...
  module5.default(H, [
    ...
    },
    {
      ...
      value: function () {
        var t,
          ...
          R = React.default.createElement(
            ...
            React.default.createElement(module385.SettingListItemView, {
              ...
              title: module505.multi_map_timer_select_map_title,
              detail:
                module1136.FloorMapPageUtils.getRealName(
                  null !=
                    (u =
                      null ==
                      (c = module414.MM.maps.find(function (t) {
          ...
          T = React.default.createElement(module385.SettingListItemView, {
            ...
            bottomDetail: this.state.cleanCount + ' ' + module505.dust_collection_life14,
            onPress: function () {
              return p.cleanCountActionSheetView.show();
            },
          }),
          L = React.default.createElement(module1848.default, {
            ref: function (t) {
          ...
          z = React.default.createElement(module382.ModeSettingPanel, {
            ...
            isSmartScene: true,
            shouldShowCustomSwitch: !module423.DMM.isGarnet,
            isTabZone: this.state.mode == j.Zone,
          ...
          N = React.default.createElement(module1268.default, {
            ref: function (t) {
              p.newSwitchGuideView = t;
            },
            parent: this,
            bgImage: this.theme.guideImages.findCarpet,
            topTitle: module505.tanos_s_mop_mode_title,
            context: module505.tanos_s_mop_mode_info1,
        ...
        var G = React.default.createElement(module1055.MultiMapSelectView, {
          ...
          F = React.default.createElement(module1429.default, {
            ref: function (t) {
              p.cleanCountActionSheetView = t;
            },
            title: module505.localization_strings_Setting_Timer_SettingPage_1,
            actions: ['1 ' + module505.dust_collection_life14, '2 ' + module505.dust_collection_life14, '3 ' + module505.dust_collection_life14],
          ...
          W = this.state.mode != j.GlobalClean || module390.default.isSupportSmartGlobalCleanWithCustomMode();
        return this.state.initializedInfo
          ? React.default.createElement(
              ...
              React.default.createElement(
                ...
                W && k,
                this.state.mode != j.GlobalClean && T,
                R,
                L,
                z,
                N,
                ...
                React.default.createElement(module1268.default, {
                  ...
                  topTitle: module505.new_firmware_detected,
                  context: module505.new_firmware_detected1,
                  buttonInfo: [module505.localization_strings_Setting_RemoteControlPage_51],
              ...
              module393
                ...
                .catch(function (t) {
                  ...
                  if (-10007 == (null == t ? undefined : null == (n = t.data) ? undefined : null == (o = n.error) ? undefined : o.code))
                    globals.showToast(module505.smart_scene_firmware_zone_reach_max_count);
    ...
    },
    {
      ...
      value: function () {
        ...
        if (module381.RSM.mapStatus != module381.MapStatus.None) {
          ...
          if (this.mapView && !this.mapView.addRectangle()) globals.showToast(module505.rubys_main_zone_max_tips);
        } else globals.showToast(module505.tap_zone_clean_button_without_map_tip);
      },
    },
    {
    ...
    },
    {
      ...
      value: function () {
        var t,
          n,
          o,
          l = module423.DMM.isGarnet ? (null == (t = this.state.mopMode) ? undefined : t.mop_template_id) : this.state.mopMode || 300;
    ...
    },
    {
      ...
      value: function (t) {
        ...
        if (module381.RSM.isRunning) {
          ...
          globals.Alert.alert('', module505.ask_if_stop_for_change_map, [l, s]);
        } else t();
      },
    },
    {
    ...
    },
    {
      ...
      value: function (t, n, o) {
        ...
        this.setState({
          cleanMode: t,
          waterMode: n,
          mopMode: module423.DMM.isGarnet ? o.id : o,
        });
    ...
    },
    {
      ...
      value: function () {
        ...
        this.props.navigation.setParams({
          ...
          rightItems: [
            module1271.default.confirmButton(
              function () {
    ...
    },
    {
      ...
      value: function () {
        var t, n, o, l;
        this.updateMap();
        if (!(null == (t = this.mapView))) t.setAllCleanMopMode(module414.MM.customCleanModes);
        if (!(null == (n = this.mapView))) n.setCleanSequence(module414.MM.cleanSequence.concat());
    ...
    },
    {
      ...
      value: function () {
        var t,
          ...
          c = null != (l = this.state.mode) ? l : j.Segment;
        ...
        if (module390.default.isSupportSmartScene()) {
          ...
          module393
            ...
            .then(function (t) {
              ...
              n.initSceneParas(y);
              return module415.default.reunionScenes(w);
            })
            .catch(function (t) {
    ...
    },
    {
      ...
      value: function () {
        var t = this;
        this.mapListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.MapDidUpdate, function () {
          var n, o, l, s;
          ...
          if ((t.updateMap(), (null != (n = null == (o = t.initialZonesList) ? undefined : o.length) ? n : 0) > 0)) {
            ...
            var S = null != (u = null == (c = module414.MM.mapData) ? undefined : null == (h = c.smartZones) ? undefined : h.smartZones) ? u : [];
            ...
            S.filter(function (n) {
              ...
              .forEach(function (n) {
                ...
                if (!(null == (o = t.mapView)))
                  o.setState(W({}, module414.MM.mapData), function () {
        ...
        this.robotListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.RobotStatusDidUpdate, function () {
          t.updateMap();
        ...
        this.specialEventListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.DidReceiveSpecialEvent, function (n) {
          if (n.data == module419.EventKeys.CurrentMapDidChange) t.resetSceneParams();
          else if (n.data == module419.EventKeys.MultiMapsDidReceive)
            t.setState({
              hasMapList: module414.MM.maps.length > 0,
            });
        });
        this.firmwareUpdateListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.RedDotDidChange, function (t) {
            ...
            if (!module390.default.isSupportSmartScene())
              if (n) {
                var o = {
                  ...
                  l = {
                    text: module505.smart_scene_firmware_update_alert_confirm,
                    onPress: function () {
                      module393.openDeviceUpgradePage();
                    },
                  };
                globals.Alert.alert(module505.localization_strings_Setting_RemoteControlPage_54, '', [o, l]);
              } else {
                var s = {
                  text: module505.localization_strings_Main_Error_ErrorDetailPage_3,
                  onPress: function () {
                ...
                globals.Alert.alert(module505.smart_scene_firmware_will_support_alert_title, '', [s]);
              }
          }
        });
        this.themeListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.ThemeDidChange, function () {
    ...
    },
    {
      ...
      value: function () {
        ...
        var s = module414.MM.mapRotateAngle[module381.RSM.currentMapId];
        if (!(null == (t = this.mapView)))
          t.setState(
            W(
              W({}, module414.MM.mapData),
              {},
              {
        ...
        this.setState({
          ...
          bottomMenu: {
            isHidden: this.shouldShowNoMap && this.state.mode != j.GlobalClean,
            tip: this.bottomMenuTip,
          },
        });
        if (!(null == (n = this.sidebarMenu)))
          n.setState({
            tab: this.state.mode == j.Segment ? module1546.TabSegment : module1546.TabZone,
            mapEditButtonEnabled: module390.default.isSupportSmartScene(),
            modeSetButtonEnabled: module390.default.isSupportSmartScene(),
          });
          ...
          if (t != module381.RSM.currentMapId)
            module381.RSM.isRunning
              ...
              : ((n.isLoadingMap = true),
                ...
                new module1269.MultiMapDataProvider()
                  .loadMap(t)
                  .then(function (o) {
                    n.mapUpdated = false;
    ...
    },
    {
      ...
      value: function () {
        ...
        if (module382.isModeCustomized(this.state.cleanMode, this.state.waterMode, this.state.mopMode)) return module505.map_edit_bottom_menu_mode;
        var o = module382.getCleanModeTitle(this.state.cleanMode),
          l = module382.getMopWaterOrStrengthTitle(this.state.waterMode),
          s = o + (l ? ' | ' + l : '');
        if (module390.default.isPureCleanMopSupported() && this.state.cleanMode == module1543.CleanModeZero) return l + ' | ' + module382.getMopMethodTitle(this.state.mopMode);

        if (module390.default.isShakeMopSetSupported() && 200 != this.state.waterMode) {
          var u,
            c = t ? (null == (u = module1545.ModeDataInstance.modePannelCustomMops[0]) ? undefined : u.name) : module382.getMopMethodTitle(this.state.mopMode);
          if (301 == this.state.mopMode) return l + ' | ' + c;

          if (t) {
            if (n == module1544.CleanMethodClean) return s;
            if (n == module1544.CleanMethodMop) return c;
            if (n == module1544.CleanMethodCleanAndMop) return s + ' | ' + c;
          }
        }
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return new Promise(function (o, l) {
          ...
          if ((!n.isTidValid(p) || undefined === v) && n.state.mode != j.GlobalClean) {
          ...
          if (v !== module381.RSM.currentMapId && n.state.mode != j.GlobalClean) {
    ...
    },
    {
      key: 'mapMode',
      get: function () {
        if (!module390.default.isSupportSmartScene()) return module1055.MapModelInCleanMode.Segment_Clean_Read_Only;

        switch (this.state.mode) {
          case j.GlobalClean:
            return module1055.MapModelInCleanMode.Global_Clean_With_Clean_Type;
          ...
          case j.Segment:
            ...
            else return n ? module1055.MapModelInCleanMode.Segment_Clean_Read_Only : module1055.MapModelInCleanMode.Segment_Clean_Edit;

          case j.Zone:
            return module1055.MapModelInCleanMode.Zone_Clean_Edit;
    ...
    },
    {
      ...
      get: function () {
        ...
        switch (this.state.mode) {
          case j.GlobalClean:
            t = module505.no_seg_map_tip;

          case j.Segment:
            t = module505.smart_scene_global_no_map_tip;
    ...
    },
    {
      ...
      get: function () {
        switch (this.state.mode) {
          ...
          case j.Zone:
          default:
            return module505.smart_scene_global_title;
        }
      },
    },
  ]);
