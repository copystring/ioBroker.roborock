...
function C(t) {
  for (var n = 1; n < arguments.length; n++) {
    ...
    if (n % 2)
      A(Object(u), true).forEach(function (n) {
        module50.default(t, n, u[n]);
      });
    else if (Object.getOwnPropertyDescriptors) Object.defineProperties(t, Object.getOwnPropertyDescriptors(u));
    else
      A(Object(u)).forEach(function (n) {
  ...
  z = (function (t) {
    ...
    function A(t) {
      ...
      (n = M.call(this, t)).onNavigationSavePress = function () {
        ...
        if (!(null == (t = globals.Alert))) t.alert(module505.map_furniture_guide_save_tip, '', [u, s]);
      };
      ...
      n.onPressResetEditButton = function () {
        n.setState(
          ...
          function () {
            var t;
            if (!(null == (t = n.mapView))) t.setState(C({}, module414.MM.mapData));
          }
        );
      };
      ...
      n.eidtCountChange = function (t) {
        if (module393.isMiApp) {
          var u = module1057.MAX_FURNITURE_EDIT_MIAPP - t;
      ...
      n.state = {
        ...
        hasEditedMap: false,
        editCount: module1057.MAX_FURNITURE_EDIT_MIAPP,
        showDragItem: false,
        dragItemType: module1057.FurnitureType.FT_BED,
        dragItemSize: {
          x: 0,
          y: 0,
          width: 0,
    ...
    module5.default(A, [
      {
        ...
        value: function () {
          ...
          var n = this.props.navigation.getParam('initAction', module1120.EditAction.None);
          this.onlyFurniture = n == module1120.EditAction.Furniture;
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            u = module1271.default.confirmButton(this.onNavigationSavePress, n, function (n) {
              t.mapSaveButton = n;
            });
          module1271.default.setNavigation(this, [u], this.onNavigationBackPress);
        },
      },
      {
        key: 'registListeners',
        ...
        value: function () {
          ...
          if (this.state.hasEditedMap) {
            var n,
              ...
              o = module505.map_edit_save_current_action + '\r\n' + module505.map_furniture_guide_save_tip;
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    ...
                    n.prev = 2;
                    n.next = 5;
                    return regeneratorRuntime.default.awrap(module419.SetStorageKey(module419.StorageKeys.CloseFurnitureGuide + '_' + module381.RSM.currentMapId, ''));
              ...
              for (;;)
                switch ((p.prev = p.next)) {
                  ...
                  case 4:
                    ...
                    p.next = 8;
                    return regeneratorRuntime.default.awrap(module414.MM.saveFurnitureEditZones(module381.RSM.currentMapId, n));
                  ...
                  case 11:
                    ...
                    p.next = 16;
                    return regeneratorRuntime.default.awrap(module414.MM.saveFurnitureEditZones(module381.RSM.currentMapId, module4, module50));
              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    ...
                    if (!module414.MM.preCheckInferZoneTagStatus() || module414.MM.checkAllRoomTagged()) {
                      l.next = 7;
                      break;
                    }

                    if (((n = this.getAllFurnitureRects()), !((u = module414.MM.smartInferZoneTag(n)) && Object.keys(u).length > 0))) {
                      l.next = 7;
                      break;
                    }

                    l.next = 7;
                    return regeneratorRuntime.default.awrap(module414.MM.updateTagInfoForMap(u));
      ...
      },
      {
        ...
        value: function () {
          ...
          for (var u = [], s = 0; s < n.length; s++) {
            ...
            if (!(l < module1057.FurnitureType.FT_TVCABINET || l > module1057.FurnitureType.FT_DINNERTABLE)) {
              var p = o[0] / 50,
                c = o[4] / 50,
                h = o[1] / 50,
                f = o[5] / 50;
      ...
      },
      {
        ...
        value: function (t) {
          var n = module1057.FurnitureResource[(t >> 8) & 255];
      ...
      },
      {
        ...
        value: function () {
          if (module393.isMiApp && this.state.editCount <= 0) {
            ...
            globals.Alert.alert(module505.map_edit_furniture_max_tip_miapp, '', [t]);
            return false;
          }
      ...
      },
      {
        ...
        value: function () {
          var t;
          if (!(null == (t = this.loadingView))) t.showWithText(module505.rubys_main_diag_update_map);
        },
      },
      {
        key: 'endLoading',
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = React.default.createElement(module1056.MapView, {
              ref: function (n) {
                t.mapView = n;
              },
              parent: this,
              ...
              bottom: module1271.MapEditCommonStyles.mapBottom + 100,
              hideAccessory: true,
              mapMode: module1265.MAP_MODE_FURNITURE_EDIT,
              showFurnitureOnly: true,
              editAction: module1120.EditAction.Furniture,
              zonesHasEdited: this.state.hasEditedMap,
              eidtCountChange: this.eidtCountChange,
            });
          return this.state.mapStatus == module381.MapStatus.None ? module1271.default.getNoMapTipView(this.state.mapStatus) : n;
        },
      },
      {
        key: 'getDragFurniture',
        value: function () {
          return React.default.createElement(module1132.Furniture, {
            id: 0,
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = [];
          n.push(module1057.FurnitureResource[module1057.FurnitureType.FT_BED][module1057.BedSubType.BST_DOUBLE]);
          n.push(module1057.FurnitureResource[module1057.FurnitureType.FT_BED][module1057.BedSubType.BST_SINGLE]);
          n.push(module1057.FurnitureResource[module1057.FurnitureType.FT_TVCABINET]);
          n.push(module1057.FurnitureResource[module1057.FurnitureType.FT_SOFA][module1057.SofaSubType.SST_THREE]);
          n.push(module1057.FurnitureResource[module1057.FurnitureType.FT_SOFA][module1057.SofaSubType.SST_DOUBLE]);
          n.push(module1057.FurnitureResource[module1057.FurnitureType.FT_SOFA][module1057.SofaSubType.SST_SINGLE]);
          n.push(module1057.FurnitureResource[module1057.FurnitureType.FT_SOFA][module1057.SofaSubType.SST_SECTIONAL]);
          n.push(module1057.FurnitureResource[module1057.FurnitureType.FT_SOFA][module1057.SofaSubType.SST_SECTIONAL_LEFT]);
          n.push(module1057.FurnitureResource[module1057.FurnitureType.FT_DINNERTABLE]);
          n.push(module1057.FurnitureResource[module1057.FurnitureType.FT_TEATABLE][module1057.TableSubType.TST_RECT]);
          n.push(module1057.FurnitureResource[module1057.FurnitureType.FT_TEATABLE][module1057.TableSubType.TST_CIRCLE]);
          n.push(module1057.FurnitureResource[module1057.FurnitureType.FT_SHOECABINET]);
          n.push(module1057.FurnitureResource[module1057.FurnitureType.FT_WARDROBE]);
          n.push(module1057.FurnitureResource[module1057.FurnitureType.FT_NIGHTSTAND]);
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = this.state.mapStatus == module381.MapStatus.None || this.state.mapStatus == module381.MapStatus.Has_WithoutSegments,
            u = n ? module1271.default.getNoMapTipView(this.state.mapStatus) : this.getMapView(),
            ...
            p =
              '' +
              module505.map_edit_furniture_count_tip_miapp.templateStringWithParams({
                max: module1057.MAX_FURNITURE_EDIT_MIAPP,
