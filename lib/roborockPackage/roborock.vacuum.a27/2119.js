      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            c = s.style,
            l = s.calling,
            module2116 = this.props.isLandscape ? require('./2116') : this.context.theme.monitor.call,
            module2120 = this.props.isLandscape ? require('./2120') : this.context.theme.monitor.hung,
            p = l ? module2120 : module2116,
