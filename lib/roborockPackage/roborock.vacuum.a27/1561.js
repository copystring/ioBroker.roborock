                  ...
                  switch ((s.prev = s.next)) {
                    case 0:
                      ...
                      this.resultTimerList.forEach(function (t) {
                        if (!(module1565.isTimerExpiredByRepeatMode(t.repeatMode, t.fullDate + ':59') && 0 != module381.RSM.FCCState)) module23.push(t);
                      });
                  ...
                  switch ((T.prev = T.next)) {
                    case 0:
                              ...
                              switch ((o.prev = o.next)) {
                                case 0:
                                  if (
                                    ...
                                    (S = module1564.ConvertToReadableFormat(s.setting.on_time)),
                                    (L = module1565.fixTargetTime(S)),
                                    (O = module1565.convertToPhoneTimeZoneTime(S.minute, S.hour, S.dateofmonth, S.month)),
                                    (w = O.hour),
                                    (M = O.minute),
                                    (k = new Date()),
                                    (P = k.getFullYear()),
                                    1 == O.month && 1 == O.day && k.getMonth() + 1 == 12 && 31 == k.getDate() && (P += 1),
                                    (R = '' + P + module1565.addZeroPrefix(O.month) + module1565.addZeroPrefix(O.day)),
                                    (D = R + ' ' + module1565.addZeroPrefix(w) + ':' + module1565.addZeroPrefix(M)),
                                    !(C = module1565.isTimerExpired(S.repeat, D + ':59', false)))
                                  ) {
                                    o.next = 20;
                                    break;
                                  }

                                  module1565.deleteServerTimer(s, h);
                                  console.log('task is outOfDate - date-' + D + ' - ' + h + ' - ' + C);
                                  return o.abrupt('return');

                                case 20:
                                  if ((F = module1565.getRepeatMode(S.repeat, false)) != module1565.RepeatMode.Once)
                                    O.month == L.month
                                      ? O.day == L.day + 1
                                        ? (F = module1565.getDaysArrByOffset(F, 1))
                                        : O.day == L.day - 1 && (F = module1565.getDaysArrByOffset(F, -1))
                                      : (F = 1 == O.day ? module1565.getDaysArrByOffset(F, 1) : module1565.getDaysArrByOffset(F, -1));
                                  _ = module1565.timerRepeatToCronRepeat(F);
                                  N = module1565.getTextOfRepeatPattern(_, R, false);
                                  I = module1565.addZeroPrefix(O.hour) + ' : ' + module1565.addZeroPrefix(O.minute);
                                  J = module1565.convetToWeekendsByStartTime(F, S.dateofmonth, S.month);
                                  Z = v(
                                    {
                                      name: h,
                                      hour: O.hour,
                      ...
                      module4.forEach(function (t) {
                        ...
                        if (s) module1562.push(s);
                      });
                      this.miTimerScenes = module1562;
                    ...
                    switch ((B.prev = B.next)) {
                      ...
                      case 6:
                        if (
                          ...
                          (O = S[1]),
                          '00000000' == s.date &&
                            ((w = new Date()), (s.date = '' + w.getFullYear() + module1565.addZeroPrefix(w.getMonth() + 1) + module1565.addZeroPrefix(w.getDate()))),
                          (M = s.date + ' ' + s.time),
                          (k = module1562.default(M, 'YYYYMMDD HH:mm')),
                          console.log('date date - ' + k.date() + ' - ' + (k.month() + 1)),
                          (P = module1565.convertTimeFromSourceZoneToPhoneZone(O, L, k.date(), k.month() + 1, module393.robotTimeZone)),
                          (L = P.hour),
                          (O = P.minute),
                          (M = s.date + ' ' + module1565.addZeroPrefix(L) + ' : ' + module1565.addZeroPrefix(O)),
                          !module1565.isTimerExpired(s.loops, M + ':59', true))
                        ) {
                          B.next = 22;
                          break;
                        }
                        ...
                        B.next = 20;
                        return regeneratorRuntime.default.awrap(module1565.deleteServerTimer(s.timerId, T));

                      case 20:
                        console.log('task is outOfDate - date-' + s.date + ' ' + s.time + ' - ' + module1565.isTimerExpired(s.loops, M + ':59', true));
                        return B.abrupt('return');

                      case 22:
                        R = module1565.getRepeatMode(s.loops, true);
                        R = module1565.resolveRepeatModeByTargetTime(R, k.month() + 1, k.date(), P.month, P.day);
                        R = module1565.getRepeatMode(R, true);
                        D = module1565.getTextOfRepeatPattern(R, s.date, true);
                        C = module1565.convetToWeekendsByStartTime(R, P.dateofmonth, P.month);
                        ...
                        _ = v(
                          {
                            ...
                            date: s.date,
                            timerId: s.timerId,
                            cleanTime: module1565.addZeroPrefix(L) + ' : ' + module1565.addZeroPrefix(O),
                            repeatMode: R,
                            repeatModeText: D,
                            startWeekdays: C,
                            disable: F,
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (t[0].constructor == Object) {
              ...
              T = b.clean_mop;
              v = b.mop_template_id;
              y = module1545.ModeDataInstance.getCustomMopModeNameById(v);
            } else {
                            ...
                            for (;;)
                              switch ((o.prev = o.next)) {
                                case 0:
                                  ...
                                  v = T[0];
                                  y = T[1];
                                  S = module1564.ConvertToReadableFormat(v);
                                  L = 0;
                                  O = [];
                                  w = 0;
                                  M = 0;
                                  ...
                                  if (
                                    ...
                                    R = _.clean_mop;
                                    D = _.mop_template_id;
                                    C = module1545.ModeDataInstance.getCustomMopModeNameById(D);
                                  } else {
                                  ...
                                  Z = '' + new Date().getFullYear() + module1565.addZeroPrefix(S.month) + module1565.addZeroPrefix(S.dateofmonth);
                                  j = Z + ' ' + module1565.addZeroPrefix(S.hour) + ':' + module1565.addZeroPrefix(S.minute);
                                  B = module1565.getRepeatMode(S.repeat, false);
                                  E = module1565.getTextOfRepeatPattern(S.repeat, Z, false);
                                  H = module1565.addZeroPrefix(S.hour) + ' : ' + module1565.addZeroPrefix(S.minute);
                                  A = module1565.convetToWeekendsByStartTime(B, S.dateofmonth, S.month);
                                  Y = {
                                    name: l,
                                    hour: S.hour,
                                    minute: S.minute,
                ...
                for (;;)
                  switch ((u.prev = u.next)) {
                    case 0:
                      ...
                      u.next = 4;
                      return regeneratorRuntime.default.awrap(module1565.deleteServerTimer(module50, module23.name));
                    ...
                    case 3:
                      if (this.resultTimerList)
                        this.resultTimerList.forEach(function (s) {
                          var o = module1564.GetExecDate(s.hour, s.minute, module1565.timerRepeatToCronRepeat(s.repeatMode)),
                            u = new Date();
