...
var module393 = require('./393'),
  module2123 = module393.monitorAllowed() ? require('./2123').default : module12.View,
  ...
  module2127 = (function (t) {
                ...
                case 9:
                  if (s && !o.isMonitoring)
                    o.appStateTimer = setTimeout(function () {
                      o.retryTimes = 0;
                      if (!module381.RSM.isChargingOnDock()) o.checkShouldStartWithNetStatus(0, module505.video_is_loading);
    ...
    module5.default(X, [
      ...
      },
      {
        ...
        value: function () {
          ...
          this.statusListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.RobotStatusDidUpdate, function (n) {
            ...
            if (module381.RSM.bumperLeft) t.showTip(le[module2110.DirectionLeft]);
            if (module381.RSM.bumperRight) t.showTip(le[module2110.DirectionRight]);
            if (module381.RSM.bumperMiddle) t.showTip(le[module2110.DirectionMiddle]);
            if (module381.RSM.obstacleLeft) t.showTip(ue[module2110.DirectionLeft]);
            if (module381.RSM.obstacleRight) t.showTip(ue[module2110.DirectionRight]);
            if (module381.RSM.obstacleMiddle) t.showTip(ue[module2110.DirectionMiddle]);
            ...
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 2:
                    if ('cellular' == s.sent) globals.showToast(module505.use_celluar_for_monitor_tip);
      ...
      },
      {
        ...
        value: function (t) {
          var o = this,
            ...
            u = React.default.createElement(module2123, {
              ref: function (t) {
      ...
      },
      {
        ...
        value: function (t) {
          var o = this;
          return React.default.createElement(module2088.default, {
      ...
      },
      {
        key: 'getCallView',
        value: function (t) {
          return React.default.createElement(module2119.default, {
            style: pe.callView,
            isLandscape: t,
            calling: this.state.calling,
          ...
          return React.default.createElement(
            ...
            module390.default.isVideoLiveCallSupported() &&
              ...
              React.default.createElement(module385.PureImageButton, {
                ...
                image: this.state.robotMic ? require('./2097') : require('./2098'),
                imageWidth: 30,
                imageHeight: 30,
                onPress: function () {
                  return t.soundOff();
        ...
        value: function () {
          ...
          if (this.isMonitoring && this.videoView)
            this.videoView.startRecordVideo(function (o) {
              if (o) {
                module2091.timeTool.startRecordTime();
                t.setState({
            ...
            n = function () {
              ...
              if (o.state.screenRecording) {
                module387.LogEventStatus('screen_recording_duration', {
                  duration: module2091.timeTool.getRecordSpan(),
                });
                module2091.timeTool.cancleRecord();
                o.setState({
      ...
      },
      {
        ...
        value: function (t) {
          var o = t == module2102.PortraitActionCall;

          if (t == module2102.PortraitActionRemote || o) {
            module387.LogEventCommon(t == module2102.PortraitActionRemote ? 'tap_remote_control_tab' : 'tap_voice_tab');
            if (o && module390.default.isVideoLiveCallSupported()) this.handleLiveCall();
            else this.togglePortaitPopup(t);
          } else if (t == module2102.PortraitActionRecord) this.handleScreenCast();
          else if (t == module2102.PortraitActionShortcut) this.screenShot();
        },
      },
      {
        key: 'showNotReadyTip',
                ...
                switch ((c.prev = c.next)) {
                  ...
                  case 3:
                    ...
                    return regeneratorRuntime.default.awrap(
                      module415.default.startVoiceChat({
                        play: true,
                  ...
                  case 19:
                    ...
                    if (!(null == this || null == (s = this.alert)))
                      s.customAlert(module505.livecall_autosoundoff_whenmoving_alerttitle, module505.livecall_autosoundoff_whenmoving_alertdesc, null, null, {
                        confirmColor: '#007AFF',
                        shouldShowCancel: false,
                      });
                    c.next = 24;
                ...
                switch ((t.prev = t.next)) {
                  case 0:
                    ...
                    module387.LogEventStatus('call_duration', {
                      duration: module2091.timeTool.getSpan(),
                    });
                    this.cancleLiveCall();
      ...
      },
      {
        ...
        value: function (t) {
          var o = this,
            n = t == module2102.PortraitActionRemote;
          this.setState(
            {
            ...
            function () {
              module12.Animated.spring(o.animatedPortraitPopupViewHeight, {
                toValue: re() - (ge() + se + he + module2102.FuncTabBackgroundHeight - 15),
                duration: 800,
              }).start();
            }
          );
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module2102.PortraitActionMenu, {
              isRemoteActive: c,
              isScreenCasting: l,
              isLiveCall: u,
            ...
            React.default.createElement(
              module12.View,
              {
                style: [
                  ...
                  {
                    width: ne(),
                    height: re() - ge() - se - he - module2102.FuncTabBackgroundHeight + 15,
                  },
                ],
              },
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            o &&
              React.default.createElement(module2083.default, {
                style: [pe.actionMenu],
                ref: function (o) {
            ...
            n && (module381.RSM.bumperMiddle || module381.RSM.obstacleMiddle)
              ? React.default.createElement(module2110.BumperView, {
                  direction: module2110.DirectionMiddle,
                })
              : null,
            n && (module381.RSM.bumperLeft || module381.RSM.obstacleLeft)
              ? React.default.createElement(module2110.BumperView, {
                  direction: module2110.DirectionLeft,
                })
              : null,
            n && (module381.RSM.bumperRight || module381.RSM.obstacleRight)
              ? React.default.createElement(module2110.BumperView, {
                  direction: module2110.DirectionRight,
                })
              : null,
            React.default.createElement(module385.AlertView, {
              ref: function (o) {
            ...
            module390.default.isRecordAllowed() && module393.isRecordSupported() && 2 == module393.iotType
              ? React.default.createElement(module2111.default, {
                  ref: function (o) {
...
exports.default = module2127;
module2127.contextType = module1121.AppConfigContext;
module2127.navigationOptions = {
  header: null,
};
