  ...
  module1938 = (function () {
    ...
    module5.default(t, null, [
      ...
      },
      {
        ...
        value: function () {
          var t, s, o, module415, module423, P, module1938, w, x, b, M, D, N, F;
          return regeneratorRuntime.default.async(
            function (O) {
              for (;;)
                switch ((O.prev = O.next)) {
                  ...
                  case 18:
                    module1938 = (module381.RobotStatusManager.sharedManager().deviceLocation || 'cn').replace('cn', 'prc');
                    w = (w = o.voice_list.filter(function (t) {
                      return -1 != t.applicable.indexOf(module1938);
                    })).sort(function (t, n) {
