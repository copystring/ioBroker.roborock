  ...
  B = (function (t) {
    ...
    module5.default(l, [
      ...
      },
      {
        key: 'updateMap',
        value: function () {
          if (this.mapView) this.mapView.setState(V({}, module414.MapManager.sharedManager().mapData));
        },
      },
      {
        key: 'manualSave',
          ...
          if (0 != this.state.hasCurrentMap || this.state.hasMap) {
            if (this.state.hasCurrentMap && this.state.isNewMap) {
              var l = this.state.isRunning
                ...
                c = this.state.isRunning
                  ...
                  : React.default.createElement(
                      ...
                      React.default.createElement(
                        ...
                        module505.map_edit_button_text_save
                      )
                    ),
                ...
                S = React.default.createElement(module1055.MultiFloorEnableTipsView, {
                  ref: function (n) {
      ...
      value: function () {
        ...
        this.mapListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.MapDidUpdate, function (n) {
          ...
          if (t.mapView)
            t.mapView.setState(
              V(
                V({}, module414.MapManager.sharedManager().mapData),
                {},
                {
        ...
        var t = this,
          ...
          l = React.default.createElement(
            ...
            React.default.createElement(
              ...
              module505.rubys_history_del_button
            )
          ),
          s = React.default.createElement(
            module12.View,
