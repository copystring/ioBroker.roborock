...
var module1340 = require('./1340'),
  ...
  j = module1336.RRSurface,
  z = module1336.isRRSurface,
        ...
        value: function () {
          ...
          this.panResponder = module12.PanResponder.create({
            ...
            onPanResponderStart: function (s, n) {
              ...
              t.touch.move = module1261._parseEvent2(s.nativeEvent, n) || {};
            },
            ...
            onPanResponderMove: function (s, n) {
              if (t.longPressStart) {
                var l = [module1261._parseEvent2(s.nativeEvent, n), t.touch.move],
                  h = l[0],
                  u = l[1];
                if (((t.touch.move = h || {}), !(h && h.x && h.y && u.x))) return;

                var p = module1261._parseDegPointWithTrans(h, u, t.props.transform, t.props.mapDeg),
      ...
      },
      {
        ...
        value: function () {
          if (!this.longPressCanceled) {
            ...
            var t = module1261._parseDegPoint(0, -30 / (this.props.transform.yy || 1), this.props.mapDeg),
...
module1401.propTypes = {
  onLongPress: PropTypes.default.func,
};
module1401.defaultProps = {
...
var module1402 = (function (t) {
  ...
  function p(t) {
    ...
    (n = s.call(this, t)).mapSourceOnLoad = function (t, s) {
      if (n.props.imageOnloadCallback)
        s == module1057.shareViewLoadType.ONLOAD_OBSTACLE
    ...
    n.showRobotAnimation = function () {
      ...
      return (
        ((n.props.mapMode == module1265.MAP_MODE_EASTER_EGG && n.state.status == module381.RobotState.EGG_ATTACK) || ('Running' !== t && null != t && undefined !== t)) &&
    ...
    n.mapEditPageDidChange = function () {
      ...
      return module12.DeviceEventEmitter.emit(module419.NotificationKeys.MapEditDidChange, {
        data: t,
      });
    };
    ...
    n.handlePressSmartZoneBubble = function () {
      var t, s;
      if (n.state.smartBubbleType != module1057.SmartBubbleType.BT_CARPET) {
        if (n.state.smartBubbleType != module1057.SmartBubbleType.BT_NONE && (null == (t = n.smartZoneInfo) ? undefined : t.zoneData))
    ...
    n.handleCheckAndroidOverflow = function (t, s, o) {
      ...
      if (s) return (s.x <= -1 * h || s.x >= n.state.width + h || s.y <= -1 * h || s.y >= n.state.height + h) && (globals.showToast(module505.rotate_map_rect_warning), true);
      ...
      if (t) {
        ...
        return (u - v <= -1 * h || u + v >= n.state.width + h || f <= -1 * h || b >= n.state.height + h) && (globals.showToast(module505.rotate_map_rect_warning), true);
      }
    ...
    n.handleMapObjectImageOnLoad = function () {
      return n.mapSourceOnLoad({}, module1057.shareViewLoadType.ONLOAD_OBSTACLE);
    };
    ...
    n.samrtZoneBubbleOpa = new module12.Animated.Value(0);
    n.chargerLottieSize = {
      width: 0,
      height: 0,
    };
    n.state = {
      ...
      transform: n.props.transform || new I(),
      status: 'Unknown',
      robot: null,
      robotAngle: 0,
      charger: null,
      ...
      smartBubbleType: module1057.SmartBubbleType.BT_NONE,
      chargerErrorText: '',
    };
    return n;
  }
  ...
  module5.default(p, [
    ...
    },
    {
      ...
      value: function (t, s) {
        if (
          t.mapMode == module1265.MAP_MODE_GOTO_EDIT &&
          s.target &&
          s.target.x &&
          s.target.y &&
    ...
    },
    {
      ...
      value: function (t) {
        var s = [];
        if (!t.charger || (t.charger && this.mapLoadSources[module1057.shareViewLoadType.ONLOAD_CHARGER])) s.push(module1057.shareViewLoadType.ONLOAD_CHARGER);
        if (undefined === t.carpetMap || t.carpetMap === this.mapLoadSources[module1057.shareViewLoadType.ONLOAD_CARPETMAP]) s.push(module1057.shareViewLoadType.ONLOAD_CARPETMAP);
        if (!this.currentMap || this.currentMap === this.mapLoadSources[module1057.shareViewLoadType.ONLOAD_MAP]) s.push(module1057.shareViewLoadType.ONLOAD_MAP);
        if (t.obstacles && 0 != t.obstacles.length) this.lastObstacles = t.obstacles;
        else s.push(module1057.shareViewLoadType.ONLOAD_OBSTACLE);
    ...
    },
    {
      key: '_imageOnLoaded',
      value: function (t) {
        module12.DeviceEventEmitter.emit(module419.NotificationKeys.MapImageLoaded, {
          types: t,
        });
      },
    },
    {
      ...
      value: function (t, s) {
        ...
        if (1 == t.parent.state.inCleanBlockMode) n = s.mapBCBackground;
          ...
          t.mapMode == module1265.MAP_MODE_CARPET_EDIT
        )
          n = s.mapNoBlock;
        return n;
      },
    ...
    },
    {
      ...
      value: function () {
        return (this.props.showDockBubbles && this.charging) || !this.state.dockType || !module1057.DockTypeRes[this.state.dockType]
          ? module423.DMM.isGarnet
            ? module1057.DockTypeRes[module1057.DockType.Garnet]
            : module381.RSM.isCollectDock()
            ? module1057.DockTypeRes[module1057.DockType.Onyx1]
            : module381.RSM.isO2Dock()
            ? module1057.DockTypeRes[module1057.DockType.Onyx2]
            : module381.RSM.isO3Dock()
            ? module1057.DockTypeRes[module1057.DockType.Onyx3]
            : module1057.DockTypeRes[module1057.DockType.Normal]
          : module1057.DockTypeRes[this.state.dockType];
      },
    },
    {
      key: '_isGlobalTag',
      value: function () {
        return this.props.mapMode == module1265.MAP_MODE_REGULAR && !this.props.parent.state.inCleanBlockMode;
      },
    },
    {
    ...
    },
    {
      ...
      value: function () {
        ...
        var s = this.showChargerWaring(),
          l = this.pixelOfElement(module1057.Config.size.chargerRadius),
              ...
              module22.default(
                ...
                module391.default.getAccessibilityLabel('map_charger'),
                {
                  ...
                  style: {
                    ...
                    width: u,
                    height: p,
                    left: this.charger.x - u / 2 + (u / 2) * 0.5 * Math.cos(this.degreeToRad(-this.charger.angle)),
                    top: this.charger.y - p / 2 + (p / 2) * 0.5 * Math.sin(this.degreeToRad(-this.charger.angle)),
                    transform: [
                      {
                        rotateZ: -1 * module1261.adjustChargerAngle(this.charger.angle) + 'deg',
                      },
                    ],
                    zIndex: s ? 999 : 0,
                  },
                  ...
                  onLoad: this.props.imageOnloadCallback
                    ? function (s) {
                        return t.mapSourceOnLoad(s.nativeEvent.source, module1057.shareViewLoadType.ONLOAD_CHARGER);
                      }
                    : null,
                }
              )
    ...
    },
    {
      ...
      value: function () {
        ...
        return s && s.x && s.y
          ? React.default.createElement(module1132.ObjectNameBubble, {
              ...
              objectImage: this.state.chargerErrorText && this.state.chargerErrorText.length ? module1118 : this._getChargerResources().chargerBubbleIcon,
              center: s,
    ...
    },
    {
      ...
      value: function () {
        var t = this.pixelOfElement(module1057.DOCK_FORBIDDEN_R),
          s = module23.default(t, 2),
          n = s[0],
          l = s[1],
          h = this.pixelOfElement(module1057.DOCK_FORBIDDEN_R - module1057.Config.size.chargerRadius / 2),
          u = module23.default(h, 2),
          p = u[0],
          c = u[1];
        return !this.props.hideAccessory && (this.charger.x || this.charger.y) && this.state.charger && this.props.mapMode == module1265.MAP_MODE_MAP_EDIT
          ? React.default.createElement(module12.View, {
              style: {
                ...
                transform: [
                  {
                    rotateZ: module1261.adjustChargerAngle(this.charger.angle) * (module12.I18nManager.isRTL ? 1 : -1) + 'deg',
                  },
                ],
              },
            })
    ...
    },
    {
      ...
      value: function () {
        ...
        var s = this.pixelOfElement(module1057.Config.size.robotRadius),
        ...
        return React.default.createElement(
          ...
          React.default.createElement(module1125.default, {
            ...
            source: module1057.MapAnimates.Warning,
          })
        );
      },
    },
    {
      ...
      value: function () {
        ...
        return React.default.createElement(module1132.ChargerStatusLottieView, {
          mapDeg: this.props.mapDeg,
          center: s,
          baseWidth: n,
          baseHeight: o,
    ...
    },
    {
      ...
      value: function () {
        ...
        var s = module381.RobotStatusInMap[this.state.status],
          n = this.pixelOfElement(module1057.Config.size.robotRadius),
        ...
        return this.props.mapMode == module1265.MAP_MODE_EASTER_EGG && this.state.status == module381.RobotState.EGG_ATTACK
          ? React.default.createElement(
              module12.View,
              {
                pointerEvents: 'none',
          ...
          ? React.default.createElement(
              ...
              React.default.createElement(module1125.default, {
                ...
                source: module1057.MapAnimates[s],
              })
            )
          : React.default.createElement(
              module12.View,
    ...
    },
    {
      ...
      value: function (t) {
        var s = this,
          l = this.pixelOfElement(module1057.Config.size.robotRadius),
          h = module23.default(l, 2),
          u = h[0],
          p = h[1],
          c = module423.DMM.robotInMap.image,
          v = this.showChargerWaring() || (this.showRobotAnimation() && 'Warning' === module381.RobotStatusInMap[this.state.status]);
    ...
    },
    {
      ...
      value: function (t, s) {
        var n = this,
          o = !this.props.hideAccessory && this.props.mapMode != module1265.MAP_MODE_ZONED_CLEAN_EDIT && this.props.mapMode != module1265.MAP_MODE_BLOCK_CLEAN_EDIT && s > 10;
        return React.default.createElement(module1132.AnimatedRobot, {
    ...
    },
    {
      ...
      value: function (t) {
        var s = this;
        return 1 != this.props.parent.state.inBlockMode && this.props.mapMode != module1265.MAP_MODE_CARPET_EDIT
          ? React.default.createElement(module1391.ForbiddenView, {
              ref: function (t) {
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return Object.keys(this.rectReferences).map(function (n, o) {
          return React.default.createElement(module1132.CleanRect, {
            key: o,
            id: n,
      ...
      value: function () {
        ...
        return 4 == this.props.parent.state.inCleanBlockMode
          ? this.state.displayZones.map(function (s, n) {
              var o = module1261._convertToPixelRect(s, t.state.transform);
              ...
              return React.default.createElement(module12.View, {
                ...
                style: {
                  ...
                  height: o.height,
                  overflow: 'visible',
                  backgroundColor: module1057.buttonConfig.rectBgColor,
                  borderColor: module1057.buttonConfig.rectColorSolid,
                  borderWidth: 1,
                  borderStyle: 'solid',
                },
              });
    ...
    },
    {
      key: 'getMapObjects',
      value: function (t, s) {
        if (!(this.props.mapElementShowFlag & module1057.MapElementShow.OBSTACLE)) return [];
        var o = [];
              ...
              React.default.createElement(
                ...
                module22.default(
                  ...
                  b,
                  {
                    ...
                    showMapObjectName: this.props.mapMode == module1265.MAP_MODE_REGULAR,
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return this.props.showSplitLine && 1 == o.length
          ? React.default.createElement(module1132.BlockOperation, {
              ref: function (t) {
                return (n.blockOp = t);
              },
              parent: this,
        ...
        for (
          var h = this.props.roomBubbleMode,
            ...
            p = function (o) {
              ...
              if (h & module1057.BlockBubbleShowInfo.CLEANMODE && u) {
                v = module381.RSM.isCustomCleanMode() ? v : -1;
                y = module381.RSM.isCustomWaterMode() ? y : -1;
                R = module381.RSM.isCustomMopMode() ? R : -1;
              }

              var S = t.state.centerInfo[o].x / t.state.centerInfo[o].count,
              ...
              if ((0 != B.length && (-1 != B[o][1] && (T = B[o][1]), 3 == B[o].length && (x = B[o][2])), '' == T)) {
                var F = t.props.parent.state.defaultNameList;
                if (0 != F.length && F[o] && F[o].length > 0) T = F[o];
              }

              T = undefined === T ? '' : T;
              var I = -1;

              if (t.props.parent.state.inBlockMode && h & module1057.BlockBubbleShowInfo.CLEANSEQUENCE) {
                for (var Z = 0; Z < t.props.parent.blockSequenceList.length; Z++)
                  if (t.props.parent.blockSequenceList[Z] == o) {
                    I = Z + 1;
                    break;
                  }
              } else
                for (var L = 0; L < t.props.parent.state.blockSequenceInfo.length; L++)
                  if (t.props.parent.state.blockSequenceInfo[L] == o) {
                    I = L + 1;
                    break;
                  }

              var V = !!t.props.blockCanEdit && t.props.parent.state.selectBlockList[o];
              if (h == module1057.BlockBubbleShowInfo.NONE && 1 != V) return 'continue';
              var N = module12.Dimensions.get('window').width,
                j = !V && u,
                z = j ? k : k + (D - N) / 2,
                G = j ? D ** 60 : N;
              if (module423.DMM.isTanosSC) y = null;
              if (!(t.props.mapElementShowFlag & module1057.MapElementShow.NAME_TAG)) h &= module1057.BlockBubbleShowInfo.CLEANMODE | module1057.BlockBubbleShowInfo.CLEANSEQUENCE;
              if (!(t.props.mapElementShowFlag & module1057.MapElementShow.CUSTOM_ORDER)) h &= module1057.BlockBubbleShowInfo.DISPLAYNAME;
              var W = t.state.roomColorData[o];
              if (
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    module22.default({}, module391.default.getAccessibilityLabel('room_info_bubble'), {
                      ...
                      hideShadow: t.props.mapPanStatus > module1057.PanStatus.MAP_VIEWING_FIT,
                      onPressTag: function () {
    ...
    },
    {
      ...
      value: function (t) {
        var s = this;
        if (!(this.props.mapElementShowFlag & module1057.MapElementShow.FLOOR_CARPET)) return null;
        var n = this.state.carpetMap;
        if (undefined === n) return null;
        var o = React.default.createElement(module1334, {
            pointerEvents: 'none',
            layerScaleFilter: 'Nearest',
            style: t,
            source: {
            ...
            onLoad: this.props.imageOnloadCallback
              ? function (t) {
                  return s.mapSourceOnLoad(t.nativeEvent.source, module1057.shareViewLoadType.ONLOAD_CARPETMAP);
                }
              : null,
          }),
    ...
    },
    {
      ...
      value: function () {
        var t;
        if (!(this.props.mapElementShowFlag & module1057.MapElementShow.FURNITURE)) return null;
        ...
        return React.default.createElement(module1132.ObjectNameBubble, {
          funcId: 'map_furniture_bubble',
          objectName: u,
          objectImage: p ? module1399 : module1398,
          objectLottie: p ? module1400 : null,
          center: h,
          transform: this.state.transform,
          textWidth: 70,
    ...
    },
    {
      ...
      value: function () {
        ...
        if (!(this.props.mapElementShowFlag & module1057.MapElementShow.FLOOR_CARPET || (s != module1057.SmartBubbleType.BT_CARPET && s != module1057.SmartBubbleType.BT_DOORSILL)))
          return null;

        var n = this._getSmartZoneBubbleCenter(null == (t = this.smartZoneInfo) ? undefined : t.zoneArea);

        if ((s == module1057.SmartBubbleType.BT_CARPET && (n = this._getCarpetBubbleCenter()), !n || !n.x || !n.y)) return null;
        var o,
          l,
          h = module1057.SmartBubbleConfig[s].pageTitle;
        if (s == module1057.SmartBubbleType.BT_STUCK)
          h = (null == (o = this.smartZoneInfo) ? undefined : null == (l = o.zoneData) ? undefined : l.nearby)
            ? module505.map_ai_zone_bubble_adjust
            : module505.map_ai_zone_bubble_set;
        return React.default.createElement(module1132.ObjectNameBubble, {
          funcId: 'map_smart_zone_bubble',
          objectName: h,
          objectImage: module1057.SmartBubbleConfig[s].bubbleImg,
          center: n,
          topOffset: s == module1057.SmartBubbleType.BT_CARPET ? 10 : 0,
          bubbleWidth: 80,
          transform: this.state.transform,
          textWidth: 70,
    ...
    },
    {
      ...
      value: function (t, s, n) {
        if (this.props.mapMode == module1265.MAP_MODE_EASTER_EGG) return null;
        var o = null;
        if (this.state.pathGotoPlan && '' != this.state.pathGotoPlan)
          o = React.default.createElement(module1333.RRShape, {
            transform: 'android' != module12.Platform.OS || z ? n : null,
        ...
        if (this.state.path && '' != this.state.path)
          l = React.default.createElement(module1333.RRShape, {
            transform: 'android' != module12.Platform.OS || z ? n : null,
        ...
        if (this.state.mopPath && '' != this.state.mopPath)
          h = React.default.createElement(module1333.RRShape, {
            transform: 'android' != module12.Platform.OS || z ? n : null,
        ...
        if (this.state.backWashPath && '' != this.state.backWashPath)
          u = React.default.createElement(module1333.RRShape, {
            transform: 'android' != module12.Platform.OS || z ? n : null,
    ...
    },
    {
      ...
      value: function (t) {
        var s = this;
        return module390.default.isCarpetSupported() && this.props.mapElementShowFlag & module1057.MapElementShow.FLOOR_CARPET
          ? React.default.createElement(module1391.CarpetsView, {
              ref: function (t) {
    ...
    },
    {
      ...
      value: function (t) {
        var s = this;
        return this.props.mapElementShowFlag & module1057.MapElementShow.FURNITURE &&
          (this.props.mapMode == module1265.MAP_MODE_FURNITURE_EDIT ||
            (this.props.showFurnitureOnly && !this.props.blockCanEdit) ||
            (this.props.mapMode != module1265.MAP_MODE_MAP_EDIT &&
              this.props.mapMode != module1265.MAP_MODE_GOTO_EDIT &&
              this.props.mapMode != module1265.MAP_MODE_EASTER_EGG &&
              !this.props.hideAccessory))
          ? React.default.createElement(module1391.FurnitureView, {
              ref: function (t) {
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return this.props.parent.props.shouldShowRobotMovingAnimation
          ? React.default.createElement(module1391.HistoryMarkView, {
              ref: function (t) {
    ...
    },
    {
      ...
      value: function () {
        ...
        var s = this.pixelOfElement(module1057.Config.size.objectsRadius),
          l = module23.default(s, 2),
          h = l[0],
          u = l[1];
        return this.state.enemies.map(function (s, o) {
          var l = module1261._convertToPixelPoint(s, t.state.transform);
    ...
    },
    {
      ...
      value: function (t) {
        var s = this;
        return this.props.mapElementShowFlag & module1057.MapElementShow.FLOOR_CARPET &&
          (module390.default.isSupportSmartDoorSill() || module390.default.isSupportCustomDoorSill()) &&
          1 != this.props.parent.state.inBlockMode &&
          this.props.mapMode != module1265.MAP_MODE_CARPET_EDIT
          ? React.default.createElement(module1391.DoorSillView, {
              ref: function (t) {
    ...
    },
    {
      ...
      value: function (t) {
        var s = this;
        return module390.default.isSupportStuckZone() && 1 != this.props.parent.state.inBlockMode && this.props.mapMode == module1265.MAP_MODE_REGULAR
          ? React.default.createElement(module1391.AIObjectView, {
              ref: function (t) {
    ...
    },
    {
      ...
      value: function () {
        ...
        if (
          ...
          this.robotAngle = module1261.adjustChargerAngle(this.charger.angle) + module423.DMM.robotInMap.chargerAngle + c;
        }

        this.robotPos = (this.charging && this.charger) || this.robot;
        var v = module1057.Config.size.robotDiameter * this.state.transform.xx;

        if (this.charging && this.charger) {
          var y = {
            x: 0.5 * (v - 10) * Math.cos(this.degreeToRad(-module1261.adjustChargerAngle(this.charger.angle))),
            y: 0.5 * (v - 10) * Math.sin(this.degreeToRad(-module1261.adjustChargerAngle(this.charger.angle))),
          };
          this.robotPos = {
        ...
        var S = this.props.mapMode == module1265.MAP_MODE_REGULAR,
          _ = this.getCleanPath(u, p, s),
          k = this.getForbiddenView(s),
          P = this.getFloorMapView(w),
          T = this.getCarpetMapView(w),
          x = this.getCarpetEditView(s),
          B = this.props.mapMode == module1265.MAP_MODE_CARPET_EDIT,
          F = this.getFurnitureView(s),
          Z = this.props.mapMode != module1265.MAP_MODE_MAP_EDIT,
          V = this.props.mapMode == module1265.MAP_MODE_DOORSILL_EDIT,
          N = this.getDoorSillView(s),
          j = this.getAIObjectView(s),
          z = !this.props.hideAccessory && this.props.mapMode != module1265.MAP_MODE_ZONED_CLEAN_EDIT && this.props.mapMode != module1265.MAP_MODE_BLOCK_CLEAN_EDIT && p > 10;

        if (!module390.default.SupportOverflowTouch()) this.mapRotatePadding = S ? 160 : 100 * this.state.transform.xx;
        var U = 'android' == module12.Platform.OS && this.props.mapPanStatus != module1057.PanStatus.MAP_VIEWING_NONE;
        return React.default.createElement(
          module12.View,
          {
          ...
          React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                module1334,
                {
                  ...
                  onLoad: this.props.imageOnloadCallback
                    ? function (s) {
                        return t.mapSourceOnLoad(s.nativeEvent.source, module1057.shareViewLoadType.ONLOAD_MAP);
                      }
                    : null,
                },
                R,
            ...
            Z && F,
            this.getCleanRect(s),
            React.default.createElement(module1401, {
              ref: function (s) {
                return (t.target = s);
              },
              transform: s,
    ...
    },
    {
      ...
      value: function () {
        for (var t = [], s = 1; s <= module1057.MAX_COUNT_ZONE_RECT; s++) this.rectReferences[s] && this.rectReferences[s].state.visible && t.push(this.rectReferences[s]);
    ...
    },
    {
      key: 'clearRectFocus',
      value: function () {
        for (var t = 1; t <= module1057.MAX_COUNT_ZONE_RECT; t++) {
          var s;
    ...
    },
    {
      ...
      value: function () {
        for (
          ...
          n <= module1057.MAX_COUNT_ZONE_RECT;
          n++
        )
          if (this.rectReferences[n] && 0 == this.rectReferences[n].state.visible && this.rectReferences[n].state.serial == s + 1) {
            ...
            t = t ? module1261._getRotateRect(t, -1 * this.props.mapDeg) : this._getDefaultMapZonesArea(n);
    ...
    },
    {
      ...
      value: function (t) {
        ...
        if (module1057.MAX_COUNT_ZONE_RECT - s < t.length) t = t.splice(0, module1057.MAX_COUNT_ZONE_RECT - s);

        for (
          var s = this._getVisibleZonesCount(this.rectReferences), n = 0, o = false, l = this.degreeToRad(-1 * this.props.mapDeg), h = 1;
          h <= module1057.MAX_COUNT_ZONE_RECT;
          h++
        ) {
          if (this.rectReferences[h] && 0 == this.rectReferences[h].state.visible && this.rectReferences[h].state.serial == s + n + 1) {
            var u,
              p = t[n];
            if (!p) continue;
            p = module1261._getRotateRect(p, -1 * this.props.mapDeg);
    ...
    },
    {
      ...
      value: function (t) {
        ...
        if (this.rectReferences[t].state.visible) {
          for (var n = this._getVisibleZonesCount(this.rectReferences), o = 1; o <= module1057.MAX_COUNT_ZONE_RECT; o++) {
            var l;
    ...
    },
    {
      key: 'setRectsMode',
      value: function (t) {
        for (var s = 1; s <= module1057.MAX_COUNT_ZONE_RECT; s++) {
          var n;
      ...
      value: function (t) {
        ...
        return (
          ...
          (this.isCarpetReachMaxNum(false)
            ? (globals.showToast(module505.map_edit_carpet_zone_exceed_limit), false)
    ...
    },
    {
      ...
      value: function () {
        ...
        if (this.carpetArea) this.showSmartZoneBubble(module1057.SmartBubbleType.BT_CARPET);
      },
    },
    {
      key: 'setCarpetPos',
    ...
    },
    {
      ...
      value: function (t, s) {
        ...
        if (this.carpetArea) {
          if (s && module390.default.isCarpetSupported()) this.showSmartZoneBubble(module1057.SmartBubbleType.BT_CARPET);
          if (this.props.mapMode == module1265.MAP_MODE_ZONED_CLEAN_EDIT && !this.addRectangle(this.carpetArea)) globals.showToast(module505.rubys_main_zone_max_tips);
    ...
    },
    {
      ...
      value: function () {
        var t = this;
        if (this.chargerTimer) module1340.clearTimeout(this.chargerTimer);
    ...
    },
    {
      ...
      value: function (t) {
        ...
        if (!(t && t.length)) this.chargerTimer = module1340.setTimeout(this.hideChargerBubble.bind(this), 5e3);
      },
    },
    {
      key: 'handleShowFurnitureBubble',
      value: function (t, s) {
        if (this.props.mapMode != module1265.MAP_MODE_ZONED_CLEAN_EDIT && !this._isGlobalTag()) return false;
        if (!this.state.furnitures || this.state.furnitures.length <= 0) return false;
        if (!(this.props.mapElementShowFlag & module1057.MapElementShow.FURNITURE)) return false;
        ...
        for (var n = 0; n < this.state.furnitures.length; n++) {
          ...
          if (o && o.type != module1057.FurnitureType.FT_TOILET) {
        ...
        if (this.furnitureArea)
          this.props.mapMode == module1265.MAP_MODE_ZONED_CLEAN_EDIT
            ? !(null == (h = this.furnitureView) ? undefined : h.showFurnitureIcon(this.furnitureArea.type, this.furnitureArea.edited)) &&
              ...
              globals.showToast(module505.rubys_main_zone_max_tips)
    ...
    },
    {
      ...
      value: function () {
        ...
        if (this.furnitureTimer) module1340.clearTimeout(this.furnitureTimer);
        this.furnitureTimer = module1340.setTimeout(this.hideFurnitureBubble.bind(this), 5e3);
      },
    },
    {
    ...
    },
    {
      ...
      value: function (t) {
        var s,
          ...
          o,
          l = null;
        if (t == module1057.SmartBubbleType.BT_CLIFF && (null == (s = this.state.cliffZones) ? undefined : s.length) > 0) l = this.state.cliffZones[0];
        else if (t == module1057.SmartBubbleType.BT_DOORSILL && (null == (n = this.state.doorSills) ? undefined : n.length) > 0) l = this.state.doorSills[0];
        else if (t == module1057.SmartBubbleType.BT_STUCK && (null == (o = this.state.stuckPoints) ? undefined : o.length) > 0) {
          l = {
            rectSize: module1261._pointToStuckRect(this.state.stuckPoints[0]),
            slopeAngle: 0,
          };
        }

        if (l) {
          var h = module1261._getRotateMaxRectSize(l);
    ...
    },
    {
      ...
      value: function (t, s) {
        ...
        if (((this.smartZoneInfo = null), (null == (n = this.state.stuckPoints) ? undefined : n.length) > 0))
          for (var u = 0; u < this.state.stuckPoints.length; u++) {
            var p = {
                rectSize: module1261._pointToStuckRect(this.state.stuckPoints[u]),
                slopeAngle: 0,
              },
              c = this._checkTouchPosInZone(p, t);

            if (c) {
              var f,
                b = null == (f = this.props.parent) ? undefined : f._checkSutckPtNearFbzs(this.state.stuckPoints[u]);
              this.smartZoneInfo = {
                zoneArea: {
                  x: c.x - 2,
                  y: c.y - 2,
                ...
                zoneData: {
                  stuckPoint: this.state.stuckPoints[u],
                  nearby: b,
                },
              };
              break;
        ...
        if (this.smartZoneInfo) {
          this.showSmartZoneBubble(module1057.SmartBubbleType.BT_STUCK);
          return true;
        }

        if ((null == (o = this.state.cliffZones) ? undefined : o.length) > 0)
          for (var v = 0; v < this.state.cliffZones.length; v++) {
            var y = this._checkTouchPosInZone(this.state.cliffZones[v], t);

            if (y) {
              this.smartZoneInfo = {
                zoneArea: h(y),
                zoneData: this.state.cliffZones[v],
              };
              break;
            }
          }
        ...
        if (this.smartZoneInfo) {
          this.showSmartZoneBubble(module1057.SmartBubbleType.BT_CLIFF);
          return true;
        }

        if ((null == (l = this.state.doorSills) ? undefined : l.length) > 0)
          for (var w = 0; w < this.state.doorSills.length; w++) {
            var R = this.state.doorSills[w];

            if (R.type == module1057.DoorSillType.SmartSill) {
              var C = this._checkTouchPosInZone(R, t);
        ...
        if (this.smartZoneInfo) this.showSmartZoneBubble(module1057.SmartBubbleType.BT_DOORSILL);
        else this.hideSmartZoneBubble();
    ...
    },
    {
      ...
      value: function (t) {
        ...
        this.setState(
          ...
          function () {
            module12.Animated.timing(s.samrtZoneBubbleOpa, {
              toValue: 1,
              duration: 500,
            }).start(function () {});
          }
        );
        if (this.smartBBTimer) module1340.clearTimeout(this.smartBBTimer);
        this.smartBBTimer = module1340.setTimeout(this.hideSmartZoneBubble.bind(this), 5e3);
      },
    },
    {
      ...
      value: function () {
        ...
        if (this.state.showSmartZoneBubble)
          module12.Animated.timing(this.samrtZoneBubbleOpa, {
            toValue: 0,
            duration: 200,
          }).start(function () {
            t.setState({
    ...
    },
    {
      ...
      value: function (t, s) {
        ...
        var l = n ? module1261._getRotateMaxRectSize(t) : t.rectSize,
          h = module1261._convertToPixelRect(l, this.state.transform);
    ...
    },
    {
      ...
      value: function () {
        ...
        var t = this.props.mapMode != module1265.MAP_MODE_ZONED_CLEAN_EDIT ? this.carpetArea.realX : this.carpetArea.x,
          s = this.props.mapMode != module1265.MAP_MODE_ZONED_CLEAN_EDIT ? this.carpetArea.realY : this.carpetArea.y,
          n = this.props.mapMode != module1265.MAP_MODE_ZONED_CLEAN_EDIT ? this.carpetArea.realW : this.carpetArea.width,
          o = this.props.mapMode != module1265.MAP_MODE_ZONED_CLEAN_EDIT ? this.carpetArea.realH : this.carpetArea.height,
    ...
    },
    {
      ...
      value: function () {
        var t = {
          ...
          s = (module1057.Config.size.robotRadius * (this.state.transform.yy || 1)) / 2,
          n = {
            x: s,
            y: s,
          };
        return module1261._getRectBubbleCenter(t, n, this.props.mapDeg);
      },
    },
    {
      ...
      value: function (t) {
        ...
        var s = module1057.getFurnitureName(this.furnitureArea.type, this.furnitureArea.subType),
          n = this.furnitureArea.y + this.furnitureArea.height / 2;
        if (t) n -= module1057.Config.size.objectsRadius / 2 + 2;
        return [
          {
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return module1261._getRectBubbleCenter(n, s, this.props.mapDeg);
      },
    },
    {
    ...
    },
    {
      ...
      value: function (t) {
        for (var s = 0, n = 1; n <= module1057.MAX_COUNT_WALL_OR_FBZ; n++) t[n] && t[n].state.visible && s++;
    ...
    },
    {
      ...
      value: function (t, s) {
        for (var n = 1; n <= module1057.MAX_COUNT_WALL_OR_FBZ; n++)
          n == s
            ? t[n] &&
              t[n].setState({
                isFocus: true,
    ...
    },
    {
      ...
      value: function () {
        var t = arguments.length > 0 && undefined !== arguments[0] ? arguments[0] : -1,
          ...
          o = -1 == s ? module1057.DEFAULT_FBZ_REALHEIGHT : s * (this.state.transform.xx || 1),
          l = -1 == s ? this.justifyRealSize(o) : s,
          h = -1 == n ? this.justifyRealSize(module1057.DEFAULT_FBZ_REALWIDTH) : n,
          u = this.props.parent.getMapViewHeight() / 2;
        u -= o / 2;
        var p = -1 != t ? ((t - 1) * module1057.DEFAULT_RECT_MARGIN) / 2 : 0,
          c = {
            x: module1057.RectConfig.initSize.x + p,
            y: u + p,
          },
          f = {
            width: h,
    ...
    },
    {
      ...
      value: function (t, s) {
        var n = arguments.length > 2 && undefined !== arguments[2] ? arguments[2] : null,
          l = module1057.getFurnitureEdge(t, s),
    ...
    },
    {
      ...
      value: function (t) {
        var s = this.props.parent.getMapViewHeight() / 2,
          n = ((t - 1) * module1057.DEFAULT_RECT_MARGIN) / 2,
          o = {
            x: module1057.wallConfig.initSize.start_x + n,
            y: s + n,
          },
          l = this.justifyRealSize(module1057.DEFAULT_FBZ_REALWIDTH),
    ...
    },
    {
      ...
      value: function () {
        ...
        return (
          ...
          T(
            {
              width: this.justifyRealSize(module1057.DEFAULT_FBZ_REALWIDTH),
              height: this.justifyRealSize(module1057.DEFAULT_FBZ_REALHEIGHT),
            },
            s
          )
        );
    ...
    },
    {
      ...
      value: function (t) {
        ...
        if (s + 6 < module1057.RectConfig.minLength) {
          l -= (module1057.RectConfig.minLength - s) / 2;
          s = module1057.RectConfig.minLength;
        } else {
          l -= 3;
          s += 6;
        }

        if (n + 6 < module1057.RectConfig.minLength) {
          h -= (module1057.RectConfig.minLength - n) / 2;
          n = module1057.RectConfig.minLength;
        } else {
          h -= 3;
          n += 6;
        }
    ...
    },
    {
      ...
      value: function (t, s) {
        if (!this.isRotated()) {
          ...
          if (!s) {
            var l = module1261._convertToPixelRect(this.carpetArea, this.state.transform);
    ...
    },
    {
      ...
      value: function (t) {
        ...
        if (t) {
          ...
          if (this.isRotated()) {
            var f = module1261._parseDegPoint(p, c, -1 * this.props.mapDeg),
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return (s ** module1057.RectConfig.maxLength) ** module1057.RectConfig.minLength;
      },
    },
    {
      key: 'isRotated',
    ...
    },
    {
      ...
      value: function () {
        ...
        } else globals.showToast(module505.history_mark_zone_exceed_limit);
      },
    },
    {
      ...
      value: function (t) {
        ...
        if (null == (s = this.doorSillView) || !s.checkMaxCount()) {
          var o = this.degreeToRad(-1 * this.props.mapDeg),
            l = this._getDefaultMapZonesArea(1, t, module1057.DoorConfig.df_width);

          if (!(null == (n = this.doorSillView))) n.addDoorSill(l, o, t != module1057.DoorConfig.other_df_height);
        }
      },
    },
    {
...
exports.default = module1402;
module1402.contextType = module1121.AppConfigContext;
module1402.propTypes = {
