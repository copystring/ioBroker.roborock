...
var module505 = require('./505').strings,
  ...
  B = module12.Dimensions.get('window').width,
  module2047 = (function (t) {
    module7.default(B, t);
    ...
    module5.default(B, [
                  ...
                  case 0:
                    if (this.alert)
                      this.alert.customAlert(
                        '',
                        module505.armap_delete_confirm,
                        function () {
                          var n;
                          return regeneratorRuntime.default.async(
                            function (o) {
                                ...
                                switch ((o.prev = o.next)) {
                                  case 0:
                                    ...
                                    return regeneratorRuntime.default.awrap(
                                      module419.DelStorageKey(module419.StorageKeys.ARMapPathPrefixKey + '_' + t.props.navigation.state.params.mapID)
                                    );
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    ...
                    n.next = 3;
                    return regeneratorRuntime.default.awrap(
                      module419.SetStorageKey(
                        module419.StorageKeys.ARMapPathPrefixKey + '_' + this.props.navigation.state.params.mapID,
                        JSON.stringify({
                  ...
                  case 0:
                    ...
                    if (1 == t.success) {
                      if ((o = null == t ? undefined : null == (n = t.result[0]) ? undefined : n.transform).constructor === Array) {
                        ...
                        globals.showToast(module505.armap_match_success);
                      }
                    } else globals.showToast(module505.armap_match_failed);
      ...
      },
      {
        ...
        value: function () {
          ...
          this.props.navigation.navigate('WebViewPage', {
            ...
            refrence: module1575.default.ARMapPrivacy(),
            buttonTitle: module505.reset_authoration,
            buttonColor: 'red',
                      ...
                      function (o) {
                        for (;;)
                          switch ((o.prev = o.next)) {
                            case 0:
                              o.next = 2;
                              return regeneratorRuntime.default.awrap(module419.DelStorageKey(module419.StorageKeys.ARMapPrivacyVersion));
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module1860.default, {
              style: A.arMapView,
              ref: function (n) {
                return (t.arView = n);
              },
            ...
            !this.props.navigation.state.params.needsMatching &&
              React.default.createElement(
                ...
                React.default.createElement(module385.PureButton, {
                  ...
                  textColor: '#FFFFFF',
                  fontSize: 16,
                  title: module505.rubys_history_del_button,
                  onPress: function () {
            ...
            !this.props.navigation.state.params.needsMatching &&
              React.default.createElement(
                ...
                module505.armap_privacy_dialog_title
              )
          );
        },
      },
      {
        ...
        value: function () {
          var t = this,
            module2053 = module1271.default.confirmButton(
          ...
          module1271.default.setNavigation(this, [module2053], function () {
...
exports.default = module2047;
module2047.contextType = module1121.AppConfigContext;
