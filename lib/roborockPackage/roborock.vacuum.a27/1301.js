...
var module1287 = (function (t, ...args) {
  ...
  function P() {
    ...
    (t = v.call(this, ...args)).setNativeProps = function (n) {
      ...
      module22.default(c, module1285.pickNotNil(module1299.default(c, false)));
  ...
  module5.default(P, [
    {
      ...
      value: function () {
        ...
        module22.default(n, module1299.default(t, false));
...
module1287.displayName = 'TSpan';
module1299.setTSpan(module1287);
