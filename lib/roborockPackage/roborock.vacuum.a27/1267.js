...
var module505 = require('./505').strings,
  ...
  k = (function (t) {
    ...
    function V(t) {
      ...
      (l = k.call(this, t)).dataProvider = module390.default.isMultiFloorSupported() ? new module1269.MultiMapDataProvider() : new module1269.SingleMapDataProvider();
        ...
        value: function () {
          var t = this,
            n = module390.default.isSupportQuickMapBuilder()
              ? [module505.confirm_start, module505.quick_build_map_start]
              : [module505.localization_strings_Main_MainPage_11, module505.confirm_start],
            l = module390.default.isSupportQuickMapBuilder()
              ? module505.multi_map_start_build_text_1 +
                '\n' +
                module505.multi_map_start_build_text_2 +
                '\n' +
                module505.multi_map_start_build_text_3 +
                '\n' +
                module505.multi_map_start_build_text_4
              : module505.multi_map_start_build_text_1 + '\n' + module505.multi_map_start_build_text_2 + '\n' + module505.multi_map_start_build_text_3,
            o = React.default.createElement(module1268.default, {
              ref: function (n) {
                t.multiMapSwitchItem = n;
              },
              isModal: this.props.isModal,
              bgImage: this.context.theme.guideImages.createMap,
              topTitle: module505.multi_map_start_build_title,
              context: l,
              buttonInfo: n,
          ...
          return React.default.createElement(module12.View, null, o, u);
        },
      },
      {
        ...
        value: function () {
          ...
          if ((this.multiMapSwitchItem.dismissModalView(), null == (t = this.props) || null == t.onPressCreateMap || t.onPressCreateMap(), module381.RSM.isRunning))
            globals.Alert.alert(module505.start_create_new_map_title, '', [o, u]);
          else {
            ...
            var s,
              ...
              _ = function () {
                ...
                if (module381.RSM.battery < 20) {
                  ...
                  return void globals.showToast(module505.localization_strings_Main_Constants_33);
                }
                  ...
                  .then(function () {
                    n.createMapLoopChecker = setInterval(function () {
                      ...
                      if (c > 50) {
                        ...
                        if (!(null == (t = n.globalLoadingView) || null == t.hide)) t.hide();
                        return void globals.showToast(module505.map_reset_page_operate_fail);
                      }
              ...
              f = module390.default.isCarpetSupported() && !module423.DMM.isGarnet;
