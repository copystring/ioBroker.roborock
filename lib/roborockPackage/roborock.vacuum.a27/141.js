    ...
    module5.default(t, null, [
      {
        ...
        value: function (n, o, u, c) {
          if ('ios' === module52.default.OS) t.prompt(n, o, u, 'default');
          else if ('android' === module52.default.OS) {
            if (!module142.default) return;
            var f = module142.default.getConstants(),
              p = {
                title: n || '',
                message: o || '',
                cancelable: false,
        ...
        value: function (t, n, o) {
          ...
          if ('ios' === module52.default.OS) {
            if ('function' == typeof s) {
              ...
              var p = s;
              return void module143.default.alertWithArgs(
                {
                  title: t || '',
                  type: 'plain-text',
                  defaultValue: n || '',
            ...
            module143.default.alertWithArgs(
              {
                title: t || '',
                message: n || undefined,
                buttons: h,
