...
var module1186 = {
    transitionSpec: (n = require('./1186').supportsImprovedSpringAnimation()
      ? {
    ...
    screenInterpolator: module1185.default.forHorizontal,
    containerStyle: {
      backgroundColor: '#000',
    },
  },
  p = {
    transitionSpec: n,
    screenInterpolator: module1185.default.forVertical,
    containerStyle: {
      backgroundColor: '#000',
    },
  },
  O = {
    ...
    screenInterpolator: module1185.default.forFadeFromBottomAndroid,
  },
  b = {
    transitionSpec: {
      duration: 230,
