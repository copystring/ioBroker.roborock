  ...
  function _() {
    ...
    t._renderScene = function (n) {
      var o = n.route,
        ...
        E = o.key,
        w = B.getComponent();
      return React.default.createElement(module1139.ResourceSavingSceneView, {
        lazy: b,
        isFocused: C === E,
    ...
    t._renderPager = function (t) {
      return React.default.createElement(module1213.TabViewPagerPan, t);
    };
  ...
  module5.default(_, [
    {
      ...
      value: function () {
        ...
        return React.default.createElement(module1213.TabViewAnimated, E);
      },
    },
  ]);
  return _;
