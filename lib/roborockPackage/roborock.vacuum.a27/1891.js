      ...
      },
      {
        ...
        value: function () {
          ...
          this.mapListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.MapDidUpdate, function (n) {
            ...
            else if (t.needUpdateMap) t.setMapData(module414.MM.mapData);
          });
        },
      },
      {
      ...
      },
      {
        ...
        value: function (t, n, o) {
          ...
          this.setState(
            ...
            function () {
              if (l.needUpdateMap && n) l.setMapData(module414.MM.mapData);
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (!(null == (n = this.mapView)))
            n.changeMapViewMode(t ? module1055.MapModelInCleanMode.Segment_Clean_Edit_With_Clean_Type : module1055.MapModelInCleanMode.Segment_Clean_Edit);
        },
      },
      {
        key: 'setMapData',
        value: function (t) {
          ...
          if (this.needUpdateMap) {
            var o = function (t) {
              ...
              if (!(null == (o = n.mapView))) o.setAllCleanMopMode(module414.MM.customCleanModes);
              if (!(null == (l = n.mapView))) l.setCleanSequence(module414.MM.cleanSequence.concat());
        ...
        value: function () {
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              module505.multi_map_timer_not_current_map_tip
            ),
            React.default.createElement(module385.PureButton, {
              title: module505.multi_map_timer_select_map_stop_task_title,
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            u = undefined === p ? 0 : p,
            h = 0 == u,
            w = module381.RSM.mapSaveEnabled ? [module505.home_bottom_menu_global, module505.home_bottom_menu_select_zone] : [module505.home_bottom_menu_global],
            v = module381.RSM.mapStatus == module381.MapStatus.Has_WithoutSegments,
            C = React.default.createElement(module1315.default, {
              tip: module505.no_seg_map_tip,
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                module505.multi_map_timer_select_map_title
              ),
              React.default.createElement(
                module12.View,
                {
            ...
            !h &&
              React.default.createElement(
                module12.View,
                null,
                (module414.MM.maps.length > 1 || (1 == module414.MM.maps.length && -1 == module381.RSM.currentMapId)) &&
                    ...
                    : React.default.createElement(
                        ...
                        !s &&
                          ...
                          React.default.createElement(
                            ...
                            module505.multi_map_timer_segment_select_bottom_tip
                          )
                      ))
              )
          );
