...
var module505 = require('./505').strings,
  ...
  module2109 = (function (t) {
    module7.default(module2105, t);

    var module50 = module2105,
      module1121 = T(),
      O = function () {
        var t,
    ...
    function module2105(t) {
      var o;
      module4.default(this, module2105);
    ...
    module5.default(module2105, [
      ...
      },
      {
        key: 'darkImgs',
        value: function () {
          return [require('./2105'), require('./2106'), require('./2107'), require('./2108'), require('./2109')];
        },
      },
      {
        key: '_getActiveImage',
...
exports.default = module2109;
module2109.contextType = module1121.AppConfigContext;
