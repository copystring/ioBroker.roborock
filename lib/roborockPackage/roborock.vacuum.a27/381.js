              ...
              for (;;)
                switch ((T.prev = T.next)) {
                  case 0:
                    ...
                    if (o - this.lastCameraStatusLockTime >= 2e3 && !this.cameraStatusLocked) module1560.default.parseCameraStatus(t.camera_status);
                    else {
                  ...
                  case 36:
                    ...
                    this.cleanProgress = t.clean_percent || 0;
            ...
            function (p) {
              for (;;)
                switch ((p.prev = p.next)) {
                  case 0:
                    p.next = 2;
                    return regeneratorRuntime.default.awrap(module1561.TLM.GetListByHours(6));
                  ...
                  case 2:
                    ...
                    if (module390.default.isUnsaveMapReasonSupported() && this.unsaveMapReason == K.ChargerOffset && -1 != this.unsaveMapFlag)
                      ...
                      this.fanPower != module1543.CleanModeZero &&
                      this.waterBoxMode != module1543.WaterModeZero &&
                      this.mopMode == module1543.CleanRouteFastMode &&
                      this.isCleaning()
                    )
                      this.specialInfo = {
                    ...
                    else if (module390.default.isPureCleanMopSupported() && this.fanPower == module1543.CleanModeZero && this.isCleaning()) {
                      l = this.isCollectDustDock ? module505.home_sepecial_tip_for_only_mop_collectdusk : module505.home_sepecial_tip_for_only_mop;
                      if (this.mopMode == module1543.CleanRouteFastMode) l = o + ', ' + l;
                      this.specialInfo = {
                        text: l,
                        actionStyle: H.PureMop,
                      };
                    } else if (module390.default.isPureCleanMopSupported() && this.waterBoxMode == module1543.WaterModeZero && this.isCleaning()) {
                      _ = module505.home_sepecial_tip_for_only_clean;
                      if (this.mopMode == module1543.CleanRouteFastMode) _ = o + ', ' + _;
                      this.specialInfo = {
                        text: _,
                ...
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    o = t.filter(function (s) {
                      return t && module1559.Reminder()[s];
                    });
                    c.next = 7;
