  ...
  module499 = module215({
    ...
    render: function () {
      for (
        ...
        var module501 = s.sectionIdentities[v],
          y = l[v];
        ...
        if (u) {
          var E = u(s.getSectionHeaderData(v), module501);
        ...
        for (var I = 0; I < y.length; I++) {
          var P = y[I],
            ...
            F = <module503 key={'r_' + L} shouldUpdate={!!D} render={this.props.renderRow.bind(null, s.getRowData(v, I), module501, P, this._onRowHighlighted)} />;

          if ((t.push(F), C++, this.props.renderSeparator && (I !== y.length - 1 || v === l.length - 1))) {
            var O = this.state.highlightedRow.sectionID === module501 && (this.state.highlightedRow.rowID === P || this.state.highlightedRow.rowID === y[I + 1]),
              N = this.props.renderSeparator(module501, P, O);
