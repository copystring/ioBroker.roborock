...
var module1849 = (function (t) {
  ...
  function A(t) {
    ...
    if (
      ...
      ((n = module1849.call(this, t)).onPressAddMap = function () {
      ...
      (n.mapUpdated = true),
      (n.lastMap = null),
      module414.MM.mapData && module414.MM.mapData.map && !module414.MM.mapData.map.isEmpty)
    )
      n.lastMap =
        (null == (o = module414.MM.mapData.map) ? undefined : null == (s = o.data) ? undefined : s.blockNum) <= 1
          ? null == (p = module414.MM.mapData.map)
            ? undefined
            : p.imageNoBlock
          : null == (u = module414.MM.mapData)
          ? undefined
          : null == (c = u.map)
          ? undefined
          : c.image;
  ...
  module5.default(A, [
    ...
    },
    {
      ...
      value: function () {
        var t,
          ...
          y = module381.RSM.mapSaveEnabled && this.state.maps && 0 == this.state.maps.length;
        if (!this.hasNewMap && y) b = true;
        var I,
          T,
          P,
          R,
          E,
          C,
          D = module381.RSM.multiFloorEnabled && module381.RSM.mapSaveEnabled && this.state.maps && this.state.maps.length < 4,
          k = !b && (y || D) && module390.default.isMultiFloorSupported(),
          B = this.getTopButtons(),
          H = (null == B ? undefined : B.length) ? s / B.length : 0,
          module1849 = {
          ...
          module1850 = React.default.createElement(
            module12.View,
            {
              style: [
          ...
          F = (!this.props.isTitleViewHidden && !b) || (null == B ? undefined : B.length) > 0,
          z = this.getBottomButtons(),
          W = {
            textColor: this.theme.subTextColor,
            enabled: module381.RSM.mapSaveEnabled,
            fontSize: 12,
          ...
          U = this.getMapSaveTipView(),
          O = this.getAddNameView(),
          j = this.getLoadingView(),
          K = this.getMapSwitchSheet(),
          q = React.default.createElement(module1055.MultiMapHintModal, {
            ref: function (t) {
        ...
        return React.default.createElement(
          ...
          !this.props.isTitleViewHidden &&
            (module381.RSM.mapSaveEnabled
              ? ((I = {
                ...
                (T = l.hasNewMap ? [I].concat(module31.default(l.state.maps)) : module31.default(l.state.maps)),
                (P = T.find(function (t) {
                  return t.id == l.state.selectedMapId;
                })),
                (R = P ? l.currentMapSource : require('./1849')),
            ...
            React.default.createElement(
              module12.View,
              {
                style: [
                  N.bottomButtonView,
                  {
                    borderTopColor: F ? l.iconTheme.lineColor : l.iconTheme.backgroundColor,
                  },
                ],
              },
              z.map(function (t, n) {
          ...
          !this.props.isTitleViewHidden && k && module1850,
          !this.props.isBottomViewHidden && O,
          j,
          q,
          K
        );
    ...
    },
    {
      ...
      get: function () {
        if (module381.RSM.isRunning && 'android' == module12.Platform.OS)
          return this.lastMap
            ? {
                uri: this.lastMap,
              }
        ...
        if (module414.MM.mapData && module414.MM.mapData.map && !module414.MM.mapData.map.isEmpty) {
          var t,
            n,
            o,
            l,
            s,
            p =
              (null == (t = module414.MM.mapData.map) ? undefined : null == (n = t.data) ? undefined : n.blockNum) <= 1
                ? null == (o = module414.MM.mapData.map)
                  ? undefined
                  : o.imageNoBlock
                : null == (l = module414.MM.mapData)
                ? undefined
                : null == (s = l.map)
                ? undefined
                : s.image;
...
module1849.contextType = module1121.AppConfigContext;
module1849.defaultProps = {
...
var N = module12.StyleSheet.create({
  ...
  A = module385.HocBottomModal(module385.WithSwipeToClose(module1849), !module393.isMiApp || 'android' != module12.Platform.OS);
exports.default = A;
