      ...
      [
            ...
            if (t) {
              ...
              if (!(o.length <= 0))
                o.forEach(function (o) {
                  o = parseInt(o);
                  if (!n.dataInstMap.has(o)) n.dataInstMap.set(o, new module1408.MapDataConfig(o));
        ...
        },
        {
          ...
          value: function (t) {
            ...
            o.forEach(function (o) {
              ...
              if (s && t[o]) {
                if ((3 == o && console.warn('check pathdiff = ' + JSON.stringify(t[o])), 3 === o && t[o].data && undefined !== t[o].start && t[o].len))
                  n._parseMapDynamicData(t[o], o) == module1408.updateRes.hasUpdate && n._updateMapDataDynamic(n.mapData, o);
                var u = s.dealDiff(t[o]);
                if (u == module1408.diffRes.getDiff) n.getMapDataDynamic(s.toJSONString, o);
                else if (u == module1408.diffRes.resetDiff) n._updateMapDataDynamic(n.mapData, o);
              }
            });
          },
        },
                ...
                for (;;)
                  switch ((v.prev = v.next)) {
                    ...
                    case 10:
                      ...
                      if (l)
                        (c = this._parseMapDynamicData(l, l.data_id)) == module1408.updateRes.hasUpdate || (c == module1408.updateRes.reUpdate && !o)
                          ? this._updateMapDataDynamic(this.mapData, n)
                          : c == module1408.updateRes.reUpdate && o && (f = this.dataInstMap.get(l.data_id)) && this.getMapDataDynamic(f.toJSONString, n, false);
                      v.next = 18;
                      break;
        ...
        },
        {
          ...
          value: function (t, n) {
            ...
            if (!module395.default.validate_single_payload(u)) return module1408.updateRes.noUpdate;
            var l = module1406.parseDynamicData(u, false);
            if (!l) return module1408.updateRes.noUpdate;
            ...
            return c ? c.updateData(t, l) : module1408.updateRes.noUpdate;
          },
        },
        {
          ...
          value: function (t, n, o) {
            ...
            var s = {
              ...
              u = module1403.convertFloorDataToImage(n.data, s, t.data, o);
            return {
              data: n.data,
              image: u,
