...
var module1340 = require('./1340'),
  ...
  C = (function (t) {
    ...
    function E(t) {
      ...
      (n = C.call(this, t)).dataSource = new module496.default.DataSource({
    ...
    module5.default(E, [
      ...
      },
      {
        ...
        value: function (t, n) {
          ...
          if ('special' == n) o = module505.soundpackage_select_special_sound_title;
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  ...
                  case 3:
                    ...
                    c.next = 9;
                    return regeneratorRuntime.default.awrap(module415.default.setSoundPackage(n));
