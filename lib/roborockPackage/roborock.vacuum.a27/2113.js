...
var P,
  ...
  module2114 = module393.isRecordSupported() ? require('./2114') : module12.View,
  M = module12.NativeModules.RRRecorder,
  O = 0,
  module2115 = (function (t) {
    module7.default(C, t);
    ...
    function C(t, n) {
      ...
      (o = module2116.call(this, t))._onVolumeChanged = function (t) {
        var n = t.nativeEvent;
          ...
          this.Gesture = {
            ...
            onResponderRelease: function (n) {
              ...
              if (
                ...
                t.setState({
                  text: module505.long_press_to_send_voice,
                  icon: t.props.isLandscape ? require('./2115') : t.context.theme.monitor.recordImg,
                }),
                clearTimeout(P),
                t.state.recording)
              ) {
      ...
      },
      {
        ...
        value: function () {
          ...
          this.setState({
            ...
            icon: this.props.isLandscape ? require('./2116') : this.context.theme.monitor.recordSelImg,
          });
                ...
                switch ((t.prev = t.next)) {
                  ...
                  case 9:
                    ...
                    this.setState({
                      recording: false,
                      text: module505.long_press_to_send_voice,
                      icon: this.props.isLandscape ? require('./2115') : this.context.theme.monitor.recordImg,
                    });
...
exports.default = module2115;
module2115.contextType = module1121.AppConfigContext;
