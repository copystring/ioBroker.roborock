  ...
  R = (function (t) {
    ...
    module5.default(P, [
      ...
      },
      {
        ...
        value: function () {
          module1421.default.shared().popGestureEnabled = true;
        },
      },
      {
        key: 'render',
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module1421.default.shared().popGestureEnabled = this.props.hidePopGestureEnabled;
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module1421.default.shared().popGestureEnabled = this.props.showPopGestureEnabled;
          this.needShow = true;
          if (this.props.noAnimated)
            this.setState({
              visible: true,
