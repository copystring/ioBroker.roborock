      ...
      value: function () {
        ...
        if (this.state.photoSize && this.state.rectInfo) {
          var V = s / this.state.photoSize.width,
            ...
            module1987 = T + B + 10 > s ? s - T - B - 2 : 10;
          T -= A;
          x -= F;
          B = B + A + module1987;
          L = L + F + H;
        ...
        var module1985 = this.getInnerFailedView(require('./1985'), module505.button_title_retry),
          ...
          ee = React.default.createElement(
            ...
            React.default.createElement(
              ...
              this.state.readPhotoLoadingStatus == K.FAILED && module1985
            )
          ),
        ...
        var ae =
            ...
            !module391.default.isShareUser() &&
            (module423.DMM.isTanosV_CN || module423.DMM.isTopazSV_CN),
          ie = module390.default.isStructuredLightSupported() ? module1265.obstacleRemoveTipsStructuredLight : module1265.obstacleRemoveTips,
        ...
        return React.default.createElement(
          ...
          React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                module390.default.isFwFilterObstacleSupported() && module1560.default.mapObjectPhotoEnabled && y && y.length >= 1 ? ee : module1986,
                React.default.createElement(
                  module12.View,
                  {
                    style: J.line,
          ...
          React.default.createElement(module1975.MapObjectIgnoreDescDialog, {
            ref: function (o) {
