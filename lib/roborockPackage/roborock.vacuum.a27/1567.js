...
var Ee = (function (t) {
  ...
  (0, p.default)(j, [
        ...
        return l.default.async(
          function (u) {
            for (;;)
              switch ((u.prev = u.next)) {
                case 0:
                  if (!(!_e.isMiApp && P.RSM.isChargingOnDock() && P.RSM.battery >= 20) || w.default.isShareUser()) {
                    u.next = 15;
                    break;
                  }
    ...
    },
    {
      ...
      value: function () {
        var t = this,
          n = we.SuppliesUpgradeTip()[this.state.suppliesUpgradeTipKey];
        return void 0 != n
          ? v.default.createElement(D.default, {
              content: n,
              isArrowStyle: !0,
    ...
    },
    {
      ...
      value: function () {
                  ...
                  for (;;)
                    switch ((c.prev = c.next)) {
                      ...
                      case 3:
                        if (
                          ((s = !!c.sent),
                          (u = parseInt(I.MC.photoPrivacyVersionAgreedOnServer) == Te.RRPhotoPrivacyVersion),
        ...
        var y = k.MM.mapRotateAngle[P.RSM.currentMapId] || 0,
          ...
          N = B.default.isSupportQuickMapBuilder() && P.RSM.mapSaveEnabled && !F && this.state.noMapTip,
        ...
        if (this.state.hasGotMap && !this.state.isLocating) {
          ...
          var L = c;
          this.state.mapType == Be.AR && this.state.arMapMatchParam ? (L = h) : this.state.mapType == Be.THREE && (L = T);
          return L;
        }
        ...
        return v.default.createElement(W.PhotoFeaturePrivacyDialog, {
          ...
          onConfirm: function () {
            return C.default.updatePhotoPrivacy(!0, function (n) {
              ...
              _e.postPrivacyAgreementStatusWithVersion(P.RSM.serverCode, 4, Te.RRPhotoPrivacyVersion || 1)
                .then(function (t) {})
                .catch(function (t) {});
            });
          },
          onCancel: function () {
            ...
            _e.postPrivacyAgreementStatusWithVersion(P.RSM.serverCode, 5, Te.RRPhotoPrivacyVersion || 1)
              .then(function (t) {})
              .catch(function (t) {});
    ...
    },
    {
      ...
      value: function () {
        ...
        var n = this.context.theme,
          ...
          s = o.width,
          u = o.height,
          l = _e.isWindowDisplay ? re.titleBarContentHeight + 14 : re.titleBarContentHeight + be.StatusBarHeight + be.AppBarMarginTop,
            ...
            for (;;)
              switch ((f.prev = f.next)) {
                ...
                case 6:
                  ...
                  t = parseInt(I.MC.MonitorPrivacyVersionAgreedOnServer) == Te.RRMonitorPrivacyVersion;
                  f.next = 10;
                  return l.default.awrap((0, R.GetStorageKey)(R.StorageKeys.MonitorPrivacyVersion));

                case 10:
                  if (((n = f.sent), (o = !!n || t), (C.default.monitorPrivacyPolicyAgreed && o) || !C.default.hasGot)) {
                    f.next = 15;
                    break;
                  }
        ...
        B.default.isCarpetSupported() && !z.DMM.isGarnet
          ? (null == (o = this.quickCreateMapGuide) || o.startLoading(),
            y.default
              .getCarpetCleanMode()
              .then(function (t) {
                if (t.result[0].carpet_clean_mode == we.CarPetCleanModeSettingMap.CarPetCleanModeAllForbidden) {
                  var o = {
                      text: de.localization_strings_Main_MainPage_11,
                    },
                    u = {
            ...
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  n.prev = 0;
                  n.next = 3;
                  return l.default.awrap(_e.saveDeviceExtraValue('RRMonitorPrivacyVersion', Te.RRMonitorPrivacyVersion.toString()));
            ...
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  n.prev = 0;
                  n.next = 3;
                  return l.default.awrap(_e.saveDeviceExtraValue('RRPhotoPrivacyVersion', Te.RRPhotoPrivacyVersion.toString()));
...
var Ae = he.create({
  ...
  topTipView: {
    alignSelf: 'center',
    marginTop: be.NavigationBarHeight,
    alignItems: 'center',
    justifyContent: 'center',
    height: 40,
  ...
  debugButton: {
    position: 'absolute',
    top: 216 + (O.StatusBar.currentHeight || 0) + be.AppBarMarginTop,
    left: 15,
  },
  videoButton: {
    position: 'absolute',
    top: 245 + (O.StatusBar.currentHeight || 0) + be.AppBarMarginTop,
    right: 10,
    width: 60,
    height: 60,
  },
  ...
  mapEditMenu: {
    position: 'absolute',
    top: 150 + (O.StatusBar.currentHeight || 0) + be.AppBarMarginTop,
    right: 20,
    width: 40,
    height: 92,
  },
  ...
  mapDiffText: {
    position: 'absolute',
    top: 160 + (O.StatusBar.currentHeight || 0) + be.AppBarMarginTop,
    left: 30,
    height: 30,
    width: 300,
    fontSize: 15,
