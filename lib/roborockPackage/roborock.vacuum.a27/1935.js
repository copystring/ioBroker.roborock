      ...
      },
      {
        ...
        value: function () {
          var t = this.context.theme.soundPackage,
            ...
            u = React.default.createElement(module1936.default, {
          ...
          if (this.props.data.validEndTime) {
            var b = module1565.convertTimeFromSourceZoneToPhoneZoneByTimestamp(this.props.data.validEndTime, 0);
            ...
            function (l) {
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    if (((t = module1937.default.wavFileName(this.props.data.voice_id, this.props.data.version)), !this.state.playing)) {
                      l.next = 16;
                      break;
                    }
