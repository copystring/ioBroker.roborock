                            ...
                            function (b) {
                              for (;;)
                                switch ((b.prev = b.next)) {
                                  ...
                                  case 7:
                                    module1858 = 'https://' + n + o;
                                    x = '/config.json';
                                    console.log('' + module1858 + x + '?time=' + new Date().getTime());
                                    b.next = 12;
                                    return regeneratorRuntime.default.awrap(module391.default.asyncDownloadFile('' + module1858 + x + '?time=' + new Date().getTime(), 'infoTemp'));
