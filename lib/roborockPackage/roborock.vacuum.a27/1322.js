...
var module1261 = require('./1261'),
  ...
  F = (function (t) {
    ...
    function F(t) {
      ...
      (n = A.call(this, t)).updateRect = function (t) {
      ...
      n.onTouchStart = function (t) {
        if (t == module1134.RectPanType.PanTypeMove) null == n.props.handlePanStart || n.props.handlePanStart(n.state.type, n.state.id);
      };
      ...
      n.state = {
        type: t.type || module1057.FbzType.FBZ_TYPE_REGULAR,
        id: t.id,
        serial: t.id || 1,
        ...
        newAdded: module1057.RectConfig.newAdded,
    ...
    module5.default(F, [
      ...
      },
      {
        ...
        value: function () {
          ...
          var t = module1261._convertToPixelRect(this.state.rectSize, this.props.transform);

          if (!t || isNaN(t.x) || isNaN(t.y) || isNaN(t.width) || isNaN(t.height)) return null;

          var o = t.width + 2 * k,
            s = t.height + 2 * k,
            h = this.state.type != module1057.FbzType.FBZ_TYPE_CARPET && this.state.type != module1057.FbzType.RECT_TYPE_CARPET,
            l = this.state.isFocus && h,
            c = module1271.default.zoneDeleteButton('forbidden_rect_edit_delete', this.panProxy.panResponderDelete, k),
            u = module1271.default.zoneScaleButton(t, 'forbidden_rect_edit_scale', this.panProxy.panResponderScale, k),
            p = this.state.isFocus && h && !this.feedbackMark,
            v = module1271.default.zoneRotateButton(t.width, 'forbidden_rect_edit_rotate', this.panProxy.panResponderRotate, k),
            C = module1271.default.zoneDragButtonView(t.height, this.panProxy.panResponder),
            _ = this.state.isFocus && this.carpetCanSave,
            A = module1271.default.carpetZoneSaveButton(t.width, 'forbidden_carpet_edit_save', this.panResponderSave, k),
            P = this.state.isFocus && (this.ignoreCarpet || (this.customCarpet && !this.state.newAdded)),
            R = module1271.default.carpetZoneDelButton('forbidden_carpet_edit_delete', this.panProxy.panResponderDelete, k),
            F = module1271.default.zoneFocusBorderView(t.width, t.height, k),
            z = this.props.showArea && this.state.isFocus,
            B = module1271.default.zoneAreaView(t.width, this.state.rectSize),
            x = this.getCarpetLines(t),
            Z = this.state.showAITag,
            ...
            D = (((globals.isRTL ? -1 : 1) * this.state.slopeAngle * 180) / Math.PI).toString() + 'deg',
            M = this._getAccessibilityLabelKey(),
            I = !this.state.editable;
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                module12.View,
                module22.default({}, module391.default.getAccessibilityLabel(M), this.panProxy.panResponder.panHandlers, {
                ...
                this.carpetCanSave && x,
                Z && O
              ),
              this.state.isFocus && F,
              l && c,
      ...
      },
      {
        ...
        get: function () {
          return this.state.type == module1057.FbzType.FBZ_TYPE_REGULAR;
        },
      },
      {
        key: 'moppingForbidden',
        get: function () {
          return this.state.type == module1057.FbzType.FBZ_TYPE_MOPPING;
        },
      },
      {
        key: 'cleanForbidden',
        get: function () {
          return this.state.type == module1057.FbzType.FBZ_TYPE_CLEANING;
        },
      },
      {
        key: 'feedbackMark',
        get: function () {
          return this.state.type == module1057.FbzType.RECT_TYPE_FBMARK;
        },
      },
      {
        key: 'customCarpet',
        get: function () {
          return this.state.type == module1057.FbzType.RECT_TYPE_CARPET;
        },
      },
      {
        key: 'ignoreCarpet',
        get: function () {
          return this.state.type == module1057.FbzType.FBZ_TYPE_CARPET;
        },
      },
      {
        key: 'carpetCanSave',
