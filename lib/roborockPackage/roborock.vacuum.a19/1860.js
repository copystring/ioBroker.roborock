                    ...
                    function (f) {
                      for (;;)
                        switch ((f.prev = f.next)) {
                          case 0:
                            c = module22.default(t, 1);
                            l = c[0];
                            f.next = 3;
                            return regeneratorRuntime.default.awrap(module407.default.deleteServerTimer(l));
          ...
          for (;;)
            switch ((l.prev = l.next)) {
              case 0:
                ...
                l.next = 5;
                return regeneratorRuntime.default.awrap(module389.rrAddOrEditTimer(t, module22, ''));
                      ...
                      for (;;)
                        switch ((o.prev = o.next)) {
                          case 0:
                            o.prev = 0;
                            o.next = 3;
                            return regeneratorRuntime.default.awrap(module389.delServerTimer(t.timerId));
