  ...
  L = (function (t) {
    ...
    n.prototype.render = function () {
      var t = this.props,
        ...
        R = null;
      if ('LOADING' === this.state.viewState) R = (w || module1894.defaultRenderLoading)();
        ...
        R = (v || module1894.defaultRenderError)(O.domain, O.code, O.description);
      } else 'IDLE' !== this.state.viewState && console.error('RNCWebView invalid state encountered: ' + this.state.viewState);
      var H = [module1896.default.container, module1896.default.webView, C],
        N = [module1896.default.container, L];
      ...
      var P = W.component || y;
      this.onShouldStartLoadWithRequest = module1894.createOnShouldStartLoadWithRequest(this.onShouldStartLoadWithRequestCallback, h, u);
    ...
    n.defaultProps = {
      ...
      originWhitelist: module1894.defaultOriginWhitelist,
    };
