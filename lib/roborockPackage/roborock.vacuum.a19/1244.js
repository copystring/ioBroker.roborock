  ...
  module5.default(F, [
    ...
    },
    {
      ...
      value: function () {
        ...
        switch (((this.isHiddenSaveAction = module1231.MM.maps.length >= module1231.MM.mapCountMax), this.mode)) {
          case k.SingleFloorWithoutSave:
            return module1231.MM.maps;

          case k.SaveNewMapInSingleFloor:
            return [t].concat(module1231.MM.maps);
          ...
          case k.Default:
          default:
            return this.isHiddenSaveAction ? module1231.MM.maps : [t].concat(module1231.MM.maps);
        }
      },
    },
    {
        ...
        var t = this,
          n = this.state.maps.map(function (n, o) {
            var l = t.props.actionPrefix
              ? module1245.FloorMapPageUtils.getRealName(n.name)
              : module491.soundpackage_update + ' ' + module1245.FloorMapPageUtils.getRealName(n.name);
            return o > 0 ? l : t.isHiddenSaveAction ? l : module1245.FloorMapPageUtils.getRealName(n.name);
          });

        switch (this.mode) {
          case k.SaveNewMapInSingleFloor:
            n = this.state.maps.map(function (t, n) {
              return 0 == n ? module1245.FloorMapPageUtils.getRealName(t.name) : module491.soundpackage_update + ' ' + module1245.FloorMapPageUtils.getRealName(t.name);
            });
        }
    ...
    },
    {
      ...
      value: function (t) {
        var n =
          (module1231.MM.maps.length <= module1231.MM.mapCountMax && -1 == module377.RSM.currentMapId && module377.RSM.multiFloorEnabled) ||
          (!module377.RSM.multiFloorEnabled && 0 == module1231.MM.maps.length);
        return 0 == t ? !this.props.actionPrefix && n : module1231.MM.maps.length >= 1;
      },
    },
    {
      key: 'didSelectRow',
