  ...
  P = (function (n) {
    ...
    function k(n) {
      ...
      t.handleFBZPanStart = function (n, l) {
        if (n == module1235.FbzType.FBZ_TYPE_REGULAR) {
        ...
        } else if (n == module1235.FbzType.FBZ_TYPE_MOPPING) {
          ...
          t._clearMapZonesFocus(t.cleanFbzReferences);
        } else if (n == module1235.FbzType.FBZ_TYPE_CLEANING) {
    ...
    module5.default(k, [
      {
        ...
        value: function (n, t) {
          ...
          if (!n.zonesHasEdited) {
            ...
            this._initFBZones(n.fbzZones, module1235.FbzType.FBZ_TYPE_REGULAR);

            this._initFBZones(n.mopZones, module1235.FbzType.FBZ_TYPE_MOPPING);

            this._initFBZones(n.cleanZones, module1235.FbzType.FBZ_TYPE_CLEANING);
          }

          if (!this.FBZZoneInit && this.props.initFBZone) {
            module1249.setTimeout(function () {
              var n = l.getNewRectIndex(module1235.FbzType.FBZ_TYPE_REGULAR);

              if (n > 0) {
                l.addFBZZones(n, l.props.initFBZone, 0, module1235.FbzType.FBZ_TYPE_REGULAR);
                module1249.setTimeout(function () {
      ...
      },
      {
        key: 'getNewWallIndex',
        value: function () {
          for (var n = this._getVisibleZonesCount(this.wallReferences), t = 1; t <= module1235.MAX_COUNT_WALL_OR_FBZ; t++)
      ...
      },
      {
        ...
        value: function () {
          return this._getVisibleZonesCount(this.wallReferences) >= module1235.MAX_COUNT_WALL_OR_FBZ;
        },
      },
      {
        key: 'getVisibleWalls',
      ...
      },
      {
        key: 'getNewRectIndex',
        value: function (n) {
          for (var t = this._getFbzRefsByType(n), l = this._getVisibleZonesCount(t), s = 1; s <= module1235.MAX_COUNT_WALL_OR_FBZ; s++)
      ...
      },
      {
        ...
        value: function (n) {
          ...
          return !!t && this._getVisibleZonesCount(t) >= module1235.MAX_COUNT_WALL_OR_FBZ;
        },
      },
      {
        key: 'getVisibleFBZZones',
        value: function () {
          for (var n = [], t = 1; t <= module1235.MAX_COUNT_WALL_OR_FBZ; t++) {
            var l, s, o;
      ...
      },
      {
        ...
        value: function () {
          return (
            ...
            3 * module1235.MAX_COUNT_WALL_OR_FBZ
          );
        },
      },
      {
        ...
        value: function () {
          for (var n = this, t = 0, l = 1; l <= module1235.MAX_COUNT_WALL_OR_FBZ; l++)
          ...
          for (l = 1; l <= module1235.MAX_COUNT_WALL_OR_FBZ; l++)
            o.map(function (s) {
      ...
      },
      {
        ...
        value: function (n) {
          if (n && 0 != n.length) {
            for (o = 1; o <= module1235.MAX_COUNT_WALL_OR_FBZ; o++)
              if (o <= n.length) {
                var t,
                  l = n[o - 1];
      ...
      },
      {
        ...
        value: function (n) {
          return n == module1235.FbzType.FBZ_TYPE_REGULAR
            ? this.forbidReferences
            : n == module1235.FbzType.FBZ_TYPE_MOPPING
            ? this.moppingFbzReferences
            : n == module1235.FbzType.FBZ_TYPE_CLEANING
      ...
      },
      {
        ...
        value: function (n, t) {
          if (n[t].state.visible) {
            for (var l = this._getVisibleZonesCount(n), s = 1; s <= module1235.MAX_COUNT_WALL_OR_FBZ; s++)
              n[s] &&
                n[s].state.visible &&
      ...
      },
      {
        ...
        value: function (n, t) {
          var l,
            ...
            u = t ? module1235.ROBOT_FORBIDDEN_R : module1235.DOCK_FORBIDDEN_R;
          return !(!o || (0 == o.x && 0 == o.y)) && module1247._judgeInlegalFBZ(o.x, o.y, n, u * this.props.transform.xx);
        },
      },
      {
      ...
      },
      {
        ...
        value: function (n, t) {
          ...
          var c = module1247._convertToPixelPosition(n.state.position, this.props.transform);

          return module1247._disBtwPointSegement(o.x, o.y, c.start.x, c.start.y, c.end.x, c.end.y).distance / this.props.transform.xx < u;
        },
      },
      {
        ...
        value: function (n, t, l) {
          var s = this,
            o = this.props.mapMode == module936.MAP_MODE_MAP_EDIT;
          return Object.keys(t).map(function (u, c) {
            return React.default.createElement(module1241.ForbiddenZone, {
              ...
              transform: l,
              editable: o,
              showArea: s.props.mapMode == module936.MAP_MODE_MAP_EDIT,
      ...
      },
      {
        ...
        value: function (n) {
          var t = this,
            l = this.props.mapMode == module936.MAP_MODE_MAP_EDIT;
          return Object.keys(this.wallReferences).map(function (s, o) {
            return React.default.createElement(module1241.InvisibleWall, {
              key: o,
              id: s,
        ...
        value: function () {
          var n = new y({
            ...
            t =
              ...
              this.props.mapMode == module936.MAP_MODE_MAP_EDIT ||
              !module377.RSM.isRunning ||
              (module377.RSM.isRunning && module377.RSM.isMopForbiddenEnabled),
            l =
              module415.DMM.isGarnet &&
              (this.props.mapMode == module936.MAP_MODE_MAP_EDIT || !module377.RSM.isRunning || (module377.RSM.isRunning && module377.RSM.isCleanFBZEnabled));
          return React.default.createElement(
            ...
            this.getForbiddenZone(module1235.FbzType.FBZ_TYPE_REGULAR, this.forbidReferences, n),
            l && this.getForbiddenZone(module1235.FbzType.FBZ_TYPE_CLEANING, this.cleanFbzReferences, n),
            t && this.getForbiddenZone(module1235.FbzType.FBZ_TYPE_MOPPING, this.moppingFbzReferences, n)
          );
        },
      },
    ]);
