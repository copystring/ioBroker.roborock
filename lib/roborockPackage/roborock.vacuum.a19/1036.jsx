  ...
  function I() {
    ...
    t._renderTabBar = function (n) {
      var o = t.props.navigation.state,
        ...
        p = t.props,
        f = p.tabBarComponent,
        v = undefined === f ? module1048.default : f,
        h = p.tabBarPosition,
        y = p.tabBarOptions;
    ...
    t._renderScene = function (n) {
      ...
      if (c) {
        ...
        if (p)
          return (
            <module1035.default isVisible={x}>
              {l({
                route: o,
              })}
            </module1035.default>
...
module940.polyfill(I);
var B = module1030.default(I);
exports.default = B;
