              ...
              for (;;)
                switch ((x.prev = x.next)) {
                  ...
                  case 16:
                    ...
                    w = !module4 || module1365.default().isBetween(module4, module5);
                    O =
                      !module7 ||
                      -1 !=
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            module1374 = React.default.createElement(
          ...
          return this.state.shouldShow ? (this.state.selfHeight ? u : module1374) : null;
        },
      },
      {
...
var H = module12.StyleSheet.create({
  ...
  text: {
    width: module12.Dimensions.get('window').width - 2 * module1065.HorizontalMargin - 30 - 45 - 20,
    fontSize: 12,
