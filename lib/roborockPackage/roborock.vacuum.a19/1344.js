...
var w = (function () {
  ...
  module5.default(t, null, [
    ...
    },
    {
      ...
      value: function (t, n) {
        if (t) {
          var o = module1231.MM.mapData;

          switch ((t.setState(O({}, o)), t.changeMapViewMode(n), t.enterMapEditMode(), n)) {
            case module1233.MapModelInCleanMode.Segment_Clean_Sequential_Edit:
              t.setCleanSequence(module1231.MM.cleanSequence.concat(), true);
              break;
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return React.default.createElement(module1345.default, {
          tip: n,
    ...
    },
    {
      ...
      value: function (t) {
        var module49 = '';
        module49 =
          t == module936.mapOpErrorCode.VENDOR_ERROR_CODE
            ? module491.robot_communication_exception
            : t == module936.mapOpErrorCode.PROCESS_BUSY_ERROR_CODE
            ? module491.toast_frequently_operate
            : t == module936.mapOpErrorCode.ERROR_ACCESS_DENIED || t == module936.mapOpErrorCode.BAD_REQUEST
            ? module491.map_edit_unauthorized_op
            : t == module936.mapOpErrorCode.ERROR_ACTION_LOCKED
            ? module491.rubys_main_diag_update_map
            : (t == module936.mapOpErrorCode.ERROR_ACTION_TIMEOUT || module936.mapOpErrorCode.PARAM_ERROR || module936.mapOpErrorCode.OPERATION_FAILED,
...
var P = module12.StyleSheet.create({
  ...
  mapTop: module387.default.iOSAndroidReturn(module936.StatusBarHeight + module936.AppBarMarginTop, module12.StatusBar.currentHeight || 0) + 44 + 60,
  mapBottom: 60,
  mapLeft: 10,
  mapRight: 10,
  confirmButton: {
