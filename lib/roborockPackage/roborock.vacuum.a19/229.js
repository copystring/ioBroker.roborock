...
var module220 = require('./220'),
  s = module220.AnimatedEvent,
  c = module220.attachNativeEvent,
  ...
  U = function t(n, u) {
    var s = function (t, n, o) {
      ...
      var u = t,
        s = n;
      u.stopTracking();
      if (n.toValue instanceof module223) u.track(new module239(u, n.toValue, module245, s, o));
      else u.animate(new module245(s), o);
    };
  ...
  spring: function t(n, u) {
    var s = function (t, n, o) {
      ...
      var u = t,
        s = n;
      u.stopTracking();
      if (n.toValue instanceof module223) u.track(new module239(u, n.toValue, module243, s, o));
      else u.animate(new module243(s), o);
    };
