  ...
  module1912 = (function () {
    ...
    module5.default(t, null, [
      ...
      },
      {
        ...
        value: function () {
          var t, s, o, module407, module415, h, P, module1912, _, x;
              ...
              for (;;)
                switch ((b.prev = b.next)) {
                  case 0:
                    if (
                      ((b.prev = 0),
                      (t = module936.areaServerMap[module377.RobotStatusManager.sharedManager().serverCode].host),
                      (s = module936.areaServerMap[module377.RobotStatusManager.sharedManager().serverCode].cdnHost),
                  ...
                  case 17:
                    ...
                    module1912 = (module1912 = o.voice_list.filter(function (t) {
                    ...
                    this.downloadPreviewWavFiles(module1912, s);
                  ...
                  case 26:
                    x = b.sent;
                    this.sharedManager().soundPackages = module1912;
                    this.sharedManager().specialSoundPackages = _;
                    b.prev = 29;
                    b.next = 32;
                    return regeneratorRuntime.default.awrap(module411.SetStorageKey(module411.StorageKeys.SoundPackageLsitData, JSON.stringify(module1912)));
            ...
            function (v) {
              for (;;)
                switch ((v.prev = v.next)) {
                  case 0:
                    v.prev = 0;
                    t = module936.areaServerMap[module377.RobotStatusManager.sharedManager().serverCode].cdnHost;
                    v.next = 4;
