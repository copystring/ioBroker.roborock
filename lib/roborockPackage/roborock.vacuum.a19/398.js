...
function s(o, s) {
  ...
  for (var u = new module400(), p = new Array(); s > 2; ) {
...
h.prototype.generate = function (o, s) {
  ...
  for (var u = new module399(s, 16); ; ) {
    for (; (this.p = new module399(o - l, 1, h)), 0 != this.p.subtract(module399.ONE).gcd(u).compareTo(module399.ONE) || !this.p.isProbablePrime(10); );

    for (; (this.q = new module399(l, 1, h)), 0 != this.q.subtract(module399.ONE).gcd(u).compareTo(module399.ONE) || !this.q.isProbablePrime(10); );
    ...
    var f = this.p.subtract(module399.ONE),
      c = this.q.subtract(module399.ONE),
      v = f.multiply(c);

    if (0 == v.gcd(u).compareTo(module399.ONE)) {
