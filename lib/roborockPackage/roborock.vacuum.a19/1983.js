var regeneratorRuntime = require('regenerator-runtime'),
  ...
  module1326 = V(require('./1326')),
  module1808 = require('./1808'),
  module1233 = require('./1233'),
  module1344 = V(require('./1344')),
  ...
  T = (function (t) {
    ...
    module5.default(V, [
      ...
      },
      {
        key: 'initMapView',
        value: function () {
          module1344.default.initMapViewConfig(this.mapView, module1233.MapModelInCleanMode.Segment_Clean_Sequential_Edit);
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          this.cleanSequenceListener = module12.DeviceEventEmitter.addListener(module411.NotificationKeys.DidReceiveSpecialEvent, function (n) {
            if (n.data == module411.EventKeys.CleanSequenceDidReceive && t.mapView) t.mapView.setCleanSequence(module1231.MM.cleanSequence.concat(), false);
          });
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = [
              module1344.default.confirmButton(this.onNavigationSavePress.bind(this), false, function (n) {
                t.mapSaveButton = n;
              }),
            ];
          module1344.default.setNavigation(this, globals.isRTL ? n.reverse() : n, this.onNavigationBackPress.bind(this));
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module1344.default.isEditedByArrays(this.originalSelectedSegements, this.selectedSegements)) {
            var n = {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            s = React.default.createElement(module1233.MapView, {
              ref: function (n) {
                t.mapView = n;
              },
            ...
            u = module1344.default.resetButton(module491.reset_order_button_title, this.state.isResetOrderEnable, this.onResetButtonPress.bind(this));
          return React.default.createElement(
            ...
            React.default.createElement(module1326.default, {
              type: module1326.MenuType.Menu_Order,
