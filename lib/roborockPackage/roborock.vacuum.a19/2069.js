...
var regeneratorRuntime = require('regenerator-runtime'),
  ...
  c = null,
  module936 = require('./936').VideoError,
  v = (function () {
    function t() {
                ...
                for (;;)
                  switch ((f.prev = f.next)) {
                    ...
                    case 15:
                      ...
                      } else this.notifyVideoError(module936.Video_StartPreviewFailed_unKnownReason, v);
        ...
        },
        {
          ...
          value: function (t, n) {
            if (undefined == t) {
              ...
              return void this.notifyVideoError(module936.Video_StartPreviewFailed_unKnownReason, n);
            }

            var o = module936.Video_StartPreviewFailed_innerUnknowReason;

            switch (t) {
              case -10009:
                o = module936.Video_StartPreviewFailed_passwordError;
                break;

              case -10010:
                o = module936.Video_StartPreviewFailed_passwordErrorFrequently;
                break;

              case -10011:
                o = module936.Video_StartPreviewFailed_robotInCharge;
                break;

              case -10012:
                o = module936.Video_StartPreviewFailed_cameraStatusError;
                break;

              case -10013:
                o = module936.Video_StartPreviewFailed_alreadyInPreview;
                break;

              case -10014:
                o = module936.Video_StartPreviewFailed_requestTurnserverFailed;
                break;

              case -10015:
                o = module936.Video_StartPreviewFailed_innerUnknowReason;
                break;

              case -10016:
                o = module936.Video_StartPreviewFailed_robotIsDisconnecting;
            }
                ...
                for (;;)
                  switch ((s.prev = s.next)) {
                    case 0:
                      ...
                      this.notifyVideoError(module936.Video_GetDeviceSdpFailed);
                      this.clearSdpTimer();
                ...
                for (;;)
                  switch ((o.prev = o.next)) {
                    ...
                    case 3:
                      ...
                      console.log('\u91cd\u8bd5\u6b21\u6570\u5df2\u8fbe\u4e0a\u9650 \u7ed3\u675f-------\u9700\u8981\u63d0\u793a\u7528\u6237');
                      this.notifyVideoError(module936.Video_GetTurnServerFailed);
                      return o.abrupt('return');
