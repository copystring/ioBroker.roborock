...
var R = (function (t, ...args) {
  ...
  function k() {
    ...
    (t = j.call(this, ...args)).setNativeProps = function (n) {
      var f = !n.matrix && module1078.default(n);
      if (f) n.matrix = f;
      module21.default(n, module1082.pickNotNil(module1096.default(n, true)));
  ...
  module5.default(k, [
    {
      ...
      value: function () {
        var t = this.props,
          ...
          R = c && c.match(module1082.idPattern),
          B = R && R[1];

        if (B) {
          var E = module1071.default(
            N(
              N({}, module1071.propsAndStyles(D)),
              {},
              {
                x: null,
                y: null,
