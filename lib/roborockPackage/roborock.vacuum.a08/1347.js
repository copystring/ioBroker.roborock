exports.default = function (t) {
  var x,
    ...
    B = module415.DMM.isGarnet ? module1351.default : A ? module1352.default : module1349.default,
    W = React.useRef(),
    G = React.useRef(),
  ...
  var ue = function () {
    ...
    ce = function (o, s) {
      var React, module12, module1348, module1349, module1351, module1352, module411, module386, module1233, x, D;
          ...
          for (;;)
            switch ((v.prev = v.next)) {
              case 0:
                ...
                module386 = function () {
                  var s, l, module1349, module1351, b, module1233, x;
                  return regeneratorRuntime.default.async(
                    function (D) {
                      for (;;)
                        switch ((D.prev = D.next)) {
                          case 0:
                            ...
                            if (!(module377.RSM.isSwitchMapModeManual && -1 != module377.RSM.currentMapId && module1231.MM.maps.length > 1)) {
                              D.next = 8;
                              break;
                            }
                            ...
                            globals.Alert.alert(
                              ...
                              module491.start_clean_with_manual_mode_alert_title.templateStringWithParams({
                                mapName: module1231.MM.getCurrentMapName(),
                              }),
                              [s, l]
                            );
                            D.next = 10;
                          ...
                          case 12:
                            ...
                            module1351 = module377.RSM.isSupportOrderSegmentClean() ? module1349 : t.cleanSegments;
                            globals.dlog('clean_mop:' + o, JSON.stringify(module1351));
                            D.next = 20;
                            return regeneratorRuntime.default.awrap(module407.default.segmentClean(module1351));

                          case 20:
                            module383.LogEventCommon('start_segment_clean', module1351);
                          ...
                          case 30:
                            ...
                            module1233 = le.state.cleanCount;
                          ...
                          case 39:
                            ...
                            module377.RSM.state = module1348[o];
              ...
              case 24:
                if (!module1351() || !module377.RSM.isCleanTaskShouldResume() || x) {
                  v.next = 29;
                  break;
                }

                v.next = 27;
                return regeneratorRuntime.default.awrap(module1233());
              ...
              case 29:
                if (!module1351() || !(module377.RSM.isCleaning() || module377.RSM.isPureMopping() || module377.RSM.isInCleanMopping() || x)) {
                  v.next = 36;
                  break;
                }
              ...
              case 36:
                if (!module377.RSM.isInBackDockTask() && module1351()) {
                  v.next = 44;
                  break;
                }
    ...
    ie = function (o, s) {
      var l, u, S, p, R, module1351, module1352, C, b;
      return regeneratorRuntime.default.async(
        function (k) {
          for (;;)
            switch ((k.prev = k.next)) {
              ...
              case 17:
                ...
                module1351 = s ? module491.home_dialog_begin_new_back_charge : module491.home_dialog_begin_new_back_washing_duster;
                module1352 = module377.RSM.isWaterBoxCarriageIn && module377.RSM.isWaterBoxIn && module415.DMM.isTopazS;
      ...
      if (
        ...
        if ((se = t.parent.mapView)) {
            ...
            if (module377.RSM.cleanResumeFlag == module377.CleanResumeFlag.Segment_Clean) {
              s = l
                ? module377.RSM.isCustomCleanWaterMode()
                  ? module1233.MapModelInCleanMode.Segment_Clean_Sequential_Read_Only_With_Clean_Type
                  : module1233.MapModelInCleanMode.Segment_Clean_Sequential_Read_Only
                : module377.RSM.isCustomCleanWaterMode()
                ? module1233.MapModelInCleanMode.Segment_Clean_Read_Only_With_Clean_Type
                : module1233.MapModelInCleanMode.Segment_Clean_Read_Only;
          ...
          if (!(o != E && o != N)) {
            ...
            s = module377.RSM.isCustomCleanWaterMode() ? module1233.MapModelInCleanMode.Global_Clean_With_Clean_Type : module1233.MapModelInCleanMode.Global_Clean;
            if (se) se.changeMapViewMode(s);
          }

          if (o == O)
            module377.RSM.cleanResumeFlag == module377.CleanResumeFlag.Zone_Clean
              ? (se && se.changeMapViewMode(module1233.MapModelInCleanMode.Zone_Clean_Read_Only),
                t.updateParent &&
                  t.updateParent({
                    topTip: '',
                  }))
              : se && se.changeMapViewMode(module1233.MapModelInCleanMode.Zone_Clean_Edit);
        } else
          setTimeout(function () {
            n(o);
          }, 200);
  ...
  return React.default.createElement(
    ...
    me && me(),
    React.default.createElement(module1348.default, {
      ref: W,
      enabled: H,
...
var F = module12.StyleSheet.create({
  wrap: {
    ...
    position: 'absolute',
    bottom: module1065.BottomControlBottom,
    alignSelf: 'center',
    zIndex: 0,
    alignItems: 'center',
  },
