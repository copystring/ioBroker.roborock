...
var module988 = {
    transitionSpec: (n = require('./988').supportsImprovedSpringAnimation()
      ? {
    ...
    screenInterpolator: module987.default.forHorizontal,
    containerStyle: {
      backgroundColor: '#000',
    },
  },
  p = {
    transitionSpec: n,
    screenInterpolator: module987.default.forVertical,
    containerStyle: {
      backgroundColor: '#000',
    },
  },
  O = {
    ...
    screenInterpolator: module987.default.forFadeFromBottomAndroid,
  },
  b = {
    transitionSpec: {
      duration: 230,
