...
var React = require('react'),
  ...
  k = module1269.RRSurface,
  O = module1269.isRRSurface,
    ...
    module5.default(l, [
      {
        ...
        value: function (t, n, o) {
          if (!(null == (s = this.props) ? undefined : null == (h = s.pathData) ? undefined : h.pathType)) module1235.MoppingType.MOPPING_TYPE_BOTH_BOTH;
          ...
          if (null != (p = this.props) && null != (c = p.pathData) && null != (v = c.points) && v.length) {
            ...
            b =
              'android' != module12.Platform.OS || O
                ...
                : module1247._parsePathWithTransform(
          ...
          if (D)
            Q =
              'android' != module12.Platform.OS || O
                ...
                : module1247._parseMopPathWithTransform(
          ...
          if (D)
            st =
              'android' != module12.Platform.OS || O
                ...
                : module1247._parseBackWashPathWithTransform(
          ...
          if ('' != rt.pathGotoPlan)
            ct = (
              <M
                ...
                stroke={module1270.map.pathGotoPlan}
                strokeWidth={1}
...
var V = (function (t) {
  ...
  function l(t) {
    ...
    s.pathPoints = [];
    s.speed = _;
    s.status = module1235.RobotAnimationStatus.DEFAULT;
    return s;
  }
  ...
  module5.default(l, [
        ...
        return (
          ...
          >
            ...
            {React.createElement(
              ...
              React.createElement(module1267, {
                resizeMethod: 'scale',
                source: b,
                style: {
                  width: 10.8 * w.xx,
    ...
    },
    {
      ...
      value: function () {
        ...
        else if (this.status != module1235.RobotAnimationStatus.PAUSED) {
          if (this.status != module1235.RobotAnimationStatus.DEFAULT || this.props.autoAnimated)
            if (this.pathPoints.length > this.currentIndex + 1) {
              this.pathPoints.length;
              this.currentIndex;
              this.run();
            } else {
              if (this.status == module1235.RobotAnimationStatus.ANIMATING && !this.props.autoAnimated) {
                this.status = module1235.RobotAnimationStatus.DEFAULT;
    ...
    },
    {
      key: 'pause',
      value: function () {
        if (this.status == module1235.RobotAnimationStatus.ANIMATING) this.status = module1235.RobotAnimationStatus.PAUSED;
      },
    },
    {
      key: 'play',
      value: function () {
        if (this.status == module1235.RobotAnimationStatus.PAUSED) this.status = module1235.RobotAnimationStatus.ANIMATING;

        if (this.status == module1235.RobotAnimationStatus.DEFAULT) {
          this.reset(true);
          this.status = module1235.RobotAnimationStatus.ANIMATING;
        }
      },
    },
    {
