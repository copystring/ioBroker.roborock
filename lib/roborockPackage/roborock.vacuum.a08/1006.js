  ...
  function k() {
    ...
    t._handleDrawerOpen = function () {
      t.props.navigation.dispatch({
        type: module1005.default.DRAWER_OPENED,
    ...
    t._handleDrawerClose = function () {
      t.props.navigation.dispatch({
        type: module1005.default.DRAWER_CLOSED,
        key: t.props.navigation.state.key,
      });
    };
      ...
      value: function () {
        ...
        return React.default.createElement(
          module1007.default,
          {
            ...
            drawerPosition: 'right' === this.props.navigationConfig.drawerPosition ? module1007.default.positions.Right : module1007.default.positions.Left,
          },
