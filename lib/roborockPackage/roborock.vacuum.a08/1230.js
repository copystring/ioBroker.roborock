...
exports.getMopWaterOrStrengthTitle = function (o) {
  if (module415.DMM.isGarnet || (!module386.default.isElectronicWaterBoxSupported() && !module386.default.isShakeMopStrengthSupported())) return '';
  if (o == c) return module491.localization_strings_Common_custom_mode;
  var s = h().find(function (t) {
    return t.strength == o;
  });
  return (null == s ? undefined : s.name) || '';
};
