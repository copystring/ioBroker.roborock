...
var module389 = require('./389'),
  ...
  G = module12.Dimensions.get('window').height - module936.StatusBarHeight - 44 - 150,
    ...
    },
    {
      ...
      value: function () {
        ...
        var module1960 = this.getInnerFailedView(require('./1960'), module491.map_object_bubble_tip_no_photo),
          ...
          module1962 = React.default.createElement(
            ...
            React.default.createElement(
              ...
              C,
              this.state.readPhotoLoadingStatus == J.LOADING && module1278,
              this.state.readPhotoLoadingStatus == J.FAILED && module1961,
              this.state.readPhotoLoadingStatus == J.NOPHOTO && module1960
            )
          ),
          ...
          lt = module936.obstacleNames[h];
        if (undefined === lt) lt = ' ';
        if (!(42 != h || module415.DMM.isV1)) lt += '(AI)';
        var ut = module1363.default.mapObjectPhotoEnabled && module386.default.isPhotoUploadSupported() && !module387.default.isShareUser() && module415.DMM.isTanosV_CN,
          ct = module386.default.isStructuredLightSupported() ? module936.obstacleRemoveTipsStructuredLight : module936.obstacleRemoveTips,
          ht = this.state.selfHeight > G ? G : this.state.selfHeight,
          dt = A(
            A({}, module1065.BaseShadow),
            {},
            {
              width: n,
              height: ht,
        ...
        return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                (module386.default.isFwFilterObstacleSupported() && module1363.default.mapObjectPhotoEnabled) ||
                  (module386.default.isFwFilterObstacleSupported() && module1363.default.mapObjectPhotoEnabled && 18 == h)
                  ? module1962
                  : module1963,
                React.default.createElement(
                  module12.View,
          ...
          React.default.createElement(module1956.MapObjectIgnoreDescDialog, {
            ref: function (o) {
