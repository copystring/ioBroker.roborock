  ...
  var A = (function (_) {
    ...
    function O(o) {
      ...
      u._handleOpenURL = function (n) {
        ...
        if (false !== c) {
          var f = module949.urlToPathAndParams(o, l);
      ...
      u.dispatch = function (n) {
        ...
        var o = u._navState;
        module944.default(o, 'should be set in constructor if stateful');
      ...
      N(o);
      u._initialAction = module941.default.init();
      if (u._isStateful())
        u.subs = module12.BackHandler.addEventListener('hardwareBackPress', function () {
          if (u._isMounted) return u.dispatch(module941.default.back());
      ...
      [
              ...
              function (L) {
                for (;;)
                  switch ((L.prev = L.next)) {
                    ...
                    case 18:
                      p = L.sent;
                      l = p && module949.urlToPathAndParams(p, u);
        ...
        },
        {
          ...
          value: function (t, n) {
            ...
            this.dispatch(module941.default.init());
          },
        },
        {
          ...
          value: function () {
            ...
            if (this._isStateful()) {
              ...
              if (!(this._navigation && this._navigation.state === u))
                this._navigation = module942.default(t.router, u, this.dispatch, this._actionEventSubscribers, this._getScreenProps, function () {
                  return n._navigation;
                });
              s = this._navigation;
            }

            module944.default(s, 'failed to get navigation');
