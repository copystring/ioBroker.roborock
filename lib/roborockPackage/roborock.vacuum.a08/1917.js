  ...
  U = (function (t) {
    ...
    module5.default(U, [
          ...
          var t = [
            {
              ...
              detail: (module1368.addZeroPrefix(this.doNotDisturbBeginHour) + ':' + module1368.addZeroPrefix(this.doNotDisturbBeginMinute)).replace('0-1:0-1', '--:--'),
            ...
            },
            {
              ...
              detail: (module1368.addZeroPrefix(this.doNotDisturbEndHour) + ':' + module1368.addZeroPrefix(this.doNotDisturbEndMinute)).replace('0-1:0-1', '--:--'),
              shouldShowBottomLine: false,
      ...
      },
      {
        ...
        value: function () {
          ...
          var l = React.default.createElement(
            ...
            React.default.createElement(module1114.default, null)
          );
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    React.default.createElement(
                      ...
                      React.default.createElement(module1117.ActionSheetView, {
                        title: module491.area_of_unit,
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              h,
              f,
              React.default.createElement(module1233.MapSavePopBox, {
                ref: function (n) {
                  t.mapSaveView = n;
                },
                didCancel: function () {
              ...
              React.default.createElement(module1918.LedSettingModalView, {
                ref: function (n) {
                  t.ledSettingView = n;
                },
                didSet: function (o) {
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 4:
                    ...
                    if (module1231.MM.maps.length > 0) {
      ...
      },
      {
        ...
        value: function (t) {
          var o, module30, module4, module5, module7, module9, f, React, module12, module381, module1117, module387, module1346;
          return regeneratorRuntime.default.async(
            function (y) {
              for (;;)
                switch ((y.prev = y.next)) {
                  case 0:
                    ...
                    module1117 = module9 ? 1 : 0;
                    module387 = undefined == t ? this.state.ledSetting : t;
                    o = f | (module12 << 1) | (module381 << 2) | (module387 << 3) | (React << 5) | (module1117 << 6);
                    y.prev = 9;
                    y.next = 12;
                  ...
                  case 12:
                    module1346 = y.sent;
                    console.log('updateCameraStatus - ' + JSON.stringify(module1346) + ' - ' + module4 + ' - ' + module5 + ' - ' + module7 + ' - ' + o);
                    this.setState({
                      ledSetting: t,
                    });
