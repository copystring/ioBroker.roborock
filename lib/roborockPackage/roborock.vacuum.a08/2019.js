...
var module936 = require('./936').Definitions,
  S = function (t) {
            ...
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 2:
                    t = s.sent;
                    o = module936.findIndex(function (n) {
                      return n.command == t;
                    });
            ...
            function (u) {
              for (;;)
                switch ((u.prev = u.next)) {
                  ...
                  case 10:
                    if (this.props.definitionDidChange) this.props.definitionDidChange(true, module936[t]);
