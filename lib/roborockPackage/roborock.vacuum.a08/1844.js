...
class v {
  ...
  __getValue() {
    ...
    f.width = module1830(h) ? h.__getValue() : h;
    f.height = module1830(u) ? u.__getValue() : u;
  ...
  __attach() {
    var t = this,
      ...
      _ = n.width,
      l = n.height;
    if (module1830(_)) _.__addChild(this);
    if (module1830(l)) l.__addChild(this);
  ...
  __detach() {
    var t = this,
      ...
      _ = n.width,
      l = n.height;
    if (module1830(_)) _.__removeChild(this);
    if (module1830(l)) l.__removeChild(this);
    o.forEach(function (n) {
    ...
    for (var o in n) {
      ...
      if (h instanceof Array) {
        for (var u = [], _ = 0; _ < h.length; _++) {
          var l = h[_];
          u[_] = module1830(l) ? l.__getValue() : l;
        }

        t[o] = u;
      } else module1830(h) ? (t[o] = h.__getValue()) : (t[o] = h);
    }
    ...
    for (var n in t) {
      ...
      if (o instanceof Array)
        for (var h = 0; h < o.length; h++) {
          var u = o[h];
          if (module1830(u)) u.__addChild(this);
        }
      else module1830(o) && o.__addChild(this);
    }
  }
  ...
  __detach() {
    ...
    for (var n in t) {
      ...
      if (o instanceof Array)
        for (var h = 0; h < o.length; h++) {
          var u = o[h];
          if (module1830(u)) u.__removeChild(this);
        }
      else module1830(o) && o.__removeChild(this);
    }
  }
}
