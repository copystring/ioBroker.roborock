    ...
    module5.default(M, [
      {
        ...
        value: function () {
          module1354.ModeDataInstance.getCustomMopList();
        },
      },
      {
              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  ...
                  case 4:
                    n = [];
                    s = [];
                    c = module1230.getSystemCustomMopModes();
                    module1354.ModeDataInstance.customMopModeListData.forEach(function (o, l) {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (
            !t &&
            module1354.ModeDataInstance.customMopModeListData.filter(function (t) {
              return !t.sys_type;
            }).length >= 5
          )
