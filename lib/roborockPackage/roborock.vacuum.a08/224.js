var t,
  ...
  N = {
    ...
    disableQueue: function () {
      module13.default(module225.default, 'Native animated module is not available');
      v = false;

      for (var t = 0, n = c.length; t < n; t++) {
        var o = c[t];
        module225.default.connectAnimatedNodes(o[0], o[1]);
      }
    ...
    createAnimatedNode: function (t, n) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.createAnimatedNode(t, n);
    },
    startListeningToAnimatedNodeValue: function (t) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.startListeningToAnimatedNodeValue(t);
    },
    stopListeningToAnimatedNodeValue: function (t) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.stopListeningToAnimatedNodeValue(t);
    },
    connectAnimatedNodes: function (t, n) {
      module13.default(module225.default, 'Native animated module is not available');
      if (v) c.push([t, n]);
      else module225.default.connectAnimatedNodes(t, n);
    },
    disconnectAnimatedNodes: function (t, n) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.disconnectAnimatedNodes(t, n);
    },
    startAnimatingNode: function (t, n, o, s) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.startAnimatingNode(t, n, o, s);
    },
    stopAnimation: function (t) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.stopAnimation(t);
    },
    setAnimatedNodeValue: function (t, n) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.setAnimatedNodeValue(t, n);
    },
    setAnimatedNodeOffset: function (t, n) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.setAnimatedNodeOffset(t, n);
    },
    flattenAnimatedNodeOffset: function (t) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.flattenAnimatedNodeOffset(t);
    },
    extractAnimatedNodeOffset: function (t) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.extractAnimatedNodeOffset(t);
    },
    connectAnimatedNodeToView: function (t, n) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.connectAnimatedNodeToView(t, n);
    },
    disconnectAnimatedNodeFromView: function (t, n) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.disconnectAnimatedNodeFromView(t, n);
    },
    dropAnimatedNode: function (t) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.dropAnimatedNode(t);
    },
    addAnimatedEventToView: function (t, n, o) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.addAnimatedEventToView(t, n, o);
    },
    removeAnimatedEventFromView: function (t, n, o) {
      module13.default(module225.default, 'Native animated module is not available');
      module225.default.removeAnimatedEventFromView(t, n, o);
    },
  },
  p = {
    opacity: true,
...
module.exports = {
  ...
  shouldUseNativeDriver: function (t) {
    if (true !== t.useNativeDriver || module225.default) return t.useNativeDriver || false;
    else {
      if (!h) {
        console.warn(
  ...
  get nativeEventEmitter() {
    if (!t) t = new module123.default(module225.default);
    return t;
  },
};
