...
function y() {
  return module2065.default.currentState().then(function (t) {
    module2064.default.update(t);
...
function h() {
  if (!p) {
    v = module2063.default.eventEmitter.addListener(s, function (t) {
      module2064.default.update(t);
      var n = module2065.default.convertState(t);
      j = n;
    ...
    y();
    O = module2064.default.addSubscription(function (t) {
      if (j) {
        var n = l(
          l({}, j),
          {},
