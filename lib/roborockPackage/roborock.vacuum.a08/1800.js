...
var O = (function (t) {
  ...
  function B(t) {
    ...
    n.dataProvider = module386.default.isMultiFloorSupported() ? new module1801.MultiMapDataProvider() : new module1801.SingleMapDataProvider();
    n.mapUpdated = true;
    return n;
  }
    ...
    },
    {
      ...
      get: function () {
        var t,
          n,
          o = this;
        return module1245.FloorMapPageUtils.getRealName(
          null !=
            (t =
              null ==
              (n = module1231.MM.maps.find(function (t) {
            ...
            n.loadEditingMap(t)
              ...
              .catch(function (t) {
                ...
                if (t != N) {
                  ...
                  module1261.showFinishCurrentTastAlertIfNeeded(n.props.alertHandler).catch(function (t) {
      ...
      value: function () {
        ...
        this.dataProvider
          ...
          .then(function (n) {
            ...
            if (t.state.multiFloorFeatureEnabled) module1231.MM.getMultiMaps();
            else {
              module12.DeviceEventEmitter.emit(module411.NotificationKeys.DidReceiveSpecialEvent, {
                data: module411.EventKeys.MapSegmentsDidChange,
                sender: t,
            ...
            {},
            {
              ...
              onPress: function () {
                if (module377.RSM.isRunning)
                  module1261.showFinishCurrentTastAlertIfNeeded(p.props.alertHandler).catch(function (t) {
      ...
      value: function (t) {
        ...
        if (
          ...
          if ('' != o) {
            var l,
              s,
              p = module1245.FloorMapPageUtils.getRealLength(o);
            if (module1245.FloorMapPageUtils.getRealLength(o) >= 30) null == (l = (s = this.props).toastHandler) || l.call(s, module491.floor_map_name_too_long);
...
var F = module12.StyleSheet.create({
    mainView: {
      ...
      borderBottomLeftRadius: module936.AppBorderRadius,
      borderBottomRightRadius: module936.AppBorderRadius,
      borderWidth: 1,
      borderColor: 'white',
    },
    buttonViewButton: {
  ...
  A = module381.HocBottomModal(module1355.WithSwipeToClose(O), true);
exports.default = A;
