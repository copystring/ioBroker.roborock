...
var _ = (function (t, ...args) {
  ...
  function I() {
    ...
    (t = x.call(this, ...args))._getScreenOptions = function (n) {
      ...
      module1009.default(o.options, 'Cannot access screen descriptor options from drawer sidebar');
      return o.options;
    };
    ...
    t._onItemPress = function (n) {
      ...
      if (!n.focused) {
        if (null != s.index && 0 !== s.index)
          o = module938.StackActions.reset({
            index: 0,
            actions: [
  ...
  module5.default(I, [
    {
      ...
      value: function () {
        ...
        module1009.default('number' == typeof o.index, 'should be set');
