...
var module491 = require('./491').strings,
  ...
  pe = module1362.Errors,
  ge = module1362.getToast,
  fe = module1362.Reminder,
  ...
  module1813 = (function (t) {
    ...
    module5.default(Y, [
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module1809.default, {
            enabled: this.settingIconConfig.enabled,
            hasBadge: this.settingIconConfig.hasBadge,
            onPress: function () {
              if (!module1063.default.shared().isDisableBackAndMore) {
                module1231.MM.stop();
                module1231.MM.isStopedBySettingPage = true;
      ...
      {
        key: 'showFoamRemoveAlertIfNeeded',
        value: function () {
          var t, o, s;
          return regeneratorRuntime.default.async(
            function (u) {
              for (;;)
                switch ((u.prev = u.next)) {
                  case 0:
                    u.next = 2;
                    return regeneratorRuntime.default.awrap(module411.GetStorageKey(module411.StorageKeys.FoamRemoveGuide));
                  ...
                  case 5:
                    if ((t = module390.MC.serialNumber)) {
                      u.next = 8;
                      break;
                    }
                  ...
                  case 8:
                    u.next = 10;
                    return regeneratorRuntime.default.awrap(module1810.default.sharedManager().getConfig());

                  case 10:
                    if (
                      ((o = module1810.default.sharedManager().foamRemoveSNPrefixes),
                      !(function () {
                        var n = false;
                    ...
                    null == (s = this.foamRemoveAlert) || s.show();
                    u.next = 16;
                    return regeneratorRuntime.default.awrap((0, module411.SetStorageKey)(module411.StorageKeys.FoamRemoveGuide, module411.StorageKeys.FoamRemoveGuide));
      ...
      },
      {
        ...
        value: function () {
          ...
          this.robotStatusListener = se.addListener(module411.NotificationKeys.RobotStatusDidUpdate, function (o) {
            ...
            n.hasGotStatus = !0;
            n.updateUI();
            module377.RSM.isCurrentMapChanged && t.currentMapDidChange();
      ...
      },
      {
        ...
        value: function () {
          ...
          this.redPointListener = se.addListener(module411.NotificationKeys.RedDotDidChange, function (o) {
            ...
            'firmware_update' == o.name && o.value && t.detectedNewFirmware();
          });
        },
      },
      {
            ...
            function (u) {
              for (;;)
                switch ((u.prev = u.next)) {
                  ...
                  case 13:
                    this.newFirmwareView && this.newFirmwareView.show();
      ...
      },
      {
        ...
        value: function () {
          ...
          this.specialEventListener = se.addListener(module411.NotificationKeys.DidReceiveSpecialEvent, function (n) {
            ...
            o == module411.EventKeys.SegmentCustomModeDidChange && t.updateCustomCleanModeForMap();
            o == module411.EventKeys.CleanSequenceDidChange && t.updateCleanSequenceForMap();
          });
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n =
              module377.RSM.mapStatus == module377.MapStatus.None || (module377.RSM.mapStatus == module377.MapStatus.Has_WithoutSegments && this.tabIndex == module1347.TabSegment);

          if (this.state.shouldShowNoMapTipView != n) {
            var o = null;
            module377.RSM.isCleaning() || (o = module377.RSM.mapStatus == module377.MapStatus.Has_WithoutSegments ? module491.no_seg_map_tip : module491.no_map_tip);
            this.setState(
              {
      ...
      },
      {
        ...
        value: function () {
          this.state.hasGotMap ||
            ...
            (module377.RSM.hasGotMapFirstTime = !0),
            this.didGetMapFirstTime());
          var t = module1231.MM.mapRotateAngle[module377.RSM.currentMapId];
          this.mapView &&
          ...
          this.showFoamGuide || (console.log('Foam: WillCheck'), this.showFoamRemoveAlertIfNeeded(), (this.showFoamGuide = !0));
          module377.RSM.isRunning || this.showBubbleGuide || (this._onShowGuideBubble(), (this.showBubbleGuide = !0));
        },
      },
      {
        ...
        value: function () {
          ...
          (0, module383.LogEventStat)(module383.LogEventMap.MapOnReady);
          module386.default.isAnalysisSupported() && (0, module383.PluginDidReadyForStatisticsTask)();
      ...
      },
      {
        ...
        value: function (t) {
          var n = t.data;
          (ge()[n] || !1) && this.eventToast && this.eventToast.show(n);
        },
      },
      {
        key: 'getErrorView',
        value: function () {
          ...
          return (
            ...
            React.default.createElement(module1372.default, {
              funcId: 'error_' + n,
      ...
      },
      {
        ...
        value: function () {
          ...
          return this.state.hasGotMap
            ? React.default.createElement(module1799.default, {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            o = React.default.createElement(module1375.default, {
              shouldShowLine: !0,
              data: [
                {
          ...
          return React.default.createElement(
            re,
            {
              style: {
                position: 'absolute',
                top: 74 + module936.AppBarMarginTop,
                left: 0,
        ...
        value: function () {
          ...
          var t = this,
            o = React.default.createElement(module1233.MapView, {
              ...
              top: module1065.MapViewInnerTop,
              bottom: module1065.MapViewInnerBottom,
                  ...
                  function (c) {
                    for (;;)
                      switch ((c.prev = c.next)) {
                        case 0:
                          s = 'photo' == t.state.mapObstaclesPopBoxType && module1363.default.mapObjectPhotoPrivacyPolicyAgreed && module1363.default.mapObjectPhotoEnabled;
                          c.next = 3;
                          return regeneratorRuntime.default.awrap((0, module411.GetStorageKey)(module411.StorageKeys.PhotoPrivacyVersion));
                        ...
                        case 8:
                          (l = parseInt(module390.MC.photoPrivacyVersionAgreedOnServer) == module403.RRPhotoPrivacyVersion)
                            ? ((0, module383.LogEventCommon)('tap_map_object'), o && o())
                            : t.photoPrivacyDialog && t.photoPrivacyDialog.show();
                          c.next = 13;
                          break;

                        case 12:
                          s && 0 == u && !l ? t.photoPrivacyDialog && t.photoPrivacyDialog.show() : ((0, module383.LogEventCommon)('tap_map_object'), o && o());
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(module1800.default, {
            ...
            mode: module1800.ModalMapEditMenuMode.Home,
            onClose: function () {
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module1804.default, {
            ref: function (n) {
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module1371.default, {
              ref: function (n) {
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module1803.MonitorPrivacyModalDialog, {
            ref: function (n) {
            ...
            onConfirm: function () {
              (0, module383.LogEventCommon)('monitor_privacy_dialog_confirm');
              module1363.default.updateMonitorPrivacy(!0, function (o) {
                return regeneratorRuntime.default.async(
                  function (s) {
                    for (;;)
                      switch ((s.prev = s.next)) {
                        case 0:
                          ...
                          return regeneratorRuntime.default.awrap(
                            (0, module411.SetStorageKey)(module411.StorageKeys.MonitorPrivacyVersion, module411.StorageKeys.MonitorPrivacyVersion)
                          );
            ...
            onCancel: function () {
              (0, module383.LogEventCommon)('monitor_privacy_dialog_cancel');
            },
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module1807.PhotoFeaturePrivacyDialog, {
            ref: function (n) {
            ...
            onConfirm: function () {
              return module1363.default.updatePhotoPrivacy(!0, function (n) {
                !n && globals.showToast(module491.robot_communication_exception);
                n && (0, module411.SetStorageKey)(module411.StorageKeys.PhotoPrivacyVersion, module411.StorageKeys.PhotoPrivacyVersion);
            ...
            onCancel: function () {
              ...
              module389
                ...
                .then(function (t) {})
                .catch(function (t) {});
              module1363.default.updatePhotoPrivacy(!1, function (n) {
                !n && globals.showToast(module491.robot_communication_exception);
      ...
      },
      {
        ...
        get: function () {
          var t,
            n,
            o = this,
            s = null == (t = module377.RSM.specialInfo) ? void 0 : t.text;

          switch (null == (n = module377.RSM.specialInfo) ? void 0 : n.actionStyle) {
      ...
      },
      {
        ...
        value: function () {
          ...
          var n = this.context.theme,
            o =
              module387.default.iOSAndroidReturn(44 + module936.StatusBarHeight + module936.AppBarMarginTop, (module12.StatusBar.currentHeight || 0) + 44) +
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(module1808.default, {
                  ...
                  parent: this,
                  bgImage: n.guideImages.foamRemove,
                  topTitle: module491.foam_remove_title,
                  context: module491.foam_remove_content,
                  buttonInfo: [module491.localization_strings_Setting_RemoteControlPage_51],
                  buttonFuncId: ['foam_remove_confirm'],
                  onPressSingleButton: function () {
                    t.foamRemoveAlert.dismissModalView();
                  },
                })
              )
            )
          ...
          return regeneratorRuntime.default.async(
            function (u) {
              for (;;)
                switch ((u.prev = u.next)) {
                  case 0:
                    if (((this.tabIndex = t), this.checkMapStatus(), !module415.DMM.isGarnet || 4 != module377.RSM.mopModeId || t != module1347.TabGlobal)) {
                      u.next = 6;
                      break;
                    }

                    u.next = 5;
                    return regeneratorRuntime.default.awrap(module407.default.setCustomMopById(null == (o = module1354.ModeDataInstance.modePannelCustomMops[0]) ? void 0 : o.id));

                  case 5:
                    null == (s = this.customModeView) || s.modeTabDidChange(0);
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    o.next = 4;
                    return regeneratorRuntime.default.awrap((0, module411.SetStorageKey)(module411.StorageKeys.MapDebugInfoVisible, t ? 'visible' : ''));
            ...
            function (h) {
              for (;;)
                switch ((h.prev = h.next)) {
                  ...
                  case 3:
                    if (module1363.default.realTimeMonitorEnabled) {
                      h.next = 6;
                      break;
                    }
                    ...
                    this.alert &&
                      this.alert.customAlert(
                        ...
                        function () {
                          (0, module383.LogEventCommon)('open_real_time_video_alert_confirm');
                          c.navigateTo('CameraSettingDetail', {
                            mode: 2,
                          });
                        },
                        function () {
                          (0, module383.LogEventCommon)('open_real_time_video_alert_cancel');
                        },
                        {
                  ...
                  case 6:
                    -1 == parseInt(module390.MC.MonitorPrivacyVersionAgreedOnServer) && this.getMonitorPrivacyVersionAgreedVersionOnServer();
                    t = parseInt(module390.MC.MonitorPrivacyVersionAgreedOnServer) == module403.RRMonitorPrivacyVersion;
                    h.next = 10;
                    return regeneratorRuntime.default.awrap((0, module411.GetStorageKey)(module411.StorageKeys.MonitorPrivacyVersion));

                  case 10:
                    if (((o = h.sent), (s = !!o || t), (module1363.default.monitorPrivacyPolicyAgreed && s) || !module1363.default.hasGot)) {
                      h.next = 15;
                      break;
                    }
                  ...
                  case 15:
                    h.next = 18;
                    return regeneratorRuntime.default.awrap((0, module411.GetStorageKey)(module411.StorageKeys.HasSetInitialGesturePassword));
                  ...
                  case 18:
                                ...
                                for (;;)
                                  switch ((t.prev = t.next)) {
                                    case 0:
                                      ...
                                      t.next = 3;
                                      return regeneratorRuntime.default.awrap(
                                        (0, module411.SetStorageKey)(module411.StorageKeys.HasSetInitialGesturePassword, module411.StorageKeys.HasSetInitialGesturePassword)
                                      );
                    ...
                    (function () {
                      module377.RSM.secPasswordEnabled
                        ? l(1)
                        : u
                        ? c.navigateTo('MonitorPage', {
                            enabledTitleBarUpdate: function () {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = this;
          n.shareView &&
            (n.shareView.capture(module1231.MM.mapData, function (o, s) {
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  ...
                  case 3:
                    ...
                    t.RRVAlertPopTimes ? (module390.MC.RemoteViewingAlertAgreedTimesOnServer = t.RRVAlertPopTimes) : (module390.MC.RemoteViewingAlertAgreedTimesOnServer = 0);
                    module409.Log.log(
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (module377.RSM.state != module377.RobotState.UPDATING && !module1363.default.hasShownPetModeAlert && module386.default.isSupportPetModeAlert()) {
            var o = function () {
              setTimeout(function () {
                module409.Log.log(module409.LogTypes.Home, 'begin update pet status,' + JSON.stringify(module1363.default), module409.InfoColors.Normal, !0);
                n.alert &&
                  n.alert.customAlert(
                    module491.if_has_pet_tip_title,
                    module491.if_has_pet_tip_detail,
                    function () {
                      module1363.default.updatePetModeEnabled(!0);
                      t && t();
                    },
                    function () {
                      module1363.default.updatePetModeEnabled(!1);
                      t && t();
                    },
                    {
            ...
            if (module1363.default.cameraEnabled) o();
            else {
              ...
              this.alert &&
                this.alert.customAlert(
                  ...
                  function () {
                    module409.Log.log(module409.LogTypes.Home, 'begin update RRAI status,' + JSON.stringify(module1363.default), module409.InfoColors.Normal, !0);
                    module1363.default.updateRRAI(!0, function (t) {
                      module409.Log.log(module409.LogTypes.Home, 'success update RRAI status,' + JSON.stringify(module1363.default), module409.InfoColors.Success, !0);
                      t && o();
                    });
                  },
                  function () {
            ...
            function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  ...
                  case 2:
                    if (
                      (this.mapView && this.mapView.setAllCleanMopMode(module1231.MM.customCleanModes),
                    ...
                    t.next = 7;
                    return regeneratorRuntime.default.awrap(module1231.MM.getMultiMaps());
            ...
            function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  ...
                  case 2:
                    this.mapView && this.mapView.setCleanSequence(module1231.MM.cleanSequence.concat(), !1);
      ...
      },
      {
        ...
        value: function () {
          ...
          this.modalMapEditMenu && this.modalMapEditMenu.show();
        },
      },
      {
        ...
        value: function () {
          ...
          null == (n = this.customModeView) || n.show();
        },
      },
      {
              ...
              for (;;)
                switch ((u.prev = u.next)) {
                  ...
                  case 12:
                    ...
                    this.sidebarMenu && this.sidebarMenu.updateModeIcon(t, o, module377.RSM.mopMode);
                    s && this.customModeView && this.customModeView.hide();
                  ...
                  case 20:
                    u.prev = 20;
                    u.t0 = u.catch(0);
                    this.customModeView && this.customModeView.showToast(module491.robot_communication_exception);
      ...
      },
      {
        ...
        value: function () {
          ...
          module377.RSM.isRunning
            ? (0, module1261.showFinishCurrentTastAlertIfNeeded)().catch(function (t) {
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    ...
                    this.checkMapStatus();
                    t.next = 4;
                    return regeneratorRuntime.default.awrap(module1231.MM.getMap(!0));

                  case 4:
                    t.next = 6;
                    return regeneratorRuntime.default.awrap(module1231.MM.updateRoomNameMapping());
      ...
      },
      {
        ...
        value: function () {
          var t = this.tabIndex == module1347.TabSegment,
            n = this.tabIndex == module1347.TabGlobal,
          ...
          if (o) {
            ...
            u = t
              ? s
                ? module1233.MapModelInCleanMode.Segment_Clean_Read_Only_With_Clean_Type
                : module1233.MapModelInCleanMode.Segment_Clean_Edit_With_Clean_Type
              : module1233.MapModelInCleanMode.Global_Clean_With_Clean_Type;
            this.mapView && this.mapView.changeMapViewMode(u);
            o && this.mapView && this.mapView.setAllCleanMopMode(module1231.MM.customCleanModes);
          } else {
            n && this.mapView && this.mapView.changeMapViewMode(module1233.MapModelInCleanMode.Global_Clean);
            t && this.mapView && this.mapView.changeMapViewMode(s ? module1233.MapModelInCleanMode.Segment_Clean_Read_Only : module1233.MapModelInCleanMode.Segment_Clean_Edit);
          }
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          module377.RSM.mapStatus != module377.MapStatus.None
            ? (this.mapView && this.mapView.enterZoneEditMode(), this.mapView && !this.mapView.addRectangle() && globals.showToast(module491.rubys_main_zone_max_tips))
            : globals.showToast(module491.tap_zone_clean_button_without_map_tip);
        },
      },
      {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          n = module377.RSM.hasCustomMode()
            ? 1 == t
              ? module1233.MapModelInCleanMode.Segment_Clean_Sequential_Edit_With_Clean_Type
              : module1233.MapModelInCleanMode.Segment_Clean_Edit_With_Clean_Type
            : 1 == t
            ? module1233.MapModelInCleanMode.Segment_Clean_Sequential_Edit
            : module1233.MapModelInCleanMode.Segment_Clean_Edit;
          this.mapView && this.mapView.changeMapViewMode(n);
        },
      },
      {
        ...
        value: function (t, n) {
          var o = this,
            s = module1363.default.mapObjectPhotoEnabled;
          (0, module383.LogEventCommon)('tap_map_object_bubble', {
            photoEnabled: s,
          });
      ...
      },
      {
        ...
        value: function () {
          this.newSwitchGuideView && this.newSwitchGuideView.dismissModalView();
          this.customModeView && this.customModeView.hide();
          this.navigateTo('MapEditZoneModePage', {
            parent: this,
            action: 'custom',
            title: module491.map_edit_bottom_menu_mode,
      ...
      },
      {
        ...
        value: function () {
          module377.RSM.errorCode > 0 && this.onOpenErrorDetailPage('', module377.RSM.errorCode);
        },
      },
      {
            ...
            function (l) {
              for (;;)
                switch ((l.prev = l.next)) {
                  ...
                  case 2:
                    l.next = 4;
                    return regeneratorRuntime.default.awrap((0, module411.GetStorageKey)(module411.StorageKeys.DockGuide));
                  ...
                  case 10:
                    module4 = module1810.default.sharedManager().dockSetSNPrefixes;
                    (function () {
                      var t = !1;
                    ...
                    null == (t = this.dockDetectedGuideView0) || t.show();
                    l.next = 16;
                    return regeneratorRuntime.default.awrap((0, module411.SetStorageKey)(module411.StorageKeys.DockGuide, module411.StorageKeys.DockGuide));
              ...
              for (;;)
                switch ((u.prev = u.next)) {
                  case 0:
                    ...
                    u.next = 3;
                    return regeneratorRuntime.default.awrap((0, module411.GetStorageKey)(t));
                  ...
                  case 3:
                    ...
                    u.next = 8;
                    return regeneratorRuntime.default.awrap((0, module411.SetStorageKey)(t, t));

                  case 8:
                    module1249.setTimeout(function () {
                      s.newSwitchGuideView && s.newSwitchGuideView.show();
                    }, 50);
            ...
            function (l) {
              for (;;)
                switch ((l.prev = l.next)) {
                  ...
                  case 3:
                    if (((o = l.sent), !module1231.MM.hasCarpetMap)) {
                      l.next = 11;
                      break;
                    }
                  ...
                  case 9:
                    module1249.setTimeout(function () {
                      u.mapView && u.mapView.findCarpetAndShowGuide();
                    }, 50);
                    return l.abrupt('return');
                  ...
                  case 11:
                    ...
                    if (!(!module1231.MM.hasCarpetMap || (module1231.MM.hasCarpetMap && o))) {
                      l.next = 23;
                      break;
                    }
                    ...
                    l.next = 16;
                    return regeneratorRuntime.default.awrap((0, module411.GetStorageKey)(module4));
                  ...
                  case 16:
                    ...
                    l.next = 21;
                    return regeneratorRuntime.default.awrap((0, module411.SetStorageKey)(module4, module4));

                  case 21:
                    module1249.setTimeout(function () {
                      u.mapView && u.mapView.showChargerBubble();
                    }, 50);
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module1249.setTimeout(function () {
            t.newSwitchGuideView && t.newSwitchGuideView.show();
          }, 50);
        },
      },
      {
            ...
            function (o) {
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    o.next = 2;
                    return regeneratorRuntime.default.awrap((0, module411.GetStorageKey)(module411.StorageKeys.HasShownMapObjectPhotoReminder));
                  ...
                  case 2:
                    if (
                      ...
                      !(
                        ...
                        !module1363.default.mapObjectPhotoEnabled &&
                        !t &&
                        this.mapView &&
                    ...
                    o.next = 7;
                    return regeneratorRuntime.default.awrap((0, module411.SetStorageKey)(module411.StorageKeys.HasShownMapObjectPhotoReminder, 'true'));
            ...
            function (o) {
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    o.next = 2;
                    return regeneratorRuntime.default.awrap((0, module411.GetStorageKey)(module411.StorageKeys.AreaUnitIndex));
...
var be = ie.create({
  ...
  videoButton: {
    position: 'absolute',
    top: 156 + (module12.StatusBar.currentHeight || 0) + module936.AppBarMarginTop,
    right: 10,
    width: 60,
    height: 60,
  },
