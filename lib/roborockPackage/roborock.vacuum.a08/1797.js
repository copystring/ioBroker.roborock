...
var module491 = require('./491').strings,
  ...
  w = (function (t) {
    ...
    function M(t) {
      ...
      o.tip = _[Math.floor(Math.random() * _.length)];
      return o;
    }
    ...
    module5.default(M, [
      ...
      },
      {
        key: 'render',
        value: function () {
          var t = 'cn' == module491.getResourceLanguageCode() && this.props.shouldShowTip ? this.tip : module491.map_loading_view_tip;
          if (this.state.isOvertimed) t = module491.load_map_overime_tip;
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              this.props.isLocating ? module491.map_locating : this.props.isWarmUp ? module491.robot_is_warm_up_tip : t
            )
          );
        },
      },
