...
exports.default = function (t, n) {
  return function (f, p) {
    var O = f.state,
      l = O;
    module944.default(l.routeName && 'string' == typeof l.routeName, 'Cannot get config because the route does not have a routeName.');
    var b = module995.default(t, l.routeName),
      v = t[l.routeName],
