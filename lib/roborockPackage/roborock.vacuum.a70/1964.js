...
var module510 = require('./510').strings,
  ...
  Z = (function (t) {
    ...
    function Z(t) {
      ...
      n.originalRepeatMode = o.repeatMode || module1638.RepeatMode.Once;
      ...
      n.state = {
        ...
        repeatMode: o.repeatMode || module1638.RepeatMode.Once,
        ...
        currentCleanMethod: undefined == o.cleanMethod ? module1619.CleanMethodMop : o.cleanMethod,
    ...
    module7.default(Z, [
      ...
      },
      {
        ...
        value: function () {
          ...
          if (this.state.currentCleanMethod == module1619.CleanMethodClean && 301 == o) o = 300;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (4 == t) {
            ...
            this.hideModalView(function () {
              n.setState({
                repeatMode: module1638.IndexRepeatMap[t],
                shouldShowFrequenceView: false,
              });
            });
        },
      ...
      },
      {
        ...
        value: function () {
          ...
          if (this.state.hasSetTime) {
            var n = module1638.timerRepeatToCronRepeat(this.state.repeatMode),
              s = -1,
              l = -1;

            if (this.state.repeatMode == module1638.RepeatMode.Once) {
              var u = new Date(),
                h = u.getHours() == this.state.hour && u.getMinutes() == this.state.minute,
                c = module1635.default();
            ...
            if (this.isRepeatTimer(l, s)) globals.showToast(module510.set_timer_dup);
              ...
              var M = module1637.ConvertToCronStr(this.state.hour, this.state.minute, n, l, s);

              if (module393.isMiApp && 1 == this.FCCState) {
                var S = module1638.convertToBeijingTime(this.state.minute, this.state.hour, l, s),
                  w = this.state.repeatMode;

                if (this.state.repeatMode != module1638.RepeatMode.Once && this.state.repeatMode != module1638.RepeatMode.Everyday) {
                  var _ = new Date();

                  if (S.month == _.getMonth() + 1)
                    S.day == _.getDate() + 1
                      ? (w = module1638.getDaysArrByOffset(this.state.repeatMode, 1))
                      : S.day == _.getDate() - 1 && (w = module1638.getDaysArrByOffset(this.state.repeatMode, -1));
                  else w = 1 == S.day ? module1638.getDaysArrByOffset(this.state.repeatMode, 1) : module1638.getDaysArrByOffset(this.state.repeatMode, -1);
                }

                n = module1638.timerRepeatToCronRepeat(w);
                M = module1637.ConvertToCronStr(S.hour, S.minute, n, S.day, S.month);
              }
      ...
      },
      {
        ...
        value: function (t, n, s, l) {
          var u, h, c, p, f, M, S, w, _, C, module1635, module394, module382, module415, module1966, module1118;
              ...
              for (;;)
                switch ((R.prev = R.next)) {
                  ...
                  case 31:
                    ...
                    module394 = module1638.convertToTargetTime(this.state.minute, this.state.hour, s, l, module393.robotTimeZone);
                    module382 = module394.hour + ':' + module1638.addZeroPrefix(module394.minute);
                    module415 = module1638.getLoopStringOfRepeatMode(this.state.repeatMode);
                    module1966 = new Date();
                    module1118 = module1638.resolveRepeatModeByTargetTime(module415, module1966.getMonth() + 1, module1966.getDate(), module394.month, module394.day);
                    console.log('loops -- time - ' + module382 + ' - loop -' + module1118 + ' -repeat-' + this.state.repeatMode + ' - timerId- ' + this.timerId);
                    R.next = 40;
                    return regeneratorRuntime.default.awrap(module393.rrAddOrEditTimer(module382, module1118, module1635, this.timerId));
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module1967.default, {
              ref: function (n) {
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(module385.SettingListItemView, {
                  ...
                  bottomDetail: module1638.getTextOfRepeatMode(this.state.repeatMode, this.date),
              ...
              l &&
                !u &&
                React.default.createElement(module1965.default, {
              ...
              u &&
                ...
                React.default.createElement(module1966.default, {
                  style: K.mapSegmentSettingView,
                  ref: function (n) {
                    t.mapSegmentSettingView = n;
                  },
      ...
      },
      {
        ...
        value: function () {
          return this.state.currentCleanMethod == module1619.CleanMethodNoSet ? module510.timer_setting_no_setting : module1619.getCleanMethods()[this.state.currentCleanMethod];
        },
      },
      {
        ...
        value: function () {
          ...
          if (module390.default.isPureCleanMopSupported()) {
            ...
            if (this.state.mode == module1618.CleanModeZero) return n + ' | ' + s;
            if (this.state.waterMode == module1618.WaterModeZero) return t;
          }
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = module1638.RepeatIndexMap[this.state.repeatMode];
          if (undefined == n) n = 4;
          return React.default.createElement(
            module13.View,
            {
            ...
            React.default.createElement(module1502.ActionSheetView, {
              title: module510.localization_strings_Setting_Timer_SettingPage_1,
              actions: module1638.RepeatMenuItems(),
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = module1638.isCustomMode(this.state.repeatMode) ? [0, 0, 0, 0, 0, 0, 0] : this.state.repeatMode.split('');
          return React.default.createElement(module1968, {
            selectedItems: n,
            cancel: function (n) {
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module1502.ActionSheetView, {
            title: module510.timer_setting_clean_method,
            actions: module1619.getCleanMethods(),
            didSelectRow: function (n) {
      ...
      },
      {
        ...
        value: function () {
          return this.state.hasSetTime || this.editMode
            ? module1638.addZeroPrefix(this.state.hour) + ' : ' + module1638.addZeroPrefix(this.state.minute)
      ...
      },
      {
        key: 'isRepeatTimer',
        value: function (t, n) {
          for (var o = module1638.convetToWeekendsByStartTime(this.state.repeatMode, t, n), s = 0; s < this.timerList.length; s++) {
            ...
            if (!this.editMode || l.hour != this.originalHour || l.minute != this.originalMinute || JSON.stringify(u) !== JSON.stringify(this.originStartWeekdays)) {
              ...
              if (l.repeatMode == module1638.RepeatMode.Once && l.hour == this.state.hour && l.minute == this.state.minute) return true;
            }
          }
      ...
      },
      {
        ...
        value: function () {
          ...
          if (t == module1618.CleanRouteFastMode) t = module1618.CleanRouteDailyMode;
          return t;
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          if (module424.DMM.isGarnet)
            this.state.currentCleanMethod != module1619.CleanMethodNoSet || this.editMode ? this.confirmButton.setEnabled(true) : this.confirmButton.setEnabled(false);
...
var K = module13.StyleSheet.create({
  ...
  modal: {
    ...
    borderRadius: module1337.AppBorderRadius,
    alignItems: 'stretch',
  },
  upperView: {
    justifyContent: 'center',
