      ...
      [
            ...
            for (var n, o = O(this.dataInstMap); !(n = o()).done; ) {
              ...
              if (p && -1 != p.snapShot)
                if (3 === c) {
                  ...
                  var M = module1118.MapDyTypeMap.get(c);
        ...
        },
        {
          ...
          value: function (t) {
            ...
            t.nonceData.data.forEach(function (o) {
              ...
              if (35 != l) {
                var p = module1118.MapDyTypeMap.get(l);

                if (p && !(p.length < 2)) {
                  if (!n.dataInstMap.has(l)) {
                    var f = p[p.length - 1];
                    n.dataInstMap.set(l, new module1481.MapDataConfig(l, f));
                  }
            ...
            if (((this.mapNonce = n), t)) {
              ...
              if (!(s.length <= 0))
                s.forEach(function (n) {
                  n = parseInt(n);
                  if (!o.dataInstMap.has(n)) o.dataInstMap.set(n, new module1481.MapDataConfig(n));
            ...
            o.forEach(function (o) {
              ...
              if (u && t[o]) {
                if (3 === o && t[o].data && undefined !== t[o].start && t[o].len)
                  n._parseMapDynamicData(t[o], o) == module1481.updateRes.hasUpdate && n._updateMapDataDynamic(n.mapData, o);
                var l = u.dealDiff(t[o]);
                if (l == module1481.diffRes.getDiff) n.getMapDataDynamic(u.toJSONString, o);
                else if (l == module1481.diffRes.resetDiff) n._updateMapDataDynamic(n.mapData, o);
                else if (l == module1481.diffRes.getMap) s = true;
              }
            });
          ...
          value: function (t, n) {
            ...
            if (null == o ? undefined : o.data)
              if (3 === n) {
                ...
                var s = module1118.MapDyTypeMap.get(n);
                ...
                for (;;)
                  switch ((v.prev = v.next)) {
                    ...
                    case 10:
                      ...
                      if (u)
                        (c = this._parseMapDynamicData(u, u.data_id)) == module1481.updateRes.hasUpdate || (c == module1481.updateRes.reUpdate && !o)
                          ? this._updateMapDataDynamic(this.mapData, n)
                          : c == module1481.updateRes.reUpdate && o && (p = this.dataInstMap.get(u.data_id)) && this.getMapDataDynamic(p.toJSONString, n, false);
                      v.next = 18;
                      break;
        ...
        },
        {
          ...
          value: function (t, n) {
            ...
            if (!module395.default.validate_single_payload(o)) return module1481.updateRes.noUpdate;
            var s,
              u,
              l = module1479.parseDynamicData(o);
            if (!l) return module1481.updateRes.noUpdate;
            if (undefined !== l.floorMap)
              l.floorMap = this._generateFloorMap(null == (s = z.mapData) ? undefined : s.map, l.floorMap, null == (u = z.mapData.floorMap) ? undefined : u.direction);
            var c = this.dataInstMap.get(n);
            return c ? c.updateData(t, l) : module1481.updateRes.noUpdate;
          },
        },
        {
          ...
          value: function (t, n, o) {
            ...
            var s = {
              ...
              u = module1476.convertFloorDataToImage(n.data, s, t.data, o);
            return {
              data: n.data,
              image: u,
        ...
        },
        {
          ...
          value: function (t) {
            for (var n, o, s = null == (n = this.mapData) ? undefined : null == (o = n.map) ? undefined : o.centerInfo, u = {}, l = Object.keys(t), c = 0; c < l.length; c++) {
              var p = t[l[c]];
              if (-1 != p.indexOf(module1118.FurnitureType.FT_BED)) u[l[c]] = 1;
              else if (-1 != p.indexOf(module1118.FurnitureType.FT_SOFA) || -1 != p.indexOf(module1118.FurnitureType.FT_TVCABINET)) u[l[c]] = 6;
              else if (-1 != p.indexOf(module1118.FurnitureType.FT_DINNERTABLE)) u[l[c]] = 13;
              else if (-1 != p.indexOf(module1118.FurnitureType.FT_TOILET) && s && s[l[c]] && 0.05 * s[l[c]].count * 0.05 < 6) u[l[c]] = 15;
            }
              ...
              function (O) {
                for (;;)
                  switch ((O.prev = O.next)) {
                    ...
                    case 22:
                      if ((R = null == (N = module1118.RoomTagInfo[b]) ? undefined : N.name)) {
                        O.next = 25;
                        break;
                      }
        ...
        },
        {
          ...
          value: function () {
            ...
            c.map(function (t) {
              if (t.length >= 12 && 0 == t[11] && t[9] != module1118.FurnitureType.FT_TOILET) l++;
            });
            return l;
          },
        },
