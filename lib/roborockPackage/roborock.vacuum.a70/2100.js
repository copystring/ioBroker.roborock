    ...
    function k(t) {
      ...
      n.eidtCountChange = function (t) {
        if (module393.isMiApp) {
          var u = module1120.MAX_FURNITURE_EDIT_MIAPP - t;
      ...
      n.state = {
        ...
        hasEditedMap: false,
        editCount: module1120.MAX_FURNITURE_EDIT_MIAPP,
        showDragItem: false,
        dragItemType: module1120.FurnitureType.FT_BED,
        dragItemSize: {
          x: 0,
          y: 0,
          width: 0,
    ...
    module7.default(k, [
      {
        ...
        value: function () {
          ...
          var n = this.props.navigation.getParam('initAction', module1192.EditAction.None);
          this.onlyFurniture = n == module1192.EditAction.Furniture;
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            u = module1343.default.confirmButton(this.onNavigationSavePress, n, function (n) {
              t.mapSaveButton = n;
            });
          module1343.default.setNavigation(this, [u], this.onNavigationBackPress);
        },
      },
      {
        key: 'registListeners',
      ...
      },
      {
        ...
        value: function () {
          ...
          for (var u = [], s = 0; s < n.length; s++) {
            ...
            if (!(l < module1120.FurnitureType.FT_TVCABINET || l > module1120.FurnitureType.FT_DINNERTABLE)) {
              var p = o[0] / 50,
                c = o[4] / 50,
                h = o[1] / 50,
                f = o[5] / 50;
      ...
      },
      {
        ...
        value: function (t) {
          var n = module1120.FurnitureResource[(t >> 8) & 255];
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = React.default.createElement(module1119.MapView, {
              ref: function (n) {
                t.mapView = n;
              },
              parent: this,
              ...
              bottom: module1343.MapEditCommonStyles.mapBottom + 100,
              hideAccessory: true,
              mapMode: module1337.MAP_MODE_FURNITURE_EDIT,
              showFurnitureOnly: true,
              editAction: module1192.EditAction.Furniture,
              zonesHasEdited: this.state.hasEditedMap,
              eidtCountChange: this.eidtCountChange,
            });
          return this.state.mapStatus == module381.MapStatus.None ? module1343.default.getNoMapTipView(this.state.mapStatus) : n;
        },
      },
      {
        key: 'getDragFurniture',
        value: function () {
          return React.default.createElement(module1204.Furniture, {
            id: 0,
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = [];
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_BED][module1120.BedSubType.BST_DOUBLE]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_BED][module1120.BedSubType.BST_SINGLE]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_TVCABINET]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_SOFA][module1120.SofaSubType.SST_THREE]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_SOFA][module1120.SofaSubType.SST_DOUBLE]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_SOFA][module1120.SofaSubType.SST_SINGLE]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_SOFA][module1120.SofaSubType.SST_SECTIONAL]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_SOFA][module1120.SofaSubType.SST_SECTIONAL_LEFT]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_DINNERTABLE]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_TEATABLE][module1120.TableSubType.TST_RECT]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_TEATABLE][module1120.TableSubType.TST_CIRCLE]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_SHOECABINET]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_WARDROBE]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_NIGHTSTAND]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_OPENCATTOILET]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_CATTOILET]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_PETCAGE]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_PETWATERLOO]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_PETBOWL]);
          n.push(module1120.FurnitureResource[module1120.FurnitureType.FT_FLOORMIRROR]);
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = this.state.mapStatus == module381.MapStatus.None || this.state.mapStatus == module381.MapStatus.Has_WithoutSegments,
            u = n ? module1343.default.getNoMapTipView(this.state.mapStatus) : this.getMapView(),
            s = this.getFurnitureEditPanel(),
            o = this.getDragFurniture(),
            l = React.default.createElement(module385.PureImageButton, {
              style: module1343.MapEditCommonStyles.refreshMapSegmentIndicator,
            ...
            p =
              ...
              module510.map_edit_furniture_count_tip_miapp.templateStringWithParams({
                max: module1120.MAX_FURNITURE_EDIT_MIAPP,
