...
var C = (function (t) {
  ...
  function C(t) {
    ...
    n.list = [];
    n.state = {
      taskListState: module1962.TaskListState.Normal,
      editingTaskIndex: null,
      tasks: [],
      cleanOnMap: {
        flag: module381.RSM.currentMapId,
        name: -1 == module381.RSM.currentMapId ? module1962.LocalizationStrings.no_seg_map_tip : module415.MM.getCurrentMapName(),
      },
    ...
    n.mapDataProvider = new module1341.MultiMapDataProvider();
    n.initData();
    return n;
  }
  ...
  module7.default(C, [
    ...
    },
    {
      ...
      value: function () {
        var t, n, o;
        if (this.state.taskListState == module1962.TaskListState.Editing && 0 == this.tasksFromListRefs.length) {
      ...
      value: function () {
        ...
        return React.default.createElement(
          ...
          React.default.createElement(
            ...
            u &&
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  module1962.LocalizationStrings.multi_map_select_map_title
                ),
                React.default.createElement(module2147.default, {
                  name: l.state.cleanOnMap.name,
                  type: module1962.TaskListItemType.Location,
                  onPress: l.onPressCleanLocationItem.bind(l),
                })
              ),
            ((n =
              l.state.tasks.length < module1962.MaxTaskCountPerCommand
                ? React.default.createElement(module2147.default, {
                    type: module1962.TaskListItemType.TaskAdd,
                    name: module1962.LocalizationStrings.smart_scene_add_task,
              ...
              null == (t = l.templateData)
                ...
                : t.map(function (t) {
                    ...
                    return l.state.tasks.find(function (n) {
                      ...
                      ? React.default.createElement(React.default.Fragment, null)
                      : React.default.createElement(module2147.default, {
                          type: module1962.TaskListItemType.AddingTemplate,
                          name: null != (n = t.name) ? n : module1962.LocalizationStrings.smart_scene_add_task,
                          onPressAdd: function () {
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    module1962.LocalizationStrings.smart_scene_task_list_title
                  ),
                  !(0 == l.state.tasks.length && l.state.taskListState == module1962.TaskListState.Normal) &&
                    React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  module1962.LocalizationStrings.smart_scene_edit_command_list_subtitle
                )
              ),
              (function () {
                var t = {
                ...
                switch (l.state.taskListState) {
                  case module1962.TaskListState.Normal:
                    return React.default.createElement(
                      React.default.Fragment,
                      null,
                  ...
                  case module1962.TaskListState.Adding:
                    return React.default.createElement(
                      React.default.Fragment,
                      null,
                  ...
                  case module1962.TaskListState.AddingTemplate:
                    return React.default.createElement(
                      React.default.Fragment,
                      null,
                      l.state.tasks.map(function (n, s) {
                  ...
                  case module1962.TaskListState.Editing:
                    return React.default.createElement(
                      React.default.Fragment,
                      null,
                      l.state.tasks.map(function (t, n) {
            ...
            React.default.createElement(module1118.MultiMapSelectView, {
    ...
    },
    {
      ...
      value: function () {
        var t = this,
          n = function () {
            var n;
            if (t.isContainInvalidTask) globals.showToast(module1962.LocalizationStrings.invalid_task_detected_hint);
            else {
              var o,
                s = function () {
        ...
        if (this.state.taskListState == module1962.TaskListState.Editing)
          this.setState(
            {
        ...
        if (!(null == (n = this.mapSelectView)))
          n.hide(function () {
            var n = function () {
              ...
              if (
                ...
                if (o.state.tasks.length > 0)
                  globals.Alert.alert('', module1962.LocalizationStrings.smart_scene_edit_switch_map_warning_title, [
                    {
                      text: module1962.LocalizationStrings.localization_strings_Main_MainPage_11,
                      onPress: function () {
                        o.setState({
                          cleanOnMap: n,
                        });
                    ...
                    {
                      text: module1962.LocalizationStrings.localization_strings_Main_Error_ErrorDetailPage_3,
                      onPress: function () {
                        o.startLoading();
                        s()
                          .then(function () {
                            globals.showToast(module1962.LocalizationStrings.map_reset_page_operate_success);
                            o.setState({
                              tasks: [],
                              taskListState: module1962.TaskListState.Normal,
                            });
                          ...
                          .catch(function (t) {
                            globals.showToast(module1962.LocalizationStrings.robot_communication_exception);
                            o.setState({
                              cleanOnMap: n,
                            });
                          })
            ...
            if (-1 == module381.RSM.currentMapId && module381.RSM.mapStatus != module381.MapStatus.None) {
              ...
              globals.Alert.alert(module1962.LocalizationStrings.delete_new_map_if_switch_map_hint, '', [s, l]);
            } else n();
          });
      },
    },
    {
      ...
      value: function () {
        var t = this;
        module1962.SmartSceneLog('\u6dfb\u52a0\u4efb\u52a1');
        this.setState(
          {
            taskListState: module1962.TaskListState.Adding,
            editingTaskIndex: -1,
          },
          function () {
            setTimeout(function () {
    ...
    },
    {
      ...
      value: function () {
        switch (this.state.taskListState) {
          ...
          case module1962.TaskListState.Normal:
            this.setState({
              taskListState: module1962.TaskListState.Editing,
            });
        }
      },
    },
    {
      ...
      value: function (t) {
        this.setState({
          taskListState: module1962.TaskListState.AddingTemplate,
          editingTaskIndex: -1,
          editingTemplate: t,
        });
      },
      ...
      value: function (t, n, o, s) {
        ...
        var p =
            ...
            (l =
              ...
              ? l
              : 0,
          S = t.mode == module1963.SmartSceneMode.Segment ? this.segmentTaskName(t.segments, o) : null,
          h = {
            name: S || t.name,
            customMode: t.customMode,
            type: module1962.TaskListItemType.Task,
            mode: t.mode,
            repeat: t.repeat,
            zones: t.zones,
            segments: t.segments,
        ...
        this.startLoading();
        module1962.SmartSceneLog('\u5411\u8bbe\u5907\u53d1\u9001\u8bf7\u6c42 - \u6dfb\u52a0\u4efb\u52a1 - ' + t.mode);
        this.syncTaskToRobot(t)
          .then(function (t) {
            h.tid = t.tid;
            h.zones = t.zones;
            module1962.SmartSceneLog('\u5411\u8bbe\u5907\u53d1\u9001\u8bf7\u6c42 - \u6dfb\u52a0\u4efb\u52a1\u6210\u529f. ' + JSON.stringify(h));
            f.setState({
          ...
          .catch(function (t) {
            ...
            if (-10007 == (null == t ? undefined : null == (n = t.data) ? undefined : null == (o = n.error) ? undefined : o.code))
              globals.showToast(module1962.LocalizationStrings.smart_scene_firmware_zone_reach_max_count);
            else if (-10003 == (null == t ? undefined : null == (l = t.data) ? undefined : null == (u = l.error) ? undefined : u.code))
              globals.showToast(module1962.LocalizationStrings.toast_frequently_operate);
            else if (
              'err.network' == (null == t ? undefined : null == (c = t.data) ? undefined : c.error) ||
              'timeout' == (null == t ? undefined : null == (f = t.data) ? undefined : f.error)
            )
              globals.showToast(module1962.LocalizationStrings.localization_strings_Setting_History_index_1);
            else globals.showToast(module1962.LocalizationStrings.map_object_ignore_failed + ' (Device)');
            if (!(null == s)) s(false);
            module1962.SmartSceneLog('\u5411\u8bbe\u5907\u53d1\u9001\u8bf7\u6c42 - \u6dfb\u52a0\u4efb\u52a1\u5931\u8d25. ' + JSON.stringify(t));
          })
          .finally(function () {
            f.endLoading();
          });
    ...
    },
    {
      ...
      value: function (t, n, o, s) {
        ...
        var S = t.isInvalid
          ...
          h = t.mode == module1963.SmartSceneMode.Segment ? this.segmentTaskName(t.segments, o) : '';
        if (t.mode != module1963.SmartSceneMode.Segment) t.name = module1962.taskNameWithMode(t.mode);
        var v = I(
          I(
            {
              name: h || t.name,
    ...
    },
    {
      ...
      value: function () {
        ...
        module1962.SmartSceneLog('\u63a5\u6536\u5230\u9875\u9762\u53c2\u6570: data: ' + this.data + ', templates: ' + this.templates);
      },
    },
    {
      key: 'loadData',
    ...
    },
    {
      ...
      value: function (t, n) {
        var o,
          s,
          l = this;
        module1962.SmartSceneLog('\u89e3\u6790\u9875\u9762\u53c2\u6570 -- data: ' + JSON.stringify(this.data) + ', templates: ' + JSON.stringify(this.templates));
        ...
        if (c) {
          module1962.SmartSceneLog('\u89e3\u6790\u9875\u9762\u53c2\u6570 -- \u5730\u56feID\u65e0\u6548\u6216\u4e3a\u7a7a, \u5c06\u4f7f\u7528\u5f53\u524d\u5730\u56fe');
          ...
          l.setState(
            {
              tasks:
                ...
                (f = v.filter(function (t) {
                  return t.mapFlag == u || t.mode == module1963.SmartSceneMode.GlobalClean || t.isInvalid;
                }))
                  ? f
                  : [],
            ...
            function () {
              module1962.SmartSceneLog('\u89e3\u6790\u9875\u9762\u53c2\u6570 -- \u5b8c\u6210, \u521d\u59cbState: ' + JSON.stringify(l.state));
        ...
        if (u != module381.RSM.currentMapId)
          setTimeout(function () {
            l.startLoading();
            module1962.SmartSceneLog('\u89e3\u6790\u9875\u9762\u53c2\u6570 -- \u5730\u56feID\u4e0e\u5f53\u524d\u5730\u56fe\u4e0d\u540c, \u52a0\u8f7d\u5730\u56fe: ID: ' + u);
            l.mapDataProvider
              .loadMap(u)
              .then(function () {
                module1962.SmartSceneLog('\u89e3\u6790\u9875\u9762\u53c2\u6570 -- \u52a0\u8f7d\u5730\u56fe\u6210\u529f');
                f();
              })
              .catch(function (t) {
                module1962.SmartSceneLog('\u89e3\u6790\u9875\u9762\u53c2\u6570 -- \u52a0\u8f7d\u5730\u56fe\u5931\u8d25, ' + JSON.stringify(t));
                globals.showToast(module1962.LocalizationStrings.map_object_ignore_failed);
              })
              .finally(function () {
                l.endLoading();
    ...
    },
    {
      ...
      value: function () {
        ...
        this.props.navigation.setParams({
          ...
          rightItems: [
            module1118.MapEditCommonService.confirmButton(this.onPressMenuConfirm.bind(this), this.state.tasks.length > 0, function (n) {
      ...
      value: function (t) {
        ...
        if (null != this.commandID)
          return new Promise(function (o, s) {
            module1961.SmartSceneAPI.renameCommand(n.commandID, t.command.name)
              .then(function () {
                var o, s, l;
                module1962.SmartSceneLog(
                  '\u5373\u5c06\u5411\u4e91\u7aef\u8bf7\u6c42\u7f16\u8f91\u6307\u4ee4 -- name: ' + t.command.name + ', action: ' + JSON.stringify(t.command.actionModel)
                );
                return module1961.SmartSceneAPI.updateCommand(
                  n.commandID,
          ...
          return module1961.SmartSceneAPI.addCommand(t.command.name, t.command.actionModel);
        }
      },
    },
    {
      ...
      value: function () {
        var t,
          ...
          c = this.state.tasks.map(function (t) {
            return new module1962.TaskDescriptorData(
          ...
          f = {
            command: new module1962.CommandCardData(
              u,
              module1962.CommandCardType.Custom,
              c,
        ...
        this.requestCommitChanges(f)
          .then(function (t) {
            ...
            module1962.SmartSceneLog('\u5411\u4e91\u7aef\u8bf7\u6c42\u6210\u529f -- \u56de\u8c03\u6570\u636e: ' + JSON.stringify(f));
          })
          .catch(function (t) {
            globals.showToast(module1962.LocalizationStrings.map_object_ignore_failed + ' (Server)');
          })
          .finally(function () {
            l.endLoading();
          });
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return module1961.SmartSceneAPI.syncTaskToRobot(o, s);
      },
    },
    {
      key: 'startLoading',
    ...
    },
    {
      ...
      get: function () {
        switch (this.state.taskListState) {
          case module1962.TaskListState.Editing:
            return module1962.LocalizationStrings.smart_scene_edit_button_title_done;

          case module1962.TaskListState.Adding:
            return module1962.LocalizationStrings.localization_strings_Main_MainPage_11;

          case module1962.TaskListState.Normal:
            return module1962.LocalizationStrings.multi_floor_edit;
        }
      },
    },
    {
