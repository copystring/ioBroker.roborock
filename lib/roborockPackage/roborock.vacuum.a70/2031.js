...
var module510 = require('./510').strings,
  ...
  G = (function (t) {
    ...
    function G(t) {
      ...
      (n = q.call(this, t)).dataProvider = module390.default.isMultiFloorSupported() ? new module1341.MultiMapDataProvider() : new module1341.SingleMapDataProvider();
                ...
                .then(function (o) {
                  var l =
                    ...
                    p.state.items.map(function (o) {
                      if (o.id == t) o.name = module1208.FloorMapPageUtils.getRealName(n);
                      return o;
                    });
                  p.setState({
                    items: l,
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  ...
                  case 3:
                    ...
                    n.then(function (n) {
                      var l = module1982(n, globals.app.state.theme != module520.Themes.light, false, false);
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (
            ...
            if ('' != o) {
              var l = module1208.FloorMapPageUtils.getRealLength(o);
              if (module1208.FloorMapPageUtils.getRealLength(o) >= 30) globals.showToast(module510.floor_map_name_too_long);
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            c = React.default.createElement(module1921.default, {
              ...
              mode: module1921.ModalMapEditMenuMode.MapManagement,
              ...
              onEditingMapNameSuccess: function (n, o) {
                var l =
                  ...
                  t.state.items.map(function (t) {
                    if (t.id == n) t.name = module1208.FloorMapPageUtils.getRealName(o);
                    return t;
                  });
                t.setState({
                  items: l,
            ...
            V =
              ...
              this.state.items.map(function (n, o) {
                return React.default.createElement(module2032.default, {
                  key: o,
                  mapID: n.id,
                  name: n.name,
                  mapTime: n.time,
            ...
            q = React.default.createElement(module2033.default, {
              ref: function (n) {
            ...
            U = React.default.createElement(module2033.SingleMapEmptyMapItem, {
            ...
            J = React.default.createElement(module1206.MultiMapHintModal, {
              ref: function (n) {
            ...
            Q = React.default.createElement(module1118.MultiFloorEnableTipsView, {
              ref: function (n) {
                t.qaContentView = n;
              },
            }),
            ...
            $ = React.default.createElement(module1206.MapSaveActionSheetView, {
              ...
              mode: module1206.MapSaveActionSheetMode.SaveNewMapInSingleFloor,
              handleSaveMap: function (n) {
                return t.onTapSingleFloorSaveActionSheet.apply(t, [n]);
              },
            }),
            ee = React.default.createElement(module1206.MapSaveActionSheetView, {
              ref: function (n) {
            ...
            te = React.default.createElement(module1206.SingleFloorSaveNewMapAlert, {
              ref: function (n) {
            ...
            ie =
              ...
              React.default.createElement(module1938.LoadBackupMapView, {
                ref: function (n) {
...
exports.default = G;
G.defaultProps = {};
G.contextType = module1193.AppConfigContext;
