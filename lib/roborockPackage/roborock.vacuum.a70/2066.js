              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  ...
                  case 4:
                    o = l.sent;
                    this.setState({
                      isCarpetFirstOn: this.isCarpetSwitchEnabled() && this.state.isCarpetFirstOn,
                    });
            ...
            function (c) {
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    if (((c.prev = 0), !t || module381.RSM.mapSaveEnabled)) {
                      c.next = 4;
                      break;
                    }

                    if (!(null == (n = globals.Alert)))
                      n.customAlert(
                        module510.open_map_save_mode_tip,
                        '',
                        function () {
                          l.props.navigation.navigate('MultiFloorPage', null);
                        },
                        null,
                        {
                          confirmTitle: module510.goto_setting_on,
                        }
                      );
                  ...
                  case 12:
                    o = c.sent;
                    console.log('setCarpetFirstSwitch successfully', o);
