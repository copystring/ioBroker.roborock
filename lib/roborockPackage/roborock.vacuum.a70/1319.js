...
function N(t) {
  return t.type === module1214.default.NAVIGATE || t.type === module1268.default.PUSH;
}
...
function T(t) {
  return t.type === module1268.default.RESET && null === t.key;
}

exports.default = function (t) {
  var o = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : {};
  module1269.default(t);
  var S = {},
    b = Object.keys(t);
  b.forEach(function (n) {
    var o = module1265.default(t, n);
      ...
      return {
        ...
        routes: [
          h(
            ...
            {},
            {
              key: t.key || module1320.generateKey(),
    ...
    return {
      ...
      routes: [
        (n = h(
          ...
          {
            routeName: j,
            key: t.key || p || module1320.generateKey(),
          }
        )),
      ],
    };
  ...
  var R = module1222.createPathParser(S, t, o.paths),
  ...
  return {
    ...
    getComponentForState: function (n) {
      var o = n.routes[n.index],
        u = o.routeName;
      return S[u] ? S[u].getComponentForState(o) : module1265.default(t, u);
    },
    getComponentForRouteName: function (n) {
      return module1265.default(t, n);
    },
    getActionCreators: function (t, n) {
      return h(
        ...
        {},
        {
          ...
          popToTop: function (t) {
            return module1268.default.popToTop(t);
          },
          push: function (t, n, o) {
            return module1268.default.push({
              routeName: t,
              params: n,
              action: o,
            });
          ...
          replace: function (n, o, u, s) {
            if ('string' == typeof n)
              return module1268.default.replace({
                routeName: n,
                params: o,
                action: u,
                key: t.key,
              ...
              module1217.default('object' == typeof n, 'Must replaceWith an object or a string');
              module1217.default(null == o, 'Params must not be provided to .replace() when specifying an object');
              module1217.default(null == u, 'Child action must not be provided to .replace() when specifying an object');
              module1217.default(null == s, 'Child action must not be provided to .replace() when specifying an object');
              return module1268.default.replace(n);
            }
          },
          reset: function (t, o) {
            return module1268.default.reset({
              actions: t,
    ...
    getStateForAction: function (t, o) {
      ...
      if (T(t) || t.type === module1214.default.NAVIGATE) {
        if (t.type === module1214.default.NAVIGATE)
          for (var p, k = A(o.routes.slice().reverse()); !(p = k()).done; ) {
            ...
            if (P) {
              ...
              if (null === x || x !== b) {
                var j = module1229.default.replaceAndPrune(o, x ? x.key : b.key, x || b);
                return h(
                  h({}, j),
                  {},
                  {
        ...
        if (E) {
          ...
          if (null !== R && R !== l) return module1229.default.replaceAt(o, l.key, R, t.type === module1214.default.SET_PARAMS);
        }
      }
      ...
      if (N(t) && undefined !== S[t.routeName]) {
        var w,
          C = S[t.routeName];
        module1217.default(t.type !== module1268.default.PUSH || null == t.key, 'StackRouter does not support key on the push action');
        var K = o.routes.findIndex(function (n) {
          return t.key ? n.key === t.key : n.routeName === t.routeName;
        });

        if (t.type !== module1268.default.PUSH && -1 !== K) {
      ...
      if (t.type === module1268.default.PUSH && undefined === S[t.routeName]) return o;
      if (N(t))
        for (var U = Object.keys(S), D = 0; D < U.length; D++) {
          ...
          if (G) {
            var V = G.getStateForAction(module1214.default.init()),
      ...
      if (t.type === module1268.default.POP_TO_TOP)
      ...
      if (
        t.type === module1268.default.REPLACE &&
        -1 !==
          (s =
        ...
        J[s] = h(
          ...
          {
            routeName: t.routeName,
            key: t.newKey || module1320.generateKey(),
          }
        );
        return h(
          h({}, o),
      ...
      if (t.type === module1268.default.COMPLETE_TRANSITION && (null == t.key || t.key === o.key) && o.isTransitioning)
        return h(
          h({}, o),
          {},
          {
      ...
      if (t.type === module1214.default.SET_PARAMS) {
        var Q = t.key,
      ...
      if (t.type === module1268.default.RESET) {
      ...
      if (t.type === module1214.default.BACK || t.type === module1268.default.POP) {
        var te = t.key,
          re = t.n,
          ae = t.immediate,
          ne = o.index;
        if (t.type === module1268.default.POP && null != re) ne = 1 ** (o.index - re + 1);
        else if (te) {
      ...
      for (var ie, ue = t.key ? module1229.default.indexOf(o, t.key) : -1, fe = A(o.routes.slice().reverse()); !(ie = fe()).done; ) {
        var se = ie.value;
        ...
        if (se.key !== l.key && !(ue >= 0 && se.key !== t.key)) {
          ...
          if (le) {
            ...
            if (null === de) return o;
            if (de && de !== se) return module1229.default.replaceAt(o, se.key, de, t.type === module1214.default.SET_PARAMS);
          }
        }
      }
    ...
    getScreenOptions: module1266.default(t, o.navigationOptions),
  };
};
