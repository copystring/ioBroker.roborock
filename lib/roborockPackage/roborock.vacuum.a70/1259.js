  ...
  b = (function (t) {
    ...
    function b(t, s) {
      ...
      u.state = {
        ...
        scenes: module1260.default([], u.props.navigation.state, null, u.props.descriptors),
      };
      u._prevTransitionProps = null;
    ...
    module7.default(b, [
      ...
      },
      {
        ...
        value: function (t) {
          var n = module1260.default(this.state.scenes, t.navigation.state, this.props.navigation.state, t.descriptors);
...
function w(t, n) {
  var s = t.navigation,
    ...
    l = n.scenes,
    p = l.find(V);
  module1246.default(p, 'Could not find active scene');
  return {
    layout: o,
    navigation: s,
    position: u,
