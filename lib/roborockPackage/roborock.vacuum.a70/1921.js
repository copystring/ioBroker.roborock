...
var module1922 = (function (t) {
  ...
  function A(t) {
    ...
    if (
      ...
      ((n = module1922.call(this, t)).onPressAddMap = function () {
      ...
      (n.dataProvider = module390.default.isMultiFloorSupported() ? new module1341.MultiMapDataProvider() : new module1341.SingleMapDataProvider()),
      (n.mapUpdated = true),
      (n.lastMap = null),
  ...
  module7.default(A, [
            ...
            n.loadEditingMap(t)
              ...
              .catch(function (t) {
                ...
                if (t != B) {
                  ...
                  module1194.showFinishCurrentTastAlertIfNeeded(n.props.alertHandler).catch(function (t) {
      ...
      value: function (t) {
        ...
        if (
          ...
          if ('' != o) {
            var l,
              s,
              p = module1208.FloorMapPageUtils.getRealLength(o);
            if (module1208.FloorMapPageUtils.getRealLength(o) >= 30) null == (l = (s = this.props).toastHandler) || l.call(s, module510.floor_map_name_too_long);
    ...
    },
    {
      ...
      value: function () {
        ...
        var o = {
            ...
            onPress: function () {
              if (module381.RSM.isRunning)
                module1194.showFinishCurrentTastAlertIfNeeded(t.props.alertHandler).catch(function (n) {
      ...
      value: function () {
        ...
        return React.default.createElement(module385.InputDialog, {
          ...
          warningVisibilityAdapter: function (t) {
            return !module1208.FloorMapPageUtils.isLengthValid(t);
          },
        });
      },
    },
    ...
    },
    {
      ...
      value: function () {
        var t = this;
        return React.default.createElement(module1118.MultiMapSelectView, {
    ...
    },
    {
      ...
      value: function () {
        ...
        var T,
          ...
          module1922 = this.getTopButtons(),
          A = (null == module1922 ? undefined : module1922.length) ? p / module1922.length : 0,
          F = {
          ...
          module1923 = React.default.createElement(
            module13.View,
            {
              style: [
          ...
          W = (!this.props.isTitleViewHidden && !y) || (null == module1922 ? undefined : module1922.length) > 0,
          ...
          Z = React.default.createElement(module1118.MultiMapHintModal, {
            ref: function (t) {
        ...
        return React.default.createElement(
          ...
          !this.props.isTitleViewHidden &&
            (module381.RSM.mapSaveEnabled
              ? ((T = {
                ...
                (E = P ? l.currentMapSource : require('./1922')),
          ...
          !this.props.isTitleViewHidden && H && module1923,
    ...
    },
    {
      ...
      get: function () {
        var t,
          n,
          o = this;
        return module1208.FloorMapPageUtils.getRealName(
          null !=
            (t =
              null ==
...
module1922.contextType = module1193.AppConfigContext;
module1922.defaultProps = {
...
var N = module13.StyleSheet.create({
    mainView: {
      ...
      borderBottomLeftRadius: module1337.AppBorderRadius,
      borderBottomRightRadius: module1337.AppBorderRadius,
      borderWidth: 1,
      borderColor: 'white',
    },
    bottomButtonView: {
  ...
  A = module385.HocBottomModal(module385.WithSwipeToClose(module1922), !module393.isMiApp || 'android' != module13.Platform.OS);
exports.default = A;
