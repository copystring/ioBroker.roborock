exports.default = function (t, n, c, u) {
  ...
  n.routes.forEach(function (t, n) {
    ...
    module1246.default(!k.has(c), 'navigation.state.routes[' + n + '].key "' + c + '" conflicts with another route!');
    k.add(c);
  ...
  if (
    ...
    module1246.default(1 === j, 'there should always be only one scene active, not %s.', j),
    O.length !== t.length)
  )
    return O;
  if (
...
function h(t, n) {
  return t && n ? t.key === n.key && module1261.default(t, n) : t === n;
}
