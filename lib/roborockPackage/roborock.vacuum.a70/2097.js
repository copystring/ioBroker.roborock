  ...
  B = (function (t) {
    ...
    function F(t) {
      ...
      n.mapCarpetFocus = function (t, o) {
        n.editAction = o ? module1192.EditAction.Ignore : module1192.EditAction.AddCarpet;
        n.setState(
          o
            ? {
    ...
    module7.default(F, [
      {
        ...
        value: function () {
          ...
          this.carpetEditMode = this.props.navigation.getParam('action', module1191.CarpetEditMode.CarpetIgnore);
        },
      },
      {
      ...
      },
      {
        key: 'configNavibar',
        value: function () {
          module1343.default.setNavigation(this, null, this.onNavigationBackPress.bind(this));
        },
      },
      {
        key: 'initMapView',
      ...
      },
      {
        ...
        value: function () {
          ...
          this.mapEditDidChange = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.MapEditDidChange, function (n) {
            if (!(n.data != module1120.FbzType.FBZ_TYPE_CARPET && n.data != module1120.FbzType.RECT_TYPE_CARPET))
              t.setState({
                ignoreCarpetEdited: n.data == module1120.FbzType.FBZ_TYPE_CARPET,
                cusCarpetEdited: n.data == module1120.FbzType.RECT_TYPE_CARPET,
              });
          });
        },
      },
      ...
      },
      {
        ...
        value: function (t, n) {
          ...
          if (this.editAction == module1192.EditAction.Ignore)
            module1414.setTimeout(function () {
              return module415.MM.saveCarpetIgnoreZone(t, n, o.onMapSaveCompleted.bind(o));
            }, 500);
          else if (this.editAction == module1192.EditAction.AddCarpet)
            module1414.setTimeout(function () {
          ...
          return regeneratorRuntime.default.async(
            function (o) {
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    this.editAction = module1192.EditAction.AddCarpet;
        ...
        value: function () {
          var t = this,
            n = React.default.createElement(module1119.MapView, {
              ...
              mapMode: module1337.MAP_MODE_CARPET_EDIT,
            ...
            o = module1343.default.getNoMapTipView(this.state.mapStatus);
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module1192.default, {
            type: module1192.MenuType.Menu_Carpet,
