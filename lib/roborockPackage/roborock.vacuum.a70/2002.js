                  ...
                  switch ((n.prev = n.next)) {
                    ...
                    case 3:
                      ...
                      s.props.navigation.navigate('WebViewPage', {
                        ...
                        buttonColor: 'red',
                        buttonAction: s.resetButtonAction.bind(module8.default(s)),
                      });
                      n.next = 12;
                      break;
    ...
    module7.default(O, [
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module393.isLogFunctionSupported()) !module424.DMM.isV1 || module390.default.isDebuggableV1User();
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              !module391.default.isShareUser() &&
                React.default.createElement(module2003.default, {
            ...
            this.state.shouldShowDebugInfoView &&
              React.default.createElement(module2004.default, {
                parent: this,
              })
          );
        },
      ...
      },
      {
        ...
        value: function () {
          this.props.navigation.navigate('WebViewPage', {
            title: V.localization_strings_Main_Views_ImprovementPage_0,
            refrence: module1648.default.UserPrivacyProtocol(),
            isNotMarginBottom: true,
          });
        },
      },
            ...
            function (l) {
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    l.next = 2;
                    return regeneratorRuntime.default.awrap(module420.GetStorageKey(module420.StorageKeys.RobotSerialNumber));
                  ...
                  case 6:
                    ...
                    module7 = n.result[0].serial_number;
                    module394.default.sharedCache().serialNumber = module7;
                    this.setState({
                      serialNumber: module7,
                    });
                    l.next = 14;
                    return regeneratorRuntime.default.awrap(module420.SetStorageKey(module420.StorageKeys.RobotSerialNumber, module7));
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module13.Linking.canOpenURL('tel: ' + this.state.phone)
            .then(function (o) {
              if (o) return module13.Linking.openURL('tel: ' + t.state.phone);
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module13.Linking.canOpenURL('mailto: ' + this.state.email)
            .then(function (o) {
              if (o) return module13.Linking.openURL('mailto: ' + t.state.email);
      ...
      },
      {
        key: 'onClickWechat',
        value: function () {
          module13.Clipboard.setString('\u77f3\u5934\u79d1\u6280roborock');
