...
function y() {
  return module2059.default.currentState().then(function (t) {
    module2058.default.update(t);
...
function h() {
  if (!p) {
    v = module2057.default.eventEmitter.addListener(s, function (t) {
      module2058.default.update(t);
      var n = module2059.default.convertState(t);
      j = n;
    ...
    y();
    O = module2058.default.addSubscription(function (t) {
      if (j) {
        var n = l(
          l({}, j),
          {},
