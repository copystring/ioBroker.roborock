            ...
            if (this.state.hasCurrentMap && this.state.isNewMap) {
              var l = this.state.isRunning
                ...
                f = React.default.createElement(
                  ...
                  c,
                  module390.default.isUnsaveMapReasonSupported() && p
                ),
                ...
                S = React.default.createElement(module1118.MultiFloorEnableTipsView, {
                  ref: function (n) {
      ...
      value: function () {
        ...
        this.mapListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.MapDidUpdate, function (n) {
          ...
          if (t.mapView)
            t.mapView.setState(
              V(
                V({}, module415.MapManager.sharedManager().mapData),
                {},
                {
