    ...
    module7.default(N, [
      ...
      },
      {
        ...
        value: function () {
          ...
          var o = module1343.default.confirmButton(this.onNavigationSavePress, n, function (n) {
              t.mapSaveButton = n;
            }),
          ...
          module1343.default.setNavigation(this, l, this.onNavigationBackPress);
        },
      },
      {
        key: 'registListeners',
      ...
      },
      {
        ...
        value: function (t) {
          ...
          return this.state.mapStatus == module381.MapStatus.None ? module1343.default.getNoMapTipView(this.state.mapStatus) : s;
        },
      },
      {
        key: 'getResetButton',
