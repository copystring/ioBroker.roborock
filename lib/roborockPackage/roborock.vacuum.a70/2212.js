var regeneratorRuntime = require('regenerator-runtime'),
  ...
  React = require('react'),
  module13 = require('./13'),
  module2213 = require('./2213'),
  module416 = require('./416'),
  module2214 = require('./2214'),
    ...
    module7.default(I, [
      {
        ...
        value: function () {
          ...
          module2214.VideoManager.cancelRequest = false;
      ...
      },
      {
        ...
        value: function () {
          ...
          module2214.VideoManager.cancelRequest = false;
          module2214.VideoManager.addIceListener(function (o) {
            if (t.videoView)
              t.videoView.sendIceInfoToSDK(o, function (t) {
                console.log('\u53d1\u9001 ICE \u4fe1\u606f \u5230SDK \u6210\u529f');
              });
          });
          module2214.VideoManager.addTurnServerCallback(function (o) {
            t.sendTurnserviceInfoToSdk(o);
          });
          module2214.VideoManager.addSdpListener(function (o) {
            if (t.videoView)
              t.videoView.sendSdpInfoToSDK(o, function (t) {
                console.log('\u53d1\u9001 sdp \u4fe1\u606f \u5230SDK \u6210\u529f');
              });
          });
          module2214.VideoManager.addErrorCodeListener(function (o, n) {
      ...
      },
      {
        ...
        value: function () {
          ...
          module2214.VideoManager.cancelRequest = true;
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module2213.default, {
              width: n || p,
              height: s || w,
              ...
              onFirstFrameRendered: function () {
                ...
                module2214.VideoManager.notifyFirstVideoFrameRendered();
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    module2214.VideoManager.stopCameraPreview(t, n);
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    module2214.VideoManager.startVideoPreview(t, n);
