        ...
        value: function () {
          ...
          if (module381.RSM.isCollectDustDock) {
            ...
            if (o) {
              var n,
                l,
                s = module1930.default.sharedManager().dockSetSNPrefixes;
              if (
                ((l = false),
      ...
      },
      {
        ...
        value: function () {
          ...
          var c = this.getTopMenus().map(function (t, o) {
            ...
            module2065 = this.getMenus().map(function (t, o) {
              return t.visible
                ? t.title
                  ? React.default.createElement(
                      module385.SettingListItemView,
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                this.state.dustCollectionSwitch && module390.default.isDustCollectionSettingSupported() && module2065
              )
            ),
