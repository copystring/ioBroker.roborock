...
var module50 = require('./50'),
  ...
  module2200 = require('./2200'),
  module2202 = require('./2202'),
  module2201 = require('./2201'),
  module2206 = require('./2206'),
  module2208 = require('./2208'),
  module2210 = require('./2210'),
...
var module393 = require('./393'),
  module2212 = module393.monitorAllowed() ? require('./2212').default : module13.View,
    ...
    module7.default(X, [
      {
        ...
        value: function () {
          ...
          module1494.default.shared().popGestureEnabled = false;
      ...
      },
      {
        ...
        value: function () {
          ...
          module2052.default.isConnected.removeEventListener('connectionChange', this.onNetWorkChange.bind(this));
                ...
                switch ((u.prev = u.next)) {
                  ...
                  case 16:
                    if (module381.RSM.isHomeSecDisconnected()) {
                      ...
                      s = {
                        quality: module1337.VideoQuality.SD,
                      ...
                      module381.RSM.isHomeSecControlledByCurrentClient()
                        ...
                        : (module418.Log.log(
                          ...
                          this.setState({
                            isLoading: false,
                            isLoadFailed: true,
                            error: module1337.VideoError.Video_StartPreviewFailed_alreadyInPreview,
                          }));
      ...
      },
      {
        ...
        value: function () {
          ...
          this.statusListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.RobotStatusDidUpdate, function (n) {
            ...
            if (module381.RSM.bumperLeft) t.showTip(le[module2199.DirectionLeft]);
            if (module381.RSM.bumperRight) t.showTip(le[module2199.DirectionRight]);
            if (module381.RSM.bumperMiddle) t.showTip(le[module2199.DirectionMiddle]);
            if (module381.RSM.obstacleLeft) t.showTip(ue[module2199.DirectionLeft]);
            if (module381.RSM.obstacleRight) t.showTip(ue[module2199.DirectionRight]);
            if (module381.RSM.obstacleMiddle) t.showTip(ue[module2199.DirectionMiddle]);
          ...
          module2052.default.isConnected.addEventListener('connectionChange', this.onNetWorkChange.bind(this));
          this.gotoFailListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.EventToastChange, function (o) {
            if ('target_not_reachable' == o.data) t.showTip(module1632.getToast()[o.data][0]);
          });
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    o.prev = 0;
                    o.next = 3;
                    return regeneratorRuntime.default.awrap(module2052.default.getConnectionInfo());
      ...
      },
      {
        ...
        value: function (t) {
          var o = this,
            ...
            u = React.default.createElement(module2212, {
              ref: function (t) {
            ...
            module1922 = React.default.createElement(
              module13.View,
              {
                style: [
                  pe.video,
          ...
          return module393.monitorAllowed() ? module391.default.iOSAndroidReturn(h, u) : module1922;
        },
      },
      {
        key: 'didRecieveMsg',
      ...
      },
      {
        key: 'didRecieveError',
        value: function (t, o) {
          if (!(t.code == module1337.VideoError.Video_SendSDKSdpToDeviceFailed_responseTimeout.code && this.isMonitoring))
            t.code == module1337.VideoError.Video_StartPreviewFailed_alreadyInPreview.code &&
            (module418.Log.log(
              module418.LogTypes.Monitor,
            ...
            o && ((module381.RSM.homeSecClientID = o), o == module393.appClientID))
              ...
              : (module418.Log.log(module418.LogTypes.Monitor, '\u6536\u5230\u89c6\u9891\u62a5\u9519 \u9519\u8bef\u7801 code=' + t.code),
                ...
                t.code == module1337.VideoError.Video_StartPreviewFailed_unKnownReason.code ||
                t.code == module1337.VideoError.Video_StartPreviewFailed_innerUnknowReason.code ||
                t.code == module1337.VideoError.Video_PreviewTimeout
            ...
            function (h) {
              for (;;)
                switch ((h.prev = h.next)) {
                  case 0:
                    h.prev = 0;
                    module50 = module1337.Definitions[t];
      ...
      },
      {
        ...
        value: function (t) {
          var o = this;
          return React.default.createElement(module2183.default, {
      ...
      },
      {
        ...
        value: function (t) {
          var o = this,
            n = {
              left: module1337.AppBarMarginTop + 24,
            },
            l = ae;
          ...
          return React.default.createElement(module2166.default, {
            ref: function (t) {
      ...
      },
      {
        ...
        value: function (t) {
          var o = this;
          return React.default.createElement(module2198.default, {
            isPortrait: t,
            ref: function (t) {
              return (o.gotoView = t);
            },
      ...
      },
      {
        key: 'getRecordView',
        value: function () {
          return React.default.createElement(module2202.default, {
            style: pe.recordView,
            isLandscape: true,
            didOperate: this._userDidOperate.bind(this),
            alertOwner: this,
      ...
      },
      {
        ...
        value: function () {
          return React.default.createElement(module2201.default, {
            isLandscape: false,
            alertOwner: this,
          });
        },
      },
      {
        key: 'getCallView',
        value: function (t) {
          return React.default.createElement(module2208.default, {
            style: pe.callView,
            isLandscape: t,
            calling: this.state.calling,
          ...
          return React.default.createElement(
            ...
            module390.default.isVideoLiveCallSupported() &&
              ...
              React.default.createElement(module385.PureImageButton, {
                ...
                image: this.state.robotMic ? require('./2192') : require('./2193'),
                imageWidth: 30,
                imageHeight: 30,
                onPress: function () {
                  return t.soundOff();
            ...
            this.state.calling &&
              ...
              React.default.createElement(
                ...
                this.state.showChatVolume &&
                  React.default.createElement(module2187.default, {
        ...
        value: function () {
          ...
          if (this.isMonitoring && this.videoView)
            this.videoView.startRecordVideo(function (o) {
              if (o) {
                module2186.timeTool.startRecordTime();
                t.setState({
            ...
            n = function () {
              ...
              if (o.state.screenRecording) {
                module387.LogEventStatus('screen_recording_duration', {
                  duration: module2186.timeTool.getRecordSpan(),
                });
                module2186.timeTool.cancleRecord();
                o.setState({
      ...
      },
      {
        ...
        value: function (t) {
          var o = t == module2197.PortraitActionCall;

          if (t == module2197.PortraitActionRemote || o) {
            module387.LogEventCommon(t == module2197.PortraitActionRemote ? 'tap_remote_control_tab' : 'tap_voice_tab');
            if (o && module390.default.isVideoLiveCallSupported()) this.handleLiveCall();
            else this.togglePortaitPopup(t);
          } else if (t == module2197.PortraitActionRecord) this.handleScreenCast();
          else if (t == module2197.PortraitActionShortcut) this.screenShot();
        },
      },
      {
        key: 'showNotReadyTip',
                ...
                switch ((t.prev = t.next)) {
                  case 0:
                    ...
                    module387.LogEventStatus('call_duration', {
                      duration: module2186.timeTool.getSpan(),
                    });
                    this.cancleLiveCall();
      ...
      },
      {
        ...
        value: function (t) {
          var o = this,
            n = t == module2197.PortraitActionRemote;
          this.setState(
            {
            ...
            function () {
              module13.Animated.spring(o.animatedPortraitPopupViewHeight, {
                toValue: re() - (ge() + se + he + module2197.FuncTabBackgroundHeight - 15),
                duration: 800,
              }).start();
            }
          );
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module2197.PortraitActionMenu, {
              isRemoteActive: c,
              isScreenCasting: l,
              isLiveCall: u,
            ...
            React.default.createElement(
              module13.View,
              {
                style: [
                  ...
                  {
                    width: ne(),
                    height: re() - ge() - se - he - module2197.FuncTabBackgroundHeight + 15,
                  },
                ],
              },
              ...
              this.state.calling &&
                React.default.createElement(module2210.default, {
                  ref: function (o) {
            ...
            React.default.createElement(module385.ActionSheetView, {
              ...
              actions: module1337.Definitions.map(function (t) {
                return t.title;
              }),
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            o &&
              React.default.createElement(module2182.default, {
                ref: function (o) {
                  return (t.definitionView = o);
                },
            ...
            o &&
              React.default.createElement(module2178.default, {
                style: [pe.actionMenu],
                ref: function (o) {
            ...
            n && (module381.RSM.bumperMiddle || module381.RSM.obstacleMiddle)
              ? React.default.createElement(module2199.BumperView, {
                  direction: module2199.DirectionMiddle,
                })
              : null,
            n && (module381.RSM.bumperLeft || module381.RSM.obstacleLeft)
              ? React.default.createElement(module2199.BumperView, {
                  direction: module2199.DirectionLeft,
                })
              : null,
            n && (module381.RSM.bumperRight || module381.RSM.obstacleRight)
              ? React.default.createElement(module2199.BumperView, {
                  direction: module2199.DirectionRight,
                })
              : null,
            React.default.createElement(module385.AlertView, {
              ref: function (o) {
            ...
            module390.default.isRecordAllowed() && module393.isRecordSupported() && 2 == module393.iotType
              ? React.default.createElement(module2200.default, {
                  ref: function (o) {
            ...
            this.state.shouldShowRecordToast && !module390.default.isVideoLiveCallSupported()
              ? React.default.createElement(module2206.default, {
                  ref: function (o) {
...
module2216.contextType = module1193.AppConfigContext;
module2216.navigationOptions = {
  header: null,
};
