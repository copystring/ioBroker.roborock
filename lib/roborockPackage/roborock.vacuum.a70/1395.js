  ...
  P = (function (t) {
    ...
    function T(t) {
      ...
      n.onTouchStart = function (t) {
        if (t == module1206.RectPanType.PanTypeMoveWall) null == n.props.handlePanStart || n.props.handlePanStart(n.state.id);
      };
    ...
    module7.default(T, [
      {
        ...
        value: function () {
          this.panProxy = new module1206.PanResponderProxy(module1206.RectPanType.PanTypeMoveWall | module1206.RectPanType.PanTypeDragEnd | module1206.RectPanType.PanTypeDelete);
      ...
      },
      {
        ...
        value: function () {
          ...
          var l = this.context.theme.displayZones,
            u = module1333._convertToPixelEndpoint(this.state.position, this.props.transform),
            h = u.end.y - u.start.y,
            p = u.end.x - u.start.x,
            w = Math.abs(h),
            C = Math.abs(p),
            ...
            T = u.start.x,
            R = u.start.y,
            k = 4 * module1120.buttonConfig.rectBtn.size.width + this.wallHeight,
            B = 2 * P + 4 * module1120.buttonConfig.rectOperateBoarderDis,
            O = k / 2,
            _ = B / 2,
            F = React.default.createElement(
              ...
              module22.default({}, this.panProxy.panResponder.panHandlers, {
                ...
                style: {
                  position: 'absolute',
                  left: _ - module1120.buttonConfig.rectOperateBoarderDis - 1,
                  top: O - module1120.buttonConfig.rectOperateBoarderDis - 1 - this.wallHeight / 2,
                  width: P + 2 * module1120.buttonConfig.rectOperateBoarderDis + 1,
                  height: 2 * module1120.buttonConfig.rectOperateBoarderDis + this.wallHeight + 1,
            ...
            z = module1343.default.zoneDeleteButton('invisible_wall_edit_delete', null == (t = this.panProxy) ? undefined : t.panResponderDelete, _, H),
            I = {
              width: _ + P,
              height: O + this.wallHeight / 2,
            },
            W = module1343.default.zoneScaleButton(I, 'invisible_wall_edit_scale', null == (o = this.panProxy) ? undefined : o.panResponderDragEnd, 0),
            Z = _ - module1120.buttonConfig.rectOperateBoarderDis - 1.5 * module1120.buttonConfig.rectBtn.size.width - 1,
            j = module1343.default.zoneDragButtonView(this.wallHeight, null == (s = this.panProxy) ? undefined : s.panResponder, {
              left: Z,
            }),
            q = module1120.buttonConfig.rectDisplay.size.width * this.props.transform.xx,
            L = module1120.buttonConfig.rectDisplay.size.height * this.props.transform.xx,
            module1396 = this.state.isFocus
              ? React.default.createElement(module13.View, null)
              : React.default.createElement(module1206.DisplayButton, {
                  left: _ - q / 2,
                  top: O - L / 2,
                  width: q,
                  height: L,
                  imageSource: require('./1396'),
                }),
            module1396 = this.state.isFocus
              ? React.default.createElement(module13.View, null)
              : React.default.createElement(module1206.DisplayButton, {
                  left: B - 2 * module1120.buttonConfig.rectOperateBoarderDis - q / 2,
                  top: O - L / 2,
                  width: q,
                  height: L,
                  imageSource: require('./1396'),
