var PropTypes = require('prop-types'),
  ...
  n = {
    ...
    scaleX: module75(PropTypes.number, 'Use the transform prop instead.'),
    scaleY: module75(PropTypes.number, 'Use the transform prop instead.'),
    rotation: module75(PropTypes.number, 'Use the transform prop instead.'),
    translateX: module75(PropTypes.number, 'Use the transform prop instead.'),
    translateY: module75(PropTypes.number, 'Use the transform prop instead.'),
  };
