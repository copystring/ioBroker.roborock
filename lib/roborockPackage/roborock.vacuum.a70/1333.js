...
exports._checkTrans = function (t, n, o, h, c, f, l, y) {
  ...
  var v = module1120.Config.scale.min,
    M = module1120.Config.scale.max;
  if ('android' === module13.Platform.OS && o && o.height && o.width && (o.width > 300 || o.height > 300)) M = module1120.Config.scale.maxAndroid;
  if (_(p))
    o = {
      width: o.height,
      height: o.width,
...
exports._parseMopPath = function (t, n, o) {
  ...
  if (!t || t.length < 2 || !o || t.length != o.length)
    return {
      mopPath: '',
    };
...
exports._mergeObstacles = function (t, o, h) {
  ...
  for (var u = {}, c = 0; c < t.length; c++)
    for (var x = t[c], f = c + 1; f < t.length; f++) {
      ...
      if (p <= 300 || p <= (50 * module1120.Config.size.objectsRadius) / h) u[c] ? u[c].push(f) : (u[c] = [f]);
    }
