    ...
    function W(t) {
      ...
      n.sectionFooter = function (t) {
        for (var s in t.section.data) {
          if (t.section.data[s].title == I.robot_status_wait_charge1 && n.state.isValleyElectricitySwitchOn && n.state.ValleyElectricityHint)
      ...
      n.valleyElectricityBeginHour = -1;
      n.valleyElectricityBeginMinute = -1;
      n.valleyElectricityEndHour = -1;
      n.valleyElectricityEndMinute = -1;
    ...
    (0, c.default)(W, [
            ...
            var t = [
                {
                  data: [
                    ...
                    },
                    {
                      ...
                      visible: (!k.default.shouldHideCarpetPressurize() && !k.default.isCarpetSupported()) || T.DMM.isGarnet,
                      shouldShowBottomLine: !1,
                      shouldShowTopLongLine: !1,
                      bottomDetailWidth: w.Dimensions.get('window').width - 70,
                    },
                  ...
                  data: [
                    {
                      ...
                      bottomDetail: k.default.isSupportCustomDnd()
                        ? null
                        : E.RSM.isCollectDustDock
                        ? I.no_disturb_with_dust_collection
                        : I.localization_strings_Setting_DoNotDisturbPage_13,
                      shouldShowSwitch: !0,
          ...
          var t = [
            {
              ...
              detail: (K.addZeroPrefix(this.valleyElectricityBeginHour) + ':' + K.addZeroPrefix(this.valleyElectricityBeginMinute)).replace('0-1:0-1', I.timer_setting_no_setting),
            ...
            },
            {
              ...
              detail: (K.addZeroPrefix(this.valleyElectricityEndHour) + ':' + K.addZeroPrefix(this.valleyElectricityEndMinute)).replace('0-1:0-1', I.timer_setting_no_setting),
              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    ...
                    -1 != this.valleyElectricityBeginHour && -1 != this.valleyElectricityBeginMinute && -1 != this.valleyElectricityEndHour && -1 != this.valleyElectricityEndMinute
                      ? this.saveValleyElectricityData()
                      : this.setState({
                          ValleyElectricityHint: I.valley_electricity_not_set_hint,
                        });
                    l.next = 21;
                    break;
                  ...
                  case 10:
                    o = l.sent;
                    this.valleyElectricityBeginHour = -1;
                    this.valleyElectricityBeginMinute = -1;
                    this.valleyElectricityEndHour = -1;
                    this.valleyElectricityEndMinute = -1;
      ...
      },
      {
        ...
        value: function () {
          ...
          t =
            -1 == this.valleyElectricityBeginHour ||
            -1 == this.valleyElectricityBeginMinute ||
            -1 == this.valleyElectricityEndHour ||
            -1 == this.valleyElectricityEndMinute ||
            s == n
              ? 0
              : s > n
              ? s - n
          ...
          t < 6 &&
            (this.setState({
              ValleyElectricityHint: I.robot_status_wait_charge6,
            }),
            this.isBeginTime
                ...
                switch ((n.prev = n.next)) {
                  case 0:
                    if (
                      ...
                      (n.prev = 1),
                      !((!k.default.shouldHideCarpetPressurize() && !k.default.isCarpetSupported()) || T.DMM.isGarnet))
                    ) {
                      n.next = 6;
                      break;
                    }
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (this.isDoNot) {
            var o = this.isBeginTime && this.doNotDisturbEndHour == n && this.doNotDisturbEndMinute == s,
              l = !this.isBeginTime && this.doNotDisturbBeginHour == n && this.doNotDisturbBeginMinute == s;

            if (o || l) {
              this.hideTimerPicker();
              return void globals.showToast(I.donot_disturb_same_time_warning);
            }

            this.isBeginTime ? ((this.doNotDisturbBeginHour = n), (this.doNotDisturbBeginMinute = s)) : ((this.doNotDisturbEndHour = n), (this.doNotDisturbEndMinute = s));
              ...
              for (;;)
                switch ((h.prev = h.next)) {
                  case 0:
                    ...
                    l = o ? (T.DMM.isTanosSE ? 300 : 280) : n ? 625 : 500;
                    u = {
                      enable: t ? 1 : 0,
                      current_high: l,
