  ...
  v = (function (t) {
    ...
    module7.default(I, [
      ...
      },
      {
        ...
        value: function () {
          ...
          var t = this,
            ...
            C = [
              S(
                S({}, module1623.getNewCollectButtonConfig(s, n)),
                {},
                {
              ...
              S(
                S({}, module1623.getNewWashButtonConfig(f, n)),
                {},
                {
            ...
            D = S(
              S({}, module1623.getNewDryButtonConfig(B, n)),
              {},
              {
          ...
          var v = (module13.Dimensions.get('window').width - module1428.HorizontalMargin * (C.length + 1)) / C.length,
            T = S(
              S({}, module1428.BaseShadow),
              {},
              {
                height: 75,
                radius: 10,
      ...
      },
      {
        key: 'dockInfoItems',
        get: function () {
          return module1623.getDockInfoItems(this.context.theme);
        },
      },
      {
        key: 'dockImage',
...
var _ = module13.StyleSheet.create({
    container: {
      paddingTop: 15,
      paddingBottom: 20 + module1337.AppBarMarginBottom,
