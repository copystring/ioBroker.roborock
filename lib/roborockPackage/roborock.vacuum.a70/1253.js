...
var p = module13.Dimensions.get('window').width / 2 - 70 - 25;
var c = module13.Dimensions.get('window').width / 2 - 70 + 25;
var l = module13.Dimensions.get('window').width;
var v = {
  forLayout: function (t) {
    ...
    var v = f(l),
      R = module1254.default(t);
    if (!R) return {};
    var y = R.first,
      w = R.last,
      h = c.index,
      L = s.initWidth || module13.Dimensions.get('window').width;
    ...
    var x = module13.I18nManager.isRTL ? -1 : 1;
    return {
      transform: [
        {
      ...
      transform: [
        {
          translateX: s.interpolate({
            ...
            outputRange: module13.I18nManager.isRTL ? [1.5 * -w, u(c[v]) ? 1.5 * -w : 0, 0, u(c[R]) ? w : 0, w] : [w, u(c[v]) ? w : 0, 0, u(c[R]) ? 1.5 * -w : 0, 1.5 * -w],
          }),
        },
      ],
    };
      ...
      transform: [
        {
          translateX: s.interpolate({
            inputRange: [v, v + 0.001, y, R - 0.001, R],
            outputRange: module13.I18nManager.isRTL ? [-w, u(p[v]) ? -w : 0, 0, u(p[R]) ? w : 0, w] : [w, u(p[v]) ? w : 0, 0, u(p[R]) ? -w : 0, -w],
          }),
        },
      ],
    };
      ...
      transform: [
        {
          translateX: u.interpolate({
            inputRange: [p, v, c],
            outputRange: module13.I18nManager.isRTL ? R.reverse() : R,
          }),
        },
      ],
    };
