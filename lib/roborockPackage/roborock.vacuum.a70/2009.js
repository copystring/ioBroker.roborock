...
var module1414 = require('./1414'),
  ...
  C = (function (t) {
    ...
    function E(t) {
      ...
      (s = C.call(this, t)).dataSource = new module501.default.DataSource({
      ...
      s.host = module1337.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].host;
      s.state = {
        progress: -1,
    ...
    module7.default(E, [
            ...
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 8:
                    this.timer = module1414.setInterval(this.getProgess.bind(this), 1e3);
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    c.next = 4;
                    return regeneratorRuntime.default.awrap(module2012.default.getListDataFromLocal());
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module2014.default, {
            ref: function (s) {
      ...
      },
      {
        ...
        value: function (t, s) {
          if (!t || !t.length) return React.default.createElement(module13.View, null);
          var n = this.context.theme,
            o = module510.soundpackage_select_sound_title;
          if ('special' == s) o = module510.soundpackage_select_special_sound_title;
      ...
      },
      {
        ...
        value: function (t, s, n) {
          return 'normal' == s
            ? React.default.createElement(module2017.default, {
            ...
            : 'special' == s
            ? React.default.createElement(module2010.default, {
                progress: t.voice_id == this.state.currentDownloadVoiceId ? this.state.progress : -1,
                data: t,
                rowId: n,
                showTopLine: false,
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    globals.showToast(module510.localization_strings_Setting_SoundPackagePage_4);
                    return c.abrupt('return');
                  ...
                  case 3:
                    ...
                    c.next = 9;
                    return regeneratorRuntime.default.awrap(module416.default.setSoundPackage(s));
              ...
              for (;;)
                switch ((v.prev = v.next)) {
                  case 0:
                    v.prev = 0;
                    v.next = 3;
                    return regeneratorRuntime.default.awrap(module416.default.getSoundPackageProgress());
                  ...
                  case 3:
                    ...
                    module1414.clearInterval(this.timer);
                    this.downloading = false;
                    this.setState({
                      progress: -1,
                      currentDownloadVoiceId: -1,
                    });
                    React = module510.sound_package_installed_failed;
                    if (!(13 != u && 2 != u)) React = module510.sound_package_download_failed;
      ...
      },
      {
        ...
        value: function () {
          globals.showToast(module510.robot_play_soundpackage_exception);
        },
      },
    ]);
    return E;
