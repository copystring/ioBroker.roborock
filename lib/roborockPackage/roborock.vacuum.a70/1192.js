...
var k = (function (t) {
  ...
  function w(t) {
    ...
    n._onPressCancelButton = function () {
      ...
      } else if (n.state.currentAction == O.Order) null == n.props.onPressCancelButtonForOrder || n.props.onPressCancelButtonForOrder();
      n.hideConfirmMenu();
    };
    ...
    n.confirmMenuViewTop = new module13.Animated.Value(200);
    n.state = {
  ...
  module7.default(w, [
    ...
    },
    {
      ...
      value: function (t) {
        return t == A.Menu_Fbz
          ? module510.fbz_cannot_cover_charger_tip
          : t == A.Menu_Mode
          ? module510.map_edit_custom_mode_tip
          : t == A.Menu_Order
          ? module510.map_edit_order_setting_tip
          : t == A.Menu_Carpet
          ? module510.map_edit_carpet_init_tip
          : '';
      },
    },
    {
    ...
    },
    {
      ...
      value: function () {
        return [
          {
            title: module510.map_edit_rotate_left,
          ...
          {
            title: module510.map_edit_rotate_right,
    ...
    },
    {
      ...
      value: function () {
        var t = new Array();
        if (this.props.subType & module1191.CarpetEditMode.CarpetAdd)
          t.push({
            title: module510.map_edit_carpet_add_carpet,
    ...
    },
    {
      ...
      value: function () {
        return [
          {
            title: module510.map_edit_mode_smart,
            image: this.menuTheme.smartMode,
            visible: true,
            onPress: function () {
              var t, n;
              this.setState({
                currentAction: O.None,
              });
              if (!(null == (t = (n = this.props).onPressSmartModeButton))) t.call(n);
            },
          },
          {
            title: module510.manual_edit_map,
            image: this.menuTheme.customMode,
            visible: true,
            onPress: function () {
              var t, n;
              this.setState({
                currentAction: O.Custom,
              });
              this.showConfirmMenu(module510.map_edit_custom_mode_tip);
              if (!(null == (t = (n = this.props).onPressCustomModeButton))) t.call(n);
            },
          },
          {
            title: module510.reset_clean_mode_button_title,
      ...
      value: function () {
        return [
          ...
          },
          {
            ...
            onPress: function () {
              this.setState({
                currentAction: O.Order,
              });
              this.showConfirmMenu(module510.map_edit_order_setting_tip);
            },
          },
          {
            title: module510.reset_order_button_title,
            image: this.menuTheme.cleanMode,
            visible: true,
            onPress: function () {
              var t, n;
    ...
    },
    {
      ...
      value: function () {
        return [
          {
            title: module510.map_edit_merge,
            image: this.menuTheme.mergeImg,
            visible: true,
            onPress: function () {
              if (this.hasSegmentMap()) {
                this.setState({
                  currentAction: O.Merge,
                });
                this.showConfirmMenu(module510.map_edit_merge_restriction);
                if (this.props.onPressMergeZoneButton) this.props.onPressMergeZoneButton();
              }
            },
          },
          {
            title: module510.map_edit_split,
            image: this.menuTheme.splitImg,
            visible: true,
            onPress: function () {
              if (this.hasSegmentMap()) {
                this.setState({
                  currentAction: O.Split,
                });
                this.showConfirmMenu(module510.map_edit_split_restriction);
                if (this.props.onPressSplitZoneButton) this.props.onPressSplitZoneButton();
              }
            },
          },
          {
            title: module510.map_edit_rename,
    ...
    },
    {
      ...
      value: function () {
        var t = {
            title: module510.map_edit_add_virtual_wall,
          ...
          o = {
            title: n ? module510.map_edit_clean_mop_forbidden : module510.map_edit_add_forbidden_zone,
          ...
          s = {
            title: module510.map_edit_add_clean_fbz_garnet,
          ...
          u = {
            title: (module424.DMM.isGarnet, module510.map_edit_add_mop_fbz),
        ...
        l.push(o);
        if (n) l.push(u);
        if (module424.DMM.isGarnet) l.push(s);
        return l;
      },
    },
    {
      ...
      value: function () {
        return [
          {
            title: module510.map_edit_floor_tile,
          ...
          {
            title: module510.map_edit_floor_wood,
          ...
          {
            title: module510.map_edit_floor_wood_width,
            image: this.theme.furnitureEdit.woodFurntImg,
            visible: !!module390.default.isSupportFloorDirection(),
            onPress: function () {
              var t, n;
          ...
          {
            title: module510.map_edit_floor_wood_longti,
            image: this.theme.furnitureEdit.woodFurntImg,
            imageStyle: {
              transform: [
                {
          ...
          {
            title: module510.map_edit_floor_other,
      ...
      value: function () {
        return [
          ...
          },
          {
            ...
            image: this.menuTheme.addCarpetImg,
            visible: module390.default.isShowCarpetEditEntrance(),
            onPress: function () {
              var t, n;
    ...
    },
    {
      ...
      value: function () {
        return [
          {
            title: module510.map_edit_door_sill_slide,
          ...
          {
            title: module510.map_edit_door_sill_stone,
          ...
          {
            title: module510.localization_strings_Setting_Timer_Common_4,
    ...
    },
    {
      ...
      value: function () {
        var t = this,
          n = module13.Dimensions.get('window').width,
          o = this.getMenu(),
          u = (n - this.getBottomMarignByModelAndMenu()) / this.getItemVisibleSize(),
          l = {
            merge: module510.map_edit_merge,
            split: module510.map_edit_split,
            custom: '',
            order: module510.map_edit_order_setting,
            name: module510.map_edit_rename,
            floor: '',
        ...
        var c =
                    ...
                    module22.default(
                      {
                        ...
                        style: [module391.default.isIphoneX() ? G.button : G.buttonSmall],
                        enabled: c,
                        key: o,
                      },
                      n,
          ...
          F = this.hasMenu() && v.length > 0,
          E = F ? this.state.menuHeight : 60;
        ...
        if (module381.RSM.mapStatus != module381.MapStatus.None) {
          if (this.props.type == A.Menu_Zone) {
            ...
            if (module381.RSM.isRunning)
              return void module1194.showFinishCurrentTastAlertIfNeeded().catch(function (t) {
                if (n.props.editMapSegmentsIsDisable) n.props.editMapSegmentsIsDisable(module510.robot_communication_exception);
              });
    ...
    },
    {
      ...
      value: function (t) {
        if (this.props.hasConfirmMenu)
          module13.Animated.timing(this.confirmMenuViewTop, {
            toValue: 0,
            duration: 500,
          }).start();
        if (t)
