  ...
  R = (function (t) {
    ...
    module7.default(A, [
      ...
      },
      {
        ...
        value: function () {
          module1494.default.shared().popGestureEnabled = true;
        },
      },
      {
        key: 'render',
        value: function () {
          ...
          var E = this.context.theme.alert,
            ...
            module1331 = React.default.createElement(
            ...
            B = React.default.createElement(module1211.NavigationConsumer, null, function (n) {
          ...
          return this.state.visible ? (k ? B : module1331) : null;
        },
      },
      {
        key: 'customAlert',
      ...
      },
      {
        ...
        value: function () {
          ...
          module1494.default.shared().popGestureEnabled = this.props.hidePopGestureEnabled;
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module1494.default.shared().popGestureEnabled = this.props.showPopGestureEnabled;
          this.needShow = true;
          if (this.props.noAnimated)
            this.setState({
              visible: true,
