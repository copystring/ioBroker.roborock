  ...
  module1976 = (function (t) {
    ...
    module7.default(z, [
          ...
          if (this.feedbackCallback)
            this.mapLoadEmitter = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.MapImageLoaded, function (n) {
              if (n.types && 0 != n.types.length) {
                ...
                var o = Object.values(module1118.shareViewLoadType),
                  l = 0;
      ...
      },
      {
        ...
        value: function () {
          this.context.theme;
          var module1943 = React.default.createElement(module385.PureImageButton, {
            image: require('./1943'),
          ...
          this.props.navigation.setParams({
            ...
            rightItems: this.shouldShowShareButton ? [module1943] : [],
          });
        },
      },
      {
      ...
      },
      {
        ...
        value: function (t) {
          var n,
            ...
            s,
            c,
            u = module1982.parse(t, globals.app.state.theme != module520.Themes.light, module424.DMM.isSapphirePlus, module394.MC.sapMapBeautify),
            h = {
      ...
      },
      {
        key: 'render',
        value: function () {
          if (1 == this.props.navigation.state.params.status) require('./1975');
          else require('./1976');
          ...
          var t = this,
            ...
            c = module1638.utcTimeConvertToPhoneTimeZoneTime(1e3 * this.state.start),
            u = module1638.addZeroPrefix(c.month) + '/' + module1638.addZeroPrefix(c.day) + ' ' + module1638.addZeroPrefix(c.hour) + ':' + module1638.addZeroPrefix(c.minute),
            h = {
              marginHorizontal: 2,
              fontSize: 20,
            ...
            K = W + ' | ' + (module1337.CleanStartType()[this.state.startType] || module510.localization_strings_Setting_General_index_0) + ' | ' + u + ' ';
          ...
          var q = [n.cleanHistory.gradSuccessLeft, n.cleanHistory.gradSuccessRight],
            module1975 = [n.cleanHistory.gradFailLeft, n.cleanHistory.gradFailRight],
            ...
            ie = React.default.createElement(
              ...
              globals.isRTL ? module1983 : te,
              globals.isRTL ? te : module1983
            ),
            ...
            module1985 = React.default.createElement(
              module13.TouchableWithoutFeedback,
              module22.default(
                {
            ...
            module1983 = React.default.createElement(
              module13.TouchableWithoutFeedback,
              module22.default(
                {
                  onPress: this.onPressPlay.bind(this),
            ...
            module1986 = React.default.createElement(
              module13.TouchableWithoutFeedback,
              module22.default(
                {
          ...
          if (this.state.uiStatus != J) {
            ...
            ie = React.default.createElement(
              ...
              globals.isRTL ? module1986 : module1984,
              se ? module1983 : module1985,
              globals.isRTL ? module1984 : module1986
            );
          }
            ...
            React.default.createElement(
              ...
              this.state.hasGotMap
                ? React.default.createElement(module1118.MapView, {
                    ...
                    syncMapDeg: false,
                    left: module1118.MapEditCommonStyles.mapLeft,
                    right: module1118.MapEditCommonStyles.mapRight,
                    top: module1118.MapEditCommonStyles.mapTop,
                    bottom: Y + 40,
                    alwaysShowFBZ: true,
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  {
                    colors: 1 == this.props.navigation.state.params.status ? q : module1975,
                    start: {
                      x: 0,
                      y: 0,
                    },
              ...
              React.default.createElement(module1920.default, {
                style: {
                  position: 'absolute',
                  bottom: 0,
                  height: Q,
      ...
      },
      {
        key: 'getDescText',
        value: function () {
          var t = module1337.CleanFinishCleanReasons()[this.state.finishReasonCode];
...
exports.default = module1976;
module1976.contextType = module1193.AppConfigContext;
var ee = module13.StyleSheet.create({
  container: {
    ...
    marginTop: -module391.default.iOSAndroidReturn(
      module1389.titleBarContentHeight + module1337.StatusBarHeight + module1337.AppBarMarginTop,
      (module13.StatusBar.currentHeight || 0) + module1389.titleBarContentHeight
    ),
  },
  contentView: {
    flex: 1,
