...
var c = function (t) {
  ...
  s = function (t) {
    return '^' + module1996.default(t).replace(/\\\*/g, '.*');
  },
  E = function (t, n) {
    var l = c(n);
...
exports.defaultRenderLoading = function () {
  return React.default.createElement(
    module13.View,
    {
      style: module1997.default.loadingOrErrorView,
    },
...
exports.defaultRenderError = function (t, n, f) {
  return React.default.createElement(
    ...
    React.default.createElement(
      module13.Text,
      {
        style: module1997.default.errorTextTitle,
      },
      'Error loading page'
    ),
    React.default.createElement(
      module13.Text,
      {
        style: module1997.default.errorText,
      },
      'Domain: ' + t
    ),
    React.default.createElement(
