  ...
  var N = (function (_) {
    ...
    function x(n) {
      ...
      u._handleOpenURL = function (n) {
        ...
        if (false !== c) {
          var f = module1222.urlToPathAndParams(o, l);
          ...
          function (s) {
            for (;;)
              switch ((s.prev = s.next)) {
                ...
                case 3:
                  s.next = 5;
                  return regeneratorRuntime.default.awrap(module13.AsyncStorage.setItem(n, JSON.stringify(t)));
      ...
      u.dispatch = function (n) {
        ...
        var o = u._navState;
        module1217.default(o, 'should be set in constructor if stateful');
      ...
      k(n);
      u._initialAction = module1214.default.init();
      if (u._isStateful())
        u.subs = module13.BackHandler.addEventListener('hardwareBackPress', function () {
          if (u._isMounted) return u.dispatch(module1214.default.back());
    ...
    module7.default(x, [
              ...
              for (;;)
                switch ((N.prev = N.next)) {
                  ...
                  case 3:
                    if (
                      (0,
                      module13.Linking.addEventListener('url', this._handleOpenURL),
                      (n = this.props),
                      (s = n.persistenceKey),
                      (u = n.uriPrefix),
                  ...
                  case 15:
                    module12 = N.t0;
                    N.next = 18;
                    return regeneratorRuntime.default.awrap(module13.Linking.getInitialURL());

                  case 18:
                    p = N.sent;
                    l = p && module1222.urlToPathAndParams(p, u);
      ...
      },
      {
        ...
        value: function (t, n) {
          ...
          this.dispatch(module1214.default.init());
        },
      },
      {
        ...
        value: function () {
          ...
          module13.Linking.removeEventListener('url', this._handleOpenURL);
        ...
        value: function () {
          ...
          if (this._isStateful()) {
            ...
            if (!(this._navigation && this._navigation.state === u))
              this._navigation = module1215.default(t.router, u, this.dispatch, this._actionEventSubscribers, this._getScreenProps, function () {
                return o._navigation;
              });
            s = this._navigation;
          }

          module1217.default(s, 'failed to get navigation');
