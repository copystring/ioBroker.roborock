  ...
  H = (function (t) {
    ...
    function D(t) {
      ...
      n.onPressMergeZoneButton = function () {
        n.setState({
          action: module1192.EditAction.Merge,
        });
      ...
      n.onPressSplitZoneButton = function () {
        var t;
        n.setState({
          action: module1192.EditAction.Split,
        });
      ...
      n.onPressRoomNameButton = function () {
        ...
        if (n.mapView) {
          ...
          if (0 == s || 1 == s) {
            ...
            n.setState({
              action: module1192.EditAction.Name,
            });
      ...
      n.onDealTagDuplicateName = function (t, o, s) {
        ...
        for (
          ...
          -1 != u.indexOf(l) &&
          l != s &&
          ((l = 0 == c ? module1120.RoomTagInfo[t].name : '' + module1120.RoomTagInfo[t].name + c),
          c++,
          l == o && (l = 0 == c ? module1120.RoomTagInfo[t].name : '' + module1120.RoomTagInfo[t].name + c),
          20 != c);
      ...
      n.initAction = n.props.navigation.state.params.action || module1192.EditAction.None;
      n.state = {
        ...
        overTimer: module1337.OverTimer_Six,
      };
    ...
    module7.default(D, [
      {
        ...
        value: function () {
          ...
          this.initAction = this.props.navigation.getParam('initAction', module1192.EditAction.None);
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = [
              module1343.default.guideButton(this.onNavigationGuidePress, function (n) {
                t.guideButton = n;
              }),
            ];
          module1343.default.setNavigation(this, globals.isRTL ? n.reverse() : n, this.onNavigationBackPress);
        },
      },
      {
        key: 'initActionShow',
        value: function () {
          if (this.initAction == module1192.EditAction.Name) {
            var t;
            if (this.state.mapStatus == module381.MapStatus.Has_WithSegments)
              if ((module393.isMiApp || module390.default.isRoomNameSupported()) && !module391.default.isShareUser()) {
                if (!(null == (t = this.editMenu)))
                  t.setState({
                    currentAction: module1192.EditAction.Name,
                  });
                this.onPressRoomNameButton();
              }
            this.initAction = module1192.EditAction.None;
          }
        },
      },
      {
      ...
      },
      {
        key: 'isCustomName',
        value: function () {
          return this.state.action == module1192.EditAction.Name;
        },
      },
      {
              ...
              for (;;)
                switch ((p.prev = p.next)) {
                  ...
                  case 35:
                    p.prev = 35;
                    p.t0 = p.catch(28);
                    l = module1343.default.errorText(p.t0.data.error ? p.t0.data.error.code : 0);
                    this.showToast(l);
      ...
      },
      {
        ...
        value: function (t) {
          ...
          for (var u = 0, l = module1120.MAX_BLOCK_NO * module1120.MAX_BLOCK_NO; s.size > 0; ) {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          return n
            ? n
                .slice(t * module1120.MAX_BLOCK_NO, (t + 1) * module1120.MAX_BLOCK_NO - 1)
                .map(function (t, n) {
                  return 1 == t ? n : -1;
                })
                .filter(function (t) {
        ...
        value: function () {
          var t = this,
            ...
            o = React.default.createElement(module1118.MapView, {
              ...
              inBlockMode: true,
              hideAccessory: true,
              blockBubbleShowInfo: module1118.BlockBubbleShowInfo.DISPLAYNAME,
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module1192.default, {
              type: module1192.MenuType.Menu_Zone,
              ref: function (n) {
                return (t.editMenu = n);
              },
              hasConfirmMenu: true,
...
exports.default = H;
H.contextType = module1193.AppConfigContext;
