...
exports.fixDeviceScreenHeight = function () {
  ...
  if (D) 'ios' != module13.Platform.OS ? (H >= 10065 ? we() : !ie && we()) : ie && De();
...
var oe = D ? 'no supported' : S.clientID;
exports.appClientID = oe;
var re = D ? '' : S.iotType;
exports.iotType = re;
var ae = D ? 0 : S.memory ? S.memory : 0;
exports.systemMemorySize = ae;
var ie = D && H >= 10051 && C.isPad;
exports.isWindowDisplay = ie;
var ce = D ? '' : S.userScope;
exports.userScope = ce;
...
function fe(n, t, o) {
  if (D)
    require('./1483').downloadFile(n, t, function (n, t) {
      o(n, t);
    });
  else
