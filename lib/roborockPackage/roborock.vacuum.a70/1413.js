...
var module1417 = (function (t) {
    ...
    (o = R.call(this, t)).onPressBubble = function () {
      if (1 != o.state.showAsReminder)
        if (o.state.photoStatus == Y.FAILED) {
          o.requestPhoto();
          module1414.clearTimeout(o.timer);
          return void (o.timer = module1414.setTimeout(o.hideName.bind(module8.default(o)), U));
        } else {
  ...
  module7.default(T, [
    ...
    },
    {
      key: '_obName',
      value: function (t) {
        var o = module1337.obstacleNames[t];
    ...
    },
    {
      ...
      value: function () {
        ...
        this.timer = module1414.setTimeout(this.hideName.bind(this), U);
    ...
    },
    {
      ...
      value: function () {
        module1414.clearTimeout(this.timer);
      ...
      value: function () {
        if (this.props.mapDeg % 360 == 0) {
          ...
          if ('ai' == this.props.popBoxType && this.state.photoStatus != Y.REMINDER) {
            ...
            if (o.x < 80) n = 80;
            if (o.x > t - 80) n = -80;
            var l = 74 + module1337.AppBarMarginTop + (module13.StatusBar.currentHeight || 0) + 80 + 160 + 30;
            if (o.y < l) s = l - o.y;
            if (n || s) this.props.parent.props.parent.moveMap(n, s);
          }
        }
    ...
    },
    {
      ...
      value: function () {
        ...
        if (this.state.photoStatus == Y.REMINDER) t = this.getInnerImageView(require('./1416'));
        else if (this.state.photoStatus == Y.FINISHED) t = this.getInnerImageView(this.state.photoSource);
        else if (this.state.photoStatus == Y.FAILED) t = this.getInnerFailedView(require('./1417'), module510.button_title_retry);
        return t;
      },
    },
    {
      ...
      value: function () {
        ...
        var s = this._obName(this.props.type) + t,
          module1418 = React.default.createElement(V, {
            resizeMode: 'stretch',
            style: J.innerPhotoArrowImg,
            source: require('./1418'),
          }),
          module1419 = React.default.createElement(
            B,
          ...
          React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                this.state.photoStatus == Y.REMINDER ? h : module1419
              )
            ),
            React.default.createElement(
              B,
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return React.default.createElement(module1398.default, {
    ...
    },
    {
      ...
      value: function () {
        ...
        var p = 1 == this.props.showAsBlackWall ? 2 : module1120.Config.size.objectsRadius,
          l = 1 == this.props.showAsBlackWall ? 2 : module1120.Config.size.objectsRadius,
          h = p * this.props.transform.xx,
          u = l * this.props.transform.yy,
          c = 5 * this.props.transform.xx,
          b = 5 * this.props.transform.yy,
          module1420 = React.default.createElement(
            B,
            {
              pointerEvents: 'auto',
              style: {
        ...
        return React.default.createElement(
          ...
          this.props.showDeleteButton && !this.props.showAsBlackWall && module1420
        );
      },
    },
    {
...
exports.MapObjectView = module1417;
module1417.contextType = module1193.AppConfigContext;
