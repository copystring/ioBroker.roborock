...
function C(t) {
  ...
  return function () {
    ...
    if (s) {
      var l = module12(this).constructor;
  ...
  N = (function (h) {
    ...
    function f(s, l) {
      ...
      c._getOutermostParentListRef = function () {
        return c._isNestedWithSameOrientation() ? c.context.virtualizedList.getOutermostParentListRef() : module8(c);
      };
      ...
      c._defaultRenderScrollComponent = function (s) {
        ...
        return c._isNestedWithSameOrientation() ? (
          ...
          (module14('boolean' == typeof s.refreshing, '`refreshing` prop must be set as a boolean in order to use `onRefresh`, but got `' + JSON.stringify(s.refreshing) + '`'),
          (<module261 />))
        ) : (
          <module261 />
        );
      ...
      c._getFrameMetricsApprox = function (t) {
        ...
        module14(!n, 'Should not have to estimate frames when a measurement metrics function is provided');
        return {
      ...
      c._getFrameMetrics = function (t) {
        var s = c.props,
          ...
          h = s.getItemLayout,
          u = s.keyExtractor;
        module14(l(n) > t, 'Tried to get frame for out of range index ' + t);
      ...
      module14(s.windowSize > 0, 'VirtualizedList: The windowSize prop must be present and set to a value greater than 0.');
    ...
    module7(f, [
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if ((module14(p >= 0 && p < l(n), 'scrollToIndex out of range: requested index ' + p + ' but maximum is ' + (l(n) - 1)), !c && p > this._highestMeasuredFrameIndex)) {
            module14(
              !!h,
      ...
      },
      {
        ...
        value: function (t, s, n, o) {
          ...
          return s
            ...
            : void module14(false, 'VirtualizedList: Either ListItemComponent or renderItem props are required but none were found.');
        },
      },
      {
        key: 'render',
