  ...
  U = (function (t) {
    ...
    function M(t) {
      ...
      n.renderListRow = function (t) {
        ...
        var p = React.default.createElement(module13.Image, {
            style: j.rightArrow,
          ...
          w = React.default.createElement(
            ...
            React.default.createElement(module1950.default, {
              uri: 'https://' + n.host + u.listImage + '?random=' + _.getMonth() + _.getDate() + _.getHours(),
              style: j.listImage,
              errorImageSize: 'small',
            })
          ),
          k = module510.dust_collection_life9.templateStringWithParams({
            time: n.getTimes(f, u.total),
          }),
          T = h > N,
          v = h <= N && h > I,
          C = h <= I,
          L = T ? module510.dust_collection_life10 : v ? module510.dust_collection_life11 : module510.dust_collection_life12,
          P = T ? '#007aff' : v ? '#ee8b00' : '#e22920',
          V = !u.isNeedTime || u.isNeedState || u.isUnitsTime ? (u.isNeedState ? L : u.subTitle) : k,
          D = !u.isNeedTime && u.isNeedState ? '' : (h < 0 ? 0 : h) + '%',
          B = h <= 0 ? '#e22920' : n.context.theme.supplies.maximumTrackTintColor;
                ...
                React.default.createElement(
                  ...
                  u.isNeedTime || u.isNeedState
                    ? React.default.createElement(
                        ...
                        React.default.createElement(module1988.default, {
                          style: {
                            flex: !u.isNeedTime && u.isNeedState ? 8.5 : 7,
                          },
                          value: h / 100,
                          minimumTrackTintColor: P,
                          maximumTrackTintColor: B,
                        }),
                        !globals.isRTL &&
                          React.default.createElement(
                            module13.View,
                  ...
                  u.isNeedTime && u.isUnitsTime
                    ? React.default.createElement(
                        ...
                        module510.localization_strings_Setting_Supplies_index_6.templateStringWithParams({
                    ...
                    ? React.default.createElement(
                        module13.Text,
                        {
                          style: [
                            j.rowHours,
                            {
                              color: C ? 'red' : n.context.theme.supplies.itemSubTitleColor,
                            },
                          ],
                        },
                        V
      ...
      n.isUnmount = false;
      n.host = module1337.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].host;
      return n;
    }
    ...
    module7.default(M, [
      {
        ...
        value: function () {
          var t = this;
          this.fetchData();
          this.consumableResetListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.DidReceiveSpecialEvent, function (n) {
            if (n.data == module420.EventKeys.ConsumableReset) t._refresh();
          });
        },
      },
      {
              ...
              for (;;)
                switch ((w.prev = w.next)) {
                  ...
                  case 20:
                    ...
                    globals.showToast(module510.localization_strings_Setting_CleanModePage_3);
      ...
      },
      {
        ...
        value: function (t) {
          ...
          var l = s <= N && s > I,
            u = s > N ? module510.dust_collection_life10 : l ? module510.dust_collection_life11 : module510.dust_collection_life12,
            c = {
              ...
              stateText: module510.dust_collection_life13.templateStringWithParams({
                state: u,
              }),
            };
      ...
      },
      {
        ...
        value: function () {
          globals.showToast(module510.rubys_supplies_wait_tips);
        },
      },
    ]);
    return M;
...
exports.default = U;
U.contextType = module1193.AppConfigContext;
var j = module13.StyleSheet.create({
  ...
  buyButton: {
    width: 0.8 * module13.Dimensions.get('window').width,
    height: 40,
    justifyContent: 'center',
    borderRadius: 6,
