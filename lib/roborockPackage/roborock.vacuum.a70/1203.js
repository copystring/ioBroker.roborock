...
module.exports = function (f) {
  if (!f) throw new Error(module1201.default(t));
  var p = f.viewName,
    s = f.propOverrides,
  ...
  h(p);
  var M = l(p),
    N = module13.UIManager[M];
  if (!M || !N) return b;
  var I = n({}, f, {
      mock: y || {},
      moduleName: M + 'Manager',
    }),
    C = module1200.default(I),
    k = O(N.Constants || {});
  ...
  var x = module13.requireNativeComponent(M),
    A = x;
  ...
  if (
    ((A.runCommand = function (n, t) {
      ...
      return module13.Platform.select({
        android: function () {
          return module13.UIManager.dispatchViewManagerCommand(module13.findNodeHandle(n), module13.UIManager[M].Commands[t], c);
        },
        ios: function () {
          return C[t](module13.findNodeHandle(n), ...c);
        },
        default: function () {},
      })();
    }),
    (A.updateView = function (n, t) {
      var u = function () {
        return module13.UIManager.updateView(module13.findNodeHandle(n), M, t);
      };
