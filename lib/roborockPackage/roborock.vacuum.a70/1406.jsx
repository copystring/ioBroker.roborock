...
var React = require('react'),
  ...
  w = module1410.RRSurface,
  k = module1410.isRRSurface,
    ...
    module7.default(l, [
      {
        ...
        value: function (t, n, o) {
          ...
          var s,
            ...
            A,
            b,
            S = module390.default.isMopPathSupported() && this.props.pathData && this.props.pathData.mopData,
          ...
          if (null == (A = this.props) ? undefined : null == (b = A.pathData) ? undefined : b.planPoints) {
            var z,
              Z,
              q = module1333._parseGotoPlanPath(this.props.pathData.planPoints, null == (z = this.props) ? undefined : null == (Z = z.pathData) ? undefined : Z.offset, M);
          ...
          if ('' != L.pathGotoPlan)
            B = (
              <module1407.RRShape
                ...
                stroke={module1411.map.pathGotoPlan}
                strokeWidth={1}
          ...
          var H = null;
          if (C && '' != C.path)
            H = <module1407.RRShape transform={'android' != module13.Platform.OS || k ? module6 : null} stroke={this.context.theme.map.pathColor} strokeWidth={0.5} d={C.path} />;
          var J = null;
          if (_ && '' != _.mopPath)
            J = (
              <module1407.RRShape
...
var V = (function (t) {
  ...
  function l(t) {
    ...
    s.pathPoints = [];
    s.speed = C;
    s.status = module1120.RobotAnimationStatus.DEFAULT;
    return s;
  }
  ...
  module7.default(l, [
        ...
        return (
          ...
          >
            ...
            {React.createElement(
              ...
              React.createElement(module1408, {
                resizeMethod: 'scale',
                source: S,
                style: {
                  width: 10.8 * I.xx,
    ...
    },
    {
      ...
      value: function () {
        ...
        else if (this.status != module1120.RobotAnimationStatus.PAUSED) {
          if (this.status != module1120.RobotAnimationStatus.DEFAULT || this.props.autoAnimated)
            if (this.pathPoints.length > this.currentIndex + 1) {
              this.pathPoints.length;
              this.currentIndex;
              this.run();
            } else {
              if (this.status == module1120.RobotAnimationStatus.ANIMATING && !this.props.autoAnimated) {
                this.status = module1120.RobotAnimationStatus.DEFAULT;
    ...
    },
    {
      key: 'pause',
      value: function () {
        if (this.status == module1120.RobotAnimationStatus.ANIMATING) this.status = module1120.RobotAnimationStatus.PAUSED;
      },
    },
    {
      key: 'play',
      value: function () {
        if (this.status == module1120.RobotAnimationStatus.PAUSED) this.status = module1120.RobotAnimationStatus.ANIMATING;

        if (this.status == module1120.RobotAnimationStatus.DEFAULT) {
          this.reset(true);
          this.status = module1120.RobotAnimationStatus.ANIMATING;
        }
      },
    },
    {
