                  ...
                  switch ((s.prev = s.next)) {
                    case 0:
                      ...
                      this.resultTimerList.forEach(function (t) {
                        if (!(module1638.isTimerExpiredByRepeatMode(t.repeatMode, t.fullDate + ':59') && 0 != module381.RSM.FCCState)) module23.push(t);
                      });
                  ...
                  switch ((v.prev = v.next)) {
                    case 0:
                              ...
                              switch ((o.prev = o.next)) {
                                case 0:
                                  if (
                                    ...
                                    (S = module1637.ConvertToReadableFormat(s.setting.on_time)),
                                    (L = module1638.fixTargetTime(S)),
                                    (O = module1638.convertToPhoneTimeZoneTime(S.minute, S.hour, S.dateofmonth, S.month)),
                                    (w = O.hour),
                                    (k = O.minute),
                                    (P = new Date()),
                                    (M = P.getFullYear()),
                                    1 == O.month && 1 == O.day && P.getMonth() + 1 == 12 && 31 == P.getDate() && (M += 1),
                                    (R = '' + M + module1638.addZeroPrefix(O.month) + module1638.addZeroPrefix(O.day)),
                                    (D = R + ' ' + module1638.addZeroPrefix(w) + ':' + module1638.addZeroPrefix(k)),
                                    !(C = module1638.isTimerExpired(S.repeat, D + ':59', false)))
                                  ) {
                                    o.next = 20;
                                    break;
                                  }

                                  module1638.deleteServerTimer(s, h);
                                  console.log('task is outOfDate - date-' + D + ' - ' + h + ' - ' + C);
                                  return o.abrupt('return');

                                case 20:
                                  if ((F = module1638.getRepeatMode(S.repeat, false)) != module1638.RepeatMode.Once)
                                    O.month == L.month
                                      ? O.day == L.day + 1
                                        ? (F = module1638.getDaysArrByOffset(F, 1))
                                        : O.day == L.day - 1 && (F = module1638.getDaysArrByOffset(F, -1))
                                      : (F = 1 == O.day ? module1638.getDaysArrByOffset(F, 1) : module1638.getDaysArrByOffset(F, -1));
                                  _ = module1638.timerRepeatToCronRepeat(F);
                                  N = module1638.getTextOfRepeatPattern(_, R, false);
                                  J = module1638.addZeroPrefix(O.hour) + ' : ' + module1638.addZeroPrefix(O.minute);
                                  Z = module1638.convetToWeekendsByStartTime(F, S.dateofmonth, S.month);
                                  j = T(
                                    {
                                      name: h,
                                      hour: O.hour,
                      ...
                      module6.forEach(function (t) {
                        ...
                        if (s) module1635.push(s);
                      });
                      this.miTimerScenes = module1635;
                    ...
                    switch ((B.prev = B.next)) {
                      ...
                      case 6:
                        if (
                          ...
                          (O = S[1]),
                          '00000000' == s.date &&
                            ((w = new Date()), (s.date = '' + w.getFullYear() + module1638.addZeroPrefix(w.getMonth() + 1) + module1638.addZeroPrefix(w.getDate()))),
                          (k = s.date + ' ' + s.time),
                          (P = module1635.default(k, 'YYYYMMDD HH:mm')),
                          console.log('date date - ' + P.date() + ' - ' + (P.month() + 1)),
                          (M = module1638.convertTimeFromSourceZoneToPhoneZone(O, L, P.date(), P.month() + 1, module393.robotTimeZone)),
                          (L = M.hour),
                          (O = M.minute),
                          (k = s.date + ' ' + module1638.addZeroPrefix(L) + ' : ' + module1638.addZeroPrefix(O)),
                          !module1638.isTimerExpired(s.loops, k + ':59', true))
                        ) {
                          B.next = 22;
                          break;
                        }
                        ...
                        B.next = 20;
                        return regeneratorRuntime.default.awrap(module1638.deleteServerTimer(s.timerId, y));

                      case 20:
                        console.log('task is outOfDate - date-' + s.date + ' ' + s.time + ' - ' + module1638.isTimerExpired(s.loops, k + ':59', true));
                        return B.abrupt('return');

                      case 22:
                        R = module1638.getRepeatMode(s.loops, true);
                        R = module1638.resolveRepeatModeByTargetTime(R, P.month() + 1, P.date(), M.month, M.day);
                        R = module1638.getRepeatMode(R, true);
                        D = module1638.getTextOfRepeatPattern(R, s.date, true);
                        C = module1638.convetToWeekendsByStartTime(R, M.dateofmonth, M.month);
                        ...
                        _ = T(
                          {
                            ...
                            date: s.date,
                            timerId: s.timerId,
                            cleanTime: module1638.addZeroPrefix(L) + ' : ' + module1638.addZeroPrefix(O),
                            repeatMode: R,
                            repeatModeText: D,
                            startWeekdays: C,
                            disable: F,
                            ...
                            for (;;)
                              switch ((o.prev = o.next)) {
                                case 0:
                                  ...
                                  T = p[0];
                                  v = p[1];
                                  x = module1637.ConvertToReadableFormat(T);
                                  S = 0;
                                  L = [];
                                  O = 0;
                                  w = 0;
                                  ...
                                  Z = '' + new Date().getFullYear() + module1638.addZeroPrefix(x.month) + module1638.addZeroPrefix(x.dateofmonth);
                                  j = Z + ' ' + module1638.addZeroPrefix(x.hour) + ':' + module1638.addZeroPrefix(x.minute);
                                  I = module1638.getRepeatMode(x.repeat, false);
                                  B = module1638.getTextOfRepeatPattern(x.repeat, Z, false);
                                  E = module1638.addZeroPrefix(x.hour) + ' : ' + module1638.addZeroPrefix(x.minute);
                                  H = module1638.convetToWeekendsByStartTime(I, x.dateofmonth, x.month);
                                  A = {
                                    name: l,
                                    hour: x.hour,
                                    minute: x.minute,
                ...
                for (;;)
                  switch ((u.prev = u.next)) {
                    case 0:
                      ...
                      u.next = 4;
                      return regeneratorRuntime.default.awrap(module1638.deleteServerTimer(module50, module23.name));
                    ...
                    case 3:
                      if (this.resultTimerList)
                        this.resultTimerList.forEach(function (s) {
                          var o = module1637.GetExecDate(s.hour, s.minute, module1638.timerRepeatToCronRepeat(s.repeatMode)),
                            u = new Date();
