...
var y = React.forwardRef(function (t, o) {
    var l = React.useContext(module1193.AppConfigContext).theme,
      C = t.cleanIconMode,
      module1624 = undefined === C ? 'start' : C,
      p = t.dockIconMode,
    ...
    var G = [
        S(
          S({}, module1623.getNewCollectButtonConfig(x, l)),
          {},
          {
        ...
        S(
          S({}, module1623.getNewWashButtonConfig('start', l)),
          {},
          {
      ...
      K = S(
        S({}, module1623.getNewDryButtonConfig(D, l)),
        {},
        {
    ...
    var V = module13.Dimensions.get('window').width,
      U = 0.6 * (V - 3 * module1428.HorizontalMargin),
      F = 0.4 * (V - 3 * module1428.HorizontalMargin),
      q = (V - module1428.HorizontalMargin * (G.length + 2) - 43) / G.length,
      J = function () {
        v.current.scrollTo({
          x: 0,
          y: 0,
      ...
      Q = S(
        S({}, module1623.getDockButtonConfig(R, l)),
        {},
        {
      ...
      Y = S(
        S({}, module1623.getCleanButtonConfig(module1624, l)),
        {},
        {
        ...
        module1402.BoxShadow,
        {
          setting: S(
            ...
            {},
            {
              width: 43,
              style: {
                marginLeft: 2 * module1428.HorizontalMargin,
                bottom: 20,
              },
            }
          ),
