...
var R = (function (t, ...args) {
  ...
  function x() {
    ...
    (t = y.call(this, ...args)).setNativeProps = function (n) {
      var f = !n.matrix && module1353.default(n);
      if (f) n.matrix = f;
      module22.default(n, module1357.pickNotNil(module1371.default(n, true)));
  ...
  module7.default(x, [
    {
      ...
      value: function () {
        var t = this.props,
          ...
          R = u && u.match(module1357.idPattern),
          E = R && R[1];

        if (E) {
          var _ = module1346.default(
            k(
              k({}, module1346.propsAndStyles(D)),
              {},
              {
                x: null,
                y: null,
