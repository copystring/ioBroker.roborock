  ...
  F = (function (t) {
    ...
    function W(t) {
      ...
      (o = B.call(this, t)).state = {
        structureLightSwitch: module1633.default.cameraEnabled,
        avoidCollisionSwitch: false,
        loading: false,
        refreshing: false,
        mapObjectPhotoEnabled: module1633.default.mapObjectPhotoEnabled,
        sceneSwitch: false,
        isShow: false,
      };
    ...
    module7.default(W, [
      {
        ...
        value: function () {
          ...
          module1633.default.addChangeListener(this.changeListener);
      ...
      },
      {
        ...
        value: function () {
          this.mounted = false;
          module1633.default.removeChangeListener(this.changeListener);
        },
      },
      {
            ...
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 3:
                    module1633.default.cameraEnabled = t;
                    if (!t) module1633.default.explorationEnabled = t;
                    this.setState({
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    module22 = 0 == t;
                    s.next = 4;
                    return regeneratorRuntime.default.awrap(module1633.default.updatePetModeEnabled(module22));
        ...
        value: function () {
          ...
          var l = module13.Dimensions.get('window').width - 30,
            ...
            h = {
              ...
              rightCenter: true,
              detailColor: 0 == module1633.default.ledSetting ? '#007AFF' : this.context.theme.subTextColor,
              detail: 0 == module1633.default.ledSetting ? module510.led_status_title2 : module510.debug_info_close,
            ...
            _ = {
              ...
              isDetailCenter: false,
              rightCenter: true,
              detailColor: module1633.default.cameraEnabled ? '#007AFF' : 'rgba(0,0,0,0.4)',
              detail: module1633.default.petModeEnabled ? module510.has_or_no_has : module510.has_or_no_no,
            ...
            F = {
              ...
              onPress: function () {
                return t.props.navigation.navigate('WebViewPage', {
                  ...
                  refrence: module1648.default.PhotoPrivacy(),
                  buttonTitle: module1633.default.mapObjectPhotoPrivacyPolicyAgreed ? module510.reset_authoration : module510.button_title_agree,
                  buttonColor: module1633.default.mapObjectPhotoPrivacyPolicyAgreed ? 'red' : '#007AFF',
                  ...
                  buttonAction: function (o) {
                    if (module381.RSM.isRunning && module1633.default.mapObjectPhotoPrivacyPolicyAgreed)
                      o.alertView &&
                      ...
                      var s = function () {
                        ...
                        module393
                          .postPrivacyAgreementStatusWithVersion(
                            ...
                            module1633.default.mapObjectPhotoPrivacyPolicyAgreed ? 5 : 4,
                            1
                          )
                          .then(function (t) {})
                          .catch(function (t) {});
                        module1633.default.updatePhotoPrivacy(!module1633.default.mapObjectPhotoPrivacyPolicyAgreed, function (n) {
                          if (
                            ...
                            if ('' != (s = module1633.default.mapObjectPhotoPrivacyPolicyAgreed ? '' : module510.map_object_cancel_privacy_success)) globals.showToast(s);
                            ...
                            LogEventCommon(module1633.default.mapObjectPhotoPrivacyPolicyAgreed ? 'accept_photo_privacy' : 'reset_photo_privacy_confirm');
                          } else {
                            var s = module1633.default.mapObjectPhotoPrivacyPolicyAgreed ? module510.map_object_cancel_privacy_timeout : module510.map_object_ignore_failed;
                            if (o) globals.showToast(s);
                          }
                        });
                      };

                      if (module1633.default.mapObjectPhotoPrivacyPolicyAgreed) {
                        if (o.alertView)
                          o.alertView.customAlert(
            ...
            q = React.default.createElement(module1928.PhotoFeaturePrivacyDialog, {
              ref: function (o) {
              ...
              onConfirm: function () {
                return module1633.default.updatePhotoPrivacy(true, function (o) {
            ...
            Q = F.visible
              ...
              : React.default.createElement(module13.View, null),
            X = module1389.titleBarContentHeight,
            Y =
              module391.default.iOSAndroidReturn(X + module1337.StatusBarHeight + module1337.AppBarMarginTop, (module13.StatusBar.currentHeight || 0) + X) +
            ...
            function (c) {
              for (;;)
                switch ((c.prev = c.next)) {
                  ...
                  case 3:
                    if (module1633.default.cameraEnabled) {
                      c.next = 6;
                      break;
                    }
                  ...
                  case 6:
                    ...
                    module22 = module1633.default.mapObjectPhotoPrivacyPolicyAgreed;
                    c.next = 10;
                  ...
                  case 27:
                    ...
                    module1633.default.mapObjectPhotoEnabled = t;
                    c.next = 31;
                    return regeneratorRuntime.default.awrap(module1633.default.updateCameraStatus());
      ...
      },
      {
        ...
        value: function (t) {
          var o = this;
          module1633.default.updateLedSetting(t, function (t) {
