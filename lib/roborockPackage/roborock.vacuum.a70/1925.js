  ...
  W = (function (t) {
    ...
    module7.default(W, [
      ...
      },
      {
        ...
        value: function () {
          var t = this.state.tab,
            n = t == module1620.TabSegment,
            o = t == module1620.TabZone,
          ...
          return module381.RSM.hasGotMapFirstTime
            ? React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  module381.RSM.isExploring && React.default.createElement(module1926.default, null)
                )
              )
            : null;
        },
      ...
      },
      {
        key: 'isOnlyMopMode',
        value: function (t, n) {
          return module390.default.isPureCleanMopSupported() && module381.RSM.fanPower == module1618.CleanModeZero;
        },
      },
      {
...
var D = module13.StyleSheet.create({
  wrapContainer: {
    height: 200,
    marginBottom: -module1428.TabWrapHeight,
  },
  container: {
    flexDirection: 'row',
  ...
  leftContainer: {
    marginBottom: module1428.TabWrapHeight + 10,
    marginLeft: 22,
  },
  loadMapButton: {
