...
var module510 = require('./510').strings,
  module2200 = (function (t) {
    ...
    function T(t) {
      ...
      (n = module2202.call(this, t)).state = {};
      return n;
    }
    ...
    module7.default(T, [
      ...
      },
      {
        ...
        value: function () {
          return module381.RSM.isCleaning() ? require('./2200') : require('./2201');
        },
      },
      {
        key: 'getCleanButtonTitle',
        value: function () {
          return module381.RSM.isCleaning() ? module510.localization_strings_Common_Constants_11 : module510.localization_strings_Main_MainPage_3;
        },
      },
      {
        key: 'getChargeButtonImage',
        value: function () {
          return module381.RSM.state == module381.RobotState.BACK_TO_DOCK ? require('./2200') : require('./2202');
        },
      },
      {
        key: 'render',
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module385.TopImageButton, {
              ...
              fontSize: 12,
              textColor: '#fff',
              title: module510.localization_strings_Main_MainPage_3,
            ...
            React.default.createElement(module385.TopImageButton, {
              ...
              imageWidth: 50,
              imageHeight: 50,
              title: module510.localization_strings_Main_MainPage_1,
              textTop: 5,
              fontSize: 12,
              textColor: '#fff',
            ...
            function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  ...
                  case 9:
                    module381.RSM.preMockState = module381.RobotState.CLEAN;
                  ...
                  case 16:
                    module381.RSM.preMockState = module381.RobotState.SEGMENT_CLEAN;
                    t.next = 36;
                    break;
                  ...
                  case 28:
                    module381.RSM.preMockState = module381.RobotState.ZONED_CLEAN;
                    t.next = 36;
                    break;
