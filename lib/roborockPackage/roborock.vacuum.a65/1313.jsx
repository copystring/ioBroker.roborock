  ...
  function P() {
    ...
    n._renderTabBar = function (t) {
      var o = n.props.navigation.state,
        ...
        p = n.props,
        f = p.tabBarComponent,
        b = undefined === f ? module1325.default : f,
        h = p.tabBarPosition,
        x = p.tabBarOptions;
    ...
    n._renderScene = function (t) {
      ...
      if (c) {
        ...
        if (p)
          return (
            <module1312.default isVisible={y}>
              {l({
                route: o,
              })}
            </module1312.default>
...
module1220.polyfill(P);
var w = module1307.default(P);
exports.default = w;
