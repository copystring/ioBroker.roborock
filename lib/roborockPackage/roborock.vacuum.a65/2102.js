    ...
    module7.default(T, [
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            o = module1350.default.confirmButton(this.onNavigationSavePress, false, function (n) {
              t.mapSaveButton = n;
            }),
            s = this.showSmartMenu ? [n] : [o];
          module1350.default.setNavigation(this, globals.isRTL ? s.reverse() : s, this.onNavigationBackPress.bind(this));
        },
      },
      {
        key: 'initMapView',
          ...
          return regeneratorRuntime.default.async(
            function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    if (module390.default.isSupportCustomModeInCleaning()) module1350.default.endEditMap();
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module1350.default.isEditedByArrays(this.originalCleanWaterModeMaps, this.cleanWaterModeMaps)) {
            var n,
              o = {
        ...
        value: function () {
          var t = this,
            ...
            o = React.default.createElement(module1125.MapView, {
              ...
              inBlockMode: true,
              hideAccessory: true,
              blockBubbleShowInfo: module1125.BlockBubbleShowInfo.DISPLAYNAME | module1125.BlockBubbleShowInfo.CLEANMODE,
              selectedBlocksDidChange: this.handleSelectedBlocksDidChange,
              didTapBlockInCustomMode: this.didTapBlockInCustomMode,
            }),
            s = React.default.createElement(module1199.default, {
              type: module1199.MenuType.Menu_Mode,
              ref: function (n) {
                return (t.editMenu = n);
              },
            ...
            u = React.default.createElement(module1199.default, {
              type: module1199.MenuType.Menu_Mode_Smart,
              ref: function (n) {
                return (t.editMenu = n);
              },
              hasConfirmMenu: true,
          ...
          var f = this.state.isResetCustomModeEnable,
            M = module1350.default.resetButton(module510.reset_clean_mode_button_title, f, this.onResetButtonPressed);
