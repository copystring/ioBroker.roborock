  ...
  q = (function (t) {
    ...
    function V(t) {
      ...
      (n = L.call(this, t)).gotoZoneInfoPage = function () {
        n.props.navigation.navigate('MapEditZoneInfoPage', {
          ...
          initAction: module1199.EditAction.Name,
        });
      };
    ...
    module7.default(V, [
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = module1350.default.guideButton(this.onNavigationGuidePress, function (n) {
              t.guideButton = n;
            }),
            s = module1350.default.confirmButton(this.onNavigationSavePress, false, function (n) {
              t.mapSaveButton = n;
            }),
            o = this.showSmartMenu ? [n] : [s];
          module1350.default.setNavigation(this, globals.isRTL ? o.reverse() : o, this.onNavigationBackPress.bind(this));
        },
      },
      {
        key: 'initMapView',
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module1350.default.isEditedByArrays(this.originalSelectedSegements, this.selectedSegements)) {
            var n,
              s = {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            s = React.default.createElement(module1125.MapView, {
              ref: function (n) {
                t.mapView = n;
              },
              ...
              inBlockMode: true,
              hideAccessory: true,
              blockBubbleShowInfo: module1125.BlockBubbleShowInfo.CLEANSEQUENCE | module1125.BlockBubbleShowInfo.DISPLAYNAME,
            ...
            o = React.default.createElement(module1199.default, {
              type: module1199.MenuType.Menu_Order,
              ref: function (n) {
                return (t.editMenu = n);
              },
              onPressGuideButton: this.onNavigationGuidePress,
            }),
            u = React.default.createElement(module1199.default, {
              type: module1199.MenuType.Menu_Order_Smart,
              ref: function (n) {
                return (t.editMenu = n);
              },
              hasConfirmMenu: true,
          ...
          var h = module1350.default.resetButton(module510.reset_order_button_title, this.state.isResetOrderEnable, this.onResetButtonPressed);
...
exports.default = q;
q.contextType = module1200.AppConfigContext;
