        ...
        value: function (t) {
          var n = t ? 1 : 0,
            u = module390.default.isMultiFloorSupported()
              ...
              : n;
          return new module1349.default(function (n, o) {
            module416.default
              .setLabStatus(u)
              .then(function () {
  ...
  module7.default(o, [
    {
      key: 'getData',
      value: function () {
        return new module1349.default(function (t, n) {
          module416.default
            .getRecoverMaps()
            .then(function (n) {
              var u = n.result,
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return new module1349.default(function (u, o) {
          var c = {
            map_index: t,
          };
  ...
  module7.default(c, [
    {
      key: 'getData',
      value: function () {
        return new module1349.default(function (t, u) {
          module416.default
            .getMultiMapsList()
            .then(function (u) {
                ...
                c = o.map_info
                  .map(function (t) {
                    return {
                      id: t.mapFlag,
                      time: t.add_time,
                      name: t.name ? module1215.FloorMapPageUtils.getRealName(t.name) : '' + module510.floor_map_default_name_prefix + (t.mapFlag + 1),
                      length: t.length,
                    };
                  })
                  .sort(function (t, n) {
