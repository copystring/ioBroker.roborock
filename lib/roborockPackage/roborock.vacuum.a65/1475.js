...
var _ = module13.ART.Transform,
  ...
  x = module1127.Config.size.objectsRadius,
  z = (function (t) {
    module9.default(R, t);
    ...
    module7.default(R, [
          ...
          if ((null == (o = this.props.stuckPoints) ? undefined : o.length) > 0) {
            ...
            return null == (u = this.props.stuckPoints)
              ...
              : u.map(function (o, u) {
                  if (o.nearby) {
                    ...
                    return React.default.createElement(
                      ...
                      module22.default(
                        {
                          key: u,
                          onPress: l.onPressSmartZone.bind(l, module1127.SmartBubbleType.BT_STUCK, o, c),
                        },
                  ...
                  var v = module1340._pointToStuckRect(o),
                    k = {
                      rectSize: v,
                      slopeAngle: 0,
                    };
                  ...
                  return React.default.createElement(module1211.RectZone, {
                    ...
                    innerImage: module1127.MapAITag,
                    handlePanShouldStart: l.onPanShouldStart,
                    handlePanOnStart: l.onPressSmartZone.bind(l, module1127.SmartBubbleType.BT_STUCK, o, k),
                  });
                });
          }
      ...
      },
      {
        ...
        value: function (t) {
          var o,
            l = this;
          if (!module1198.canEditDoorSill()) return null;
          var u =
            ...
            : u.map(function (o, u) {
                ...
                return React.default.createElement(
                  ...
                  module22.default(
                    {
                      key: u,
                      onPress: l.onPressSmartZone.bind(l, module1127.SmartBubbleType.BT_DOORSILL, o, c),
                    },
