...
var z = (function (t, ...args) {
  ...
  function z() {
    ...
    t.repeat = 1;
    t.state = {
      mode: module1970.SmartSceneMode.GlobalClean,
      customMode: {
        cleanMode: module381.RSM.fanPower || 102,
        waterMode: module381.RSM.waterBoxMode || 202,
        mopMode: module381.RSM.mopMode == module1625.CleanRouteFastMode ? module1625.CleanRouteDailyMode : module381.RSM.mopMode || 301,
      },
      repeat: 1,
      isModeFixed: false,
  ...
  module7.default(z, [
      ...
      value: function () {
        ...
        return React.default.createElement(
          ...
          React.default.createElement(module385.SettingListItemView, {
            ...
            title: module1969.LocalizationStrings.multi_map_timer_select_map_title,
          ...
          React.default.createElement(module385.SettingListItemView, {
            title: module1969.LocalizationStrings.map_edit_custom_mode,
          ...
          this.state.mode != module1970.SmartSceneMode.GlobalClean &&
            React.default.createElement(module385.SettingListItemView, {
              title: module1969.LocalizationStrings.localization_strings_Setting_History_index_12,
          ...
          React.default.createElement(
            ...
            n &&
              React.default.createElement(module1394.default, {
                tip:
                  module381.RSM.mapStatus == module381.MapStatus.Has_WithoutSegments
                    ? module1969.LocalizationStrings.no_seg_map_tip
                    : module1969.LocalizationStrings.smart_scene_global_no_map_tip,
            ...
            !n &&
              this.state.mode == module1970.SmartSceneMode.Zone &&
              React.default.createElement(module385.TopImageButton, {
                ...
                title: module1969.LocalizationStrings.rubys_main_button_text_add,
          ...
          React.default.createElement(
            module13.TouchableWithoutFeedback,
            {
              onPress: function () {
                ...
                if (t.isConfirmEnabled) {
                  module1969.SmartSceneLog('\u4efb\u52a1\u7f16\u8f91 - \u786e\u8ba4 - ' + JSON.stringify(t.data));
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                module1969.LocalizationStrings.smart_scene_task_confirm_button_title
              )
            )
          ),
          React.default.createElement(module385.ActionSheetView, {
            ...
            actions: [
              module1969.LocalizationStrings.home_bottom_menu_global,
              module1969.LocalizationStrings.home_bottom_menu_select_zone,
              module1969.LocalizationStrings.home_bottom_menu_draw_zone,
            ],
          ...
          React.default.createElement(module382.ModeSettingPanel, {
            ...
            isTabZone: this.state.mode == module1970.SmartSceneMode.Zone,
            ...
            onPressMore: function () {
              ...
              t.props.navigation.navigate('MopModeListPage', {
                title: module1969.LocalizationStrings.custom_mode_panel_more_mode_title,
              });
            },
          }),
          React.default.createElement(module385.ActionSheetView, {
            ...
            actions: [
              '1' + module1969.LocalizationStrings.dust_collection_life14,
              '2' + module1969.LocalizationStrings.dust_collection_life14,
              '3' + module1969.LocalizationStrings.dust_collection_life14,
            ],
    ...
    },
    {
      ...
      value: function (t, n) {
        var o,
          s = this;
        module1969.SmartSceneLog('\u4efb\u52a1\u7f16\u8f91 - \u89e3\u6790\u53c2\u6570 - data: ' + JSON.stringify(t) + ', template: ' + JSON.stringify(n));
        this.originalData = t;
        this.template = n;
        var l,
          c =
    ...
    },
    {
      ...
      value: function (t) {
        ...
        var s = function () {
            ...
            if (
              (module1969.SmartSceneLog('\u4efb\u52a1\u7f16\u8f91 - \u9009\u62e9\u6e05\u6d01\u6a21\u5f0f - ' + o.state.mode),
              null == (t = o.mapView) || null == t.changeMapViewMode || t.changeMapViewMode(o.mapMode),
              o.state.mode == module1970.SmartSceneMode.Zone && 0 == o.selectedZones.length)
            ) {
              if (!(null == (n = o.mapView))) n.enterZoneEditMode();
              if (o.mapView && !o.mapView.addRectangle()) globals.showToast(module1969.LocalizationStrings.rubys_main_zone_max_tips);
            }
          },
        ...
        switch (t) {
          ...
          case 2:
            return void this.setState(
              {
                mode: module1970.SmartSceneMode.Zone,
                repeat: l,
              },
              s
            );
    ...
    },
    {
      ...
      value: function (t, n, o) {
        ...
        this.setState(
          ...
          function () {
            module1969.SmartSceneLog('\u4efb\u52a1\u7f16\u8f91 - \u9009\u62e9\u6e05\u6d01\u6863\u4f4d - ' + s.levelDescription);
          }
        );
      },
    },
    {
      ...
      value: function (t) {
        ...
        module1969.SmartSceneLog('\u4efb\u52a1\u7f16\u8f91 - \u9009\u62e9\u6e05\u6d01\u6b21\u6570 - ' + (t + 1));
        this.setState({
          repeat: t + 1,
        });
      },
    },
    {
      ...
      value: function (t) {
        var n;
        module1969.SmartSceneLog('\u4efb\u52a1\u7f16\u8f91 - \u9009\u533a - \u5f53\u524d\u9009\u4e2d\u533a\u57df ' + t);
    ...
    },
    {
      ...
      value: function () {
        ...
        if (module381.RSM.mapStatus != module381.MapStatus.None) {
          module1969.SmartSceneLog('\u4efb\u52a1\u7f16\u8f91 - \u5212\u533a');
          if (!(null == (t = this.mapView))) t.enterZoneEditMode();
          if (this.mapView && !this.mapView.addRectangle()) globals.showToast(module1969.LocalizationStrings.rubys_main_zone_max_tips);
        } else globals.showToast(module1969.LocalizationStrings.tap_zone_clean_button_without_map_tip);
      },
    },
    {
      ...
      value: function (t) {
        var n = this;
        module1969.SmartSceneLog('\u4efb\u52a1\u7f16\u8f91 - \u5212\u533a - ' + t + '\u4e2a\u533a\u57df');
        setTimeout(function () {
          var t;
          n.forceUpdate();
    ...
    },
    {
      ...
      get: function () {
        return module1969.taskNameWithMode(this.state.mode);
      },
    },
    {
      key: 'levelDescription',
      get: function () {
        return module1625.getCleanModeDetailText(this.state.customMode);
      },
    },
    {
      key: 'cleanCountDesciption',
      get: function () {
        return this.state.repeat + ' ' + module1969.LocalizationStrings.dust_collection_life14;
      },
    },
    {
      key: 'mapMode',
      get: function () {
        switch (this.state.mode) {
          case module1970.SmartSceneMode.GlobalClean:
            return module1125.MapModelInCleanMode.Global_Clean_With_Clean_Type;

          case module1970.SmartSceneMode.Segment:
          ...
          case module1970.SmartSceneMode.Zone:
    ...
    },
    {
      ...
      get: function () {
        var t = this,
          n = this.state.mode == module1970.SmartSceneMode.Segment ? this.selectedBlocks : [],
          o = this.state.mode == module1970.SmartSceneMode.Zone ? this.selectedZones : [],
          s = this.state.mode == module1970.SmartSceneMode.GlobalClean ? null : this.state.repeat;
        ...
        return this.originalData
          ? this.originalData
          : new module1969.TaskDescriptorData(
