  ...
  function _() {
    ...
    t._renderScene = function (n) {
      var o = n.route,
        ...
        E = o.key,
        w = B.getComponent();
      return React.default.createElement(module1218.ResourceSavingSceneView, {
        lazy: b,
        isFocused: C === E,
    ...
    t._renderPager = function (t) {
      return React.default.createElement(module1292.TabViewPagerPan, t);
    };
  ...
  module7.default(_, [
    {
      ...
      value: function () {
        ...
        return React.default.createElement(module1292.TabViewAnimated, E);
      },
    },
  ]);
  return _;
