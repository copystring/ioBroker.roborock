    ...
    module7.default(t, null, [
      {
        key: 'get',
        value: function (t) {
          module14.default(n[t], 'No dimension set for key ' + t);
          return n[t];
        },
      },
      {
      ...
      },
      {
        ...
        value: function (n, t) {
          module14.default('change' === n, 'Trying to subscribe to unknown event: "%s"', n);
          v.addListener(n, t);
        },
      },
      {
        ...
        value: function (n, t) {
          module14.default('change' === n, 'Trying to remove listener for unknown event: "%s"', n);
