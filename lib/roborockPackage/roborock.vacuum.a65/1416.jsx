...
var module66 = require('./66'),
  ...
  P = module13.ImageBackground;

console.warn(JSON.stringify(module13.UIManager));
if (module13.UIManager.MHImageView) P = module13.requireNativeComponent('MHImageView');
else if (module13.UIManager.RRImageView) P = module13.requireNativeComponent('RRImageView');
var z = 1;
var L = s(
  s({}, module276),
  {},
