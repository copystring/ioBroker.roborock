...
var module510 = require('./510').strings,
  ...
  module1982 = (function (t) {
    ...
    function z(t) {
      ...
      (o = module1989.call(this, t)).hasFetchedRecordCount = 0;
    ...
    module7.default(z, [
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          this.fetchData();
          this.areaUnitListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.AreaUnitChange, function (o) {
            if (!t.unMount)
              t.setState({
                areaUnit: Utils.getAreaUnit(),
              });
          ...
          this.props.navigation.setParams({
            ...
            hiddenBottomLine: !module424.DMM.isGarnet,
          });
        },
      },
      {
        key: 'testUI',
        value: function () {
          this.cleanRecords = require('./1989');
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(module1984.default, {
                style: [
                  {
                ...
                data: [
                  {
                    title: module510.localization_strings_Setting_History_index_8,
                    unit: this.getTimeUnit(),
                    value: this.state.loaded ? this.formatTimeNumber(this.state.totalTime) : '--',
                  },
                  {
                    title: module510.clean_history_total_area,
                ...
                subTitleData: [
                  {
                    title: module510.clean_history_mop_sweep,
                    unit: ' ',
                    value: this.state.loaded ? this.formatCount(this.state.totalCount) : '--',
                    icon: require('./1990'),
                  },
                  {
                    title: module510.clean_history_mop_time,
                    unit: ' ',
                    value: this.state.loaded ? this.formatCount(this.state.mopCount) : '--',
                    icon: require('./1991'),
                  },
                  {
                    title: module510.mop_mode_setting_page_wash_count,
                    unit: ' ',
      ...
      },
      {
        ...
        value: function (t, o, n, s) {
          var l = this,
            u = module1645.utcTimeConvertToPhoneTimeZoneTime(1e3 * t.start);
          console.log('rowData = ' + t);
          if (!module1344.CleanStartType()[t.startType]) module510.localization_strings_Setting_General_index_0;
          var c = module1645.addZeroPrefix(u.month) + '/' + module1645.addZeroPrefix(u.day) + ' ' + module1645.addZeroPrefix(u.hour) + ':' + module1645.addZeroPrefix(u.minute),
            h = [module510.home_bottom_menu_global, module510.home_bottom_menu_draw_zone, module510.home_bottom_menu_select_zone][t.cleanType - 1],
            p = t.area;
          p = p < 1e6 ? (p / 1e6).toFixed(1) : E(p);

          if (t.cleanMop) {
            module510.localization_strings_Main_MainPage_3;
            module510.clean_method_mop;
            module510.clean_method_clean_and_mop;
            module510.clean_method_clean_and_mop;
            t.cleanMop;
          } else module510.localization_strings_Main_MainPage_3;

          var y = t.time < 60 ? t.time + 's' : P(t.time) + 'min',
            C = h + ' | ' + Utils.getAreaUnitValue(p) + this.state.areaUnit + ' | ' + y;
          if (module390.default.isNewDataForCleanHistoryDetail() && t.dustCollectionStatus) C = C + ' | ' + module510.dust_collection_status_1;
          return React.default.createElement(module1986.default, {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this.props.navigation.navigate('CleanRecordDetailPage', {
            ...
            title: module510.setting_history_detail,
              ...
              for (;;)
                switch ((v.prev = v.next)) {
                  case 0:
                    ...
                    v.next = 5;
                    return regeneratorRuntime.default.awrap(module416.default.getCleanSummary());
                  ...
                  case 5:
                    ...
                    if (0 == c.length) {
                      ...
                      if (0 == this.totalRecordCount && !this.unMount)
                        this.setState({
                          loaded: true,
                          refreshing: false,
                          isNoData: true,
              ...
              for (;;)
                switch ((U.prev = U.next)) {
                  case 0:
                    U.prev = 0;
                    U.next = 3;
                    return regeneratorRuntime.default.awrap(module416.default.getCleanRecord(t));
                          ...
                          for (;;)
                            switch ((h.prev = h.next)) {
                              case 0:
                                h.prev = 0;
                                h.next = 3;
                                return regeneratorRuntime.default.awrap(module416.default.deleteCleanRecord(t.start));
                              ...
                              case 3:
                                ...
                                globals.showToast(module510.rubys_history_del_toast_succ);
                                h.next = 17;
                                break;
                              ...
                              case 12:
                                ...
                                h.t0 = h.catch(0);
                                if (u.loadingView) u.loadingView.hide();
                                globals.showToast(module510.rubys_history_del_toast_failed);
      ...
      },
      {
        ...
        value: function (t, o, n, s) {
          var l = this;
          this.alert.alert(module510.whether_to_delete_the_recorded, '', [
            {
...
exports.default = module1982;
module1982.contextType = module1200.AppConfigContext;
