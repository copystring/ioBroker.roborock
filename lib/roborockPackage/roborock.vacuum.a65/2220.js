...
var b = function () {
    return module13.Dimensions.get('window').width;
  },
  D = function () {
    return module13.Dimensions.get('window').height;
  },
  j = 60,
  x = (function (t) {
    module9.default(x, t);
    ...
    function x(t) {
      ...
      n.animatedRadius = new module13.Animated.Value(n.minRadius);
      n.animatedOpacity = new module13.Animated.Value(0);
      n.animatedMargin = new module13.Animated.Value(-(2 * n.minRadius - j));
      var p = [
        {
    ...
    module7.default(x, [
      ...
      },
      {
        key: 'animate',
        value: function () {
          var t = module13.Animated.timing(this.animatedRadius, {
              toValue: this.maxRadius,
              duration: 1200,
            }),
            n = module13.Animated.timing(this.animatedMargin, {
              toValue: -(2 * this.maxRadius - this.maxDepth),
              duration: 1200,
            }),
            o = module13.Animated.timing(this.animatedOpacity, {
              toValue: 1,
              duration: 1200,
            }),
            u = module13.Animated.parallel([t, o, n]),
            c = module13.Animated.timing(this.animatedOpacity, {
              toValue: 0,
              duration: 300,
            }),
            s = module13.Animated.sequence([u, c]);
          module13.Animated.loop(s, {
            interations: -1,
          }).start();
        },
      },
