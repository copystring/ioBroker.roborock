  ...
  E = (function (t) {
    ...
    function R(t) {
      ...
      (o = D.call(this, t)).state = {
        minute: null,
        hour: null,
        repeatMode: module1645.RepeatMode.Everyday,
    ...
    module7.default(R, [
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if ((null != (n = null == t ? undefined : t.length) ? n : 0) > 0) {
            var l = module1644.ConvertToReadableFormat(t[0].cron);
            this.isEnabled = t[0];
            this.setState(
              {
                repeatMode: module1645.getRepeatMode(l.repeat, false),
                minute: l.minute,
                hour: l.hour,
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(module385.SettingListItemView, {
                ...
                title: module1969.LocalizationStrings.localization_strings_Setting_DoNotDisturbPage_0,
              ...
              React.default.createElement(module385.SettingListItemView, {
                ...
                title: module1969.LocalizationStrings.localization_strings_Setting_Timer_SettingPage_1,
                bottomDetail: module1645.getTextOfRepeatMode(this.state.repeatMode, new Date()),
            ...
            React.default.createElement(
              ...
              module1969.LocalizationStrings.timer_list_server_timer_tip
            ),
            !this.state.isNew &&
              React.default.createElement(
                module13.TouchableWithoutFeedback,
                {
                  onPress: function () {
                    ...
                    globals.Alert.alert('', module1969.LocalizationStrings.localization_strings_Setting_Timer_index_13, [n, o]);
                  },
                },
                React.default.createElement(
                  module13.Text,
                  ...
                  module1969.LocalizationStrings.smart_scene_delete_timer
                )
              ),
            React.default.createElement(
              module385.BaseModal,
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(module1980.default, {
                  selectedItems: n,
                  cancel: function (n) {
            ...
            React.default.createElement(module1509.default, {
              ...
              title: module1969.LocalizationStrings.localization_strings_Setting_Timer_SettingPage_1,
              actions: module1645.SmartSceneRepeatMenuItems(),
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this.frequencyView.hide(function () {
            if (t == module1645.SmartSceneRepeatMenuItems().length - 1)
              n.setState({
                isShowingCustomFrequencyView: true,
              });
            else
              n.setState({
                repeatMode: module1645.SmartSceneIndexRepeatMap[t],
              });
          });
        },
      },
          ...
          var t,
            ...
            s = function () {
              var t = {
                  ...
                  repeated: o.state.repeatMode != module1645.IndexRepeatMap[0],
              ...
              module1968.SmartSceneAPI.editTriggers(o.commandId, [n])
                .then(function (s) {
                  if (o.data.length > 0) o.data[0].param = t;
                  else o.dataRef.timer = [new module1968.SmartSceneTriggerModel(n)];
                  o.confirmcallBack();
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module1968.SmartSceneAPI.editTriggers(this.commandId, [])
            .then(function (n) {
              t.dataRef.timer = [];
              t.confirmcallBack();
      ...
      },
      {
        ...
        value: function () {
          ...
          this.props.navigation.setParams({
            ...
            rightItems: [
              module1125.MapEditCommonService.confirmButton(this.onPressMenuConfirm.bind(this), null != this.state.hour && null != this.state.minute, function (n) {
      ...
      },
      {
        ...
        get: function () {
          return null != this.state.minute && null != this.state.hour
            ...
            : module1969.LocalizationStrings.timer_setting_no_setting;
        },
      },
      {
        key: 'cron',
        get: function () {
          var t = module1645.timerRepeatToCronRepeat(this.state.repeatMode),
            n = -1,
            o = -1;
          ...
          return module1644.ConvertToCronStr(this.state.hour, this.state.minute, t, o, n);
        },
      },
      {
        key: 'dataRef',
