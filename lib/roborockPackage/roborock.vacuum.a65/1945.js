...
var module510 = require('./510').strings,
  ...
  module1486 = require('./1486').parseSync,
  R = (function (t) {
    module9.default(u, t);
    var n = E(u);
    ...
    module7.default(u, [
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(module1347.default, {
            ref: function (n) {
              t.view = n;
            },
            isModal: true,
          ...
          contentComponent: React.default.createElement(
            ...
            this.bakTime > 0 &&
              React.default.createElement(
                ...
                module510.recover_map_backup_time + ' ' + module1643.formatWithMillis(1e3 * this.bakTime, 'YYYY/MM/DD HH:mm')
              ),
            React.default.createElement(P, {
    ...
    module7.default(p, [
      ...
      },
      {
        ...
        value: function () {
          ...
          (module390.default.isMultiFloorSupported() ? new module1348.MultiMapDataProvider() : new module1348.SingleMapDataProvider())
            .getMapData(this.props.mapID, this.props.isBackupData)
            .then(function (n) {
              console.log('LoadMap: Success');
              var o = base64js.toByteArray(n),
                l = module1486(o, false);
