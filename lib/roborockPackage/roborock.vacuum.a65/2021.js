...
var module1421 = require('./1421'),
  ...
  C = (function (t) {
    ...
    function E(t) {
      ...
      s.host = module1344.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].host;
      s.state = {
        progress: -1,
    ...
    module7.default(E, [
            ...
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 8:
                    this.timer = module1421.setInterval(this.getProgess.bind(this), 1e3);
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    c.next = 4;
                    return regeneratorRuntime.default.awrap(module2024.default.getListDataFromLocal());
                  ...
                  case 7:
                    c.next = 9;
                    return regeneratorRuntime.default.awrap(module2024.default.getListDataFromServer());
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module2026.default, {
            ref: function (s) {
      ...
      },
      {
        ...
        value: function (t, s, n) {
          return 'normal' == s
            ...
            : 'special' == s
            ? React.default.createElement(module2022.default, {
                progress: t.voice_id == this.state.currentDownloadVoiceId ? this.state.progress : -1,
                data: t,
                rowId: n,
                showTopLine: false,
              ...
              for (;;)
                switch ((v.prev = v.next)) {
                  ...
                  case 3:
                    ...
                    module1421.clearInterval(this.timer);
                    this.downloading = false;
                    this.setState({
                      progress: -1,
