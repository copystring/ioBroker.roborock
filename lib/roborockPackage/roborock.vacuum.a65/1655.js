var module381 = require('./381'),
  ...
  module1656 = require('./1656').HtmlMap;

function M() {
  return module1344.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].host;
}
