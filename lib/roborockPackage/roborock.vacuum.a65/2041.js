  ...
  B = (function (t) {
    ...
    function O(t) {
      ...
      (o = B.call(this, t)).state = {
        monitorEnabled: module1640.default.realTimeMonitorEnabled,
        videoSetting: module1640.default.realVideoSetting,
    ...
    module7.default(O, [
      ...
      },
      {
        ...
        value: function () {
          ...
          this.vodeoSettingListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.RealTimeVideoSettingChange, function (o) {
            ...
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    s.next = 2;
                    return regeneratorRuntime.default.awrap(module420.GetStorageKey(module420.StorageKeys.MonitorVideoWatermark));
      ...
      },
      {
        ...
        value: function () {
          ...
          return [
            ...
            {
              title: module510.common_setting_water_mark,
              visible: true,
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    ...
                    n.prev = 2;
                    n.next = 5;
                    return regeneratorRuntime.default.awrap(module416.default.setWatermark(o));

                  case 5:
                    n.next = 8;
                    return regeneratorRuntime.default.awrap(module420.SetStorageKey(module420.StorageKeys.MonitorVideoWatermark, o));
      ...
      },
      {
        ...
        value: function () {
          ...
          this.props.navigation.navigate('WebViewPage', {
            title: module424.DMM.isTopazSV || module424.DMM.isPearlPlus ? module510.camera_monitor_voice_privacy_title : module510.camera_monitor_privacy_title,
            refrence: module1655.default.MonitorPrivacy(),
            buttonTitle: module1640.default.monitorPrivacyPolicyAgreed ? module510.reset_authoration : module510.button_title_agree,
            buttonColor: module1640.default.monitorPrivacyPolicyAgreed ? 'red' : '#007aff',
            buttonAction: function (o) {
              if (module381.RSM.isRunning && module1640.default.monitorPrivacyPolicyAgreed)
                o.alertView &&
                ...
                var n = function () {
                  setTimeout(function () {
                    if (o.loadingView) o.loadingView.showWithText(module510.map_object_cancel_privacy_loading);
                  }, 100);
                  if (t.timerForUnlock) module1421.clearTimeout(t.timerForUnlock);
                  module381.RSM.hardLockCameraStatus();
                  module1640.default.updateMonitorPrivacy(!module1640.default.monitorPrivacyPolicyAgreed, function (n) {
                    if (
                      ((t.timerForUnlock = module1421.setTimeout(function () {
                      ...
                      if ('' != (l = module1640.default.monitorPrivacyPolicyAgreed ? '' : module510.map_object_cancel_privacy_success)) globals.showToast(l);
                      o.props.navigation.setParams({
                        buttonTitle: module1640.default.monitorPrivacyPolicyAgreed ? module510.reset_authoration : module510.button_title_agree,
                        buttonColor: module1640.default.monitorPrivacyPolicyAgreed ? 'red' : '#007AFF',
                      });
                      module387.LogEventCommon(module1640.default.monitorPrivacyPolicyAgreed ? 'accept_monitor_privacy' : 'reset_monitor_privacy_confirm');
                    } else {
                      var l = module1640.default.monitorPrivacyPolicyAgreed ? module510.map_object_cancel_privacy_timeout : module510.map_object_ignore_failed;
                      globals.showToast(l);
                    }
                  });
                };

                if (module1640.default.monitorPrivacyPolicyAgreed) {
                  if (o.alertView)
                    o.alertView.customAlert(
                      module510.reset_monitor_privacy_dialog_title,
                      module510.reset_monitor_privacy_dialog_content,
                      function () {
                        n();
                      },
                      function () {
                ...
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    return regeneratorRuntime.default.awrap(
                      module393.postPrivacyAgreementStatus(module381.RobotStatusManager.sharedManager().serverCode, module1640.default.monitorPrivacyPolicyAgreed ? 2 : 3)
                    );
                ...
                switch ((n.prev = n.next)) {
                  case 0:
                    if ((t = !this.state.monitorEnabled)) {
                      if (this.alert)
                        this.alert.customAlert('', module510.camera_setting_open_monitor_function_tip, null, null, {
                          confirmColor: '#007AFF',
                      ...
                      this.alert.customAlert(
                        '',
                        module510.camera_setting_monitor_off_tip,
                        function () {
                          return regeneratorRuntime.default.async(
                            function (n) {
                              for (;;)
                                switch ((n.prev = n.next)) {
                                  case 0:
                                    ...
                                    module1640.default.realTimeMonitorEnabled = t;
                                    n.next = 4;
                                    return regeneratorRuntime.default.awrap(module1640.default.updateCameraStatus());
      ...
      },
      {
        ...
        value: function () {
          ...
          var l = this.getMenus().map(function (t, o) {
            ...
            s = {
              title: module510.setting_realtime_monitor_switch_title,
              detail: module1640.default.realTimeMonitorEnabled ? module510.setting_camera_on : module510.setting_camera_off,
              detailColor: module1640.default.realTimeMonitorEnabled ? '#007AFF' : this.context.theme.settingListItem.disableColor,
              ...
              bottomDetail:
                '1.' + module510.monitor_setting_introduction_1 + '\n2.' + module510.monitor_setting_introduction_2 + '\n3.' + module510.monitor_setting_introduction_3 + '\n',
            },
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                module424.DMM.isTopazSV || module424.DMM.isPearlPlus ? module510.monitor_voice_privacy_dialog_title : module510.monitor_privacy_dialog_title
              )
            ),
            this.state.monitorEnabled &&
              React.default.createElement(
                ...
                React.default.createElement(module385.PureButton, {
                  ...
                  textColor: '#FFFFFF',
                  fontSize: 16,
                  title: module510.camera_setting_detail1,
                  onPress: function () {
                    return t.off_monitor();
                  },
                })
              ),
            React.default.createElement(module1931.MonitorPrivacyDialogWithNavbar, {
              ref: function (o) {
              ...
              onConfirm: function () {},
              noTitle: true,
              desc1: module510.camera_setting_open_monitor_function_tip_1,
              desc2: module510.camera_setting_open_monitor_function_tip,
              shouldShowCancel: false,
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    o = 0 == t;
                    n.next = 3;
                    return regeneratorRuntime.default.awrap(module1640.default.updatePetModeEnabled(o));

                  case 3:
                    this.setState({
                      petModeEnabled: module1640.default.petModeEnabled,
                    });
      ...
      },
      {
        ...
        value: function (t) {
          return t == module389.VideoSettingMap().VideoSettingStrongReminder
            ? module510.realtime_video_title_3
            : t == module389.VideoSettingMap().VideoSettingNotDisturb
            ? module510.realtime_video_title_1
            : module510.realtime_video_title_2;
        },
      },
    ]);
    return O;
