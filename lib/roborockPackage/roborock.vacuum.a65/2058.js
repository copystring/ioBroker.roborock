  ...
  module7.default(b, [
    ...
    },
    {
      ...
      value: function (t) {
        ...
        for (var n = module2059.getMiddlePoint(this.state.circles[s], this.state.circles[t]), o = 0; o < '13457'.length; o++) {
          var l = '13457'[o];
          if (module2059.isEquals(n, this.state.circles[l])) return String(l);
        }
    ...
    },
    {
      ...
      value: function (t, s) {
        ...
        if (this.isMoving) {
          var o = module2059.getRealPassword(this.sequence);
          this.sequence = '';
          this.lastIndex = -1;
          this.isMoving = false;
          var l = {
