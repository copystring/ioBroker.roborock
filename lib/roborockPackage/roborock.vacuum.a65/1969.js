...
exports.taskMethodToMode = function (t) {
  switch (t) {
    case 'do_scenes_app_start':
      return module1970.SmartSceneMode.GlobalClean;

    case 'do_scenes_segments':
      return module1970.SmartSceneMode.Segment;

    case 'do_scenes_zones':
      return module1970.SmartSceneMode.Zone;
  }
};
...
var module1975 = {
  Edit: {
    text: _.multi_floor_edit,
    icon: require('./1971'),
  },
  EditTimer: {
    text: _.localization_strings_Setting_Timer_SettingPage_16,
    icon: require('./1972'),
  },
  Rename: {
    text: _.smart_scene_rename,
    icon: require('./1973'),
  },
  Sort: {
    text: _.smart_scene_sort,
    icon: require('./1974'),
  },
  Delete: {
    text: _.map_edit_delete,
    icon: require('./1975'),
  },
};
exports.SmartCommandAction = module1975;
...
var v = (function () {
  function t(o, s, c, u, _) {
    ...
    this.mode = u || module1970.SmartSceneMode.GlobalClean;
    this.repeat = _ || 0;
    this.segments = h;
    this.zones = p;
    this.id = S;
...
var T = [
  new v(102, 202, 300, module1970.SmartSceneMode.GlobalClean, 1),
  new v(103, 203, 301, module1970.SmartSceneMode.Segment, 2),
  new v(104, 203, 301, module1970.SmartSceneMode.Zone, 3),
];
exports.TestTasks = T;
var w = [new v(102, 202, 300, module1970.SmartSceneMode.GlobalClean, null, null, null, 1)],
  k = [new v(102, 202, 300, module1970.SmartSceneMode.Segment, 1, null, null, 1, null, null, _.map_edit_zone_tag_kitchen + ' ' + _.map_edit_zone_tag_diningroom)],
  b = [new v(102, 200, 300, module1970.SmartSceneMode.GlobalClean, null, null, null, 1), new v(105, 202, 300, module1970.SmartSceneMode.GlobalClean, null, null, null, 2)],
