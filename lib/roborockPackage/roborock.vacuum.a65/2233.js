    ...
    module7.default(I, [
      {
        ...
        value: function () {
          ...
          module2235.VideoManager.cancelRequest = false;
      ...
      },
      {
        ...
        value: function () {
          ...
          module2235.VideoManager.cancelRequest = false;
          module2235.VideoManager.addIceListener(function (o) {
            if (t.videoView)
              t.videoView.sendIceInfoToSDK(o, function (t) {
                console.log('\u53d1\u9001 ICE \u4fe1\u606f \u5230SDK \u6210\u529f');
              });
          });
          module2235.VideoManager.addTurnServerCallback(function (o) {
            t.sendTurnserviceInfoToSdk(o);
          });
          module2235.VideoManager.addSdpListener(function (o) {
            if (t.videoView)
              t.videoView.sendSdpInfoToSDK(o, function (t) {
                console.log('\u53d1\u9001 sdp \u4fe1\u606f \u5230SDK \u6210\u529f');
              });
          });
          module2235.VideoManager.addErrorCodeListener(function (o, n) {
      ...
      },
      {
        ...
        value: function () {
          ...
          module2235.VideoManager.cancelRequest = true;
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module2234.default, {
              width: n || p,
              height: s || w,
              ...
              onFirstFrameRendered: function () {
                ...
                module2235.VideoManager.notifyFirstVideoFrameRendered();
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    module2235.VideoManager.stopCameraPreview(t, n);
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    module2235.VideoManager.startVideoPreview(t, n);
