...
var R = React.forwardRef(function (t, o) {
    ...
    var I = module13.Dimensions.get('window').width,
      j = 0.6 * (I - 3 * module1435.HorizontalMargin),
      k = 0.4 * (I - 3 * module1435.HorizontalMargin),
      T =
      ...
      G = B(
        B({}, module1630.getCleanButtonConfig(R, l)),
        {},
        {
      ...
      H = B(
        B({}, module1630.getDockButtonConfig(O, l)),
        {},
        {
          funcId: 'home_dock_button',
          shouldShowRedPoint: 'unfold' == O && module1630.hasDockExceptions(),
          redPointStyle: {
            width: 7,
            height: 7,
            borderRadius: 3.5,
