...
var H = function () {},
  ...
  q = (function (t) {
    ...
    function I(t) {
      ...
      n._getTransitionConfig = function () {
        ...
        return module1263.default.getTransitionConfig(n.props.transitionConfig, n.props.transitionProps, n.props.lastTransitionProps, t);
      };
    ...
    module7.default(I, [
      {
        ...
        value: function (t, o) {
          ...
          var p =
              s ||
              function (t) {
                return React.default.createElement(module1254.default, t);
              },
      ...
      },
      {
        key: '_reset',
        value: function (t, n) {
          if ('ios' === module13.Platform.OS && module1265.supportsImprovedSpringAnimation())
        ...
        value: function (t, n) {
          ...
          var f = function () {
            ...
            if (!o._isResponding && t) {
              p.dispatch(
                module1218.NavigationActions.back({
                  key: t.route.key,
                  immediate: true,
                })
              );
              p.dispatch(module1218.StackActions.completeTransition());
            }
          };
          ...
          return 'screen' === u
            ? React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(module1218.SceneView, {
                    screenProps: p,
                    navigation: o,
                    component: s,
                  })
  ...
  X = module1218.withOrientation(q);
