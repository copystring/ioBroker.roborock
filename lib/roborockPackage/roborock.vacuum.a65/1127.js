...
exports.MAX_COUNT_EXTRA_ZONE = 1;
...
var R = s / 4.7;
exports.DEFAULT_FBZ_REALHEIGHT = R;
var L = (s - C) / 2,
  B = (0.67 * I - 10) / 2,
  c = (s - C) / 2,
  W = (0.67 * I) / 2;
...
module50.default(
  ...
  module50.default(T, P.SST_SECTIONAL, {
    ...
    imageWidth: 70,
    imageHeight: 39,
    type: (D.FT_SOFA << 8) | P.SST_SECTIONAL,
  }),
  module50.default(T, P.SST_SECTIONAL_LEFT, {
    ...
    imageWidth: 70,
    imageHeight: 39,
    type: (D.FT_SOFA << 8) | P.SST_SECTIONAL_LEFT,
  }),
  T)
);
module50.default(o, D.FT_DINNERTABLE, {
  iconImage: require('./1137'),
  hasSubtype: 0,
  image: require('./1138'),
...
h = {};
module50.default(h, D.FT_UNKNOWN, {
  minWidth: 24,
  maxWidth: 48,
  minHeight: 16,
  maxHeight: 16,
...
module50.default(h, D.FT_DINNERTABLE, {
  minWidth: 24,
  maxWidth: 48,
  minHeight: 16,
  maxHeight: 30,
});
module50.default(h, D.FT_TVCABINET, {
  minWidth: 20,
  maxWidth: 50,
  minHeight: 8,
  maxHeight: 16,
...
module50.default(h, D.FT_SHOECABINET, {
  minWidth: 10,
  maxWidth: 20,
  minHeight: 6,
  maxHeight: 8,
});
module50.default(h, D.FT_WARDROBE, {
  minWidth: 20,
  maxWidth: 50,
  minHeight: 8,
  maxHeight: 14,
});
module50.default(h, D.FT_NIGHTSTAND, {
  minWidth: 8,
  maxWidth: 12,
  minHeight: 8,
  maxHeight: 12,
});
module50.default(h, D.FT_TOILET, {
  minWidth: 10,
  maxWidth: 10,
  minHeight: 15,
  maxHeight: 15,
});
module50.default(h, D.FT_OPENCATTOILET, {
  minWidth: 7,
  maxWidth: 10,
  minHeight: 10,
  maxHeight: 14,
});
module50.default(h, D.FT_CATTOILET, {
  minWidth: 7,
  maxWidth: 10,
  minHeight: 10,
  maxHeight: 14,
});
module50.default(h, D.FT_PETCAGE, {
  minWidth: 8,
  maxWidth: 20,
  minHeight: 8,
  maxHeight: 16,
});
module50.default(h, D.FT_PETWATERLOO, {
  minWidth: 8,
  maxWidth: 20,
  minHeight: 8,
  maxHeight: 16,
});
module50.default(h, D.FT_PETBOWL, {
  minWidth: 6,
  maxWidth: 12,
  minHeight: 3,
  maxHeight: 6,
});
module50.default(h, D.FT_FLOORMIRROR, {
  minWidth: 8,
  maxWidth: 16,
  minHeight: 6,
  maxHeight: 10,
...
var module1179 = {
  ...
  15: {
    ...
    fan_power: 102,
    warter_mode: 203,
    bubble_image: require('./1179'),
  },
};
exports.RoomTagInfo = module1179;
Object.freeze(module1179);
exports.DisplayRoomTag = [1, 6, 14, 13, 15, 7, 2, 3, 8, 9, 12];
var module1186 = {
  Charged: require('./1180'),
  Charging: require('./1180'),
  Locating: require('./1181'),
  Sleeping: require('./1182'),
  Waiting: require('./1181'),
  Warning: require('./1183'),
  Washingdust: require('./1184'),
  Collectdust: require('./1185'),
  WashingdustPearl: require('./1186'),
};
exports.MapAnimates = module1186;
var v = {
  Other: -1,
  Normal: 0,
};
...
module50.default(p, v.Normal, {
  ...
  type: v.Normal,
  chargerIcon: require('./1187'),
  chargerBubbleIcon: require('./1188'),
});
module50.default(p, v.Other, {
  name: module510.charger_type_name_special,
  type: v.Other,
  chargerIcon: require('./1189'),
  chargerBubbleIcon: require('./1190'),
});
var Z = p;
...
module50.default(S, Y.BT_CARPET, {
  ...
  bubbleImg: require('./1196'),
});
var X = S;
exports.SmartBubbleConfig = X;

var module1197 = require('./1197');

exports.MapAITag = module1197;
var j = new Map([
  [3, ['path', 500]],
  [6, ['zones', ['zones'], 50]],
  [11, ['blocks', ['blocks'], 50]],
