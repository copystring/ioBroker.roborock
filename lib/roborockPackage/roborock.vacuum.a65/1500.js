  ...
  R = (function (t) {
    ...
    module7.default(A, [
      ...
      },
      {
        ...
        value: function () {
          module1501.default.shared().popGestureEnabled = true;
        },
      },
      {
        key: 'render',
        value: function () {
          ...
          var E = this.context.theme.alert,
            ...
            module1338 = React.default.createElement(
            ...
            B = React.default.createElement(module1218.NavigationConsumer, null, function (n) {
          ...
          return this.state.visible ? (k ? B : module1338) : null;
        },
      },
      {
        key: 'customAlert',
      ...
      },
      {
        ...
        value: function () {
          ...
          module1501.default.shared().popGestureEnabled = this.props.hidePopGestureEnabled;
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module1501.default.shared().popGestureEnabled = this.props.showPopGestureEnabled;
          this.needShow = true;
          if (this.props.noAnimated)
            this.setState({
              visible: true,
