  ...
  M = (function (t) {
    ...
    function A(t) {
      ...
      (n = b.call(this, t))._handleStartShouldSetPanResponder = function () {
        return (
          n.props.mapMode == module1344.MAP_MODE_MAP_EDIT ||
      ...
      n._handlePanResponderStart = function (t, o) {
        n.touch.move = module1340._parseEvent2(t.nativeEvent, o) || {};
    ...
    module7.default(A, [
      ...
      },
      {
        key: '_getMoveXY',
        value: function (t, n) {
          var s = [module1340._parseEvent2(t.nativeEvent, n), this.touch.move],
            l = s[0],
            h = s[1];
          if (((this.touch.move = l || {}), !(l && l.x && l.y && h.x))) return null;
          if (l.hasOwnProperty('distance')) return null;

          var u = module1340._parseDegPointWithTrans(l, h, this.props.transform, this.props.mapDeg),
        ...
        value: function () {
          ...
          if (!s || !s.data || s.data.length <= 0) this.resetSplitPoint();
            ...
            var l = function (t, n) {
              ...
              u = function (o, s) {
                var l = module1340._getAroundIndexInfo(n, o, s),
                  h = 0;
              ...
              c = this.formLine(f, p),
              y = module1340._mapScreenToOriginXY(n, f.x, f.y),
              v = module1340._mapScreenToOriginXY(n, p.x, p.y),
              x = this.formLine(v, y),
              P = function (t, n, o) {
              ...
              for (var b = y.y ** v.y, A = y.y ** v.y, D = 0; D < s.height && !(b - D <= A); D++) {
                ...
                if (C == t && 0 != B) {
                  if (((R = true), 0 == D && (this.adjustDirecton.right = 1 != B ? S(null, b + 1) : u(j, T)), !this.adjustDirecton.right)) {
                    ...
                    var L = (M = module1340._mapOriginXYToScreen(n, j, T)).y;
              ...
              for (var O = 0; O < s.height && !(A + O >= b); O++) {
                ...
                if (W == t && 0 != Z) {
                  if (((w = true), 0 == O && (this.adjustDirecton.left = 1 != Z ? S(null, A - 1) : u(X, Y)), !this.adjustDirecton.left)) {
                    ...
                    var q = (k = module1340._mapOriginXYToScreen(n, X, Y)).y;
              ...
              for (var H = y.x ** v.x, U = y.x ** v.x, z = 0; z < s.width && !(H - z <= U); z++) {
                ...
                if ($ == t && 0 != tt) {
                  if (((R = true), 0 == z && (this.adjustDirecton.right = 1 != tt ? S(H + 1, null) : u(G, J)), !this.adjustDirecton.right)) {
                    ...
                    var et = (M = module1340._mapOriginXYToScreen(n, G, J)).x;
              ...
              for (var nt = 0; nt < s.width && !(U + nt >= H); nt++) {
                ...
                if (st == t && 0 != lt) {
                  if (((w = true), 0 == nt && (this.adjustDirecton.left = 1 != lt ? S(U - 1, null) : u(it, rt)), !this.adjustDirecton.left)) {
                    ...
                    var ht = (k = module1340._mapOriginXYToScreen(n, it, rt)).x;
        ...
        value: function () {
          ...
          if (this.props.touchPt) t = this.getTouchEdge(this.props.touchPt);
            ...
            if (n && o && o.maxX && o.maxY) {
              var s = {
                ...
                l = module1340._mapRectXYToOrigin(n, s.x, s.y);
          ...
          if (t && t.res) {
            var h = this.props.parent.props.parent.state.map,
              u = module1340._mapOriginXYToScreen(h, t.left.x, t.left.y),
              f = module1340._mapOriginXYToScreen(h, t.right.x, t.right.y);
              ...
              isNaN(R) || isNaN(w)
                ...
                : React.default.createElement(
                    ...
                    React.default.createElement(
                      ...
                      React.default.createElement(module1351.Circle, {
                        cx: '20',
                        cy: '20',
                        r: '8',
                        stroke: 'white',
