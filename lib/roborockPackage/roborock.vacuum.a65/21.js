...
function l(o, l) {
  ...
  var f = module23(o, 5),
    ...
    C = f[3],
    p = f[4];
  if ((module14(!v.startsWith('RCT') && !v.startsWith('RK'), "Module name prefixes should've been stripped by the native side but wasn't for " + v), !h && !y))
    return {
      name: v,
    };
  var M = {};
  if (y)
    y.forEach(function (n, t) {
      var o = C && c(C, t),
        f = p && c(p, t);
      module14(!o || !f, 'Cannot have a method that is both async and a sync hook');
...
function f(n, t) {
  module14(globals.nativeRequireModuleConfig, "Can't lazily create module without nativeRequireModuleConfig");
    ...
    'promise' === l
      ...
      : function (...args) {
          var v = args.length > 0 ? args[args.length - 1] : null,
            ...
            y = 'function' == typeof v,
            C = 'function' == typeof h;
          if (C) module14(y, 'Cannot have a non-function arg after a function arg.');
          var p = y ? v : null,
            M = C ? h : null,
            b = y + C;
...
if (globals.nativeModuleProxy) h = globals.nativeModuleProxy;
  ...
  module14(y, '__fbBatchedBridgeConfig is not set, cannot invoke native modules');
