...
var module510 = require('./510').strings,
  ...
  Z = (function (t) {
    ...
    function Z(t) {
      ...
      n.originalRepeatMode = o.repeatMode || module1645.RepeatMode.Once;
      ...
      n.state = {
        ...
        repeatMode: o.repeatMode || module1645.RepeatMode.Once,
        ...
        currentCleanMethod: undefined == o.cleanMethod ? module1626.CleanMethodMop : o.cleanMethod,
    ...
    module7.default(Z, [
      ...
      },
      {
        ...
        value: function () {
          ...
          if (this.state.currentCleanMethod == module1626.CleanMethodClean && 301 == o) o = 300;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (4 == t) {
            ...
            this.hideModalView(function () {
              n.setState({
                repeatMode: module1645.IndexRepeatMap[t],
                shouldShowFrequenceView: false,
              });
            });
        },
      ...
      },
      {
        ...
        value: function () {
          ...
          if (this.state.hasSetTime) {
            var n = module1645.timerRepeatToCronRepeat(this.state.repeatMode),
              s = -1,
              l = -1;

            if (this.state.repeatMode == module1645.RepeatMode.Once) {
              var u = new Date(),
                h = u.getHours() == this.state.hour && u.getMinutes() == this.state.minute,
                c = module1642.default();
            ...
            if (this.isRepeatTimer(l, s)) globals.showToast(module510.set_timer_dup);
              ...
              var M = module1644.ConvertToCronStr(this.state.hour, this.state.minute, n, l, s);

              if (module393.isMiApp && 1 == this.FCCState) {
                var S = module1645.convertToBeijingTime(this.state.minute, this.state.hour, l, s),
                  w = this.state.repeatMode;

                if (this.state.repeatMode != module1645.RepeatMode.Once && this.state.repeatMode != module1645.RepeatMode.Everyday) {
                  var _ = new Date();

                  if (S.month == _.getMonth() + 1)
                    S.day == _.getDate() + 1
                      ? (w = module1645.getDaysArrByOffset(this.state.repeatMode, 1))
                      : S.day == _.getDate() - 1 && (w = module1645.getDaysArrByOffset(this.state.repeatMode, -1));
                  else w = 1 == S.day ? module1645.getDaysArrByOffset(this.state.repeatMode, 1) : module1645.getDaysArrByOffset(this.state.repeatMode, -1);
                }

                n = module1645.timerRepeatToCronRepeat(w);
                M = module1644.ConvertToCronStr(S.hour, S.minute, n, S.day, S.month);
              }
      ...
      },
      {
        ...
        value: function (t, n, s, l) {
          var u, h, c, p, f, M, S, w, _, C, module1642, module394, module382, module415, module1978, module1125;
              ...
              for (;;)
                switch ((R.prev = R.next)) {
                  ...
                  case 31:
                    ...
                    module394 = module1645.convertToTargetTime(this.state.minute, this.state.hour, s, l, module393.robotTimeZone);
                    module382 = module394.hour + ':' + module1645.addZeroPrefix(module394.minute);
                    module415 = module1645.getLoopStringOfRepeatMode(this.state.repeatMode);
                    module1978 = new Date();
                    module1125 = module1645.resolveRepeatModeByTargetTime(module415, module1978.getMonth() + 1, module1978.getDate(), module394.month, module394.day);
                    console.log('loops -- time - ' + module382 + ' - loop -' + module1125 + ' -repeat-' + this.state.repeatMode + ' - timerId- ' + this.timerId);
                    R.next = 40;
                    return regeneratorRuntime.default.awrap(module393.rrAddOrEditTimer(module382, module1125, module1642, this.timerId));
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module1979.default, {
              ref: function (n) {
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(module385.SettingListItemView, {
                  ...
                  bottomDetail: module1645.getTextOfRepeatMode(this.state.repeatMode, this.date),
      ...
      },
      {
        ...
        value: function () {
          return this.state.currentCleanMethod == module1626.CleanMethodNoSet ? module510.timer_setting_no_setting : module1626.getCleanMethods()[this.state.currentCleanMethod];
        },
      },
      {
        ...
        value: function () {
          ...
          if (module390.default.isPureCleanMopSupported()) {
            ...
            if (this.state.mode == module1625.CleanModeZero) return n + ' | ' + s;
            if (this.state.waterMode == module1625.WaterModeZero) return t;
          }
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = module1645.RepeatIndexMap[this.state.repeatMode];
          if (undefined == n) n = 4;
          return React.default.createElement(
            module13.View,
            {
              style: {
                paddingBottom: module1344.AppBarMarginBottom,
              },
            },
            React.default.createElement(module1509.ActionSheetView, {
              title: module510.localization_strings_Setting_Timer_SettingPage_1,
              actions: module1645.RepeatMenuItems(),
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = module1645.isCustomMode(this.state.repeatMode) ? [0, 0, 0, 0, 0, 0, 0] : this.state.repeatMode.split('');
          return React.default.createElement(module1980, {
            selectedItems: n,
            cancel: function (n) {
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module1509.ActionSheetView, {
            title: module510.timer_setting_clean_method,
            actions: module1626.getCleanMethods(),
            didSelectRow: function (n) {
      ...
      },
      {
        ...
        value: function () {
          return this.state.hasSetTime || this.editMode
            ? module1645.addZeroPrefix(this.state.hour) + ' : ' + module1645.addZeroPrefix(this.state.minute)
      ...
      },
      {
        key: 'isRepeatTimer',
        value: function (t, n) {
          for (var o = module1645.convetToWeekendsByStartTime(this.state.repeatMode, t, n), s = 0; s < this.timerList.length; s++) {
            ...
            if (!this.editMode || l.hour != this.originalHour || l.minute != this.originalMinute || JSON.stringify(u) !== JSON.stringify(this.originStartWeekdays)) {
              ...
              if (l.repeatMode == module1645.RepeatMode.Once && l.hour == this.state.hour && l.minute == this.state.minute) return true;
            }
          }
      ...
      },
      {
        ...
        value: function () {
          ...
          if (t == module1625.CleanRouteFastMode) t = module1625.CleanRouteDailyMode;
          return t;
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          if (module424.DMM.isGarnet)
            this.state.currentCleanMethod != module1626.CleanMethodNoSet || this.editMode ? this.confirmButton.setEnabled(true) : this.confirmButton.setEnabled(false);
