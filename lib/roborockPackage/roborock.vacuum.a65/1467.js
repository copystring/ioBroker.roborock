...
var module1340 = require('./1340'),
  k = 2 * module1127.buttonConfig.rectBtn.size.width,
  z = (function (t) {
    module9.default(z, t);
      ...
      },
      {
        ...
        value: function () {
          var t = this.props,
            ...
            h = module1340._convertToPixelRect(n, s);

          if (!h || isNaN(h.x) || isNaN(h.y) || isNaN(h.width) || isNaN(h.height)) return null;

          var c = h.width + 2 * k,
            y = h.height + 2 * k,
            v = n.width < module1127.RectConfig.minLength || n.height < module1127.RectConfig.minLength,
            b = module1350.default.zoneDeleteButton('forbidden_rect_edit_delete', this.panProxy.panResponderDelete, k),
            R = module1350.default.zoneScaleButton(h, 'forbidden_rect_edit_scale', this.panProxy.panResponderScale, k),
            T = module1350.default.zoneRotateButton(h.width, 'forbidden_rect_edit_rotate', this.panProxy.panResponderRotate, k),
            x = module1350.default.zoneDragButtonView(h.height, this.panProxy.panResponder),
            z = v
              ? module1350.default.zoneFocusBorderViewWithPan(h, k, this.panProxy.panResponder, this.props.isFocus)
              : module1350.default.zoneFocusBorderView(h.width, h.height, k),
            ...
            j = module1350.default.zoneAreaView(h.width, n, this.props.areaScale, '', {}, this.props.areaFix),
