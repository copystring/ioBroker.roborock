  ...
  B = (function (t) {
    ...
    function F(t) {
      ...
      n.mapCarpetFocus = function (t, o) {
        n.editAction = o ? module1199.EditAction.Ignore : module1199.EditAction.AddCarpet;
        n.setState(
          o
            ? {
    ...
    module7.default(F, [
      {
        ...
        value: function () {
          ...
          this.carpetEditMode = this.props.navigation.getParam('action', module1198.CarpetEditMode.CarpetIgnore);
        },
      },
      {
      ...
      },
      {
        key: 'configNavibar',
        value: function () {
          module1350.default.setNavigation(this, null, this.onNavigationBackPress.bind(this));
        },
      },
      {
        key: 'initMapView',
      ...
      },
      {
        ...
        value: function () {
          ...
          this.mapEditDidChange = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.MapEditDidChange, function (n) {
            if (!(n.data != module1127.FbzType.FBZ_TYPE_CARPET && n.data != module1127.FbzType.RECT_TYPE_CARPET))
              t.setState({
                ignoreCarpetEdited: n.data == module1127.FbzType.FBZ_TYPE_CARPET,
                cusCarpetEdited: n.data == module1127.FbzType.RECT_TYPE_CARPET,
              });
          });
        },
      },
      ...
      },
      {
        ...
        value: function (t, n) {
          ...
          if (this.editAction == module1199.EditAction.Ignore)
            module1421.setTimeout(function () {
              return module415.MM.saveCarpetIgnoreZone(t, n, o.onMapSaveCompleted.bind(o));
            }, 500);
          else if (this.editAction == module1199.EditAction.AddCarpet)
            module1421.setTimeout(function () {
          ...
          return regeneratorRuntime.default.async(
            function (o) {
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    this.editAction = module1199.EditAction.AddCarpet;
        ...
        value: function () {
          var t = this,
            n = React.default.createElement(module1126.MapView, {
              ...
              mapMode: module1344.MAP_MODE_CARPET_EDIT,
            ...
            o = module1350.default.getNoMapTipView(this.state.mapStatus);
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(module1199.default, {
            type: module1199.MenuType.Menu_Carpet,
