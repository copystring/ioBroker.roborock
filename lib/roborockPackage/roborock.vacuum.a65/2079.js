  ...
  F = (function (t) {
    ...
    function W(t) {
      ...
      (o = B.call(this, t)).state = {
        structureLightSwitch: module1640.default.cameraEnabled,
        avoidCollisionSwitch: false,
        loading: false,
        refreshing: false,
        mapObjectPhotoEnabled: module1640.default.mapObjectPhotoEnabled,
        sceneSwitch: false,
        isShow: false,
      };
    ...
    module7.default(W, [
      {
        ...
        value: function () {
          ...
          module1640.default.addChangeListener(this.changeListener);
      ...
      },
      {
        ...
        value: function () {
          this.mounted = false;
          module1640.default.removeChangeListener(this.changeListener);
        },
      },
      {
            ...
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 3:
                    module1640.default.cameraEnabled = t;
                    if (!t) module1640.default.explorationEnabled = t;
                    this.setState({
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    module22 = 0 == t;
                    s.next = 4;
                    return regeneratorRuntime.default.awrap(module1640.default.updatePetModeEnabled(module22));
        ...
        value: function () {
          ...
          var l = module13.Dimensions.get('window').width - 30,
            ...
            h = {
              ...
              rightCenter: true,
              detailColor: 0 == module1640.default.ledSetting ? '#007AFF' : this.context.theme.subTextColor,
              detail: 0 == module1640.default.ledSetting ? module510.led_status_title2 : module510.debug_info_close,
            ...
            _ = {
              ...
              isDetailCenter: false,
              rightCenter: true,
              detailColor: module1640.default.cameraEnabled ? '#007AFF' : 'rgba(0,0,0,0.4)',
              detail: module1640.default.petModeEnabled ? module510.has_or_no_has : module510.has_or_no_no,
            ...
            F = {
              ...
              onPress: function () {
                return t.props.navigation.navigate('WebViewPage', {
                  ...
                  refrence: module1655.default.PhotoPrivacy(),
                  buttonTitle: module1640.default.mapObjectPhotoPrivacyPolicyAgreed ? module510.reset_authoration : module510.button_title_agree,
                  buttonColor: module1640.default.mapObjectPhotoPrivacyPolicyAgreed ? 'red' : '#007AFF',
                  ...
                  buttonAction: function (o) {
                    if (module381.RSM.isRunning && module1640.default.mapObjectPhotoPrivacyPolicyAgreed)
                      o.alertView &&
                      ...
                      var s = function () {
                        ...
                        module393
                          .postPrivacyAgreementStatusWithVersion(
                            ...
                            module1640.default.mapObjectPhotoPrivacyPolicyAgreed ? 5 : 4,
                            1
                          )
                          .then(function (t) {})
                          .catch(function (t) {});
                        module1640.default.updatePhotoPrivacy(!module1640.default.mapObjectPhotoPrivacyPolicyAgreed, function (n) {
                          if (
                            ...
                            if ('' != (s = module1640.default.mapObjectPhotoPrivacyPolicyAgreed ? '' : module510.map_object_cancel_privacy_success)) globals.showToast(s);
                            ...
                            LogEventCommon(module1640.default.mapObjectPhotoPrivacyPolicyAgreed ? 'accept_photo_privacy' : 'reset_photo_privacy_confirm');
                          } else {
                            var s = module1640.default.mapObjectPhotoPrivacyPolicyAgreed ? module510.map_object_cancel_privacy_timeout : module510.map_object_ignore_failed;
                            if (o) globals.showToast(s);
                          }
                        });
                      };

                      if (module1640.default.mapObjectPhotoPrivacyPolicyAgreed) {
                        if (o.alertView)
                          o.alertView.customAlert(
            ...
            q = React.default.createElement(module1935.PhotoFeaturePrivacyDialog, {
              ref: function (o) {
              ...
              onConfirm: function () {
                return module1640.default.updatePhotoPrivacy(true, function (o) {
            ...
            Q = F.visible
              ...
              : React.default.createElement(module13.View, null),
            X = module1396.titleBarContentHeight,
            Y =
              module391.default.iOSAndroidReturn(X + module1344.StatusBarHeight + module1344.AppBarMarginTop, (module13.StatusBar.currentHeight || 0) + X) +
            ...
            function (c) {
              for (;;)
                switch ((c.prev = c.next)) {
                  ...
                  case 3:
                    if (module1640.default.cameraEnabled) {
                      c.next = 6;
                      break;
                    }
                  ...
                  case 6:
                    ...
                    module22 = module1640.default.mapObjectPhotoPrivacyPolicyAgreed;
                    c.next = 10;
      ...
      },
      {
        ...
        value: function (t) {
          var o = this;
          module1640.default.updateLedSetting(t, function (t) {
