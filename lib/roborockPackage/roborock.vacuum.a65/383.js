  ...
  z = (function (t) {
    ...
    module7.default(L, [
      ...
      },
      {
        ...
        value: function () {
          module1501.default.shared().enableBackAndMore();
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            c = l.parent,
            p = l.isSmartScene,
            M = (u && (null == c ? undefined : c.tabIndex) == module1627.TabZone) || this.props.isTabZone,
            f = null;
          ...
          var b = React.default.createElement(module13.ImageBackground, {
            ...
            y = React.default.createElement(module1125.MapView, {
              top: 30,
              right: 0,
              left: 0,
              bottom: 80,
              ...
              pointerEvents: 'none',
              hideAccessory: true,
              blockBubbleShowInfo: module1125.BlockBubbleShowInfo.CLEANMODE,
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module390.default.isPureCleanMopSupported())
            this.waterMode == module1625.WaterModeZero ? (t = 2) : this.cleanMode == module1625.CleanModeZero ? (t = 1) : this.state.isCustomMode && (t = 3);
          return t;
        },
      },
      {
        ...
        value: function () {
          ...
          var c = n && module390.default.isSoftCleanModeSupportedInMain() ? 0 : 1,
            p = module1625.CleanModes().slice(c, module1625.CleanModes().length);
          if (module390.default.isMaxPlusModeSupported() || module390.default.isNonePureCleanMopWithMaxPlus()) p.pop();

          var M = !u && h,
            _ = M && n && module390.default.isSoftCleanModeSupportedInMain() && this.cleanMode == module1625.CleanModeZero,
      ...
      },
      {
        ...
        value: function () {
          ...
          return module390.default.isCustomWaterBoxDistanceSupported() && 207 == module381.RSM.waterBoxMode && o
            ? React.default.createElement(module1637.SliderAdjuster, {
                title: null,
                style: {
                  backgroundColor: 'transparent',
                },
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            h = module1625.MopMethods();

          if (
            (this.isCleanMopTab
              ? (h = [module1625.CleanRouteFast(), module1625.CleanRouteDaily()])
              : this.isPureMopTab
              ? (h = module1625.MopMethods())
              : this.isPureCleanTab && (h = [module1625.CleanRouteFast(), module1625.CleanRouteDaily()]),
            !s)
          ) {
            var c = h.findIndex(function (t) {
              return t.strength == module1625.CleanRouteFastMode;
            });
            if (-1 != c) h.splice(c, 1);
          ...
          return module390.default.isShakeMopSetSupported() && u
            ? React.default.createElement(
                ...
                React.default.createElement(module384.default, {
                  ...
                  isRedAddonTip: true,
                  isInHomePage: s,
                  shouldShowQuestionIcon: s && (301 == this.mopMode || 303 == this.mopMode || this.mopMode == module1625.CleanRouteDeepSlowPearlMode || 304 == this.mopMode),
                  willOnPressButton: function (o) {
                    console.log('willOnPressButton', o, module381.RSM.mapSaveEnabled, module381.RSM.currentMapId);
                    return (
                      !s ||
                      (o != module1625.CleanRouteFastMode || (module381.RSM.mapSaveEnabled && -1 != module381.RSM.currentMapId)
                        ? o != module1625.CleanRouteFastMode || !t.state.cornerCleanOn || (globals.showToast(module510.switchfastroute_withcornerclean_toast), false)
                        : (null == t || null == (n = t.props) || n.showCleanRouteGuideByMode(module1625.CleanRouteFastMode + 1e4), false))
                    );
                    var n;
                  },
      ...
      },
      {
        ...
        value: function () {
          ...
          var x = module1625.MopWaterOrStrengths();
          ...
          return React.default.createElement(
            ...
            p &&
              React.default.createElement(module384.default, {
                ...
                submode: v,
                title:
                  !module390.default.isCleanRouteSettingSupported() ||
                  module424.DMM.isPearl ||
                  module424.DMM.isUltronLite ||
                  module424.DMM.isTanosSLitePlus ||
                ...
                addonTip: module390.default.isPureCleanMopSupported()
                  ? null
                  : C && module381.RSM.isWaterBoxIn && l && module381.RSM.waterBoxMode == module1625.WaterModeZero
                  ? module510.effect_only_once_tip
                  : u && !module390.default.isShakeMopSetSupported() && module381.RSM.waterBoxMode == module1625.WaterModeZero
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(module1617.SwipeDownIndicator, {
                  style: {
                    marginBottom: 10,
                  },
                }),
                (!s || module390.default.isPureCleanMopSupported()) &&
                  React.default.createElement(module1636.default, {
                    tabs: this.tabs,
            ...
            function (E) {
              for (;;)
                switch ((E.prev = E.next)) {
                  case 0:
                    if (
                      (module1501.default.shared().disableBackAndMore(),
                  ...
                  case 10:
                    if (
                      ...
                      module390.default.isCornerCleanModeSupported() &&
                        ...
                        f == module1625.CleanRouteDeepSlowPearlMode && (this.mopMode = module1625.CleanRouteDeepSlowMode)),
                      (this.cleanMode = M),
                      (this.waterMode = S),
                      (this.mopMode = f),
                      (C = module1625.isModeCustomized(M, S, f) && !h),
                      (x = module390.default.isPureCleanMopSupported() && M == module1625.CleanModeZero),
                      (v = module390.default.isPureCleanMopSupported() && S == module1625.WaterModeZero),
                      module390.default.isPureCleanMopSupported()
                        ? ((P = S != module1625.WaterModeZero && M != module1625.CleanModeZero),
                          (k = 0),
                          x ? (k = 1) : v ? (k = 2) : C && (k = 3),
                    ...
                    if (M == module1625.CustomCleanMode) M = module1625.CleanModes()[2].strength;
                    if (S == module1625.CustomWaterMode) S = module1625.MopWaterOrStrengths()[2].strength;
                    if (f == module1625.CustomMopMode) f = module1625.MopMethods()[0].strength;
                  ...
                  case 31:
                    this.setState(
                      ...
                      function () {
                        if (V.cleanModeSetView) V.cleanModeSetView.setMode(M, module1625.CustomCleanMode);
                        if (V.waterModeSetView) V.waterModeSetView.setMode(S, module1625.CustomWaterMode);
            ...
            function (n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    u = this.cleanMode || (null == this ? undefined : null == (t = this.cleanModeSetView) ? undefined : t.value) || 102;
                    h = (null == this ? undefined : null == (o = this.waterModeSetView) ? undefined : o.value) || this.waterMode || 202;
                    c = (null == this ? undefined : null == (s = this.mopModeSetView) ? undefined : s.value) || this.mopMode || 300;
                    if (
                      !(
                        h != module1625.WaterModeZero ||
                        (c != module1625.CleanRouteSubtlyMode && c != module1625.CleanRouteDeepSlowMode && c != module1625.CleanRouteDeepSlowPearlMode)
                      )
                    )
                      c = module1625.CleanRouteDailyMode;
              ...
              for (;;)
                switch ((M.prev = M.next)) {
                  ...
                  case 21:
                    ...
                    this.cleanMode = t;
                    if (this.cleanModeSetView) this.cleanModeSetView.setMode(t, module1625.CustomCleanMode);
          ...
          return regeneratorRuntime.default.async(
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    if (this.mopMode != module1625.CleanRouteFastMode || !t) {
                      s.next = 3;
                      break;
                    }
              ...
              for (;;)
                switch ((M.prev = M.next)) {
                  ...
                  case 38:
                    ...
                    this.showToast(module510.robot_communication_exception);
                    if (this.waterModeSetView) this.waterModeSetView.setMode(t, module1625.CustomWaterMode);
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  ...
                  case 11:
                    ...
                    if (((u = module420.StorageKeys.ExquisiteCleanbyGuide + '_' + o), (c.t0 = o == module1625.CleanRouteFastMode), c.t0)) {
                      c.next = 21;
                      break;
                    }
              ...
              for (;;)
                switch ((H.prev = H.next)) {
                  case 0:
                    ...
                    H.t0 = module1625.CustomCleanMode;
                    H.next = 17;
                    break;
                  ...
                  case 17:
                    ...
                    H.t4 = module1625.CustomWaterMode;
                    H.next = 30;
                    break;
                      ...
                      !c &&
                        (function () {
                          if (module390.default.isCleanRouteFastModeSupported()) {
                            if (!(p || (C != module1625.CleanRouteSubtlyMode && C != module1625.CleanRouteDeepSlowMode && C != module1625.CleanRouteDeepSlowPearlMode))) C = 300;
                            if (!(s || C != module1625.CleanRouteFastMode)) C = module1625.CleanRouteDailyMode;
                          } else if (!p) C = 300;

                          if (C == module1625.CustomMopMode) C = 300;
                        })(),
                      module390.default.isPureCleanMopSupported()
                        ? (M
                            ? ((f = module1625.WaterModeZero),
                              (this.state.shouldShowCleanModeView = true),
                              (this.state.shouldShowWaterModeView = false),
                              (this.state.shouldShowMopMethodView = false))
                            : p
                            ? ((S = module1625.CleanModeZero),
      ...
      },
      {
        ...
        value: function (t, o, n) {
          return !(module1625.isModeCustomized(t, o, n) && !this.props.isSmartScene);
        },
      },
      {
...
exports.default = z;
z.contextType = module1200.AppConfigContext;
z.defaultProps = {
