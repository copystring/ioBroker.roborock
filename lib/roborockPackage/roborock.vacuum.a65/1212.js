  ...
  O = (function (t) {
    ...
    function O(t) {
      ...
      n.onTouchStart = function (t) {
        if (!(null == n.props.handlePanStart)) n.props.handlePanStart(n.state.id, t == module1213.RectPanType.PanTypeMove, n.props.type);
      };
    ...
    module7.default(O, [
      ...
      },
      {
        ...
        value: function () {
          ...
          this.panProxy = new module1213.PanResponderProxy(module1213.RectPanType.PanTypeMove | module1213.RectPanType.PanTypeScale);
        ...
        value: function () {
          if (this.state.visible) {
            ...
            if (n) {
              ...
              o = module1340._getRotateRect(o, n);
              this.setState({
                rectSize: o,
        ...
        value: function () {
          ...
          var o = t.width + 2 * E,
            ...
            l = this.isFocus
              ? {}
              : {
                  bottom: module1127.buttonConfig.rectBtn.size.height + 13,
                },
            c = module1350.default.zoneAreaView(t.width, this.state.rectSize, true, this.state.serial, l),
            u = module1350.default.zoneFocusBorderView(t.width, t.height, E),
            p = module1350.default.zoneDeleteButton('clean_rect_edit_delete', this.panResponderDelete, E),
            h = module1350.default.zoneScaleButton(t, 'clean_rect_edit_scale', this.panProxy.panResponderScale, E),
            b = module1350.default.zoneDragButtonView(t.height, this.panProxy.panResponder),
      ...
      },
      {
        key: 'isNormal',
        get: function () {
          return this.props.type == module1127.CleanRectType.Normal;
        },
      },
      {
        key: 'isFocus',
...
O.defaultProps = {
  ...
  mapDeg: 0,
  type: module1127.CleanRectType.Normal,
};
