...
var module503 = require('./503'),
  React = require('react'),
  module13 = require('./13'),
  u = module13.NativeModules.ScrollViewManager,
  f = module13.ScrollView,
  ...
  module504 = module215({
    ...
    getScrollableNode: function () {
      return this._scrollComponent && this._scrollComponent.getScrollableNode ? this._scrollComponent.getScrollableNode() : module13.findNodeHandle(this._scrollComponent);
    },
    scrollTo: function () {
      var t;
    ...
    render: function () {
      for (
        ...
        var module506 = s.sectionIdentities[v],
          y = l[v];
        ...
        if (u) {
          var E = u(s.getSectionHeaderData(v), module506);
        ...
        for (var I = 0; I < y.length; I++) {
          var P = y[I],
            ...
            F = <module508 key={'r_' + L} shouldUpdate={!!D} render={this.props.renderRow.bind(null, s.getRowData(v, I), module506, P, this._onRowHighlighted)} />;

          if ((t.push(F), C++, this.props.renderSeparator && (I !== y.length - 1 || v === l.length - 1))) {
            var O = this.state.highlightedRow.sectionID === module506 && (this.state.highlightedRow.rowID === P || this.state.highlightedRow.rowID === y[I + 1]),
              N = this.props.renderSeparator(module506, P, O);
    ...
    _measureAndUpdateScrollProps: function () {
      ...
      if (t && t.getInnerViewNode && u && u.calculateChildFrames) u.calculateChildFrames(module13.findNodeHandle(t), this._updateVisibleRows);
    },
