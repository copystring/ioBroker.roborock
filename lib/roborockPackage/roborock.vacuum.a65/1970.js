...
function F(t) {
  for (var o = 1; o < arguments.length; o++) {
    ...
    if (o % 2)
      G(Object(l), true).forEach(function (o) {
...
var j = (function (t) {
  ...
  function j(t) {
    ...
    (o = G.call(this, t)).checkShowFurnitureModel = function () {
      var t;
    ...
    o.state = {
      ...
      cleanMode: 102,
      waterMode: 202,
      mopMode: module424.DMM.isGarnet ? 1 : 300,
      initializedInfo: false,
      hasMapList: (null != (n = module415.MM.maps) ? n : []).length > 0,
    };
    return o;
  }
  ...
  module7.default(j, [
    ...
    },
    {
      ...
      value: function () {
        var t,
          ...
          D = React.default.createElement(
            ...
            React.default.createElement(module385.SettingListItemView, {
              ...
              title: module510.multi_map_timer_select_map_title,
              detail:
                module1215.FloorMapPageUtils.getRealName(
                  null !=
                    (u =
                      null ==
                      (c = module415.MM.maps.find(function (t) {
          ...
          T = React.default.createElement(module385.SettingListItemView, {
            ...
            bottomDetail: this.state.cleanCount + ' ' + module510.dust_collection_life14,
            onPress: function () {
              return p.cleanCountActionSheetView.show();
            },
          }),
          L = React.default.createElement(module1928.default, {
            ref: function (t) {
          ...
          z = React.default.createElement(module382.ModeSettingPanel, {
            ref: function (t) {
              p.customModeView = t;
            },
            ...
            isTabZone: this.state.mode == U.Zone,
          ...
          O = React.default.createElement(module1347.default, {
            ref: function (t) {
              p.newSwitchGuideView = t;
            },
            parent: this,
            bgImage: this.theme.guideImages.findCarpet,
            topTitle: module510.tanos_s_mop_mode_title,
            context: module510.tanos_s_mop_mode_info1,
            buttonInfo: [module510.localization_strings_Setting_RemoteControlPage_51],
            buttonFuncId: ['mop_mode_guide_ok'],
          }),
          Z = React.default.createElement(module385.CancelableLoadingView, {
        ...
        var G = React.default.createElement(module1125.MultiMapSelectView, {
          ...
          F = React.default.createElement(module1509.default, {
            ref: function (t) {
              p.cleanCountActionSheetView = t;
            },
            title: module510.localization_strings_Setting_Timer_SettingPage_1,
            actions: ['1 ' + module510.dust_collection_life14, '2 ' + module510.dust_collection_life14, '3 ' + module510.dust_collection_life14],
          ...
          W = this.state.mode != U.GlobalClean || module390.default.isSupportSmartGlobalCleanWithCustomMode();
        return this.state.initializedInfo
          ? React.default.createElement(
              ...
              React.default.createElement(
                ...
                W && k,
                this.state.mode != U.GlobalClean && T,
                D,
                L,
                z,
                O,
                ...
                React.default.createElement(module1347.default, {
                  ...
                  topTitle: module510.new_firmware_detected,
                  context: module510.new_firmware_detected1,
                  buttonInfo: [module510.localization_strings_Setting_RemoteControlPage_51],
              ...
              module393
                ...
                .catch(function (t) {
                  ...
                  if (-10007 == (null == t ? undefined : null == (n = t.data) ? undefined : null == (o = n.error) ? undefined : o.code))
                    globals.showToast(module510.smart_scene_firmware_zone_reach_max_count);
    ...
    },
    {
      ...
      value: function () {
        ...
        if (module381.RSM.mapStatus != module381.MapStatus.None) {
          ...
          if (this.mapView && !this.mapView.addRectangle()) globals.showToast(module510.rubys_main_zone_max_tips);
        } else globals.showToast(module510.tap_zone_clean_button_without_map_tip);
      },
    },
    {
    ...
    },
    {
      ...
      value: function () {
        var t,
          n,
          o,
          l = module424.DMM.isGarnet ? (null == (t = this.state.mopMode) ? undefined : t.mop_template_id) : this.state.mopMode || 300;
    ...
    },
    {
      ...
      value: function (t) {
        ...
        if (module381.RSM.isRunning) {
          ...
          globals.Alert.alert('', module510.ask_if_stop_for_change_map, [l, s]);
        } else t();
      },
    },
    {
    ...
    },
    {
      ...
      value: function () {
        ...
        this.props.navigation.setParams({
          ...
          rightItems: [
            module1350.default.confirmButton(
              function () {
    ...
    },
    {
      ...
      value: function () {
        var t,
          ...
          c = null != (l = this.state.mode) ? l : U.Segment;
        ...
        if (module390.default.isSupportSmartScene()) {
          ...
          module393
            ...
            .then(function (t) {
              ...
              n.initSceneParas(y);
              return module416.default.reunionScenes(w);
            })
            .catch(function (t) {
    ...
    },
    {
      ...
      value: function () {
        var t = this;
        this.mapListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.MapDidUpdate, function () {
          var n, o, l, s;
          ...
          if ((t.updateMap(), (null != (n = null == (o = t.initialZonesList) ? undefined : o.length) ? n : 0) > 0)) {
            var u,
              ...
              h,
              p,
              S = t.initialZonesList;
            t.zidList = S.map(function (t) {
              return t.zid;
            });
            console.log('SmartSceneDebug: -- ZoneList: ' + JSON.stringify(S));
            var f = null != (u = null == (c = module415.MM.mapData) ? undefined : null == (h = c.smartZones) ? undefined : h.smartZones) ? u : [];
            console.log('SmartSceneDebug: -- MapZoneList: ' + JSON.stringify(f) + ', ZList: ' + JSON.stringify(t.zidList));
            var M = f
              .filter(function (t) {
                console.log('SmartSceneDebug: ' + zidList.hasElement(t.zid));
                return zidList.hasElement(t.zid);
              })
              .map(function (t) {
                return t.range;
              })
              .map(function (n) {
                ...
                var c = n[0],
                  ...
                  S = n[3],
                  f = [c, S, p, S, p, h, c, h];
                return null == (o = t.mapView)
                  ? undefined
                  : null == o.decodeMachineFBZ
                  ? undefined
                  : null == (l = o.decodeMachineFBZ(f, null == (s = t.mapView) ? undefined : null == (u = s.state) ? undefined : u.map))
                  ? undefined
                  : l.rectSize;
              });
            if (!(null == (p = t.mapView)))
              p.setState(F({}, module415.MM.mapData), function () {
                var n;
                if (!(null == (n = t.mapView) || null == n.addRectangleArray)) n.addRectangleArray(M);
              });
            t.zidList = S.map(function (t) {
              return t.zid;
            });
        ...
        this.robotListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.RobotStatusDidUpdate, function () {
          t.updateMap();
        ...
        this.specialEventListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.DidReceiveSpecialEvent, function (n) {
          if (n.data == module420.EventKeys.CurrentMapDidChange) t.resetSceneParams();
          else if (n.data == module420.EventKeys.MultiMapsDidReceive)
            t.setState({
              hasMapList: module415.MM.maps.length > 0,
            });
        });
        this.firmwareUpdateListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.RedDotDidChange, function (t) {
            ...
            if (!module390.default.isSupportSmartScene())
              if (n) {
                var o = {
                  ...
                  l = {
                    text: module510.smart_scene_firmware_update_alert_confirm,
                    onPress: function () {
                      module393.openDeviceUpgradePage();
                    },
                  };
                globals.Alert.alert(module510.localization_strings_Setting_RemoteControlPage_54, '', [o, l]);
              } else {
                var s = {
                  text: module510.localization_strings_Main_Error_ErrorDetailPage_3,
                  onPress: function () {
                ...
                globals.Alert.alert(module510.smart_scene_firmware_will_support_alert_title, '', [s]);
              }
          }
        });
        this.themeListener = module13.DeviceEventEmitter.addListener(module420.NotificationKeys.ThemeDidChange, function () {
    ...
    },
    {
      ...
      value: function () {
        ...
        var s = module415.MM.mapRotateAngle[module381.RSM.currentMapId];
        if (!(null == (t = this.mapView)))
          t.setState(
            F(
              F({}, module415.MM.mapData),
              {},
              {
        ...
        this.setState({
          ...
          bottomMenu: {
            isHidden: this.shouldShowNoMap && this.state.mode != U.GlobalClean,
            tip: this.bottomMenuTip,
          },
        });
        if (!(null == (n = this.sidebarMenu)))
          n.setState({
            tab: this.state.mode == U.Segment ? module1627.TabSegment : module1627.TabZone,
            mapEditButtonEnabled: module390.default.isSupportSmartScene(),
            modeSetButtonEnabled: module390.default.isSupportSmartScene(),
          });
          ...
          if (t != module381.RSM.currentMapId)
            module381.RSM.isRunning
              ...
              : ((n.isLoadingMap = true),
                ...
                new module1348.MultiMapDataProvider()
                  .loadMap(t)
                  .then(function (o) {
                    n.mapUpdated = false;
    ...
    },
    {
      ...
      value: function () {
        var t = module424.DMM.isGarnet,
          n = this.state.currentCleanMethod;
        if (module382.isModeCustomized(this.state.cleanMode, this.state.waterMode, this.state.mopMode)) return module510.map_edit_bottom_menu_mode;
        var o = module382.getCleanModeTitle(this.state.cleanMode),
          l = module382.getMopWaterOrStrengthTitle(this.state.waterMode),
          s = o + (l ? ' | ' + l : '');
        if (module390.default.isPureCleanMopSupported() && this.state.cleanMode == module1625.CleanModeZero) return l + ' | ' + module382.getMopMethodTitle(this.state.mopMode);

        if (module390.default.isShakeMopSetSupported() && 200 != this.state.waterMode) {
          var u = module382.getMopMethodTitle(this.state.mopMode);
          if (301 == this.state.mopMode) return l + ' | ' + u;

          if (t) {
            if (n == module1626.CleanMethodClean) return s;
            if (n == module1626.CleanMethodMop) return u;
            if (n == module1626.CleanMethodCleanAndMop) return s + ' | ' + u;
          }
        }
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return new Promise(function (o, l) {
          ...
          if ((!n.isTidValid(p) || undefined === v) && n.state.mode != U.GlobalClean) {
          ...
          if (v !== module381.RSM.currentMapId && n.state.mode != U.GlobalClean) {
    ...
    },
    {
      key: 'mapMode',
      get: function () {
        if (!module390.default.isSupportSmartScene()) return module1125.MapModelInCleanMode.Segment_Clean_Read_Only;

        switch (this.state.mode) {
          case U.GlobalClean:
            return module1125.MapModelInCleanMode.Global_Clean_With_Clean_Type;
          ...
          case U.Segment:
            ...
            else return n ? module1125.MapModelInCleanMode.Segment_Clean_Read_Only : module1125.MapModelInCleanMode.Segment_Clean_Edit;

          case U.Zone:
            return module1125.MapModelInCleanMode.Zone_Clean_Edit;
    ...
    },
    {
      ...
      get: function () {
        ...
        switch (this.state.mode) {
          case U.GlobalClean:
            t = module510.no_seg_map_tip;

          case U.Segment:
            t = module510.smart_scene_global_no_map_tip;
    ...
    },
    {
      ...
      get: function () {
        switch (this.state.mode) {
          ...
          case U.Zone:
          default:
            return module510.smart_scene_global_title;
        }
      },
    },
  ]);
