...
var x = {
  ...
  b = (function (t) {
    ...
    function b(t, s) {
      ...
      var c = {
        height: new module13.Animated.Value(0),
        initHeight: 0,
        initWidth: 0,
        isMeasured: false,
        width: new module13.Animated.Value(0),
      };
      u.state = {
        layout: c,
        position: new module13.Animated.Value(u.props.navigation.state.index),
        progress: new module13.Animated.Value(1),
        scenes: module1267.default([], u.props.navigation.state, null, u.props.descriptors),
      };
      u._prevTransitionProps = null;
    ...
    module7.default(b, [
      ...
      },
      {
        ...
        value: function (t) {
          var n = module1267.default(this.state.scenes, t.navigation.state, this.props.navigation.state, t.descriptors);
                ...
                function (o) {
                  for (;;)
                    switch ((o.prev = o.next)) {
                      ...
                      case 5:
                        module13.Animated.parallel(b).start(u._onTransitionEnd);
...
function w(t, n) {
  var s = t.navigation,
    ...
    l = n.scenes,
    p = l.find(V);
  module1253.default(p, 'Could not find active scene');
  return {
    layout: o,
    navigation: s,
    position: u,
