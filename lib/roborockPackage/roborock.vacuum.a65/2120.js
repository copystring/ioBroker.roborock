            ...
            for (;;)
              switch ((l.prev = l.next)) {
                case 0:
                  ...
                  l.next = 5;
                  return regeneratorRuntime.default.awrap(module416.default.setSoundVolume(t));
...
var S = module13.StyleSheet.create({
  ...
  wrap: {
    width: module13.Dimensions.get('window').width - 80,
    borderRadius: 8,
  ...
  bottomButton: {
    width: module13.Dimensions.get('window').width / 2 - 40,
    alignSelf: 'stretch',
    justifyContent: 'center',
    backgroundColor: 'white',
  },
