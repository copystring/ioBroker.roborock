exports.default = function (t) {
  var n = this,
    C = t.data,
    v = undefined === C ? new module1969.CommandListSectionData('', []) : C,
    x = t.titleStyle,
    y =
      undefined === x
        ? {
    ...
    S = t.onStartDragging,
    h = t.onEndDragging,
    T = React.useContext(module1200.AppConfigContext).theme,
    M = function (t) {
      var n = t.data;
      t.active;
      return React.default.createElement(module2155.default, {
        isSorting: w,
        key: n.name,
        data: n,
    ...
    F = React.useMemo(
      function () {
        return React.default.createElement(
          ...
          React.default.createElement(module2159.default, {
            style: {
              flex: 1,
            },
