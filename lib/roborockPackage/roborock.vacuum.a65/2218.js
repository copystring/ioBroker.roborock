...
var C = (function (t) {
  ...
  module7.default(C, [
        ...
        var t = this,
          ...
          p = this.tabItems.map(function (o) {
            ...
            if (u && 'monitor_tab_record' == o.action)
              return React.default.createElement(module2206.default, {
                onPress: function () {
                  return s();
                },
    ...
    },
    {
      ...
      get: function () {
        return (module424.DMM.isTopazSV_CN || module424.DMM.isCoral) && 'cn' == module381.RSM.countryCode && 'cn' == module381.RSM.deviceLocation;
      },
    },
    {
      key: 'tabItems',
