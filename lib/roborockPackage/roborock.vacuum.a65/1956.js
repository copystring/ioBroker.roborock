...
var module510 = require('./510').strings,
  ...
  module1639 = require('./1639').Errors,
  ...
  A = (function (t) {
    ...
    module7.default(E, [
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module1959.getCountryInfo(function (n, o) {
            if (n && !t.isUnmount)
              t.setState({
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  this.state.code >= 100 && this.state.code <= 255
                    ? module510.localization_strings_Main_Error_Constants_1 + ':' + this.state.code + ' ' + module1639()[this.state.code][4]
                    : ''
                ),
                React.default.createElement(
                  O,
