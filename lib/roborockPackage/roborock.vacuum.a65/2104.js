  ...
  I = (function (t) {
    ...
    module7.default(I, [
      ...
      },
      {
        key: 'isValidTag',
        value: function (t) {
          return !this.props.supportTag || (!(!t || t <= 0) && 'object' == typeof module1127.RoomTagInfo[t]);
        },
      },
      {
        key: 'isAutoCreateTagName',
        value: function (t, o) {
          if (!module1127.RoomTagInfo[o] && t.length > 0) return false;
          var n = module1127.RoomTagInfo[o].name;
          if (t == n) return true;
          var s = n.length;

          if (t.length > s) {
            var l = t.substring(0, s);
            if (l == module1127.RoomTagInfo[o].name && (l = t.substring(s)).match(/^\d+$/)) return true;
          }
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if ('' == o) o = module1127.RoomTagInfo[t].name;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (t.length >= 2 && this.props.supportTag)
            for (var n = 0; n < module1127.DisplayRoomTag.length; n++)
              if (this.isAutoCreateTagName(t, module1127.DisplayRoomTag[n])) {
                o = module1127.DisplayRoomTag[n];
                break;
              }
          return o;
        },
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            module2105 = module1127.RoomTagInfo[this.state.selectTagKey] ? module1127.RoomTagInfo[this.state.selectTagKey].image : require('./2105'),
            u = {
            ...
            module2106 = module1127.DisplayRoomTag.map(function (o, s) {
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    React.default.createElement(
                      ...
                      React.default.createElement(module13.Image, {
                        style: R.tagImg,
                        source: module1127.RoomTagInfo[o].image,
                      }),
                      React.default.createElement(
                        module13.Text,
            ...
            module2108 = this.state.showAllName ? require('./2107') : require('./2108'),
