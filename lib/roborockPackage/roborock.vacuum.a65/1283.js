  ...
  function k() {
    ...
    t._handleDrawerOpen = function () {
      t.props.navigation.dispatch({
        type: module1282.default.DRAWER_OPENED,
    ...
    t._handleDrawerClose = function () {
      t.props.navigation.dispatch({
        type: module1282.default.DRAWER_CLOSED,
        key: t.props.navigation.state.key,
      });
    };
      ...
      value: function () {
        ...
        return React.default.createElement(
          module1284.default,
          {
            ...
            drawerPosition: 'right' === this.props.navigationConfig.drawerPosition ? module1284.default.positions.Right : module1284.default.positions.Left,
          },
