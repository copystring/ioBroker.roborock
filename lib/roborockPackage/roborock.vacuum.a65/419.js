                ...
                for (;;)
                  switch ((l.prev = l.next)) {
                    ...
                    case 4:
                      ...
                      if (module6.length >= 40) module7 = module7.concat(module6.splice(40, module6.length - 40));
                          ...
                          function (n) {
                            for (;;)
                              switch ((n.prev = n.next)) {
                                case 0:
                                  if ((t - parseInt(s.replace('log_', ''))) / 1e3 >= 432e3) module7.push(s);
            ...
            return regeneratorRuntime.default.async(
              function (o) {
                for (;;)
                  switch ((o.prev = o.next)) {
                    case 0:
                      if (!(!module393.isLogFunctionSupported() || this.logs.length <= 3 || this.logs.length >= 3e4)) {
                        o.next = 2;
                        break;
                      }
