  ...
  module498 = (function () {
    ...
    module7.default(
      ...
      [
        ...
        {
          key: 'isTanosSLitePlus',
          get: function () {
            return this.currentProduct == T.TanosSLitePlus;
          },
        },
      ],
      [
...
module50.default(u, P.TanosSLitePlus, {
  models: [
    'roborock.vacuum.a88',
    'roborock.vacuum.a88v2',
    'roborock.vacuum.a88v3',
    'roborock.vacuum.a88v4',
    'roborock.vacuum.a88v5',
    'roborock.vacuum.a89',
    'roborock.vacuum.a89v2',
    'roborock.vacuum.a89v3',
    'roborock.vacuum.a89v4',
    'roborock.vacuum.a89v5',
  ],
  volume: y.Default,
  product: T.TanosSLitePlus,
  resources: module425.ResourceMap.UltronLite,
});
