      ...
      value: function () {
          ...
          this.panResponderScale = module13.PanResponder.create({
            ...
            onPanResponderStart: function (n, o) {
              if (!(n.nativeEvent.touches.length > 1)) {
                var l = module1340._parseMove(n.nativeEvent, o) || {};
                t.scale.dx = l.x;
                t.scale.dy = l.y;
                ...
                if (s) {
                  ...
                  if (c) {
                    ...
                    t.rotateTrans.widthVsign = module1340._pointVectorToLine(
                      t.rotateTrans.realLTX,
                      t.rotateTrans.realLTY,
                      t.rotateTrans.targetVectorX,
                      t.rotateTrans.targetVectorY
                    );
                    t.rotateTrans.heightVsign = module1340._pointVectorToLine(
                      t.rotateTrans.realLTX,
                      t.rotateTrans.realLTY,
            ...
            onPanResponderMove: function (o, l) {
              if (!(o.nativeEvent.touches.length > 1)) {
                o = module1340._parseMove(o.nativeEvent, l) || {};
                var s = null == t.callBack.getInfo ? undefined : t.callBack.getInfo();
                ...
                if (s) {
                  ...
                  if (c) {
                    var h = {
                      ...
                      T = module1340._parseDegPointWithTrans(o, h, s.trans, s.mapDeg),
                    ...
                    if (s.mapDeg % 360 == 0 && 0 === s.slopeAngle) {
                      ...
                      if (((w = X[0]), (E = X[1]), X[2])) {
                        var Y = E ** w,
                          L = module1340._regularAngle(s.slopeAngle + Y);
        ...
        if (this.rectPanType & T.PanTypeRotate)
          this.panResponderRotate = module13.PanResponder.create({
            ...
            onPanResponderMove: function (o, l) {
              if (!(o.nativeEvent.touches.length > 1)) {
                var s = module1340._parseMove2(o.nativeEvent, l) || {},
                  c = null == t.callBack.getInfo ? undefined : t.callBack.getInfo();

                if (c) {
                  var h = module1340._parseDegPointWithTrans(
                      s,
                      {
                        x: 0,
                        y: 0,
              ...
              if (!(o.nativeEvent.touches.length > 1)) {
                ...
                if (s) {
                  var c = {
                    ...
                    T = module1340._parseDegPointWithTrans(o, c, s.trans, s.mapDeg),
                    p = module23.default(T, 2),
                    v = p[0],
                    f = p[1],
                    R = t.wallEnd.x + v,
                  ...
                  if (B > module1127.RectConfig.maxLength) {
                    var w = module1127.RectConfig.maxLength - B;
                    P += Math.sin(D) * w;
                    R += Math.cos(D) * w;
                  }

                  if (!(B < module1127.RectConfig.minLength)) {
                    var E = {
    ...
    },
    {
      ...
      value: function (t, n) {
        var o,
          l,
          s = false,
          c = module1127.RectConfig.maxLength,
          u = module1127.RectConfig.maxLength,
          T = module1127.RectConfig.minLength,
          p = module1127.RectConfig.minLength,
        ...
        if (v) {
          ...
          if (f) {
            ...
            if ((null == (c = (h = this.callBack).onShouldTwoFinger) ? undefined : c.call(h)) && t.hasOwnProperty('distance') && o.hasOwnProperty('distance')) {
              ...
              var B = module1340._parseDegPointWithTrans(t, o, v.trans, v.mapDeg),
    ...
    },
    {
      ...
      value: function (t, o) {
        ...
        if (!t.hasOwnProperty('distance')) {
          ...
          if (T) {
            var p = module1340._parseDegPointWithTrans(t, o, T.trans, T.mapDeg),
