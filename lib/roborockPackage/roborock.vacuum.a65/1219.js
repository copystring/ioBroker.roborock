  ...
  var N = (function (_) {
    ...
    function x(n) {
      ...
      u._handleOpenURL = function (n) {
        ...
        if (false !== c) {
          var f = module1229.urlToPathAndParams(o, l);
      ...
      u.dispatch = function (n) {
        ...
        var o = u._navState;
        module1224.default(o, 'should be set in constructor if stateful');
      ...
      k(n);
      u._initialAction = module1221.default.init();
      if (u._isStateful())
        u.subs = module13.BackHandler.addEventListener('hardwareBackPress', function () {
          if (u._isMounted) return u.dispatch(module1221.default.back());
    ...
    module7.default(x, [
            ...
            function (N) {
              for (;;)
                switch ((N.prev = N.next)) {
                  ...
                  case 18:
                    p = N.sent;
                    l = p && module1229.urlToPathAndParams(p, u);
      ...
      },
      {
        ...
        value: function (t, n) {
          ...
          this.dispatch(module1221.default.init());
        },
      },
      {
        ...
        value: function () {
          ...
          if (this._isStateful()) {
            ...
            if (!(this._navigation && this._navigation.state === u))
              this._navigation = module1222.default(t.router, u, this.dispatch, this._actionEventSubscribers, this._getScreenProps, function () {
                return o._navigation;
              });
            s = this._navigation;
          }

          module1224.default(s, 'failed to get navigation');
