  ...
  module461 = (function (t) {
    ...
    function M(t) {
      ...
      (n = y.call(this, t)).handlePressForbiddenBtn = function () {
        if (module381.RSM.mapSaveEnabled)
          module381.RSM.state != module381.RobotState.UPDATING
            ? n.pageType == module1127.AIInfoPageType.Carpet
              ? n._carpetPageAction(true)
              : n.pageType == module1127.AIInfoPageType.DoorSill
              ? n._doorSillPageAction(true)
              : n.pageType == module1127.AIInfoPageType.StuckZone
              ? n._stuckZonePageAction(true)
              : n.pageType == module1127.AIInfoPageType.CliffZone && n._cliffZonePageAction(true)
        ...
        if (module381.RSM.mapSaveEnabled)
          module381.RSM.state != module381.RobotState.UPDATING
            ? n.pageType == module1127.AIInfoPageType.Carpet
              ...
              : n.pageType == module1127.AIInfoPageType.CliffZone && n._cliffZonePageAction(false)
            : globals.showToast(module510.localization_strings_Setting_RemoteControlPage_13);
        else globals.showToast(module510.open_map_save_mode_tip);
      };
      ...
      n.handleSubTextLayout = function (t) {
        var o = 234 + t.nativeEvent.layout.height + 20,
          l = n.pageType == module1127.AIInfoPageType.DoorSill ? 285 : 360;
        o = l ** o;
        o = o ** (H - q - 44 - 142 - 30);
        n.setState({
          topHeight: o,
      ...
      n.pageType = n.props.navigation.getParam('pageType', module1127.AIInfoPageType.Carpet);
      return n;
    }
    ...
    module7.default(M, [
        ...
        value: function () {
          ...
          return this.state.initLoad
            ...
            : React.default.createElement(
                ...
                this.getHeaderView(),
                this.showBottomView && module1350.default.mapEditStep >= module1350.MapEditSteps.Saved && this.getBottomView(),
                this.getLoadingView()
              );
        },
      },
      ...
      },
      {
        key: 'backgroundImage',
        get: function () {
          return module1127.AIInfoPageBackRes[this.pageType].image || require('./461');
        },
      },
      {
        key: 'title',
        get: function () {
          return module1127.AIInfoPageBackRes[this.pageType].title || module510.carpet_bubble_name;
        },
      },
      {
        key: 'subText',
        get: function () {
          return module1127.AIInfoPageBackRes[this.pageType].detail || this.getCleanModeSubText();
        },
      },
      {
        key: 'topButtonText',
      ...
      },
      {
        key: 'isCarpetPage',
        get: function () {
          return this.pageType == module1127.AIInfoPageType.Carpet;
        },
      },
    ]);
    return M;
...
module461.contextType = module1200.AppConfigContext;
