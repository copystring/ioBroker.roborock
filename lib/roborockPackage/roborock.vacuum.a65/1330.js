...
var R = 375,
  ...
  j = B.height,
  I = B.width,
  T = module13.NativeModules.PlatformConstants,
  M =
    'web' !== module13.Platform.OS && (('ios' === module13.Platform.OS && ((j === P && I === R) || (j === R && I === P))) || (896 === j && 414 === I) || (414 === j && 896 === I)),
  k = !('ios' !== module13.Platform.OS || M || (j > I && I < 768) || (I > j && j < 768)),
  x = null,
  E = function (t) {
    return null !== x ? x : 'android' === module13.Platform.OS ? (globals.Expo ? globals.Expo.Constants.statusBarHeight : 0) : M ? (t ? 0 : 44) : k ? 20 : t ? 0 : 20;
  },
  A = function (t) {
    ...
    module7.default(s, [
      {
        ...
        value: function () {
          ...
          module13.InteractionManager.runAfterInteractions(function () {
            t._onLayout();
          });
        },
      },
