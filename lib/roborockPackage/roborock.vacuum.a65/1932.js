  ...
  W = (function (t) {
    ...
    module7.default(W, [
      ...
      },
      {
        ...
        value: function () {
          var t = this.state.tab,
            n = t == module1627.TabSegment,
            o = t == module1627.TabZone,
          ...
          return module381.RSM.hasGotMapFirstTime
            ? React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  module381.RSM.isExploring && React.default.createElement(module1933.default, null)
                )
              )
            : null;
        },
      ...
      },
      {
        key: 'isOnlyMopMode',
        value: function (t, n) {
          return module390.default.isPureCleanMopSupported() && module381.RSM.fanPower == module1625.CleanModeZero;
        },
      },
      {
...
var D = module13.StyleSheet.create({
  wrapContainer: {
    height: 200,
    marginBottom: -module1435.TabWrapHeight,
  },
  container: {
    flexDirection: 'row',
  ...
  leftContainer: {
    marginBottom: module1435.TabWrapHeight + 10,
    marginLeft: 22,
  },
  loadMapButton: {
