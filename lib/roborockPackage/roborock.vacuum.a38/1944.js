  ...
  L = (function (t) {
    ...
    module5.default(I, [
            ...
            1 == this.state.multiFloorEnabled
              ...
              : (null == (t = this.globalLoadingView) || t.showWithText(),
                module1329.MM.getMultiMaps()
                  .then(function () {
                    if (module1329.MM.maps.length <= 1) n.setMultiFloorSwitch(false);
                    else
                              ...
                              switch ((l.prev = l.next)) {
                                case 0:
                                  ...
                                  return regeneratorRuntime.default.awrap(
                                    module414.default.setLabStatus({
                                      lab_status: 3,
                                    })
                                  );
                                ...
                                case 11:
                                  module1404.setTimeout(function () {
                                    return n.saveSelectMap(module1329.MM.maps.length >= 1 ? module1329.MM.maps[0].id : -1, 1e3);
                                  });
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    ...
                    t.next = 4;
                    return regeneratorRuntime.default.awrap(module414.default.setSwitchMapMode(this.state.smartSwitchEnabled ? 0 : 1));
      ...
      },
      {
        ...
        value: function (t) {
          if (!t) globals.showToast(module500.robot_communication_exception);
        },
      },
      {
        key: 'render',
        value: function () {
          var t = this,
            ...
            module1947 = React.default.createElement(
              module12.View,
              {
                style: C.floorItem,
              },
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    React.default.createElement(module12.Image, {
                      ...
                      source: this.state.multiFloorEnabled ? require('./1947') : require('./1946'),
                    }),
                    React.default.createElement(
                      module12.Text,
                      {
                      ...
                      module500.single_floor_pattern
                    )
                  )
                )
              )
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    React.default.createElement(module12.Image, {
                      ...
                      source: this.state.multiFloorEnabled ? require('./1946') : require('./1947'),
                    }),
                    React.default.createElement(
                      module12.Text,
                      {
            ...
            u = React.default.createElement(module1395.MapSaveActionSheetView, {
              ...
              mode: module1395.MapSaveActionSheetMode.KeepMap,
            }),
            h = this.state.multiFloorEnabled
              ? React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    module500.multi_map_function_description_text_1
                  ),
                  React.default.createElement(
                    module12.Text,
                    {
                    ...
                    module500.single_floor_save_new_map_tip
                  )
                )
            ...
            p = React.default.createElement(
              ...
              React.default.createElement(
                ...
                module500.multi_floor_not_support_block_timer
              )
            ),
            b = module390.default.isSupportSetSwitchMapMode() && this.state.multiFloorEnabled,
            module1938 = {
              title: module500.smart_switch_pattern,
              bottomDetail: module500.smart_switch_tip,
              fontSize: 16,
            ...
            module1938 = {
              title: module500.manual_switch_pattern,
              bottomDetail: module500.manual_switch_tip,
              fontSize: 16,
          ...
          return React.default.createElement(
            ...
            b &&
              React.default.createElement(
                ...
                module500.smart_switch_section_title
              ),
            React.default.createElement(
              module12.View,
              {
...
exports.default = L;
L.contextType = module515.AppConfigContext;
