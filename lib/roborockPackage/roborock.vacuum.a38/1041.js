...
var p = function t(n, s, p) {
  ...
  var O = module1043.default(n.router, y.routeName),
    b = y.routes && 'number' == typeof y.index ? y.routes[y.index] : null,
    P = f(f(f(f({}, n.actions), n.router.getActionCreators(y, n.state.key)), O ? O.getActionCreators(b, y.key) : {}), module1039.default(y)),
    j = {};
  ...
  var h = module1042.default(n.addListener, s);
  v[s] = f(
    f({}, j),
    {},
    {
