...
function f(t) {
  var o = React.useContext(module515.AppConfigContext).theme.alert,
  ...
  return React.default.createElement(
    ...
    !f &&
      React.default.createElement(
        ...
        _ || module500.camera_monitor_privacy_title
      ),
    React.default.createElement(
      module12.Text,
      null,
      React.default.createElement(
        ...
        u || module500.real_time_monitor_privacy_desc,
        React.default.createElement(
          module12.Text,
          {
            style: c.link,
          ...
          ' ' + b || module500.monitor_privacy_dialog_title
        )
      )
    ),
    y &&
