  ...
  E = (function (t) {
    ...
    function B(t) {
      ...
      (n = M.call(this, t))._handleStartShouldSetPanResponder = function () {
        return (
          n.props.mapMode == module1153.MAP_MODE_MAP_EDIT ||
      ...
      n._handlePanResponderStart = function (t, o) {
        n.touch.move = module1402._parseEvent2(t.nativeEvent, o) || {};
    ...
    module5.default(B, [
      ...
      },
      {
        key: '_getMoveXY',
        value: function (t, n) {
          var s = [module1402._parseEvent2(t.nativeEvent, n), this.touch.move],
            l = s[0],
            h = s[1];
          if (((this.touch.move = l || {}), !(l && l.x && l.y && h.x))) return null;
          if (l.hasOwnProperty('distance')) return null;

          var u = module1402._parseDegPointWithTrans(l, h, this.props.transform, this.props.mapDeg),
      ...
      },
      {
        ...
        value: function () {
          return null == this.state.leftSplitPoint || null == this.state.rightSplitPoint
            ? {
                error: this.needAdjustPoint ? module500.map_edit_split_restriction_point_adjust : module500.map_edit_split_restriction_point_illegal,
              }
            : {
        ...
        value: function () {
          ...
          if (!s || !s.data || s.data.length <= 0) this.resetSplitPoint();
            ...
            var l = function (t, n) {
              ...
              u = function (o, s) {
                var l = module1402._getAroundIndexInfo(n, o, s),
                  h = 0;
              ...
              c = this.formLine(f, p),
              v = module1402._mapScreenToOriginXY(n, f.x, f.y),
              y = module1402._mapScreenToOriginXY(n, p.x, p.y),
              P = this.formLine(y, v),
              x = function (t, n, o) {
              ...
              for (var M = v.y ** y.y, B = v.y ** y.y, A = 0; A < s.height && !(M - A <= B); A++) {
                ...
                if (D == t && 0 != T) {
                  if (((k = true), 0 == A && (this.adjustDirecton.right = 1 != T ? S(null, M + 1) : u(L, I)), !this.adjustDirecton.right)) {
                    ...
                    var C = (E = module1402._mapOriginXYToScreen(n, L, I)).y;
              ...
              for (var O = 0; O < s.height && !(B + O >= M); O++) {
                ...
                if (W == t && 0 != Z) {
                  if (((R = true), 0 == O && (this.adjustDirecton.left = 1 != Z ? S(null, B - 1) : u(Y, V)), !this.adjustDirecton.left)) {
                    ...
                    var q = (b = module1402._mapOriginXYToScreen(n, Y, V)).y;
              ...
              for (var H = v.x ** y.x, U = v.x ** y.x, z = 0; z < s.width && !(H - z <= U); z++) {
                ...
                if ($ == t && 0 != tt) {
                  if (((k = true), 0 == z && (this.adjustDirecton.right = 1 != tt ? S(H + 1, null) : u(G, J)), !this.adjustDirecton.right)) {
                    ...
                    var et = (E = module1402._mapOriginXYToScreen(n, G, J)).x;
              ...
              for (var nt = 0; nt < s.width && !(U + nt >= H); nt++) {
                ...
                if (st == t && 0 != lt) {
                  if (((R = true), 0 == nt && (this.adjustDirecton.left = 1 != lt ? S(U - 1, null) : u(it, ot)), !this.adjustDirecton.left)) {
                    ...
                    var ht = (b = module1402._mapOriginXYToScreen(n, it, ot)).x;
      ...
      },
      {
        ...
        value: function () {
          ...
          if ((t = module1402._isVerticalRotate(this.props.mapDeg) ? this.getRotateEdge() : this.getNormalEdge()) && t.res) {
            var n = this.props.parent.props.parent.state.map,
              o = module1402._mapOriginXYToScreen(n, t.left.x, t.left.y),
              s = module1402._mapOriginXYToScreen(n, t.right.x, t.right.y);
      ...
      },
      {
        ...
        value: function () {
          ...
          globals.showToast(module500.map_edit_split_restriction_point_illegal);
        },
      },
      {
        key: 'showAdjustPoint',
        value: function () {
          ...
          globals.showToast(module500.map_edit_split_restriction_point_adjust);
        },
      },
      {
        key: 'render',
              ...
              isNaN(k) || isNaN(R)
                ...
                : React.default.createElement(
                    ...
                    React.default.createElement(
                      ...
                      React.default.createElement(module1163.Circle, {
                        cx: '20',
                        cy: '20',
                        r: '8',
                        stroke: 'white',
