...
var module502 = require('./502'),
  x = [module419.Types.Home, module419.Types.KeyEvent, module419.Types.LoopStatus, module419.Types.LoopMap],
  C = (function (t) {
    module7.default(R, t);
    ...
    function R(t) {
      ...
      n.state = {
        ...
        showDelete: true,
        isNoData: false,
        selectedTypes: module419.Category.map(function (t, n) {
          return -1 !=
    ...
    module5.default(R, [
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    c.t0 = JSON.parse(JSON.stringify(module417.Log.logs));
                    c.next = 8;
                    break;

                  case 5:
                    c.next = 7;
                    return regeneratorRuntime.default.awrap(module417.Log.getLog(this.logId));
                    ...
                    l = (t ? n : n.logs).filter(function (t) {
                      return (
                        ...
                        s.state.selectedTypes.findIndex(function (n) {
                          return module419.Category[n].type == t.type;
                        })
                      );
                    });
                    this.logs = l;
      ...
      },
      {
        ...
        value: function () {
          ...
          this.logs.forEach(function (n) {
            t += n.type + '  ' + module420.default.getTime(n.time) + ' \n ' + n.content + ' \n\n';
          });
          this.copy(t);
        },
      },
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    ...
                    n.next = 4;
                    return regeneratorRuntime.default.awrap(module417.Log.upload(this.logId, t));
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module385.OptionSheetView, {
              title: '\u8bf7\u9009\u62e9\u8981\u67e5\u770b\u7684log\u7c7b\u578b',
              options: module419.Category.map(function (t) {
                return t.name;
              }),
      ...
      },
      {
        key: 'renderRow',
        value: function (t) {
          var n = module419.GetCateroy(t.type) || {};
          return React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    module420.default.getTime(t.time),
                    ' '
                  )
                )
              ),
      ...
      },
      {
        key: 'onPressRow',
        value: function (t) {
          this.copy(t.type + '  ' + module420.default.getTime(t.time) + ' \n' + t.content);
        },
      },
    ]);
    return R;
