  ...
  I = (function (t) {
    ...
    module5.default(I, [
      ...
      },
      {
        ...
        value: function () {
          ...
          var l = this.state.isUnitsTime ? module398(this.state.spent) : this.state.spent,
            ...
            u =
              !module393.isMiApp &&
              (this.state.gid || this.state.url || this.state.path) &&
              'cn' == module381.RobotStatusManager.sharedManager().serverCode &&
              module390.default.isOpenMiShopSupported(),
            ...
            p = React.default.createElement(
              ...
              this.state.isUnitsTime ? 'h' : module500.dust_collection_life14
            ),
            ...
            w = React.default.createElement(
              ...
              this.state.isUnitsTime ? '%' : module500.dust_collection_life14
            ),
                    ...
                    ? React.default.createElement(
                        ...
                        React.default.createElement(
                          ...
                          React.default.createElement(
                            ...
                            module500.localization_strings_Setting_Supplies_DetailsPage_4
                          ),
                          React.default.createElement(
                            module12.Text,
                            {
                            ...
                            module500.localization_strings_Setting_Supplies_DetailsPage_5
                          )
                        ),
                        React.default.createElement(
                          module12.View,
      ...
      },
      {
        ...
        value: function () {
          if (module393.isMiApp) module393.openShopPage(this.state.gid);
          else if (module393.isMiApp || module393.isSupportGotoMainlandMall()) {
            if (module393.isSupportGotoMainlandMall()) module393.gotoMainlandMall(this.state.path);
          } else globals.showToast(module500.map_object_app_version_tip);
        },
      },
      {
        key: 'calcLeftPercent',
                        ...
                        switch ((s.prev = s.next)) {
                          ...
                          case 4:
                            ...
                            module12.DeviceEventEmitter.emit(module418.NotificationKeys.DidReceiveSpecialEvent, {
                              data: module418.EventKeys.ConsumableReset,
                            });
                          ...
                          case 11:
                            s.prev = 11;
                            s.t0 = s.catch(1);
                            globals.showToast(module500.localization_strings_Setting_Supplies_DetailsPage_13);
