    ...
    module5.default(x, [
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module515.AppConfigContext.Consumer, null, function (o) {
            var l = t.props,
              s = l.detail,
              c = l.selected,
              f = l.detailWidth,
            ...
            u = u || X.detailColor;
            if (!S && !R) R = module12.Dimensions.get('window').width - 40;
            var Z =
                s &&
                !E &&
              ...
              nt =
                E &&
                React.default.createElement(module514.default, {
                  funcId: ot + '_switch',
              ...
              rt = module12.Dimensions.get('window').width,
              lt =
                (j || V) &&
                React.default.createElement(module12.View, {
                  style: [
              ...
              React.default.createElement(
                module12.View,
                {
                  ...
                  accessibilityLabel:
                    ...
                    (E ? (t.props.switchOn ? module500.accessibility_on : module500.debug_info_close) : ''),
                },
                lt,
                React.default.createElement(
                  module12.View,
