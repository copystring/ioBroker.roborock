...
var module1402 = require('./1402'),
  O = 2 * module1332.buttonConfig.rectBtn.size.width,
  x = (function (t) {
    module7.default(x, t);
    ...
    function x(t) {
      ...
      n.onTouchStart = function (t) {
        if (!(null == n.props.handlePanStart)) n.props.handlePanStart(n.state.id, t == module1395.RectPanType.PanTypeMove);
      };
    ...
    module5.default(x, [
      ...
      },
      {
        ...
        value: function () {
          ...
          this.panProxy = new module1395.PanResponderProxy(module1395.RectPanType.PanTypeMove | module1395.RectPanType.PanTypeScale);
        ...
        value: function () {
          if (this.state.visible) {
            ...
            if (n) {
              ...
              o = module1402._getRotateRect(o, n);
              this.setState({
                rectSize: o,
      ...
      },
      {
        ...
        value: function () {
          ...
          var t = this.context.theme.displayZones,
            o = module1402._convertToPixelRect(this.state.rectSize, this.props.transform);
          ...
          var s = o.width + 2 * O,
            ...
            c = this.state.isFocus
              ? {}
              : {
                  bottom: module1332.buttonConfig.rectBtn.size.height + 13,
                },
            u = 4 != this.state.cleanMode,
            p = module1410.default.zoneAreaView(o.width, this.state.rectSize, true, this.state.serial, c),
            h = module1410.default.zoneFocusBorderView(o.width, o.height, O),
            R = module1410.default.zoneDeleteButton('clean_rect_edit_delete', this.panResponderDelete, O),
            P = module1410.default.zoneScaleButton(o, 'clean_rect_edit_scale', this.panProxy.panResponderScale, O),
            S = module1410.default.zoneDragButtonView(o.height, this.panProxy.panResponder),
