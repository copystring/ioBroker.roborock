...
class w {
  constructor(t) {
    module4(this, h);
    module494(t && 'function' == typeof t.rowHasChanged, 'Must provide a rowHasChanged function.');
  ...
  cloneWithRowsAndSections(t, n, s) {
    module494('function' == typeof this._sectionHeaderHasChanged, 'Must provide a sectionHeaderHasChanged function with section data.');
    module494(!n || !s || n.length === s.length, 'row and section ids lengths must be the same');
    var c = new h({
  ...
  rowShouldUpdate(t, n) {
    ...
    module496(undefined !== s, 'missing dirtyBit for section, row: ' + t + ', ' + n);
    return s;
  }
  ...
  getRowData(t, n) {
    ...
    module496(undefined !== s && undefined !== o, 'rendering invalid section, row: ' + t + ', ' + n);
  ...
  sectionHeaderShouldUpdate(t) {
    ...
    module496(undefined !== n, 'missing dirtyBit for section: ' + t);
    return n;
  }
  ...
  getSectionHeaderData(t) {
    ...
    module496(undefined !== n, 'renderSection called on invalid section: ' + t);
  ...
  _calculateDirtyArrays(t, n, s) {
    for (var o, h = f(n), u = {}, l = 0; l < s.length; l++) {
      var w = n[l];
      module496(!u[w], 'SectionID appears more than once: ' + w);
      u[w] = f(s[l]);
    }
...
function f(t) {
  if (module495(t)) return {};

  for (var n = {}, s = 0; s < t.length; s++) {
    var o = t[s];
    module496(!n[o], 'Value appears more than once in array: ' + o);
    n[o] = true;
  }
