  ...
  function P() {
    ...
    n._renderTabBar = function (t) {
      var o = n.props.navigation.state,
        ...
        p = n.props,
        f = p.tabBarComponent,
        b = undefined === f ? module1141.default : f,
        h = p.tabBarPosition,
        x = p.tabBarOptions;
    ...
    n._renderScene = function (t) {
      ...
      if (c) {
        ...
        if (p)
          return (
            <module1128.default isVisible={y}>
              {l({
                route: o,
              })}
            </module1128.default>
...
module1036.polyfill(P);
var w = module1123.default(P);
exports.default = w;
