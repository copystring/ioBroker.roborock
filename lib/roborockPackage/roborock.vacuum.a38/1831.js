...
var module500 = require('./500').strings,
  ...
  N = (function (t) {
    ...
    function N(t) {
      ...
      (n = V.call(this, t)).renderListRow = function (t) {
        var n = t.index,
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    t = this;
                    this.props.navigation.setParams({
                      title: module500.localization_strings_Setting_index_21,
                    ...
                    module416.Log.log(module416.LogTypes.KeyEvent, 'enter setting page, lang: ' + globals.AppLang + ',isRTL:' + globals.isRTL);
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            s = {
              title: module500.setting_robot_setting,
            ...
            l = {
              ...
              visible: module390.default.isCarpetSupported() && !module422.DMM.isGarnet,
              shouldShowBottomLine: false,
            },
            u = {
              title: module500.dust_collection_setting_title,
            ...
            p = {
              title: module500.robot_setting_self_cleaning_title,
              funcId: 'robot_setting_page_self_cleaning',
              onPress: this.openSelfCleaningSettingPage.bind(this),
              visible: module381.RSM.isO3Dock() || 3 == module381.RSM.lastDockType,
              shouldShowBottomLine: false,
            },
            h = {
              ...
              visible:
                ...
                !module393.isMiApp &&
                (module422.DMM.isTanosV || module422.DMM.isTopazSV || module422.DMM.isTanosSV),
            ...
            _ = {
              title: module500.soundpackage_volume_adjust_title,
            ...
            S = {
              title: module500.rubys_main_button_text_goto,
            ...
            w = {
              title: module500.localization_strings_Setting_index_23,
            ...
            C = {
              title: module500.localization_strings_Setting_Guide_index_8,
            ...
            T = {
              title: module500.wifi_debug_mode_title1,
            ...
            I = {
              title: module500.localization_strings_Setting_General_index_3,
            ...
            B = {
              title: module500.setting_page_device_share,
            ...
            V = {
              title: module511.ObaInfoString.Title,
            ...
            z = [
              {
                sectionTitle: module500.setting_section_title_clean_management,
              ...
              c,
              {
                sectionTitle: module500.setting_section_title1,
              ...
              s,
              {
                sectionTitle: module500.setting_section_title2,
              ...
              w,
              {
                sectionTitle: module500.setting_section_title_more_info,
          ...
          if (!module393.isMiApp) for (var A = 0; A < N.length; A++) for (var U = N[A].data, F = 0; F < U.length; F++) U[F].visible || (U.splice(F, 1), (F -= 1));
          return module393.isMiApp ? z : N;
        },
      },
      {
        key: 'render',
        value: function () {
          var t = this,
            ...
            o =
              ...
              React.default.createElement(module385.PureButton, {
                ...
                title: module500.localization_strings_Setting_General_index_4,
                textColor: 'red',
                fontSize: 15,
                onPress: function () {
          ...
          if (module393.isMiApp) {
            ...
            return React.default.createElement(
              ...
              React.default.createElement(module1832.default, {
                ref: function (n) {
                  t.randomCodeView = n;
                },
              })
      ...
      },
      {
        ...
        value: function () {
          if ('cn' == module391.default.getAppLanguage()) {
            var t = {
              modelId: module422.DMM.currentSeries,
              isDark: globals.app.state.theme == module516.Themes.dark,
            };
      ...
      },
      {
        ...
        value: function () {
          this.props.navigation.navigate('NetInfoPage', {
            title: module500.localization_strings_Setting_General_index_5,
          });
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          if (module381.RSM.voiceChat) globals.showToast(module500.voice_chat_title2);
            ...
            else globals.showToast(module500.localization_strings_Setting_RemoteControlPage_54);
          }
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          module393.getDevicePropertyFromMemCache(['ssid', 'localip', 'mac'], function (n) {
            ...
            else alert(module500.localization_strings_Setting_CleanModePage_3);
          });
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          this.props.navigation.navigate('CarpetCleanModeSetting', {
            parent: this,
            title: module500.setting_timezone_title,
          });
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          this.props.navigation.navigate('WiFiDebugPage', {
            title: module500.wifi_debug_mode_title1,
            refrence: module1523.default.WiFiPrivacy(),
          });
        },
      },
      {
