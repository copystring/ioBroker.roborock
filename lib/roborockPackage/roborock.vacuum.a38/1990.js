    ...
    module5.default(E, [
      {
        ...
        value: function () {
          ...
          if (!(null == this || null == (t = this.props) || null == (o = t.navigation) || null == (n = o.state) || null == (s = n.params) || null == (c = s.settingPanel)))
            c.addBackListener();
          module1328.ModeDataInstance.getCustomMopList();
        },
      },
      {
              ...
              for (;;)
                switch ((w.prev = w.next)) {
                  case 0:
                    ...
                    w.prev = 4;
                    w.next = 7;
                    return regeneratorRuntime.default.awrap(module414.default.sortCustomMopModes(module11));
              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  ...
                  case 4:
                    o = [];
                    s = [];
                    c = module1326.getSystemCustomMopModes();
                    module1328.ModeDataInstance.customMopModeListData.forEach(function (n, l) {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (
            !t &&
            module1328.ModeDataInstance.customMopModeListData.filter(function (t) {
              return !t.sys_type;
            }).length >= 5
          )
            return void globals.showToast(module500.mop_mop_list_page_exceed_max_tip);
          var n = t || {},
            s = n.id,
            c = n.name,
            l = undefined === c ? module500.custom_mop_mode_page_default_title : c,
            u = n.sys_type,
            f = undefined !== u && u,
            h = n.show,
            w = undefined === h || h;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (o.dragEnabled) {
            if (t.show) {
              if (1 == n.length) return void globals.showToast(module500.mop_mode_list_min_show_count_toast);
              if (t.id == module381.RSM.mopModeId) return void globals.showToast(module500.mop_mode_list_remove_used_mode_toast);
              x(n, t);
              t.show = false;
              var c = s.concat([t]);
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(L, {
            name: module500.mop_mode_list_page_add_new_mode,
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            this.renderSection(module500.mop_mode_list_section_recent_title),
            ...
            this.renderSection(module500.custom_mode_panel_more_mode_title),
            React.default.createElement(
              module12.View,
              {
                style: O.list,
