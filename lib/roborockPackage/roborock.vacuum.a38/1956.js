...
var module393 = require('./393'),
  ...
  B = module12.ART.Surface,
  D = module12.ART.Shape,
  L = module12.ART.Path,
  R = {
    LOADING: 'loading',
    FAILED: 'failed',
            ...
            for (;;)
              switch ((f.prev = f.next)) {
                ...
                case 5:
                  ...
                  module5 = JSON.parse(JSON.stringify(module4));
                  console.log('uploadObstaclesPhotos - ' + JSON.stringify(module5));
                  f.next = 14;
                  return regeneratorRuntime.default.awrap(module414.default.uploadObstaclesPhotos(module5));

                case 14:
                  globals.showToast(module500.introduction_to_image_uploading6);
                  setTimeout(function () {
                ...
                case 18:
                  f.prev = 18;
                  f.t0 = f.catch(8);
                  globals.showToast(module500.introduction_to_image_uploading7);
                ...
                case 23:
                  globals.showToast(module500.introduction_to_image_uploading8);
    ...
    },
    {
      ...
      value: function () {
        ...
        if (this.state.photoSize && this.state.rectInfo) {
          ...
          _ = _ + O + k;
          T = T + P + E;
          f = React.default.createElement(module12.View, {
            style: {
              position: 'absolute',
              left: S,
              top: w,
        ...
        var module1934 = this.getInnerFailedView(require('./1934'), module500.button_title_retry),
          ...
          F = React.default.createElement(
            ...
            React.default.createElement(
              ...
              f,
              this.state.readPhotoLoadingStatus == R.LOADING && module1434,
              this.state.readPhotoLoadingStatus == R.FAILED && module1934
            )
          ),
          module1935 = React.default.createElement(
            ...
            React.default.createElement(module12.ImageBackground, {
              ...
              source: module422.DMM.obstacleImagesMap.topBigImage[c],
            })
          ),
          module1957 = this.state.isSure ? require('./1957') : o.monitor.confirmPhoto;
        return React.default.createElement(
          module12.View,
          {
            style: [
          ...
          React.default.createElement(
            ...
            React.default.createElement(
              ...
              module390.default.isFwFilterObstacleSupported() && module1508.default.mapObjectPhotoEnabled && u && u.length >= 1 ? F : module1935,
              React.default.createElement(
                module12.Text,
                ...
                module500.introduction_to_image_uploading1 + '\n' + module500.introduction_to_image_uploading2 + '\n' + module500.introduction_to_image_uploading3
              ),
              React.default.createElement(
                module12.View,
                {
                ...
                React.default.createElement(
                  ...
                  module500.introduction_to_image_uploading4
                )
              ),
              React.default.createElement(
                module12.View,
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    React.default.createElement(
                      ...
                      module500.introduction_to_image_uploading5
                    )
                  )
                )
              )
