...
var y = module12.ART.Transform,
  ...
  P = (function (n) {
    ...
    function k(n) {
      ...
      (t = w.call(this, n)).handleFBZPanOnShouldStart = function () {
        return t._enableEditMap();
      };

      t.handleFBZPanStart = function (n, l) {
        if (n == module1332.FbzType.FBZ_TYPE_REGULAR) {
        ...
        } else if (n == module1332.FbzType.FBZ_TYPE_MOPPING) {
          ...
          t._clearMapZonesFocus(t.cleanFbzReferences);
        } else if (n == module1332.FbzType.FBZ_TYPE_CLEANING) {
    ...
    module5.default(k, [
      {
        ...
        value: function (n, t) {
          ...
          if (!n.zonesHasEdited) {
            ...
            this._initFBZones(n.fbzZones, module1332.FbzType.FBZ_TYPE_REGULAR);

            this._initFBZones(n.mopZones, module1332.FbzType.FBZ_TYPE_MOPPING);

            this._initFBZones(n.cleanZones, module1332.FbzType.FBZ_TYPE_CLEANING);
          }

          if (!this.FBZZoneInit && this.props.initFBZone) {
            module1404.setTimeout(function () {
              var n = l.getNewRectIndex(module1332.FbzType.FBZ_TYPE_REGULAR);

              if (n > 0) {
                l.addFBZZones(n, l.props.initFBZone, 0, module1332.FbzType.FBZ_TYPE_REGULAR);
                module1404.setTimeout(function () {
      ...
      },
      {
        key: 'getNewWallIndex',
        value: function () {
          for (var n = this._getVisibleZonesCount(this.wallReferences), t = 1; t <= module1332.MAX_COUNT_WALL_OR_FBZ; t++)
      ...
      },
      {
        ...
        value: function () {
          return this._getVisibleZonesCount(this.wallReferences) >= module1332.MAX_COUNT_WALL_OR_FBZ;
        },
      },
      {
        key: 'getVisibleWalls',
      ...
      },
      {
        key: 'getNewRectIndex',
        value: function (n) {
          for (var t = this._getFbzRefsByType(n), l = this._getVisibleZonesCount(t), s = 1; s <= module1332.MAX_COUNT_WALL_OR_FBZ; s++)
      ...
      },
      {
        ...
        value: function (n) {
          ...
          return !!t && this._getVisibleZonesCount(t) >= module1332.MAX_COUNT_WALL_OR_FBZ;
        },
      },
      {
        key: 'getVisibleFBZZones',
        value: function () {
          for (var n = [], t = 1; t <= module1332.MAX_COUNT_WALL_OR_FBZ; t++) {
            var l, s, o;
      ...
      },
      {
        ...
        value: function () {
          return (
            ...
            3 * module1332.MAX_COUNT_WALL_OR_FBZ
          );
        },
      },
      {
        ...
        value: function () {
          for (var n = 0, t = 1; t <= module1332.MAX_COUNT_WALL_OR_FBZ; t++)
          ...
          for (t = 1; t <= module1332.MAX_COUNT_WALL_OR_FBZ; t++)
            for (var o = 0; o < s.length; o++) {
              var u = s[o];

              if (u[t] && u[t].state.visible) {
                var c = this._checkFBZInChargerOrRobot(u[t]);
      ...
      },
      {
        ...
        value: function (n) {
          if (n && 0 != n.length) {
            for (o = 1; o <= module1332.MAX_COUNT_WALL_OR_FBZ; o++)
              if (o <= n.length) {
                var t,
                  l = n[o - 1];
            ...
            for (var o = 1; o <= module1332.MAX_COUNT_WALL_OR_FBZ; o++) {
              var u;
      ...
      },
      {
        ...
        value: function (n) {
          return n == module1332.FbzType.FBZ_TYPE_REGULAR
            ? this.forbidReferences
            : n == module1332.FbzType.FBZ_TYPE_MOPPING
            ? this.moppingFbzReferences
            : n == module1332.FbzType.FBZ_TYPE_CLEANING
      ...
      },
      {
        ...
        value: function (n, t) {
          if (n[t].state.visible) {
            for (var l = this._getVisibleZonesCount(n), s = 1; s <= module1332.MAX_COUNT_WALL_OR_FBZ; s++)
              n[s] &&
                n[s].state.visible &&
      ...
      },
      {
        ...
        value: function (n) {
          if (this._ifFBZInTarget(n, false)) {
            globals.showToast(module500.map_edit_forbidden_too_close_to_dock);
            return 2;
      ...
      },
      {
        ...
        value: function (n, t) {
          var l,
            ...
            u = t ? module1332.ROBOT_FORBIDDEN_R : module1332.DOCK_FORBIDDEN_R;
          return !(!o || (0 == o.x && 0 == o.y)) && module1402._judgeInlegalFBZ(o.x, o.y, n, u * this.props.transform.xx);
        },
      },
      {
        ...
        value: function (n) {
          if (this._ifWallInTarget(n, false)) {
            globals.showToast(module500.map_edit_virtual_wall_too_close_to_dock);
            return 2;
      ...
      },
      {
        ...
        value: function (n, t) {
          ...
          var c = module1402._convertToPixelEndpoint(n.state.position, this.props.transform);

          return module1402._disBtwPointSegement(o.x, o.y, c.start.x, c.start.y, c.end.x, c.end.y).distance / this.props.transform.xx < u;
        },
      },
      {
        ...
        value: function (n, t, l) {
          var s = this,
            o = this.props.mapMode == module1153.MAP_MODE_MAP_EDIT;
          return Object.keys(t).map(function (u, c) {
            return React.default.createElement(module1393.ForbiddenZone, {
              ...
              transform: l,
              editable: o,
              showArea: s.props.mapMode == module1153.MAP_MODE_MAP_EDIT,
      ...
      },
      {
        ...
        value: function (n) {
          var t = this,
            l = this.props.mapMode == module1153.MAP_MODE_MAP_EDIT;
          return Object.keys(this.wallReferences).map(function (s, o) {
            return React.default.createElement(module1393.InvisibleWall, {
              key: o,
              id: s,
        ...
        value: function () {
          var n = new y({
            ...
            l =
              ...
              (this.props.mapMode == module1153.MAP_MODE_MAP_EDIT || !module381.RSM.isRunning || (module381.RSM.isRunning && module381.RSM.isCleanFBZEnabled));
          return React.default.createElement(
            ...
            this.getForbiddenZone(module1332.FbzType.FBZ_TYPE_REGULAR, this.forbidReferences, n),
            l && this.getForbiddenZone(module1332.FbzType.FBZ_TYPE_CLEANING, this.cleanFbzReferences, n),
            t && this.getForbiddenZone(module1332.FbzType.FBZ_TYPE_MOPPING, this.moppingFbzReferences, n)
          );
        },
      },
    ]);
