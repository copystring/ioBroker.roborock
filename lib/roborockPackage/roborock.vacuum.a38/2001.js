    ...
    module5.default(B, [
      ...
      },
      {
        ...
        value: function () {
          ...
          this.props.navigation.setParams({
            title: module500.egg_page_title,
          ...
          var u = module381.RSM.cleanResumeFlag != module381.CleanResumeFlag.None || module381.RSM.backDockResumeFlag != module381.BackDockResumeFlag.None,
            c = module500.defender_mode_introduction,
            l = module500.start_egg_attack_with_other_task_tip,
            p = '' + c + (u ? l : '');
          if (module381.RSM.state != module381.RobotState.EGG_ATTACK)
            null == (t = globals) ||
              ...
              n.customAlert(
                ...
                {
                  confirmTitle: module500.egg_attack_start_title,
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module381.RSM.state == module381.RobotState.EGG_ATTACK) module1329.MM.enterEasterEggModel();
          else module1329.MM.quitEasterEggModel();
        },
      },
      {
        key: 'keepEggMode',
              ...
              function (n) {
                for (;;)
                  switch ((n.prev = n.next)) {
                    case 0:
                      n.next = 2;
                      return regeneratorRuntime.default.awrap(module414.default.eggKeep());
            ...
            function (n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  ...
                  case 11:
                    n.next = 13;
                    return regeneratorRuntime.default.awrap(module414.default.startEggAttack());
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module2002.default, {
              ref: function (n) {
                return (t.menu = n);
              },
            ...
            React.default.createElement(module1330.MapView, {
              ...
              left: 10,
              right: 10,
              mapMode: module1153.MAP_MODE_EASTER_EGG,
            })
          );
        },
      },
          ...
          return regeneratorRuntime.default.async(
            function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    if ((module1329.MM.quitEasterEggModel(), (t.t0 = module381.RSM.state == module381.RobotState.EGG_ATTACK), !t.t0)) {
                      t.next = 5;
                      break;
                    }
