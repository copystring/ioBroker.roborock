...
function V(t) {
  var o = React.useContext(module515.AppConfigContext).theme,
    n = t.title,
    s = t.options,
    l = t.selectedIndex,
    u = t.enabled,
...
var I = (function (t) {
  ...
  function T(t) {
    ...
    (h = S.call(this, t)).state = {
      ...
      washCount: 1,
      moveSpeed: 30,
      modeName: module500.localization_strings_Setting_General_index_0,
  ...
  module5.default(T, [
              ...
              for (;;)
                switch ((y.prev = y.next)) {
                  case 0:
                    y.prev = 0;
                    y.next = 3;
                    return regeneratorRuntime.default.awrap(module414.default.getCustomMopModeDetail(o));
    ...
    },
    {
      ...
      value: function () {
        var t = this,
          module1505 = React.default.createElement(module385.PureImageButton, {
            ...
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  ...
                  globals.showToast(module500.save_mop_mode_now_used_tip);
                ...
                case 3:
                  ...
                  n.next = 7;
                  return regeneratorRuntime.default.awrap(module414.default.delCustomMopMode(this.id));
            ...
            for (;;)
              switch ((M.prev = M.next)) {
                ...
                case 3:
                  ...
                  M.next = 11;
                  return regeneratorRuntime.default.awrap(module414.default.addCustomMopMode(y));
                ...
                case 14:
                  M.next = 16;
                  return regeneratorRuntime.default.awrap(module414.default.updateCustomMopMode(y));
    ...
    },
    {
      ...
      value: function () {
        var t = [
            {
              name: module500.mop_mode_custom_wet_mode_wetest_name,
              desc: module500.mop_mode_custom_wet_mode_wetest_desc,
            },
            {
              name: module500.mop_mode_custom_wet_mode_wet_name,
              desc: module500.mop_mode_custom_wet_mode_wet_desc,
            },
            {
              name: module500.dust_collection_title_3,
              desc: module500.mop_mode_custom_wet_mode_normal_desc,
            },
            {
              name: module500.mop_mode_custom_wet_mode_dry_name,
              desc: module500.mop_mode_custom_wet_mode_dry_desc,
            },
            {
              name: module500.mop_mode_custom_wet_mode_dryest_name,
              desc: module500.mop_mode_custom_wet_mode_dryest_desc,
            },
          ],
      ...
      value: function () {
        ...
        return React.default.createElement(
          ...
          React.default.createElement(
            ...
            !this.sys_type &&
              React.default.createElement(module385.SettingListItemView, {
                title: module500.mop_mode_setting_page_mode_name,
          ...
          React.default.createElement(module385.InputDialog, {
            ...
            maxLength: 10,
            title: module500.mop_mode_setting_page_mode_name,
            inputPlaceholder: module500.mop_mode_setting_page_input_mode_name,
    ...
    },
    {
      ...
      get: function () {
        ...
        return [
          {
            title: module500.mop_mode_custom_page_mop_setting_title,
            section: true,
          },
          {
            title: module500.mop_mode_custom_page_wet_title,
            minValue: 15,
            maxValue: 150,
            step: 5,
          ...
          {
            title: module500.mop_mode_setting_page_roller_clean,
            section: true,
          },
          {
            ...
            desc: module500.mop_mode_setting_wash_interval_desc,
            onSlidingComplete: function (t) {},
            onSlidingMove: function (o) {
              t.setState({
                washInterval: 60 * o,
          ...
          {
            title: module500.mop_cleaning_time,
            minValue: 30,
            maxValue: 60,
            step: 10,
            value: this.state.washTime,
            showValue: this.state.washTime + 's',
            desc: module500.mop_mode_setting_page_wash_time_desc,
            onSlidingMove: function (o) {
              t.setState({
                washTime: o,
              });
