var module381 = require('./381'),
  ...
  _ = module500.getInterfaceLanguage(),
  c = null,
  h = module422.DMM.bucket,
  module1524 = require('./1524').HtmlMap;

function M() {
  return module1153.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].host;
}
...
c =
  module422.DMM.isTanosS || module422.DMM.isTanosSL || module422.DMM.isTanosSC || module422.DMM.isTanosSE
    ? module1524.TanosS
    : module422.DMM.isTanosSPlus || module422.DMM.isTanosSMax
    ? module1524.TanosSPlus
    : module422.DMM.isTanosV
    ? module1524.TanosV
    : module422.DMM.isRubysLite
    ? module1524.RubysLite
    : module422.DMM.isTopazS
    ? module1524.TopazS
    : module422.DMM.isTopazSV
    ? module1524.TopazSV
    : module422.DMM.isTanos || module422.DMM.isRubyPlus || module422.DMM.isRubySC || module422.DMM.isRubysE
    ? module1524.Tanos
    : module1524.Default;
...
var T = (HtmlResManager = {
  ...
  GuideTitle1: function () {
    return module390.default.isUseOldTitleInGuide() ? module500.localization_strings_Setting_Guide_index_0 : module500.tanosv_title_guide_1;
  },
  GuideTitle2: function () {
    return module390.default.isUseOldTitleInGuide() ? module500.localization_strings_Setting_Guide_index_1 : module500.tanosv_title_guide_2;
  },
  GuideTitle2_2: function () {
    return module500.localization_strings_Main_IntroducePage_1;
  },
  GuideTitle3: function () {
    return module390.default.isUseOldTitleInGuide() ? module500.localization_strings_Setting_Guide_index_2 : module500.map_edit_map_lab_save_map_kindly_remind;
  },
  GuideTitle4: function () {
    return module390.default.isUseOldTitleInGuide() ? module500.localization_strings_Setting_Guide_index_3 : module500.tanosv_title_guide_4;
  },
  GuideTitle5: function () {
    return module390.default.isUseOldTitleInGuide() ? module500.localization_strings_Setting_Guide_index_0 : module500.tanosv_title_guide_5;
  },
  GuideTitle6: function () {
    return module390.default.isUseOldTitleInGuide() ? module500.localization_strings_Setting_Guide_index_5 : module500.tanosv_title_guide_6;
  },
  GuideTitle7: function () {
    return module500.localization_strings_Setting_Guide_index_6;
  },
});
exports.default = T;
