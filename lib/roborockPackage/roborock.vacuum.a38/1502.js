exports.CustomMopModeView = function (t) {
  var o = React.useContext(module515.AppConfigContext).theme.ModeSettingPanel,
    n = t.items,
    b = undefined === n ? [] : n,
    x = t.currentMopId,
          ...
          for (;;)
            switch ((n.prev = n.next)) {
              case 0:
                ...
                n.next = 5;
                return regeneratorRuntime.default.awrap(module414.default.setCustomMopById(t.id));
  ...
  return React.default.createElement(
    ...
    React.default.createElement(
      ...
      React.default.createElement(
        ...
        module500.custom_mode_panel_mop_gear_title
      )
    ),
    React.default.createElement(
      module12.View,
