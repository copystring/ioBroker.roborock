            ...
            contentComponent: React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(P, {
                  ...
                  mapBgColor: this.context.theme.guideImages.mapUnitBgColor,
                  name: module500.choose_map_hint_old_map,
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  module500.unsave_map_alert_content
                )
              )
            ),
            buttonInfo: [module500.choose_map_option_ignore, module500.choose_map_option_recover],
...
exports.default = z;
z.contextType = module515.AppConfigContext;
        ...
        return React.default.createElement(module1802.default, {
          ...
          contentComponent: React.default.createElement(
            ...
            React.default.createElement(
              ...
              module500.recover_map_alert_title
            ),
            this.bakTime > 0 &&
              React.default.createElement(
                module12.Text,
                ...
                module500.recover_map_backup_time + ' ' + module1511.formatWithMillis(1e3 * this.bakTime, 'YYYY/MM/DD HH:mm')
              ),
            React.default.createElement(P, {
          ...
          buttonInfo: [module500.localization_strings_Main_MainPage_11, module500.choose_map_option_recover],
          buttonFuncId: ['choose_map_reset', 'choose_map_recover'],
          onPressLeftButton: this.props.onPressLeft,
          onPressGoSetting: function () {
            t.props.onPressRight();
    ...
    module5.default(p, [
        ...
        value: function () {
          ...
          if (!this.props.isBackupData && this.props.isCurrentMap)
            this.setState(
              ...
              function () {
                var n;
                if (!(null == (n = t.mapView))) n.setState(module1329.MM.mapData);
              }
            );
      ...
      },
      {
        ...
        value: function () {
          ...
          (module390.default.isMultiFloorSupported() ? new module1797.MultiMapDataProvider() : new module1797.SingleMapDataProvider())
            .getMapData(this.props.mapID, this.props.isBackupData)
            .then(function (n) {
              console.log('LoadMap: Success');
              var o = base64js.toByteArray(n),
                l = module1487(o, false);
                ...
                o.state.loadingStatus == B.Loading
                  ...
                  ? React.default.createElement(
                      ...
                      React.default.createElement(
                        ...
                        module500.reset_map_getlist_fail
                      )
                    )
