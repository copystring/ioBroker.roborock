  ...
  R = (function (t) {
    ...
    module5.default(P, [
      ...
      },
      {
        ...
        value: function () {
          module1157.default.shared().popGestureEnabled = true;
        },
      },
      {
        key: 'render',
        value: function () {
          ...
          var P = this.context.theme.alert,
            ...
            I = React.default.createElement(module1034.NavigationConsumer, null, function (n) {
      ...
      },
      {
        ...
        value: function (t, n, o, l, s) {
          var u = s.confirmTitle,
            ...
            w = undefined === p || p,
            x = {
              text: u || module500.localization_strings_Main_Error_ErrorDetailPage_3,
              onPress: o,
              color: f,
            },
            A = {
              text: c || module500.localization_strings_Main_MainPage_11,
              onPress: l,
            },
            P = w ? [A, x] : [x];
          this.setState({
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module1157.default.shared().popGestureEnabled = this.props.hidePopGestureEnabled;
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module1157.default.shared().popGestureEnabled = this.props.showPopGestureEnabled;
          this.needShow = true;
          if (this.props.noAnimated)
            this.setState({
              visible: true,
