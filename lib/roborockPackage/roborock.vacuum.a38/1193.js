...
var R = (function (t, ...args) {
  ...
  function x() {
    ...
    (t = y.call(this, ...args)).setNativeProps = function (n) {
      var f = !n.matrix && module1172.default(n);
      if (f) n.matrix = f;
      module22.default(n, module1176.pickNotNil(module1190.default(n, true)));
  ...
  module5.default(x, [
    {
      ...
      value: function () {
        var t = this.props,
          ...
          R = u && u.match(module1176.idPattern),
          E = R && R[1];

        if (E) {
          var _ = module1165.default(
            k(
              k({}, module1165.propsAndStyles(D)),
              {},
              {
                x: null,
                y: null,
