...
var regeneratorRuntime = require('regenerator-runtime'),
  ...
  k = module422.DMM.soundPackageFilePath,
  P = null,
  module1890 = (function () {
    function t() {
    ...
    module5.default(t, null, [
      ...
      },
      {
        key: 'wavFileName',
        value: function (t, n) {
          return module422.DMM.bucket + '_pre_' + t + '_' + n + '.wav';
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t, s, o, module414, module422, P, module1890, w, x, b, M, D, N, F;
          return regeneratorRuntime.default.async(
            function (O) {
              for (;;)
                switch ((O.prev = O.next)) {
                  case 0:
                    if (
                      ((O.prev = 0),
                      (t = module1153.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].host),
                      (s = module1153.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].cdnHost),
                  ...
                  case 7:
                    module414 = 'https://' + t + k;
                    console.log('soundpackage info url : ' + module414 + 'info?time=' + new Date().getTime());
                    O.next = 11;
                    return regeneratorRuntime.default.awrap(module391.default.asyncDownloadFile(module414 + 'info?time=' + new Date().getTime(), 'infoTemp'));

                  case 11:
                    module422 = O.sent;
                    console.log('SoundPackageManager : ' + JSON.stringify(module422));
                    O.next = 15;
                    return regeneratorRuntime.default.awrap(module391.default.asyncReadFile(module422.filename));
                  ...
                  case 18:
                    module1890 = (module381.RobotStatusManager.sharedManager().deviceLocation || 'cn').replace('cn', 'prc');
                    w = (w = o.voice_list.filter(function (t) {
                      return -1 != t.applicable.indexOf(module1890);
                    })).sort(function (t, n) {
                  ...
                  case 27:
                    ...
                    O.prev = 33;
                    O.next = 36;
                    return regeneratorRuntime.default.awrap(module418.SetStorageKey(module418.StorageKeys.SoundPackageLsitData, JSON.stringify(w)));

                  case 36:
                    O.next = 38;
                    return regeneratorRuntime.default.awrap(module418.SetStorageKey(module418.StorageKeys.SpecialSoundPackageLsitData, JSON.stringify(x)));
      ...
      },
      {
        ...
        value: function () {
          var t, module4, module5, module391, module414, module422, module394, module390;
          return regeneratorRuntime.default.async(
            function (y) {
              for (;;)
                switch ((y.prev = y.next)) {
                  case 0:
                    y.prev = 0;
                    t = module1153.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].cdnHost;
                    y.next = 4;
                    return regeneratorRuntime.default.awrap(module418.GetStorageKey(module418.StorageKeys.SoundPackageLsitData));

                  case 4:
                    module4 = y.sent;
                    y.next = 7;
                    return regeneratorRuntime.default.awrap(module418.GetStorageKey(module418.StorageKeys.SpecialSoundPackageLsitData));

                  case 7:
                    module5 = y.sent;
                    module391 = JSON.parse(module4);
                    module414 = [];
                    if (module5) module414 = JSON.parse(module5);
                    this.downloadPreviewWavFiles(module391, t);
                    this.downloadPreviewWavFiles(module414, t);
                    y.next = 15;
                    return regeneratorRuntime.default.awrap(this.filterSpecialVoicesByServer(module414));
