...
exports.timerRepeatToCronRepeat = function (t) {
  if (t == y.Once) return module1512.CodeOnce;
  if (t == y.Everyday) return module1512.CodeEveryday;
  if (t == y.Weekdays) return module1512.CodeWeekdays;
  if (t == y.Weekends) return module1512.CodeWeekends;
  t = module1512.ConvertArrayToRepeatNum(t.split(''));
  return t;
};
...
exports.isTimerExpired = function (t, n, s) {
  var u = (s ? S[t] : h(t)) || t,
    _ = module1510.default(n, 'YYYYMMDD HH:mm:ss');

  return u == y.Once && _.isBefore();
};

exports.isTimerExpiredByRepeatMode = function (t, n) {
  var s = module1510.default(n, 'YYYYMMDD HH:mm:ss');
      ...
      for (;;)
        switch ((l.prev = l.next)) {
          case 0:
            l.prev = 0;
            l.next = 3;
            return regeneratorRuntime.default.awrap(module414.default.deleteServerTimer(o));

          case 3:
            module500 = l.sent;
            console.log('RobotApi.deleteServerTimer -' + o + ' - ' + JSON.stringify(module500));
            l.next = 7;
...
var regeneratorRuntime = require('regenerator-runtime'),
  ...
  T = function () {
    return [
      module500.localization_strings_Setting_Timer_Common_5,
      module500.localization_strings_Setting_Timer_Common_6,
      module500.localization_strings_Setting_Timer_Common_7,
      module500.localization_strings_Setting_Timer_Common_8,
      module500.localization_strings_Setting_Timer_Common_9,
      module500.localization_strings_Setting_Timer_Common_10,
      module500.localization_strings_Setting_Timer_Common_11,
    ];
  };
...
exports.RepeatMenuItems = function () {
  return [
    module500.localization_strings_Setting_Timer_Common_0,
    module500.localization_strings_Setting_Timer_Common_1,
    module500.localization_strings_Setting_Timer_Common_2,
    module500.localization_strings_Setting_Timer_Common_3,
    module500.localization_strings_Setting_Timer_Common_4,
  ];
};
...
function h(t) {
  switch (t) {
    case module1512.CodeOnce:
      return y.Once;

    case module1512.CodeEveryday:
      return y.Everyday;

    case module1512.CodeWeekdays:
      return y.Weekdays;

    case module1512.CodeWeekends:
      return y.Weekends;
...
function R(t, n) {
  var o = (n ? S[t] : h(t)) || t;
  if (!(t != o || n)) o = module1512.ConvertCustomRepeat(t).join('');
  return o;
}

function k(t, n) {
  if (t == y.Once) {
    module1510.default(n, 'YYYYMMDD');
    return module500.localization_strings_Setting_Timer_Common_0;
  }

  if (t == y.Everyday) return module500.localization_strings_Setting_Timer_Common_1;
  if (t == y.Weekends) return module500.localization_strings_Setting_Timer_Common_3;
  if (t == y.Weekdays) return module500.localization_strings_Setting_Timer_Common_2;
  var s = [];
  t.split('').forEach(function (t, n) {
    if (1 == t) s.push(T()[n]);
  });
...
function W(t, n, o, s, u) {
  var _ = new Date(module1511.GenerateTimestamp(t, n, o, s)),
    c = _.getTime(),
...
function D(t, n, o, s, u) {
  return O(new Date(module1511.GenerateTimestamp(t, n, o, s)).getTime(), u);
}
