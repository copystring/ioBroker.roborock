  ...
  F = (function (t) {
    ...
    function N(t) {
          ...
          function (n) {
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  if ((p = null == (t = module1231.MM.mapData) ? undefined : null == (u = t.map) ? undefined : u.colorData) && 'object' == typeof p) {
                    n.next = 3;
                    break;
                  }
                ...
                case 3:
                  f = null == (c = module1231.MM.mapData) ? undefined : null == (l = c.floorMap) ? undefined : l.data;
                  h = true;
      ...
      o.onPressCancelButtonForCustom = function () {
        ...
        o.cleanWaterModeMaps = module1231.MM.customCleanModes;
      ...
      o.cleanWaterModeMaps = module1231.MM.customCleanModes;
      o.originalCleanWaterModeMaps = module1231.MM.customCleanModes;
      return o;
    }
    ...
    module5.default(N, [
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = module1344.default.guideButton(this.onNavigationGuidePress, function (n) {
              t.guideButton = n;
            }),
            o = module1344.default.confirmButton(this.onNavigationSavePress, false, function (n) {
              t.mapSaveButton = n;
            }),
            s = module386.default.isSupportFloorEdit() ? [n] : [o];
          module1344.default.setNavigation(this, globals.isRTL ? s.reverse() : s, this.onNavigationBackPress.bind(this));
        },
      },
      {
        key: 'initMapView',
        value: function () {
          var t, n;
          if (!(null == (t = this.mapView))) t.setState(K({}, module1231.MM.mapData));
          if (!(null == (n = this.mapView))) n.setAllCleanMopMode(module1231.MM.customCleanModes);
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          this.cleanModeListener = module12.DeviceEventEmitter.addListener(module411.NotificationKeys.DidReceiveSpecialEvent, function (t) {
            if (t.data == module411.EventKeys.SegmentCustomModeDidReceive && n) n.setAllCleanMopMode(module1231.MM.customCleanModes);
          });
            ...
            function (o) {
              for (;;)
                switch ((o.prev = o.next)) {
                  ...
                  case 2:
                    t = module1231.MM.customCleanModes;
                    module383.LogEventStatus('custom_mode_info', {
                      mode: module1231.MM.customCleanModes,
                    });
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module1344.default.isEditedByArrays(this.originalCleanWaterModeMaps, this.cleanWaterModeMaps)) {
            var n = {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            s = React.default.createElement(module1326.default, {
              type: module1326.MenuType.Menu_Mode,
              ref: function (n) {
                return (t.editMenu = n);
              },
              onPressGuideButton: this.onNavigationGuidePress,
            }),
            u = React.default.createElement(module1326.default, {
              type: module1326.MenuType.Menu_Mode_Smart,
              ref: function (n) {
                return (t.editMenu = n);
              },
              hasConfirmMenu: true,
          ...
          var f = this.state.isResetCustomModeEnable,
            v = module1344.default.resetButton(module491.reset_clean_mode_button_title, f, this.onResetButtonPressed);
