...
exports._checkTrans = function (o, x, y, s, u, c, f, l) {
  ...
  var v = module1235.Config.scale.min,
    p = module1235.Config.scale.max;
  if ('android' === module12.Platform.OS && y && y.height && y.width && (y.width > 300 || y.height > 300)) p = module1235.Config.scale.maxAndroid;
