  ...
  module1361 = (function (t) {
    ...
    module5.default(L, [
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module1063.default.shared().enableBackAndMore();
          module1354.ModeDataInstance.removeChangeListener(function () {
            t.forceUpdate();
          });
        },
      },
      {
        ...
        value: function () {
          var t = this;
          module1354.ModeDataInstance.addChangeListener(function () {
            t.forceUpdate();
          });
        },
      },
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            n = module1231.MM.customCleanModes.length > 0,
            l = this.props,
            u = l.isInHomePage,
            c = l.isTimerPage,
            p = l.parent,
            h = (u && (null == p ? undefined : p.tabIndex) == module1347.TabZone) || this.props.isTabZone,
            f = null;
          f = c
          ...
          var w = React.default.createElement(
              ...
              !c &&
                React.default.createElement(module1286.ModeBubble, {
                  cleanMode: 102,
                  waterMode: 202,
                  iconWidth: 24,
                  iconHeight: 24,
            ...
            _ = React.default.createElement(module1233.MapView, {
              top: 50,
              righ: 0,
              left: 0,
              bottom: 0,
              ...
              hideAccessory: true,
              inBlockMode: true,
              blockBubbleShowInfo: module1233.BlockBubbleShowInfo.CLEANMODE,
      ...
      },
      {
        ...
        value: function () {
          ...
          else if (module1231.MM.customCleanModes.length > 0) s.enableSubTitleColor;
          ...
          var t,
            ...
            R = module1230.CleanModes().slice(B, module1230.CleanModes().length),
            V = module386.default.isElectronicWaterBoxSupported() || module386.default.isShakeMopStrengthSupported(),
            W =
              -1 !=
              module1231.MM.customCleanModes.findIndex(function (t) {
                ...
                React.default.createElement(
                  ...
                  V &&
                    ...
                    React.default.createElement(module380.default, {
                      ...
                      items: module1230.MopWaterOrStrengths(),
                      enabled: G,
                      isInHomePage: p,
                      addonTip:
                  ...
                  module386.default.isCustomWaterBoxDistanceSupported() &&
                    ...
                    p &&
                    React.default.createElement(module1358.SliderAdjuster, {
                      title: null,
                      style: {
                        backgroundColor: 'transparent',
                      },
                  ...
                  module386.default.isShakeMopSetSupported() &&
                    !module415.DMM.isGarnet &&
                    React.default.createElement(module1229.default, {
                      ref: function (t) {
                        n.mopModeSetView = t;
                      },
                      style: {
                  ...
                  module415.DMM.isGarnet &&
                    React.default.createElement(module1356.CustomMopModeView, {
                      currentMopId: this.mopModeId,
                      items: module1354.ModeDataInstance.modePannelCustomMops,
                      onPressMore: u,
                      shouldCallRpc: p,
            ...
            N = module415.DMM.isGarnet && p && ((null == y ? undefined : y.tabIndex) == module1347.TabZone || (null == y ? undefined : y.tabIndex) == module1347.TabSegment),
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(module1355.SwipeDownIndicator, {
                  style: {
                    marginBottom: 10,
                  },
                }),
                T &&
                  React.default.createElement(module1357.default, {
                    tabs: q,
            ...
            function (R) {
              for (;;)
                switch ((R.prev = R.next)) {
                  case 0:
                    if (
                      (module1063.default.shared().disableBackAndMore(),
                      module386.default.isCustomWaterBoxDistanceSupported() &&
                  ...
                  case 10:
                    if (
                      ...
                      module415.DMM.isGarnet &&
                        ((this.mopModeId = s || (p ? module377.RSM.mopModeId : null == (b = module1354.ModeDataInstance.modePannelCustomMops[0]) ? undefined : b.id)),
                        (this.mopModeConfig = module1354.ModeDataInstance.getCustomMopModeConfigById(this.mopModeId))),
                      (x = module1230.isModeCustomized(M, f, w) && !h && !c),
                    ...
                    if (M == module1230.CustomCleanMode) M = module1230.CleanModes()[2].strength;
                    if (f == module1230.CustomWaterMode) f = module1230.MopWaterOrStrengths()[2].strength;
                    if (w == module1230.CustomMopMode) w = module1230.MopMethods()[0].strength;
                  ...
                  case 27:
                    this.setState(
                      ...
                      function () {
                        if (B.cleanModeSetView) B.cleanModeSetView.setMode(M, module1230.CustomCleanMode);
                        if (B.waterModeSetView) B.waterModeSetView.setMode(f, module1230.CustomWaterMode);
      ...
      },
      {
        ...
        value: function () {
          if (this.mapView) this.mapView.setState(N({}, module1231.MM.mapData));
          if (this.mapView) this.mapView.setAllCleanMopMode(module1231.MM.customCleanModes);
        },
      },
      {
        key: 'setCleanWaterMode',
        value: function (t, o, n) {
          if (this.cleanModeSetView) this.cleanModeSetView.setMode(t, module1230.CustomCleanMode);
          if (this.waterModeSetView) this.waterModeSetView.setMode(o, module1230.CustomWaterMode);
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    c = u ? module1230.CustomCleanMode : null == this ? undefined : null == (t = this.cleanModeSetView) ? undefined : t.value;
                    p = u ? module1230.CustomWaterMode : null == this ? undefined : null == (n = this.waterModeSetView) ? undefined : n.value;
                    h = u ? module1230.CustomMopMode : null == this ? undefined : null == (s = this.mopModeSetView) ? undefined : s.value;
              ...
              for (;;)
                switch ((M.prev = M.next)) {
                  ...
                  case 35:
                    ...
                    console.log('setCustomMode  error: ' + ('object' == typeof M.t0 ? JSON.stringify(M.t0) : M.t0));
                    this.showToast(module491.robot_communication_exception);
                    if (this.waterModeSetView) this.waterModeSetView.setMode(t, module1230.CustomWaterMode);
              ...
              for (;;)
                switch ((K.prev = K.next)) {
                  case 0:
                    ...
                    K.t0 = module1230.CustomCleanMode;
                    K.next = 16;
                    break;
                  ...
                  case 16:
                    ...
                    K.t4 = module1230.CustomWaterMode;
                    K.next = 29;
                    break;
                  ...
                  case 42:
                    if (
                      ...
                      module415.DMM.isGarnet &&
                        (c
                          ? ((this.mopModeId = this.lastMopId || (null == (b = module1354.ModeDataInstance.modePannelCustomMops[0]) ? undefined : b.id)),
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module377.RSM.isRunning)
            module1261.showFinishCurrentTastAlertIfNeeded().catch(function (o) {
      ...
      },
      {
        ...
        value: function (t, o, n) {
          return !(module1230.isModeCustomized(t, o, n) && !this.props.isSmartScene);
        },
      },
    ]);
    return L;
...
exports.default = module1361;
module1361.contextType = module506.AppConfigContext;
module1361.defaultProps = {
