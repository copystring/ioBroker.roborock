...
var PropTypes = require('prop-types'),
  ...
  module1269 = require('./1269').isRRSurface,
...
var z = 32,
  ...
  $ = (function (t) {
    ...
    function H(t) {
      ...
      (o = x.call(this, t)).top = o.props.hasOwnProperty('top') ? o.props.top : module936.StatusBarHeight + module936.AppBarHeight;
      ...
      o.state = {
        charger: t.charger,
        map: t.map || {
          left: module1235.Config.center.x - module1235.EMPTY_MAP_WIDTH / 2,
          top: module1235.Config.center.y - module1235.EMPTY_MAP_HEIGHT / 2,
        ...
        robotStatus: 'Unknown',
        manual: false,
        mapMode: t.mapMode || module936.MAP_MODE_REGULAR,
        showGotoTips: true,
        labEnabled: false,
        ...
        blockBubbleShowInfo: t.blockBubbleShowInfo || module1235.BlockBubbleShowInfo.DISPLAYNAME,
        roomModeList: [],
    ...
    module5.default(H, [
      {
        ...
        value: function () {
          ...
          this.roomNameListener = this.specialEventListener = module12.DeviceEventEmitter.addListener(module411.NotificationKeys.DidReceiveSpecialEvent, function (o) {
            if (o.data == module411.EventKeys.RoomNameMappingDidReceive && t.props.editAction != module1326.EditAction.Name) t.getAllRoomNameList();
          });
          this.panResponder = module12.PanResponder.create({
            ...
            onPanResponderStart: function (o, s) {
              ...
              t.touch.move = module1247._parseEvent(o.nativeEvent) || {};
              t.touch.page =
                {
            ...
            onPanResponderEnd: function (o, s) {
              if (
                ...
                1 != q &&
                  ...
                  (t.touch.end = module1247._parseEvent(o.nativeEvent)),
                  t.touch.start.timestamp && t.touch.end && t.touch.end.timestamp))
              )
                if (!(t.touch.end.timestamp - t.touch.start.timestamp + t.touch.interval > module1235.Config.click) && t.touch.interval > 0) {
                  if (t.touch.interval > 0 && t.state.mapMode != module936.MAP_MODE_MAP_EDIT && t.state.mapMode != module936.MAP_MODE_CARPET_EDIT) {
                    var n =
                      (t.map &&
                        t.map.state.width &&
                        t.map.state.height && {
                    ...
                    if (t.map)
                      t.map.setState({
                        transform: module1247._center(t.transform, t.size, n, t.left, t.top, t.right, t.bottom, t.state.mapDeg),
                      });
                  }
                } else if (
            ...
            onPanResponderMove: function (o, s) {
              if ((t._handleLongPressCancel(), 1 != q))
                if (
                  ...
                  var n = [module1247._parseEvent(o.nativeEvent), t.touch.move],
                    l = n[0],
                    h = n[1];
                  ...
                  if (
                    ...
                    if (module1247._checkTrans(c, t.size, f, t.left, t.top, t.right, t.bottom, t.props.noScale)) {
        ...
        value: function (t, o) {
          ...
          if (o.map === this.state.map && o.path === this.state.path) {
            var c =
              ...
              {};
            if (!o.manual) module1247._center(u, this.size, c, this.left, this.top, this.right, this.bottom, o.mapDeg);
          ...
          if (f) {
            ...
            if (!o.manual) module1247._center(u, this.size, M, this.left, this.top, this.right, this.bottom, o.mapDeg);

            var _ = {
                x: f.left || 0,
                y: f.top + f.height || 0,
              },
              y = module1247._offset(module1235.Config.center.x, module1235.Config.center.y, _),
              k = 0,
              S = (o.path && o.path.points && o.path.points.length) || 0;

            if (S > 2) {
              var B = o.path.points || [];
              y = module1247._offset(B[S - 1].x, B[S - 1].y, _);
            }

            if (o.robot) {
              y = module1247._offset(o.robot.x, o.robot.y, _);
              k = o.robot.angle;
            }
            ...
            var C =
                (o.charger &&
                  ...
                  module21.default(module1247._offset(o.charger.x, o.charger.y, _), {
            ...
            if (o.mapMode == module936.MAP_MODE_REGULAR && o.zones && (w = module1247._parseDisplayRects(o.zones, _)).displayZones.length > 0 && 4 == o.inCleanBlockMode)
            ...
            if (o.path) {
              ...
              R = 'android' != module12.Platform.OS || module1269 ? module1247._parsePath(o.path.points, _, A, false) : module1247._parsePathWithTransform(o.path.points, _, u);
            }
            ...
            if (P)
              x =
                'android' != module12.Platform.OS || module1269
                  ? module1247._parseMopPath(o.path.points, _, o.mopPath.data)
                  : module1247._parseMopPathWithTransform(o.path.points, _, u, o.mopPath.data);
            var F = {
              backWashPath: '',
            };
            if (P)
              F =
                'android' != module12.Platform.OS || module1269
                  ? module1247._parseBackWashPath(o.path.points, _, o.mopPath.data)
                  : module1247._parseBackWashPathWithTransform(o.path.points, _, u, o.mopPath.data);
            var D = {
              pathType: module1235.MoppingType.MOPPING_TYPE_BOTH_BOTH,
            };
            if (o.pathType)
              D = {
            ...
            if (this.state.mapMode == module936.MAP_MODE_GOTO_EDIT && o.pathGotoPlan) {
              var G =
                'android' != module12.Platform.OS || module1269
                  ? module1247._parseGotoPlanPath(o.pathGotoPlan.points, _, new L())
                  : module1247._parseGotoPlanPath(o.pathGotoPlan.points, _, u);
            ...
            if (o.path)
              for (var W = 0; W < o.path.points.length; W++) {
                var Y = module1247._offset(o.path.points[W].x, o.path.points[W].y, _);
            ...
            if (this.state.mapMode == module936.MAP_MODE_GOTO_EDIT && o.target) q = module1247._parseTarget(o.target, _);
              ...
              for (
                var ot = function (t) {
                    ...
                    if (module386.default.isFwFilterObstacleSupported()) {
                      var n = module1247._offset(s[0] / 50, s[1] / 50, _);
                    ...
                    var u = module1247._offset(s[0] / 50, s[1] / 50, _);
                ...
                O(
                  ...
                  {},
                  {
                    ...
                    pathData: {
                      ...
                      planPoints: this.state.mapMode == module936.MAP_MODE_GOTO_EDIT && (null == o ? undefined : null == (l = o.pathGotoPlan) ? undefined : l.points),
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              module21.default({}, module387.default.getAccessibilityLabel('map_root'), this.panResponder.panHandlers, {
                ...
                onLayout: function (o) {
                  ...
                  if (t.state.map && t.state.map.height && t.state.map.width) {
                    module1247._center(t.transform, t.size, t.state.map, t.left, t.top, t.right, t.bottom, t.state.mapDeg);
              ...
              React.default.createElement(module1327.default, {
                transform: this.transform,
                ref: function (o) {
                  return (t.map = o);
                },
                color: module1270.map,
                ...
                blockCanEdit: s,
                roomBubbleMode: l,
                showSplitLine: this.props.editAction == module1326.EditAction.Split,
        ...
        value: function (t) {
          if (t.syncMapDeg) {
            var o = undefined !== t.mapID ? t.mapID : module377.RSM.currentMapId,
              s = module1231.MM.mapRotateAngle[o];
            return s || 0;
          }
      ...
      },
      {
        key: 'roomBubbleMode',
        value: function () {
          var t = this.state.blockBubbleShowInfo & module1235.BlockBubbleShowInfo.DISPLAYNAME,
            o = this.state.blockBubbleShowInfo & module1235.BlockBubbleShowInfo.CLEANMODE,
            s = this.state.blockBubbleShowInfo & module1235.BlockBubbleShowInfo.CLEANSEQUENCE;
          if (this.props.showAllBubbleInfo)
            return t && o
              ? module1241.RoomInfoBubbleMode.Home
              : t && !o
              ? module1241.RoomInfoBubbleMode.HomeWithoutMode
              : t || !o || s
              ? module1241.RoomInfoBubbleMode.None
              : module1241.RoomInfoBubbleMode.OnlyShowMode;
          else
            return this.state.inBlockMode
              ? o
                ? module1241.RoomInfoBubbleMode.EditMode
                : t
                ? module1241.RoomInfoBubbleMode.EditArea
                : s
                ? module1241.RoomInfoBubbleMode.EditOrder
                : module1241.RoomInfoBubbleMode.None
              : module1241.RoomInfoBubbleMode.None;
        },
      },
      ...
      },
      {
        ...
        value: function (t) {
          ...
          var l = this.state.map.width * this.transform.xx,
            ...
            u = module1247._parseDegPointWithTrans(t, p, this.transform, this.state.mapDeg),
      ...
      },
      {
        ...
        value: function () {
          return this.state.mapMode == module936.MAP_MODE_CARPET_EDIT && this.props.subCarpetMode & module377.CarpetEditMode.CarpetIgnore;
        },
      },
      {
        key: '_singleClick',
        value: function (t) {
          if (t.x && t.y && this.map) {
            if (this.state.mapMode == module936.MAP_MODE_CARPET_EDIT) this.handleCarpetMapClick(t);
            else this.handleGlobalCarpetClick(t);
            if (this.state.mapMode == module936.MAP_MODE_GOTO_EDIT) this.props.parent.isGoing || this._dropTarget(t);
          }
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          for (var t = [], o = [], s = 1; s <= module1235.MAX_COUNT_WALL_OR_FBZ; s++)
          ...
          for (s = 0; s < o.length; s++) {
            ...
            if (module1247._isVerticalRotate(this.state.mapDeg)) n = this._getVerticalZoneRect(n);
      ...
      },
      {
        ...
        value: function () {
          ...
          for (var o = null == (t = this.map) ? undefined : t.getVisibleFBZZones(), s = [], n = 0; n < o.length; n++) {
            var l = [];
            if (o[n].state.type == module1235.FbzType.FBZ_TYPE_REGULAR) l.push(0);
            else if (o[n].state.type == module1235.FbzType.FBZ_TYPE_MOPPING) l.push(2);
            else if (o[n].state.type == module1235.FbzType.FBZ_TYPE_CLEANING) l.push(3);
        ...
        value: function (t, o, s) {
          for (
            ...
            var M = o,
              ...
              y = c[b] - v,
              k = y ** _,
              S = module1247._regularAngle(k - M),
              B = Math.sqrt(_ * _ + y * y);
      ...
      },
      {
        ...
        value: function (t, o, s) {
          ...
          if (this.props.editAction == module1326.EditAction.Floor) {
            var h = module21.default(l.data, o),
              ...
              u = module1341.convertFloorDataToImage(h, p, s.data);
            l.image = u;
          }
      ...
      },
      {
        key: 'getSplitParams',
        value: function () {
          if (this.map && this.map.blockOp && this.props.editAction == module1326.EditAction.Split) {
      ...
      },
      {
        ...
        value: function () {
          var t;
          return null == (t = this.map) ? undefined : t.isFBZReachMaxNum(module1235.FbzType.FBZ_TYPE_REGULAR);
        },
      },
      {
        ...
        value: function () {
          var t;
          return null == (t = this.map) ? undefined : t.isFBZReachMaxNum(module1235.FbzType.FBZ_TYPE_MOPPING);
        },
      },
      {
        ...
        value: function () {
          var t;
          return null == (t = this.map) ? undefined : t.isFBZReachMaxNum(module1235.FbzType.FBZ_TYPE_CLEANING);
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          this.setState({
            mapMode: module936.MAP_MODE_ZONED_CLEAN_EDIT,
          });
          if (this.map)
            this.map.setState({
              displayZones: [],
      ...
      },
      {
        ...
        value: function (t) {
          var o;
          this.disableAddingModeCallback = t;
          if (!(null == (o = this.map))) o.addFBZoneNew(module1235.FbzType.FBZ_TYPE_REGULAR);
        },
      },
      {
        ...
        value: function () {
          var t;
          if (!(null == (t = this.map))) t.addFBZoneNew(module1235.FbzType.FBZ_TYPE_MOPPING);
        },
      },
      {
        ...
        value: function () {
          var t;
          if (!(null == (t = this.map))) t.addFBZoneNew(module1235.FbzType.FBZ_TYPE_CLEANING);
        },
      },
      {
      ...
      },
      {
        ...
        value: function (t) {
          if (this.map && module1231.MM.hasCarpetMap && this.state.showCarpetBubbles) {
      ...
      },
      {
        ...
        value: function (t) {
          if (t != this.lastMapMode) {
            this.lastMapMode = t;
            var o = module1235.BlockBubbleShowInfo.DISPLAYNAME | module1235.BlockBubbleShowInfo.CLEANMODE;
            if (t == G.Global_Clean)
              this.setState({
                inBlockMode: false,
                inCleanBlockMode: 0,
                mapMode: module936.MAP_MODE_REGULAR,
                blockBubbleShowInfo: module1235.BlockBubbleShowInfo.DISPLAYNAME,
              ...
              this.setState({
                inCleanBlockMode: 2,
                mapMode: module936.MAP_MODE_BLOCK_CLEAN_EDIT,
                blockBubbleShowInfo: module1235.BlockBubbleShowInfo.DISPLAYNAME,
                showCarpetBubbles: false,
              });
              ...
              this.setState({
                ...
                inCleanBlockMode: 4,
                mapMode: module936.MAP_MODE_REGULAR,
                blockBubbleShowInfo: module1235.BlockBubbleShowInfo.NONE,
                showCarpetBubbles: false,
              });
              ...
              this.setState({
                ...
                inCleanBlockMode: 0,
                hideAccessory: true,
                blockBubbleShowInfo: module1235.BlockBubbleShowInfo.CLEANSEQUENCE,
              });
      ...
      },
      {
        ...
        value: function () {
          if (!(('android' == module12.Platform.OS && module389.MiApiLevel < module389.androidRoomApiLevel && module389.isMiApp) || module387.default.isShareUser())) {
            var t = module1231.MM.roomNameMapping,
              o = module1231.MM.roomNameList;
      ...
      },
      {
        ...
        value: function (t) {
          if (!(('android' == module12.Platform.OS && module389.MiApiLevel < module389.androidRoomApiLevel && module389.isMiApp) || module387.default.isShareUser())) {
            var o = module1231.MM.roomNameMapping,
              s = module1231.MM.roomNameList;
