      ...
      value: function () {
          ...
          this.panResponder = module12.PanResponder.create({
            ...
            onPanResponderMove: function (o, l) {
              if (!t.callBack.onShouldMove || t.callBack.onShouldMove()) {
                var s = [module1247._parseEvent2(o.nativeEvent, l), t.touch.move],
                  c = s[0],
                  h = s[1];
                  ...
                  if (u) {
                    ...
                    if (p) {
                      ...
                      if (null != t.callBack.onShouldTwoFinger && t.callBack.onShouldTwoFinger() && c.hasOwnProperty('distance') && h.hasOwnProperty('distance')) {
                        ...
                        var w = module1247._parseDegPointWithTrans(c, h, u.trans, u.mapDeg),
          ...
          this.panResponderScale = module12.PanResponder.create({
            ...
            onPanResponderStart: function (n, o) {
              if (!(n.nativeEvent.touches.length > 1)) {
                var l = module1247._parseMove(n.nativeEvent, o) || {};
                t.scale.dx = l.x;
                t.scale.dy = l.y;
                ...
                if (s) {
                  ...
                  if (c) {
                    ...
                    t.rotateTrans.widthVsign = module1247._pointVectorToLine(
                      t.rotateTrans.realLTX,
                      t.rotateTrans.realLTY,
                      t.rotateTrans.targetVectorX,
                      t.rotateTrans.targetVectorY
                    );
                    t.rotateTrans.heightVsign = module1247._pointVectorToLine(
                      t.rotateTrans.realLTX,
                      t.rotateTrans.realLTY,
            ...
            onPanResponderMove: function (o, l) {
              if (!(o.nativeEvent.touches.length > 1)) {
                o = module1247._parseMove(o.nativeEvent, l) || {};
                var s = null == t.callBack.getInfo ? undefined : t.callBack.getInfo();
                ...
                if (s) {
                  ...
                  if (c) {
                    var h = {
                      ...
                      u = module1247._parseDegPointWithTrans(o, h, s.trans, s.mapDeg),
                    ...
                    if (s.mapDeg % 360 == 0 && 0 === s.slopeAngle) {
                      ...
                      if (((Y = L[0]), (B = L[1]), L[2])) {
                        var V = B ** Y,
                          E = module1247._regularAngle(s.slopeAngle + V);
        ...
        if (this.rectPanType & u.PanTypeRotate)
          this.panResponderRotate = module12.PanResponder.create({
            ...
            onPanResponderMove: function (o, l) {
              if (!(o.nativeEvent.touches.length > 1)) {
                var s = module1247._parseMove2(o.nativeEvent, l) || {},
                  c = null == t.callBack.getInfo ? undefined : t.callBack.getInfo();

                if (c) {
                  var h = module1247._parseDegPointWithTrans(
                      s,
                      {
                        x: 0,
                        y: 0,
    ...
    },
    {
      ...
      value: function (t, n) {
        var o,
          l,
          s = false,
          c = module1235.RectConfig.maxLength,
          T = module1235.RectConfig.maxLength,
          u = module1235.RectConfig.minLength,
          p = module1235.RectConfig.minLength,
