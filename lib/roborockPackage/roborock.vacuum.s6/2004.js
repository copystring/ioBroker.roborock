  ...
  module5.default(N, [
    ...
    },
    {
      ...
      value: function () {
        ...
        var t = this,
          ...
          s = React.default.createElement(module1345.default, {
            tip: this.state.noMap.tip,
            shouldShowGuideButton: this.state.noMap.showGuide,
          }),
          l = React.default.createElement(module1233.MapView, {
            left: 20,
            right: 20,
            style: {
              flex: 1,
          ...
          c = React.default.createElement(
            ...
            React.default.createElement(module1804.default, {
              ref: function (n) {
          ...
          _ = React.default.createElement(module1800.default, {
            ref: function (n) {
          ...
          k = React.default.createElement(module1808.default, {
            ref: function (n) {
    ...
    },
    {
      ...
      value: function () {
        var t, n, o, s;
        this.updateMap();
        if (!(null == (t = this.mapView))) t.setAllCleanMopMode(module1231.MM.customCleanModes);
        if (!(null == (n = this.mapView))) n.setCleanSequence(module1231.MM.cleanSequence.concat(), false);
    ...
    },
    {
      ...
      value: function () {
        ...
        var l = module1231.MM.mapRotateAngle[module377.RSM.currentMapId];
        if (!(null == (t = this.mapView)))
          t.setState(
            x(
              x({}, module1231.MM.mapData),
              {},
              {
        ...
        if (!(null == (n = this.sidebarMenu)))
          n.setState({
            tab: this.state.mode == G.Segment ? module1347.TabSegment : module1347.TabZone,
            mapEditButtonEnabled: module386.default.isSupportSmartScene(),
            modeSetButtonEnabled: module386.default.isSupportSmartScene(),
          });
          ...
          if (n.isTidValid(S) && undefined !== v) {
            ...
            var w = function () {
              if (
                ...
                var c = null != (o = null == (s = module1231.MM.mapData) ? undefined : null == (l = s.smartZones) ? undefined : l.smartZones) ? o : [];
                ...
                c.filter(function (t) {
                  ...
                  .forEach(function (t) {
                    ...
                    if (!(null == (o = n.mapView)))
                      o.setState(x({}, module1231.MM.mapData), function () {
    ...
    },
    {
      key: 'mapMode',
      get: function () {
        if (!module386.default.isSupportSmartScene()) return module1233.MapModelInCleanMode.Segment_Clean_Read_Only;

        switch (this.state.mode) {
          case G.GlobalClean:
            return module1233.MapModelInCleanMode.Global_Clean_With_Clean_Type;
          ...
          case G.Segment:
            ...
            else return n ? module1233.MapModelInCleanMode.Segment_Clean_Read_Only : module1233.MapModelInCleanMode.Segment_Clean_Edit;

          case G.Zone:
            return module1233.MapModelInCleanMode.Zone_Clean_Edit;
