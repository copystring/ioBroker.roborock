    ...
    (o = D.call(this, t)).onPressBubble = function () {
      if (1 != o.state.showAsReminder)
        if (o.state.photoStatus == U.FAILED) {
          o.requestPhoto();
          module1249.clearTimeout(o.timer);
          return void (o.timer = module1249.setTimeout(o.hideName.bind(module6.default(o)), q));
        } else {
  ...
  module5.default(L, [
    ...
    },
    {
      ...
      value: function () {
        ...
        this.timer = module1249.setTimeout(this.hideName.bind(this), q);
    ...
    },
    {
      ...
      value: function () {
        module1249.clearTimeout(this.timer);
      ...
      value: function () {
        if (this.props.mapDeg % 360 == 0) {
          ...
          if ('ai' == this.props.popBoxType && this.state.photoStatus != U.REMINDER) {
            ...
            if (t.x < 80) o = 80;
            if (t.x > W - 80) o = -80;
            var p = 74 + module936.AppBarMarginTop + (module12.StatusBar.currentHeight || 0) + 80 + 160 + 30;
            if (t.y < p) s = p - t.y;
            if (o || s) this.props.parent.props.parent.moveMap(o, s);
          }
        }
    ...
    },
    {
      ...
      value: function () {
        ...
        if (this.state.photoStatus == U.REMINDER) t = this.getInnerImageView(require('./1279'));
        else if (this.state.photoStatus == U.FINISHED) t = this.getInnerImageView(this.state.photoSource);
        else if (this.state.photoStatus == U.FAILED) t = this.getInnerFailedView(require('./1280'), module491.button_title_retry);
        else if (this.state.photoStatus == U.NOPHOTO) t = this.getInnerFailedView(require('./1281'), module491.map_object_bubble_tip_no_photo);
        return t;
      },
    },
    {
      ...
      value: function () {
        ...
        var o = module936.obstacleNames[this.props.type];
        if (undefined === o) o = ' ';
        ...
        var module1283 = React.default.createElement(
          ...
          module1283 = React.default.createElement(
            j,
            {
              style: {
                position: 'absolute',
          ...
          React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                this.state.photoStatus == U.REMINDER ? module1283 : module1283
              )
            ),
            React.default.createElement(
              j,
    ...
    },
    {
      ...
      value: function () {
        ...
        if (1 == this.props.showAsGeneralObject && 1 != this.props.showAsBlackWall && 1 != this.props.showDeleteButton && 1 != this.props.showDebugInfo) s = require('./1284');
        var n = 8,
          p = 8;
        ...
        var u = module936.obstacleNames[this.props.type];
        if (undefined === s) u = ' ';
        var c = '';
        ...
        var module1285 = React.default.createElement(
            j,
            {
              pointerEvents: 'auto',
              style: {
          ...
          y = React.default.createElement(module1262.default, {
        ...
        return React.default.createElement(
          ...
          this.props.showDeleteButton && !this.props.showAsBlackWall && module1285
        );
      },
    },
  ]);
...
exports.MapObjectView = module1284;
module1284.defaultProps = {
