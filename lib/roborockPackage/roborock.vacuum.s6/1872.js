...
var module491 = require('./491').strings,
  ...
  module1871 = (function (t) {
    ...
    function z(t) {
      ...
      (o = module1878.call(this, t)).hasFetchedRecordCount = 0;
    ...
    module5.default(z, [
      ...
      },
      {
        key: 'testUI',
        value: function () {
          this.cleanRecords = require('./1878');
      ...
      },
      {
        ...
        value: function (t, o, n, s) {
          var l = this,
            u = module1368.utcTimeConvertToPhoneTimeZoneTime(1e3 * t.start);
          console.log('rowData = ' + t);
          var c = module1368.addZeroPrefix(u.month) + '/' + module1368.addZeroPrefix(u.day) + ' ' + module1368.addZeroPrefix(u.hour) + ':' + module1368.addZeroPrefix(u.minute),
            h = module936.CleanStartType()[t.startType] || module491.localization_strings_Setting_General_index_0,
          ...
          return React.default.createElement(module1875.default, {
