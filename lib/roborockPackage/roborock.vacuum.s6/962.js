...
exports.default = function (u, l) {
  var h,
    v,
    y = '__create-react-context-' + (0, module963.default)() + '__',
    b = (function (t) {
      function n() {
        var module963, u, p, f;
        s(this, n);
        ...
        module963 = u = c(this, t.call.apply(t, [this].concat(h)));
        u.emitter =
          ((p = u.props.value),
          (f = []),
          {
  ...
  var _ = (function (t) {
    function n() {
      ...
      module963 = u = c(this, t.call.apply(t, [this].concat(f)));
      u.state = {
        value: u.getValue(),
      };
