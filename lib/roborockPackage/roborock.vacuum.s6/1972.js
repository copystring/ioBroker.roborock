            ...
            1 == this.state.multiFloorEnabled
              ...
              : (null == (t = this.globalLoadingView) || t.showWithText(),
                module1231.MM.getMultiMaps()
                  .then(function () {
                    if (module1231.MM.maps.length <= 1) n.setMultiFloorSwitch(false);
                    else
                          ...
                          function (l) {
                            for (;;)
                              switch ((l.prev = l.next)) {
                                ...
                                case 11:
                                  module1249.setTimeout(function () {
                                    return o.saveSelectMap(module1231.MM.maps.length >= 1 ? module1231.MM.maps[0].id : -1, 1e3);
                                  });
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            module1975 = React.default.createElement(
              module12.View,
              {
                style: {
                  flex: 1,
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    React.default.createElement(module12.Image, {
                      ...
                      source: this.state.multiFloorEnabled ? require('./1975') : require('./1974'),
                    }),
                    React.default.createElement(
                      module12.Text,
                      {
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    React.default.createElement(module12.Image, {
                      ...
                      source: this.state.multiFloorEnabled ? require('./1974') : require('./1975'),
                    }),
                    React.default.createElement(
                      module12.Text,
                      {
            ...
            c = React.default.createElement(module1243.MapSaveActionSheetView, {
              actionPrefix: 'reserve_map',
              ref: function (n) {
                return (t.mapSavingActionSheet = n);
              },
              handleSaveMap: this.saveMapOnSelectedMenu.bind(this),
              mode: module1243.MapSaveActionSheetMode.KeepMap,
            }),
