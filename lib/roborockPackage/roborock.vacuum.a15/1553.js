exports.CustomMopModeView = function (t) {
  var o = React.useContext(module1121.AppConfigContext).theme.ModeSettingPanel,
    n = t.items,
    b = undefined === n ? [] : n,
    x = t.currentMopId,
          ...
          for (;;)
            switch ((n.prev = n.next)) {
              case 0:
                ...
                n.next = 5;
                return regeneratorRuntime.default.awrap(module415.default.setCustomMopById(t.id));
    ...
    k = (module12.Dimensions.get('window').width - 80 - 20) / 3;
  ...
  return React.default.createElement(
    ...
    React.default.createElement(
      ...
      React.default.createElement(
        ...
        module505.custom_mode_panel_mop_gear_title
      )
    ),
    React.default.createElement(
      module12.View,
