  ...
  S = (function (t) {
    ...
    function k(t) {
      ...
      (s = P.call(this, t)).handleFBZPanOnShouldStart = function (t) {
        ...
        if (module393.isMiApp && -1 == n && s.editItems.length >= module1057.MAX_FURNITURE_EDIT_MIAPP) {
          var u = {
            text: module505.localization_strings_Main_Error_ErrorDetailPage_3,
          };
          globals.Alert.alert(module505.map_edit_furniture_max_tip_miapp, '', [u]);
          return false;
        }

        module1055.MapEditCommonService.enableEditMap();
        return true;
      };
    ...
    module5.default(k, [
      ...
      },
      {
        ...
        value: function () {
          var t = [];
          this.state.data.forEach(function (n) {
            if (n.type != module1057.FurnitureType.FT_TOILET) n.changed ? t.push(n) : n.edited || t.push(n);
          });
          return t;
        },
      },
      ...
      },
      {
        ...
        value: function (t, n) {
          if (t == module1057.FurnitureType.FT_TOILET) return true;
          return !(
            !this.props.showFurnitureIcon ||
            !((t >= module1057.FurnitureType.FT_TVCABINET && t <= module1057.FurnitureType.FT_DINNERTABLE) || t == module1057.FurnitureType.FT_TEATABLE) ||
            n
          );
        },
      },
      ...
      },
      {
        ...
        value: function (t) {
          ...
          var s = this.props.mapMode == module1265.MAP_MODE_FURNITURE_EDIT;
          return this.state.data.map(function (u, o) {
            if (u.type == module1057.FurnitureType.FT_NONE || (u.type == module1057.FurnitureType.FT_TOILET && (n.props.showFurnitureIcon || !module394.MC.showAllFurnitureModel)))
