  ...
  F = (function (t) {
    ...
    function W(t) {
      ...
      (o = B.call(this, t)).state = {
        structureLightSwitch: module1558.default.cameraEnabled,
        avoidCollisionSwitch: false,
        loading: false,
        refreshing: false,
        mapObjectPhotoEnabled: module1558.default.mapObjectPhotoEnabled,
        sceneSwitch: false,
        isShow: false,
      };
    ...
    module5.default(W, [
      {
        ...
        value: function () {
          ...
          module1558.default.addChangeListener(this.changeListener);
      ...
      },
      {
        ...
        value: function () {
          this.mounted = false;
          module1558.default.removeChangeListener(this.changeListener);
        },
      },
      {
                ...
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    module1122.showFinishCurrentTastAlertIfNeeded().catch(function (t) {
                      o.showToast(module505.robot_communication_exception);
                    });
                    return s.abrupt('return');

                  case 3:
                    module1558.default.cameraEnabled = t;
                    if (!t) module1558.default.explorationEnabled = t;
                    this.setState({
                      structureLightSwitch: t,
                    });
                    s.next = 8;
                    return regeneratorRuntime.default.awrap(module1558.default.updateCameraStatus());
              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    l.prev = 0;
                    l.next = 3;
                    return regeneratorRuntime.default.awrap(module415.default.getFloorIdentifyStatus());

                  case 3:
                    t = l.sent;
                    l.next = 6;
                    return regeneratorRuntime.default.awrap(module415.default.getFurnitureIdentifyStatus());
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    module22 = 0 == t;
                    s.next = 4;
                    return regeneratorRuntime.default.awrap(module1558.default.updatePetModeEnabled(module22));
      ...
      },
      {
        ...
        value: function () {
          return module423.DMM.isTanosV
            ? module505.camera_setting_rrai_detail
            : module390.default.isObjectPhotoShowSupported()
            ? module505.camera_setting_detail3
            : module505.structure_light_tip_1;
        },
      },
      {
        key: 'render',
        value: function () {
          ...
          var l = module12.Dimensions.get('window').width - 30,
            ...
            u = {
              title: module505.avoid_collision_mode,
              bottomDetail: '' + module505.structure_light_tip_3,
              bottomDetailWidth: l - 40,
              shouldShowSwitch: true,
            ...
            h = {
              title: module505.led_status_title1,
              visible: module423.DMM.isTopazSV && this.state.structureLightSwitch,
              shouldShowBottomLine: false,
              shouldShowBottomLongLine: false,
              bottomDetailWidth: l - 40,
              isDetailCenter: false,
              rightCenter: true,
              detailColor: 0 == module1558.default.ledSetting ? '#007AFF' : this.context.theme.subTextColor,
              detail: 0 == module1558.default.ledSetting ? module505.led_status_title2 : module505.debug_info_close,
              bottomDetail: module505.led_status_detail1,
            ...
            w = {
              title: module505.camera_setting_pet_mode_title,
              ...
              isDetailCenter: false,
              rightCenter: true,
              detailColor: module1558.default.cameraEnabled ? '#007AFF' : 'rgba(0,0,0,0.4)',
              detail: module1558.default.petModeEnabled ? module505.has_or_no_has : module505.has_or_no_no,
              bottomDetail: module505.if_has_pet_tip_detail,
            ...
            E = {
              title: module505.obstacle_pop_type_photo,
              ...
              bottomDetail: module505.map_object_enable_intro,
            },
            R = {
              title: module505.camera_setting_detail4,
              bottomDetail: '' + module505.camera_setting_detail5,
              bottomDetailWidth: l - 40,
              shouldShowSwitch: true,
              switchOn: this.state.sceneSwitch,
              switchValueChanged: this.onSceneSwitch.bind(this),
              visible: (module423.DMM.isTopazSV || module423.DMM.isTanosSV) && this.state.structureLightSwitch,
              shouldShowTopLongLine: true,
              shouldShowBottomLine: true,
            },
            F = {
              title: module505.map_object_privacy_alert_link,
              ...
              onPress: function () {
                return t.props.navigation.navigate('WebViewPage', {
                  title: module505.map_object_privacy_title,
                  refrence: module1573.default.PhotoPrivacy(),
                  buttonTitle: module1558.default.mapObjectPhotoPrivacyPolicyAgreed ? module505.reset_authoration : module505.button_title_agree,
                  buttonColor: module1558.default.mapObjectPhotoPrivacyPolicyAgreed ? 'red' : '#007AFF',
                  ...
                  buttonAction: function (o) {
                    if (module381.RSM.isRunning && module1558.default.mapObjectPhotoPrivacyPolicyAgreed)
                      o.alertView &&
                      ...
                      var s = function () {
                        setTimeout(function () {
                          if (o && o.loadingView) o.loadingView.showWithText(module505.map_object_cancel_privacy_loading);
                        }, 100);
                        ...
                        module393
                          .postPrivacyAgreementStatusWithVersion(
                            ...
                            module1558.default.mapObjectPhotoPrivacyPolicyAgreed ? 5 : 4,
                            1
                          )
                          .then(function (t) {})
                          .catch(function (t) {});
                        module1558.default.updatePhotoPrivacy(!module1558.default.mapObjectPhotoPrivacyPolicyAgreed, function (n) {
                          if (
                            ...
                            if ('' != (s = module1558.default.mapObjectPhotoPrivacyPolicyAgreed ? '' : module505.map_object_cancel_privacy_success)) globals.showToast(s);
                            ...
                            LogEventCommon(module1558.default.mapObjectPhotoPrivacyPolicyAgreed ? 'accept_photo_privacy' : 'reset_photo_privacy_confirm');
                          } else {
                            var s = module1558.default.mapObjectPhotoPrivacyPolicyAgreed ? module505.map_object_cancel_privacy_timeout : module505.map_object_ignore_failed;
                            if (o) globals.showToast(s);
                          }
                        });
                      };

                      if (module1558.default.mapObjectPhotoPrivacyPolicyAgreed) {
                        if (o.alertView)
                          o.alertView.customAlert(
                            module505.reset_monitor_privacy_dialog_title,
                            module505.map_object_privacy_reset_dialog_content,
                            function () {
                              s();
                            },
                            null,
            ...
            B = React.default.createElement(module385.ActionSheetView, {
              ...
              title: module505.if_has_pet_tip_title,
              actions: [module505.has_or_no_has, module505.has_or_no_no],
            ...
            W = React.default.createElement(module385.ActionSheetView, {
              ...
              actions: [module505.led_status_title2, module505.debug_info_close],
            ...
            q = React.default.createElement(module1853.PhotoFeaturePrivacyDialog, {
              ref: function (o) {
              ...
              onConfirm: function () {
                return module1558.default.updatePhotoPrivacy(true, function (o) {
                  if (!o) globals.showToast(module505.robot_communication_exception);
                  if (o) module419.SetStorageKey(module419.StorageKeys.PhotoPrivacyVersion, module419.StorageKeys.PhotoPrivacyVersion);
            ...
            Q = F.visible
              ...
              : React.default.createElement(module12.View, null),
            X = module1317.titleBarContentHeight,
            Y =
              module391.default.iOSAndroidReturn(X + module1265.StatusBarHeight + module1265.AppBarMarginTop, (module12.StatusBar.currentHeight || 0) + X) +
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    globals.showToast(module505.map_object_app_version_tip);
                    return c.abrupt('return');

                  case 3:
                    if (module1558.default.cameraEnabled) {
                      c.next = 6;
                      break;
                    }

                    globals.showToast(module505.camera_setting_open_rrai_tip);
                    return c.abrupt('return');
                  ...
                  case 6:
                    ...
                    module22 = module1558.default.mapObjectPhotoPrivacyPolicyAgreed;
                    c.next = 10;
                    return regeneratorRuntime.default.awrap(module419.GetStorageKey(module419.StorageKeys.PhotoPrivacyVersion));
                  ...
                  case 27:
                    ...
                    module1558.default.mapObjectPhotoEnabled = t;
                    c.next = 31;
                    return regeneratorRuntime.default.awrap(module1558.default.updateCameraStatus());
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this.hideLedDialog();
          if (1 == t)
            globals.Alert.alert('', module505.led_alert_detail, [
              {
      ...
      },
      {
        ...
        value: function (t) {
          var o = this;
          module1558.default.updateLedSetting(t, function (t) {
            if (!t) o.showToast(module505.robot_communication_exception);
          });
        },
      },
      {
        ...
        value: function () {
          ...
          module1558.default
            ...
            .then(function () {
              ...
              return module390.default.isAvoidCollisionSupported() ? module415.default.getCollisionAvoidStatus() : null;
            })
            .then(function (o) {
              var n;
              t.setState({
            ...
            .catch(function (o) {
              t.showToast(module505.robot_communication_exception);
            })
            .finally(function () {
              if (module423.DMM.isTopazSV || module423.DMM.isTanosSV) t.getSceneSwitchState();
              else t.endLoading();
            });
        },
      },
...
exports.default = F;
F.defaultProps = {};
F.contextType = module1121.AppConfigContext;
