      ...
      },
      {
        ...
        value: function () {
          this.setState({
            ...
            photoSwitch: module1558.default.mapObjectPhotoEnabled,
          });
        },
      },
      {
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 3:
                    ...
                    module1558.default.updatePhotoPrivacy(true, function (s) {
                      if (s)
                        module419
                          ...
                          .then(function () {
                            return module1558.default.updateCameraStatus();
                          })
                          .then(function () {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            this.state.showVoiceTest &&
              React.default.createElement(module2025.default, {
                parent: this,
              }),
