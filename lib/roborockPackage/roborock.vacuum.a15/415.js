  ...
  return new Promise(function (c, _) {
    s(t, n, o, function (o, s) {
      if (o && s && s.result && 'unknown_method' != s.result) {
        module417.Log.log(module417.LogTypes.RPC, t + ' - ' + ('object' == typeof n ? JSON.stringify(n) : n) + ' - ' + JSON.stringify(s), module417.InfoColors.Success, true);
        c(s);
      } else {
        module417.Log.log(
          module417.LogTypes.RPC,
...
function M(t, n, s) {
  var c = {
    ...
    f = module416.default.encode(JSON.stringify(c)),
    l = {
    ...
    module393.Service.spec
      ...
      .then(function (_) {
        if ((console.log('miSpec', _), _.out)) {
          ...
          module417.Log.log(module417.LogTypes.RPC, 'spec error missing out field', module417.InfoColors.Fail, true);
          c('spec error missing out field');
        }
      })
      .catch(function (n) {
        module417.Log.log(module417.LogTypes.RPC, 'spec error ' + t + ' - ' + ('object' == typeof n ? JSON.stringify(n) : n), module417.InfoColors.Fail, true);
        c({
          error: 'spec error: ' + t,
...
function S(t, n, o) {
  if ((p++, !(module390.default.isRPCRetrySupported() && 'retry_request' != t))) return module393.isSpecSupported() ? M(t, n) : l(t, n, o, module393.callMethod);
  ...
  return new Promise(function (n, s) {
    var c;
    ((c = u), module393.isSpecSupported() ? M(t, c) : l(t, c, o, module393.callMethod))
      .then(function (o) {
...
var C = (RobotApi = {
  ...
  setAutoDeliveryCleanFluid: function (t) {
    return S('set_auto_delivery_cleaning_fluid', t, {});
  },
