var module381 = require('./381'),
  ...
  _ = module505.getInterfaceLanguage(),
  c = null,
  h = module423.DMM.bucket,
  module1574 = require('./1574').HtmlMap;

function M() {
  return module1265.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].host;
}
...
c =
  module423.DMM.isTanosS || module423.DMM.isTanosSL || module423.DMM.isTanosSC || module423.DMM.isTanosSE
    ? module1574.TanosS
    : module423.DMM.isTanosSPlus || module423.DMM.isTanosSMax
    ? module1574.TanosSPlus
    : module423.DMM.isTanosV
    ? module1574.TanosV
    : module423.DMM.isRubysLite
    ? module1574.RubysLite
    : module423.DMM.isTopazS
    ? module1574.TopazS
    : module423.DMM.isTopazSV
    ? module1574.TopazSV
    : module423.DMM.isTanos || module423.DMM.isRubyPlus || module423.DMM.isRubySC || module423.DMM.isRubysE
    ? module1574.Tanos
    : module1574.Default;
...
var T = (HtmlResManager = {
  ...
  GuideTitle1: function () {
    return module390.default.isUseOldTitleInGuide() ? module505.localization_strings_Setting_Guide_index_0 : module505.tanosv_title_guide_1;
  },
  GuideTitle2: function () {
    return module390.default.isUseOldTitleInGuide() ? module505.localization_strings_Setting_Guide_index_1 : module505.tanosv_title_guide_2;
  },
  GuideTitle2_2: function () {
    return module505.localization_strings_Main_IntroducePage_1;
  },
  GuideTitle3: function () {
    return module390.default.isUseOldTitleInGuide() ? module505.localization_strings_Setting_Guide_index_2 : module505.map_edit_map_lab_save_map_kindly_remind;
  },
  GuideTitle4: function () {
    return module390.default.isUseOldTitleInGuide() ? module505.localization_strings_Setting_Guide_index_3 : module505.tanosv_title_guide_4;
  },
  GuideTitle5: function () {
    return module390.default.isUseOldTitleInGuide() ? module505.localization_strings_Setting_Guide_index_0 : module505.tanosv_title_guide_5;
  },
  GuideTitle6: function () {
    return module390.default.isUseOldTitleInGuide() ? module505.localization_strings_Setting_Guide_index_5 : module505.tanosv_title_guide_6;
  },
  GuideTitle7: function () {
    return module505.localization_strings_Setting_Guide_index_6;
  },
});
exports.default = T;
