...
exports.getCleanModeDetailText = function (o) {
  ...
  if (module390.default.isShakeMopSetSupported() && 200 != o.waterMode) {
    var f,
      C = u ? (null == (f = module1543.ModeDataInstance.modePannelCustomMops[0]) ? undefined : f.name) : y(o.mopMode);
    if (301 == o.mopMode) return p + ' | ' + C;

    if (u) {
      if (t == module1542.CleanMethodClean) return h;
      if (t == module1542.CleanMethodMop) return C;
      if (t == module1542.CleanMethodCleanAndMop) return h + ' | ' + C;
    }
  }
