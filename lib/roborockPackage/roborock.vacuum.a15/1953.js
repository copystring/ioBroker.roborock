...
var module505 = require('./505').strings,
  ...
  O = (function (t) {
    ...
    function O(t) {
      ...
      (n = A.call(this, t)).dataProvider = module390.default.isMultiFloorSupported() ? new module1269.MultiMapDataProvider() : new module1269.SingleMapDataProvider();
    ...
    module5.default(O, [
      ...
      },
      {
        ...
        value: function () {
          ...
          this.multiMapsListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.DidReceiveSpecialEvent, function (n) {
            if (n.sender != t) {
              if (n.data == module419.EventKeys.MultiMapsDidReceive) t.reloadDataIfNeeded();

              if (
                !(
                  n.data != module419.EventKeys.MapSegmentsDidChange &&
                  n.data != module419.EventKeys.FBZSettingsDidChange &&
                  n.data != module419.EventKeys.CurrentMapDidChange &&
                  n.data != module419.EventKeys.MapDidRotate
                )
              ) {
                t.requestMaps(false);
              ...
              if (n.data == module419.EventKeys.CurrentMapDidChange) module414.MM.getMultiMaps();
            }
          });
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module381.RSM.isLocating && module381.RSM.multiFloorEnabled) {
            var s = module381.RSM.mscode >> 2;
            if (63 != s && -1 != s) l = false;
          }

          var u = this.emptyMapView.state.hasCurrentMap,
            c = this.emptyMapView.state.isNewMap,
            p = this.state.items && this.state.items.length > 0;
              ...
              .catch(function (t) {
                if (!t.isCanceled)
                  if (t.data && t.data.result && 'unknown_method' == t.data.result) {
                    ...
                    globals.Alert.alert(module505.plugin_need_update, '', [n]);
            ...
            .catch(function (t) {
              ...
              if (
                ...
                if (t.data && t.data.result && 'unknown_method' == t.data.result) {
                  ...
                  globals.Alert.alert(module505.plugin_need_update, '', [s]);
                } else globals.showToast(module505.robot_communication_exception);
            })
            .finally(function () {
              if (!t.unMount) {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this.dataProvider
            ...
            .catch(function (t) {
              if (-3 != t.data.error && -10005 != t.data.error.code && -10005 != t.data.error) globals.showToast(module505.robot_communication_exception);
            })
            .finally(function () {
              var t;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this.dataProvider
            ...
            .then(function () {
              return n.dataProvider.manualSegmentMap(module414.CurrentMapId);
            })
            .then(function () {
              n.setState({
                multiFloorEnabled: t,
                ...
                .then(function (o) {
                  var l =
                    ...
                    p.state.items.map(function (o) {
                      if (o.id == t) o.name = module1136.FloorMapPageUtils.getRealName(n);
                      return o;
                    });
                  p.setState({
                    items: l,
      ...
      },
      {
        ...
        value: function () {
          ...
          this.dataProvider
            ...
            .catch(function (t) {
              if (t.data && t.data.result && 'unknown_method' == t.data.result)
                globals.Alert.alert(module505.plugin_need_update, '', [
                  {
                    text: module505.localization_strings_Setting_RemoteControlPage_51,
                    onPress: function () {
                      module393.closeCurrentPage();
        ...
        value: function (t) {
          ...
          if (!this.isLoadingMap) {
            ...
            this.dataProvider
              ...
              .catch(function (o) {
                if (n.state.multiFloorFeatureEnabled) globals.showToast(module505.map_object_ignore_failed);
                  ...
                  globals.Alert.alert(module505.plugin_need_update, '', [l]);
        ...
        value: function (t) {
          ...
          this.dataProvider
            ...
            .then(function (o) {
              ...
              if (n.state.multiFloorFeatureEnabled) module414.MM.getMultiMaps();
              else {
                module12.DeviceEventEmitter.emit(module419.NotificationKeys.DidReceiveSpecialEvent, {
                  data: module419.EventKeys.MapSegmentsDidChange,
                  sender: n,
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    c.next = 3;
                    return regeneratorRuntime.default.awrap(module419.GetStorageKey(module419.StorageKeys.ARMapPathPrefixKey + '_' + t));
                  ...
                  case 3:
                    ...
                    n.then(function (n) {
                      var l = module1905(n, globals.app.state.theme != module515.Themes.light, false, false);
            ...
            if (module381.RSM.isRunning)
              ...
              if (!(null == (n = this.dataProvider) || null == n.backupMap))
                n.backupMap(this.state.currentMapId)
                  .then(function (t) {
                    globals.Alert.alert(module505.backup_success_hint, '', [o]);
                    module414.MM.getMultiMaps();
                  })
                  .catch(function () {
                    globals.showToast(module505.robot_communication_exception);
      ...
      },
      {
        ...
        value: function () {
          ...
          if (null == (t = this.dataProvider) ? undefined : t.recoverMultiMap) {
            ...
            globals.Alert.alert('', module505.recover_map_hint, [
              {
              ...
              n.setState(
                ...
                function () {
                  if (t) {
                    ...
                    globals.Alert.alert(module505.map_edit_map_lab_close_warn, '', [o, l]);
                  }
                }
              );
            };
      ...
      },
      {
        ...
        value: function () {
          ...
          globals.Alert.alert('', module505.manual_saving_map_popup_title, [o, n]);
        },
      },
      {
        ...
        value: function () {
          ...
          globals.Alert.alert('', module505.delete_map_hint_title, [o, n]);
        },
      },
      {
        ...
        value: function () {
          ...
          globals.Alert.alert(module505.map_edit_map_edit_reset_remind, '', [n, o]);
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          if (((module381.RSM.mapSaveEnabled && !module381.RSM.multiFloorEnabled) || module381.RSM.multiFloorEnabled) && 0 == module414.MM.maps.length)
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this.singleFloorSaveNewMapActionSheet.hide(function () {
            if (t == module414.CurrentMapId) n.singleFloorSaveNewMapAlert.show();
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (
            ...
            if ('' != o) {
              var l = module1136.FloorMapPageUtils.getRealLength(o);
              if (module1136.FloorMapPageUtils.getRealLength(o) >= 30) globals.showToast(module505.floor_map_name_too_long);
              else this.requestEditingMapName(this.state.editingNameMap.id, o, l);
            }
          } else globals.showToast(module505.name_already_exists);
        },
      },
      {
        ...
        value: function (t) {
          ...
          if (this.state.multiFloorFeatureEnabled) {
            if (module381.RSM.isRunning) {
              ...
              if (!(null == (o = this.modalMapEditMenu))) o.alert('', module505.ask_if_stop_for_change_map, [l, s]);
            } else {
            ...
            if (!(null == (u = this.modalMapEditMenu))) u.alert(module505.map_reset_page_choose_map_title, '', [c, p]);
          }
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          this.loadEditingMap(this.state.currentMapId)
            ...
            .catch(function (t) {
              if (t != W) globals.showToast(module505.map_reset_page_operate_fail);
              else
                module1122.showFinishCurrentTastAlertIfNeeded().catch(function (t) {
                  globals.showToast(module505.robot_communication_exception);
                });
        ...
        value: function () {
          if (module390.default.groundOnlySupportFloor())
            ...
            this.props.navigation.navigate('MapEditGroundPage', {
              title: module505.map_edit_ground_material_title,
            });
        },
      },
      {
          ...
          this.loadEditingMap(this.state.currentMapId)
            .then(function () {
              o.props.navigation.navigate('MapEditRotatePage', {
                title: module505.map_edit_rotate_map_title,
              });
            })
            .catch(function (t) {
              if (t != W) globals.showToast(module505.map_reset_page_operate_fail);
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            c = React.default.createElement(module1846.default, {
              ...
              mode: module1846.ModalMapEditMenuMode.MapManagement,
              ...
              onEditingMapNameSuccess: function (n, o) {
                var l =
                  ...
                  t.state.items.map(function (t) {
                    if (t.id == n) t.name = module1136.FloorMapPageUtils.getRealName(o);
                    return t;
                  });
                t.setState({
                  items: l,
            ...
            E = {
              title: module505.map_edit_map_lab_save_map,
              bottomDetail: module505.map_edit_map_lab_save_map_des,
            ...
            R = {
              ...
              detail: this.state.multiFloorEnabled ? module505.multi_floor_pattern : module505.single_floor_pattern,
              detailWidth: 150,
            ...
            x =
              ...
              this.state.items.map(function (n, o) {
                return React.default.createElement(module1954.default, {
                  key: o,
                  mapID: n.id,
                  name: n.name,
                  mapTime: n.time,
                                ...
                                for (;;)
                                  switch ((s.prev = s.next)) {
                                    case 0:
                                      ...
                                      s.next = 3;
                                      return regeneratorRuntime.default.awrap(module419.GetStorageKey(module419.StorageKeys.ARMapPathPrefixKey + '_' + t.id));
                                    ...
                                    case 3:
                                      ...
                                      if (!(o != module381.RSM.currentMapId || n))
                                        module12.DeviceEventEmitter.emit(module419.NotificationKeys.DidReceiveSpecialEvent, {
                                          data: module419.EventKeys.CurrentARMapDidDelete,
                                        });
            ...
            A = p && this.state.items && this.state.multiFloorFeatureEnabled,
            q = React.default.createElement(module1955.default, {
              ref: function (n) {
            ...
            z = !this.state.multiFloorFeatureEnabled,
            U = React.default.createElement(module1955.SingleMapEmptyMapItem, {
            ...
            Z = React.default.createElement(
              ...
              React.default.createElement(
                module12.Text,
                {
                  style: G.addNewMapFont,
                },
                this.state.multiFloorEnabled ? module505.new_map_entrance_in_multiMap_2 : module505.new_map_entrance_in_multiMap_0
              )
            ),
            ...
            J = React.default.createElement(module1134.MultiMapHintModal, {
              ref: function (n) {
            ...
            Q = React.default.createElement(module1055.MultiFloorEnableTipsView, {
              ref: function (n) {
                t.qaContentView = n;
              },
            }),
            X = this.state.mapSaveEnabled && this.state.items && this.state.items.length >= 4,
            ...
            $ = React.default.createElement(module1134.MapSaveActionSheetView, {
              ...
              mode: module1134.MapSaveActionSheetMode.SaveNewMapInSingleFloor,
              handleSaveMap: function (n) {
                return t.onTapSingleFloorSaveActionSheet.apply(t, [n]);
              },
            }),
            ee = React.default.createElement(module1134.MapSaveActionSheetView, {
              ref: function (n) {
            ...
            te = React.default.createElement(module1134.SingleFloorSaveNewMapAlert, {
              ref: function (n) {
            ...
            ie =
              ...
              React.default.createElement(module1863.LoadBackupMapView, {
                ref: function (n) {
