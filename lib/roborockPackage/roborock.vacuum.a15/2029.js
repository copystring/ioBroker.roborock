      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            s = n.html,
            c = n.refrence;
          module417.Log.log(module417.LogTypes.KeyEvent, 'wifi debug page html path,' + module177(c).uri);
          var l =
              (o && {
                uri: o,
              }) ||
              ...
              c,
            u = null;
          if (globals.app.state.theme == module515.Themes.dark) u = 'javascript:document.body.style.color="white";javascript:document.body.style.background="black";';
          var f = 'ios' == module12.Platform.OS ? this.onMessageForIos : null,
            module2003 = this.state.isSure ? require('./2003') : this.context.theme.monitor.confirmPhoto;
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                {
                  style: E.confirmButton,
                  onPress: function () {
                    t.confirmButtonAuction();
                  },
                },
                React.default.createElement(module12.Image, {
                  style: E.confirmButtonImage,
                  source: module2003,
                })
              ),
              React.default.createElement(
                ...
                module505.wifi_debug_mode_title2
              )
            ),
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    n.prev = 0;
                    n.next = 3;
                    return regeneratorRuntime.default.awrap(module415.default.uploadDataDebugMode());
