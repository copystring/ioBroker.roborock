      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            c = s.style,
            l = s.calling,
            module2115 = this.props.isLandscape ? require('./2115') : this.context.theme.monitor.call,
            module2119 = this.props.isLandscape ? require('./2119') : this.context.theme.monitor.hung,
            p = l ? module2119 : module2115,
