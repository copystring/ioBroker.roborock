...
var module505 = require('./505').strings,
  ...
  module1893 = (function (t) {
    ...
    function z(t) {
      ...
      (o = module1900.call(this, t)).hasFetchedRecordCount = 0;
    ...
    module5.default(z, [
      ...
      },
      {
        key: 'testUI',
        value: function () {
          this.cleanRecords = require('./1900');
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(module1895.default, {
                style: [
                  {
      ...
      },
      {
        ...
        value: function (t, o, n, s) {
          var l = this,
            u = module1563.utcTimeConvertToPhoneTimeZoneTime(1e3 * t.start);
          console.log('rowData = ' + t);
          if (!module1265.CleanStartType()[t.startType]) module505.localization_strings_Setting_General_index_0;
          var c = module1563.addZeroPrefix(u.month) + '/' + module1563.addZeroPrefix(u.day) + ' ' + module1563.addZeroPrefix(u.hour) + ':' + module1563.addZeroPrefix(u.minute),
          ...
          return React.default.createElement(module1897.default, {
