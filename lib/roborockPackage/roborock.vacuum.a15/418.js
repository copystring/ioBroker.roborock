      ...
      [
        ...
        },
        {
          ...
          value: function (t, n, s, o) {
            module420.Types.LoopMap;
            module420.Types.LoopStatus;
            var l = new Date();
            ...
            var c = {
              ...
              type: t,
              content: n,
              infoColor: s || module420.InfoColors.Normal,
            };
            this.logs.push(c);
          },
        },
        {
          ...
          value: function (t) {
            if (!this.isEnterd) {
              ...
              this.logs = [];
              this.endTime = 0;
              this.log(module420.Types.KeyEvent, (t ? 'enter plugin from background' : 'firstly enter plugin') + ',interfaceLang: ' + globals.AppLang + ',isRTL:' + globals.isRTL);
              this.isEnterd = true;
            }
          },
        },
                    ...
                    case 0:
                      if (
                        !(
                          ...
                          (module423.DMM.isV1 && !module390.default.isDebuggableV1User())
                        )
                      ) {
                        o.next = 2;
                        break;
        ...
        },
        {
          ...
          value: function (t) {
            if (this.isEnterd) {
              ...
              this.log(module420.Types.KeyEvent, t ? 'enter background mode' : 'completely quit plugin');
              this.save();
              this.isEnterd = false;
            }
          },
        ...
        },
        {
          key: 'upload',
          value: function (t, s) {
            var o, module5, module420, module390, module423, v, x;
            return regeneratorRuntime.default.async(
              function (w) {
                for (;;)
                  switch ((w.prev = w.next)) {
                    ...
                    case 11:
                      module5 = w.t0;
                      module420 = o ? this.beginTime : t.replace('log_', '');
                      module390 = module393.deviceId;
                      module423 = module393.userId;
                      v = module494(module420 + '_' + module423 + '_' + module390);
                      x = {
                        id: v,
                        log: module5,
                        time: module420,
                      ...
                      return regeneratorRuntime.default.awrap(
                        fetch(module422.LogUploadUrl, {
                          method: 'POST',
                          headers: {
                            'Content-Type': 'application/x-www-form-urlencoded',
                          },
                          body: module421.default.jsonToQueryString(x),
                        })
                      );
