    ...
    function (n) {
      for (;;)
        switch ((n.prev = n.next)) {
          case 0:
            n.next = 2;
            return regeneratorRuntime.default.awrap(ue('get_map', {}, module399.DecryptorType.Lz4));
...
exports.getAndDecBase64Data = ue;
exports.getRobotData = le;
...
exports.postPrivacyAgreementStatus = function (n, o) {
  return y
    ? new Promise(function (t, c) {
        var u = ce.PrivacyAgreementStatusKey,
          l = JSON.stringify({
            deviceId: j,
            deviceModel: G,
            server: n,
...
exports.postPrivacyAgreementStatusWithVersion = function (n, o, t) {
  return y
    ? new Promise(function (c, u) {
        var l = ce.PrivacyAgreementStatusWithVersionKey,
          s = JSON.stringify({
            deviceId: j,
            deviceModel: G,
            server: n,
...
exports.isRubyplus = function () {
  return de(['roborock.vacuum.t4', 'roborock.vacuum.t4v2', 'roborock.vacuum.t4v3', 'roborock.vacuum.s4', 'roborock.vacuum.s4v2', 'roborock.vacuum.s4v3']);
};

exports.isTanosT6 = function () {
  return de(['roborock.vacuum.t6', 'roborock.vacuum.t6v2', 'roborock.vacuum.t6v3']);
};

exports.isTanosS6 = function () {
  return de(['roborock.vacuum.s6', 'roborock.vacuum.s6v2', 'roborock.vacuum.s6v3']);
};
...
exports.isRubysCP5 = function () {
  return de(['roborock.vacuum.p5', 'roborock.vacuum.p5v2', 'roborock.vacuum.p5v3', 'roborock.vacuum.p5v4', 'roborock.vacuum.p5v5']);
};
...
exports.isTanosV_CE = function () {
  return de(['roborock.vacuum.a10', 'roborock.vacuum.a10v2', 'roborock.vacuum.a10v3', 'roborock.vacuum.a10v4', 'roborock.vacuum.a10v5']);
};

exports.isTanosVA09 = function () {
  return de(['roborock.vacuum.a09', 'roborock.vacuum.a09v2', 'roborock.vacuum.a09v3', 'roborock.vacuum.a09v4', 'roborock.vacuum.a09v5']);
};

exports.isRubys = function () {
  return de(['roborock.vacuum.s5', 'roborock.sweeper.s5v2', 'roborock.sweeper.s5v3']);
};

exports.isTanosS = pe;

exports.isGarnet = function () {
  return de(['roborock.vacuum.a16', 'roborock.vacuum.a16v2', 'roborock.vacuum.a16v3']);
};
...
exports.isV2Model = ge;
exports.isV3Model = he;
exports.isV4Model = Se;
exports.isV5Model = be;

exports.fixDeviceScreenHeight = function () {
  module394.MC.ScreenHeight = module12.Dimensions.get('window').height;
  if (y) 'ios' != module12.Platform.OS ? (U >= 10065 ? Pe() : !re && Pe()) : re && ke();
  else if ('ios' != module12.Platform.OS) ke();
};
...
if (((exports.PrivacyEvent = V), y)) {
  ...
  exports.CommonSetting = E = module412.CommonSetting;
  exports.MoreSetting = I = module412.MoreSetting;
...
function le(n, o, t) {
  if (y)
    require('./1408').downloadFile(n, o, function (n, o) {
      t(n, o);
    });
  else
...
function fe() {
  if (y) {
    ...
    } else return ie.light;
  } else return b && null != (n = null == b ? undefined : b.colorScheme) ? n : ie.light;
  var n;
}
...
function me() {
  return de(['roborock.vacuum.a19', 'roborock.vacuum.a19v2', 'roborock.vacuum.a19v3', 'roborock.vacuum.a19v4', 'roborock.vacuum.a19v5']);
}
