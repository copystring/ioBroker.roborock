      ...
      module5.default(T, [
        {
          ...
          value: function (t) {
            ...
            this.animatedImageOpacity = new module12.Animated.Value(1);
          },
        },
        {
        ...
        },
        {
          ...
          value: function () {
            this.isAnimating = true;
            var t = module12.Animated.timing(this.animatedImageOpacity, {
                toValue: 0.5,
                duration: 500,
              }),
              n = module12.Animated.timing(this.animatedImageOpacity, {
                toValue: 1,
                duration: 500,
              }),
              o = module12.Animated.sequence([t, n]);
            this.opaAnimation = module12.Animated.loop(o, {
