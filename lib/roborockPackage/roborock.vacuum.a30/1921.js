            ...
            function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    t.next = 2;
                    return regeneratorRuntime.default.awrap(module419.DelStorageKey(module419.StorageKeys.HasShownFullChargeReminder));

                  case 2:
                    t.next = 4;
                    return regeneratorRuntime.default.awrap(module419.DelStorageKey(module419.StorageKeys.HasShownNotDisturbReminder));

                  case 4:
                    t.next = 6;
                    return regeneratorRuntime.default.awrap(module419.DelStorageKey(module419.StorageKeys.MapEditNewbyGuide + 'menu2'));

                  case 6:
                    t.next = 8;
                    return regeneratorRuntime.default.awrap(module419.DelStorageKey(module419.StorageKeys.MapEditNewbyGuide + 'menu3'));
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(module1923.default, {
                style: {
                  flex: 1,
                  height: 300,
                  width: C,
                ...
                url: module1573.default.MainVideoUrl(),
                posterUrl: module1573.default.MainVideoPosterUrl(),
              }),
              l
            )
          );
      ...
      },
      {
        ...
        value: function () {
          return [
            ...
            {
              title: module1573.default.GuideTitle1(),
              onPress: this.onOpenGuideDetailPage.bind(this, 1),
              videoUrl: '',
              videoPosterUrl: '',
              guideUrl: module1573.default.IntroduceRobotGuideUrl(),
            ...
            {
              title: module1573.default.GuideTitle2(),
              onPress: this.onOpenGuideDetailPage.bind(this, 2),
              videoUrl: module1573.default.QuickStartVideoUrl(),
              videoPosterUrl: module1573.default.MainVideoPosterUrl(),
              guideUrl: module1573.default.QuickStartGuideUrl(),
              short_separator: true,
              height_4s: 2450,
              height_6: 2455,
              height_6p: 2455,
            ...
            {
              title: module1573.default.GuideTitle2_2(),
              onPress: this.onOpenGuideDetailPage.bind(this, 3),
              videoUrl: module1573.default.UseMoppingModuleVideoUrl(),
              videoPosterUrl: module1573.default.UseMoppingModulePosterUrl(),
              guideUrl: module1573.default.UseMoppingModuleGuideUrl(),
              short_separator: true,
              height_4s: 2800,
              height_6: 2800,
              height_6p: 2800,
            ...
            {
              title: module1573.default.GuideTitle3(),
              onPress: this.onOpenGuideDetailPage.bind(this, 4),
              videoUrl: module1573.default.MachineWorksVideoUrl(),
              videoPosterUrl: module1573.default.MachineWorksPosterUrl(),
              guideUrl: module1573.default.MachineWorksGuideUrl(),
              short_separator: true,
              height_4s: 5300,
              height_6: 5100,
              height_6p: 5200,
            ...
            {
              title: module1573.default.GuideTitle4(),
              onPress: this.onOpenGuideDetailPage.bind(this, 5),
              videoUrl: module1573.default.CleanWashableFilterVideoUrl(),
              videoPosterUrl: module1573.default.CleanWashableFilterPosterUrl(),
              guideUrl: module1573.default.CleanWashableFilterGuideUrl(),
              short_separator: true,
              height_4s: 2390,
              height_6: 2410,
              height_6p: 2440,
            ...
            {
              title: module1573.default.GuideTitle5(),
              onPress: this.onOpenGuideDetailPage.bind(this, 6),
              videoUrl: module1573.default.Guide5VideoUrl(),
              videoPosterUrl: module1573.default.Guide5PosterUrl(),
              guideUrl: module1573.default.Guide5Url(),
              short_separator: true,
              height_4s: 2390,
              height_6: 2410,
              height_6p: 2440,
            ...
            {
              title: module1573.default.GuideTitle6(),
              onPress: this.onOpenGuideDetailPage.bind(this, 7),
              videoUrl: module1573.default.RoutineMaintenanceVideoUrl(),
              videoPosterUrl: module1573.default.RoutineMaintenancePosterUrl(),
              guideUrl: module1573.default.RoutineMaintenanceGuideUrl(),
              short_separator: true,
              height_4s: 4200,
              height_6: 4290,
              height_6p: 4410,
            ...
            {
              title: module1573.default.GuideTitle7(),
              onPress: this.onOpenGuideDetailPage.bind(this, 8),
              videoUrl: '',
              videoPosterUrl: '',
              guideUrl: module1573.default.TroubleshootingGuideUrl(),
