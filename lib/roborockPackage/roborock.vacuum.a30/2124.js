...
var regeneratorRuntime = require('regenerator-runtime'),
  ...
  c = null,
  module1265 = require('./1265').VideoError,
  v = (function () {
    function t() {
                ...
                for (;;)
                  switch ((f.prev = f.next)) {
                    case 0:
                      ...
                      f.prev = 2;
                      f.next = 5;
                      return regeneratorRuntime.default.awrap(module415.default.startCameraPreview(t));
                    ...
                    case 15:
                      ...
                      } else this.notifyVideoError(module1265.Video_StartPreviewFailed_unKnownReason, v);
                ...
                for (;;)
                  switch ((c.prev = c.next)) {
                    ...
                    case 7:
                      ...
                      c.prev = 8;
                      c.next = 11;
                      return regeneratorRuntime.default.awrap(module415.default.stopCameraPreview(t));
        ...
        },
        {
          ...
          value: function (t, n) {
            if (undefined == t) {
              ...
              return void this.notifyVideoError(module1265.Video_StartPreviewFailed_unKnownReason, n);
            }

            var o = module1265.Video_StartPreviewFailed_innerUnknowReason;

            switch (t) {
              case -10009:
                o = module1265.Video_StartPreviewFailed_passwordError;
                break;

              case -10010:
                o = module1265.Video_StartPreviewFailed_passwordErrorFrequently;
                break;

              case -10011:
                o = module1265.Video_StartPreviewFailed_robotInCharge;
                break;

              case -10012:
                o = module1265.Video_StartPreviewFailed_cameraStatusError;
                break;

              case -10013:
                o = module1265.Video_StartPreviewFailed_alreadyInPreview;
                break;

              case -10014:
                o = module1265.Video_StartPreviewFailed_requestTurnserverFailed;
                break;

              case -10015:
                o = module1265.Video_StartPreviewFailed_innerUnknowReason;
                break;

              case -10016:
                o = module1265.Video_StartPreviewFailed_robotIsDisconnecting;
                break;

              case -10021:
                o = module1265.Video_PreviewDustCollectionError;
            }
                ...
                for (;;)
                  switch ((s.prev = s.next)) {
                    case 0:
                      ...
                      this.notifyVideoError(module1265.Video_GetDeviceSdpFailed);
                      this.clearSdpTimer();
                    ...
                    case 5:
                      ...
                      s.next = 9;
                      return regeneratorRuntime.default.awrap(module415.default.getDeviceSdpInfo());
                ...
                for (;;)
                  switch ((s.prev = s.next)) {
                    case 0:
                      s.prev = 0;
                      s.next = 3;
                      return regeneratorRuntime.default.awrap(module415.default.getDeviceIceInfo());
                ...
                for (;;)
                  switch ((s.prev = s.next)) {
                    case 0:
                      ...
                      s.prev = 1;
                      s.next = 4;
                      return regeneratorRuntime.default.awrap(module415.default.getTurnServerInfo());
                ...
                for (;;)
                  switch ((o.prev = o.next)) {
                    ...
                    case 3:
                      ...
                      console.log('\u91cd\u8bd5\u6b21\u6570\u5df2\u8fbe\u4e0a\u9650 \u7ed3\u675f-------\u9700\u8981\u63d0\u793a\u7528\u6237');
                      this.notifyVideoError(module1265.Video_GetTurnServerFailed);
                      return o.abrupt('return');
