      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            module2010 = module1057.RoomTagInfo[this.state.selectTagKey] ? module1057.RoomTagInfo[this.state.selectTagKey].image : require('./2010'),
            u = {
            ...
            module2011 = module1057.DisplayRoomTag.map(function (o, s) {
            ...
            module2013 = this.state.showAllName ? require('./2012') : require('./2013'),
