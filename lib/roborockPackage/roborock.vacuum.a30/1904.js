  ...
  module1899 = (function (t) {
    ...
    module5.default(z, [
      ...
      },
      {
        ...
        value: function () {
          this.context.theme;
          var module1864 = React.default.createElement(module385.PureImageButton, {
            image: require('./1864'),
          ...
          this.props.navigation.setParams({
            ...
            rightItems: this.shouldShowShareButton ? [module1864] : [],
          });
        },
      },
      {
      ...
      },
      {
        ...
        value: function (t) {
          var n,
            ...
            s,
            c,
            u = module1905.parse(t, globals.app.state.theme != module515.Themes.light, module423.DMM.isSapphirePlus, module394.MC.sapMapBeautify),
            h = {
      ...
      },
      {
        key: 'render',
        value: function () {
          if (1 == this.props.navigation.state.params.status) require('./1898');
          else require('./1899');
          ...
          var t = this,
            ...
            c = module1563.utcTimeConvertToPhoneTimeZoneTime(1e3 * this.state.start),
            u = module1563.addZeroPrefix(c.month) + '/' + module1563.addZeroPrefix(c.day) + ' ' + module1563.addZeroPrefix(c.hour) + ':' + module1563.addZeroPrefix(c.minute),
            h = {
              marginHorizontal: 2,
              fontSize: 20,
          ...
          var q = [n.cleanHistory.gradSuccessLeft, n.cleanHistory.gradSuccessRight],
            module1898 = [n.cleanHistory.gradFailLeft, n.cleanHistory.gradFailRight],
            ...
            ie = React.default.createElement(
              ...
              globals.isRTL ? module1906 : te,
              globals.isRTL ? te : module1906
            ),
            module1907 = React.default.createElement(
              module12.TouchableWithoutFeedback,
              {
            ...
            module1906 = React.default.createElement(
              module12.TouchableWithoutFeedback,
              module22.default(
                {
                  onPress: this.onPressPlay.bind(this),
          ...
          if (this.state.uiStatus != J) {
            ...
            ie = React.default.createElement(
              ...
              globals.isRTL ? module1909 : module1907,
              se ? module1906 : module1908,
              globals.isRTL ? module1907 : module1909
            );
          }
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  {
                    colors: 1 == this.props.navigation.state.params.status ? q : module1898,
                    start: {
                      x: 0,
                      y: 0,
                    },
...
exports.default = module1899;
module1899.contextType = module1121.AppConfigContext;
