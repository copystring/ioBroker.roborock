...
var module505 = require('./505').strings,
  ...
  U = module1139.createSwitchNavigator(
    {
      KeyView: W ? module1965.default : module1963.default,
    },
    {
    ...
    module5.default(x, [
      {
        ...
        value: function () {
          ...
          var s = React.default.createElement(
            ...
            c = module393.isWindowDisplay ? module1317.titleBarContentHeight + 14 : module1317.titleBarContentHeight + module1265.StatusBarHeight + module1265.AppBarMarginTop,
            l = module391.default.iOSAndroidReturn(c, module1317.titleBarHeight);
      ...
      },
      {
        ...
        value: function () {
          ...
          module1410.readRemoteControlModeFlag(function (o) {
            if (o) {
              var n = parseInt(o);
      ...
      },
      {
        ...
        value: function () {
          ...
          module1410.saveRemoteControlModeFlag(this.state.activeControlViewIndex);
