...
var module398 = require('./398'),
  ...
  module1402 = require('./1402').getIndexPngBase64,
  module1405 = require('./1405').getCleanUpedWalls,
  module1401 = require('./1401'),
  D = module1401.convertFloorDataToImage,
  x = module1401.precessFurnitureData,
  M = {
    type: 2,
    header: 2,
    payload: 4,
...
function S(t, o, n) {
  ...
  for (var Ha in ((l.mapArea = Math.round((25 * h) / 1e4)), (l.left += f.left - 0.5), (l.top += f.top - 0.5), A))
    O[Ha] = 'data:image/png;base64,' + module1402(l.width, l.height, A[Ha]);
  ...
  return p(
    p(
      {
        image: 'data:image/png;base64,' + module1402(l.width, l.height, w),
        imageNoBlock: 'data:image/png;base64,' + module1402(l.width, l.height, x),
        imageBlockCleanBackground: 'data:image/png;base64,' + module1402(l.width, l.height, M),
        image3DBackground: 'data:image/png;base64,' + module1402(l.width, l.height, T),
        image3DBackgroundDark: 'data:image/png;base64,' + module1402(l.width, l.height, I),
      },
      l
    ),
    {},
...
function P(t, o) {
  ...
  return {
    image: 'data:image/png;base64,' + module1402(3 * f.width, 3 * f.height, s),
    capData: l,
    firstIndex: p,
    capCount: u,
  };
...
function B(t, o, n) {
  ...
  if (f && undefined !== f.top) {
    ...
    return p(
      {
        image: 'data:image/png;base64,' + module1402(6 * f.width, 6 * f.height, l),
      },
      f
    );
  }
