module.exports = {
  ...
  camera_setting_detail2: 'ReactiveAI Obstacle Avoidance',
  ...
  charger_type_name_o3: 'Auto-Empty Dock',
  ...
  unsave_map_alert_content:
    '"There is a big difference between current and saved maps. Continue using the saved map?\nChoose\xa0""No""\xa0to\xa0continue\xa0using\xa0the\xa0current\xa0map.\xa0The\xa0previous\xa0saved\xa0map\xa0will\xa0remain."',
  ...
  localization_strings_Setting_DoNotDisturbPage_8: 'Working Range',
  ...
  home_new_control_start_dry: 'Drying',
  ...
  map_edit_door_sill_slide: 'Sliding door thresholds',
  ...
  localization_strings_Setting_Supplies_Common_6: 'Door sills',
  map_edit_ignore: 'Ignore',
  map_edit_add_ai_zone: 'Add No-Go Zone',
  ...
  map_edit_stuck_zone_title2: 'Add no-go zones for entrapping areas',
  map_edit_stuck_zone_detail: 'The robot gets trapped here repeatedly. Add a no-go zone so the robot would go around.\n*If you don\u2019t want to do this, tap "Ignore".',
  map_edit_cliff_zone_title: 'Cliff as No-Go Zone',
  map_edit_cliff_zone_title2: 'Set a cliff as a no-go zone',
  ...
  setting_carpet_deep_clean_switch_desc: 'After Room Cleaning, the robot will seperately clean carpets in each room. *Not include mats.',
  ...
  ground_material_clean_direction_detail:
    'In Full Cleaning or Selective Room Cleaning, the robot will clean the floor along its direction to minimize scraping against the floor seams.\n*Set the floor material for this function to work. The robot can only clean in one direction."*Set the floor material for this function to work. The robot can only clean in one direction.',
  ...
  map_cliff_zone_guide_text: 'Cliff detected here repeatedly. No-go zone added automatically.',
  map_stuck_point_guide_text: 'The robot gets trapped here repeatedly. Add a no-go zone.',
  map_door_sill_guide_text: 'Threshold detected here. Add a threshold zone or purchase consumables for thresholds.',
  ...
  map_object_name_cat: 'Cats',
  map_object_name_dog: 'Dogs',
  map_object_name_curledfabric: 'Fabric/paper balls',
  auto_delivery_cleaning_fluid_title: 'Smart Filling',
  auto_delivery_cleaning_fluid_desc: 'Cleaning fluid is added automatically during mop wash and tank refill.',
  clean_route_fast_mode_guide_title: 'Light mode for better efficiency.',
  ...
  clean_route_fast_mode_is_work: 'Light mode',
  home_sepecial_tip_cleanmop_fastroute: 'Light mode | Single Use',
  livecall_autosoundoff_whenmoving_alerttitle: 'Call on the Move',
  livecall_autosoundoff_whenmoving_alertdesc: 'Start a call on the move. Muted by default. Unmute if necessary.',
  ...
  clean_route_setting_title: 'Route Preference',
  ...
  offline_map_guide_desc1:
    'The device will shut down automatically if left uncharged for more than 12 hours. Enabling Offline Map allows you to know where the device was before getting offline.',
  offline_map_guide_desc2: "*You'll be able to disable this function in Settings later.",
  offline_map_tips_title: 'Device Location Before Getting Offline',
  offline_map_tips_subtitle: 'The device was located here before getting offline. Place it back on the dock, and it will start up and connect to the network automatically.',
  upgrade_progress_view_title: 'OTA upgrade in progress',
