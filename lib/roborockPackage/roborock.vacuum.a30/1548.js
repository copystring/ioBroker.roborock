...
var M = React.forwardRef(function (t, o) {
    ...
    var L = [
        C(
          C({}, module1547.getCleanButtonConfig(M, u)),
          {},
          {
        ...
        C(
          C({}, module1547.getMopButtonConfig(O, u)),
          {},
          {
        ...
        C(
          C({}, module1547.getCleanMopButtonConfig(y, u)),
          {},
          {
      ...
      G = [
        C(
          C({}, module1547.getChargeButtonConfig(R, u)),
          {},
          {
            onPress: V,
        ...
        C(
          C({}, module1547.getWashingDusterButtonConfig(v, u)),
          {},
          {
