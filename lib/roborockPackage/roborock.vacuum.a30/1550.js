...
var y = React.forwardRef(function (t, o) {
    var l = React.useContext(module1121.AppConfigContext).theme,
      C = t.cleanIconMode,
      module1551 = undefined === C ? 'start' : C,
      _ = t.dockIconMode,
    ...
    var G = [
        S(
          S({}, module1547.getNewCollectButtonConfig(P, l)),
          {},
          {
        ...
        S(
          S({}, module1547.getNewWashButtonConfig('start', l)),
          {},
          {
      ...
      K = S(
        S({}, module1547.getNewDryButtonConfig(D, l)),
        {},
        {
    ...
    var V = module12.Dimensions.get('window').width,
      ...
      Q = S(
        S({}, module1547.getDockButtonConfig(x, l)),
        {},
        {
      ...
      Y = S(
        S({}, module1547.getCleanButtonConfig(module1551, l)),
        {},
        {
