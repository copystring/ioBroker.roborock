          ...
          for (;;)
            switch ((N.prev = N.next)) {
              ...
              case 6:
                ...
                k = '02.36.46';
                M = '02.04.74';
                R = module423.DMM.isTopazSV && module391.RRFirmwareVersionCompare(s, k) < 0 && module423.DMM.isV1;
                v = module423.DMM.isTanosSL && module391.RRFirmwareVersionCompare(s, M) <= 0 && module423.DMM.isV1;
                if (module423.DMM.isTopazSV && 0 == module391.RRFirmwareVersionCompare(s, k) && module423.DMM.isV1) w = false;
              ...
              case 22:
                ...
                V = '4.1.5_3246';
                P = '4.1.5_0474';
                F = module423.DMM.isTopazSV && module391.MIFirmwareVersionCompare(null != (S = y.curVersion) ? S : '', V) <= 0 && module423.DMM.isV1;
                T = module423.DMM.isTanosSL && module391.MIFirmwareVersionCompare(null != (b = y.curVersion) ? b : '', P) <= 0 && module423.DMM.isV1;
                x = y.hasNewFirmware;
