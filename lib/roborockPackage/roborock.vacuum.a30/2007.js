  ...
  j = (function (t) {
    ...
    function T(t) {
          ...
          function (s) {
            for (;;)
              switch ((s.prev = s.next)) {
                case 0:
                  if ((p = null == (t = module414.MM.mapData) ? undefined : null == (o = t.map) ? undefined : o.colorData) && 'object' == typeof p) {
                    s.next = 3;
                    break;
                  }
                ...
                case 3:
                  if (((f = module423.DMM.isGarnet ? 1 : 0), (M = []), (h = []), module414.MM.roomNameMapping && module414.MM.roomNameMapping.length > 0))
                    for (v = module414.MM.roomNameMapping.concat(), w = 0; w < v.length; w++)
                      3 == v[w].length &&
                        v[w][2] > 0 &&
                        ((C = v[w][0]),
                        (y = v[w][2]),
                        (b = module1057.RoomTagInfo[y]) &&
                          'object' == typeof b &&
                          ((k = {
                            segment: parseInt(C),
                          }),
                          ...
                          M.push(k),
                          h.push(C)));
                  x = null == (l = module414.MM.mapData) ? undefined : null == (c = l.floorMap) ? undefined : c.data;
              ...
              switch ((l.prev = l.next)) {
                case 0:
                  try {
                    ...
                    if (!(null == (t = globals.Alert))) t.alert('', module505.reset_clean_mode_prompt, [o, u]);
                  } catch (t) {
      ...
      n.onPressSmartModeButton = function () {
        ...
        globals.Alert.alert(module505.map_edit_mode_smart_tip, '', [t, o]);
      };
      ...
      n.onPressCancelButtonForCustom = function () {
        ...
        n.cleanWaterModeMaps = module414.MM.customCleanModes;
      ...
      n.cleanWaterModeMaps = module414.MM.customCleanModes;
      n.originalCleanWaterModeMaps = module414.MM.customCleanModes;
    ...
    module5.default(T, [
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = module1271.default.guideButton(this.onNavigationGuidePress, function (n) {
              t.guideButton = n;
            }),
            o = module1271.default.confirmButton(this.onNavigationSavePress, false, function (n) {
              t.mapSaveButton = n;
            }),
            s = this.showSmartMenu ? [n] : [o];
          module1271.default.setNavigation(this, globals.isRTL ? s.reverse() : s, this.onNavigationBackPress.bind(this));
        },
      },
      {
        key: 'initMapView',
        value: function () {
          var t, n;
          if (!(null == (t = this.mapView))) t.setState(W({}, module414.MM.mapData));
          if (!(null == (n = this.mapView))) n.setAllCleanMopMode(module414.MM.customCleanModes);
        },
      },
      {
            ...
            function (u) {
              for (;;)
                switch ((u.prev = u.next)) {
                  ...
                  case 2:
                    t = module419.StorageKeys.CustomModebyGuide;
                    u.next = 5;
                  ...
                  case 10:
                    module1340.setTimeout(function () {
                      ...
                      if (o.showSmartMenu) null == (n = o.editMenu) || n.showSmartCustomGuide(module505.smart_custom_mode_guide_tip_text);
                    }, 50);
      ...
      },
      {
        ...
        value: function () {
          ...
          this.cleanModeListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.DidReceiveSpecialEvent, function (t) {
            if (t.data == module419.EventKeys.SegmentCustomModeDidReceive && n) n.setAllCleanMopMode(module414.MM.customCleanModes);
          });
            ...
            function (n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  ...
                  case 2:
                    t = module414.MM.customCleanModes;
                    module387.LogEventStatus('custom_mode_info', {
                      mode: module414.MM.customCleanModes,
                    });
            ...
            function (n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  ...
                  case 7:
                    this.cleanWaterModeMaps = module414.MM.customCleanModes;
                    this.originalCleanWaterModeMaps = module414.MM.customCleanModes;
                    n.next = 13;
                    break;
          ...
          return regeneratorRuntime.default.async(
            function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    if (module390.default.isSupportCustomModeInCleaning()) module1271.default.endEditMap();
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    o.prev = 1;
                    o.next = 4;
                    return regeneratorRuntime.default.awrap(module415.default.setCustomCleanMode(this.cleanWaterModeMaps));
      ...
      },
      {
        ...
        value: function () {
          ...
          if (!module382.isModeCustomized(o, u, l)) {
            ...
            if (!(null == (c = globals.Alert))) c.alert('', module505.custom_mode_sync_title, [p]);
            return false;
          }
              ...
              for (;;)
                switch ((u.prev = u.next)) {
                  case 0:
                    ...
                    u.next = 7;
                    return regeneratorRuntime.default.awrap(module415.default.setCleanMopMode(t, n, o));
                  ...
                  case 10:
                    ...
                    u.next = 13;
                    return regeneratorRuntime.default.awrap(module415.default.setCleanMotorMode(t, n));
                  ...
                  case 15:
                    u.next = 17;
                    return regeneratorRuntime.default.awrap(module415.default.setCustomMode(t));

                  case 17:
                    u.next = 19;
                    return regeneratorRuntime.default.awrap(module415.default.setWaterBoxMode(n));
      ...
      },
      {
        ...
        value: function (t) {
          var n = this.cleanWaterModeMaps.find(function (n) {
            ...
            o = module423.DMM.isGarnet ? (null == n ? undefined : n.mop_template_id) : (null == n ? undefined : n.mop_mode) || 300;
            ...
            function (p) {
              for (;;)
                switch ((p.prev = p.next)) {
                  ...
                  case 5:
                    p.next = 7;
                    return regeneratorRuntime.default.awrap(module415.default.setCustomCleanMode([]));
                  ...
                  case 17:
                    ...
                    p.next = 27;
                    return regeneratorRuntime.default.awrap(module415.default.setCleanMopMode(o, u, l));
                  ...
                  case 29:
                    ...
                    p.next = 32;
                    return regeneratorRuntime.default.awrap(module415.default.setCleanMotorMode(o, u));
                  ...
                  case 36:
                    p.next = 38;
                    return regeneratorRuntime.default.awrap(module415.default.setWaterBoxMode(u));
                  ...
                  case 40:
                    p.next = 42;
                    return regeneratorRuntime.default.awrap(module419.SetStorageKey(module419.StorageKeys.WaterMode, u + ''));

                  case 42:
                    p.next = 44;
                    return regeneratorRuntime.default.awrap(module419.SetStorageKey(module419.StorageKeys.MopMode, l + ''));
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module1271.default.isEditedByArrays(this.originalCleanWaterModeMaps, this.cleanWaterModeMaps)) {
            var n,
              o = {
        ...
        value: function () {
          var t = this,
            ...
            o = React.default.createElement(module1055.MapView, {
              ...
              inBlockMode: true,
              hideAccessory: true,
              blockBubbleShowInfo: module1055.BlockBubbleShowInfo.DISPLAYNAME | module1055.BlockBubbleShowInfo.CLEANMODE,
              selectedBlocksDidChange: this.handleSelectedBlocksDidChange,
              didTapBlockInCustomMode: this.didTapBlockInCustomMode,
            }),
            s = React.default.createElement(module1120.default, {
              type: module1120.MenuType.Menu_Mode,
              ref: function (n) {
                return (t.editMenu = n);
              },
              onPressGuideButton: this.onNavigationGuidePress,
            }),
            u = React.default.createElement(module1120.default, {
              type: module1120.MenuType.Menu_Mode_Smart,
              ref: function (n) {
                return (t.editMenu = n);
              },
              hasConfirmMenu: true,
          ...
          var f = this.state.isResetCustomModeEnable,
            M = module1271.default.resetButton(module505.reset_clean_mode_button_title, f, this.onResetButtonPressed);
