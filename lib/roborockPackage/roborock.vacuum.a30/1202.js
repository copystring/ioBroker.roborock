...
exports.default = function (t) {
  ...
  var c = module1139.SwitchRouter(t, n);
  return l(
    l({}, c),
    {},
    {
      getActionCreators: function (t, n) {
        return l(
          {
            openDrawer: function () {
              return module1203.default.openDrawer({
                key: n,
              });
            },
            closeDrawer: function () {
              return module1203.default.closeDrawer({
                key: n,
              });
            },
            toggleDrawer: function () {
              return module1203.default.toggleDrawer({
                key: n,
              });
            },
          },
      ...
      getStateForAction: function (t, n) {
        ...
        if (null == t.key || t.key === n.key) {
          if (t.type === module1203.default.DRAWER_CLOSED)
            return l(
              l({}, n),
              {},
              {
          ...
          if (t.type === module1203.default.DRAWER_OPENED)
            return l(
              l({}, n),
              {},
              {
          ...
          if (t.type === module1203.default.CLOSE_DRAWER)
            return l(
              l({}, n),
              {},
              {
          ...
          if (t.type === module1139.NavigationActions.BACK && n.isDrawerOpen)
            return l(
              l({}, n),
              {},
              {
          ...
          if (t.type === module1203.default.OPEN_DRAWER)
            return l(
              l({}, n),
              {},
              {
          ...
          if (t.type === module1203.default.TOGGLE_DRAWER)
            return l(
              l({}, n),
              {},
              {
