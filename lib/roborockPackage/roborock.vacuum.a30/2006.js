    ...
    function V(t) {
      ...
      (n = L.call(this, t)).gotoZoneInfoPage = function () {
        n.props.navigation.navigate('MapEditZoneInfoPage', {
          ...
          initAction: module1120.EditAction.Name,
        });
      };

      n.setSmartOrderForTag = function () {
        var t = module414.MM.roomNameMapping;
              ...
              switch ((c.prev = c.next)) {
                case 0:
                  try {
                    ...
                    if (!(null == (t = globals.Alert))) t.alert('', module505.reset_order_prompt, [s, u]);
                  } catch (t) {
                    n.endLoading();
                  }
      ...
      n.onPressSmartOrderButton = function () {
        ...
        if (n.showSmartMenu) {
          var s = module414.MM.checkAllRoomTagged(),
            o = s ? module505.map_edit_order_smart_tip : module505.map_edit_mode_smart_tip_detail,
            u = {
              text: module505.localization_strings_Main_MainPage_11,
            },
            c = {
      ...
      n.selectedSegements = module414.MM.cleanSequence.concat();
      n.blockOperated = false;
      n.originalSelectedSegements = module414.MM.cleanSequence.concat();
    ...
    module5.default(V, [
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            s = module1271.default.confirmButton(this.onNavigationSavePress, false, function (n) {
              t.mapSaveButton = n;
            }),
            o = this.showSmartMenu ? [n] : [s];
          module1271.default.setNavigation(this, globals.isRTL ? o.reverse() : o, this.onNavigationBackPress.bind(this));
        },
      },
      {
        key: 'initMapView',
        value: function () {
          var t;
          if (!(null == (t = this.mapView))) t.setState(N({}, module414.MM.mapData));
        },
      },
      {
        key: 'initShowSmartSet',
        value: function () {
          return !!module390.default.isSupportRoomTag() && (!!module414.MM.checkAllRoomTagged() || !module391.default.isShareUser());
        },
      },
      {
            ...
            function (u) {
              for (;;)
                switch ((u.prev = u.next)) {
                  ...
                  case 2:
                    t = module419.StorageKeys.CleanSequencebyGuide;
                    u.next = 5;
                  ...
                  case 10:
                    module1340.setTimeout(function () {
                      ...
                      if (s.showSmartMenu) null == (n = s.editMenu) || n.showSmartCustomGuide(module505.smart_custom_order_guide_tip_text);
                    }, 50);
      ...
      },
      {
        ...
        value: function () {
          ...
          this.cleanSequenceListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.DidReceiveSpecialEvent, function (n) {
            var s;
            if (n.data == module419.EventKeys.CleanSequenceDidReceive) null == (s = t.mapView) || s.setCleanSequence(module414.MM.cleanSequence.concat(), true);
          });
        },
      },
      {
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    ...
                    this.startLoading();
                    n.next = 4;
                    return regeneratorRuntime.default.awrap(module415.default.setCleanSequence([]));
      ...
      },
      {
        ...
        value: function () {
          ...
          if (this.checkAllSegmentsOrdered()) this.saveCleanOrder();
            ...
            if (!(null == (n = globals.Alert))) n.alert('', module505.clean_sequence_not_set_for_all_segments_tip, [s, u]);
          }
        },
      },
      {
              ...
              for (;;)
                switch ((u.prev = u.next)) {
                  ...
                  case 5:
                    ...
                    this.startLoading();
                    u.next = 10;
                    return regeneratorRuntime.default.awrap(module415.default.setCleanSequence(this.selectedSegements));
            ...
            function (n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  ...
                  case 7:
                    this.selectedSegements = module414.MM.cleanSequence.concat();
                    this.originalSelectedSegements = module414.MM.cleanSequence.concat();
                    n.next = 13;
                    break;
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module1271.default.isEditedByArrays(this.originalSelectedSegements, this.selectedSegements)) {
            var n,
              s = {
            ...
            if (!(null == (n = globals.Alert))) n.alert(module505.map_edit_save_current_action, '', [s, o]);
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            s = React.default.createElement(module1055.MapView, {
              ref: function (n) {
                t.mapView = n;
              },
              ...
              inBlockMode: true,
              hideAccessory: true,
              blockBubbleShowInfo: module1055.BlockBubbleShowInfo.CLEANSEQUENCE | module1055.BlockBubbleShowInfo.DISPLAYNAME,
            ...
            o = React.default.createElement(module1120.default, {
              type: module1120.MenuType.Menu_Order,
              ref: function (n) {
                return (t.editMenu = n);
              },
            ...
            u = React.default.createElement(module1120.default, {
              type: module1120.MenuType.Menu_Order_Smart,
              ref: function (n) {
                return (t.editMenu = n);
              },
              hasConfirmMenu: true,
          ...
          var h = module1271.default.resetButton(module505.reset_order_button_title, this.state.isResetOrderEnable, this.onResetButtonPressed);
          return React.default.createElement(
            ...
            React.default.createElement(module1268.default, {
              ...
              topTitle: module505.map_edit_bottom_menu_order_title,
              context: module505.map_edit_bottom_menu_order_info1,
