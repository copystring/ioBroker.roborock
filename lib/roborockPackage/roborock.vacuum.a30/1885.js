...
exports.taskMethodToMode = function (t) {
  switch (t) {
    case 'do_scenes_app_start':
      return module1886.SmartSceneMode.GlobalClean;

    case 'do_scenes_segments':
      return module1886.SmartSceneMode.Segment;

    case 'do_scenes_zones':
      return module1886.SmartSceneMode.Zone;
  }
};
...
var v = (function () {
  function t(o, s, c, u, _) {
    ...
    this.mode = u || module1886.SmartSceneMode.GlobalClean;
    this.repeat = _ || 0;
    this.segments = h;
    this.zones = p;
    this.id = S;
...
var T = [
  new v(102, 202, 300, module1886.SmartSceneMode.GlobalClean, 1),
  new v(103, 203, 301, module1886.SmartSceneMode.Segment, 2),
  new v(104, 203, 301, module1886.SmartSceneMode.Zone, 3),
];
exports.TestTasks = T;
var w = [new v(102, 202, 300, module1886.SmartSceneMode.GlobalClean, null, null, null, 1)],
  k = [new v(102, 202, 300, module1886.SmartSceneMode.Segment, 1, null, null, 1, null, null, _.map_edit_zone_tag_kitchen + ' ' + _.map_edit_zone_tag_diningroom)],
  b = [new v(102, 200, 300, module1886.SmartSceneMode.GlobalClean, null, null, null, 1), new v(105, 202, 300, module1886.SmartSceneMode.GlobalClean, null, null, null, 2)],
