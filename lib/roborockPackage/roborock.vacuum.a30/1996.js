...
var module505 = require('./505').strings,
  ...
  M = (function (t) {
    ...
    function module1998(t) {
      var n;
      module4.default(this, module1998);
      ...
      n.getShowOccurTime = function () {
        return null == n.state.occurHour || null == n.state.occurMinute
          ? '\u672a\u8bbe\u7f6e'
          : module1563.addZeroPrefix(n.state.occurHour) + ':' + module1563.addZeroPrefix(n.state.occurMinute);
      };
    ...
    module5.default(module1998, [
      ...
      },
      {
        ...
        value: function (t) {
          ...
          var n = module1563.utcTimeConvertToPhoneTimeZoneTime(1e3 * t);
          return [module1563.addZeroPrefix(n.month), module1563.addZeroPrefix(n.day), module1563.addZeroPrefix(n.hour), module1563.addZeroPrefix(n.minute)];
        },
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module12.FlatList, {
              ...
              horizontal: true,
              ListFooterComponent: module1997,
            })
          );
        },
      },
