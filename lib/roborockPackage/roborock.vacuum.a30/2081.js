...
var module393 = require('./393'),
  module2122 = module393.monitorAllowed() ? require('./2122').default : module12.View,
    ...
    module5.default(X, [
      {
        ...
        value: function () {
          ...
          module1419.default.shared().popGestureEnabled = false;
      ...
      },
      {
        ...
        value: function () {
          ...
          this.statusListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.RobotStatusDidUpdate, function (n) {
            ...
            if (module381.RSM.bumperLeft) t.showTip(le[module2109.DirectionLeft]);
            if (module381.RSM.bumperRight) t.showTip(le[module2109.DirectionRight]);
            if (module381.RSM.bumperMiddle) t.showTip(le[module2109.DirectionMiddle]);
            if (module381.RSM.obstacleLeft) t.showTip(ue[module2109.DirectionLeft]);
            if (module381.RSM.obstacleRight) t.showTip(ue[module2109.DirectionRight]);
            if (module381.RSM.obstacleMiddle) t.showTip(ue[module2109.DirectionMiddle]);
          ...
          this.gotoFailListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.EventToastChange, function (o) {
            if ('target_not_reachable' == o.data) t.showTip(module1557.getToast()[o.data][0]);
          });
      ...
      },
      {
        ...
        value: function (t) {
          var o = this,
            ...
            u = React.default.createElement(module2122, {
              ref: function (t) {
            ...
            module1847 = React.default.createElement(
              module12.View,
              {
                style: [
                  pe.video,
          ...
          return module393.monitorAllowed() ? module391.default.iOSAndroidReturn(h, u) : module1847;
        },
      },
      {
        key: 'didRecieveMsg',
      ...
      },
      {
        ...
        value: function (t) {
          var o = this;
          return React.default.createElement(module2087.default, {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          return React.default.createElement(module2103.default, {
            ref: function (t) {
      ...
      },
      {
        ...
        value: function (t) {
          var o = this;
          return React.default.createElement(module2102.default, {
            isPortrait: t,
            ref: function (t) {
              return (o.gotoView = t);
            },
      ...
      },
      {
        key: 'getRecordView',
        value: function () {
          return React.default.createElement(module2112.default, {
            style: pe.recordView,
            isLandscape: true,
            didOperate: this._userDidOperate.bind(this),
            alertOwner: this,
      ...
      },
      {
        ...
        value: function () {
          return React.default.createElement(module2111.default, {
            isLandscape: false,
            alertOwner: this,
          });
        },
      },
      {
        key: 'getCallView',
        value: function (t) {
          return React.default.createElement(module2118.default, {
            style: pe.callView,
            isLandscape: t,
            calling: this.state.calling,
          ...
          return React.default.createElement(
            ...
            module390.default.isVideoLiveCallSupported() &&
              ...
              React.default.createElement(module385.PureImageButton, {
                ...
                image: this.state.robotMic ? require('./2096') : require('./2097'),
                imageWidth: 30,
                imageHeight: 30,
                onPress: function () {
                  return t.soundOff();
        ...
        value: function () {
          ...
          if (this.isMonitoring && this.videoView)
            this.videoView.startRecordVideo(function (o) {
              if (o) {
                module2090.timeTool.startRecordTime();
                t.setState({
            ...
            n = function () {
              ...
              if (o.state.screenRecording) {
                module387.LogEventStatus('screen_recording_duration', {
                  duration: module2090.timeTool.getRecordSpan(),
                });
                module2090.timeTool.cancleRecord();
                o.setState({
      ...
      },
      {
        ...
        value: function (t) {
          var o = t == module2101.PortraitActionCall;

          if (t == module2101.PortraitActionRemote || o) {
            module387.LogEventCommon(t == module2101.PortraitActionRemote ? 'tap_remote_control_tab' : 'tap_voice_tab');
            if (o && module390.default.isVideoLiveCallSupported()) this.handleLiveCall();
            else this.togglePortaitPopup(t);
          } else if (t == module2101.PortraitActionRecord) this.handleScreenCast();
          else if (t == module2101.PortraitActionShortcut) this.screenShot();
        },
      },
      {
        key: 'showNotReadyTip',
                ...
                switch ((t.prev = t.next)) {
                  case 0:
                    ...
                    module387.LogEventStatus('call_duration', {
                      duration: module2090.timeTool.getSpan(),
                    });
                    this.cancleLiveCall();
      ...
      },
      {
        ...
        value: function (t) {
          var o = this,
            n = t == module2101.PortraitActionRemote;
          this.setState(
            {
            ...
            function () {
              module12.Animated.spring(o.animatedPortraitPopupViewHeight, {
                toValue: re() - (ge() + se + he + module2101.FuncTabBackgroundHeight - 15),
                duration: 800,
              }).start();
            }
          );
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module2101.PortraitActionMenu, {
              isRemoteActive: c,
              isScreenCasting: l,
              isLiveCall: u,
            ...
            React.default.createElement(
              module12.View,
              {
                style: [
                  ...
                  {
                    width: ne(),
                    height: re() - ge() - se - he - module2101.FuncTabBackgroundHeight + 15,
                  },
                ],
              },
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            o &&
              React.default.createElement(module2082.default, {
                style: [pe.actionMenu],
                ref: function (o) {
            ...
            n && (module381.RSM.bumperMiddle || module381.RSM.obstacleMiddle)
              ? React.default.createElement(module2109.BumperView, {
                  direction: module2109.DirectionMiddle,
                })
              : null,
            n && (module381.RSM.bumperLeft || module381.RSM.obstacleLeft)
              ? React.default.createElement(module2109.BumperView, {
                  direction: module2109.DirectionLeft,
                })
              : null,
            n && (module381.RSM.bumperRight || module381.RSM.obstacleRight)
              ? React.default.createElement(module2109.BumperView, {
                  direction: module2109.DirectionRight,
                })
              : null,
            React.default.createElement(module385.AlertView, {
              ref: function (o) {
            ...
            module390.default.isRecordAllowed() && module393.isRecordSupported() && 2 == module393.iotType
              ? React.default.createElement(module2110.default, {
                  ref: function (o) {
            ...
            this.state.shouldShowRecordToast && !module390.default.isVideoLiveCallSupported()
              ? React.default.createElement(module2116.default, {
                  ref: function (o) {
...
exports.default = module2126;
module2126.contextType = module1121.AppConfigContext;
module2126.navigationOptions = {
  header: null,
};
