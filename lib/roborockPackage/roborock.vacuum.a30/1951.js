  ...
  D = (function (t) {
    ...
    function O(t) {
      ...
      (o = D.call(this, t)).state = {
        monitorEnabled: module1558.default.realTimeMonitorEnabled,
        videoSetting: module1558.default.realVideoSetting,
      ...
      },
      {
        ...
        value: function () {
          ...
          this.props.navigation.navigate('WebViewPage', {
            ...
            refrence: module1573.default.MonitorPrivacy(),
            buttonTitle: module1558.default.monitorPrivacyPolicyAgreed ? module505.reset_authoration : module505.button_title_agree,
            buttonColor: module1558.default.monitorPrivacyPolicyAgreed ? 'red' : '#007aff',
            buttonAction: function (o) {
              if (module381.RSM.isRunning && module1558.default.monitorPrivacyPolicyAgreed)
                o.alertView &&
                ...
                var n = function () {
                  ...
                  module1558.default.updateMonitorPrivacy(!module1558.default.monitorPrivacyPolicyAgreed, function (n) {
                    if (
                      ...
                      if ('' != (l = module1558.default.monitorPrivacyPolicyAgreed ? '' : module505.map_object_cancel_privacy_success)) globals.showToast(l);
                      o.props.navigation.setParams({
                        buttonTitle: module1558.default.monitorPrivacyPolicyAgreed ? module505.reset_authoration : module505.button_title_agree,
                        buttonColor: module1558.default.monitorPrivacyPolicyAgreed ? 'red' : '#007AFF',
                      });
                      module387.LogEventCommon(module1558.default.monitorPrivacyPolicyAgreed ? 'accept_monitor_privacy' : 'reset_monitor_privacy_confirm');
                    } else {
                      var l = module1558.default.monitorPrivacyPolicyAgreed ? module505.map_object_cancel_privacy_timeout : module505.map_object_ignore_failed;
                      globals.showToast(l);
                    }
                  });
                };

                if (module1558.default.monitorPrivacyPolicyAgreed) {
                  if (o.alertView)
                    o.alertView.customAlert(
                ...
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    return regeneratorRuntime.default.awrap(
                      module393.postPrivacyAgreementStatus(module381.RobotStatusManager.sharedManager().serverCode, module1558.default.monitorPrivacyPolicyAgreed ? 3 : 2)
                    );
                              ...
                              for (;;)
                                switch ((n.prev = n.next)) {
                                  case 0:
                                    ...
                                    module1558.default.realTimeMonitorEnabled = t;
                                    n.next = 4;
      ...
      },
      {
        ...
        value: function () {
          ...
          var l = this.getMenus().map(function (t, o) {
            ...
            s = {
              title: module505.setting_realtime_monitor_switch_title,
              detail: module1558.default.realTimeMonitorEnabled ? module505.setting_camera_on : module505.setting_camera_off,
              detailColor: module1558.default.realTimeMonitorEnabled ? '#007AFF' : this.context.theme.settingListItem.disableColor,
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module1849.MonitorPrivacyDialogWithNavbar, {
              ref: function (o) {
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    o = 0 == t;
                    n.next = 3;
                    return regeneratorRuntime.default.awrap(module1558.default.updatePetModeEnabled(o));

                  case 3:
                    this.setState({
                      petModeEnabled: module1558.default.petModeEnabled,
                    });
