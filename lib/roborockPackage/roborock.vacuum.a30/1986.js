...
var module505 = require('./505').strings,
  ...
  module1987 = (function (t) {
    ...
    function R(t) {
      ...
      (o = module1987.call(this, t)).state = {
        titleSelected: module1558.default.realVideoSetting,
      };
      o.isChanging = false;
      return o;
    }
      ...
      },
      {
        ...
        value: function () {
          var t = this.context.theme,
            o = this.getMenus().map(function (t, module1987) {
              return t.visible
                ? t.title
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (!this.isChanging) {
            ...
            module1558.default.updateRealTimeVideoSetting(t, function (l) {
              o.isChanging = false;
