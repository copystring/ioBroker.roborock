...
function u(t) {
  ...
  return {
    type: t.type === module2059.NetInfoStateType.vpn || t.type === module2059.NetInfoStateType.other ? 'unknown' : t.type,
    effectiveType: o,
  };
}

function f(o) {
  if ('android' === module12.Platform.OS) return o.type !== module2059.NetInfoStateType.none && o.type !== module2059.NetInfoStateType.unknown && o.details.isConnectionExpensive;
