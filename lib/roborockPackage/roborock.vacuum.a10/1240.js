...
var module1245 = require('./1245'),
  z = 2 * module1233.buttonConfig.rectDelete.size.width,
  D = z / 2 - module1233.buttonConfig.rectOperateBoarderDis,
  T = z / 2,
  V = (function (t) {
    module7.default(V, t);
    ...
    module5.default(V, [
      ...
      },
      {
        ...
        value: function () {
          ...
          this.panProxy = new module1241.PanResponderProxy(module1241.RectPanType.PanTypeMove | module1241.RectPanType.PanTypeScale);
        ...
        value: function (t, n) {
          ...
          return this.state.isFocus
            ? React.default.createElement(module12.View, {
                ...
                style: {
                  position: 'absolute',
                  left: z / 2 - module1233.buttonConfig.rectOperateBoarderDis - 1,
                  top: z / 2 - module1233.buttonConfig.rectOperateBoarderDis - 1,
      ...
      },
      {
        ...
        value: function () {
          ...
          var t = this.context.theme.displayZones,
            o = module1245._convertToPixelRect(this.state.rectSize, this.props.transform);
          ...
          var s = o.width + z,
            ...
            P = this.state.isFocus
              ? React.default.createElement(module1254.RectButton, {
                  ...
                  left: z / 2 - (1.5 * module1233.buttonConfig.rectDelete.size.width) / 2 - module1233.buttonConfig.rectOperateBoarderDis,
                  top: z / 2 - (1.5 * module1233.buttonConfig.rectDelete.size.height) / 2 + 1 - module1233.buttonConfig.rectOperateBoarderDis,
            ...
            x = this.state.isFocus
              ? React.default.createElement(module1254.RectButton, {
                  ...
                  left: o.width - (1.5 * module1233.buttonConfig.rectScale.size.width) / 2 - 1 + z / 2 + module1233.buttonConfig.rectOperateBoarderDis,
                  top: o.height - (1.5 * module1233.buttonConfig.rectScale.size.height) / 2 - 2 + z / 2 + module1233.buttonConfig.rectOperateBoarderDis,
...
var F = module12.StyleSheet.create({
  ...
  serialView: {
    ...
    left: D,
    bottom: 0,
    width: module1233.buttonConfig.rectSerial.size.width,
    height: module1233.buttonConfig.rectSerial.size.height,
    overflow: 'visible',
    alignItems: 'flex-start',
    justifyContent: 'center',
