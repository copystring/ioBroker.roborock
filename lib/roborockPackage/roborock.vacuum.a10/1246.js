  ...
  P = (function (t) {
    ...
    function w(t) {
      ...
      n.handleFBZPanStart = function (t, s) {
        var o,
          l = null;
        if (
          (t == module1233.FbzType.FBZ_TYPE_CARPET
            ? (n._setCarpetZonesFocus(n.fbzReferences, s), (l = n.fbzReferences))
            : t == module1233.FbzType.RECT_TYPE_CARPET && (n._setCarpetZonesFocus(n.customReferences, s), (l = n.customReferences)),
          l)
        )
    ...
    module5.default(w, [
        ...
        value: function (t, n, s) {
          for (
            var o = this,
              ...
              f = 1;
            f <= module1233.MAX_COUNT_WALL_OR_FBZ;
            f++
          ) {
            var p = c(f);
      ...
      },
      {
        ...
        value: function (t) {
          var n = t ? this.customReferences : this.fbzReferences;
          return this._getVisibleZonesCount(n) >= module1233.MAX_COUNT_WALL_OR_FBZ;
        },
      },
      {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          for (var o = this._getRotateMaxRectSize(s[0]), l = 1; l <= module1233.MAX_COUNT_WALL_OR_FBZ; l++)
      ...
      },
      {
        ...
        value: function () {
          ...
          for (var o = 0; o < s.length; o++) {
            ...
            if (module1245._isVerticalRotate((180 * u) / Math.PI)) {
      ...
      },
      {
        ...
        value: function (t) {
          var n = t.rectSize,
            ...
            l = n.x + n.width / 2,
            u = n.y + n.height / 2,
            c = module1245._parseDegPoint(n.x - l, n.y - u, o),
            f = module22.default(c, 2),
            p = f[0],
            h = f[1],
            v = module1245._parseDegPoint(n.x - l, n.y + n.height - u, o),
      ...
      },
      {
        ...
        value: function () {
          var t = new E({
            ...
            n = this.props.mapMode == module934.MAP_MODE_CARPET_EDIT && !module377.RSM.isRunning,
          ...
          return React.default.createElement(
            ...
            this.getCarpetZoneView(module1233.FbzType.RECT_TYPE_CARPET, this.customReferences, t, o && n),
            n && s && this.getCarpetZoneView(module1233.FbzType.FBZ_TYPE_CARPET, this.fbzReferences, t, true)
          );
        },
      },
    ]);
