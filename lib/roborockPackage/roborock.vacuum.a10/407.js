  ...
  return new Promise(function (c, _) {
    s(t, n, o, function (o, s) {
      if (o && s && s.result && 'unknown_method' != s.result) {
        module409.Log.log(module409.LogTypes.RPC, t + ' - ' + ('object' == typeof n ? JSON.stringify(n) : n) + ' - ' + JSON.stringify(s), module409.InfoColors.Success, true);
        c(s);
      } else {
        module409.Log.log(
          module409.LogTypes.RPC,
...
function M(t, n, s) {
  var c = {
    ...
    f = module408.default.encode(JSON.stringify(c)),
    l = {
  ...
  console.log('miSpec', t, JSON.stringify(l));
  return new Promise(function (s, c) {
    module389.Service.spec
      .doAction(l)
      .then(function (_) {
        if ((console.log('miSpec', _), _.out)) {
          var p = JSON.parse(module408.default.decode(_.out[0])),
            f = p.result && 'unknown_method' != p.result;
          module409.Log.log(
            module409.LogTypes.RPC,
            'spec ' + t + ' - ' + ('object' == typeof n ? JSON.stringify(n) : n) + ' - ' + JSON.stringify(p),
            module409.InfoColors.Success,
            true
          );
          if (f) s(p);
          else
          ...
          module409.Log.log(module409.LogTypes.RPC, 'spec error missing out field', module409.InfoColors.Fail, true);
          c('spec error missing out field');
        }
      })
      .catch(function (n) {
        module409.Log.log(module409.LogTypes.RPC, 'spec error ' + t + ' - ' + ('object' == typeof n ? JSON.stringify(n) : n), module409.InfoColors.Fail, true);
        c({
          error: 'spec error: ' + t,
...
function S(t, n, o) {
  if ((p++, !(module386.default.isRPCRetrySupported() && 'retry_request' != t))) return module389.isSpecSupported() ? M(t, n) : l(t, n, o, module389.callMethod);
    ...
    S = function t(n, o, u, s) {
      ...
      setTimeout(function () {
        RobotApi.retryRequest({
          ...
          .then(function (_) {
            if (_.result && 'retry' == _.result) c >= 8 ? s && s(f.ReachMaxRetryCount) : t(n, o, u, s);
            else if (u) u(_);
          })
          .catch(function (t) {
            if (s) s(t);
  ...
  return new Promise(function (n, s) {
    var c;
    ((c = u), module389.isSpecSupported() ? M(t, c) : l(t, c, o, module389.callMethod))
      .then(function (o) {
        if (o.result && 'retry' == o.result && C) undefined != o.id && null != o.id ? S(o.id, t, n, s) : s(f.RetryIDInvalid);
        else n(o);
      })
      .catch(function (t) {
        s(t);
...
var C = (RobotApi = {
  getStatus: function () {
    return S(module385.Methods.GetProp, [module385.Methods.GetStatus], {});
  },
  getMapStatus: function () {
    return S(module385.Methods.GetMapStatus, [], {});
  },
  getMapName: function (t, n) {
    return S(t, n, {});
  },
  getSegmentStatus: function () {
    return S(module385.Methods.GetSegmentStatus, [], {});
  },
  start: function (t) {
    return S(module385.Methods.AppStart, t || [], {});
  },
  segmentClean: function (t) {
    return S(module385.Methods.SegmentClean, t, {});
  },
  stopSegmentClean: function () {
    return S(module385.Methods.StopSegmentClean, [], {});
  },
  resumeSegmentClean: function () {
    return S(module385.Methods.ResumeSegmentClean, [], {});
  },
  zoneClean: function (t) {
    return S(module385.Methods.StartZonedClean, t, {});
  },
  stopZoneClean: function () {
    return S(module385.Methods.StopZonedClean, [], {});
  },
  resumeZoneClean: function () {
    return S(module385.Methods.ResumeZonedClean, [], {});
  },
  pause: function () {
    return S(module385.Methods.AppPause, [], {});
  },
  charge: function () {
    return S(module385.Methods.AppCharge, [], {});
  },
  startWashThenCharge: function () {
    return S('start_wash_then_charge', [], {});
  },
  stop: function () {
    return S(module385.Methods.AppStop, [], {});
  },
  spot: function () {
    return S(module385.Methods.AppSpot, [], {});
  },
  getCustomMode: function () {
    return S(module385.Methods.GetCustomMode, [], {});
  },
  setCustomMode: function (t) {
    return S(module385.Methods.SetCustomMode, [t], {});
  },
  ...
  getCurrentSoundPackage: function () {
    return S(module385.Methods.GetCurrentSoundPackage, [], {});
  },
  setSoundPackage: function (t) {
    return S(module385.Methods.SetSoundPackage, t, {});
  },
  getSoundPackageProgress: function () {
    return S(module385.Methods.GetSoundPackageProgress, [], {});
  },
  setCarpetMode: function (t) {
    return S(module385.Methods.SetCarpetMode, [t], {});
  },
  getCarpetMode: function () {
    return S(module385.Methods.GetCarpetMode, [], {});
  },
  getTimeZone: function () {
    return S(module385.Methods.GetTimezone, [], {});
  },
  setLabStatus: function (t) {
    return S(module385.Methods.SetLabStatus, [t], {});
  },
  setSwitchMapMode: function (t) {
    return S(
      module385.Methods.SetSwitchMapMode,
      {
        mode: t,
      },
      {}
  ...
  findMe: function () {
    return S(module385.Methods.FindMe, [], {});
  },
  getCleanSummary: function () {
    return S(module385.Methods.GetCleanSummary, [], {});
  },
  getLocale: function () {
    return S(module385.Methods.GetRobotLocale, [], {});
  },
  getServerTimer: function () {
    return S(module385.Methods.GetServerTimer, [], {});
  },
  deleteServerTimer: function (t) {
    return S(module385.Methods.DeleteServerTimer, [t], {});
  },
  updateServerTimer: function (t) {
    return S(module385.Methods.UpdateServerTimer, t, {});
  },
  setServerTimer: function (t) {
    return S(module385.Methods.SetServerTimer, [t], {});
  },
  updateTimer: function (t) {
    return S(module385.Methods.UpdTimer, t, {});
  },
  setTimer: function (t) {
    return S(module385.Methods.SetTimer, [t], {});
  },
  getTimer: function () {
    return S(module385.Methods.GetTimer, [], {});
  },
  deleteTimer: function (t) {
    return S(module385.Methods.DelTimer, [t], {});
  },
  getSupplies: function () {
    return S(module385.Methods.GetSupplies, [], {});
  },
  getNetworkInfo: function () {
    return S(module385.Methods.GetNetworkInfo, [], {});
  },
  getCleanSummary: function () {
    return S(module385.Methods.GetCleanSummary, [], {});
  },
  getCleanRecord: function (t) {
    return S(module385.Methods.GetCleanRecord, [t], {});
  },
  deleteCleanRecord: function (t) {
    return S(module385.Methods.DelCleanRecord, [t], {});
  },
  setLogLevel: function (t, n) {
    return S(module385.Methods.EnableLogUpload, [t, n], {});
  },
  setDndTimer: function (t, n, o, u) {
    return S(module385.Methods.SetDndTimer, [t, n, o, u], {});
  },
  closeDndTimer: function () {
    return S(module385.Methods.CloseDndTimer, [], {});
  },
  getDndTimer: function () {
    return S(module385.Methods.GetDndTimer, [], {});
  },
  getFWFeatures: function () {
    return S(module385.Methods.GetFWFeatures, [], {});
  },
  setFDSEndpoint: function (t) {
    return S(module385.Methods.SetFdsEndpoint, [t], {});
  },
  getInitStatus: function () {
    return S(module385.Methods.GetInitStatus, [], {});
  },
  setAppTimezone: function (t) {
    return S(module385.Methods.SetAppTimezone, t, {});
  },
  manualSegmentMap: function (t) {
    return S(module385.Methods.ManualSegmentMap, [t], {});
  },
  setLedStatus: function (t) {
    return S(module385.Methods.SetLedStatus, [t], {});
  },
  getLedStatus: function () {
    return S(module385.Methods.GetLedStatus, [], {});
  },
  getSoundVolume: function () {
    return S(module385.Methods.GetSoundVolume, [], {});
  },
  setSoundVolume: function (t) {
    return S(module385.Methods.SetSoundVolume, [t], {});
  },
  testSoundVolume: function () {
    return S(module385.Methods.TestSoundVolume, [], {});
  },
  getSerialNumber: function () {
    return S(module385.Methods.GetSerialNumber, [], {});
  },
  getWaterBoxMode: function () {
    return S(module385.Methods.GetWaterBoxMode, [], {});
  },
  setWaterBoxMode: function (t) {
    return S(module385.Methods.SetWaterBoxMode, [t], {});
  },
  setCustomCleanMode: function (t) {
    return S(module385.Methods.SetCustomCleanMode, t, {});
  },
  getCustomCleanMode: function () {
    return S(module385.Methods.GetCustomCleanMode, [], {});
  },
  setTimezone: function (t) {
    return S(module385.Methods.SetTimezone, [t], {});
  },
  createNewFloorMap: function () {
    return S(
      module385.Methods.AppStart,
      [
        {
          use_new_map: 1,
        },
  ...
  getRoomNameMappingInfo: function () {
    return S(module385.Methods.GetRoomMapping, [], {});
  },
  getMultiMaps: function () {
    return S(module385.Methods.GetMultiMapsList, [], {});
  },
  saveMap: function (t) {
    return S('save_map', t, {});
  },
  ...
  startEditMap: function () {
    return S(module385.Methods.StartEditMap, [], {});
  },
  loadMultiMap: function (t) {
    return S(module385.Methods.LoadMultiMap, [t], {});
  },
  remoteStart: function () {
    return S(module385.Methods.AppRemoteControlStart, [], {});
  },
  remoteEnd: function () {
    return S(module385.Methods.AppRemoteControlEnd, [], {});
  },
  remoteMove: function (t) {
    return S(module385.Methods.AppRemoteControlMove, [t], {});
  },
  remoteStop: function () {
  ...
  resetSupplies: function (t) {
    return S(module385.Methods.ResetSupplies, [t], {});
  },
  userUploadLog: function () {
    return S(module385.Methods.UserUploadLog, [], {});
  },
  appStat: function (t) {
    return S(module385.Methods.AppStat, [t], {});
  },
  appWakeupRobot: function () {
    return S(module385.Methods.AppWakeupRobot, [], {});
  },
  gotoTargetStop: function () {
    return S(module385.Methods.GotoTargetStop, [], {});
  },
  endEditMap: function () {
    return S(module385.Methods.EndEditMap, [], {});
  },
  mergeSegment: function (t) {
    return S(module385.Methods.MergeSegment, t, {});
  },
  splitSegment: function (t) {
    return S(module385.Methods.SplitSegment, t, {});
  },
  nameSegment: function (t) {
    return S(module385.Methods.NameSegment, t, {});
  },
  ...
  nameMultiMap: function (t) {
    return S(module385.Methods.NameMultiMap, t, {});
  },
  getRecoverMap: function (t) {
    return S(module385.Methods.GetRecoverMap, [t], {});
  },
  deleteSelectMap: function (t) {
    return S(module385.Methods.DeleteSelectMap, [t], {});
  },
  recoverMap: function (t) {
    return S(module385.Methods.RecoverMap, [t], {});
  },
  resetMap: function () {
    return S('reset_map', [], {});
  },
  getRecoverMaps: function () {
    return S(module385.Methods.GetRecoverMaps, [], {});
  },
