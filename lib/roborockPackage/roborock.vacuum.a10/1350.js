...
var O = React.forwardRef(function (t, n) {
    ...
    var E =
      ...
      k = [
        B(
          B({}, module1348.getChargeButtonConfig(R, w)),
          {},
          {
        ...
        B(
          B({}, module1348.getCleanButtonConfig(O, w)),
          {},
          {
        ...
        B(
          B({}, module1348.getWashingDusterButtonConfig(_, w)),
          {},
          {
  ...
  S = module12.StyleSheet.create({
    ...
    bottomButton: {
      width: module1063.BottomControlBottomThreeButtonWidth,
      backgroundColor: 'transparent',
