  ...
  b = (function (t) {
    ...
    function b(t, s) {
      ...
      u.state = {
        ...
        scenes: module988.default([], u.props.navigation.state, null, u.props.descriptors),
      };
      u._prevTransitionProps = null;
    ...
    module5.default(b, [
      ...
      },
      {
        ...
        value: function (t) {
          var n = module988.default(this.state.scenes, t.navigation.state, this.props.navigation.state, t.descriptors);
...
function w(t, n) {
  var s = t.navigation,
    ...
    c = n.scenes,
    p = c.find(V);
  module974.default(p, 'Could not find active scene');
  return {
    layout: o,
    navigation: s,
    position: u,
