    ...
    module5.default(I, [
      {
        ...
        value: function () {
          var t = this.props.isLoadMap,
            n = module1229.MM.maps.findIndex(function (t) {
      ...
      },
      {
        ...
        value: function () {
          var t = {
            ...
            s = n.isLoadMap,
            l = n.isHomePage;
          return (module377.RSM.multiFloorEnabled || 0 == module1229.MM.maps.length) && o && !s && !l ? [t].concat(module1229.MM.maps) : module1229.MM.maps;
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            module1252 = this.state.maps.map(function (n, module1251) {
              return React.default.createElement(
                module12.View,
                {
                  ...
                  style: [
                    O.mapItem,
                    {
                      opacity: o && module1229.MM.maps.length >= module1229.MM.mapCountMax && 0 == module1251 ? 0.5 : 1,
                    },
                  ],
                },
                ...
                React.default.createElement(module381.PureImageButton, {
                  ...
                  selected: module1251 == t.state.current,
                  onPress: t.selectItem.bind(t, module1251),
                })
              );
            }),
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (!this.props.isHomePage && module377.RSM.multiFloorEnabled && this.props.isOverwriteMode && module1229.MM.maps.length >= module1229.MM.mapCountMax && 0 == t) {
            this.hide();
