    ...
    module5.default(c, [
      {
        key: 'updateMap',
        value: function () {
          if (this.mapView) this.mapView.setState(I({}, module1229.MapManager.sharedManager().mapData));
        },
      },
      {
        key: 'manualSave',
          ...
          if (0 != this.state.hasCurrentMap || this.state.hasMap) {
            if (this.state.hasCurrentMap && this.state.isNewMap) {
              var l = React.default.createElement(
                ...
                c = React.default.createElement(module1231.MultiFloorEnableTipsView, {
                  ref: function (n) {
      ...
      value: function () {
        ...
        this.mapListener = module12.DeviceEventEmitter.addListener(module411.NotificationKeys.MapDidUpdate, function (n) {
          ...
          if (t.mapView)
            t.mapView.setState(
              I(
                I({}, module1229.MapManager.sharedManager().mapData),
                {},
                {
