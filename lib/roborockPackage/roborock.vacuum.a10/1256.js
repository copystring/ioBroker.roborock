        ...
        value: function () {
          ...
          this.panResponder = module12.PanResponder.create({
            ...
            onPanResponderMove: function (n, s) {
              var l = [module1245._parseEvent2(n.nativeEvent, s), t.touch.move],
                u = l[0],
                p = l[1];

              if (((t.touch.move = u || {}), u && !u.hasOwnProperty('distance'))) {
                var c = module1245._parseDegPointWithTrans(u, p, t.props.transform, t.props.mapDeg),
          ...
          this.panResponderScale = module12.PanResponder.create({
            ...
            onPanResponderStart: function (n, o) {
              if (!(n.nativeEvent.touches.length > 1)) {
                var s = module1245._parseMove(n.nativeEvent, o) || {};
                t.scale.dx = s.x;
                t.scale.dy = s.y;
                t.wallEnd = {
            ...
            onPanResponderMove: function (n, s) {
              if (!(n.nativeEvent.touches.length > 1)) {
                n = module1245._parseMove(n.nativeEvent, s) || {};

                var l = {
                    x: t.scale.dx,
                    y: t.scale.dy,
                  },
                  u = module1245._parseDegPointWithTrans(n, l, t.props.transform, t.props.mapDeg),
                ...
                if (x > module1233.RectConfig.maxLength) {
                  var P = module1233.RectConfig.maxLength - x;
                  b += Math.sin(R) * P;
                  f += Math.cos(R) * P;
                }

                if (!(x < module1233.RectConfig.minLength)) {
                  var D = {
                    x: f,
                    y: b,
                  };
      ...
      },
      {
        ...
        value: function () {
          ...
          var t = this.context.theme.displayZones,
            o = module1245._convertToPixelPosition(this.state.position, this.props.transform),
            s = o.end.y - o.start.y,
            l = o.end.x - o.start.x,
            u = Math.abs(s),
            p = Math.abs(l),
            ...
            C = o.start.x,
            E = o.start.y,
            x = 3.5 * module1233.buttonConfig.rectScale.size.width,
            P = 2 * c + x,
            D = x / 2,
            _ = P / 2,
          ...
          var O = React.default.createElement(
              ...
              module21.default({}, this.panResponder.panHandlers, {
                ...
                style: {
                  position: 'absolute',
                  left: _ - module1233.buttonConfig.rectOperateBoarderDis - M,
                  top: D - module1233.buttonConfig.rectOperateBoarderDis - 4.5 - M,
                  width: c + 2 * module1233.buttonConfig.rectOperateBoarderDis + 1,
                  height: 15 + 2 * module1233.buttonConfig.rectOperateBoarderDis + M,
              ...
              this.props.editable && this.state.isFocus
                ? React.default.createElement(
                    module12.View,
                    {
                      ...
                      style: {
                        position: 'absolute',
                        left: _ - module1233.buttonConfig.rectOperateBoarderDis - 2,
                        bottom: 10,
                        width: 90,
            ...
            F = this.state.isFocus
              ? React.default.createElement(module1254.RectButton, {
                  ...
                  left: _ - (1.5 * module1233.buttonConfig.rectDelete.size.width) / 2 - module1233.buttonConfig.rectOperateBoarderDis - M,
                  top: D - (1.5 * module1233.buttonConfig.rectDelete.size.height) / 2 - module1233.buttonConfig.rectOperateBoarderDis - 4.5 - M,
            ...
            T = this.state.isFocus
              ? React.default.createElement(module1254.RectButton, {
                  ...
                  left: P - D - (1.5 * module1233.buttonConfig.rectScale.size.width) / 2 + module1233.buttonConfig.rectOperateBoarderDis - M + 1,
                  top: D - (1.5 * module1233.buttonConfig.rectScale.size.height) / 2 + module1233.buttonConfig.rectOperateBoarderDis + 10.5 - M,
              ...
              : React.default.createElement(module12.View, null),
            module1257 = this.state.isFocus
              ? React.default.createElement(module12.View, null)
              : React.default.createElement(module1254.DisplayButton, {
                  left: _ - (module1233.buttonConfig.rectDisplay.size.width / 2) * M,
                  top: D - (module1233.buttonConfig.rectDisplay.size.height / 2) * M,
                  width: module1233.buttonConfig.rectDisplay.size.width * M,
                  height: module1233.buttonConfig.rectDisplay.size.height * M,
                  imageSource: require('./1257'),
                }),
            module1257 = this.state.isFocus
              ? React.default.createElement(module12.View, null)
              : React.default.createElement(module1254.DisplayButton, {
                  left: P - D - (module1233.buttonConfig.rectDisplay.size.width * M) / 2,
                  top: D - (module1233.buttonConfig.rectDisplay.size.height * M) / 2,
                  width: module1233.buttonConfig.rectDisplay.size.width * M,
                  height: module1233.buttonConfig.rectDisplay.size.height * M,
                  imageSource: require('./1257'),
                }),
