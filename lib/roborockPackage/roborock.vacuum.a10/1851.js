exports.getCountryInfo = function (t) {
  if (module389.apiLevel >= 115)
    module389.getCurrentCountryInfoCallback(function (n, o) {
      return t(n, o);
    });
};
...
exports.getPrivacyAndProtocolView = function (t, n, c, u) {
  if (module389.apiLevel >= 133) module389.privacyAndProtocolReview(t, n, c, u);
  else module389.reviewPrivacyAndProtocol();
};

exports.removeFdsTempMapFiles = function () {
  module389.callSmartHomeAPI(
    module385.SmartHomeApi.DelFdsTempMaps,
    {
