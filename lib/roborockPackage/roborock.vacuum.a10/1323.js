...
var module1245 = require('./1245'),
  z = module1233.buttonConfig.rectScale.size.width,
  D = module1233.buttonConfig.rectScale.size.width,
  E = (function (t) {
    module7.default(E, t);
    ...
    function E(t) {
      ...
      o.edgeSize = module1233.FurnitureSize[t.type];
      return o;
    }
    ...
    module5.default(E, [
      ...
      },
      {
        ...
        value: function (t) {
          if (t.type != this.props.type) this.edgeSize = module1233.FurnitureSize[t.type];
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = null;
          if (module1233.FurnitureResource[this.props.type]) t = module1233.FurnitureResource[this.props.type].image;
          return t;
        },
      },
      {
        ...
        value: function (t, o) {
          ...
          return this.props.isFocus
            ? React.default.createElement(module12.View, {
                ...
                style: {
                  position: 'absolute',
                  left: D + z - module1233.buttonConfig.rectOperateBoarderDis - 1,
                  top: z - module1233.buttonConfig.rectOperateBoarderDis - 1,
                  width: t + 2 * module1233.buttonConfig.rectOperateBoarderDis + 1,
                  height: o + 2 * module1233.buttonConfig.rectOperateBoarderDis + 1,
                  overflow: 'visible',
      ...
      },
      {
        ...
        value: function (t) {
          ...
          var n = D + z - module1233.buttonConfig.rectOperateBoarderDis + 1,
            s = z + t + module1233.buttonConfig.rectOperateBoarderDis - 1,
            u = D / 2 + z - module1233.buttonConfig.rectOperateBoarderDis + 1;
      ...
      },
      {
        key: 'render',
        value: function () {
          if (this.props.type == module1233.FurnitureType.FT_NONE) return React.default.createElement(module12.View, null);

          var t = this.context.theme.displayZones,
            n = module1245._convertToPixelRect(this.props.rectSize, this.props.transform);
            ...
            p =
              (this.props.isFocus &&
                React.default.createElement(module1254.RectButton, {
                  ...
                  left: D + z - (1.5 * module1233.buttonConfig.rectDelete.size.width) / 2 - module1233.buttonConfig.rectOperateBoarderDis,
                  top: z - (1.5 * module1233.buttonConfig.rectDelete.size.height) / 2 + 1 - module1233.buttonConfig.rectOperateBoarderDis,
            ...
            l =
              (this.props.isFocus &&
                React.default.createElement(module1254.RectButton, {
                  ...
                  left: n.width + D + z - (1.5 * module1233.buttonConfig.rectScale.size.width) / 2 - 1 + module1233.buttonConfig.rectOperateBoarderDis,
                  top: n.height + z - (1.5 * module1233.buttonConfig.rectScale.size.height) / 2 - 2 + module1233.buttonConfig.rectOperateBoarderDis,
            ...
            c =
              (this.props.isFocus &&
                React.default.createElement(module1254.RectButton, {
                  ...
                  left: n.width + D + z - (1.5 * module1233.buttonConfig.rectRotate.size.width) / 2 - 1 + module1233.buttonConfig.rectOperateBoarderDis,
                  top: z - (1.5 * module1233.buttonConfig.rectRotate.size.height) / 2 + 1 - module1233.buttonConfig.rectOperateBoarderDis,
                  width: module1233.buttonConfig.rectRotate.size.width,
                  height: module1233.buttonConfig.rectRotate.size.height,
...
E.defaultProps = {
  ...
  percent: 0,
  direction: 0,
  type: module1233.FurnitureType.FT_NONE,
  subType: module1233.FurnitureType.FT_NONE,
