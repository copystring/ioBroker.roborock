    ...
    module5.default(S, [
      ...
      },
      {
        ...
        value: function () {
          ...
          if (((n !== C && n !== P) || ((s = this.getDateData()), (l = [o.getFullYear() + '', o.getMonth() + '', o.getDate() + ''])), n === C || n === O)) {
            ...
            b = y(
              {
                ...
                transform: [
                  {
                    rotateZ: module12.I18nManager.isRTL ? '-180deg' : '0deg',
                  },
                ],
              },
              k
              ...
              return React.default.createElement(
                module1209.default,
                {
                  ...
                  itemStyle: [
                    x,
                    {
                      color: globals.app.state.theme.customDatePicker.titleColor,
                      transform: [
                        {
                          rotateZ: module12.I18nManager.isRTL ? '-180deg' : '0deg',
                        },
                ...
                t.props.children.map(function (t) {
                  return React.default.createElement(
                    module1209.default.Item,
                    {
                      key: t.value,
                      value: t.value,
                    },
