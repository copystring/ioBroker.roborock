    ...
    function k(t) {
      ...
      n.onPressResetEditButton = function () {
        n.setState(
          ...
          function () {
            var t;
            if (!(null == (t = n.mapView))) t.setState(F({}, module1229.MM.mapData));
          }
        );
      };
      ...
      n.eidtCountChange = function (t) {
        n.setState({
          editCount: module1233.MAX_FURNITURE_EDIT_MIAPP - t,
        });
      };
      ...
      n.state = {
        ...
        hasEditedMap: false,
        showButton: true,
        editCount: module1233.MAX_FURNITURE_EDIT_MIAPP,
        showDragItem: false,
        dragItemType: module1233.FurnitureType.FT_BED,
        dragItemSize: {
          x: 0,
          y: 0,
          width: 0,
    ...
    module5.default(k, [
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            o = module1342.default.confirmButton(this.onNavigationSavePress, n, function (n) {
              t.mapSaveButton = n;
            });
          module1342.default.setNavigation(this, [o], this.onNavigationBackPress);
        },
      },
      {
        key: 'registListeners',
          ...
          this.panResponderDrop = module12.PanResponder.create({
            ...
            onPanResponderStart: function (n, o) {
              ...
              if (
                ...
                var u = {
                  width: module1233.FurnitureResource[s].imageWidth,
                  height: module1233.FurnitureResource[s].imageHeight,
                };
                t.setState({
                  showDragItem: true,
                  dragItemType: s,
      ...
      },
      {
        ...
        value: function () {
          ...
          module1247.setTimeout(function () {
            return module1229.MM.saveFurnitureEditZones(module377.RSM.currentMapId, o, n.onMapSaveCompleted.bind(n));
          }, 500);
        },
      },
      {
        ...
        value: function () {
          var t = this,
            n = React.default.createElement(module1231.MapView, {
              ...
              bottom: module1342.MapEditCommonStyles.mapBottom + 100,
              hideAccessory: true,
              mapMode: module934.MAP_MODE_FURNITURE_EDIT,
              zonesHasEdited: this.state.hasEditedMap,
              eidtCountChange: this.eidtCountChange,
            });
          return this.state.mapStatus == module377.MapStatus.None ? module1342.default.getNoMapTipView(this.state.mapStatus) : n;
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            s = [];
          s.push(module1233.FurnitureResource[module1233.FurnitureType.FT_BED]);
          s.push(module1233.FurnitureResource[module1233.FurnitureType.FT_SOFA]);
          s.push(module1233.FurnitureResource[module1233.FurnitureType.FT_DINNERTABLE]);
          s.push(module1233.FurnitureResource[module1233.FurnitureType.FT_TEATABLE]);
          ...
          var t = this,
            ...
            h =
              ...
              module491.map_edit_furniture_count_tip_miapp.templateStringWithParams({
                max: module1233.MAX_FURNITURE_EDIT_MIAPP,
