...
var module385 = require('./385'),
  ...
  module1360 = require('./1360').getToast,
  ...
  D = (function (t) {
    ...
    module5.default(E, [
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module1229.MapManager.sharedManager().shouldForceStart = true;
      ...
      },
      {
        ...
        value: function () {
          ...
          if (this.mapView) this.mapView.setState(P({}, module1229.MapManager.sharedManager().mapData));
          ...
          this.mapListener = module12.DeviceEventEmitter.addListener(module411.NotificationKeys.MapDidUpdate, function (t) {
            if (n.mapView)
              n.mapView.setState(
                P(
                  P({}, module1229.MapManager.sharedManager().mapData),
                  {},
                  {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(module1369, {
                ref: function (n) {
