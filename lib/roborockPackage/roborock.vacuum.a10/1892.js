...
var c = function (t) {
  ...
  s = function (t) {
    return '^' + module1893.default(t).replace(/\\\*/g, '.*');
  },
  E = function (t, n) {
    var l = c(n);
...
exports.defaultRenderLoading = function () {
  return React.default.createElement(
    module12.View,
    {
      style: module1894.default.loadingOrErrorView,
    },
...
exports.defaultRenderError = function (t, n, f) {
  return React.default.createElement(
    ...
    React.default.createElement(
      module12.Text,
      {
        style: module1894.default.errorTextTitle,
      },
      'Error loading page'
    ),
    React.default.createElement(
      module12.Text,
      {
        style: module1894.default.errorText,
      },
      'Domain: ' + t
    ),
    React.default.createElement(
