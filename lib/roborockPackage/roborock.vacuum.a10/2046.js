  ...
  C = (function (t) {
    ...
    module5.default(C, [
      ...
      },
      {
        key: 'robotPlayAudio',
        value: function (t) {
          var o, module4, module5, module6, module7, module9, module11, React, module12, module2047;
          return regeneratorRuntime.default.async(
            function (b) {
              for (;;)
                switch ((b.prev = b.next)) {
                  ...
                  case 8:
                    ...
                    module2047 = JSON.parse(JSON.stringify(module12));
                    console.log('playAudio - ' + JSON.stringify(module2047));
                    b.next = 30;
                    return regeneratorRuntime.default.awrap(module407.default.playAudio(module2047));
