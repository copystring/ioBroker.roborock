  ...
  L = (function (t) {
      ...
      n.mapCarpetFocus = function (t, o, u) {
        ...
        var p = u
          ...
          l = module21.default(p, {
            editAction: u ? module1231.EditAction.Ignore : module1231.EditAction.AddCarpet,
          });
        n.setState(l, function () {
          var t;
          if (!(null == (t = n.mapView))) t.clearCarpetFbzFocus(u);
        });
        if (!(null == (c = n.editMenu))) c.showCarpetConfirmMenu(u ? module1231.EditAction.Ignore : module1231.EditAction.AddCarpet, !o);
      };
    ...
    module5.default(L, [
      ...
      },
      {
        key: 'configNavibar',
        value: function () {
          module1231.MapEditCommonService.setNavigation(this, null, this.onNavigationBackPress.bind(this));
        },
      },
      {
        key: 'initMapView',
      ...
      },
      {
        ...
        value: function () {
          ...
          this.mapEditDidChange = module12.DeviceEventEmitter.addListener(module411.NotificationKeys.MapEditDidChange, function (n) {
            if (!(n.data != module1231.FbzType.FBZ_TYPE_CARPET && n.data != module1231.FbzType.RECT_TYPE_CARPET))
              t.setState({
                ignoreCarpetEdited: n.data == module1231.FbzType.FBZ_TYPE_CARPET,
                cusCarpetEdited: n.data == module1231.FbzType.RECT_TYPE_CARPET,
              });
          });
        },
      },
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    ...
                    else this._onPressAddButton(module1231.EditAction.AddCarpet);
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    ...
                    else this._onPressAddButton(module1231.EditAction.Ignore);
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (module386.default.isMultiFloorSupported())
            this.state.mapStatus != module377.MapStatus.None && module1229.MM.maps.length >= 1 && -1 == n
              ? globals.showToast(module491.no_map_status_description)
              : 1 == module1229.MM.maps.length && 1 == module1229.MM.mapCountMax
              ? ((n = module1229.MM.maps[0].id), this.startMapSave(n, t))
      ...
      },
      {
        ...
        value: function (t, n) {
          ...
          if (this.state.editAction == module1231.EditAction.Ignore)
            module1247.setTimeout(function () {
              return module1229.MM.saveCarpetIgnoreZone(t, n, o.onMapSaveCompleted.bind(o));
            }, 500);
          else if (this.state.editAction == module1231.EditAction.AddCarpet)
            module1247.setTimeout(function () {
              return module1229.MM.saveCarpetAddedZone(t, 1, n, o.onMapSaveCompleted.bind(o));
            }, 500);
        },
      },
      {
                ...
                switch ((s.prev = s.next)) {
                  case 0:
                    this.setState(
                      ...
                      function () {
                        var n, s;
                        if (!(null == (n = o.mapView))) n.addCarpetNewZone(t == module1231.EditAction.AddCarpet);
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = React.default.createElement(module1231.MapView, {
              ref: function (n) {
                t.mapView = n;
              },
              parent: this,
              style: module1231.MapEditCommonStyles.map,
              top: module1231.MapEditCommonStyles.mapTop,
              bottom: module1231.MapEditCommonStyles.mapBottom,
              left: module1231.MapEditCommonStyles.mapLeft,
              right: module1231.MapEditCommonStyles.mapRight,
              initFBZone: this.carpetRect,
              mapMode: module934.MAP_MODE_CARPET_EDIT,
            ...
            o = React.default.createElement(module1343.default, {
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module1231.MapEditMenuView, {
            type: module1231.MenuType.Menu_Carpet,
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            {
              style: [
                module1231.MapEditCommonStyles.root,
                {
