  ...
  G = (function (t) {
    ...
    function D(t) {
      ...
      n.handleSelectedBlocksDidChange = function (t) {
        ...
        if (n.state.action == module1324.EditAction.Floor && 1 == t.length) {
            ...
            : n.alert.alert(module491.refresh_segments_alert_hint, '', [
                ...
                },
                {
                  ...
                  onPress: function () {
                    ...
                    if (1 == module1229.MM.maps.length && 1 == module1229.MM.mapCountMax) t = module1229.MM.maps[0].id;
      ...
      n.onPressMergeZoneButton = function () {
        n.setState({
          action: module1324.EditAction.Merge,
        });
      ...
      n.onPressSplitZoneButton = function () {
        n.setState({
          action: module1324.EditAction.Split,
        });
        n.setReSegmentButtonVisible(false);
      };
      ...
      n.onPressConfirmButtonForName = function () {
        ...
        module407.default
          .nameSegment(u)
          .then(function () {
            module1229.MM.updateRoomNameMapping(function (t) {
      ...
      n.onPressConfirmButtonForFloor = function () {
        ...
        if (t.length <= 0) n.endLoading();
          ...
          module407.default
            ...
            .catch(function (t) {
              var o = module1342.default.errorText(t.data.error ? t.data.error.code : 0);
              n.showToast(o);
            })
            .finally(function () {
              n.resetActionStatus();
      ...
      n.onPressRoomNameButton = function () {
        ...
        if (n.mapView) {
          ...
          if (0 == o || 1 == o) {
            ...
            n.editMenu.showConfirmMenu(module491.map_edit_name_select_more_segment_tip);
            n.setState({
              action: module1324.EditAction.Name,
            });
      ...
      n.onPressRoomFloorButton = function () {
        ...
        if (o <= 1) {
          ...
          n.editMenu.showConfirmMenu(module491.map_edit_floor_change_tip);
          n.setState({
            action: module1324.EditAction.Floor,
          });
          if (!(null == (t = n.mapView)))
            t.setState({
      ...
      n.initAction = n.props.navigation.state.params.action || module1324.EditAction.None;
      n.state = {
        ...
        overTimer: module934.OverTimer_Six,
    ...
    module5.default(D, [
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = [
              module1342.default.guideButton(this.onNavigationGuidePress, function (n) {
                t.guideButton = n;
              }),
            ];
          module1342.default.setNavigation(this, globals.isRTL ? n.reverse() : n, this.onNavigationBackPress);
        },
      },
      {
        key: 'initMapView',
        value: function () {
          var t;
          if (!(null == (t = this.mapView))) t.setState(F({}, module1229.MM.mapData));
        },
      },
      {
        key: 'registListeners',
            ...
            function (o) {
              for (;;)
                switch ((o.prev = o.next)) {
                  ...
                  case 2:
                    if ((t = module1229.MM.customCleanModes) && t.length > 0) this.showSegmentEditPrompt();
            ...
            function (o) {
              for (;;)
                switch ((o.prev = o.next)) {
                  ...
                  case 2:
                    if ((t = module1229.MM.cleanSequence) && t.length > 0) this.showSegmentEditPrompt();
          ...
          return regeneratorRuntime.default.async(
            function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    if (this.mapView) this.mapView.setState(F({}, module1229.MM.mapData));
              ...
              for (;;)
                switch ((u.prev = u.next)) {
                  ...
                  case 14:
                    u.prev = 14;
                    u.t0 = u.catch(3);
                    o = module1342.default.errorText(u.t0.data.error ? u.t0.data.error.code : 0);
                    this.showToast(o);
              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  ...
                  case 29:
                    l.prev = 29;
                    l.t0 = l.catch(17);
                    s = module1342.default.errorText(l.t0.data.error ? l.t0.data.error.code : 0);
                    this.showToast(s);
      ...
      },
      {
        key: 'isCustomName',
        value: function () {
          return this.state.action == module1324.EditAction.Name;
        },
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            o = React.default.createElement(module1231.MapView, {
              ...
              bottom: module1342.MapEditCommonStyles.mapBottom,
            ...
            u = React.default.createElement(module381.TopImageButton, {
              ...
              style: module1342.MapEditCommonStyles.refreshMapSegmentIndicator,
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module1324.default, {
              type: module1324.MenuType.Menu_Zone,
              ref: function (n) {
                return (t.editMenu = n);
              },
              hasConfirmMenu: true,
