  ...
  _ = (function (t) {
    ...
    module5.default(_, [
      ...
      },
      {
        key: 'fetchAndSetMap',
        value: function () {
          var t = module1229.MapManager.sharedManager().mapData;
          ...
          if (this.mapView) this.mapView.setAllCleanMopMode(module1229.MapManager.sharedManager().customCleanModes);
      ...
      },
      {
        key: 'setCustomMode',
        value: function (t) {
          if (this.mapView) this.mapView.setCleanSequence(module1229.MapManager.sharedManager().cleanSequence.concat(), false);
          if (this.mapView)
