...
var M = React.forwardRef(function (t, n) {
    ...
    var L = [
        C(
          C({}, module1348.getCleanButtonConfig(M, b)),
          {},
          {
        ...
        C(
          C({}, module1348.getMopButtonConfig(O, b)),
          {},
          {
        ...
        C(
          C({}, module1348.getCleanMopButtonConfig(_, b)),
          {},
          {
      ...
      G = [
        C(
          C({}, module1348.getChargeButtonConfig(v, b)),
          {},
          {
            onPress: V,
        ...
        C(
          C({}, module1348.getWashingDusterButtonConfig(j, b)),
          {},
          {
          ...
          return React.default.createElement(
            ...
            module21.default(
              ...
              t,
              {
                ...
                maxTextWidth: module1063.BottomControlTopButtonWidth - 20,
                style: [w.topButton],
              }
            )
          );
        ...
        G.map(function (t, n) {
          return React.default.createElement(
            ...
            module21.default(
              ...
              t,
              {
                maxTextWidth: module1063.BottomControlBottomButtonWidth - 20,
                textColor: b.homeBottomControl.textColor,
                fontSize: 14,
  ...
  w = module12.StyleSheet.create({
    ...
    topButton: {
      width: module1063.BottomControlTopButtonWidth,
      backgroundColor: 'transparent',
    },
    splitLine: {
      width: module12.Dimensions.get('window').width - 4 * module1063.HorizontalMargin,
      height: 0.8,
      marginTop: 12,
