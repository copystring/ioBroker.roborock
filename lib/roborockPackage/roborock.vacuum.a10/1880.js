...
var module491 = require('./491').strings,
  ...
  F = module1339.parse,
  O = module1339.convertMap,
  I = module1339.convertCarpetMap,
  j = module1339.convertFloorMap,
  ...
  module1875 = (function (t) {
    ...
    module5.default(D, [
          ...
          if (this.feedbackCallback)
            this.mapLoadEmitter = module12.DeviceEventEmitter.addListener(module411.NotificationKeys.MapImageLoaded, function (n) {
              if (n.types && 0 != n.types.length) {
                ...
                var o = Object.values(module1231.shareViewLoadType),
                  l = 0;
      ...
      },
      {
        ...
        value: function () {
          var t = this.context.theme,
            module1811 = React.default.createElement(module381.PureImageButton, {
              image: require('./1811'),
            ...
            l = globals.isRTL ? [o, module1811] : [module1811, o];
      ...
      },
      {
        key: 'render',
        value: function () {
          if (1 == this.props.navigation.state.params.status) require('./1874');
          else require('./1875');
          var t = this,
            n = this.context.theme,
            o = this.getDescText(),
            l = Math.ceil(this.props.navigation.state.params.time / 60),
            s = module1366.utcTimeConvertToPhoneTimeZoneTime(1e3 * this.state.start),
            c = module1366.addZeroPrefix(s.month) + '/' + module1366.addZeroPrefix(s.day) + ' ' + module1366.addZeroPrefix(s.hour) + ':' + module1366.addZeroPrefix(s.minute),
            ...
            N = j + ' | ' + A + ' | ' + (module934.CleanStartType()[this.state.startType] || module491.localization_strings_Setting_General_index_0) + ' | ' + c + ' ';
          ...
          var W = [n.cleanHistory.gradSuccessLeft, n.cleanHistory.gradSuccessRight],
            ...
            module1874 = React.default.createElement(
              module12.View,
              {
                style: [ee.horizontalView],
              },
              globals.isRTL ? module1881 : K,
              globals.isRTL ? K : module1881
            ),
            module1882 = React.default.createElement(
              module12.TouchableWithoutFeedback,
              {
            ...
            module1881 = React.default.createElement(
              module12.TouchableWithoutFeedback,
              {
                onPress: this.onPressPlay.bind(this),
              },
          ...
          if (this.state.uiStatus != J) {
            ...
            module1874 = React.default.createElement(
              ...
              globals.isRTL ? module1884 : module1882,
              oe ? module1881 : module1883,
              globals.isRTL ? module1882 : module1884
            );
          }
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              this.state.hasGotMap
                ? React.default.createElement(module1231.MapView, {
                    style: {
                      flex: 1,
              ...
              React.default.createElement(module1796.default, {
                style: {
                  position: 'absolute',
                  bottom: 0,
                  height: Q,
      ...
      },
      {
        key: 'getDescText',
        value: function () {
          var t = module934.CleanFinishCleanReasons()[this.state.finishReasonCode];
...
exports.default = module1875;
module1875.contextType = module506.AppConfigContext;
var ee = module12.StyleSheet.create({
  container: {
    ...
    justifyContent: 'center',
    marginBottom: 0,
    marginTop: -module387.default.iOSAndroidReturn(44 + module934.StatusBarHeight + module934.AppBarMarginTop, (module12.StatusBar.currentHeight || 0) + 44),
  },
  contentView: {
    flex: 1,
  },
