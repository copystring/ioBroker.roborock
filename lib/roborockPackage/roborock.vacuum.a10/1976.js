...
var module491 = require('./491').strings,
  ...
  H = (function (t) {
    module7.default(module1977, t);

    var module506 = module1977,
      P = T(),
      V = function () {
        var t,
    ...
    function module1977(t) {
      var o;
      module4.default(this, module1977);
      ...
      o.getShowOccurTime = function () {
        return null == o.state.occurHour || null == o.state.occurMinute
          ? '\u672a\u8bbe\u7f6e'
          : module1366.addZeroPrefix(o.state.occurHour) + ':' + module1366.addZeroPrefix(o.state.occurMinute);
      };
    ...
    module5.default(module1977, [
      ...
      },
      {
        ...
        value: function (t) {
          ...
          var n = module1366.utcTimeConvertToPhoneTimeZoneTime(1e3 * t);
          return [module1366.addZeroPrefix(n.month), module1366.addZeroPrefix(n.day), module1366.addZeroPrefix(n.hour), module1366.addZeroPrefix(n.minute)];
        },
      },
      {
...
var D = module12.StyleSheet.create({
  ...
  containter: {
    flex: 1,
    backgroundColor: '#f5f5f5',
    marginTop: module934.NavigationBarHeight + 10,
    marginHorizontal: 15,
    marginBottom: 20,
  },
  categoryView: {
