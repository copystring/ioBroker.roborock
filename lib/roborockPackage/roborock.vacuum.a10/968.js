  ...
  z = (function (t) {
    ...
    function T(t) {
      ...
      n._getTransitionConfig = function () {
        ...
        return module984.default.getTransitionConfig(n.props.transitionConfig, n.props.transitionProps, n.props.lastTransitionProps, t);
      };
    ...
    module5.default(T, [
      {
        ...
        value: function (t, o) {
          ...
          var p =
              s ||
              function (t) {
                return React.default.createElement(module975.default, t);
              },
      ...
      },
      {
        key: '_reset',
        value: function (t, n) {
          if ('ios' === module12.Platform.OS && module986.supportsImprovedSpringAnimation())
        ...
        value: function (t, n) {
          ...
          var f = function () {
            ...
            if (!o._isResponding && t) {
              p.dispatch(
                module936.NavigationActions.back({
                  key: t.route.key,
                  immediate: true,
                })
              );
              p.dispatch(module936.StackActions.completeTransition());
            }
          };
