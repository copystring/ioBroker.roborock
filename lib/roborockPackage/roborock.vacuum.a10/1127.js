...
var module1129 = require('./1129'),
  ...
  c = function c(p, f, s) {
    var y,
      ...
      G = p & c.B,
      P = p & c.W,
      R = h ? module1129 : module1129[f] || (module1129[f] = {}),
      S = R.prototype,
      W = h ? globals : F ? globals[f] : (globals[f] || {}).prototype;

    for (y in (h && (s = f), s))
      ((l = !w && W && undefined !== W[y]) && module1142(R, y)) ||
        ((v = l ? W[y] : s[y]),
        (R[y] =
          h && 'function' != typeof W[y]
            ? s[y]
            : G && l
            ? module1130(v, globals)
            : P && W[y] == v
            ? (function (t) {
            ...
            : B && 'function' == typeof v
            ? module1130(Function.call, v)
            : v),
        B && (((R.virtual || (R.virtual = {}))[y] = v), p & c.R && S && !S[y] && module1132(S, y, v)));
  };
