    ...
    [
              ...
              for (;;)
                switch ((A.prev = A.next)) {
                  case 0:
                    ...
                    if (u - this.lastCameraStatusLockTime >= 2e3 && !this.cameraStatusLocked) module1361.default.parseCameraStatus(t.camera_status);
                    else {
                  ...
                  case 35:
                    ...
                    A.next = 52;
                    return regeneratorRuntime.default.awrap(module1362.TLM.GetListByHours(6));
                ...
                switch ((_.prev = _.next)) {
                  case 0:
                    ...
                    o = t.filter(function (s) {
                      return t && module1360.Reminder()[s];
                    });
                    _.next = 7;
      ...
      },
      {
        ...
        value: function () {
          ...
          this.staticTotalCount = 0;
          module1229.MapManager.sharedManager().isStopedByStatus = false;
          module1229.MapManager.sharedManager().shouldForceStart = false;
          module1229.MapManager.sharedManager().isStopedBySettingPage = false;
          this.errorCode = 0;
      ...
      },
      {
        ...
        value: function () {
          if (this.isStatic()) {
            ...
            if (this.staticTotalCount > 5 && module1229.MapManager.sharedManager().isRunning()) {
              module1229.MapManager.sharedManager().stop();
              module1229.MapManager.sharedManager().isStopedByStatus = true;
              console.log('checkHowToHandleMapManager stop request map - ' + this.staticTotalCount);
            }
          } else if (module1229.MapManager.sharedManager().isStopedByStatus) {
            module1229.MapManager.sharedManager().isStopedByStatus = false;
            this.staticTotalCount = 0;
            module1229.MapManager.sharedManager().start();
