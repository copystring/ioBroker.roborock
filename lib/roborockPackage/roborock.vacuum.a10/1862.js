  ...
  E = (function (t) {
    ...
    module5.default(C, [
      ...
      },
      {
        ...
        value: function () {
          ...
          this.mapListener = module12.DeviceEventEmitter.addListener(module411.NotificationKeys.MapDidUpdate, function (n) {
            ...
            else if (t.needUpdateMap) t.setMapData(module1229.MM.mapData);
          });
        },
      },
      {
      ...
      },
      {
        ...
        value: function (t, n, o) {
          ...
          this.setState(
            ...
            function () {
              if (s.needUpdateMap && n) s.setMapData(module1229.MM.mapData);
      ...
      },
      {
        ...
        value: function (t) {
          if (this.mapView)
            this.mapView.changeMapViewMode(t ? module1231.MapModelInCleanMode.Segment_Clean_Edit_With_Clean_Type : module1231.MapModelInCleanMode.Segment_Clean_Edit);
        },
      },
      {
        key: 'setMapData',
        value: function (t) {
          ...
          if (this.needUpdateMap) {
            var o = function (t) {
              ...
              if (n.mapView) n.mapView.setAllCleanMopMode(module1229.MapManager.sharedManager().customCleanModes);
              if (n.mapView) n.mapView.setCleanSequence(module1229.MapManager.sharedManager().cleanSequence.concat(), false);
              if (n.mapView)
                n.mapView.changeMapViewMode(
                  n.props.isCustomMode ? module1231.MapModelInCleanMode.Segment_Clean_Edit_With_Clean_Type : module1231.MapModelInCleanMode.Segment_Clean_Edit
                );
            };
