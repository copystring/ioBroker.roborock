...
var module1247 = require('./1247'),
  ...
  W = module1267.RRSurface,
  z = module1267.isRRSurface,
        ...
        value: function () {
          ...
          this.panResponder = module12.PanResponder.create({
            ...
            onPanResponderStart: function (s, o) {
              ...
              t.touch.move = module1245._parseEvent2(s.nativeEvent, o) || {};
            },
            ...
            onPanResponderMove: function (s, o) {
              if (t.longPressStart) {
                var h = [module1245._parseEvent2(s.nativeEvent, o), t.touch.move],
                  l = h[0],
                  p = h[1];
                if (((t.touch.move = l || {}), !(l && l.x && l.y && p.x))) return;

                var u = module1245._parseDegPointWithTrans(l, p, t.props.transform, t.props.mapDeg),
      ...
      },
      {
        ...
        value: function () {
          if (!this.longPressCanceled) {
            ...
            var t = module1245._parseDegPoint(0, -30 / (this.props.transform.yy || 1), this.props.mapDeg),
...
module1327.propTypes = {
  onLongPress: PropTypes.default.func,
};
module1327.defaultProps = {
...
var module1338 = (function (t) {
  ...
  function u(t) {
    ...
    (o = s.call(this, t)).mapSourceOnLoad = function (t, s) {
      if (o.props.imageOnloadCallback)
        s == module1233.shareViewLoadType.ONLOAD_OBSTACLE
    ...
    o.handleMapObjectImageOnLoad = function () {
      return o.mapSourceOnLoad({}, module1233.shareViewLoadType.ONLOAD_OBSTACLE);
    };
  ...
  module5.default(u, [
    ...
    },
    {
      ...
      value: function (t, s) {
        if (
          t.mapMode == module934.MAP_MODE_GOTO_EDIT &&
          s.target &&
          s.target.x &&
          s.target.y &&
    ...
    },
    {
      ...
      value: function (t) {
        var s = [];
        if (!t.charger || (t.charger && this.mapLoadSources[module1233.shareViewLoadType.ONLOAD_CHARGER])) s.push(module1233.shareViewLoadType.ONLOAD_CHARGER);
        if (undefined === t.carpetMap || t.carpetMap === this.mapLoadSources[module1233.shareViewLoadType.ONLOAD_CARPETMAP]) s.push(module1233.shareViewLoadType.ONLOAD_CARPETMAP);
        if (!this.currentMap || this.currentMap === this.mapLoadSources[module1233.shareViewLoadType.ONLOAD_MAP]) s.push(module1233.shareViewLoadType.ONLOAD_MAP);
        if (t.obstacles && 0 != t.obstacles.length) this.lastObstacles = t.obstacles;
        else s.push(module1233.shareViewLoadType.ONLOAD_OBSTACLE);
    ...
    },
    {
      ...
      value: function (t, s) {
        ...
        if (1 == t.parent.state.inCleanBlockMode) o = s.mapBCBackground;
          ...
          t.mapMode == module934.MAP_MODE_CARPET_EDIT
        )
          o = s.mapNoBlock;
        return o;
      },
    ...
    },
    {
      ...
      value: function () {
        var module1329 = {
            ...
            chargerIcon: require('./1328'),
            chargerBubbleIcon: require('./1329'),
          },
          module1331 = {
      ...
      value: function (t) {
        ...
        if (!(t.touches.length > 1))
          this.props.showDockBubbles &&
            (this.props.mapMode != module934.MAP_MODE_REGULAR ||
    ...
    },
    {
      ...
      value: function () {
        ...
        var s = module1233.Config.size.chargerWidth * this.state.transform.xx,
          n = module1233.Config.size.chargerHeight * this.state.transform.yy;
              ...
              module21.default(
                ...
                module387.default.getAccessibilityLabel('map_charger'),
                {
                  ...
                  onLoad: this.props.imageOnloadCallback
                    ? function (s) {
                        return t.mapSourceOnLoad(s.nativeEvent.source, module1233.shareViewLoadType.ONLOAD_CHARGER);
                      }
                    : null,
                }
              )
    ...
    },
    {
      ...
      value: function () {
        ...
        return React.default.createElement(module1239.ObjectNameBubble, {
          ...
          objectImage: this.state.chargerErrorText && this.state.chargerErrorText.length ? require('./1338') : this._getChargerResources().chargerBubbleIcon,
          center: s,
    ...
    },
    {
      ...
      value: function () {
        return !this.props.hideAccessory && (this.charger.x || this.charger.y) && this.state.charger && this.props.mapMode == module934.MAP_MODE_MAP_EDIT
          ? React.default.createElement(module12.View, {
              style: {
                position: 'absolute',
                width: module1233.DOCK_FORBIDDEN_R * this.state.transform.xx,
                height: module1233.DOCK_FORBIDDEN_R * this.state.transform.yy * 2,
                left:
                  this.charger.x -
                  (module1233.DOCK_FORBIDDEN_R / 2) * this.state.transform.xx +
                  (module1233.DOCK_FORBIDDEN_R - module1233.Config.size.chargerWidth / 2) * this.state.transform.xx * 0.5 * Math.cos(this.degreeToRad(-this.charger.angle)),
                top:
                  this.charger.y -
                  module1233.DOCK_FORBIDDEN_R * this.state.transform.yy +
                  (module1233.DOCK_FORBIDDEN_R - module1233.Config.size.chargerWidth / 2) * this.state.transform.yy * 0.5 * Math.sin(this.degreeToRad(-this.charger.angle)),
                backgroundColor: '#00000033',
                borderColor: '#add8ff',
                borderWidth: 1,
                borderStyle: 'dashed',
                borderRadius: module1233.DOCK_FORBIDDEN_R * this.state.transform.yy,
    ...
    },
    {
      ...
      value: function () {
        ...
        var s = module1233.Config.size.robotRadius * this.state.transform.xx,
          o = module1233.Config.size.robotRadius * this.state.transform.yy;
        return React.default.createElement(
          module12.View,
          {
            pointerEvents: 'none',
          ...
          React.default.createElement(module925.default, {
            ...
            source: module1268.anim.Warning,
          })
        );
      },
    },
    {
      ...
      value: function () {
        ...
        var o = module1233.Config.size.robotRadius * this.state.transform.xx,
          n = module1233.Config.size.robotRadius * this.state.transform.yy;
    ...
    },
    {
      ...
      value: function (t) {
        var s = this,
          n = module1233.Config.size.robotRadius * this.state.transform.xx,
          h = module1233.Config.size.robotRadius * this.state.transform.yy,
    ...
    },
    {
      ...
      value: function (t, s) {
        var o = this,
          n = !this.props.hideAccessory && this.props.mapMode != module934.MAP_MODE_ZONED_CLEAN_EDIT && this.props.mapMode != module934.MAP_MODE_BLOCK_CLEAN_EDIT && s > 10;
        return React.default.createElement(module1239.AnimatedRobot, {
    ...
    },
    {
      ...
      value: function (t) {
        var s = this;
        return 1 != this.props.parent.state.inBlockMode && this.props.mapMode != module934.MAP_MODE_CARPET_EDIT
          ? React.default.createElement(module1241.ForbiddenView, {
              ref: function (t) {
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return Object.keys(this.rectReferences).map(function (o, n) {
          return React.default.createElement(module1239.CleanRect, {
            key: n,
            id: o,
          ...
          ? this.state.displayZones.map(function (s, o) {
              return React.default.createElement(module12.View, {
                ...
                style: {
                  ...
                  overflow: 'visible',
                  backgroundColor: module1233.buttonConfig.rectBgColor,
                  borderColor: module1233.buttonConfig.rectColorSolid,
                  borderWidth: 1,
                  borderStyle: 'solid',
                },
              });
              ...
              React.default.createElement(
                ...
                module21.default(
                  ...
                  b,
                  {
                    ...
                    showMapObjectName: this.props.mapMode == module934.MAP_MODE_REGULAR,
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return this.props.showSplitLine && 1 == o
          ? React.default.createElement(module1239.BlockOperation, {
              ref: function (t) {
                return (s.blockOp = t);
              },
              parent: this,
    ...
    },
    {
      ...
      value: function () {
        ...
        if (n == module1239.RoomInfoBubbleMode.None) return s;
        ...
        for (
          var h = this.props.parent.props.showAllBubbleInfo,
            l = function (l) {
              ...
              if (n == module1239.RoomInfoBubbleMode.Home) {
              ...
              if (t.props.parent.state.inBlockMode && t.props.parent.state.blockBubbleShowInfo & module1233.BlockBubbleShowInfo.CLEANSEQUENCE) {
              ...
              P = n == module1239.RoomInfoBubbleMode.EditArea ? -1 : P;
    ...
    },
    {
      ...
      value: function (t) {
        ...
        var n = React.default.createElement(module1265, {
            pointerEvents: 'none',
            layerScaleFilter: 'Nearest',
            style: t,
            source: {
            ...
            onLoad: this.props.imageOnloadCallback
              ? function (t) {
                  return s.mapSourceOnLoad(t.nativeEvent.source, module1233.shareViewLoadType.ONLOAD_CARPETMAP);
                }
              : null,
          }),
    ...
    },
    {
      ...
      value: function () {
        ...
        return t
          ? React.default.createElement(module1239.ObjectNameBubble, {
              funcId: 'map_carpet_bubble',
              objectName: module491.carpet_bubble_name,
              objectImage: module1326,
              center: t,
              topOffset: 10,
              transform: this.state.transform,
              textWidth: 70,
    ...
    },
    {
      ...
      value: function (t, s, o) {
        ...
        if (this.state.mopPath && '' != this.state.mopPath)
          l = React.default.createElement(module1264.RRShape, {
            transform: 'android' != module12.Platform.OS || z ? o : null,
    ...
    },
    {
      ...
      value: function (t) {
        var s = this;
        return React.default.createElement(module1241.CarpetsView, {
          ref: function (t) {
    ...
    },
    {
      ...
      value: function (t) {
        var s = this;
        return 1 != this.props.parent.state.inBlockMode && this.props.mapMode != module934.MAP_MODE_CARPET_EDIT
          ? React.default.createElement(module1241.FurnitureView, {
              ref: function (t) {
    ...
    },
    {
      ...
      value: function () {
        ...
        var u = module1233.Config.size.robotDiameter * this.state.transform.xx;
        ...
        var x = this.getCleanPath(h, l, s),
          ...
          B = this.props.mapMode == module934.MAP_MODE_REGULAR,
          S = !this.props.hideAccessory && this.props.mapMode != module934.MAP_MODE_ZONED_CLEAN_EDIT && this.props.mapMode != module934.MAP_MODE_BLOCK_CLEAN_EDIT && l > 10,
          T = this.props.mapMode == module934.MAP_MODE_CARPET_EDIT;
        ...
        return React.default.createElement(
          ...
          React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                module1265,
                {
                  ...
                  onLoad: this.props.imageOnloadCallback
                    ? function (s) {
                        return t.mapSourceOnLoad(s.nativeEvent.source, module1233.shareViewLoadType.ONLOAD_MAP);
                      }
                    : null,
                },
                y,
            ...
            this.getCleanRect(s),
            React.default.createElement(module1327, {
              ref: function (s) {
                return (t.target = s);
              },
              transform: s,
    ...
    },
    {
      key: 'clearRectFocus',
      value: function () {
        for (var t = 1; t <= module1233.MAX_COUNT_WALL_OR_FBZ; t++) {
          var s;
    ...
    },
    {
      ...
      value: function () {
        for (
          ...
          o <= module1233.MAX_COUNT_WALL_OR_FBZ;
          o++
        )
    ...
    },
    {
      key: 'setRectsMode',
      value: function (t) {
        for (var s = 1; s <= module1233.MAX_COUNT_WALL_OR_FBZ; s++)
    ...
    },
    {
      ...
      value: function (t) {
        ...
        if (this.carpetArea) {
          ...
          if (this.props.mapMode == module934.MAP_MODE_ZONED_CLEAN_EDIT && !this.addRectangle(this.carpetArea)) globals.showToast(module491.rubys_main_zone_max_tips);
    ...
    },
    {
      ...
      value: function () {
        var t = this;
        if (this.carpetTimer) module1247.clearTimeout(this.carpetTimer);
    ...
    },
    {
      ...
      value: function () {
        ...
        if (this.carpetTimer) module1247.clearTimeout(this.carpetTimer);
        this.carpetTimer = module1247.setTimeout(this.hideCarpetBubble.bind(this), 5e3);
      },
    },
    {
      key: 'moveMapIfNeeded',
    ...
    },
    {
      ...
      value: function (t) {
        ...
        if (t) {
          ...
          if (this.isRotated()) {
            var f = module1245._parseDegPoint(u, c, -1 * this.props.mapDeg),
    ...
    },
    {
      ...
      value: function () {
        var t = this;
        if (this.chargerTimer) module1247.clearTimeout(this.chargerTimer);
    ...
    },
    {
      ...
      value: function (t) {
        ...
        if (!(t && t.length)) this.chargerTimer = module1247.setTimeout(this.hideChargerBubble.bind(this), 5e3);
      },
    },
    {
      ...
      value: function () {
        ...
        var t = this.props.mapMode != module934.MAP_MODE_ZONED_CLEAN_EDIT ? this.carpetArea.realX : this.carpetArea.x,
          s = this.props.mapMode != module934.MAP_MODE_ZONED_CLEAN_EDIT ? this.carpetArea.realY : this.carpetArea.y,
          o = this.props.mapMode != module934.MAP_MODE_ZONED_CLEAN_EDIT ? this.carpetArea.realW : this.carpetArea.width,
          n = this.props.mapMode != module934.MAP_MODE_ZONED_CLEAN_EDIT ? this.carpetArea.realH : this.carpetArea.height,
    ...
    },
    {
      ...
      value: function () {
        var t = this.charging ? this.robotPos.x : this.charger.x,
          ...
          o = (module1233.Config.size.robotRadius * (this.state.transform.yy || 1)) / 2,
          n = {
            x: t,
            y: s - o,
          };
    ...
    },
    {
      ...
      value: function (t) {
        for (var s = 0, o = 1; o <= module1233.MAX_COUNT_WALL_OR_FBZ; o++) t[o] && t[o].state.visible && s++;
    ...
    },
    {
      ...
      value: function () {
        ...
        s -= module1233.DEFAULT_FBZ_REALHEIGHT / 2;
        var o = -1 != t ? ((t - 1) * module1233.DEFAULT_RECT_MARGIN) / 2 : 0,
          n = {
            x: module1233.RectConfig.initSize.x + o,
            y: s + o,
          },
          h = {
            width: this.justifyRealSize(module1233.DEFAULT_FBZ_REALWIDTH),
            height: this.justifyRealSize(module1233.DEFAULT_FBZ_REALHEIGHT),
          };
    ...
    },
    {
      ...
      value: function (t) {
        ...
        var s = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : null,
          o = module1233.FurnitureSize[t],
          n = o ? o.maxWidth : module1233.FurnitureSize[module1233.FurnitureType.FT_BED].maxWidth,
          h = o ? o.maxHeight : module1233.FurnitureSize[module1233.FurnitureType.FT_BED].maxHeight,
          l = {
            width: n,
            height: h,
          },
    ...
    },
    {
      ...
      value: function (t) {
        var s = this.props.parent.getMapViewHeight() / 2,
          o = ((t - 1) * module1233.DEFAULT_RECT_MARGIN) / 2,
          n = {
            x: module1233.wallConfig.initSize.start_x + o,
            y: s + o,
          },
          h = this.justifyRealSize(module1233.DEFAULT_FBZ_REALWIDTH),
    ...
    },
    {
      ...
      value: function (t) {
        ...
        if (s + 6 < module1233.RectConfig.minLength) {
          h -= (module1233.RectConfig.minLength - s) / 2;
          s = module1233.RectConfig.minLength;
        } else {
          h -= 3;
          s += 6;
        }

        if (o + 6 < module1233.RectConfig.minLength) {
          l -= (module1233.RectConfig.minLength - o) / 2;
          o = module1233.RectConfig.minLength;
        } else {
          l -= 3;
          o += 6;
        }
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return (s ** module1233.RectConfig.maxLength) ** module1233.RectConfig.minLength;
      },
    },
    {
...
exports.default = module1338;
module1338.contextType = module506.AppConfigContext;
module1338.propTypes = {
