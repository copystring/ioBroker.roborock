                  ...
                  switch ((o.prev = o.next)) {
                    case 0:
                      ...
                      this.resultTimerList.forEach(function (t) {
                        if (!(module1366.isTimerExpiredByRepeatMode(t.repeatMode, t.fullDate + ':59') && 0 != module377.RSM.FCCState)) module22.push(t);
                      });
                  ...
                  switch ((T.prev = T.next)) {
                    case 0:
                              ...
                              switch ((n.prev = n.next)) {
                                case 0:
                                  if (
                                    ...
                                    (S = module1365.ConvertToReadableFormat(o.setting.on_time)),
                                    (L = module1366.fixTargetTime(S)),
                                    (O = module1366.convertToPhoneTimeZoneTime(S.minute, S.hour, S.dateofmonth, S.month)),
                                    (w = O.hour),
                                    (M = O.minute),
                                    (k = new Date()),
                                    (P = k.getFullYear()),
                                    1 == O.month && 1 == O.day && k.getMonth() + 1 == 12 && 31 == k.getDate() && (P += 1),
                                    (R = '' + P + module1366.addZeroPrefix(O.month) + module1366.addZeroPrefix(O.day)),
                                    (D = R + ' ' + module1366.addZeroPrefix(w) + ':' + module1366.addZeroPrefix(M)),
                                    !(C = module1366.isTimerExpired(S.repeat, D + ':59', false)))
                                  ) {
                                    n.next = 20;
                                    break;
                                  }

                                  module1366.deleteServerTimer(o, h);
                                  console.log('task is outOfDate - date-' + D + ' - ' + h + ' - ' + C);
                                  return n.abrupt('return');

                                case 20:
                                  if ((F = module1366.getRepeatMode(S.repeat, false)) != module1366.RepeatMode.Once)
                                    O.month == L.month
                                      ? O.day == L.day + 1
                                        ? (F = module1366.getDaysArrByOffset(F, 1))
                                        : O.day == L.day - 1 && (F = module1366.getDaysArrByOffset(F, -1))
                                      : (F = 1 == O.day ? module1366.getDaysArrByOffset(F, 1) : module1366.getDaysArrByOffset(F, -1));
                                  _ = module1366.timerRepeatToCronRepeat(F);
                                  N = module1366.getTextOfRepeatPattern(_, R, false);
                                  I = module1366.addZeroPrefix(O.hour) + ' : ' + module1366.addZeroPrefix(O.minute);
                                  J = module1366.convetToWeekendsByStartTime(F, S.dateofmonth, S.month);
                                  Z = v(
                                    {
                                      name: h,
                                      hour: O.hour,
                      ...
                      module4.forEach(function (t) {
                        ...
                        if (n) module1363.push(n);
                      });
                      this.miTimerScenes = module1363;
                    ...
                    switch ((B.prev = B.next)) {
                      ...
                      case 6:
                        if (
                          ...
                          (O = S[1]),
                          '00000000' == o.date &&
                            ((w = new Date()), (o.date = '' + w.getFullYear() + module1366.addZeroPrefix(w.getMonth() + 1) + module1366.addZeroPrefix(w.getDate()))),
                          (M = o.date + ' ' + o.time),
                          (k = module1363.default(M, 'YYYYMMDD HH:mm')),
                          console.log('date date - ' + k.date() + ' - ' + (k.month() + 1)),
                          (P = module1366.convertTimeFromSourceZoneToPhoneZone(O, L, k.date(), k.month() + 1, module389.robotTimeZone)),
                          (L = P.hour),
                          (O = P.minute),
                          (M = o.date + ' ' + module1366.addZeroPrefix(L) + ' : ' + module1366.addZeroPrefix(O)),
                          !module1366.isTimerExpired(o.loops, M + ':59', true))
                        ) {
                          B.next = 22;
                          break;
                        }
                        ...
                        B.next = 20;
                        return regeneratorRuntime.default.awrap(module1366.deleteServerTimer(o.timerId, T));

                      case 20:
                        console.log('task is outOfDate - date-' + o.date + ' ' + o.time + ' - ' + module1366.isTimerExpired(o.loops, M + ':59', true));
                        return B.abrupt('return');

                      case 22:
                        R = module1366.getRepeatMode(o.loops, true);
                        R = module1366.resolveRepeatModeByTargetTime(R, k.month() + 1, k.date(), P.month, P.day);
                        R = module1366.getRepeatMode(R, true);
                        D = module1366.getTextOfRepeatPattern(R, o.date, true);
                        C = module1366.convetToWeekendsByStartTime(R, P.dateofmonth, P.month);
                        ...
                        _ = v(
                          {
                            ...
                            date: o.date,
                            timerId: o.timerId,
                            cleanTime: module1366.addZeroPrefix(L) + ' : ' + module1366.addZeroPrefix(O),
                            repeatMode: R,
                            repeatModeText: D,
                            startWeekdays: C,
                            disable: F,
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (t[0].constructor == Object) {
              ...
              T = b.clean_mop;
              v = b.mop_template_id;
              y = module1352.ModeDataInstance.getCustomMopModeNameById(v);
            } else {
                            ...
                            for (;;)
                              switch ((n.prev = n.next)) {
                                case 0:
                                  ...
                                  v = T[0];
                                  y = T[1];
                                  S = module1365.ConvertToReadableFormat(v);
                                  L = 0;
                                  O = [];
                                  w = 0;
                                  M = 0;
                                  ...
                                  if (
                                    ...
                                    R = _.clean_mop;
                                    D = _.mop_template_id;
                                    C = module1352.ModeDataInstance.getCustomMopModeNameById(D);
                                  } else {
                                  ...
                                  Z = '' + new Date().getFullYear() + module1366.addZeroPrefix(S.month) + module1366.addZeroPrefix(S.dateofmonth);
                                  j = Z + ' ' + module1366.addZeroPrefix(S.hour) + ':' + module1366.addZeroPrefix(S.minute);
                                  B = module1366.getRepeatMode(S.repeat, false);
                                  E = module1366.getTextOfRepeatPattern(S.repeat, Z, false);
                                  H = module1366.addZeroPrefix(S.hour) + ' : ' + module1366.addZeroPrefix(S.minute);
                                  A = module1366.convetToWeekendsByStartTime(B, S.dateofmonth, S.month);
                                  Y = {
                                    name: l,
                                    hour: S.hour,
                                    minute: S.minute,
                ...
                for (;;)
                  switch ((u.prev = u.next)) {
                    case 0:
                      ...
                      u.next = 4;
                      return regeneratorRuntime.default.awrap(module1366.deleteServerTimer(module49, module22.name));
                    ...
                    case 3:
                      if (this.resultTimerList)
                        this.resultTimerList.forEach(function (n) {
                          var o = module1365.GetExecDate(n.hour, n.minute, module1366.timerRepeatToCronRepeat(n.repeatMode)),
                            u = new Date();
