      ...
      },
      {
        ...
        value: function () {
          var t = this.state.tab,
            n = t == module1345.TabSegment,
            o = t == module1345.TabZone,
          ...
          return module377.RSM.hasGotMapFirstTime
            ? React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  module377.RSM.isExploring && React.default.createElement(module1803.default, null)
                )
              )
            : null;
        },
      ...
      },
      {
        ...
        value: function (t, n, o) {
          ...
          this.setState({
            ...
            smallWaterModeIcon: h ? null : module415.DMM.isGarnet ? (null == (l = module1352.ModeDataInstance.getCustomMopModeConfigById(o)) ? undefined : l.icon) : u.homesmall,
...
var W = module12.StyleSheet.create({
  wrapContainer: {
    ...
    height: 200,
    marginBottom: -module1063.TabWrapHeight,
  },
  container: {
    flexDirection: 'row',
  ...
  leftContainer: {
    marginBottom: module1063.TabWrapHeight + 10,
    marginLeft: 22,
  },
  loadMapButton: {
