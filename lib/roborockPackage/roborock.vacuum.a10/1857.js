    ...
    module5.default(j, [
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    c.prev = 2;
                    if (!(module1362.TLM.resultTimerList && 0 != module1362.TLM.resultTimerList.length)) t = true;
                    c.next = 6;
                    return regeneratorRuntime.default.awrap(module1362.TLM.fetchTimerList(t));

                  case 6:
                    if (module1362.TLM.resultTimerList || !(this.retryTime < 7)) {
                      c.next = 9;
                      break;
                    }
                  ...
                  case 9:
                    l = null != (o = module1362.TLM.resultTimerList) ? o : [];
                    console.log('fetchTimerList ' + module1362.TLM.resultTimerList);
                    this.finishLoading();
                    this.retryTime = 0;
                    this.setState({
                      loading: false,
                  ...
                  for (;;)
                    switch ((l.prev = l.next)) {
                      case 0:
                        l.prev = 0;
                        l.next = 3;
                        return regeneratorRuntime.default.awrap(module1362.TLM.fetchTimerList(true));

                      case 3:
                        s = null != (o = module1362.TLM.resultTimerList) ? o : [];
                        t.finishLoading();
                        t.setState({
                          loading: false,
                          refreshing: false,
            ...
            function (o) {
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    o.next = 2;
                    return regeneratorRuntime.default.awrap(module1362.TLM.deleteServerTimer(t));
              ...
              for (;;)
                switch ((u.prev = u.next)) {
                  case 0:
                    u.prev = 0;
                    u.next = 3;
                    return regeneratorRuntime.default.awrap(module1362.TLM.deleteRobotTimer(t));
                  ...
                  case 3:
                    ...
                    u.next = 8;
                    return regeneratorRuntime.default.awrap(module1362.TLM.fetchTimerList(false));
      ...
      },
      {
        ...
        value: function (t, n, o) {
          var s = this;
          if (0 == Object.keys(n).length && (module1362.TLM.totalTimerCount >= 10 || this.state.timerlist.length >= 10))
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this.openSettingPage(true, n, module389.isMiApp && 1 == this.FCCState ? module1362.TLM.miTimerScenes[t] : 0);
        },
      },
      {
              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    ...
                    l.prev = 2;
                    l.next = 5;
                    return regeneratorRuntime.default.awrap(module1362.TLM.updateTimerOnStatus(t, module49, o));
      ...
      },
      {
        ...
        value: function (t) {
          if (module415.DMM.isGarnet) {
            var n = module1859.getCleanMethods()[t.cleanMethod];
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (
            ...
            if (((o = module1859.getCleanMethods()[t.cleanMethod]), (l = t.mopModeName), t.cleanMethod == module1859.CleanMethodClean)) return o + ' | ' + n;
            if (t.cleanMethod == module1859.CleanMethodMop) return o + ' | ' + l;
            if (t.cleanMethod == module1859.CleanMethodCleanAndMop) return o + ' | ' + n + ' | ' + l;
          }
