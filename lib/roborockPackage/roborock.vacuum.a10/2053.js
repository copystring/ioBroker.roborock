      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            s = c.style,
            l = c.calling,
            module2050 = this.props.isLandscape ? require('./2050') : this.context.theme.monitor.call,
            module2054 = this.props.isLandscape ? require('./2054') : this.context.theme.monitor.hung,
            v = l ? module2054 : module2050,
