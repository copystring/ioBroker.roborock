          ...
          if (module389.isMiApp) {
            var l = module389.SETTING_KEYS,
              ...
              p = React.default.createElement(module389.CommonSetting, {
                ...
                extraOptions: {
                  licenseUrl: module1376.default.UserAgreement(),
                  policyUrl: module1376.default.UserPrivacyProtocol(),
                },
              }),
            ...
            return React.default.createElement(
              ...
              React.default.createElement(module1854.default, {
                ref: function (n) {
                  t.randomCodeView = n;
                },
              })
      ...
      },
      {
        ...
        value: function () {
          this.props.navigation.navigate('WiFiDebugPage', {
            title: module491.wifi_debug_mode_title1,
            refrence: module1376.default.WiFiPrivacy(),
          });
        },
      },
      {
