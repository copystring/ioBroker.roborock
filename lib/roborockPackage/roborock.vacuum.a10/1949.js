    ...
    module5.default(S, [
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              this.renderCircles(),
              this.renderLines(),
              React.default.createElement(module1951.default, {
                ref: 'line',
                color: o,
              })
            ),
      ...
      },
      {
        ...
        value: function (t) {
          ...
          for (var s = module1950.getMiddlePoint(this.state.circles[n], this.state.circles[t]), o = 0; o < '13457'.length; o++) {
            var l = '13457'[o];
            if (module1950.isEquals(s, this.state.circles[l])) return String(l);
          }
      ...
      },
      {
        ...
        value: function (t, n) {
          ...
          if (this.isMoving) {
            var o = module1950.getRealPassword(this.sequence);
            this.sequence = '';
            this.lastIndex = -1;
            this.isMoving = false;
            var l = {
