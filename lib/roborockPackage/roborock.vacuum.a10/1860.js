...
var module491 = require('./491').strings,
  ...
  Z = (function (t) {
    ...
    function J(t) {
      ...
      s.originalRepeatMode = u.repeatMode || module1366.RepeatMode.Once;
      ...
      s.state = {
        ...
        repeatMode: u.repeatMode || module1366.RepeatMode.Once,
        ...
        mopModeName: s.editMode ? u.mopModeName : null == (n = module1352.ModeDataInstance.modePannelCustomMops[0]) ? undefined : n.name,
        mopModeId: s.editMode ? u.mopModeId : null == (o = module1352.ModeDataInstance.modePannelCustomMops[0]) ? undefined : o.id,
        currentCleanMethod: undefined == u.cleanMethod ? module1859.CleanMethodMop : u.cleanMethod,
    ...
    module5.default(J, [
      {
        ...
        value: function () {
          ...
          module1229.MM.shouldForceStart = true;
          module1229.MM.start();
          ...
          this.modeChangeHandler = function () {
            ...
            if (
              !(
                -1 !=
                module1352.ModeDataInstance.modePannelCustomMops.findIndex(function (n) {
                  return n.id == t.setState.mopModeId;
                })
              )
            )
              t.setState({
                mopModeId: null == (n = module1352.ModeDataInstance.modePannelCustomMops[0]) ? undefined : n.id,
                mopModeName: null == (o = module1352.ModeDataInstance.modePannelCustomMops[0]) ? undefined : o.name,
              });
          };

          module1352.ModeDataInstance.addChangeListener(this.modeChangeHandler);
        },
      },
      {
        key: 'componentWillUnmount',
        value: function () {
          module1229.MM.shouldForceStart = false;
          module1229.MM.stop();
          module1352.ModeDataInstance.removeChangeListener(this.modeChangeHandler);
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          var t = module1229.MM.getMapConfigById(this.segmentMapId) || {
      ...
      },
      {
        ...
        value: function () {
          ...
          if (this.state.currentCleanMethod == module1859.CleanMethodClean && 301 == o) o = 300;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (4 == t) {
            ...
            this.hideModalView(function () {
              n.setState({
                repeatMode: module1366.IndexRepeatMap[t],
                shouldShowFrequenceView: false,
              });
            });
        },
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            o = module1366.timerRepeatToCronRepeat(this.state.repeatMode),
            s = -1,
            l = -1;

          if (this.state.repeatMode == module1366.RepeatMode.Once) {
            var u = new Date(),
              h = u.getHours() == this.state.hour && u.getMinutes() == this.state.minute,
              c = module1363.default();
          ...
          if (this.isRepeatTimer(l, s)) globals.showToast(module491.set_timer_dup);
            ...
            var M = module1365.ConvertToCronStr(this.state.hour, this.state.minute, o, l, s);

            if (module389.isMiApp && 1 == this.FCCState) {
              var S = module1366.convertToBeijingTime(this.state.minute, this.state.hour, l, s),
                w = this.state.repeatMode;

              if (this.state.repeatMode != module1366.RepeatMode.Once && this.state.repeatMode != module1366.RepeatMode.Everyday) {
                var _ = new Date();

                if (S.month == _.getMonth() + 1)
                  S.day == _.getDate() + 1
                    ? (w = module1366.getDaysArrByOffset(this.state.repeatMode, 1))
                    : S.day == _.getDate() - 1 && (w = module1366.getDaysArrByOffset(this.state.repeatMode, -1));
                else w = 1 == S.day ? module1366.getDaysArrByOffset(this.state.repeatMode, 1) : module1366.getDaysArrByOffset(this.state.repeatMode, -1);
              }

              o = module1366.timerRepeatToCronRepeat(w);
              M = module1365.ConvertToCronStr(S.hour, S.minute, o, S.day, S.month);
            }
      ...
      },
      {
        ...
        value: function (t, o, s, l) {
          var u, h, c, p, f, M, S, w, _, y, module1363, module390, module378, module1229, module1862, module1863;
              ...
              for (;;)
                switch ((I.prev = I.next)) {
                  ...
                  case 29:
                    ...
                    module390 = module1366.convertToTargetTime(this.state.minute, this.state.hour, s, l, module389.robotTimeZone);
                    module378 = module390.hour + ':' + module1366.addZeroPrefix(module390.minute);
                    module1229 = module1366.getLoopStringOfRepeatMode(this.state.repeatMode);
                    module1862 = new Date();
                    module1863 = module1366.resolveRepeatModeByTargetTime(module1229, module1862.getMonth() + 1, module1862.getDate(), module390.month, module390.day);
                    console.log('loops -- time - ' + module378 + ' - loop -' + module1863 + ' -repeat-' + this.state.repeatMode + ' - timerId- ' + this.timerId);
                    I.next = 38;
                    return regeneratorRuntime.default.awrap(module389.rrAddOrEditTimer(module378, module1863, module1363, this.timerId));
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(module381.SettingListItemView, {
                ...
                bottomDetail: module1366.getTextOfRepeatMode(this.state.repeatMode, this.date),
              ...
              l &&
                !u &&
                React.default.createElement(module1861.default, {
              ...
              u &&
                React.default.createElement(module1862.default, {
                  style: K.mapSegmentSettingView,
                  ref: function (n) {
                    t.mapSegmentSettingView = n;
                  },
      ...
      },
      {
        ...
        value: function () {
          return this.state.currentCleanMethod == module1859.CleanMethodNoSet ? module491.timer_setting_no_setting : module1859.getCleanMethods()[this.state.currentCleanMethod];
        },
      },
      {
        ...
        value: function () {
          ...
          if (module386.default.isShakeMopSetSupported() && 200 != this.state.waterMode) {
            ...
            if (t) {
              if (n == module1859.CleanMethodClean) return l;
              if (n == module1859.CleanMethodMop) return u;
              if (n == module1859.CleanMethodCleanAndMop) return l + ' | ' + u;
            }
          }
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = module1366.RepeatIndexMap[this.state.repeatMode];
          if (undefined == n) n = 4;
          return React.default.createElement(module1115.ActionSheetView, {
            title: module491.localization_strings_Setting_Timer_SettingPage_1,
            actions: module1366.RepeatMenuItems(),
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = module1366.isCustomMode(this.state.repeatMode) ? [0, 0, 0, 0, 0, 0, 0] : this.state.repeatMode.split('');
          return React.default.createElement(module1867, {
            selectedItems: n,
            cancel: function (n) {
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(module1115.ActionSheetView, {
            title: module491.timer_setting_clean_method,
            actions: module1859.getCleanMethods(),
            didSelectRow: function (n) {
      ...
      },
      {
        ...
        value: function () {
          return this.state.hasSetTime || this.editMode
            ? module1366.addZeroPrefix(this.state.hour) + ' : ' + module1366.addZeroPrefix(this.state.minute)
      ...
      },
      {
        key: 'isRepeatTimer',
        value: function (t, n) {
          for (var o = module1366.convetToWeekendsByStartTime(this.state.repeatMode, t, n), s = 0; s < this.timerList.length; s++) {
            ...
            if (!this.editMode || l.hour != this.originalHour || l.minute != this.originalMinute || JSON.stringify(u) !== JSON.stringify(this.originStartWeekdays)) {
              ...
              if (l.repeatMode == module1366.RepeatMode.Once && l.hour == this.state.hour && l.minute == this.state.minute) return true;
            }
          }
      ...
      },
      {
        ...
        value: function () {
          if (module415.DMM.isGarnet)
            (this.state.currentCleanMethod != module1859.CleanMethodNoSet && this.state.hasSetTime) || this.editMode
