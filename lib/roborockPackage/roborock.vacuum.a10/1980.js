  ...
  I = (function (t) {
    ...
    module5.default(R, [
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            o = module1342.default.confirmButton(this.onNavigationSavePress.bind(this), n, function (n) {
              t.mapSaveButton = n;
            }),
            s = module1342.default.guideButton(
          ...
          module1342.default.setNavigation(this, globals.isRTL ? [o, s] : [s, o], this.onNavigationBackPress.bind(this));
        },
      },
      {
        key: 'registListeners',
      ...
      },
      {
        ...
        value: function () {
          var t;
          if (!(null == (t = this.mapView))) t.setState(Z({}, module1229.MM.mapData));
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            o = this.state.mapStatus != module377.MapStatus.None && module1229.MM.maps.length >= 1 && -1 == n && module377.RSM.multiFloorEnabled,
            ...
            module386.default.isMultiFloorSupported()
              ? o
                ...
                ? -1 == n
                  ...
                  : ((n = module1229.MM.maps[0].id), this.startMapSave(n, u, s))
      ...
      },
      {
        ...
        value: function (t, n, o) {
          ...
          module1247.setTimeout(function () {
            return module1229.MM.saveMap(false, t, n, o, s.onMapSaveCompleted.bind(s));
          }, 500);
        },
      },
      {
      ...
      },
      {
        ...
        value: function (t) {
          if (t == module1229.CurrentMapId) this.singleFloorSaveNewMapAlert.show();
          else {
            var n = (this.mapView && this.mapView.getFBZParams()) || [],
              o = (this.mapView && this.mapView.getWallsParams()) || [];
        ...
        value: function (t) {
          ...
          this.toggleMultiMapFeature(t)
            .then(function () {
              ...
              n.startMapSave(module1229.CurrentMapId, o, t);
            })
            .catch(function (o) {
              n.setState({
                multiFloorEnabled: !t,
      ...
      },
      {
        ...
        value: function (t) {
          ...
          return t
            ? new module1800.default(function (t, n) {
                module407.default
                  .setLabStatus({
                    lab_status: 3,
                  })
            ...
            : new module1800.default(function (t, n) {
                module407.default
                  .setLabStatus({
                    lab_status: 1,
                    reserve_map: module1229.MM.maps[0].id,
                  })
                  .then(function (n) {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            s = this.state.mapStatus == module377.MapStatus.None ? module1342.default.getNoMapTipView(this.state.mapStatus) : o,
            u = React.default.createElement(module1241.MapSaveActionSheetView, {
              ref: function (n) {
                return (t.singleFloorSaveNewMapActionSheet = n);
              },
              mode: module1241.MapSaveActionSheetMode.SingleFloorWithoutSave,
              handleSaveMap: function (n) {
                return t.onTapSingleFloorSaveActionSheet.apply(t, [n]);
              },
            }),
            l = React.default.createElement(module1933.SingleFloorSaveNewMapAlert, {
              ref: function (n) {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module1324.default, {
              type: module1324.MenuType.Menu_Fbz,
              ref: function (n) {
                return (t.editMenu = n);
              },
            ...
            React.default.createElement(module1806.default, {
              ...
              context: module1342.default.isMopForbiddenSupported()
