        ...
        var module1958 = this.getInnerFailedView(require('./1958'), module491.map_object_bubble_tip_no_photo),
          ...
          module1960 = React.default.createElement(
            ...
            React.default.createElement(
              ...
              u,
              this.state.readPhotoLoadingStatus == D.LOADING && module1276,
              this.state.readPhotoLoadingStatus == D.FAILED && module1959,
              this.state.readPhotoLoadingStatus == D.NOPHOTO && module1958
            )
          ),
          ...
          module1979 = this.state.isSure ? require('./1979') : o.monitor.confirmPhoto;
        return React.default.createElement(
          module12.View,
          {
            style: [
          ...
          React.default.createElement(
            ...
            React.default.createElement(
              ...
              (module386.default.isFwFilterObstacleSupported() && module1361.default.mapObjectPhotoEnabled) ||
                (module386.default.isFwFilterObstacleSupported() && module1361.default.mapObjectPhotoEnabled && 18 == s)
                ? module1960
                : module1961,
              React.default.createElement(
                module12.Text,
