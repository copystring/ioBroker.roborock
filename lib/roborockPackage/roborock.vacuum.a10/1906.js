  ...
  B = (function (t) {
    ...
    module5.default(O, [
            ...
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 8:
                    this.timer = module1247.setInterval(this.getProgess.bind(this), 1e3);
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    o.next = 4;
                    return regeneratorRuntime.default.awrap(module1909.default.getListDataFromLocal());
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module1911.default, {
            ref: function (n) {
      ...
      },
      {
        key: '_renderRow',
        value: function (t, n) {
          return React.default.createElement(module1907.default, {
              ...
              for (;;)
                switch ((v.prev = v.next)) {
                  ...
                  case 3:
                    ...
                    module1247.clearInterval(this.timer);
                    this.downloading = false;
                    this.setState({
                      progress: -1,
                      currentDownloadVoiceId: -1,
                    });
                    module1907 = module491.sound_package_installed_failed;
                    if (!(13 != c && 2 != c)) module1907 = module491.sound_package_download_failed;
                    globals.showToast(module1907);
