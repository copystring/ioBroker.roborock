...
var j = function (t, o) {
  ...
  Object.keys(t).forEach(function (t) {
    ...
    module942.default(null === n || 'string' == typeof n, 'Route path for ' + t + ' must be specified as a string, or null.');
    var c = null !== n,
      l = [],
      s = c ? module948.default(n, l) : null,
      v = [],
      y = '' === n || !c,
      P = module948.default(y ? '*' : n + '/*', v);
    h[t] = {
      exactRe: s,
      exactReKeys: l,
      extendedPathRe: P,
