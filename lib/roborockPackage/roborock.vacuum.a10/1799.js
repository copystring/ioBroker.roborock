          ...
          value: function (t) {
            var n = t ? 1 : 0,
              u = module386.default.isMultiFloorSupported()
                ...
                : n;
            return new module1800.default(function (n, o) {
              module407.default
                .setLabStatus(u)
                .then(function () {
  ...
  module5.default(u, [
    {
      key: 'getData',
      value: function () {
        return new module1800.default(function (t, n) {
          module407.default
            .getRecoverMaps()
            .then(function (n) {
              var u = n.result,
    ...
    },
    {
      key: 'getMapData',
      value: function (t) {
        return new module1800.default(function (n, u) {
                ...
                c = o.map_info
                  .map(function (t) {
                    return {
                      id: t.mapFlag,
                      time: t.add_time,
                      name: t.name ? module1243.FloorMapPageUtils.getRealName(t.name) : '' + module491.floor_map_default_name_prefix + (t.mapFlag + 1),
                      length: t.length,
                    };
                  })
                  .sort(function (t, n) {
