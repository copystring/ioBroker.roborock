    ...
    module5.default(C, [
      {
        ...
        value: function () {
          var t = this.props.isLoadMap,
            n = module414.MM.maps.findIndex(function (t) {
      ...
      },
      {
        ...
        value: function () {
          var t = {
            ...
            s = n.isLoadMap,
            l = n.isHomePage;
          return (module381.RSM.multiFloorEnabled || 0 == module414.MM.maps.length) && o && !s && !l ? [t].concat(module414.MM.maps) : module414.MM.maps;
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            module1259 = this.state.maps.map(function (n, module1258) {
              return React.default.createElement(
                module12.View,
                {
                  ...
                  style: [
                    E.mapItem,
                    {
                      opacity: o && module414.MM.maps.length >= module414.MM.mapCountMax && 0 == module1258 ? 0.5 : 1,
                    },
                  ],
                },
                React.default.createElement(
                  ...
                  -1 != n.id ? (t.props.isOverwriteMode ? module505.map_save_pop_box_overwrite : t.props.isLoadMap ? '' : module505.map_edit_button_text_save) + n.name : n.name
                ),
                React.default.createElement(module385.PureImageButton, {
                  ...
                  selected: module1258 == t.state.current,
                  onPress: t.selectItem.bind(t, module1258),
                })
              );
            }),
            ...
            u = this.props.isLoadMap ? module505.home_load_map_title : this.props.isOverwriteMode ? module505.save_map_pop_box_save_title1 : module505.save_map_pop_box_save_title2;
          return React.default.createElement(
            module12.Modal,
            {
              transparent: true,
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (!this.props.isHomePage && module381.RSM.multiFloorEnabled && this.props.isOverwriteMode && module414.MM.maps.length >= module414.MM.mapCountMax && 0 == t) {
            this.hide();
