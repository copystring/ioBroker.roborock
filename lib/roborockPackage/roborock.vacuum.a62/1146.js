...
var p = function t(n, s, p) {
  ...
  var O = module1148.default(n.router, y.routeName),
    b = y.routes && 'number' == typeof y.index ? y.routes[y.index] : null,
    P = f(f(f(f({}, n.actions), n.router.getActionCreators(y, n.state.key)), O ? O.getActionCreators(b, y.key) : {}), module1144.default(y)),
    j = {};
  ...
  var h = module1147.default(n.addListener, s);
  v[s] = f(
    f({}, j),
    {},
    {
