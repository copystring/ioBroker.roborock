  ...
  z = (function (t) {
    ...
    module5.default(O, [
      ...
      },
      {
        ...
        value: function () {
          module1421.default.shared().enableBackAndMore();
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            p = l.parent,
            c = l.isSmartScene,
            M = (u && (null == p ? undefined : p.tabIndex) == module1546.TabZone) || this.props.isTabZone,
            f = null;
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module390.default.isPureCleanMopSupported())
            this.waterMode == module1543.WaterModeZero ? (t = 2) : this.cleanMode == module1543.CleanModeZero ? (t = 1) : this.state.isCustomMode && (t = 3);
          return t;
        },
      },
      {
        ...
        value: function () {
          ...
          var p = n && module390.default.isSoftCleanModeSupportedInMain() ? 0 : 1,
            c = module1543.CleanModes().slice(p, module1543.CleanModes().length);
          if (module390.default.isMaxPlusModeSupported()) c.pop();

          var M = !u && h,
            _ = M && n && module390.default.isSoftCleanModeSupportedInMain() && this.cleanMode == module1543.CleanModeZero,
      ...
      },
      {
        ...
        value: function () {
          ...
          return module390.default.isCustomWaterBoxDistanceSupported() && 207 == module381.RSM.waterBoxMode && o
            ? React.default.createElement(module1557.SliderAdjuster, {
                title: null,
                style: {
                  backgroundColor: 'transparent',
                },
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            k = module1543.MopMethods();
          if (module390.default.isCleanRouteFastModeSupported() && -1 == module381.RSM.currentMapId) k.shift();
          if (x) k = [module1543.CleanRouteFast(), module1543.CleanRouteDaily()];
          else if (v) k = module1543.MopMethods();
          else if (y) k = [module1543.CleanRouteFast(), module1543.CleanRouteDaily()];
      ...
      },
      {
        ...
        value: function () {
          ...
          var x = module1543.MopWaterOrStrengths();
            ...
            c &&
              React.default.createElement(module384.default, {
                ...
                addonTip: module390.default.isPureCleanMopSupported()
                  ? null
                  : C && module381.RSM.isWaterBoxIn && l && module381.RSM.waterBoxMode == module1543.WaterModeZero
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(module1539.SwipeDownIndicator, {
                  style: {
                    marginBottom: 10,
                  },
                }),
                (!s || module390.default.isPureCleanMopSupported()) &&
                  React.default.createElement(module1556.default, {
                    tabs: this.tabs,
            ...
            function (W) {
              for (;;)
                switch ((W.prev = W.next)) {
                  case 0:
                    if (
                      (module1421.default.shared().disableBackAndMore(),
                  ...
                  case 10:
                    if (
                      ...
                      (this.waterMode = S),
                      (this.mopMode = f),
                      (C = module1543.isModeCustomized(M, S, f) && !h),
                      (x = module390.default.isPureCleanMopSupported() && M == module1543.CleanModeZero),
                      (v = module390.default.isPureCleanMopSupported() && S == module1543.WaterModeZero),
                      module390.default.isPureCleanMopSupported()
                        ? ((k = S != module1543.WaterModeZero && M != module1543.CleanModeZero),
                          (P = 0),
                          x ? (P = 1) : v ? (P = 2) : C && (P = 3),
                    ...
                    if (M == module1543.CustomCleanMode) M = module1543.CleanModes()[2].strength;
                    if (S == module1543.CustomWaterMode) S = module1543.MopWaterOrStrengths()[2].strength;
                    if (f == module1543.CustomMopMode) f = module1543.MopMethods()[0].strength;
                  ...
                  case 30:
                    this.setState(
                      ...
                      function () {
                        if (E.cleanModeSetView) E.cleanModeSetView.setMode(M, module1543.CustomCleanMode);
                        if (E.waterModeSetView) E.waterModeSetView.setMode(S, module1543.CustomWaterMode);
      ...
      },
      {
        ...
        value: function (t, o, n) {
          if (this.cleanModeSetView) this.cleanModeSetView.setMode(t, module1543.CustomCleanMode);
          if (this.waterModeSetView) this.waterModeSetView.setMode(o, module1543.CustomWaterMode);
              ...
              for (;;)
                switch ((M.prev = M.next)) {
                  ...
                  case 35:
                    ...
                    this.showToast(module505.robot_communication_exception);
                    if (this.waterModeSetView) this.waterModeSetView.setMode(t, module1543.CustomWaterMode);
              ...
              for (;;)
                switch ((K.prev = K.next)) {
                  case 0:
                    ...
                    K.t0 = module1543.CustomCleanMode;
                    K.next = 17;
                    break;
                  ...
                  case 17:
                    ...
                    K.t4 = module1543.CustomWaterMode;
                    K.next = 30;
                    break;
                  ...
                  case 43:
                    if (
                      ...
                      !p &&
                        (function () {
                          if (module390.default.isCleanRouteFastModeSupported()) {
                            if (!(c || (C != module1543.CleanRouteSubtlyMode && C != module1543.CleanRouteDeepSlowMode))) C = 300;
                          } else if (!c) C = 300;
                          if (C == module1543.CustomMopMode) C = 300;
                        })(),
                      module390.default.isPureCleanMopSupported() &&
                        (M
                          ? ((f = module1543.WaterModeZero),
                            (this.state.shouldShowCleanModeView = true),
                            (this.state.shouldShowWaterModeView = false),
                            (this.state.shouldShowMopMethodView = false))
                          : c
                          ? ((S = module1543.CleanModeZero),
                      ...
                      null == (k = this.mopModeSetView) || k.setMode(C, 301),
                      this.modeDidChange(),
                      s)
                    ) {
                      K.next = 59;
                  ...
                  case 73:
                    ...
                    if (s) null == l || null == (P = l.sidebarMenu) || P.updateModeIcon(S, f, C);
                    if (u) u(S, f, C);
                    module12.DeviceEventEmitter.emit(module419.NotificationKeys.DidReceiveSpecialEvent, {
                      data: module419.EventKeys.CleanWaterModeDidChange,
                    });
                  ...
                  case 86:
                    ...
                    if (!(null == (I = this.waterModeSetView))) I.setMode(module381.RSM.waterBoxMode);
                    if (!(null == (D = this.mopModeSetView))) D.setMode(module381.RSM.mopMode, 301);
                    this.setState({
                      isCustomMode: !p,
                    });
      ...
      },
      {
        ...
        value: function (t, o, n) {
          return !(module1543.isModeCustomized(t, o, n) && !this.props.isSmartScene);
        },
      },
      {
