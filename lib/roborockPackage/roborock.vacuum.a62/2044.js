...
var x = module12.Dimensions.get('window').width,
  G = (function (t) {
    ...
    function module2047(t) {
      var n;
      module4.default(this, module2047);
    ...
    module5.default(module2047, [
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module2045.MapARPrivacyDialogWithNavbar, {
            ref: function (n) {
        ...
        value: function () {
          var t = this,
            ...
            module2049 = React.default.createElement(module385.PureImageButton, {
              ...
              style: E.bigButton,
              image: this.state.status == k.INIT ? require('./2048') : require('./2049'),
              imageWidth: 70,
              imageHeight: 70,
              onPress: function () {
            ...
            module2051 = React.default.createElement(module385.PureImageButton, {
              funcId: 'map_edit_menu_close',
              style: E.smallButton,
              image: this.state.status == k.SCANNING ? require('./2050') : require('./2051'),
              imageWidth: 46,
              imageHeight: 46,
              onPress: function () {
          ...
          return React.default.createElement(
            ...
            module2049,
            this.state.status != k.INIT && module2051,
