...
var P,
  ...
  module2115 = module393.isRecordSupported() ? require('./2115') : module12.View,
  M = module12.NativeModules.RRRecorder,
  O = 0,
  module2116 = (function (t) {
    module7.default(C, t);
    ...
    function C(t, n) {
      ...
      (o = module2117.call(this, t))._onVolumeChanged = function (t) {
        var n = t.nativeEvent;
      ...
      o.state = {
        recording: false,
        text: module505.long_press_to_send_voice,
    ...
    module5.default(C, [
          ...
          this.Gesture = {
            ...
            onResponderRelease: function (n) {
              ...
              if (
                ...
                t.setState({
                  text: module505.long_press_to_send_voice,
                  icon: t.props.isLandscape ? require('./2116') : t.context.theme.monitor.recordImg,
                }),
                clearTimeout(P),
                t.state.recording)
              ) {
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          this.setState({
            text: module505.let_go_of_send_up_slide_to_cancel,
            icon: this.props.isLandscape ? require('./2117') : this.context.theme.monitor.recordSelImg,
          });
                ...
                switch ((t.prev = t.next)) {
                  ...
                  case 9:
                    ...
                    this.setState({
                      recording: false,
                      text: module505.long_press_to_send_voice,
                      icon: this.props.isLandscape ? require('./2116') : this.context.theme.monitor.recordImg,
                    });
                    if ('-2000' == t.t0.code) globals.showToast(module505.microphone_is_occupied);
      ...
      },
      {
        key: 'robotPlayAudio',
        value: function (t) {
          var n, module22, module4, module5, module7, module9, module11, React, module12, module1121;
          return regeneratorRuntime.default.async(
            function (b) {
              for (;;)
                switch ((b.prev = b.next)) {
                  ...
                  case 7:
                    module22 = b.sent;
                    module4 = L(module494(module494(module22)).substring(0, 16));
                    module5 = L(module494(module22).substring(0, 16));
                    ...
                    module1121 = JSON.parse(JSON.stringify(module12));
                    b.next = 19;
                    return regeneratorRuntime.default.awrap(module415.default.playAudio(module1121));
...
exports.default = module2116;
module2116.contextType = module1121.AppConfigContext;
