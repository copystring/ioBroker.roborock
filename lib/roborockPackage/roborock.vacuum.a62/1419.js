  ...
  C = (function (t, ...args) {
    ...
    function _() {
      ...
      t._setCurrentValueAnimated = function (n) {
        ...
        module12.Animated[u](t.state.value, o).start();
      };
      ...
      },
      {
        ...
        value: function () {
          ...
          var O = y(
              {
                position: 'absolute',
                width: module12.Animated.add(E, z.width / 2),
                backgroundColor: h,
              },
              M
            ),
                  ...
                  y(
                    {
                      transform: [
                        {
                          translateX: module12.I18nManager.isRTL ? module12.Animated.multiply(E, -1) : E,
                        },
                        {
                          translateY: 0,
                        },
