  ...
  F = (function (t) {
    ...
    function W(t) {
      ...
      (o = B.call(this, t)).state = {
        structureLightSwitch: module1560.default.cameraEnabled,
        avoidCollisionSwitch: false,
        loading: false,
        refreshing: false,
        mapObjectPhotoEnabled: module1560.default.mapObjectPhotoEnabled,
        sceneSwitch: false,
        isShow: false,
      };
    ...
    module5.default(W, [
      {
        ...
        value: function () {
          ...
          module1560.default.addChangeListener(this.changeListener);
      ...
      },
      {
        ...
        value: function () {
          this.mounted = false;
          module1560.default.removeChangeListener(this.changeListener);
        },
      },
      {
            ...
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 3:
                    module1560.default.cameraEnabled = t;
                    if (!t) module1560.default.explorationEnabled = t;
                    this.setState({
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    module22 = 0 == t;
                    s.next = 4;
                    return regeneratorRuntime.default.awrap(module1560.default.updatePetModeEnabled(module22));
        ...
        value: function () {
          ...
          var l = module12.Dimensions.get('window').width - 30,
            ...
            h = {
              ...
              rightCenter: true,
              detailColor: 0 == module1560.default.ledSetting ? '#007AFF' : this.context.theme.subTextColor,
              detail: 0 == module1560.default.ledSetting ? module505.led_status_title2 : module505.debug_info_close,
            ...
            w = {
              ...
              isDetailCenter: false,
              rightCenter: true,
              detailColor: module1560.default.cameraEnabled ? '#007AFF' : 'rgba(0,0,0,0.4)',
              detail: module1560.default.petModeEnabled ? module505.has_or_no_has : module505.has_or_no_no,
            ...
            F = {
              ...
              onPress: function () {
                return t.props.navigation.navigate('WebViewPage', {
                  ...
                  refrence: module1575.default.PhotoPrivacy(),
                  buttonTitle: module1560.default.mapObjectPhotoPrivacyPolicyAgreed ? module505.reset_authoration : module505.button_title_agree,
                  buttonColor: module1560.default.mapObjectPhotoPrivacyPolicyAgreed ? 'red' : '#007AFF',
                  ...
                  buttonAction: function (o) {
                    if (module381.RSM.isRunning && module1560.default.mapObjectPhotoPrivacyPolicyAgreed)
                      o.alertView &&
                      ...
                      var s = function () {
                        ...
                        module393
                          .postPrivacyAgreementStatusWithVersion(
                            ...
                            module1560.default.mapObjectPhotoPrivacyPolicyAgreed ? 5 : 4,
                            1
                          )
                          .then(function (t) {})
                          .catch(function (t) {});
                        module1560.default.updatePhotoPrivacy(!module1560.default.mapObjectPhotoPrivacyPolicyAgreed, function (n) {
                          if (
                            ...
                            if ('' != (s = module1560.default.mapObjectPhotoPrivacyPolicyAgreed ? '' : module505.map_object_cancel_privacy_success)) globals.showToast(s);
                            ...
                            LogEventCommon(module1560.default.mapObjectPhotoPrivacyPolicyAgreed ? 'accept_photo_privacy' : 'reset_photo_privacy_confirm');
                          } else {
                            var s = module1560.default.mapObjectPhotoPrivacyPolicyAgreed ? module505.map_object_cancel_privacy_timeout : module505.map_object_ignore_failed;
                            if (o) globals.showToast(s);
                          }
                        });
                      };

                      if (module1560.default.mapObjectPhotoPrivacyPolicyAgreed) {
                        if (o.alertView)
                          o.alertView.customAlert(
            ...
            q = React.default.createElement(module1855.PhotoFeaturePrivacyDialog, {
              ref: function (o) {
              ...
              onConfirm: function () {
                return module1560.default.updatePhotoPrivacy(true, function (o) {
            ...
            function (c) {
              for (;;)
                switch ((c.prev = c.next)) {
                  ...
                  case 3:
                    if (module1560.default.cameraEnabled) {
                      c.next = 6;
                      break;
                    }
                  ...
                  case 6:
                    ...
                    module22 = module1560.default.mapObjectPhotoPrivacyPolicyAgreed;
                    c.next = 10;
      ...
      },
      {
        ...
        value: function (t) {
          var o = this;
          module1560.default.updateLedSetting(t, function (t) {
