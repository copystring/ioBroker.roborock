...
var module393 = require('./393'),
  ...
  I = !('ios' !== module12.Platform.OS || E() || (j > T && T < 768) || (T > j && j < 768)),
  M = null,
  k = function (t) {
    return null !== M
      ? M
  ...
  A = (function (t, ...args) {
    ...
    function u() {
      ...
      t._getSafeAreaStyle = function () {
        ...
        if (h) O.width = module12.Dimensions.get('window').width;
        if (l && 'android' === module12.Platform.OS) O.width = module12.Dimensions.get('screen').width ** module12.Dimensions.get('screen').height;
        if (f)
