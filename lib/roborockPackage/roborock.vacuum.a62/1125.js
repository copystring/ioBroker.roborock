...
var b = module1126.default.component({
  ...
  O = o({}, module12.ViewPropTypes, {
    style: function (t, o, n) {
      ...
      var c = module12.StyleSheet.flatten(t[o]);
      return Object.keys(c).some(function (t) {
        ...
        : module12.ViewPropTypes.style.apply(module12.ViewPropTypes, [t, o, n].concat(s));
    },
