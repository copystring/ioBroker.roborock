  ...
  module1895 = (function (t) {
    ...
    function N(t) {
      ...
      (n = D.call(this, t)).state = {
        ...
        updating: false,
        smartSceneTimerlist: [],
        smartSceneTimers: new module496.default.DataSource({
          rowHasChanged: function (t, n) {
            return t !== n;
          },
        }),
    ...
    module5.default(N, [
        ...
        value: function () {
          var t = this,
            ...
            o = React.default.createElement(module385.PureImageButton, {
              ...
              accessibilityLabel: module505.accessibility_add,
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    c.prev = 2;
                    if (!(module1561.TLM.resultTimerList && 0 != module1561.TLM.resultTimerList.length)) t = true;
                    c.next = 6;
                    return regeneratorRuntime.default.awrap(module1561.TLM.fetchTimerList(t));

                  case 6:
                    if (module1561.TLM.resultTimerList || !(this.retryTime < 7)) {
                      c.next = 9;
                      break;
                    }
                  ...
                  case 9:
                    l = null != (n = module1561.TLM.resultTimerList) ? n : [];
                    console.log('fetchTimerList ' + module1561.TLM.resultTimerList);
                    this.finishLoading();
                    this.retryTime = 0;
                    this.setState({
                      loading: false,
                  ...
                  for (;;)
                    switch ((l.prev = l.next)) {
                      case 0:
                        l.prev = 0;
                        l.next = 3;
                        return regeneratorRuntime.default.awrap(module1561.TLM.fetchTimerList(true));

                      case 3:
                        s = null != (n = module1561.TLM.resultTimerList) ? n : [];
                        t.finishLoading();
                        t.setState({
                          loading: false,
                          refreshing: false,
            ...
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    s.next = 2;
                    return regeneratorRuntime.default.awrap(module1561.TLM.deleteServerTimer(t));
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    c.prev = 0;
                    c.next = 3;
                    return regeneratorRuntime.default.awrap(module1561.TLM.deleteRobotTimer(t));
                  ...
                  case 3:
                    ...
                    c.next = 9;
                    return regeneratorRuntime.default.awrap(module1561.TLM.fetchTimerList(false));

                  case 9:
                    u = null != (s = module1561.TLM.resultTimerList) ? s : [];
      ...
      },
      {
        ...
        value: function (t, n, o) {
          var s = this;
          if (0 == Object.keys(n).length && (module1561.TLM.totalTimerCount >= 10 || this.state.timerlist.length >= 10))
            this.alert.alert('', module505.localization_strings_Setting_Timer_index_10, [
              {
      ...
      },
      {
        ...
        value: function (t, n) {
          ...
          if (1 == n)
            ...
            this.openSettingPage(true, s, module393.isMiApp && 1 == this.FCCState ? module1561.TLM.miTimerScenes[t] : 0);
          }
        },
      },
      {
        ...
        value: function (t, n) {
          var o = this;
          this.alert.alert(module505.localization_strings_Setting_Timer_index_13, '', [
            {
            ...
            },
            {
              ...
              onPress: function () {
                var s;
                if (1 == n)
                  module1886.SmartSceneAPI.editTriggers(null == (s = o.state.smartSceneTimerlist[t]) ? undefined : s.id, [])
                    .then(function (t) {
                      var n, s;
                      o.fetchSmartSceneTimers();
              ...
              for (;;)
                switch ((h.prev = h.next)) {
                  case 0:
                    ...
                    h.next = 9;
                    return regeneratorRuntime.default.awrap(module1886.SmartSceneAPI.editTriggers(null == (u = this.state.smartSceneTimerlist[t]) ? undefined : u.id, [module9]));
                  ...
                  case 11:
                    h.next = 13;
                    return regeneratorRuntime.default.awrap(module1561.TLM.updateTimerOnStatus(t, l, s));
                  ...
                  case 15:
                    ...
                    globals.showToast(module505.localization_strings_Setting_Timer_index_11);
        ...
        value: function (t, o, s) {
          if (1 == o) {
            var l = this.state.smartSceneTimerlist.map(function (t) {
              return module22.default(new module1887.CommandCardData(), t);
            });
      ...
      },
      {
        ...
        value: function (t, o, s) {
          var l = this,
            ...
            c = '0' != t.segments && 'ok' != t.segments ? module505.home_bottom_menu_select_zone : module505.home_bottom_menu_global,
            f = t.cleanTime,
            h = '' + t.repeatModeText,
      ...
      },
      {
        key: 'getBottomText',
        value: function (t, n) {
          if (t.disable) return module505.timer_disable;
          var o,
            s = module382.isModeCustomized(t.mode, t.waterMode, module423.DMM.isGarnet ? t.mopModeId : t.mopMode);
          if (
            (o = s
              ? module505.map_edit_bottom_menu_mode
              : module390.default.isPureCleanMopSupported()
              ? t.waterMode == module1543.WaterModeZero
                ? module505.robot_clean_status_only_clean
                : t.mode == module1543.CleanModeZero
                ? module505.robot_clean_status_only_mop
                : module505.robot_status_clean_mop_mode
              : '').length > 0
          )
            o = ' | ' + o;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (
            ...
            module390.default.isShakeMopSetSupported() && !module423.DMM.isGarnet && (l = module382.getMopMethodTitle(t.mopMode)),
            module423.DMM.isGarnet)
          ) {
            if (((o = module1544.getCleanMethods()[t.cleanMethod]), (l = t.mopModeName), t.cleanMethod == module1544.CleanMethodClean)) return o + ' | ' + n;
            if (t.cleanMethod == module1544.CleanMethodMop) return o + ' | ' + l;
            if (t.cleanMethod == module1544.CleanMethodCleanAndMop) return o + ' | ' + n + ' | ' + l;
          }
        ...
        value: function () {
          ...
          var u,
            ...
            v = React.default.createElement(
              ...
              React.default.createElement(
                ...
                module505.localization_strings_Setting_Timer_index_21
              )
            ),
            L = null;
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module1268.default, {
              ...
              topTitle: module505.timer_guide_title,
              context: module505.timer_guide_title_info,
              hintText:
                module505.timer_guide_title_tip1 +
                '\n' +
                module505.timer_guide_title_tip2 +
                '\n' +
                (module381.RSM.multiFloorEnabled ? '* ' + module505.multi_map_timer_segment_select_bottom_tip + '\n' : '') +
                (1 == this.FCCState ? '* ' + module505.timer_list_server_timer_tip : ''),
          ...
          return regeneratorRuntime.default.async(
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    t = module419.StorageKeys.TimerCleanbyGuide;
                    s.next = 3;
...
exports.default = module1895;
module1895.contextType = module1121.AppConfigContext;
