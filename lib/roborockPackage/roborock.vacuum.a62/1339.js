    ...
    (o = j.call(this, t)).onPressBubble = function () {
      if (1 != o.state.showAsReminder)
        if (o.state.photoStatus == q.FAILED) {
          o.requestPhoto();
          module1340.clearTimeout(o.timer);
          return void (o.timer = module1340.setTimeout(o.hideName.bind(module6.default(o)), H));
        } else {
  ...
  module5.default(L, [
    ...
    },
    {
      ...
      value: function (t) {
        if (this.props.mapObjectImageOnLoad) {
          ...
          var s = module423.DMM.obstacleImagesMap.source[t.type];
    ...
    },
    {
      ...
      value: function () {
        ...
        this.timer = module1340.setTimeout(this.hideName.bind(this), H);
    ...
    },
    {
      ...
      value: function () {
        module1340.clearTimeout(this.timer);
      ...
      value: function () {
        if (this.props.mapDeg % 360 == 0) {
          ...
          if ('ai' == this.props.popBoxType && this.state.photoStatus != q.REMINDER) {
            ...
            if (o.x < 80) s = 80;
            if (o.x > t - 80) s = -80;
            var h = 74 + module1265.AppBarMarginTop + (module12.StatusBar.currentHeight || 0) + 80 + 160 + 30;
            if (o.y < h) n = h - o.y;
            if (s || n) this.props.parent.props.parent.moveMap(s, n);
          }
        }
    ...
    },
    {
      ...
      value: function () {
        ...
        if (this.state.photoStatus == q.REMINDER) t = this.getInnerImageView(require('./1342'));
        else if (this.state.photoStatus == q.FINISHED) t = this.getInnerImageView(this.state.photoSource);
        else if (this.state.photoStatus == q.FAILED) t = this.getInnerFailedView(require('./1343'), module505.button_title_retry);
        return t;
      },
    },
    {
      ...
      value: function () {
        ...
        var s = module1265.obstacleNames[this.props.type];
        if (undefined === s) s = ' ';
        var n = module505.map_object_bubble_tip_avoid;
        if (this.props.hasOwnProperty('avoidTimes') && 1e3 == this.props.avoidTimes) n = module505.map_object_bubble_tip_regonized;
        var module1345 = React.default.createElement(
            T,
          ...
          module1345 = React.default.createElement(
            T,
            {
              style: {
                position: 'absolute',
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                module505.map_object_bubble_tip_show_photo
              ),
              React.default.createElement(M, {
                resizeMode: 'stretch',
                style: {
          ...
          React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                this.state.photoStatus == q.REMINDER ? module1345 : module1345
              )
            ),
            React.default.createElement(
              T,
    ...
    },
    {
      ...
      value: function () {
        ...
        var s = module423.DMM.obstacleImagesMap.image[this.props.type];
        if (undefined === s) return React.default.createElement(T, null);
        if (1 == this.props.showAsGeneralObject && 1 != this.props.showAsBlackWall && 1 != this.props.showDeleteButton && 1 != this.props.showDebugInfo) s = require('./1346');
        var n = 1 == this.props.showAsBlackWall ? 2 : module1057.Config.size.objectsRadius,
          p = 1 == this.props.showAsBlackWall ? 2 : module1057.Config.size.objectsRadius,
          h = n * this.props.transform.xx,
          l = p * this.props.transform.yy,
          u = module1265.obstacleNames[this.props.type];
        if (undefined === s) u = ' ';
        var c = '';
        if (18 != this.props.type)
          (42 == this.props.type && module423.DMM.isV1) || (c = this.props.showOnlyGeneralObstacles ? '' : ':' + Math.floor(this.props.percent / 100) + '%');
        var module1347 = React.default.createElement(
            T,
            {
              pointerEvents: 'auto',
              style: {
          ...
          y = React.default.createElement(module1326.default, {
        ...
        return React.default.createElement(
          ...
          this.props.showDeleteButton && !this.props.showAsBlackWall && module1347
        );
      },
    },
  ]);
...
exports.MapObjectView = module1346;
module1346.defaultProps = {
