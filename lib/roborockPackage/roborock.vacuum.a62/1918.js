  ...
  V = (function (t) {
    function n() {
      ...
      n.getWebViewHandle = function () {
        ...
        module1919.default(null != t, 'nodeHandle expected to be non-null');
        return t;
      };
    ...
    n.prototype.render = function () {
      var t = this.props,
        ...
        O = null;
      if ('LOADING' === this.state.viewState) O = (w || module1920.defaultRenderLoading)();
      else if ('ERROR' === this.state.viewState) {
        var H = this.state.lastErrorEvent;
        module1919.default(null != H, 'lastErrorEvent expected to be non-null');
        O = (v || module1920.defaultRenderError)(H.domain, H.code, H.description);
      } else 'IDLE' !== this.state.viewState && console.error('RNCWebView invalid state encountered: ' + this.state.viewState);
      var R = [module1922.default.container, module1922.default.webView, C],
        N = [module1922.default.container, V];
      ...
      var _ = M.component || y,
        P = module1920.createOnShouldStartLoadWithRequest(this.onShouldStartLoadWithRequestCallback, h, u),
    ...
    n.defaultProps = {
      ...
      originWhitelist: module1920.defaultOriginWhitelist,
    };
