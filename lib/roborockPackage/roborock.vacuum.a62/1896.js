...
var module505 = require('./505').strings,
  ...
  module1895 = (function (t) {
    ...
    function z(t) {
      ...
      (o = module1902.call(this, t)).hasFetchedRecordCount = 0;
    ...
    module5.default(z, [
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          this.fetchData();
          this.areaUnitListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.AreaUnitChange, function (o) {
            if (!t.unMount)
              t.setState({
                areaUnit: Utils.getAreaUnit(),
              });
          ...
          this.props.navigation.setParams({
            ...
            hiddenBottomLine: !module423.DMM.isGarnet,
          });
        },
      },
      {
        key: 'testUI',
        value: function () {
          this.cleanRecords = require('./1902');
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(module1897.default, {
                style: [
                  {
                ...
                data: [
                  {
                    title: module505.localization_strings_Setting_History_index_8,
                    unit: this.getTimeUnit(),
                    value: this.state.loaded ? this.formatTimeNumber(this.state.totalTime) : '--',
                  },
                  {
                    title: module505.clean_history_total_area,
                ...
                subTitleData: [
                  {
                    title: module505.clean_history_mop_sweep,
                    unit: ' ',
                    value: this.state.loaded ? this.formatCount(this.state.totalCount) : '--',
                    icon: require('./1903'),
                  },
                  {
                    title: module505.clean_history_mop_time,
                    unit: ' ',
                    value: this.state.loaded ? this.formatCount(this.state.mopCount) : '--',
                    icon: require('./1904'),
                  },
                  {
                    title: module505.mop_mode_setting_page_wash_count,
                    unit: ' ',
      ...
      },
      {
        ...
        value: function (t, o, n, s) {
          var l = this,
            u = module1565.utcTimeConvertToPhoneTimeZoneTime(1e3 * t.start);
          console.log('rowData = ' + t);
          if (!module1265.CleanStartType()[t.startType]) module505.localization_strings_Setting_General_index_0;
          var c = module1565.addZeroPrefix(u.month) + '/' + module1565.addZeroPrefix(u.day) + ' ' + module1565.addZeroPrefix(u.hour) + ':' + module1565.addZeroPrefix(u.minute),
            h = [module505.home_bottom_menu_global, module505.home_bottom_menu_draw_zone, module505.home_bottom_menu_select_zone][t.cleanType - 1],
            p = t.area;
          p = p < 1e6 ? (p / 1e6).toFixed(1) : E(p);

          if (t.cleanMop) {
            module505.localization_strings_Main_MainPage_3;
            module505.clean_method_mop;
            module505.clean_method_clean_and_mop;
            module505.clean_method_clean_and_mop;
            t.cleanMop;
          } else module505.localization_strings_Main_MainPage_3;

          var y = t.time < 60 ? t.time + 's' : P(t.time) + 'min',
            C = h + ' | ' + Utils.getAreaUnitValue(p) + this.state.areaUnit + ' | ' + y;
          if (module390.default.isNewDataForCleanHistoryDetail() && t.dustCollectionStatus) C = C + ' | ' + module505.dust_collection_status_1;
          return React.default.createElement(module1899.default, {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this.props.navigation.navigate('CleanRecordDetailPage', {
            ...
            title: module505.setting_history_detail,
              ...
              for (;;)
                switch ((v.prev = v.next)) {
                  case 0:
                    ...
                    v.next = 5;
                    return regeneratorRuntime.default.awrap(module415.default.getCleanSummary());
              ...
              for (;;)
                switch ((U.prev = U.next)) {
                  case 0:
                    U.prev = 0;
                    U.next = 3;
                    return regeneratorRuntime.default.awrap(module415.default.getCleanRecord(t));
                          ...
                          for (;;)
                            switch ((h.prev = h.next)) {
                              case 0:
                                h.prev = 0;
                                h.next = 3;
                                return regeneratorRuntime.default.awrap(module415.default.deleteCleanRecord(t.start));
                              ...
                              case 3:
                                ...
                                globals.showToast(module505.rubys_history_del_toast_succ);
                                h.next = 17;
                                break;
                              ...
                              case 12:
                                ...
                                h.t0 = h.catch(0);
                                if (u.loadingView) u.loadingView.hide();
                                globals.showToast(module505.rubys_history_del_toast_failed);
      ...
      },
      {
        ...
        value: function (t, o, n, s) {
          var l = this;
          this.alert.alert(module505.whether_to_delete_the_recorded, '', [
            {
