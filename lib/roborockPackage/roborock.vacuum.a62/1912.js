...
var module505 = require('./505').strings,
  ...
  module1883 = require('./1883').getSupplies,
    ...
    function z(t) {
      ...
      n.renderListRow = function (t) {
        ...
        var p = React.default.createElement(module12.Image, {
          ...
          w = module505.dust_collection_life9.templateStringWithParams({
            time: n.getTimes(f, u.total),
          }),
          k = h > D,
          T = h <= D && h > I,
          v = h <= I,
          C = k ? module505.dust_collection_life10 : T ? module505.dust_collection_life11 : module505.dust_collection_life12,
          L = k ? '#007aff' : T ? '#ee8b00' : '#e22920',
          P = !u.isNeedTime || u.isNeedState || u.isUnitsTime ? (u.isNeedState ? C : u.subTitle) : w,
          V = !u.isNeedTime && u.isNeedState ? '' : (h < 0 ? 0 : h) + '%',
          N = h <= 0 ? '#e22920' : n.context.theme.supplies.maximumTrackTintColor;
                ...
                React.default.createElement(
                  ...
                  u.isNeedTime || u.isNeedState
                    ? React.default.createElement(
                        ...
                        React.default.createElement(module1913.default, {
                          style: {
                            flex: !u.isNeedTime && u.isNeedState ? 8.5 : 7,
                          },
                          value: h / 100,
                          minimumTrackTintColor: L,
                          maximumTrackTintColor: N,
                        }),
                        !globals.isRTL &&
                          React.default.createElement(
                            module12.View,
                  ...
                  u.isNeedTime && u.isUnitsTime
                    ? React.default.createElement(
                        ...
                        module505.localization_strings_Setting_Supplies_index_6.templateStringWithParams({
                    ...
                    ? React.default.createElement(
                        module12.Text,
                        {
                          style: [
                            j.rowHours,
                            {
                              color: v ? 'red' : n.context.theme.supplies.itemSubTitleColor,
                            },
                          ],
                        },
                        P
    ...
    module5.default(z, [
      {
        ...
        value: function () {
          var t = this;
          this.fetchData();
          this.consumableResetListener = module12.DeviceEventEmitter.addListener(module419.NotificationKeys.DidReceiveSpecialEvent, function (n) {
            if (n.data == module419.EventKeys.ConsumableReset) t._refresh();
          });
        },
      },
      {
        ...
        value: function () {
          this.isUnmount = true;
          module1882.default.checkSuppliesRedPoint();
              ...
              for (;;)
                switch ((w.prev = w.next)) {
                  case 0:
                    w.prev = 0;
                    w.next = 3;
                    return regeneratorRuntime.default.awrap(module415.default.getSupplies());
                  ...
                  case 20:
                    ...
                    globals.showToast(module505.localization_strings_Setting_CleanModePage_3);
      ...
      },
      {
        ...
        value: function (t) {
          ...
          var l = s <= D && s > I,
            u = s > D ? module505.dust_collection_life10 : l ? module505.dust_collection_life11 : module505.dust_collection_life12,
            c = {
              ...
              stateText: module505.dust_collection_life13.templateStringWithParams({
                state: u,
              }),
            };
      ...
      },
      {
        ...
        value: function () {
          globals.showToast(module505.rubys_supplies_wait_tips);
        },
      },
    ]);
    return z;
...
exports.default = U;
U.contextType = module1121.AppConfigContext;
