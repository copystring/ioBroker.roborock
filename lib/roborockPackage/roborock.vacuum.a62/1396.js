  ...
  A = (function (t) {
    ...
    function P(t) {
      ...
      l.handleUpdateRect = function (t, n) {
        l._updataSill(t, n, null);
      };

      l.handleUpdateAngle = function (t, n) {
        l._updataSill(t, null, n);
      };
    ...
    module5.default(P, [
      {
        ...
        value: function (t) {
          if (!t.zonesHasEdited) {
            ...
            this.changed = false;
            if (-9999 != this.state.focusId) this._updataSill(this.state.focusId);
          }
        },
      },
      {
      ...
      },
      {
        ...
        value: function (t, n, l) {
          if (this.state.data && !(this.state.data.length <= 0)) {
            var o = this.state.data.find(function (n) {
              return n.id == t;
            });

            if (o) {
              if (o.type == module1057.DoorSillType.SmartSill && this.checkMaxCount()) return;
              if (n) o.rectSize = n;
              if (l) o.slopeAngle = l;
