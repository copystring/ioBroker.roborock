    ...
    module5.default(N, [
      ...
      },
      {
        ...
        value: function () {
          ...
          var o = module1271.default.confirmButton(this.onNavigationSavePress, n, function (n) {
              t.mapSaveButton = n;
            }),
          ...
          module1271.default.setNavigation(this, l, this.onNavigationBackPress);
        },
      },
      {
        key: 'registListeners',
              ...
              for (;;)
                switch ((f.prev = f.next)) {
                  case 0:
                    ...
                    f.prev = 1;
                    module4 = null == (o = this.exProps) ? undefined : null == (s = o.guideProps) ? undefined : s.guideKey;
                    f.next = 5;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          return this.state.mapStatus == module381.MapStatus.None ? module1271.default.getNoMapTipView(this.state.mapStatus) : s;
        },
      },
      {
        key: 'getResetButton',
