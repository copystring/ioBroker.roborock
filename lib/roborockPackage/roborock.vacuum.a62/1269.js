    ...
    module5.default(t, null, [
      {
        ...
        value: function () {
          var t, module23, module7, module9, c;
              ...
              for (;;)
                switch ((f.prev = f.next)) {
                  ...
                  case 4:
                    ...
                    f.next = 7;
                    return regeneratorRuntime.default.awrap(module415.default.getScenes());
        ...
        value: function (n) {
          return new Promise(function (u, o) {
            module415.default
              .deleteSelectMap(n)
              .then(function (c) {
                if (n == module381.RSM.currentMapId) module414.MM.clearMapData();
                t.syncSmartSceneIfNeeded();
                module419
                  .DelStorageKey(module419.StorageKeys.ARMapPathPrefixKey + '_' + n)
                  .then(function () {
                    var t;
                    console.log('Delete AR Map succeeded');

                    if ((null == (t = module414.MM.mapRotateAngle) ? undefined : t.hasOwnProperty(n + '')) && module414.MM.mapRotateAngle[n]) {
                      module414.MM.mapRotateAngle[n] = 0;
                      module419
                        .SetStorageKey(module419.StorageKeys.MapRotateAngle, JSON.stringify(module414.MM.mapRotateAngle))
                        .then(function () {
  ...
  module5.default(o, [
    {
      key: 'getData',
      value: function () {
        return new module1270.default(function (t, n) {
          module415.default
            .getRecoverMaps()
            .then(function (n) {
              var u = n.result,
                o = u.map(function (t) {
                  return {
                    id: t[0],
                    time: t[1],
                    name: module505.reset_map_item_title + ' | ' + (3 == t[0] ? module505.manual_edit_map : module505.auto_update_map),
                  };
                });
              o.sort(function (t, n) {
    ...
    },
    {
      ...
      value: function (t) {
        ...
        return new module1270.default(function (u, o) {
          var c = {
            map_index: t,
          };
    ...
    },
    {
      key: 'loadMap',
      value: function (t) {
        return module415.default.recoverMap(t);
      },
    },
    {
      key: 'resetMap',
      value: function () {
        return module415.default.resetMap();
      },
    },
  ]);
  return o;
  ...
  module5.default(c, [
    {
      key: 'getData',
      value: function () {
        return new module1270.default(function (t, u) {
          module415.default
            .getMultiMapsList()
            .then(function (u) {
                ...
                c = o.map_info
                  .map(function (t) {
                    return {
                      id: t.mapFlag,
                      time: t.add_time,
                      name: t.name ? module1136.FloorMapPageUtils.getRealName(t.name) : '' + module505.floor_map_default_name_prefix + (t.mapFlag + 1),
                      length: t.length,
                    };
                  })
                  .sort(function (t, n) {
    ...
    },
    {
      key: 'editMapName',
      value: function (t, n, u) {
        return module415.default.nameMultiMap([
          {
            multi_map: t,
            name: n,
            length: u,
    ...
    },
    {
      key: 'loadMap',
      value: function (t) {
        return module415.default.loadMultiMap(t);
      },
    },
    {
      key: 'getMapData',
    ...
    },
    {
      key: 'backupMap',
      value: function (t) {
        return module415.default.manualBackupMap(t);
      },
    },
    {
      key: 'recoverMultiMap',
      value: function (t) {
        return module415.default.recoverMultiMap(t);
      },
    },
    {
      key: 'supportFeatures',
