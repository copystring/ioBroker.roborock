    ...
    module5.default(x, [
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module1121.AppConfigContext.Consumer, null, function (o) {
            var l = t.props,
              s = l.detail,
              c = l.selected,
              f = l.detailWidth,
              ...
              React.default.createElement(
                module12.View,
                {
                  ...
                  accessibilityLabel:
                    ...
                    (E ? (t.props.switchOn ? module505.accessibility_on : module505.debug_info_close) : ''),
                },
                lt,
                React.default.createElement(
                  module12.View,
