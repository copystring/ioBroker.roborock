  ...
  I = (function (t) {
    ...
    module5.default(I, [
      ...
      },
      {
        key: 'isValidTag',
        value: function (t) {
          return !this.props.supportTag || (!(!t || t <= 0) && 'object' == typeof module1057.RoomTagInfo[t]);
        },
      },
      {
        key: 'isAutoCreateTagName',
        value: function (t, o) {
          if (!module1057.RoomTagInfo[o] && t.length > 0) return false;
          var n = module1057.RoomTagInfo[o].name;
          if (t == n) return true;
          var s = n.length;

          if (t.length > s) {
            var l = t.substring(0, s);
            if (l == module1057.RoomTagInfo[o].name && (l = t.substring(s)).match(/^\d+$/)) return true;
          }
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if ('' == o) o = module1057.RoomTagInfo[t].name;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (t.length >= 2 && this.props.supportTag)
            for (var n = 0; n < module1057.DisplayRoomTag.length; n++)
              if (this.isAutoCreateTagName(t, module1057.DisplayRoomTag[n])) {
                o = module1057.DisplayRoomTag[n];
                break;
              }
          return o;
        },
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            module2012 = module1057.RoomTagInfo[this.state.selectTagKey] ? module1057.RoomTagInfo[this.state.selectTagKey].image : require('./2012'),
            u = {
            ...
            module2013 = module1057.DisplayRoomTag.map(function (o, s) {
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    React.default.createElement(
                      ...
                      React.default.createElement(module12.Image, {
                        style: R.tagImg,
                        source: module1057.RoomTagInfo[o].image,
                      }),
                      React.default.createElement(
                        module12.Text,
            ...
            module2015 = this.state.showAllName ? require('./2014') : require('./2015'),
            ...
            B = React.default.createElement(
              ...
              React.default.createElement(
                ...
                module505.map_edit_zone_select_tag
              ),
              module2013
            ),
