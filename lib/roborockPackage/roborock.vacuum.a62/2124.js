    ...
    module5.default(I, [
      {
        ...
        value: function () {
          ...
          module2126.VideoManager.cancelRequest = false;
      ...
      },
      {
        ...
        value: function () {
          ...
          module2126.VideoManager.cancelRequest = false;
          module2126.VideoManager.addIceListener(function (o) {
            if (t.videoView)
              t.videoView.sendIceInfoToSDK(o, function (t) {
                console.log('\u53d1\u9001 ICE \u4fe1\u606f \u5230SDK \u6210\u529f');
              });
          });
          module2126.VideoManager.addTurnServerCallback(function (o) {
            t.sendTurnserviceInfoToSdk(o);
          });
          module2126.VideoManager.addSdpListener(function (o) {
            if (t.videoView)
              t.videoView.sendSdpInfoToSDK(o, function (t) {
                console.log('\u53d1\u9001 sdp \u4fe1\u606f \u5230SDK \u6210\u529f');
              });
          });
          module2126.VideoManager.addErrorCodeListener(function (o, n) {
      ...
      },
      {
        ...
        value: function () {
          ...
          module2126.VideoManager.cancelRequest = true;
      ...
      },
      {
        key: 'renderStateView',
        value: function (t) {
          if (!module423.DMM.isV1 && !module423.DMM.isV3) {
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module2125.default, {
              width: n || p,
              height: s || w,
              ...
              onFirstFrameRendered: function () {
                ...
                module2126.VideoManager.notifyFirstVideoFrameRendered();
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    s.next = 5;
                    return regeneratorRuntime.default.awrap(module415.default.sendSdpInfo(t));
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    s.next = 4;
                    return regeneratorRuntime.default.awrap(module415.default.sendIceInfo(t));
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    module2126.VideoManager.stopCameraPreview(t, n);
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    module2126.VideoManager.startVideoPreview(t, n);
