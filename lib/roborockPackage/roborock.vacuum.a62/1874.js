...
var module505 = require('./505').strings,
  ...
  module1559 = require('./1559').Errors,
  ...
  A = (function (t) {
    ...
    module5.default(E, [
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module1877.getCountryInfo(function (n, o) {
            if (n && !t.isUnmount)
              t.setState({
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  this.state.code >= 100 && this.state.code <= 255
                    ? module505.localization_strings_Main_Error_Constants_1 + ':' + this.state.code + ' ' + module1559()[this.state.code][4]
                    : ''
                ),
                React.default.createElement(
                  P,
