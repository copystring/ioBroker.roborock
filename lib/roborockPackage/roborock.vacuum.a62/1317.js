...
var x = module12.StatusBar.currentHeight || 0,
  k = x + w;
  ...
  module5.default(k, [
    {
      ...
      value: function () {
        ...
        module505.addLanguageListener(this.languageChangeListener);
      },
    },
    {
      key: 'componentWillUnmount',
      value: function () {
        module505.removeLanguageListener(this.languageChangeListener);
      },
    },
    {
      ...
      value: function () {
        var t,
          ...
          l = React.default.createElement(module385.PureImageButton, {
            ...
            imageHeight: 32,
            funcId: 'navi_back',
            accessibilityLabel: module505.strings.accessibility_back,
          }),
