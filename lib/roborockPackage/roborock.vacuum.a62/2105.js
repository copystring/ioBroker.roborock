...
var module505 = require('./505').strings,
  ...
  module2110 = (function (t) {
    module7.default(module2106, t);

    var module50 = module2106,
      module1121 = T(),
      O = function () {
        var t,
    ...
    function module2106(t) {
      var o;
      module4.default(this, module2106);
    ...
    module5.default(module2106, [
          ...
          if (!this.hasShownTranverseDialog)
            ...
            module381.RSM.state == module381.RobotState.GOTO_TARGET
              ? ((this.hasShownTranverseDialog = true),
                module417.Log.log(module417.LogTypes.Monitor, 'ask if tranverse to remote,now state is ' + module381.RSM.state),
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    globals.showToast(module505.voice_chat_title2);
                  ...
                  case 7:
                    ...
                    module417.Log.log(module417.LogTypes.Monitor, 'remote start, now state is ' + module381.RSM.state, module417.InfoColors.Success);
                    o.next = 19;
                    break;
                  ...
                  case 14:
                    ...
                    module417.Log.log(module417.LogTypes.Monitor, 'remote start failed,' + ('object' == typeof o.t0 ? JSON.stringify(o.t0) : o.t0), module417.InfoColors.Fail);
      ...
      },
      {
        key: 'darkImgs',
        value: function () {
          return [require('./2106'), require('./2107'), require('./2108'), require('./2109'), require('./2110')];
        },
      },
      {
        key: '_getActiveImage',
      ...
      },
      {
        ...
        value: function (t, o) {
          ...
          } else globals.showToast(module505.voice_chat_title2);
        },
      },
      {
        key: 'render',
            ...
            React.default.createElement(
              ...
              this.state.isRemoteLaunching &&
                React.default.createElement(
                  ...
                  module505.localization_strings_Setting_RemoteControlPage_61
                )
            )
          );
        },
...
exports.default = module2110;
module2110.contextType = module1121.AppConfigContext;
