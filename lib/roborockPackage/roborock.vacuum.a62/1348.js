...
exports.WaterModeImage = function (t, o) {
  ...
  switch (o.waterMode) {
    ...
    case k.LowWater:
      return require(T ? (t ? d[31] : d[32]) : t ? d[33] : d[34]);

    case k.MediumWater:
      return require(T ? (t ? d[35] : d[36]) : t ? d[37] : d[38]);

    case k.HighWater:
      return require(T ? (t ? d[39] : d[40]) : t ? d[41] : d[42]);
...
exports.MopModeImage = function (t, o) {
  ...
  if (!module390.default.isCleanRouteFastModeSupported() && o.cleanMode != R.NoClean) return '';
  ...
  switch (o.mopMode) {
    ...
    case x.SlowIntensive:
      return require(t ? d[49] : d[50]);

    case x.Fast:
      return require(t ? d[51] : d[52]);
...
exports.MopSettingMode = x;
var P = {
  Dry: 3,
  Normal: 1,
  Wet: 2,
};
exports.GarnetMopMode = P;
var T = module390.default.isShakeMopStrengthSupported();
  ...
  module5.default(c, [
    ...
    },
    {
      ...
      value: function (t, o) {
        ...
        if (!module390.default.isCleanRouteFastModeSupported() && this.props.cleanMode != R.NoClean) return '';
    ...
    },
    {
      ...
      value: function () {
        var t,
          ...
          R = Boolean(this.props.roomTag > 0 && undefined != this.props.roomTag && null != this.props.roomTag && I && this.hasName),
          k = this.isSelected;
        this.lastRoomName = this.props.roomName;
        if (!B) this.didlayoutMode = true;
        if (!L) this.didlayoutSequence = true;

        var x = this.didlayout ? 1 : 0,
          P = k ? 1 : x,
          T = this.props.roomColor ? this.props.roomColor : 'transparent',
          O = !B && !L && k,
          q = L && !k,
          A = q && !B,
          j = Boolean(this.isSelected || L),
          F = this.cleanImage(this.isSelected, this.props.cleanMode),
          z = this.waterModeImage(this.isSelected, this.props.waterMode),
          _ = this.mopModeImage(this.isSelected, this.props.mopMode),
          G = function (t) {
            return module391.default.iOSAndroidReturn(t + 1, t);
          };

        if (!(B || k || L || N || R)) return React.default.createElement(module12.View, null);
                            ...
                            if ((q && ((paddingLeft = 0), (paddingRight = 0)), B)) {
                              ...
                              return React.default.createElement(
                                module1327.Bubble,
                                {
                                  ...
                                  style: {
                                    backgroundColor: p.isSelected ? T : 'rgba(255,255,255, 0.3)',
                                    paddingHorizontal: t,
                                    paddingVertical: o,
                                  },
                                },
