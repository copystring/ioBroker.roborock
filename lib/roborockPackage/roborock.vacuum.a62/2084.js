...
var module505 = require('./505').strings,
  module2085 = (function (t) {
    ...
    function T(t) {
      ...
      (n = module2087.call(this, t)).state = {};
      return n;
    }
    ...
    module5.default(T, [
      ...
      },
      {
        ...
        value: function () {
          return module381.RSM.isCleaning() ? require('./2085') : require('./2086');
        },
      },
      {
        key: 'getCleanButtonTitle',
        value: function () {
          return module381.RSM.isCleaning() ? module505.localization_strings_Common_Constants_11 : module505.localization_strings_Main_MainPage_3;
        },
      },
      {
        key: 'getChargeButtonImage',
        value: function () {
          return module381.RSM.state == module381.RobotState.BACK_TO_DOCK ? require('./2085') : require('./2087');
        },
      },
      {
        key: 'render',
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module385.TopImageButton, {
              ...
              fontSize: 12,
              textColor: '#fff',
              title: module505.localization_strings_Main_MainPage_3,
