      ...
      },
      {
        ...
        value: function () {
          var t = this.context.theme.soundPackage,
            ...
            v = React.default.createElement(module1888.default, {
          ...
          if (this.props.data.validEndTime) {
            var k = module1513.convertTimeFromSourceZoneToPhoneZoneByTimestamp(this.props.data.validEndTime, 0);
            R = module500.soundpackage_valid_end_time_title + ' ' + k.year + '.' + k.month + '.' + k.day;
            if (k.year >= 2099) R = module500.soundpackage_valid_end_time_title + ' ' + module500.voice_package_end_validtime_forever;
          }
