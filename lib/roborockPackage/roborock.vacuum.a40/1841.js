...
var module500 = require('./500').strings,
  ...
  K = (function (t) {
    ...
    function K(t) {
      ...
      s.originalRepeatMode = u.repeatMode || module1513.RepeatMode.Once;
      ...
      s.state = {
        ...
        repeatMode: u.repeatMode || module1513.RepeatMode.Once,
        ...
        mopModeName: s.editMode ? u.mopModeName : null == (n = module1328.ModeDataInstance.modePannelCustomMops[0]) ? undefined : n.name,
        mopModeId: s.editMode ? u.mopModeId : null == (o = module1328.ModeDataInstance.modePannelCustomMops[0]) ? undefined : o.id,
        currentCleanMethod: undefined == u.cleanMethod ? module1327.CleanMethodMop : u.cleanMethod,
        shouldShowCleanMethodView: false,
        shouldShowCustomSwitch: !module422.DMM.isGarent,
      };
    ...
    module5.default(K, [
        ...
        value: function () {
          ...
          this.modeChangeHandler = function () {
            ...
            if (
              !(
                -1 !=
                module1328.ModeDataInstance.modePannelCustomMops.findIndex(function (n) {
                  return n.id == t.setState.mopModeId;
                })
              )
            )
              t.setState({
                mopModeId: null == (n = module1328.ModeDataInstance.modePannelCustomMops[0]) ? undefined : n.id,
                mopModeName: null == (o = module1328.ModeDataInstance.modePannelCustomMops[0]) ? undefined : o.name,
              });
          };

          module1328.ModeDataInstance.addChangeListener(this.modeChangeHandler);
        },
      },
      {
        key: 'componentWillUnmount',
        value: function () {
          module1329.MM.shouldForceStart = false;
          module1329.MM.stop();
          module1328.ModeDataInstance.removeChangeListener(this.modeChangeHandler);
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          var t = module1329.MM.getMapConfigById(this.segmentMapId) || {
            name: module500.timer_setting_map_select_any_map,
            id: -1,
          };
      ...
      },
      {
        ...
        value: function () {
          ...
          if (this.state.currentCleanMethod == module1327.CleanMethodClean && 301 == o) o = 300;
          if (module390.default.isShakeMopSetSupported()) {
            if (this.customModeView) this.customModeView.show(t, n, module422.DMM.isGarnet ? this.state.mopModeId : o);
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (4 == t) {
            ...
            this.hideModalView(function () {
              n.setState({
                repeatMode: module1513.IndexRepeatMap[t],
                shouldShowFrequenceView: false,
              });
            });
        },
      },
      {
        ...
        value: function (t, n, o) {
          ...
          this.setState({
            waterMode: l,
            mode: s,
            mopMode: module422.DMM.isGarnet ? null : u,
            mopModeId: module422.DMM.isGarnet ? (null == o ? undefined : o.id) : null,
            mopModeName: module422.DMM.isGarnet ? (null == o ? undefined : o.name) : null,
          });
      ...
      },
      {
        ...
        value: function () {
          ...
          if (this.state.hasSetTime) {
            var n = module1513.timerRepeatToCronRepeat(this.state.repeatMode),
              s = -1,
              l = -1;
            ...
            if (this.isRepeatTimer(l, s)) globals.showToast(module500.set_timer_dup);
            else if (this.mapSegmentSettingView && this.mapSegmentSettingView.state.isLoading) globals.showToast(module500.map_loading_view_tip);
            else {
              if ('0' == this.selectedSegments && this.mapSegmentSettingView && this.mapSegmentSettingView.state.shouldShowBottom) {
                if (!module390.default.isMultiMapSegmentTimerSupported()) return void globals.showToast(module500.timer_setting_select_zone_tip);
              ...
              var M = module1512.ConvertToCronStr(this.state.hour, this.state.minute, n, l, s);

              if (module393.isMiApp && 1 == this.FCCState) {
                var S = module1513.convertToBeijingTime(this.state.minute, this.state.hour, l, s),
                  w = this.state.repeatMode;

                if (this.state.repeatMode != module1513.RepeatMode.Once && this.state.repeatMode != module1513.RepeatMode.Everyday) {
                  var _ = new Date();

                  if (S.month == _.getMonth() + 1)
                    S.day == _.getDate() + 1
                      ? (w = module1513.getDaysArrByOffset(this.state.repeatMode, 1))
                      : S.day == _.getDate() - 1 && (w = module1513.getDaysArrByOffset(this.state.repeatMode, -1));
                  else w = 1 == S.day ? module1513.getDaysArrByOffset(this.state.repeatMode, 1) : module1513.getDaysArrByOffset(this.state.repeatMode, -1);
                }

                n = module1513.timerRepeatToCronRepeat(w);
                M = module1512.ConvertToCronStr(S.hour, S.minute, n, S.day, S.month);
              }
              ...
              if (module390.default.isMultiMapSegmentTimerSupported() && module381.RSM.isRunning && this.segmentMapId != module381.RSM.currentMapId && -1 != this.segmentMapId) {
                if (this.alert)
                  this.alert.customAlert(
                    '',
                    module500.set_multi_map_timer_different_map_save_tip,
                    function () {
          ...
          } else globals.showToast(module500.set_timer_without_time_tip);
        },
      },
      {
        key: 'getNewLogicPara',
              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    l.prev = 0;
                    l.next = 3;
                    return regeneratorRuntime.default.awrap(module414.default.setTimer(t));
      ...
      },
      {
        ...
        value: function (t, n, s, l) {
          var u, h, c, p, f, M, S, w, _, y, module1510, module394, module382, module1329, module1843, module1840;
              ...
              for (;;)
                switch ((x.prev = x.next)) {
                  case 0:
                    x.prev = 0;
                    x.next = 3;
                    return regeneratorRuntime.default.awrap(module414.default.setServerTimer(t));
                  ...
                  case 31:
                    ...
                    module394 = module1513.convertToTargetTime(this.state.minute, this.state.hour, s, l, module393.robotTimeZone);
                    module382 = module394.hour + ':' + module1513.addZeroPrefix(module394.minute);
                    module1329 = module1513.getLoopStringOfRepeatMode(this.state.repeatMode);
                    module1843 = new Date();
                    module1840 = module1513.resolveRepeatModeByTargetTime(module1329, module1843.getMonth() + 1, module1843.getDate(), module394.month, module394.day);
                    console.log('loops -- time - ' + module382 + ' - loop -' + module1840 + ' -repeat-' + this.state.repeatMode + ' - timerId- ' + this.timerId);
                    x.next = 40;
                    return regeneratorRuntime.default.awrap(module393.rrAddOrEditTimer(module382, module1840, module1510, this.timerId));
                  ...
                  case 44:
                    ...
                    if (this.loadingView) this.loadingView.hide();
                    globals.showToast(module500.robot_communication_exception);
                    console.log('setTimerOnServer error: ' + ('object' == typeof x.t0 ? JSON.stringify(x.t0) : x.t0));
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(module1844.default, {
              ref: function (n) {
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(module385.SettingListItemView, {
                  ...
                  title: module500.localization_strings_Setting_DoNotDisturbPage_0,
                ...
                React.default.createElement(module385.SettingListItemView, {
                  ...
                  bottomDetail: module1513.getTextOfRepeatMode(this.state.repeatMode, this.date),
                ...
                module422.DMM.isGarnet &&
                  React.default.createElement(module385.SettingListItemView, {
                    ...
                    title: module500.timer_setting_clean_method,
              ...
              l &&
                !u &&
                React.default.createElement(module1842.default, {
              ...
              u &&
                React.default.createElement(module1843.default, {
                  style: Q.mapSegmentSettingView,
                  ref: function (n) {
                    t.mapSegmentSettingView = n;
                  },
                  ...
                  switchToSelectAreaMode: function () {
                    var n = module1329.MM.getMapConfigById(-1 != t.segmentMapId ? t.segmentMapId : module381.RSM.currentMapId);
                    t.handleMapChange(n);
                  },
                  onPanResponderGrant: function () {
                    t.setState({
              ...
              React.default.createElement(module1840.default, {
            ...
            React.default.createElement(module1802.default, {
              ...
              topTitle: module500.tanos_custom_mode_title,
              context: module500.tanos_custom_mode_des_info,
              hintText: module500.map_edit_guide_wall_tip_line2,
              buttonInfo: [module500.localization_strings_Main_MainPage_11, module500.button_go_setting],
      ...
      },
      {
        ...
        value: function () {
          return this.state.currentCleanMethod == module1327.CleanMethodNoSet ? module500.timer_setting_no_setting : module1327.getCleanMethods()[this.state.currentCleanMethod];
        },
      },
      {
        ...
        value: function () {
          ...
          if (module382.isModeCustomized(this.state.mode, this.state.waterMode, this.state.mopMode)) return module500.map_edit_bottom_menu_mode;
          var o = module382.getCleanModeTitle(this.state.mode),
            s = module382.getMopWaterOrStrengthTitle(this.state.waterMode),
            l = o + (s ? ' | ' + s : '');
          if (module390.default.isPureCleanMopSupported() && this.state.mode == module1326.CleanModeZero) return s + ' | ' + module382.getMopMethodTitle(this.state.mopMode);
          ...
          if (module390.default.isShakeMopSetSupported() && 200 != this.state.waterMode) {
            ...
            if (t) {
              if (n == module1327.CleanMethodClean) return l;
              if (n == module1327.CleanMethodMop) return u;
              if (n == module1327.CleanMethodCleanAndMop) return l + ' | ' + u;
            }
          }
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = module1513.RepeatIndexMap[this.state.repeatMode];
          if (undefined == n) n = 4;
          return React.default.createElement(
            module12.View,
            {
            ...
            React.default.createElement(module1212.ActionSheetView, {
              title: module500.localization_strings_Setting_Timer_SettingPage_1,
              actions: module1513.RepeatMenuItems(),
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(module1845, {
            selectedItems: n,
            cancel: function (n) {
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          return React.default.createElement(module1212.ActionSheetView, {
            title: module500.timer_setting_clean_method,
            actions: module1327.getCleanMethods(),
            didSelectRow: function (n) {
      ...
      },
      {
        ...
        value: function () {
          return this.state.hasSetTime || this.editMode
            ...
            : module500.timer_setting_no_setting;
        },
      },
      {
        key: 'hideTimerPicker',
      ...
      },
      {
        key: 'isRepeatTimer',
        value: function (t, n) {
          for (var o = module1513.convetToWeekendsByStartTime(this.state.repeatMode, t, n), s = 0; s < this.timerList.length; s++) {
            ...
            if (!this.editMode || l.hour != this.originalHour || l.minute != this.originalMinute || JSON.stringify(u) !== JSON.stringify(this.originStartWeekdays)) {
              ...
              if (l.repeatMode == module1513.RepeatMode.Once && l.hour == this.state.hour && l.minute == this.state.minute) return true;
            }
          }
      ...
      },
      {
        ...
        value: function () {
          ...
          if (this.editMode && this.hasChanged())
            this.alert.alert(module500.map_edit_save_current_action, '', [
              {
              ...
              for (;;)
                switch ((u.prev = u.next)) {
                  ...
                  case 7:
                    ...
                    u.next = 12;
                    return regeneratorRuntime.default.awrap(module414.default.loadMultiMap(this.segmentMapId));
      ...
      },
      {
        ...
        value: function () {
          ...
          this.props.navigation.navigate('MapEditZoneModePage', {
            action: 'custom',
            title: module500.map_edit_bottom_menu_mode,
          });
        },
      },
      {
        ...
        value: function () {
          if (module422.DMM.isGarnet)
            this.state.currentCleanMethod != module1327.CleanMethodNoSet || this.editMode ? this.confirmButton.setEnabled(true) : this.confirmButton.setEnabled(false);
