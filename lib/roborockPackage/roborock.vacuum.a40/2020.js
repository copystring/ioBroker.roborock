  ...
  M = (function (t) {
    ...
    function V(t) {
                  ...
                  switch ((o.prev = o.next)) {
                    ...
                    case 3:
                      ...
                      l.props.navigation.navigate('WebViewPage', {
                        title: module500.localization_strings_Main_Views_ImprovementPage_0,
                        url: t.privacyProtocol.langUrl,
                        isNotMarginBottom: true,
                        buttonTitle: module393.isSupportDeleteDevice() ? module500.reset_authoration : null,
                        buttonColor: 'red',
      ...
      l.onUploadLog = function () {
        l.alert.alert(module390.default.isShowPicUpload() ? module500.log_for_v4_dialog_title : module500.upload_log_legal_statement, '', [
          {
    ...
    module5.default(V, [
      {
        ...
        value: function () {
          var t = this,
            module2021 = React.default.createElement(module385.PureImageButton, {
              funcId: 'pi_setting_copy',
              accessibilityLabel: module500.debug_info_copy_all,
              image: require('./2021'),
              onPress: function () {
            ...
            function (c) {
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    c.next = 2;
                    return regeneratorRuntime.default.awrap(module414.default.getTimeZone());
                ...
                switch ((s.prev = s.next)) {
                  ...
                  case 8:
                    ...
                    if (FetchNetworkInfoRetry < 10) {
                      ...
                      this.props.parent.showMsg(module500.localization_strings_Setting_CleanModePage_3);
                    }
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    ...
                    this.setState({
                      firmwareVersion: module500.share_device,
                    });
              ...
              n = [
                {
                  data: [
                    {
                      title: module500.localization_strings_Setting_General_index_1,
                ...
                },
                {
                  data: [
                    {
                      title: module500.debug_info_serial_model,
                    ...
                    {
                      title: module500.debug_info_serial_number,
                    ...
                    {
                      title: module500.debug_info_firmware_version,
                ...
                },
                {
                  data: [
                    {
                      title: module500.app_vesion_info,
                    ...
                    {
                      title: module500.debug_info_plugin_version,
                    ...
                    {
                      title: module393.isMiApp ? module500.debug_info_xiaomi_id : 'UID',
                ...
                },
                {
                  data: [
                    ...
                    {
                      title: module500.localization_strings_Setting_General_NetInfoPage_0,
                      funcId: 'localization_strings_Setting_General_NetInfoPage_0',
                      detail: this.state.ssid,
                      detailWidth: 350,
                      onPress: function () {
                        return t.onPressCopyButton(t.state.ssid);
                      },
                      shouldShowRightArrow: false,
                      visible: true,
                    },
                    {
                      title: module500.localization_strings_Setting_General_NetInfoPage_1,
                    ...
                    {
                      title: module500.localization_strings_Setting_General_NetInfoPage_2,
          ...
          var t = this,
            ...
            o =
              ...
              React.default.createElement(module1880.default, {
                text1: module390.default.isShowPicUpload() ? module500.log_for_v4_upload : module500.rubys_setting_guide_contact_report_log,
                text2: module390.default.isShowPicUpload() ? module500.log_for_v4_upload_info : module500.rubys_setting_guide_contact_report_tip,
                text3: ' ',
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this.showMsg(module500.debug_info_copy_success);
        },
      },
      {
        ...
        value: function () {
          ...
          if (globals.Alert)
            globals.Alert.customAlert(
              ...
              module500.reset_privacy_dialog_content,
              function () {
                t.updatePrivacy();
              },
              function () {
