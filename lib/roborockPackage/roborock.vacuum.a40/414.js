  ...
  return new Promise(function (c, _) {
    s(t, n, o, function (o, s) {
      if (o && s && s.result && 'unknown_method' != s.result) {
        module416.Log.log(module416.LogTypes.RPC, t + ' - ' + ('object' == typeof n ? JSON.stringify(n) : n) + ' - ' + JSON.stringify(s), module416.InfoColors.Success, true);
        c(s);
      } else {
        module416.Log.log(
          module416.LogTypes.RPC,
...
function M(t, n, s) {
  var c = {
    ...
    f = module415.default.encode(JSON.stringify(c)),
    l = {
    ...
    module393.Service.spec
      ...
      .then(function (_) {
        if ((console.log('miSpec', _), _.out)) {
          ...
          module416.Log.log(module416.LogTypes.RPC, 'spec error missing out field', module416.InfoColors.Fail, true);
          c('spec error missing out field');
        }
      })
      .catch(function (n) {
        module416.Log.log(module416.LogTypes.RPC, 'spec error ' + t + ' - ' + ('object' == typeof n ? JSON.stringify(n) : n), module416.InfoColors.Fail, true);
        c({
          error: 'spec error: ' + t,
