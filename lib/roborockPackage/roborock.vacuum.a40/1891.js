...
var module500 = require('./500').strings,
  ...
  module1893 = (function (t) {
    ...
    function D(t) {
      ...
      (o = module1892.call(this, t)).state = {
        value: module422.DMM.volumeMin,
      };
      return o;
    }
    ...
    module5.default(D, [
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    n.prev = 0;
                    n.next = 3;
                    return regeneratorRuntime.default.awrap(module418.GetStorageKey(module418.StorageKeys.VolumeValue));
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    n.prev = 0;
                    n.next = 3;
                    return regeneratorRuntime.default.awrap(module414.default.getSoundVolume());
                  ...
                  case 3:
                    ...
                    n.next = 8;
                    return regeneratorRuntime.default.awrap(module418.SetStorageKey(module418.StorageKeys.VolumeValue, '' + t.result[0]));
      ...
      },
      {
        ...
        value: function (t) {
          return t > module422.DMM.volumeMax ? module422.DMM.volumeMax : t < module422.DMM.volumeMin ? module422.DMM.volumeMin : t;
        },
      },
      {
        key: 'render',
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              module500.setting_robot_volume
            ),
            React.default.createElement(
              module12.View,
              {
              ...
              React.default.createElement(module385.Slider, {
                ...
                minimumValue: module422.DMM.volumeMin,
                maximumValue: module422.DMM.volumeMax,
            ...
            React.default.createElement(
              ...
              module500.setting_volume_tips_text
            )
          );
        },
      },
              ...
              for (;;)
                switch ((u.prev = u.next)) {
                  case 0:
                    ...
                    u.prev = 1;
                    u.next = 4;
                    return regeneratorRuntime.default.awrap(module414.default.setSoundVolume(module4));

                  case 4:
                    module5 = u.sent;
                    console.log('setSoundVolume - ' + JSON.stringify(module5));
                    u.next = 8;
                    return regeneratorRuntime.default.awrap(module414.default.testSoundVolume());
                  ...
                  case 8:
                    ...
                    u.next = 13;
                    return regeneratorRuntime.default.awrap(module418.SetStorageKey(module418.StorageKeys.VolumeValue, '' + module4));
                  ...
                  case 16:
                    ...
                    if (this.props.setVolumeDidFail) this.props.setVolumeDidFail(module500.robot_communication_exception);
...
module1893.contextType = module515.AppConfigContext;
