    ...
    module5.default(T, [
          ...
          var l = this,
            ...
            E = React.default.createElement(
              ...
              React.default.createElement(module385.PureButton, {
                ...
                enabled: !s,
                title: (j || module500.localization_strings_Main_Error_ErrorDetailPage_3) + (s ? u : ''),
                textColor: s
      ...
      },
      {
        ...
        value: function () {
          ...
          this.timer = module1404.setTimeout(this._fire.bind(this), 1e3);
      ...
      },
      {
        key: '_stopSecond',
        value: function () {
          if (this.timer) module1404.clearTimeout(this.timer);
        },
      },
      {
        key: 'show',
...
var j = O(function (t) {
  var o = module12.StyleSheet.create({
    ...
    n = module500.obstacle_photo_page_ignore_desc;
