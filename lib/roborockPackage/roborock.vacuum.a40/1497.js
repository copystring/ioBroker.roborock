...
var M = React.forwardRef(function (t, o) {
    var u = React.useContext(module515.AppConfigContext).theme,
      B = t.cleanIconMode,
    ...
    var L = [
        C(
          C({}, module1496.getCleanButtonConfig(M, u)),
          {},
          {
        ...
        C(
          C({}, module1496.getMopButtonConfig(O, u)),
          {},
          {
        ...
        C(
          C({}, module1496.getCleanMopButtonConfig(y, u)),
          {},
          {
      ...
      G = [
        C(
          C({}, module1496.getChargeButtonConfig(R, u)),
          {},
          {
            onPress: V,
        ...
        C(
          C({}, module1496.getWashingDusterButtonConfig(v, u)),
          {},
          {
          ...
          return React.default.createElement(
            ...
            module22.default(
              ...
              t,
              {
                ...
                maxTextWidth: module1159.BottomControlTopButtonWidth - 20,
                style: [w.topButton],
              }
            )
          );
        ...
        G.map(function (t, o) {
          return React.default.createElement(
            ...
            module22.default(
              ...
              t,
              {
                maxTextWidth: module1159.BottomControlBottomButtonWidth - 20,
                textColor: u.homeBottomControl.textColor,
                fontSize: 14,
  ...
  w = module12.StyleSheet.create({
    controlMenuWrap: {
      ...
      height: module1159.BottomControlHeight,
      paddingVertical: 20,
    ...
    topButton: {
      width: module1159.BottomControlTopButtonWidth,
      backgroundColor: 'transparent',
    },
    splitLine: {
      width: module12.Dimensions.get('window').width - 4 * module1159.HorizontalMargin,
      height: 0.8,
      marginTop: 12,
    ...
    bottomButton: {
      width: module1159.BottomControlBottomButtonWidth,
      backgroundColor: 'transparent',
    },
  }),
  S = M;
