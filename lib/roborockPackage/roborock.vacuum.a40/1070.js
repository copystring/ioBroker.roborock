...
var x,
  ...
  B = 'ios' === module12.Platform.OS ? 20 : 0,
  O = 'ios' === module12.Platform.OS ? 70 : 56,
  I = 'ios' === module12.Platform.OS ? 20 : 56,
  P = function (t, n, o, l) {
    if ('left' === t) {
      var s = {
        left: I,
  ...
  module1078 = (function (t, ...args) {
    ...
    function O() {
        ...
        var c = t._getHeaderTitleString(n.scene),
          ...
          v =
            'center' === o
              ...
              : undefined,
          b = u && 'string' != typeof u ? u : module1071.default;
      ...
      t._renderLeftComponent = function (n) {
        ...
        if (o.headerLeft || 0 !== n.scene.index) {
          var l = t._getBackButtonTitleString(n.scene),
            ...
            c = o.headerLeft || module1072.default;
      ...
      t._renderModularLeftComponent = function (n, o, l) {
        ...
        return React.default.createElement(module1075.default, {
          onPress: function () {
            requestAnimationFrame(function () {
        ...
        },
        {
          ...
          value: function () {
            ...
            var S = c.descriptor.options,
              w = S.headerStyle,
              C = undefined === w ? {} : w,
              _ = module12.StyleSheet.flatten(C),
              T = E(f),
...
module1078.defaultProps = {
  layoutInterpolator: module1076.default.forLayout,
  leftInterpolator: module1076.default.forLeft,
  leftButtonInterpolator: module1076.default.forLeftButton,
  leftLabelInterpolator: module1076.default.forLeftLabel,
  titleFromLeftInterpolator: module1076.default.forCenterFromLeft,
  titleInterpolator: module1076.default.forCenter,
  rightInterpolator: module1076.default.forRight,
  backgroundInterpolator: module1076.default.forBackground,
};
x =
...
var A = '#FFF',
  R = module12.StyleSheet.create({
    ...
    header: _(
      _({}, module12.StyleSheet.absoluteFillObject),
      {},
      {
        flexDirection: 'row',
      }
  ...
  j = module1034.withOrientation(module1078);
exports.default = j;
