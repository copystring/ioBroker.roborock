    ...
    module5.default(H, [
      {
        ...
        value: function () {
          ...
          if (this.feedbackCallback)
            this.mapLoadEmitter = module12.DeviceEventEmitter.addListener(module418.NotificationKeys.MapImageLoaded, function (n) {
              if (n.types && 0 != n.types.length) {
                n.types.forEach(function (n) {
                  t.mapImageHasOnLoad[n] = true;
                });
                var o = Object.values(module1330.shareViewLoadType),
                  l = 0;
      ...
      },
      {
        ...
        value: function () {
            ...
            function (o) {
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    o.next = 2;
                    return regeneratorRuntime.default.awrap(module418.GetStorageKey(module418.StorageKeys.MapDebugInfoVisible));
          ...
          this.areaUnitListener = module12.DeviceEventEmitter.addListener(module418.NotificationKeys.AreaUnitChange, function (n) {
            t.setState({
              areaUnit: module391.default.getAreaUnit(),
            });
          });
      ...
      },
      {
        ...
        value: function () {
          this.context.theme;
          var module1818 = React.default.createElement(module385.PureImageButton, {
            image: require('./1818'),
          ...
          this.props.navigation.setParams({
            ...
            rightItems: this.shouldShowShareButton ? [module1818] : [],
          });
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          module393.getMapData(
            module389.Methods.GetCleanRecordMap,
            {
      ...
      },
      {
        ...
        value: function (t) {
          var n,
            ...
            s,
            c,
            u = module1859.parse(t, globals.app.state.theme != module516.Themes.light, module422.DMM.isSapphirePlus, module394.MC.sapMapBeautify),
            h = {
          ...
          if (
            ...
            -2 != this.state.mapFlag && module1329.MM.mapRotateAngle)
          ) {
            var f = module1329.MM.mapRotateAngle[this.state.mapFlag];
            module22.default(h, {
              mapDeg: f || 0,
            });
          }
          ...
          this.mapData = h;
          if (this.mapView) this.mapView.setState(z({}, h));
          this.setState({
            obstaclesCount:
      ...
      },
      {
        ...
        value: function () {
          var t;
          if (!(null == (t = this.loadingView))) t.showWithText(module500.robot_status_locked_when_saving_map);
        },
      },
      {
        key: '_endLoading',
      ...
      },
      {
        key: 'render',
        value: function () {
          if (1 == this.props.navigation.state.params.status) require('./1852');
          else require('./1853');
          if (module390.default.isStructuredLightSupported() || module422.DMM.isTopazSV)
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  ' ',
                  module500.localization_strings_CommonModules_NumberView_4
                ),
                React.default.createElement(
                  module12.View,
                  {
          ...
          var t = this,
            ...
            c = module1513.utcTimeConvertToPhoneTimeZoneTime(1e3 * this.state.start),
            u = module1513.addZeroPrefix(c.month) + '/' + module1513.addZeroPrefix(c.day) + ' ' + module1513.addZeroPrefix(c.hour) + ':' + module1513.addZeroPrefix(c.minute),
            h = {
              marginHorizontal: 2,
              fontSize: 20,
                ...
                ? React.default.createElement(
                    ...
                    React.default.createElement(
                      ...
                      React.default.createElement(
                        ...
                        ' ',
                        module500.mop_mode_setting_page_wash_count
                      ),
                      React.default.createElement(
                        module12.View,
                        {
            ...
            F =
              this.state.washTime > 0 && (1 == this.state.cleanMop || 3 == this.state.cleanMop)
                ...
                : React.default.createElement(module12.View, null),
            A = module500.localization_strings_CommonModules_NumberView_2,
            ...
            j = module500.localization_strings_CommonModules_NumberView_0,
            ...
            W = [module500.home_bottom_menu_global, module500.home_bottom_menu_draw_zone, module500.home_bottom_menu_select_zone][this.state.cleanType - 1],
            G = this.state.cleanMop
              ? [module500.localization_strings_Main_MainPage_3, module500.clean_method_mop, module500.localization_strings_Main_MainPage_3, module500.clean_method_mop][
                  this.state.cleanMop
                ]
              : module500.localization_strings_Main_MainPage_3,
            K = W + ' | ' + (module1153.CleanStartType()[this.state.startType] || module500.localization_strings_Setting_General_index_0) + ' | ' + u + ' ';
          if (module390.default.isNewDataForCleanHistoryDetail() && this.state.dustCollectionStatus) K = K + '| ' + module500.dust_collection_status_1;
          var q = [n.cleanHistory.gradSuccessLeft, n.cleanHistory.gradSuccessRight],
            module1852 = [n.cleanHistory.gradFailLeft, n.cleanHistory.gradFailRight],
            ...
            module1860 =
              module422.DMM.isV1 && !module390.default.isObaAccount()
                ? React.default.createElement(module12.View, null)
                : React.default.createElement(
                    module12.TouchableWithoutFeedback,
                    module22.default(
                    ...
                    React.default.createElement(
                      ...
                      React.default.createElement(
                        ...
                        ' ',
                        module500.clean_path_record_palyback,
                        ' '
                      )
                    )
                  ),
            ie = React.default.createElement(
              ...
              globals.isRTL ? module1860 : te,
              globals.isRTL ? te : module1860
            ),
            module1861 = React.default.createElement(
              module12.TouchableWithoutFeedback,
              {
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  ' ',
                  module500.map_object_cancel_privacy_stop,
                  ' '
                )
              )
            ),
            module1862 = React.default.createElement(
              module12.TouchableWithoutFeedback,
              module22.default(
                {
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  ' ',
                  module500.clean_path_record_pause,
                  ' '
                )
              )
            ),
            module1860 = React.default.createElement(
              module12.TouchableWithoutFeedback,
              module22.default(
                {
                  onPress: this.onPressPlay.bind(this),
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  ' ',
                  module500.clean_path_record_play,
                  ' '
                )
              )
            ),
            module1863 = React.default.createElement(
              module12.TouchableWithoutFeedback,
              module22.default(
                {
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  module500.clean_path_record_speed
                )
              )
            );
          ...
          if (this.state.uiStatus != J) {
            ...
            ie = React.default.createElement(
              ...
              globals.isRTL ? module1863 : module1861,
              se ? module1860 : module1862,
              globals.isRTL ? module1861 : module1863
            );
          }
            ...
            React.default.createElement(
              ...
              this.state.hasGotMap
                ? React.default.createElement(module1330.MapView, {
                    ...
                    syncMapDeg: false,
                    left: module1330.MapEditCommonStyles.mapLeft,
                    right: module1330.MapEditCommonStyles.mapRight,
                    top: module1330.MapEditCommonStyles.mapTop,
                    bottom: Y + 40,
                    alwaysShowFBZ: true,
                    showMapObjectDebugInfo: !module422.DMM.isV1 && this.state.mapDebugInfoVisible,
              ...
              React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  {
                    colors: 1 == this.props.navigation.state.params.status ? q : module1852,
                    start: {
                      x: 0,
                      y: 0,
                    },
              ...
              React.default.createElement(module1794.default, {
                style: {
                  position: 'absolute',
                  bottom: 0,
                  height: Q,
      ...
      },
      {
        key: 'getDescText',
        value: function () {
          var t = module1153.CleanFinishCleanReasons()[this.state.finishReasonCode];
          return undefined == t || '' == t || t.length < 1
            ? 1 == this.props.navigation.state.params.status
              ? module500.localization_strings_Main_Constants_68
              : module500.localization_strings_Setting_History_index_15
            : t;
        },
      },
      {
...
exports.default = module1853;
module1853.contextType = module515.AppConfigContext;
var ee = module12.StyleSheet.create({
  container: {
    ...
    marginTop: -module391.default.iOSAndroidReturn(
      module1414.titleBarContentHeight + module1153.StatusBarHeight + module1153.AppBarMarginTop,
      (module12.StatusBar.currentHeight || 0) + module1414.titleBarContentHeight
    ),
  },
  contentView: {
    flex: 1,
