exports.default = function (t) {
    ...
    function O() {
      ...
      (t = P.call(this, ...args))._renderScene = function (n) {
        var o = n.route,
          ...
          p = u[o.key],
          l = p.getComponent();
        return <module1034.SceneView screenProps={c} navigation={p.navigation} component={l} />;
      };
      ...
      t._jumpTo = function (n) {
        return t.props.navigation.dispatch(
          module1034.NavigationActions.navigate({
            routeName: n,
          })
        );
      };
  ...
  return function (t) {
    var o = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : {},
      s = module1034.TabRouter(t, o),
      c = module1034.createNavigator(n, s, o);
    return module1034.createNavigationContainer(c);
  };
};
