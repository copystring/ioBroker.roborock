...
var H = function () {},
  ...
  q = (function (t) {
    ...
    function I(t) {
      ...
      n._getTransitionConfig = function () {
        ...
        return module1079.default.getTransitionConfig(n.props.transitionConfig, n.props.transitionProps, n.props.lastTransitionProps, t);
      };
    ...
    module5.default(I, [
      {
        ...
        value: function (t, o) {
          ...
          var p =
              s ||
              function (t) {
                return React.default.createElement(module1070.default, t);
              },
      ...
      },
      {
        key: '_reset',
        value: function (t, n) {
          if ('ios' === module12.Platform.OS && module1081.supportsImprovedSpringAnimation())
        ...
        value: function (t, n) {
          ...
          var f = function () {
            ...
            if (!o._isResponding && t) {
              p.dispatch(
                module1034.NavigationActions.back({
                  key: t.route.key,
                  immediate: true,
                })
              );
              p.dispatch(module1034.StackActions.completeTransition());
            }
          };
  ...
  X = module1034.withOrientation(q);
