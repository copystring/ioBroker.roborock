            ...
            for (;;)
              switch ((o.prev = o.next)) {
                case 0:
                  o.prev = 0;
                  o.next = 3;
                  return regeneratorRuntime.default.awrap(module418.GetStorageKey(module418.StorageKeys.ChatVolumeValue));
                ...
                case 3:
                  ...
                  o.next = 7;
                  return regeneratorRuntime.default.awrap(module414.default.setVoiceChatVolume(t ? parseInt(t) : parseInt(this.state.value)));
            ...
            for (;;)
              switch ((u.prev = u.next)) {
                case 0:
                  ...
                  u.next = 5;
                  return regeneratorRuntime.default.awrap(module418.SetStorageKey(module418.StorageKeys.ChatVolumeValue, '' + module4));

                case 5:
                  u.prev = 5;
                  u.next = 8;
                  return regeneratorRuntime.default.awrap(module414.default.setVoiceChatVolume(module4));
