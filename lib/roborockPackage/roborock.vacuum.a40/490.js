    ...
    module5.default(R, [
            ...
            function (n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    n.next = 2;
                    return regeneratorRuntime.default.awrap(module417.Log.getLogList());
                  ...
                  case 5:
                    (t = n.t0).push(module417.Log.beginTime);
            ...
            function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    t.next = 2;
                    return regeneratorRuntime.default.awrap(module417.Log.deleteAll());
      ...
      },
      {
        ...
        value: function () {
          ...
          module417.Log.uploadAll(function () {
              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    ...
                    if (this.loadingView) this.loadingView.showWithText('log\u4e0a\u4f20\u4e2d...');
                    l.next = 4;
                    return regeneratorRuntime.default.awrap(module417.Log.upload(t, module22));

                  case 4:
                    if (this.loadingView) this.loadingView.hide();
                    module12.Clipboard.setString(module489((module22 ? module417.Log.beginTime : t) + '_' + module393.userId + '_' + module393.deviceId));
      ...
      },
      {
        key: 'copyId',
        value: function (t) {
          module12.Clipboard.setString(module489(t + '_' + module393.userId + '_' + module393.deviceId));
      ...
      },
      {
        ...
        value: function (t, n) {
          this.props.navigation.navigate('LogDetailPage', {
            logId: 0 == n ? 'current' : t,
            title: 0 == n ? '\u5b9e\u65f6log,\u4e0b\u62c9\u5237\u65b0\u83b7\u53d6\u6700\u65b0' : module420.default.getTime(t),
          });
        },
      },
    ]);
