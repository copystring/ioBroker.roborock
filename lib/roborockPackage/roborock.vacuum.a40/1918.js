  ...
  E = (function (t) {
    ...
    function O(t) {
      ...
      s.state = {
        ...
        status: 'normal',
        locked: false,
        message: s.mode == T ? module500.draw_new_gestue_password_tip : module500.input_gestue_password_tip,
        timeCount: B,
      };
      s.password = null;
      s.oldPassword = null;
    ...
    module5.default(O, [
      ...
      },
      {
        ...
        value: function () {
          var t = [module500.title_password, module500.verify_gesture_password, module500.disable_gesture_password, module500.modify_password];
              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    l.prev = 0;
                    l.next = 3;
                    return regeneratorRuntime.default.awrap(module414.default.checkSecPassword(module489(t)));

                  case 3:
                    n = l.sent;
                    console.log('checkSecPassword - ' + JSON.stringify(n));
                    module394.MC.gesturePassword = module489(t);
                  ...
                  case 10:
                    ...
                    else this.handleWrongPassword('timeout' == l.t0.data.error ? module500.robot_communication_exception : module500.password_is_incorrect_tip);
                    module416.Log.log(
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (t.length < 4) this.handleWrongPassword(module500.gesture_password_at_least_four_length);
          else {
      ...
      },
      {
        ...
        value: function (t, s) {
          if (this.isSetModeFirstlyInput) {
            ...
            this.setState({
              status: 'normal',
              message: module500.please_draw_again,
            });
          } else if (t != this.password) this.handleWrongPassword(module500.password_is_not_same_with_older);
                ...
                switch ((u.prev = u.next)) {
                  case 0:
                    ...
                    return regeneratorRuntime.default.awrap(
                      module414.default.setSecPassword({
                        enable_password: t ? 1 : 0,
                        old_password: s ? module489(s) : '',
                        new_password: n ? module489(n) : '',
                      })
                    );
                  ...
                  case 3:
                    ...
                    u.next = 7;
                    return regeneratorRuntime.default.awrap(
                      module418.SetStorageKey(module418.StorageKeys.HasSetInitialGesturePassword, module418.StorageKeys.HasSetInitialGesturePassword)
                    );

                  case 7:
                    module394.MC.gesturePassword = module489(n);
                    if (l) l();
                    u.next = 14;
                    break;
                  ...
                  case 11:
                    u.prev = 11;
                    u.t0 = u.catch(0);
                    console.log('setSecPassword  error: ' + ('object' == typeof u.t0 ? JSON.stringify(u.t0) : u.t0));
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this.handleSetNewPassword(
            ...
            o ||
              function () {
                return s.toastThenBack(module500.gesture_password_set_successfully_tip);
              }
          );
        },
      },
        ...
        value: function (t) {
          ...
          this.checkPassword(t, function (t) {
            s.rpcUpdatePassword(false, t, '', function () {
              return s.toastThenBack(module500.disable_gesture_password_successfully_tip);
            });
          });
        },
      },
        ...
        value: function (t) {
          ...
          if (this.isOldPasswordVerified)
            this.handleSetNewPassword(t, function () {
              s.toastThenBack(module500.modify_gesture_password_successfully_tip);
            });
          else
            this.checkPassword(t, function (t) {
              s.oldPassword = t;
              s.setState({
                state: 'normal',
                message: module500.begin_draw_new_gesture_password,
              });
            });
        },
      },
        ...
        value: function () {
          ...
          return (
            ...
            React.default.createElement(module385.PureButton, {
              ...
              title: n ? module500.title_skip : module500.forget_password,
        ...
        value: function () {
          ...
          if (this.alert)
            this.alert.customAlert(
              '',
              module500.reset_gesture_password_tip,
              function () {
                var s;
                return regeneratorRuntime.default.async(
                  function (n) {
                    for (;;)
                      switch ((n.prev = n.next)) {
                        case 0:
                          n.prev = 0;
                          n.next = 3;
                          return regeneratorRuntime.default.awrap(module414.default.resetSecPassword());

                        case 3:
                          s = n.sent;
                          console.log('resetSecPassword - ' + JSON.stringify(s));
                          t.toastThenBack(module500.disable_gesture_password_successfully_tip);
                          n.next = 11;
                          break;
          ...
          return (
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                module500.video_func_is_locked
              ),
              React.default.createElement(
                module12.Text,
                {
                ...
                module500.retry_after_30_seconds,
                ' - ',
      ...
      },
      {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            !this.state.locked &&
              React.default.createElement(module1919.default, {
                ref: function (s) {
                  t.gesturePassword = s;
                },
                title: module500.gesture_password_title,
