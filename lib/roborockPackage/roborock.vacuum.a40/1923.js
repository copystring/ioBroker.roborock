    ...
    o._onPressBottomBtn = function () {
      ...
      if (module381.RSM.mapSaveEnabled)
        module381.RSM.isRunning
          ...
          : module1508.default.mapObjectPhotoEnabled &&
            module390.default.isPhotoUploadSupported() &&
            !module391.default.isShareUser() &&
            (module422.DMM.isTanosV_CN || module422.DMM.isTopazSV_CN)
                  ...
                  setTimeout(function () {
                    if (0 == t) o.mapObjectIgnoreDescDialog && o.mapObjectIgnoreDescDialog.show();
                      ...
                      o.props.navigation.navigate('ObstacleTypeSelection', {
                        title: module500.actual_type_of_obstacle,
                        currentObj: n,
                      });
                    }
                  }, 500);
    ...
    },
    {
      ...
      value: function () {
        ...
        var t = this,
          ...
          n = module12.Dimensions.get('window').height - module1153.StatusBarHeight - 44 - 150,
        ...
        if (this.state.photoSize && this.state.rectInfo) {
          var V = s / this.state.photoSize.width,
            ...
            module1936 = T + B + 10 > s ? s - T - B - 2 : 10;
          T -= A;
          x -= F;
          B = B + A + module1936;
          L = L + F + H;
        ...
        var module1934 = this.getInnerFailedView(require('./1934'), module500.button_title_retry),
          module1434 = React.default.createElement(module1025.default, {
            ref: function (o) {
          ...
          ee = React.default.createElement(
            ...
            React.default.createElement(
              ...
              v,
              this.state.readPhotoLoadingStatus == K.LOADING && module1434,
              this.state.readPhotoLoadingStatus == K.FAILED && module1934
            )
          ),
          te = module422.DMM.obstacleImagesMap.topBigImage[f],
          module1935 = React.default.createElement(
            module12.ImageBackground,
            {
              resizeMode: 'cover',
              style: {
          ...
          ne = module1153.obstacleNames[f];
        if (undefined === ne) ne = ' ';
        if (!(42 != f || module422.DMM.isV1)) ne += '(AI)';
        var ae =
            module1508.default.mapObjectPhotoEnabled &&
            module390.default.isPhotoUploadSupported() &&
            !module391.default.isShareUser() &&
            (module422.DMM.isTanosV_CN || module422.DMM.isTopazSV_CN),
          ie = module390.default.isStructuredLightSupported() ? module1153.obstacleRemoveTipsStructuredLight : module1153.obstacleRemoveTips,
          re = this.state.selfHeight ** n,
          se = R(
            R({}, module1159.BaseShadow),
            {},
            {
              width: s,
              height: re,
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    React.default.createElement(module1212.ActionSheetView, {
                      actions: [module500.obstacle_photo_page_ignore, module500.obstacle_photo_page_feedback],
        ...
        return React.default.createElement(
          ...
          React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(
                ...
                module390.default.isFwFilterObstacleSupported() && module1508.default.mapObjectPhotoEnabled && y && y.length >= 1 ? ee : module1935,
                React.default.createElement(
                  module12.View,
                  {
                    style: J.line,
                  ...
                  React.default.createElement(
                    ...
                    module500.obstacle_photo_page_subtitle + ne
                  )
                ),
                (function () {
                  if (18 == f) return React.default.createElement(module12.View, null);
                  if (42 == f && module422.DMM.isV1) return React.default.createElement(module12.View, null);

                  if (t.props.navigation.state.params.shouldShowPossibility) {
                    var n = !module422.DMM.isV1 && t.state.mapDebugInfoVisible ? ' | \u5750\u6807\u7cfb: ' + u + ' ' + h : '';
                    return React.default.createElement(
                      module12.Text,
                      {
                        style: [
                      ...
                      module500.obstacle_photo_page_percent + Math.floor(t.props.navigation.state.params.currentObj.percent / 100) + '%' + n
                    );
                  }
          ...
          React.default.createElement(
            ...
            (18 != f || module390.default.isIgnoreUnknownMapObjectSupported()) &&
              React.default.createElement(module385.PureButton, {
                ...
                title: ae ? module500.obstacle_photo_page_identify_mistakes : module500.obstacle_photo_page_ignore_link,
          ...
          React.default.createElement(module1924.MapObjectIgnoreDescDialog, {
            ref: function (o) {
              return (t.mapObjectIgnoreDescDialog = o);
            },
            confirmTextColor: '#007AFF',
            confirmTitle: module500.rubys_location_confirm_button_confirm,
