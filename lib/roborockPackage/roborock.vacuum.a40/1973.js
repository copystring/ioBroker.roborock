...
var module500 = require('./500').strings,
  ...
  E = (function (t) {
    ...
    function E(t) {
      ...
      (o = _.call(this, t))._onPressShowFurnitureIcon = function (t) {
        o.setState({
          showFurnitureModel: t,
        });
        module418
          .SetStorageKey(module418.StorageKeys.ShowFurnitureModel, t ? 'on' : '')
          .then(function () {
            ...
            for (;;)
              switch ((s.prev = s.next)) {
                case 0:
                  s.prev = 0;
                  s.next = 3;
                  return regeneratorRuntime.default.awrap(module418.SetStorageKey(module418.StorageKeys.AutoIdentifyRoomTag, t ? 'true' : 'false'));
            ...
            for (;;)
              switch ((s.prev = s.next)) {
                case 0:
                  ...
                  module418
                    .SetStorageKey(module418.StorageKeys.SapMapBeautifyFlag, t ? 'on' : 'close')
                    .then(function () {
    ...
    module5.default(E, [
      ...
      },
      {
        ...
        value: function () {
          var t = module390.default.isDebuggableV1User(),
            o = module393.userScope,
            s = 'DEV_TEST' == o,
            n = 'DEV_TEST' == o || 'INTERNAL_TEST' == o,
            u = F.hasElement(o),
            h = module390.default.isMapBeautifyInternalDebugSupported() && n,
            l = u && !module393.isMiApp && 'cn' == module381.RSM.countryCode && 'cn' == module381.RSM.deviceLocation;
          return [
            {
              title: '\u5206\u533a\u5730\u56fe\u8c03\u8bd5',
            ...
            },
            {
              ...
              visible: h || t,
              shouldShowBottomLongLine: module422.DMM.isGarnet,
            ...
            },
            {
              ...
              visible: (module422.DMM.isSapphirePlus && n) || t,
              shouldShowBottomLongLine: module422.DMM.isSapphirePlus,
            },
            {
              visible: module422.DMM.isSapphirePlus,
            },
            {
              title: '\u80f6\u5237\u5730\u6bef\u663e\u793a',
              shouldShowSwitch: true,
            ...
            },
            {
              ...
              visible: module390.default.isCameraSupported() || module390.default.isStructuredLightSupported() || t,
              shouldShowBottomLine: false,
            },
            {
              visible: module390.default.isCameraSupported() || module390.default.isStructuredLightSupported() || t,
            },
            {
              ...
              visible: (module390.default.isSupportFurniture() && n) || t,
              shouldShowBottomLine: false,
            },
            {
              title: '\u623f\u95f4\u81ea\u52a8\u8bc6\u522b',
              ...
              visible: (module390.default.isSupportFurniture() && module390.default.isSupportRoomTag() && n) || t,
              shouldShowBottomLine: false,
            },
            {
              visible: (module390.default.isSupportFurniture() && n) || t,
            },
            {
              ...
              visible: (module390.default.isRubberBrushCarpetSupported() && s) || t,
              shouldShowBottomLine: false,
            },
            {
              visible: (module390.default.isRubberBrushCarpetSupported() && s) || t,
            },
            {
              title: '\u5730\u6bef\u626b\u62d6\u65b9\u5f0f',
              shouldShowRightArrow: true,
              onPress: this._onPressCarpetCleanMode.bind(this),
              visible: (n && module422.DMM.isTopazSV) || t,
            ...
            {
              visible: n && module422.DMM.isTopazSV,
            },
            {
              title: '\u5b9e\u666f\u7167\u7247',
              shouldShowSwitch: true,
              ...
              visible: ((module422.DMM.isTanosSPlus || module422.DMM.isTanosSMax || module422.DMM.isTopazSPlus) && u) || t,
              shouldShowBottomLine: false,
            },
            {
              title: '\u514d\u78b0\u649e\u529f\u80fd\u5f00\u5173',
            ...
            },
            {
              ...
              visible: (module390.default.isShowGeneralObstacle() && u) || t,
            },
            {
              visible: (module390.default.isShowGeneralObstacle() && u) || t,
            },
            ...
            },
            {
              ...
              shouldShowRightArrow: true,
              onPress: function () {
                module418.clearAllAsyncStorage();
            ...
            },
            {
              ...
              visible: (this.state.shouldShowTestIDListItem && l) || t,
              shouldShowTopLine: false,
              shouldShowBottomLine: false,
              shouldShowTopLongLine: false,
              shouldShowBottomLongLine: (this.state.shouldShowTestIDListItem && this.state.shouldShowVnIDListItem && l) || t,
            },
            {
              title: '\u63d0\u4ea4\u56fe\u7247\u533f\u540dID',
              shouldShowRightArrow: true,
              onPress: this.submitVnID.bind(this),
              visible: (this.state.shouldShowVnIDListItem && l) || t,
              shouldShowTopLine: false,
              shouldShowBottomLine: false,
              shouldShowTopLongLine: false,
              shouldShowBottomLongLine: false,
            ...
            },
            {
              ...
              visible: module390.default.isSupportedDrying() && s,
              shouldShowBottomLine: false,
            },
            {
              visible: true,
            },
            {
              ...
              visible: s && module390.default.isSupportCleanEstimate(),
              shouldShowBottomLine: false,
            },
            {
              visible: true,
      ...
      },
      {
        ...
        value: function (t) {
          ...
          globals.app.changeTheme(globals.app.state.theme == module516.Themes.light ? module516.Themes.dark : module516.Themes.light);
        },
      },
      {
        key: 'setThemeMode',
            ...
            function (o) {
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    o.next = 2;
                    return regeneratorRuntime.default.awrap(module418.SetStorageKey(module418.StorageKeys.HasDarkMode, t));
      ...
      },
      {
        ...
        value: function () {
          this.setState({
            ...
            darkSwitch: globals.app.state.theme == module516.Themes.dark,
            photoSwitch: module1508.default.mapObjectPhotoEnabled,
          });
        },
      },
      {
              ...
              for (;;)
                switch ((S.prev = S.next)) {
                  case 0:
                    S.prev = 0;
                    S.next = 3;
                    return regeneratorRuntime.default.awrap(module414.default.getMapBeautificationStatus());
              ...
              for (;;)
                switch ((u.prev = u.next)) {
                  ...
                  case 3:
                    ...
                    this.mapDebugStatus = o;
                    u.next = 10;
                    return regeneratorRuntime.default.awrap(module414.default.setMapBeautificationStatus(o));
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 3:
                    ...
                    module1508.default.updatePhotoPrivacy(true, function (s) {
                      if (s)
                        module418
                          .SetStorageKey(module418.StorageKeys.PhotoPrivacyVersion, module418.StorageKeys.PhotoPrivacyVersion)
                          .then(function () {
                            return module393.saveDeviceExtraValue('RRPhotoPrivacyVersion', module410.RRPhotoPrivacyVersion.toString());
                          })
                          .then(function () {
                            return module1508.default.updateCameraStatus();
                          })
                          .then(function () {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          module418
            .SetStorageKey(module418.StorageKeys.ShowSpecificObstacle, t ? 'on' : '')
            .then(function () {
      ...
      {
        key: '_onPressCarpetCleanMode',
        value: function () {
          this.props.navigation.navigate('CarpetCleanModeDebug', {});
        },
      },
      {
              ...
              for (;;)
                switch ((u.prev = u.next)) {
                  case 0:
                    u.prev = 0;
                    u.next = 3;
                    return regeneratorRuntime.default.awrap(module414.default.getAnonymousID());
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    s.prev = 0;
                    s.next = 3;
                    return regeneratorRuntime.default.awrap(module414.default.getCollisionAvoidStatus());
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    t.t0 = this;
                    t.next = 3;
                    return regeneratorRuntime.default.awrap(module418.GetStorageKey(module418.StorageKeys.ShowSpecificObstacle));
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            this.state.showVoiceTest &&
              React.default.createElement(module1974.default, {
                parent: this,
              }),
            this.state.shouldShowAnonymousIDView &&
              React.default.createElement(module1975.default, {
                ref: function (o) {
