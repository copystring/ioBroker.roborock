...
exports.default = function (t) {
  ...
  var F = module1045.createPathParser(N, t, o.paths),
  ...
  return {
    ...
    getStateForAction: function (t, o) {
      ...
      if (t.type === module1037.default.INIT) {
        var p = t.params;
        if (p)
      ...
      if (t.type === module1037.default.BACK) {
        if (!F || !b) return f;
        s = j;
      }
      ...
      if (
        t.type === module1037.default.NAVIGATE &&
      ...
      G = t.type;
      if ([module1037.default.SET_PARAMS, module1091.default.COMPLETE_TRANSITION].includes(G)) K = f.index;
    ...
    getComponentForState: function (n) {
      ...
      module1040.default(o, 'There is no route defined for index ' + n.index + '. Check that\n        that you passed in a navigation state with a valid tab/screen index.');
      var s = N[o];
      return s ? s.getComponentForState(n.routes[n.index]) : module1088.default(t, o);
    },
