...
var module389 = require('./389'),
  ...
  module1507 = require('./1507').getToast,
    ...
    module5.default(R, [
      ...
      },
      {
        ...
        value: function () {
          ...
          if (!(null == (n = this.mapView))) n.setState(P({}, module1329.MM.mapData));
          ...
          this.statusListener = module12.DeviceEventEmitter.addListener(module418.NotificationKeys.RobotStatusDidUpdate, function (t) {
            o.checkButtonStatus();
          });
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            module1901 = React.default.createElement(module385.PureImageButton, {
              funcId: 'egg_entrance',
              style: {
                marginRight: 10,
              },
        ...
        value: function () {
          ...
          this.isGoingTimer = setTimeout(function () {
            if (t.editMenu)
              t.editMenu.setState({
                isGoing: false,
                tip: module500.rubys_main_goto_click_text,
              });
          }, 5e3);
        },
      },
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              React.default.createElement(module1516, {
                ref: function (n) {
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  ...
                  case 4:
                    ...
                    this.alert.alert('', module500.rubys_main_goto_cancel_alet, [
                      {
                              ...
                              for (;;)
                                switch ((n.prev = n.next)) {
                                  case 0:
                                    ...
                                    n.next = 4;
                                    return regeneratorRuntime.default.awrap(module414.default.gotoTargetStop());
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    globals.showToast(module500.localization_strings_Setting_RemoteControlPage_13);
                    c.next = 43;
                    break;
                  ...
                  case 6:
                    ...
                    globals.showToast(module500.localization_strings_Setting_RemoteControlPage_19);
                    c.next = 43;
                    break;
                  ...
                  case 10:
                    ...
                    globals.showToast(module500.localization_strings_Setting_RemoteControlPage_20);
                    c.next = 43;
                    break;
                  ...
                  case 14:
                    ...
                    c.prev = 15;
                    c.next = 18;
                    return regeneratorRuntime.default.awrap(module414.default.spot());
                  ...
                  case 26:
                    ...
                    s = module500.home_dialog_begin_new_clean;
                    if (t == module381.RobotState.BACK_TO_DOCK) s = module500.home_dialog_begin_new_clean;
                    if (t == module381.RobotState.GOTO_TARGET) s = module500.home_dialog_begin_new_clean;
                    if (t == module381.RobotState.ZONED_CLEAN) s = module500.home_dialog_begin_new_clean;
                    this.alert.alert('', s, [
                      {
                        text: module500.localization_strings_Main_MainPage_11,
                        onPress: function () {},
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    globals.showToast(module500.rubys_main_goto_click_text);
                  ...
                  case 10:
                    ...
                    s = module500.localization_strings_abort_current_task_and_start_goto;
                    if (n == module381.RobotState.BACK_TO_DOCK) s = module500.localization_strings_abort_current_task_and_start_goto;
                    if (n == module381.RobotState.ZONED_CLEAN) s = module500.localization_strings_abort_current_task_and_start_goto;
                    if (n == module381.RobotState.SPOT_CLEAN) s = module500.localization_strings_abort_current_task_and_start_goto;
                    if (n == module381.RobotState.REMOTE) s = module500.localization_strings_abort_current_task_and_start_goto;
                    this.alert.alert('', s, [
                      {
                        text: module500.localization_strings_Main_MainPage_11,
                        onPress: function () {},
                                            ...
                                            switch ((n.prev = n.next)) {
                                              case 0:
                                                ...
                                                if (u.editMenu)
                                                  u.editMenu.setState({
                                                    isGoing: true,
                                                    tip: module500.rubys_main_subtitle_goto_target,
                                                  });
                                                n.next = 4;
                                              ...
                                              case 4:
                                                n.next = 6;
                                                return regeneratorRuntime.default.awrap(module414.default.gotoTarget(t));
            ...
            function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    t.next = 2;
                    return regeneratorRuntime.default.awrap(module414.default.appWakeupRobot());
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          this.specialToastListener = module12.DeviceEventEmitter.addListener(module418.NotificationKeys.DidReceiveSpecialEvent, function (n) {
            var o = n.data;
            t.toastInfo = o;
            if ('goto_target_succ' != o) {
              if (!('target_not_reachable' != o && 'relocate_fail' != o))
                t.editMenu &&
                  t.editMenu.setState({
                    isGoing: false,
                    tip: module500.rubys_main_toast_goto_not_finish,
                  });
            } else if (t.editMenu)
              t.editMenu.setState({
                isGoing: false,
                tip: module500.rubys_main_toast_goto_finish,
              });
          });
        },
      },
      ...
      },
      {
        ...
        value: function () {
          var t = this;
          this.robotEventListener = module12.DeviceEventEmitter.addListener(module418.NotificationKeys.EventToastChange, function (n) {
            t.showEventToast(n);
          });
        },
      },
