                  ...
                  switch ((s.prev = s.next)) {
                    case 0:
                      ...
                      this.resultTimerList.forEach(function (t) {
                        if (!(module1513.isTimerExpiredByRepeatMode(t.repeatMode, t.fullDate + ':59') && 0 != module381.RSM.FCCState)) module23.push(t);
                      });
                  ...
                  switch ((T.prev = T.next)) {
                    case 0:
                              ...
                              switch ((o.prev = o.next)) {
                                case 0:
                                  if (
                                    ...
                                    (S = module1512.ConvertToReadableFormat(s.setting.on_time)),
                                    (L = module1513.fixTargetTime(S)),
                                    (O = module1513.convertToPhoneTimeZoneTime(S.minute, S.hour, S.dateofmonth, S.month)),
                                    (w = O.hour),
                                    (M = O.minute),
                                    (k = new Date()),
                                    (P = k.getFullYear()),
                                    1 == O.month && 1 == O.day && k.getMonth() + 1 == 12 && 31 == k.getDate() && (P += 1),
                                    (R = '' + P + module1513.addZeroPrefix(O.month) + module1513.addZeroPrefix(O.day)),
                                    (D = R + ' ' + module1513.addZeroPrefix(w) + ':' + module1513.addZeroPrefix(M)),
                                    !(C = module1513.isTimerExpired(S.repeat, D + ':59', false)))
                                  ) {
                                    o.next = 20;
                                    break;
                                  }

                                  module1513.deleteServerTimer(s, h);
                                  console.log('task is outOfDate - date-' + D + ' - ' + h + ' - ' + C);
                                  return o.abrupt('return');

                                case 20:
                                  if ((F = module1513.getRepeatMode(S.repeat, false)) != module1513.RepeatMode.Once)
                                    O.month == L.month
                                      ? O.day == L.day + 1
                                        ? (F = module1513.getDaysArrByOffset(F, 1))
                                        : O.day == L.day - 1 && (F = module1513.getDaysArrByOffset(F, -1))
                                      : (F = 1 == O.day ? module1513.getDaysArrByOffset(F, 1) : module1513.getDaysArrByOffset(F, -1));
                                  _ = module1513.timerRepeatToCronRepeat(F);
                                  N = module1513.getTextOfRepeatPattern(_, R, false);
                                  I = module1513.addZeroPrefix(O.hour) + ' : ' + module1513.addZeroPrefix(O.minute);
                                  J = module1513.convetToWeekendsByStartTime(F, S.dateofmonth, S.month);
                                  Z = v(
                                    {
                                      name: h,
                                      hour: O.hour,
                      ...
                      module4.forEach(function (t) {
                        ...
                        if (s) module1510.push(s);
                      });
                      this.miTimerScenes = module1510;
                            ...
                            for (;;)
                              switch ((h.prev = h.next)) {
                                case 0:
                                  ...
                                  h.next = 7;
                                  return regeneratorRuntime.default.awrap(module414.default.deleteServerTimer(u));
                    ...
                    switch ((B.prev = B.next)) {
                      ...
                      case 6:
                        if (
                          ...
                          (O = S[1]),
                          '00000000' == s.date &&
                            ((w = new Date()), (s.date = '' + w.getFullYear() + module1513.addZeroPrefix(w.getMonth() + 1) + module1513.addZeroPrefix(w.getDate()))),
                          (M = s.date + ' ' + s.time),
                          (k = module1510.default(M, 'YYYYMMDD HH:mm')),
                          console.log('date date - ' + k.date() + ' - ' + (k.month() + 1)),
                          (P = module1513.convertTimeFromSourceZoneToPhoneZone(O, L, k.date(), k.month() + 1, module393.robotTimeZone)),
                          (L = P.hour),
                          (O = P.minute),
                          (M = s.date + ' ' + module1513.addZeroPrefix(L) + ' : ' + module1513.addZeroPrefix(O)),
                          !module1513.isTimerExpired(s.loops, M + ':59', true))
                        ) {
                          B.next = 22;
                          break;
                        }
                        ...
                        B.next = 20;
                        return regeneratorRuntime.default.awrap(module1513.deleteServerTimer(s.timerId, T));

                      case 20:
                        console.log('task is outOfDate - date-' + s.date + ' ' + s.time + ' - ' + module1513.isTimerExpired(s.loops, M + ':59', true));
                        return B.abrupt('return');

                      case 22:
                        R = module1513.getRepeatMode(s.loops, true);
                        R = module1513.resolveRepeatModeByTargetTime(R, k.month() + 1, k.date(), P.month, P.day);
                        R = module1513.getRepeatMode(R, true);
                        D = module1513.getTextOfRepeatPattern(R, s.date, true);
                        C = module1513.convetToWeekendsByStartTime(R, P.dateofmonth, P.month);
                        ...
                        _ = v(
                          {
                            ...
                            date: s.date,
                            timerId: s.timerId,
                            cleanTime: module1513.addZeroPrefix(L) + ' : ' + module1513.addZeroPrefix(O),
                            repeatMode: R,
                            repeatModeText: D,
                            startWeekdays: C,
                            disable: F,
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (t[0].constructor == Object) {
              ...
              T = b.clean_mop;
              v = b.mop_template_id;
              y = module1328.ModeDataInstance.getCustomMopModeNameById(v);
            } else {
                            ...
                            for (;;)
                              switch ((o.prev = o.next)) {
                                case 0:
                                  ...
                                  v = T[0];
                                  y = T[1];
                                  S = module1512.ConvertToReadableFormat(v);
                                  L = 0;
                                  O = [];
                                  w = 0;
                                  M = 0;
                                  ...
                                  if (
                                    ...
                                    R = _.clean_mop;
                                    D = _.mop_template_id;
                                    C = module1328.ModeDataInstance.getCustomMopModeNameById(D);
                                  } else {
                                  ...
                                  Z = '' + new Date().getFullYear() + module1513.addZeroPrefix(S.month) + module1513.addZeroPrefix(S.dateofmonth);
                                  j = Z + ' ' + module1513.addZeroPrefix(S.hour) + ':' + module1513.addZeroPrefix(S.minute);
                                  B = module1513.getRepeatMode(S.repeat, false);
                                  E = module1513.getTextOfRepeatPattern(S.repeat, Z, false);
                                  H = module1513.addZeroPrefix(S.hour) + ' : ' + module1513.addZeroPrefix(S.minute);
                                  A = module1513.convetToWeekendsByStartTime(B, S.dateofmonth, S.month);
                                  Y = {
                                    name: l,
                                    hour: S.hour,
                                    minute: S.minute,
                ...
                for (;;)
                  switch ((u.prev = u.next)) {
                    case 0:
                      ...
                      u.next = 4;
                      return regeneratorRuntime.default.awrap(module1513.deleteServerTimer(module50, module23.name));
                ...
                for (;;)
                  switch ((u.prev = u.next)) {
                    case 0:
                      ...
                      u.next = 4;
                      return regeneratorRuntime.default.awrap(module414.default.deleteTimer(module23.name));
                ...
                for (;;)
                  switch ((T.prev = T.next)) {
                    case 0:
                      ...
                      T.next = 5;
                      return regeneratorRuntime.default.awrap(module414.default.updateServerTimer([[n.name, u]]));
                    ...
                    case 13:
                      T.next = 15;
                      return regeneratorRuntime.default.awrap(module414.default.updateTimer([n.name, u]));
                    ...
                    case 3:
                      if (this.resultTimerList)
                        this.resultTimerList.forEach(function (s) {
                          var o = module1512.GetExecDate(s.hour, s.minute, module1513.timerRepeatToCronRepeat(s.repeatMode)),
                            u = new Date();
