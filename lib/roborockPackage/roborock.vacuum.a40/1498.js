...
var w = React.forwardRef(function (t, o) {
    ...
    var x =
      ...
      E = [
        S(
          S({}, module1496.getChargeButtonConfig(_, u)),
          {},
          {
        ...
        S(
          S({}, module1496.getCleanButtonConfig(w, u)),
          {},
          {
        ...
        S(
          S({}, module1496.getWashingDusterButtonConfig(y, u)),
          {},
          {
  ...
  R = module12.StyleSheet.create({
    ...
    bottomButton: {
      width: module1159.BottomControlBottomThreeButtonWidth,
      backgroundColor: 'transparent',
