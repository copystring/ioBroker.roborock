...
exports.fixDeviceScreenHeight = function () {
  ...
  if (y)
    'ios' != module12.Platform.OS
      ...
      : re && Pe();
  else if ('ios' != module12.Platform.OS) Pe();
  var n, o;
};
    ...
    function (o) {
      for (;;)
        switch ((o.prev = o.next)) {
          case 0:
            o.next = 2;
            return regeneratorRuntime.default.awrap(ye());

          case 2:
            n = o.sent;
            return o.abrupt('return', ke(n));
...
function le(n, o, t) {
  if (y)
    require('./510').downloadFile(n, o, function (n, o) {
      t(n, o);
    });
  else
