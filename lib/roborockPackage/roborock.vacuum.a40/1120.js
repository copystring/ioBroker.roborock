  ...
  I = (function (t, ...args) {
    ...
    function x() {
      ...
      t._renderIcon = function (n) {
        ...
        return React.default.createElement(module1119.default, {
          position: l,
          navigation: s,
          activeTintColor: c,
          inactiveTintColor: u,
      ...
      t._handleTabPress = function (n) {
        ...
        if (s.state.index === n) {
          ...
          if (c.hasOwnProperty('index') && c.index > 0)
            s.dispatch(
              module1034.StackActions.popToTop({
                key: c.key,
              })
            );
        } else l(n);
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            I = [O.tabBar, this._shouldUseHorizontalTabs() && !module12.Platform.isPad ? O.tabBarCompact : O.tabBarRegular, v];
...
var O = module12.StyleSheet.create({
  ...
  S = module1034.withOrientation(I);
exports.default = S;
