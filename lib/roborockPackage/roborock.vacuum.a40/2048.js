    ...
    module5.default(C, [
              ...
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    o.t0 = JSON;
                    o.next = 3;
                    return regeneratorRuntime.default.awrap(module418.GetStorageKey('tttt_map_data'));
      ...
      },
      {
        ...
        value: function () {
          ...
          this.statusListener = module12.DeviceEventEmitter.addListener(module418.NotificationKeys.RobotStatusDidUpdate, function (o) {
            t.forceUpdate();
          });
        },
      },
      {
        ...
        value: function () {
          ...
          } else this.showMsg(module500.voice_chat_title2);
        },
      },
      {
        key: 'minsize',
        ...
        value: function () {
          ...
          var t = this,
            ...
            w = React.default.createElement(
              f,
              {
                style: [G.container, n ? null : G.landscapeContainer, n ? null : p],
              },
              M &&
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    module381.RSM.state == module381.RobotState.GOTO_TARGET ? module500.rubys_main_subtitle_goto_target : module500.rubys_main_goto_click_text
                  ),
                  !n &&
              ...
              (function () {
                var n = React.default.createElement(module1330.MapView, {
                    style: {
                      flex: 1,
                    ...
                    left: M ? 20 : 5,
                    right: M ? 20 : 5,
                    bottom: M ? module1153.AppBarMarginBottom + 16 : 5,
              ...
              M &&
                React.default.createElement(module385.TopImageButton, {
                  ...
                  fontSize: 12,
                  textTop: 7,
                  title: module381.RSM.state == module381.RobotState.GOTO_TARGET ? module500.localization_strings_Common_Constants_11 : module500.rubys_main_button_text_goto_cmd,
            ...
            O = s ? 0 : module1153.AppBarMarginTop + 24,
            R = {
              width: s ? A(true) : L,
              height: s ? B(true) : L,
              opacity: s ? c : 1,
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    this.showMsg(module500.voice_chat_title2);
                  ...
                  case 3:
                            ...
                            for (;;)
                              switch ((u.prev = u.next)) {
                                ...
                                case 3:
                                  ...
                                  l.forceUpdate();
                                  module416.Log.log(module416.LogTypes.Monitor, 'gotoTarget - ' + JSON.stringify(s) + ' - fromOtherStatus:' + o, module416.InfoColors.Success);
                                  l.minsize();
                                  u.next = 13;
                                  break;
                            ...
                            for (;;)
                              switch ((t.prev = t.next)) {
                                ...
                                case 3:
                                  ...
                                  l.forceUpdate();
                                  module416.Log.log(module416.LogTypes.Monitor, 'gotoTarget stop - ' + JSON.stringify(o), module416.InfoColors.Success);
                    ...
                    this.showMsg(module500.rubys_main_goto_click_text);
                    return c.abrupt('return');

                  case 10:
                    u = {
                      BACK_TO_DOCK: module500.localization_strings_abort_current_task_and_start_goto,
                      ZONED_CLEAN: module500.localization_strings_abort_current_task_and_start_goto,
                      SPOT_CLEAN: module500.localization_strings_abort_current_task_and_start_goto,
                      REMOTE: module500.localization_strings_abort_current_task_and_start_goto,
                    };
                    if (!u[module381.RSM.state]) module500.localization_strings_abort_current_task_and_start_goto;
                    if (
...
var G = module12.StyleSheet.create({
  ...
  gotoButton: {
    ...
    height: 90,
    position: 'absolute',
    bottom: 16 + module1153.AppBarMarginBottom,
    right: 20,
  },
});
