...
var module1153 = require('./1153').Definitions,
  x = function (t) {
            ...
            function (u) {
              for (;;)
                switch ((u.prev = u.next)) {
                  case 0:
                    u.next = 2;
                    return regeneratorRuntime.default.awrap(module418.GetStorageKey(module418.StorageKeys.MonitorVideoDefinition));

                  case 2:
                    t = u.sent;
                    n = module1153.findIndex(function (n) {
                      return n.command == t;
                    });
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    this.hide();
                    s.prev = 1;
                    n = module1153[t].command;
                    module387.LogEventCommon('tap_video_quality_' + n);
                    s.next = 6;
                    return regeneratorRuntime.default.awrap(module414.default.setVideoQuality(n));
                  ...
                  case 6:
                    ...
                    s.next = 10;
                    return regeneratorRuntime.default.awrap(module418.SetStorageKey(module418.StorageKeys.MonitorVideoDefinition, n));

                  case 10:
                    if (this.props.definitionDidChange) this.props.definitionDidChange(true, module1153[t]);
