      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            s = [
              {
                title: module500.localization_strings_Common_Constants_12,
                image: this.context.theme.mapGoTo.zoneCleanImg,
              },
              {
                title: this.state.isGoing ? module500.localization_strings_Common_Constants_11 : module500.rubys_main_button_text_goto_cmd,
