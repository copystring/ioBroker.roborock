    ...
    module5.default(C, [
      {
        ...
        value: function () {
          var t = this.props.isLoadMap,
            n = module1329.MM.maps.findIndex(function (t) {
      ...
      },
      {
        ...
        value: function () {
          var t = {
            ...
            s = n.isLoadMap,
            l = n.isHomePage;
          return (module381.RSM.multiFloorEnabled || 0 == module1329.MM.maps.length) && o && !s && !l ? [t].concat(module1329.MM.maps) : module1329.MM.maps;
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            module1400 = this.state.maps.map(function (n, module1399) {
              return React.default.createElement(
                module12.View,
                {
                  ...
                  style: [
                    E.mapItem,
                    {
                      opacity: o && module1329.MM.maps.length >= module1329.MM.mapCountMax && 0 == module1399 ? 0.5 : 1,
                    },
                  ],
                },
                React.default.createElement(
                  ...
                  -1 != n.id ? (t.props.isOverwriteMode ? module500.map_save_pop_box_overwrite : t.props.isLoadMap ? '' : module500.map_edit_button_text_save) + n.name : n.name
                ),
                React.default.createElement(module385.PureImageButton, {
                  ...
                  image: require('./1399'),
                  selectedImage: require('./1400'),
                  selected: module1399 == t.state.current,
                  onPress: t.selectItem.bind(t, module1399),
                })
              );
            }),
            ...
            u = this.props.isLoadMap ? module500.home_load_map_title : this.props.isOverwriteMode ? module500.save_map_pop_box_save_title1 : module500.save_map_pop_box_save_title2;
          return React.default.createElement(
            module12.Modal,
            {
              transparent: true,
                ...
                React.default.createElement(
                  ...
                  React.default.createElement(
                    ...
                    React.default.createElement(module385.PureButton, {
                      style: E.button,
                      title: module500.localization_strings_Main_MainPage_11,
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (!this.props.isHomePage && module381.RSM.multiFloorEnabled && this.props.isOverwriteMode && module1329.MM.maps.length >= module1329.MM.mapCountMax && 0 == t) {
            this.hide();
