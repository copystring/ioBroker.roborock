...
var module500 = require('./500').strings,
  ...
  U = module1034.createSwitchNavigator(
    {
      KeyView: W ? module1916.default : module1914.default,
    },
    {
    ...
    module5.default(x, [
      {
        ...
        value: function () {
          ...
          var s = React.default.createElement(
              ...
              React.default.createElement(module1910.default, {
            ...
            c = module393.isWindowDisplay ? module1414.titleBarContentHeight + 14 : module1414.titleBarContentHeight + module1153.StatusBarHeight + module1153.AppBarMarginTop,
            l = module391.default.iOSAndroidReturn(c, module1414.titleBarHeight);
      ...
      },
      {
        ...
        value: function () {
          ...
          module512.readRemoteControlModeFlag(function (o) {
            if (o) {
              var n = parseInt(o);
      ...
      },
      {
        ...
        value: function () {
          ...
          module512.saveRemoteControlModeFlag(this.state.activeControlViewIndex);
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  ...
                  case 2:
                    ...
                    s = module1034.NavigationActions.navigate({
      ...
      },
      {
        ...
        value: function () {
          ...
          if (module393.apiLevel < 110) {
            ...
            globals.Alert.alert(module500.localization_strings_Setting_RemoteControlPage_49, module500.localization_strings_Setting_RemoteControlPage_50, [
              {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (this.noteTimerID > 0) {
            module1404.clearTimeout(this.noteTimerID);
            this.noteTimerID = 0;
          }

          this._setNoteVisible(true);

          this.noteTimerID = module1404.setTimeout(function () {
                ...
                switch ((s.prev = s.next)) {
                  case 0:
                    if (
                      ...
                      (t = function () {
                        if (o.startTimerID <= 0)
                          o.startTimerID = module1404.setInterval(function () {
      ...
      },
      {
        ...
        value: function () {
          if (this.startTimerID > 0) {
            module1404.clearInterval(this.startTimerID);
            this.startTimerID = 0;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if ((console.log('_isCheckingRemoteCondition:', this._isCheckingRemoteCondition, module500.robot_communication_exception), !this._isCheckingRemoteCondition)) {
            ...
            if (n == module381.RobotState.SPOT_CLEAN)
              globals.Alert.alert('', module500.localization_strings_abort_current_task_and_start_remote, [
                {
