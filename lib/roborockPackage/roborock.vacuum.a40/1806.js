  ...
  W = (function (t) {
    ...
    function W(t) {
      ...
      (n = B.call(this, t)).state = {
        ...
        modeBgIcon: null,
        tab: null,
        modeTitle: module500.smart_scene_clean_mode_setting_item_title,
      };
      return n;
    }
    ...
    module5.default(W, [
      ...
      },
      {
        key: 'updateUI',
        value: function () {
          this.updateModeIcon(module381.RSM.fanPower, module381.RSM.waterBoxMode, module422.DMM.isGarnet ? module381.RSM.mopModeId : module381.RSM.mopMode);
        },
      },
      {
        key: 'getLeftDatas',
        value: function () {
          var t = this.state.tab,
            n = t == module1493.TabSegment,
            o = t == module1493.TabZone,
            ...
            c = module422.DMM.isGarnet && 4 == module381.RSM.mopModeId,
            h = o && u,
          ...
          return [
            {
              ...
              accessibilityLabel: module500.map_edit_home_menu_title,
              redPointStyle: {
                top: 10,
                right: 10,
              },
            ...
            },
            {
              ...
              accessibilityLabel: module500.map_edit_bottom_menu_mode,
          ...
          return module381.RSM.hasGotMapFirstTime
            ? React.default.createElement(
                ...
                React.default.createElement(
                  ...
                  module381.RSM.isExploring && React.default.createElement(module1807.default, null)
                )
              )
            : null;
        },
        ...
        value: function (t) {
          ...
          return React.default.createElement(
            ...
            module22.default(
              ...
              module391.default.getAccessibilityLabel('main_mode_set', module500.smart_scene_clean_mode_setting_item_title),
              {
      ...
      },
      {
        ...
        value: function (t, n, o) {
          ...
          this.setState({
            ...
            smallWaterModeIcon: h ? null : module422.DMM.isGarnet ? (null == (l = module1328.ModeDataInstance.getCustomMopModeConfigById(o)) ? undefined : l.icon) : u.homesmall,
      ...
      },
      {
        key: 'isOnlyMopMode',
        value: function (t, n) {
          return module390.default.isPureCleanMopSupported() && module381.RSM.fanPower == module1326.CleanModeZero;
        },
      },
      {
...
var P = module12.StyleSheet.create({
  wrapContainer: {
    height: 200,
    marginBottom: -module1159.TabWrapHeight,
  },
  container: {
    flexDirection: 'row',
  ...
  leftContainer: {
    marginBottom: module1159.TabWrapHeight + 10,
    marginLeft: 22,
  },
  loadMapButton: {
