  ...
  F = (function (t) {
    ...
    function W(t) {
      ...
      (o = B.call(this, t)).state = {
        structureLightSwitch: module1508.default.cameraEnabled,
        avoidCollisionSwitch: false,
        loading: false,
        refreshing: false,
        mapObjectPhotoEnabled: module1508.default.mapObjectPhotoEnabled,
        sceneSwitch: false,
        isShow: false,
      };
    ...
    module5.default(W, [
      {
        ...
        value: function () {
          ...
          module1508.default.addChangeListener(this.changeListener);
      ...
      },
      {
        ...
        value: function () {
          this.mounted = false;
          module1508.default.removeChangeListener(this.changeListener);
        },
      },
      {
                ...
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    module1391.showFinishCurrentTastAlertIfNeeded().catch(function (t) {
                      o.showToast(module500.robot_communication_exception);
                    });
                    return s.abrupt('return');

                  case 3:
                    module1508.default.cameraEnabled = t;
                    if (!t) module1508.default.explorationEnabled = t;
                    this.setState({
              ...
              for (;;)
                switch ((l.prev = l.next)) {
                  case 0:
                    l.prev = 0;
                    l.next = 3;
                    return regeneratorRuntime.default.awrap(module414.default.getFloorIdentifyStatus());

                  case 3:
                    t = l.sent;
                    l.next = 6;
                    return regeneratorRuntime.default.awrap(module414.default.getFurnitureIdentifyStatus());
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    module22 = 0 == t;
                    s.next = 4;
                    return regeneratorRuntime.default.awrap(module1508.default.updatePetModeEnabled(module22));
      ...
      },
      {
        ...
        value: function () {
          return module422.DMM.isTanosV
            ? module500.camera_setting_rrai_title
            : module422.DMM.isTanosSPlus
            ? module500.localization_strings_Setting_index_24
            : module500.camera_setting_detail2;
        },
      },
      {
        ...
        value: function () {
          return module422.DMM.isTanosV
            ? module500.camera_setting_rrai_detail
            : module390.default.isObjectPhotoShowSupported()
            ? module500.camera_setting_detail3
            : module500.structure_light_tip_1;
        },
      },
      {
        key: 'render',
        value: function () {
          ...
          var l = module12.Dimensions.get('window').width - 30,
            c = {
              title: this.getThreeDimensionTitle(),
            ...
            u = {
              title: module500.avoid_collision_mode,
              bottomDetail: '' + module500.structure_light_tip_3,
              bottomDetailWidth: l - 40,
              shouldShowSwitch: true,
            ...
            h = {
              title: module500.led_status_title1,
              visible: module422.DMM.isTopazSV && this.state.structureLightSwitch,
              shouldShowBottomLine: false,
              shouldShowBottomLongLine: false,
              bottomDetailWidth: l - 40,
              isDetailCenter: false,
              rightCenter: true,
              detailColor: 0 == module1508.default.ledSetting ? '#007AFF' : this.context.theme.subTextColor,
              detail: 0 == module1508.default.ledSetting ? module500.led_status_title2 : module500.debug_info_close,
              bottomDetail: module500.led_status_detail1,
            ...
            w = {
              title: module500.camera_setting_pet_mode_title,
              visible: this.state.structureLightSwitch,
              shouldShowTopLongLine: false,
              shouldShowBottomLongLine: false,
              bottomDetailWidth: l - 40,
              isDetailCenter: false,
              rightCenter: true,
              detailColor: module1508.default.cameraEnabled ? '#007AFF' : 'rgba(0,0,0,0.4)',
              detail: module1508.default.petModeEnabled ? module500.has_or_no_has : module500.has_or_no_no,
              bottomDetail: module500.if_has_pet_tip_detail,
            ...
            E = {
              title: module500.obstacle_pop_type_photo,
              ...
              bottomDetail: module500.map_object_enable_intro,
            },
            R = {
              title: module500.camera_setting_detail4,
              bottomDetail: '' + module500.camera_setting_detail5,
              bottomDetailWidth: l - 40,
              shouldShowSwitch: true,
              switchOn: this.state.sceneSwitch,
              switchValueChanged: this.onSceneSwitch.bind(this),
              visible: (module422.DMM.isTopazSV || module422.DMM.isTanosSV) && this.state.structureLightSwitch,
              shouldShowTopLongLine: true,
              shouldShowBottomLine: true,
            },
            F = {
              title: module500.map_object_privacy_alert_link,
              ...
              onPress: function () {
                return t.props.navigation.navigate('WebViewPage', {
                  title: module500.map_object_privacy_title,
                  refrence: module1523.default.PhotoPrivacy(),
                  buttonTitle: module1508.default.mapObjectPhotoPrivacyPolicyAgreed ? module500.reset_authoration : module500.button_title_agree,
                  buttonColor: module1508.default.mapObjectPhotoPrivacyPolicyAgreed ? 'red' : '#007AFF',
                  ...
                  buttonAction: function (o) {
                    if (module381.RSM.isRunning && module1508.default.mapObjectPhotoPrivacyPolicyAgreed)
                      o.alertView &&
                      ...
                      var s = function () {
                        setTimeout(function () {
                          if (o && o.loadingView) o.loadingView.showWithText(module500.map_object_cancel_privacy_loading);
                        }, 100);
                        ...
                        module393
                          .postPrivacyAgreementStatusWithVersion(
                            ...
                            module1508.default.mapObjectPhotoPrivacyPolicyAgreed ? 5 : 4,
                            1
                          )
                          .then(function (t) {})
                          .catch(function (t) {});
                        module1508.default.updatePhotoPrivacy(!module1508.default.mapObjectPhotoPrivacyPolicyAgreed, function (n) {
                          if (
                            ...
                            if ('' != (s = module1508.default.mapObjectPhotoPrivacyPolicyAgreed ? '' : module500.map_object_cancel_privacy_success)) globals.showToast(s);
                            ...
                            LogEventCommon(module1508.default.mapObjectPhotoPrivacyPolicyAgreed ? 'accept_photo_privacy' : 'reset_photo_privacy_confirm');
                          } else {
                            var s = module1508.default.mapObjectPhotoPrivacyPolicyAgreed ? module500.map_object_cancel_privacy_timeout : module500.map_object_ignore_failed;
                            if (o) globals.showToast(s);
                          }
                        });
                      };

                      if (module1508.default.mapObjectPhotoPrivacyPolicyAgreed) {
                        if (o.alertView)
                          o.alertView.customAlert(
                            module500.reset_monitor_privacy_dialog_title,
                            module500.map_object_privacy_reset_dialog_content,
                            function () {
                              s();
                            },
                            null,
            ...
            B = React.default.createElement(module385.ActionSheetView, {
              ...
              title: module500.if_has_pet_tip_title,
              actions: [module500.has_or_no_has, module500.has_or_no_no],
            ...
            W = React.default.createElement(module385.ActionSheetView, {
              ...
              actions: [module500.led_status_title2, module500.debug_info_close],
            ...
            K = R.visible
              ...
              : React.default.createElement(module12.View, null),
            G = React.default.createElement(module12.View, {
              style: I.section,
            }),
            q = React.default.createElement(module1809.PhotoFeaturePrivacyDialog, {
              ref: function (o) {
              ...
              onConfirm: function () {
                return module1508.default.updatePhotoPrivacy(true, function (o) {
                  if (!o) globals.showToast(module500.robot_communication_exception);
                  if (o) module418.SetStorageKey(module418.StorageKeys.PhotoPrivacyVersion, module418.StorageKeys.PhotoPrivacyVersion);
            ...
            Q = F.visible
              ...
              : React.default.createElement(module12.View, null),
            X = module1414.titleBarContentHeight,
            Y =
              module391.default.iOSAndroidReturn(X + module1153.StatusBarHeight + module1153.AppBarMarginTop, (module12.StatusBar.currentHeight || 0) + X) +
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    ...
                    globals.showToast(module500.map_object_app_version_tip);
                    return c.abrupt('return');

                  case 3:
                    if (module1508.default.cameraEnabled) {
                      c.next = 6;
                      break;
                    }

                    globals.showToast(module500.camera_setting_open_rrai_tip);
                    return c.abrupt('return');
                  ...
                  case 6:
                    ...
                    module22 = module1508.default.mapObjectPhotoPrivacyPolicyAgreed;
                    c.next = 10;
                    return regeneratorRuntime.default.awrap(module418.GetStorageKey(module418.StorageKeys.PhotoPrivacyVersion));
                  ...
                  case 27:
                    ...
                    module1508.default.mapObjectPhotoEnabled = t;
                    c.next = 31;
                    return regeneratorRuntime.default.awrap(module1508.default.updateCameraStatus());
      ...
      },
      {
        ...
        value: function (t) {
          ...
          this.hideLedDialog();
          if (1 == t)
            globals.Alert.alert('', module500.led_alert_detail, [
              {
      ...
      },
      {
        ...
        value: function (t) {
          var o = this;
          module1508.default.updateLedSetting(t, function (t) {
            if (!t) o.showToast(module500.robot_communication_exception);
          });
        },
      },
      {
        ...
        value: function () {
          ...
          module1508.default
            ...
            .then(function () {
              ...
              return module390.default.isAvoidCollisionSupported() ? module414.default.getCollisionAvoidStatus() : null;
            })
            .then(function (o) {
              var n;
              t.setState({
            ...
            .catch(function (o) {
              t.showToast(module500.robot_communication_exception);
            })
            .finally(function () {
              if (module422.DMM.isTopazSV || module422.DMM.isTanosSV) t.getSceneSwitchState();
              else t.endLoading();
            });
        },
      },
