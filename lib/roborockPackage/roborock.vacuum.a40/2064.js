      ...
      },
      {
        ...
        value: function () {
          var t = this,
            ...
            c = s.style,
            l = s.calling,
            module2061 = this.props.isLandscape ? require('./2061') : this.context.theme.monitor.call,
            module2065 = this.props.isLandscape ? require('./2065') : this.context.theme.monitor.hung,
            p = l ? module2065 : module2061,
            v = l ? module500.click_to_end_call : module500.click_to_start_call;
