              ...
              function (h) {
                for (;;)
                  switch ((h.prev = h.next)) {
                                ...
                                switch ((b.prev = b.next)) {
                                  case 0:
                                    if (
                                      ...
                                      (n = module1153.areaServerMap[module381.RobotStatusManager.sharedManager().serverCode].host),
                                      (o = module422.DMM.configFilePath),
                                  ...
                                  case 7:
                                    module1812 = 'https://' + n + o;
                                    x = '/config.json';
                                    console.log('' + module1812 + x + '?time=' + new Date().getTime());
                                    b.next = 12;
                                    return regeneratorRuntime.default.awrap(module391.default.asyncDownloadFile('' + module1812 + x + '?time=' + new Date().getTime(), 'infoTemp'));
                                  ...
                                  case 16:
                                    ...
                                    h = JSON.parse(w);
                                    b.next = 20;
                                    return regeneratorRuntime.default.awrap(module418.SetStorageKey(module418.StorageKeys.ConfigInfoStorage, JSON.stringify(h)));

                                  case 20:
                                    u.config = h;
                                    module12.DeviceEventEmitter.emit(module418.NotificationKeys.ConfigDidLoad);
                    ...
                    case 4:
                      h.next = 6;
                      return regeneratorRuntime.default.awrap(module418.GetStorageKey(module418.StorageKeys.ConfigInfoStorage));
