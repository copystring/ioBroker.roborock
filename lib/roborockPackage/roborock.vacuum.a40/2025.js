            ...
            var t = [
                {
                  data: [
                    {
                      title: module500.localization_strings_Setting_DoNotDisturbPage_3,
                    ...
                    {
                      title: module500.localization_strings_Setting_DoNotDisturbPage_4,
                    ...
                    {
                      title: module500.localization_strings_Setting_DoNotDisturbPage_5,
                    ...
                    {
                      title: module500.localization_strings_Setting_DoNotDisturbPage_6,
                      ...
                      visible:
                        module381.RSM.isO1Dock() || module381.RSM.isOCDock() || module381.RSM.isO3Dock() || 1 == module381.RSM.lastDockType || 3 == module381.RSM.lastDockType,
                      shouldShowBottomLine: true,
                    },
                    {
                      title: module500.localization_strings_Setting_DoNotDisturbPage_7,
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    s.prev = 0;
                    s.next = 3;
                    return regeneratorRuntime.default.awrap(module414.default.getDndTimer());
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    s.next = 4;
                    return regeneratorRuntime.default.awrap(module414.default.setDndTimerActions(t));
        ...
        value: function () {
          var t = this,
            ...
            s = React.default.createElement(
              ...
              React.default.createElement(module1208.default, null)
            );
