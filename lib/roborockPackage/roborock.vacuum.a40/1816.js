    ...
    module5.default(_, [
      {
        ...
        value: function () {
          var t = this,
            ...
            n = [
              {
                title: module500.map_type_2d,
                type: '2d',
                img: o.type2d,
              },
            ],
            p = {
              title: module500.map_type_3d,
              type: '3d',
              img: o.type3d,
            },
            u = {
              title: module500.map_type_ar,
              type: 'ar',
              img: o.typear,
            };
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              module500.map_type_switcher_title
            ),
            React.default.createElement(
              module12.View,
              {
        ...
        value: function () {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              module500.map_edit_rotate_map_title
            ),
            React.default.createElement(
              module12.View,
              {
        ...
        value: function (t) {
          ...
          return React.default.createElement(
            ...
            React.default.createElement(
              ...
              module500.map_element_switcher_title
            ),
            React.default.createElement(
              module12.View,
              {
      ...
      },
      {
        ...
        value: function () {
          var t = this.theme.mapTypeSwitcher,
            l = [],
            o = {
              title: module500.map_element_room_props,
              type: module1330.MapElementShow.NAME_TAG,
              image: t.eleName,
              selImg: t.eleNameSel,
              pvEvent: 'mapdetails_roomname_switch',
            },
            n = {
              title: module500.map_element_custom_props,
              type: module1330.MapElementShow.CUSTOM_ORDER,
              image: t.eleCustom,
              selImg: t.eleCustomSel,
              pvEvent: 'mapdetails_customize_switch',
            },
            p = {
              title: module500.map_edit_floor,
              type: module1330.MapElementShow.FLOOR_CARPET,
              image: t.eleFloor,
              selImg: t.eleFloorSel,
              pvEvent: 'mapdetails_floor_switch',
            },
            u = {
              title: module500.map_element_furnitures,
              type: module1330.MapElementShow.FURNITURE,
              image: t.eleFurniture,
              selImg: t.eleFurnitureSel,
              pvEvent: 'mapdetails_furniture_switch',
            },
            s = {
              title: module500.map_obstacles_title18,
              type: module1330.MapElementShow.OBSTACLE,
              image: t.eleObstacle,
          ...
          if (module390.default.isCameraSupported() || module390.default.isStructuredLightSupported()) l.push(s);
          return l;
        },
      },
      {
...
var O = module12.StyleSheet.create({
  ...
  k = module385.HocBottomModal(module385.WithSwipeToClose(I), false);
exports.default = k;
