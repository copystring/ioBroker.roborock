  ...
  module5.default(w, [
    {
      ...
      value: function () {
        return {
          ...
          menuProps: {
            type: module1390.MenuType.Menu_Rotate,
            ...
            for (;;)
              switch ((l.prev = l.next)) {
                ...
                case 3:
                  ...
                  u = JSON.stringify(c);
                  module1329.MM.mapRotateAngle = c;
                  l.next = 11;
                  return regeneratorRuntime.default.awrap(module418.SetStorageKey(module418.StorageKeys.MapRotateAngle, u));

                case 11:
                  module12.DeviceEventEmitter.emit(module418.NotificationKeys.DidReceiveSpecialEvent, {
                    data: module418.EventKeys.MapDidRotate,
                    sender: this,
                  });
                  if (t) t(true);
                  l.next = 18;
          ...
          function (n) {
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  o = module1329.MM.mapRotateAngle || {};
