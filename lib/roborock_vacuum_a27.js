...
class roborock_vacuum_a27 extends roborock_vacuum_a15 {
	constructor() {
		...
		this.setup.reset_consumables.strainer_work_times = {
			"name": "Water Filter",
			"type": "boolean",
			"def":false,
			"write": true
		};
		this.setup.reset_consumables.cleaning_brush_work_times = {
			"name": "High-speed maintenance brush",
			"type": "boolean",
			"def":false,
			"write": true
		};
		this.setup.reset_consumables.filter_element_work_time = {
