...
} = require("ioBroker.roborock/lib/genSpecs/gen8/q8_max/robot");

const {
	deviceStatus: cameradeviceStatus,
	camera: camera,
} = require("ioBroker.roborock/lib/genSpecs/gen8/q8_max/camera");
