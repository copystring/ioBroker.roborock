...
const actions = {
	...
	set_sub_source: () => {
		cleaningRecordsString.sub_source = { type: "number", name: "cleaning_sub_source" };
	},
	set_monitor_status: () => {
	...
	set_extra_time: () => {
		(cleaningRecordsString.extra_time = { type: "number", name: "cleaningRecord_extra_time" }), (deviceStates.extra_time = "number");
	},
	set_cleaning_info: () => {
	...
	set_sterilize_status: () => {
		deviceStates.sterilize_status = "number";
	},
	set_rst: () => {
		deviceStates.rst = "number";
	},
};
...
class device_features {
	...
	isWashThenChargeCmdSupported() {
		...
		consumables.strainer_work_times = { type: "number", unit: null, divider: null };
		consumables.cleaning_brush_work_times = { type: "number", unit: null, divider: null };
