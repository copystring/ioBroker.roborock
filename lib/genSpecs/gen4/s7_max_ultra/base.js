 ...
 * @property {string} dss - @dss@
 * @property {string} rss - @rss@
 * @property {string} clean_percent - @clean_percent@
 * @property {string} rdt - @rdt@
 * @property {string} dry_status - @dry_status@
 * @property {string} wash_status - @wash_status@
 ...
 * @property {string} camera_status - @camera_status@
 ...
 * @property {Object} begin - @start_cleaning_time_description@
 * @property {Object} end - @end_cleaning_time_description@
 * @property {Object} duration - @duration_cleaning_time_description@
 * @property {Object} area - @cleaning_area_description@
 * @property {Object} error - @error_type_description@
 * @property {Object} complete - @completion_type_description@
 * @property {Object} start_type - @start_type_description@
 * @property {Object} clean_type - @clean_type_description@
 * @property {Object} finish_reason - @clean_finish_reason_description@
 * @property {Object} dust_collection_status - @dust_collection_status_description@
 * @property {Object} map_flag - @map_flag_description@
 * @property {Object} switch_map_mode - @switch_map_mode@
 * @property {Object} charge_status - @charge_status@
 * @property {Object} wash_count - @charge_status@
 * @property {Object} avoid_count - @charge_status@
 *
 *
 */
