...
const states = {
    /**
     * Fan power modes.
     * @property {Object} fan_power - An object that maps fan power modes to their corresponding values.
     * @property {string} fan_power.101 - Quiet mode.
     * @property {string} fan_power.102 - Balanced mode.
     * @property {string} fan_power.103 - Turbo mode.
     * @property {string} fan_power.104 - Max mode.
     * @property {string} fan_power.105 - Off mode.
     */
    fan_power: {
        "101": "Quiet",
        "102": "Balanced",
