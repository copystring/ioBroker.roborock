 ...
 * @property {number} last_clean_t - @last_clean_t@
 * @property {number} rdt - @rdt@
 * @property {number} in_warmup - @in_warmip@
 * @property {number} common_status - @common_status@
 * @property {number} corner_clean_mode - @corner_clean_mode@
 */
const deviceStatus = {
	unsave_map_flag: {
