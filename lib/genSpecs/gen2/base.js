 ...
 * @property {number} unsave_map_flag - @unsave_map_flag_description@
 * @property {number} unsave_map_reason - @unsave_map_reason_description@
 * @property {number} dock_error_status - @dock_error_status_description@
 * @property {number} debug_mode - @debug_mode_description@
 * @property {number} auto_dust_collection - @auto_dust_collection_description@
 * @property {number} dust_collection_status - @dust_collection_status_description@
 * @property {number} dock_type - @dock_type_description@
 * @property {string} adbumper_status - @adbumper_status_description@
 * @property {number} lock_status - @lock_status_description@
 * @property {number} is_locating - @is_locating_description@
 * @property {number} map_status - @map_status_description@
 * @property {number} dnd_enabled - @dnd_enabled_description@
 * @property {number} lab_status - @lab_status_description@
 * @property {number} in_fresh_state - @in_fresh_state_description@
 * @property {number} in_returning - @in_returning_description@
 * @property {number} in_cleaning - @in_cleaning_description@
 * @property {number} map_present - @map_present_description@
 * @property {number} error_code - @error_code_description@
 * @property {number} clean_area - @clean_area_description@
 * @property {number} clean_time - @clean_time_description@
 * @property {number} battery - @battery_description@
 * @property {number} state - @state_description@
 * @property {number} msg_seq - @msg_seq_description@
 * @property {number} msg_ver - @msg_ver_description@
 * @property {number} fan_power - @fan_power_description@
 * @property {number} mop_mode - @mop_mode_description@
 * @property {number} water_shortage_status - @water_shortage_status_description@
 * @property {number} mop_forbidden_enable - @mop_forbidden_enable_description@
 * @property {number} water_box_carriage_status - @water_box_carriage_status_description@
 * @property {number} water_box_status - @water_box_status_description@
 * @property {number} water_box_mode - @water_box_mode_description@
 */
const deviceStatus = {
	unsave_map_flag: {
 ...
 * @property {Object} 0 - @cleaningInfo_0@
 * @property {Object} 1 - @cleaningInfo_1@
 * @property {Object} 2 - @cleaningInfo_2@
 * @property {Object} 3 - @cleaningInfo_3@
 */
const cleaningInfo = {
