						...
						if (obstacleCount > 0) {
							for (let i = 0; i < length; i += 28) {
								obstacles.push([
									...
									buf.readUInt16LE(0x0c + offset + i + 4), // title
									...
									buf.readUInt16LE(0x0c + offset + i + 16),
									buf.readUInt16LE(0x0c + offset + i + 18),
									buf.readUInt16LE(0x0c + offset + i + 20),
									buf.readUInt16LE(0x0c + offset + i + 22),
									buf.readUInt16LE(0x0c + offset + i + 24),
									buf.readUInt16LE(0x0c + offset + i + 26),
								]);
							}
