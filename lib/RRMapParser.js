...
RRMapParser.PARSEDATA = function parseData(mapBuf) {
	...
	const returnData = [];
	returnData.push(parsedMapData);
	returnData.push(parameters.position.top);
	returnData.push(parameters.position.left);
	returnData.push(parameters.dimensions.width);
	returnData.push(parameters.dimensions.height);
