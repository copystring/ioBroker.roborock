...
window.onload = function() {
	(async () => {
		...
		function convertToRobotZone(rect)
		{
			...
			rectMin.x = Math.round((rect.x  + canvasOffsetX + 2) / (mapSizeX / mapSizeY) / scaleFactor / zoomLevel + ((mapMinX) / scaleFactor));
			rectMin.y = Math.round((rect.y + canvasOffsetY + 2) / (mapSizeX / mapSizeY) / scaleFactor / zoomLevel + ((mapMinY) / scaleFactor));
