...
class message_parser {
	...
	_decodeMsg(message, duid) {
		try {
			...
			this.adapter.log.error(`failed to _decodeMsg: ${error.stack}. Local binary data: ${message.toString("hex")}`, null, duid);
	 ...
	 */
	async buildPayload(protocol, messageID, method, params) {
